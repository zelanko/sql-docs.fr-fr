---
title: Principes de base des services Bureau à distance | Documents Microsoft
ms.prod: sql
...
ms.locfileid: "35274028"
---
# <a name="rds-fundamentals"></a>Principes de base des services Bureau à distance
> [!IMPORTANT]
...
-   [Le résumé du modèle objet RDS](../../../ado/guide/remote-data-service/rds-object-model-summary.md)  
  
## <a name="see-also"></a>Voir aussi  
 [Solutions pour l’accès aux données distantes](../../../ado/guide/remote-data-service/solutions-for-remote-data-access.md)   
