---
title: À l’aide de Technologies associées avec RDS | Microsoft Docs
ms.prod: sql
 ...
 **Microsoft Internet Explorer** pour plus d’informations sur Microsoft Internet Explorer, consultez le site de Microsoft Internet ExplorerWeb et le site Web d’atelier de Web et de la bibliothèque MSDN.  
  
 **Microsoft Windows NT Server/Windows 2000 Server** pour plus d’informations sur la sécurité dans Microsoft Windows NT Server ou Windows 2000 Server, consultez le site Web de Microsoft Windows.  
