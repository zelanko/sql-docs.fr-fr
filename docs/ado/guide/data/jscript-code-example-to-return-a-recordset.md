---
description: Exemple de code JScript pour retourner un recordset
...
1.  Enregistrez le code ci-dessus dans un fichier texte. Enregistrez le fichier en tant que rs.js.  
