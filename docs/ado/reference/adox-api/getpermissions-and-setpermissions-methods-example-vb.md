---
description: GetPermissions et SetPermissions, exemples de méthodes (VB)
title: GetPermissions et SetPermissions, exemples de méthodes (VB) | Microsoft Docs
ms.prod: sql
