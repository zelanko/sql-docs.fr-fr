---
title: Indexes, exemple de méthode (VC ++) Append | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "47661037"
---
# <a name="indexes-append-method-example-vc"></a>Indexes, exemple de méthode Append (VC++)
Le code suivant montre comment créer un nouvel index. L’index est sur deux colonnes de la table.  
