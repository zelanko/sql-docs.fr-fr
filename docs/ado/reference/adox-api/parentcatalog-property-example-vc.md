---
title: Exemple de propriété ParentCatalog (VC ++) | Documents Microsoft
ms.prod: sql
...
ms.locfileid: "35286588"
---
# <a name="parentcatalog-property-example-vc"></a>Exemple de propriété ParentCatalog (VC ++)
