---
title: Exemple de propriété DeleteRule (VB) | Documents Microsoft
ms.prod: sql
...
ms.locfileid: "35285888"
---
# <a name="deleterule-property-example-vb"></a>Exemple de propriété DeleteRule (VB)
