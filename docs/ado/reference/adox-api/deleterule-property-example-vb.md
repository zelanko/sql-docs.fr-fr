---
description: DeleteRule, exemple de propriété (VB)
title: DeleteRule, exemple de propriété (VB) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "88440101"
---
# <a name="deleterule-property-example-vb"></a>DeleteRule, exemple de propriété (VB)
