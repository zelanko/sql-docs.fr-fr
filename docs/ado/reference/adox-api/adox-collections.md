...
ms.locfileid: "47613398"
---
# <a name="adox-collections"></a>Collections ADOX
|||  
|-|-|  
|[Colonnes](../../../ado/reference/adox-api/columns-collection-adox.md)|Contient tous les **colonne** objets d’une table, un index ou une clé.|  
|[Groupes](../../../ado/reference/adox-api/groups-collection-adox.md)|Contient tous les stockées **groupe** objets d’un catalogue ou d’utilisateur.|  
...
|[Utilisateurs](../../../ado/reference/adox-api/users-collection-adox.md)|Contient tous les stockées **utilisateur** objets d’un catalogue ou un groupe.|  
