---
title: Type de propriété (colonne) (ADOX) | Microsoft Docs
ms.prod: sql
...
## <a name="remarks"></a>Notes  
 Cette propriété est en lecture/écriture jusqu'à ce que le [colonne](../../../ado/reference/adox-api/column-object-adox.md) objet est ajouté à une collection ou à un autre objet, après quoi elle est en lecture seule.  
