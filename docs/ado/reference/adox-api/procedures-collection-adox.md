...
-   Supprimer une procédure de la collection avec le [supprimer](../../../ado/reference/adox-api/delete-method-adox-collections.md) (méthode).  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Événements, méthodes et propriétés de Collection de procédures](../../../ado/reference/adox-api/procedures-collection-properties-methods-and-events.md)   
