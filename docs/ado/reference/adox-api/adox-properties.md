...
|[IndexNulls,](../../../ado/reference/adox-api/indexnulls-property-adox.md)|Indique si les enregistrements qui ont des valeurs NULL dans leurs champs d’index ont des entrées d’index.|  
...
|[SortOrder](../../../ado/reference/adox-api/sortorder-property-adox.md)|Indique la séquence de tri de la colonne (colonnes d’index uniquement).|  
...
|[UpdateRule](../../../ado/reference/adox-api/updaterule-property-adox.md)|Indique l’action effectuée lors de la mise à jour d’une clé primaire.|  
