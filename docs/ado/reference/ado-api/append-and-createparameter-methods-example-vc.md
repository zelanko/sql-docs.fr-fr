---
title: Append et CreateParameter, exemple de méthodes (VC ++) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "63248154"
---
# <a name="append-and-createparameter-methods-example-vc"></a>Append et CreateParameter, exemple de méthodes (VC ++)
