...
-   Représentation hexadécimale hexadécimal, à savoir le du numéro d’erreur complet. Le code de fonction Windows est dans le quatrième chiffre. Le code de fonction des numéros d’erreur ADO est *A*. Exemple : 0x800***A***0E7B.  
