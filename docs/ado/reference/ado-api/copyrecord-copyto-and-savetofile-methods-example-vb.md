---
description: CopyRecord, CopyTo et SaveToFile, exemple de méthodes (VB)
title: CopyRecord, CopyTo et SaveToFile, exemple de méthodes (VB) | Microsoft Docs
ms.prod: sql
