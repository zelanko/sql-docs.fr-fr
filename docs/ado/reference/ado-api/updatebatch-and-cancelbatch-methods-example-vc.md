---
description: UpdateBatch et CancelBatch, exemple de méthodes (VC++)
title: UpdateBatch et CancelBatch, exemples de méthodes (VC + +) | Microsoft Docs
ms.prod: sql
