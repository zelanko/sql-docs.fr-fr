---
description: AbsolutePosition et CursorLocation, exemples de propriétés (VC + +)
title: AbsolutePosition et CursorLocation, exemples de propriétés (VC + +) | Microsoft Docs
ms.prod: sql
