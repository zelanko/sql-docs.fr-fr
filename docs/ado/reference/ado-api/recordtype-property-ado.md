---
title: RecordType, propriété (ADO) | Documents Microsoft
ms.prod: sql
...
ms.locfileid: "35281374"
---
# <a name="recordtype-property-ado"></a>RecordType, propriété (ADO)
Indique le type de [enregistrement](../../../ado/reference/ado-api/record-object-ado.md) objet.  
  
## <a name="return-value"></a>Valeur de retour  
 Retourne un [RecordTypeEnum](../../../ado/reference/ado-api/recordtypeenum.md) valeur.  
  
## <a name="remarks"></a>Notes  
 Le **RecordType** propriété est en lecture seule.  
