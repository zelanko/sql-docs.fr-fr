---
description: BeginTrans, CommitTrans et RollbackTrans, exemples de méthodes (VC + +)
title: BeginTrans, CommitTrans et RollbackTrans, exemples de méthodes (VC + +) | Microsoft Docs
ms.prod: sql
