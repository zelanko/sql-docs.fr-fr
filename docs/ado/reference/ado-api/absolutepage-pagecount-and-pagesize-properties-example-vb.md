---
description: AbsolutePage, PageCount et PageSize, propriétés, exemple (VB)
title: AbsolutePage, PageCount et PageSize, propriétés, exemple (VB) | Microsoft Docs
ms.prod: sql
