---
description: Execute, Requery et Clear, exemples de méthodes (VC + +)
title: Execute, Requery et Clear, exemples de méthodes (VC + +) | Microsoft Docs
ms.prod: sql
