---
description: 'ConnectionEvents (index de la syntaxe Visual C++ avec #import)'
title: 'ConnectionEvents (index de la syntaxe Visual C++ avec #import) | Microsoft Docs'
ms.prod: sql
