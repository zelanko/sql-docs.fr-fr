---
description: Provider et DefaultDatabase, exemple de propriétés (VB)
title: Provider et DefaultDatabase, exemple de propriétés (VB) | Microsoft Docs
ms.prod: sql
