---
description: Field (syntaxe ADO pour Visual C++)
title: Field (syntaxe ADO pour Visual C++) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "88973280"
---
# <a name="field-ado-for-visual-c-syntax"></a>Field (syntaxe ADO pour Visual C++)
