---
description: Move, exemple de méthode (VC++)
title: Move, exemple de méthode (VC + +) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "88990560"
---
# <a name="move-method-example-vc"></a>Move, exemple de méthode (VC++)
