---
title: Mise à jour et CancelUpdate, méthodes-exemple (VB) | Documents Microsoft
ms.prod: sql
...
```  
 ...
 Cet exemple illustre la **mise à jour** méthode conjointement avec la [AddNew](../../../ado/reference/ado-api/addnew-method-ado.md) (méthode).  
