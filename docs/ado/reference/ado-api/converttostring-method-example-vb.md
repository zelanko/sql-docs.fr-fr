---
title: Exemple de méthode ConvertToString (VB) | Documents Microsoft
ms.prod: sql
...
ms.locfileid: "35277118"
---
# <a name="converttostring-method-example-vb"></a>Exemple de méthode ConvertToString (VB)
```  
