...
|[Caractères](../../../ado/reference/ado-api/charset-property-ado.md)|Indique le jeu de caractères dans lequel le contenu d’un **flux** de texte doit être traduit.|  
...
|[CursorType](../../../ado/reference/ado-api/cursortype-property-ado.md)|Indique le type de curseur utilisé dans un objet **Recordset** .|  
...
|[Mustek](../../../ado/reference/ado-api/datasource-property-ado.md)|Indique un objet qui contient les données à représenter sous la forme d’un objet **Recordset** .|  
...
|[Native](../../../ado/reference/ado-api/nativeerror-property-ado.md)|Indique le code d’erreur spécifique au fournisseur pour un objet d' **erreur** particulier.|  
|[Certain](../../../ado/reference/ado-api/number-property-ado.md)|Indique le nombre qui identifie de façon unique un objet d' **erreur** .|  
