---
description: Append et CreateParameter, exemple de méthodes (VB)
title: Append et CreateParameter, exemple de méthodes (VB) | Microsoft Docs
ms.prod: sql
