---
title: Attributs et propriétés nom-exemple (VB) | Documents Microsoft
ms.prod: sql
...
ms.locfileid: "35275968"
---
# <a name="attributes-and-name-properties-example-vb"></a>Attributs et propriétés nom-exemple (VB)
