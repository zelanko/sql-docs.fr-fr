---
title: DimensionCount, propriété (ADO MD) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "66709318"
---
# <a name="dimensioncount-property-ado-md"></a>DimensionCount, propriété (ADO MD)
Indique le nombre de dimensions sur un [axe](../../../ado/reference/ado-md-api/axis-object-ado-md.md).  
