---
title: Propriétés ADO MD | Microsoft Docs
ms.prod: sql
...
|[Ordinal (cellule)](../../../ado/reference/ado-md-api/ordinal-property-ado-md-cell.md)|Identifie de façon unique une cellule par sa position au sein d’un ensemble de cellules.|  
...
|[Source](../../../ado/reference/ado-md-api/source-property-ado-md.md)|Indique la source pour les données dans l’ensemble de cellules.|  
