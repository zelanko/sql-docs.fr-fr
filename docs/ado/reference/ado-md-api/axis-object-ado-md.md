---
title: Objet de l’axe (ADO MD) | Documents Microsoft
ms.prod: sql
...
-   Identifier les **axe** avec la [nom](../../../ado/reference/ado-md-api/name-property-ado-md.md) propriété.  
  
-   Parcourir chaque position le long d’un **axe** à l’aide de la [Positions](../../../ado/reference/ado-md-api/positions-collection-ado-md.md) collection.  
  
-   Obtenir le nombre de dimensions sur la **axe** avec la [DimensionCount](../../../ado/reference/ado-md-api/dimensioncount-property-ado-md.md) propriété.  
