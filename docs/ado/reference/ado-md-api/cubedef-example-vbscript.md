---
title: CubeDef, exemple (VBScript) | Documents Microsoft
ms.prod: sql
...
ms.locfileid: "35283558"
---
# <a name="cubedef-example-vbscript"></a>CubeDef, exemple (VBScript)
Cet exemple affiche les métadonnées de cube sur une page web.  
