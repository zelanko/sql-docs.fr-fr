---
title: Méthodes ADO MD | Documents Microsoft
ms.prod: sql
...
|[Ouvrir](../../../ado/reference/ado-md-api/open-method-ado-md.md)|Récupère les résultats d’une requête multidimensionnelle et renvoie les résultats à un ensemble de cellules.|  
