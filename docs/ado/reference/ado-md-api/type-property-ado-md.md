...
ms.locfileid: "67949119"
---
# <a name="type-property-ado-md"></a>Type, propriété (ADO MD)
Indique le type du [membre](../../../ado/reference/ado-md-api/member-object-ado-md.md)actuel.  
  
## <a name="return-values"></a>Valeurs de retour  
 Retourne une valeur [MemberTypeEnum](../../../ado/reference/ado-md-api/membertypeenum.md) et est en lecture seule.  
