...
6.  Dans le volet **Métadonnées** , dans la dimension **Product** , faites glisser **Core Products** vers la zone de filtre.  
    ...
    ![Membres du jeu nommé Core Product](../analysis-services/media/l6-named-set-04.gif "Membres du jeu nommé Core Product")  
...
7.  Dans le volet **Métadonnées** , développez **Reseller**, ajoutez **Large Resellers** à la zone de filtre.  
    ...
    ![Volet Filtre contenant deux jeux nommés](../analysis-services/media/l6-named-set-05.gif "Volet Filtre contenant deux jeux nommés")  
