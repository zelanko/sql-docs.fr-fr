---
title: "Sp&#233;cification des relations d&#39;attribut dans une hi&#233;rarchie d&#233;finie par l&#39;utilisateur | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
19. Dans la boîte de dialogue **Créer une relation d’attribut**, **l’Attribut source** est **État-Province**. Définissez **l’Attribut associé** sur **Pays-Région**. Dans la liste **Type de relation**, définissez le type de relation sur **Rigide**, car la relation entre un état-province et un pays-région ne change pas au fil du temps.  
...
[Définition du membre inconnu et des propriétés de traitement Null](../analysis-services/defining-the-unknown-member-and-null-processing-properties.md)  
