...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Une perspective est un mécanisme permettant de simplifier ou mieux cibler le modèle dans une plus petite partie de celui-ci pour l’application cliente.  
