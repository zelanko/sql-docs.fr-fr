...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Dans les modèles tabulaires une hiérarchie est le chemin d’accès de navigation d’un attribut à un autre en fonction des valeurs sélectionnées par l’utilisateur.  
