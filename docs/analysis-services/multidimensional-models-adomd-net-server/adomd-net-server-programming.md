...
|[Architecture d’objets serveur ADOMD.NET](../../analysis-services/multidimensional-models-adomd-net-server/adomd-net-server-object-architecture.md)|Décrit l'architecture objet des objets serveur ADOMD.NET.|  
|[Fonctions définies par l’utilisateur et les procédures stockées](../../analysis-services/multidimensional-models-adomd-net-server/user-defined-functions-and-stored-procedures.md)|Présente le processus de création d'une fonction définie par l'utilisateur ou d'une procédure stockée.|  
