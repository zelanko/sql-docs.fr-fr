...
1.  Ouvrez le Concepteur de cube pour le cube du didacticiel de [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)], puis cliquez sur l’onglet **Indicateurs de performance clés**.  
    ...
    ![Onglet indicateurs de performance clés du Concepteur de Cube](../media/l7-kpi-1.gif "onglet indicateurs de performance clés du Concepteur de Cube")  
...
2.  Dans la barre d’outils de l’onglet **Indicateurs de performance clés** , cliquez sur le bouton **Nouvel indicateur de performance clé (KPI)** .  
    ...
    ![Modèle d’indicateur de performance clé vide dans le volet d’informations](../media/l7-kpi-2.gif "modèle d’indicateur de performance clé vide dans le volet d’informations")  
