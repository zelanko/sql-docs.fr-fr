...
Pour plus d’informations, consultez [Dimensions parent-enfant](../multidimensional-models/parent-child-dimension.md) et [Attributs dans des hiérarchies de type parent-enfant](../multidimensional-models/parent-child-dimension-attributes.md).  
...
10. ![Tableau croisé dynamique affichant la hiérarchie Employees](../media/l4-employee-1.gif "tableau croisé dynamique affichant la hiérarchie Employees")  
...
4.  Dans la deuxième ligne, la ligne **\*** , tapez **Employee Level \*** dans la colonne **Name**, puis sélectionnez la troisième ligne.  
    ...
    ![Boîte de dialogue modèle de nom au niveau](../media/l4-namingtemplate.gif "boîte de dialogue modèle de nom de niveau")  
...
5.  Faites glisser la hiérarchie **Employees** vers la zone Étiquettes de ligne.  
    ...
    ![Modification de la hiérarchie Employees](../media/l4-employee-2.png "hiérarchie Employees modifiée")  
  
## <a name="next-task-in-lesson"></a>Tâche suivante de la leçon  
[Regroupement automatique des membres d'attribut](lesson-4-3-automatically-grouping-attribute-members.md)  
  
## <a name="see-also"></a>Voir aussi  
[Dimensions parent-enfant](../multidimensional-models/parent-child-dimension.md)  
[Attributs dans des hiérarchies de type parent-enfant](../multidimensional-models/parent-child-dimension-attributes.md)  
