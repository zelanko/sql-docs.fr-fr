...
-   Vous devez avoir autorisations de lecture dans le **AdventureWorksDW** base de données exemple. Cet exemple de base de données est valable pour la version de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] .  
