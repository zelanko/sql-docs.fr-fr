...
4.  Vérifiez les propriétés de la clé et de la configuration de l'erreur de clé Null, mais n'apportez aucune modification.  
    ...
    ![Collection de propriétés ErrorConfiguration](../media/l4-productdimensionerrorconfig-1.gif "collection de propriétés ErrorConfiguration")  
...
6.  Développez **Components**, puis le membre sans nom du niveau **Model Name** .  
    ...
    ![Composants d’assemblage permet de créer d’autres composants](../media/l4-productdimensionerrorconfig-2.gif "composants d’Assembly utilisés pour créer d’autres composants")  
...
4.  Sélectionnez la requête SELECT DISTINCT et cliquez sur **Afficher les détails**.  
    ...
    ![Clause SELECT DISTINCT affichant la clause WHERE](../media/l4-productnametraceline-1.gif "clause SELECT DISTINCT affichant la clause WHERE")  
...
4.  Développez le membre **Assembly Components** du niveau **Category** , puis le membre **Assembly Components** du niveau **Subcategory** .  
    ...
    ![Niveau de nom de produit affichant des composants d’assemblage](../media/l4-assemblycomponents-1.gif "niveau Product Name montrant des composants d’assembly")  
