...
[!INCLUDE[ssas-appliesto-sqlas](../includes/ssas-appliesto-sqlas.md)]Dans les leçons précédentes de ce didacticiel, vous avez appris que les dimensions de base de données ajoutées à un cube peuvent servir comme base pour une ou plusieurs dimensions de cube. Au cours de cette leçon, vous allez apprendre à définir différents types de relations entre des dimensions de cube et des groupes de mesures et à spécifier les propriétés de ces relations.  
