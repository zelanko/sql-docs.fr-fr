...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Définit un type de données dérivé qui représente la relation entre une dimension plusieurs-à-plusieurs et un groupe de mesures.  
