...
# <a name="dimensionbinding-data-type-assl"></a>Type de données DimensionBinding (ASSL)
  Définit un type de données dérivé qui représente la liaison entre une source de données et un [Dimension](../../../analysis-services/scripting/objects/dimension-element-assl.md) élément.  
