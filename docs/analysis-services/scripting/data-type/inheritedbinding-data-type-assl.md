...
# <a name="inheritedbinding-data-type-assl"></a>Type de données InheritedBinding (ASSL)
  Définit un type de données dérivé indiquant qu’un [MeasureGroupAttribute](../../../analysis-services/scripting/data-type/measuregroupattribute-data-type-assl.md) élément hérite ses liaisons de l’attribut.  
