...
# <a name="dsvtablebinding-data-type-assl"></a>Type de données DSVTableBinding (ASSL)
  Définit un type de données dérivé qui représente la liaison entre une table et un [DataSourceView](../../../analysis-services/scripting/objects/datasourceview-element-assl.md) élément.  
