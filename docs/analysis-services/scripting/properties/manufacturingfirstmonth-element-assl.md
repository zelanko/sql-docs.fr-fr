...
ms.locfileid: "34034130"
---
# <a name="manufacturingfirstmonth-element-assl"></a>Élément ManufacturingFirstMonth (ASSL)
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]
  Définit le premier mois de fabrication pour un élément [TimeBinding](../../../analysis-services/scripting/data-type/timebinding-data-type-assl.md) .  
