...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Contient le nom de fichier ou l’identificateur programmatique (ProgID) d’un composant de modèle COM (Component Object).  
