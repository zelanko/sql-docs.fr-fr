...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Contient une valeur en lecture seule qui décrit l’état actuel du traitement de l’élément parent.  
