...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Contient la représentation graphique recommandée de la tendance de la [Kpi](../../../analysis-services/scripting/objects/kpi-element-assl.md) élément.  
