...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Contient l’horodatage de la mise à jour des métadonnées en lecture seule de l’élément parent.  
