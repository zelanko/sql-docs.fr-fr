...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Contient un fragment de document XML qui décrit le [Trace](../../../analysis-services/scripting/objects/trace-element-assl.md) filtre.  
