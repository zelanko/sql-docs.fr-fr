...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Contient la collection d’autorisations applicable à un [Cube](../../../analysis-services/scripting/objects/cube-element-assl.md) élément.  
