---
title: "Élément (ASSL) de la partition | Documents Microsoft"
ms.custom: 
ms.date: 03/06/2017
...
---
# <a name="partition-element-assl"></a>Élément Partition (ASSL)
  Définit une partition d’un [MeasureGroup](../../../analysis-services/scripting/objects/measuregroup-element-assl.md) élément ou une liaison de partition dans une sortie de ligne [MeasureGroupBinding](../../../analysis-services/scripting/data-type/measuregroupbinding-data-type-out-of-line-assl.md) élément.  
...
-   Les éléments enfants suivants ne sont pas pris en charge et ne doivent pas être utilisés :  
    ...
    -   [Tranche](../../../analysis-services/scripting/properties/slice-element-assl.md)  
  
    -   [ProactiveCaching](../../../analysis-services/scripting/objects/proactivecaching-element-assl.md)  
  
    -   [Type](../../../analysis-services/scripting/properties/type-element-partition-assl.md)  
    ...
    -   [AggregationInstanceSource](../../../analysis-services/scripting/properties/aggregationinstancesource-element-assl.md)  
     ...
     Une erreur peut être générée si l'un des éléments précédents est utilisé.  
  
-   Le [Source](../../../analysis-services/scripting/properties/source-element-binding-assl.md) élément utilisé accepte seulement **requête** liaison.  
  
 L’élément correspondant dans le modèle d’objet objets AMO (Analysis Management) est <xref:Microsoft.AnalysisServices.Partition>.  
