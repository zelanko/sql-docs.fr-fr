...
ms.locfileid: "34036500"
---
# <a name="partition-element-assl"></a>Élément Partition (ASSL)
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]
  Définit une partition d'un élément [MeasureGroup](../../../analysis-services/scripting/objects/measuregroup-element-assl.md) ou une liaison de partition dans un élément [MeasureGroupBinding](../../../analysis-services/scripting/data-type/measuregroupbinding-data-type-out-of-line-assl.md) hors ligne.  
...
|[MeasureGroupBinding](../../../analysis-services/scripting/data-type/measuregroupbinding-data-type-out-of-line-assl.md)|Aucun|  
...
-   L'élément [Source](../../../analysis-services/scripting/properties/source-element-binding-assl.md) accepte uniquement la liaison de **requête** .  
