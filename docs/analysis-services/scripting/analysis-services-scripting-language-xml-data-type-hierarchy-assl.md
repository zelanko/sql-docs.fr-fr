...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Le tableau suivant affiche la hiérarchie d’héritage des types de données dans Analysis Services Scripting Language (ASSL).  
