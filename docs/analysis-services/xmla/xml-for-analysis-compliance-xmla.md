---
title: Conformité XML for Analysis (XMLA) | Microsoft Docs
ms.date: 05/30/2018
ms.prod: sql
...
ms.locfileid: "38051587"
---
# <a name="xml-for-analysis-xmla-compliance"></a>Conformité XML for Analysis (XMLA)
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]  

  La spécification XML for Analysis 1.1 décrit une norme ouverte qui prend en charge l'accès aux sources de données qui résident sur Internet. Cette rubrique décrit en détail le niveau de conformité avec la spécification XML for Analysis 1.1 qui est pris en charge par Azure Analysis Services et SQL Server Analysis Services.  
  
## <a name="compliant-items"></a>Éléments conformes  
Analysis Services est conforme à tous les éléments obligatoires répertoriés dans la spécification XML for Analysis 1.1. En outre, Analysis Services implémente l’élément facultatif suivant décrit dans la spécification XML for Analysis 1.1.  
...
## <a name="extensions"></a>Extensions  
 Analysis Services étend également la spécification XML for Analysis 1.1 pour prendre en charge les fonctionnalités supplémentaires suivantes.  
