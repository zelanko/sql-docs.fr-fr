...
## <a name="remarks"></a>Notes  
 Le **fichier** élément contient un nom de fichier UNC, et l’élément parent détermine l’utilisation de la **fichier** élément.  
 ...
 Pour **restaurer** commandes, le **fichier** élément détermine le nom du fichier de sauvegarde à restaurer par la **restaurer** commande.  
