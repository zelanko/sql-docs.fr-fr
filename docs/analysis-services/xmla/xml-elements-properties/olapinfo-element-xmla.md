...
ms.locfileid: "37968371"
---
# <a name="olapinfo-element-xmla"></a>Élément OlapInfo (XMLA)
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]
  Contient les métadonnées de l’axe et de cellule contenue par une [racine](../../../analysis-services/xmla/xml-elements-properties/root-element-xmla.md) élément qui utilise le [MDDataSet](../../../analysis-services/xmla/xml-data-types/mddataset-data-type-xmla.md) type de données.  
...
## <a name="remarks"></a>Notes  
 Le **OLAPInfo** section d’un **racine** à l’aide de l’élément le **MDDataSet** type de données fournit les métadonnées relatives au cube, les axes du résultat multidimensionnel et les propriétés les cellules incluses dans le résultat.  
