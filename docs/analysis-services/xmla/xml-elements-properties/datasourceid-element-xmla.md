...
## <a name="remarks"></a>Notes  
 Le **DataSourceID** élément contient le nom de la source de données sur l’instance source qui identifie l’instance distante sur lesquels les informations de partition distante doit être sauvegardées, restaurées ou synchronisées.  
