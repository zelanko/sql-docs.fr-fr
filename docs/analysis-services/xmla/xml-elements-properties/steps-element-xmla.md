...
ms.locfileid: "34577591"
---
# <a name="steps-element-xmla"></a>Élément Steps (XMLA)
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]
  Spécifie le nombre maximal d'étapes suivies par la commande [DesignAggregations](../../../analysis-services/xmla/xml-elements-commands/designaggregations-element-xmla.md) pour concevoir des agrégations.  
