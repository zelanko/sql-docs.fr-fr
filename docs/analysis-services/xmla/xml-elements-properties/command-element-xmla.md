...
ms.locfileid: "38979231"
---
# <a name="command-element-xmla"></a>Élément Command (XMLA)
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]
  Contient la commande doit être exécuté par le [Execute](../../../analysis-services/xmla/xml-elements-methods-execute.md) (méthode).  
