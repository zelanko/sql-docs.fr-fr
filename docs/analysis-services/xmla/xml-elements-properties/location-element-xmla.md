...
## <a name="remarks"></a>Notes  
 Pour **sauvegarde** commandes, le **emplacement** élément fournit des informations sur la création d’un fichier de sauvegarde à distance pour une instance distante d’Analysis Services.  
  
 Pour **restaurer** commandes, le **emplacement** élément fournit des informations sur l’identification et de connexion à une distance [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] instance, ainsi que le fichier de sauvegarde distant utilisé pour restaurer à distance partitions sur cette instance à distance.  
