---
title: Programmation du modèle de propriétés de cube - multidimensionnelles | Microsoft Docs
ms.date: 05/02/2018
ms.prod: sql
...
ms.locfileid: "68209369"
---
# <a name="cube-properties---multidimensional-model-programming"></a>Propriétés des cubes - Programmation de modèle multidimensionnel
...
|**ProcessingMode**|Indique si l'indexation et l'agrégation doivent avoir lieu lors du traitement ou après celui-ci. Les options sont **régulière** ou **différé**.|  
...
|**ScriptCacheProcessingMode**|Indique si le cache des scripts doit être généré durant le traitement ou après celui-ci. Les options sont **régulière** et **différé**.|  
