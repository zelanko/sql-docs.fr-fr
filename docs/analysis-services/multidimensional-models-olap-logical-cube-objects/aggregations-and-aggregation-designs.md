...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Un <xref:Microsoft.AnalysisServices.AggregationDesign> objet définit un ensemble de définitions d’agrégation qui peuvent être partagés entre plusieurs partitions.  
