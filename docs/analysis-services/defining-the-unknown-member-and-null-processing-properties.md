...
6.  Développez **Components**, puis le membre sans nom du niveau **Model Name**.  
    ...
    ![Composants d'assembly servant à créer d'autres composants](../analysis-services/media/l4-productdimensionerrorconfig-2.gif "Composants d'assembly servant à créer d'autres composants")  
...
4.  Développez le membre **Assembly Components** du niveau **Category**, puis le membre **Assembly Components** du niveau **Subcategory**.  
    ...
    ![Niveau Nom de produit affichant des composants d'assembly](../analysis-services/media/l4-assemblycomponents-1.gif "Niveau Nom de produit affichant des composants d'assembly")  
