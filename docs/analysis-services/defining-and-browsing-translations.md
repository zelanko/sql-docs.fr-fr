...
8.  Dans la liste **Colonnes de traduction**, sélectionnez **SpanishMonthName**, comme le montre l’image suivante.  
    ...
    ![Boîte de dialogue Traduction de données d'attribut](../analysis-services/media/l9-translations-4.gif "Boîte de dialogue Traduction de données d'attribut")  
...
1.  Ouvrez le Concepteur de cube pour le cube du didacticiel de [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)], puis cliquez sur l’onglet **Traductions**.  
    ...
    ![Langue par défaut sous l'onglet Traductions](../analysis-services/media/l9-translations-5.gif "Langue par défaut sous l'onglet Traductions")  
...
5.  Dans la barre d’outils, sélectionnez **Espagnol (Espagne)** dans la liste **Langue**.  
    ...
    ![Volet de métadonnées rempli à nouveau](../analysis-services/media/l9-translations-6.png "Volet de métadonnées rempli à nouveau")  
...
9. Dans le volet Métadonnées, cliquez avec le bouton droit sur **Mes del Año** et sélectionnez **Ajouter à la requête**.  
    ...
    ![Noms de mois en espagnol dans le volet de données](../analysis-services/media/l9-translations-7.gif "Noms de mois en espagnol dans le volet de données")  
