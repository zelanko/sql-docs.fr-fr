...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]La catégorie d’événement Locks Events comporte les classes d’événements décrites dans le tableau suivant.  
