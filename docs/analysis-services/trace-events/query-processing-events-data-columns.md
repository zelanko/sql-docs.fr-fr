...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]La catégorie d’événement événements de traitement de requête présente les classes d’événements suivantes :  
