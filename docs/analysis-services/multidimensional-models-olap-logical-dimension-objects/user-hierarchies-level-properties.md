...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Le tableau suivant répertorie et décrit les propriétés d’un niveau dans une hiérarchie définie par l’utilisateur.  
