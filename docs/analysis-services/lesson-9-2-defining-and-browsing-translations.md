...
8.  Dans la liste **Colonnes de traduction** , sélectionnez **SpanishMonthName**, comme le montre l’image suivante.  
    ...
    ![Boîte de dialogue traduction de données attribut](../analysis-services/media/l9-translations-4.gif "boîte de dialogue traduction de données d’attribut")  
...
1.  Ouvrez le Concepteur de cube pour le cube du didacticiel de [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] , puis cliquez sur l’onglet **Traductions** .  
    ...
    ![Sous l’onglet Traductions la langue par défaut](../analysis-services/media/l9-translations-5.gif "langue sous l’onglet traductions par défaut")  
...
5.  Dans la barre d’outils, sélectionnez **Espagnol (Espagne)** dans la liste **Langue** .  
    ...
    ![Volet de métadonnées Repopulated](../analysis-services/media/l9-translations-6.gif "volet de métadonnées Repopulated")  
