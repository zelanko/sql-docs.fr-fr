...
### Pour définir une nouvelle vue de source de données  
...
8.  Cliquez sur le bouton **Agrandir** pour agrandir l’environnement de développement [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[vsprvs](../includes/vsprvs-md.md)].  
...
[Modification des noms de tables par défaut](../analysis-services/modifying-default-table-names.md)  
