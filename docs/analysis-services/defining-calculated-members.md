...
## Définition de calculs pour agréger des mesures physiques  
...
2.  Dans la barre d'outils de l'onglet **Calculs** , cliquez sur **Nouveau membre calculé**.  
    ...
    ![Formulaire du volet des expressions de calcul](../analysis-services/media/l6-calculatedmembers-02.gif "Formulaire du volet des expressions de calcul")  
...
9. Dans la liste **Comportement non vide**, cochez les cases pour **Internet Sales-Sales Amount** et **Reseller Sales-Sales Amount**, puis cliquez sur **OK**.  
    ...
    ![Volet des expressions de calcul rempli](../analysis-services/media/l6-calculatedmembers-03.gif "Volet des expressions de calcul rempli")  
...
11. Ajoutez une nouvelle ligne au script de calcul après la commande **Calculate;** et avant le script de calcul que vous venez d'ajouter, puis ajoutez le texte suivant au script sur sa propre ligne :  
    ...
    ![Scripts dans le volet des expressions de calcul](../analysis-services/media/l6-calculatedmembers-04.gif "Scripts dans le volet des expressions de calcul")  
...
## Définition de calculs de marge brute  
...
## Définition des calculs de pourcentage du total  
...
## Exploration des nouveaux membres calculés  
