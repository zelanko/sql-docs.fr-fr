...
manager: "erikre"
---
# Configurer les propri&#233;t&#233;s de cr&#233;ation de rapports pour les rapports Power View
...
Pour des informations détaillées sur l’ensemble de champs par défaut, consultez [Configurer un ensemble de champs par défaut pour les rapports Power View &#40;SSAS Tabulaire&#41;](../analysis-services/tabular-models/configure-default-field-set-for-power-view-reports-ssas-tabular.md) dans la documentation en ligne de SQL Server.  
...
4.  Répétez ces étapes, en définissant les propriétés de création de rapports et de colonne suivantes pour toutes les tables spécifiées. Conservez les valeurs par défaut de toutes les autres propriétés.  
    ...
    **Date**  
    ...
    |Day of Week|Caché|True|  
    |Day of Month|Caché|True|  
    |Day of Year|Caché|True|  
    |Month Name|Trier par colonne|Month|  
    |Month|Caché|True|  
    |Month Calendar|Caché|True|  
    |Fiscal Quarter|Caché|True|  
    |Fiscal Year|Caché|True|  
    |Fiscal Semester|Caché|True|  
    ...
    **Géographie (Geography)**  
    ...
    |----------|------------|---------|  
    |Geography Id|Caché|True|  
    |Sales Territory Id|Caché|True|  
  
    **Produits**  
  
    |Colonne|Propriété|Value|  
    |----------|------------|---------|  
    |Product Id|Caché|True|  
    |Product Alternate Id|Étiquette par défaut|True|  
    |Product Subcategory Id|Caché|True|  
    ...
    **Internet Sales**  
    ...
    |----------|------------|---------|  
    |Product Id|Caché|True|  
    |Customer Id|Caché|True|  
    |Promotion Id|Caché|True|  
    |Currency Id|Caché|True|  
    |Sales Territory Id|Caché|True|  
...
Étant donné que vous avez modifié le modèle, vous devez le redéployer. Pour l’essentiel, vous allez répéter les tâches effectuées à la [Leçon 14 : Déploiement](../analysis-services/lesson-14-deploy.md).  
