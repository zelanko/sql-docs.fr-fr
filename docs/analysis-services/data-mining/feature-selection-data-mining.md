...
ms.topic: "article"
helpviewer_keywords: 
  - "modèles d’exploration de données [Analysis Services], sélections de fonctionnalités"
  - "attributs [exploration de données]"
  - "algorithmes de sélection de fonctionnalités [Analysis Services]"
  - "exploration de données [Analysis Services], sélection de fonctionnalités"
