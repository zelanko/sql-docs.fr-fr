...
2.  Ensuite, vous pouvez voir le même modèle, affiché à l’aide de la **Visionneuse de l’arborescence de contenu générique Microsoft**.  
 ...
 ![Vue d’ensemble du Concepteur de modèles d’exploration de données](../../analysis-services/data-mining/media/generic-mining-model-tab1.gif "vue d’ensemble du Concepteur de modèles d’exploration de données")  
