...
helpviewer_keywords: 
  ...
  - "OLAP [Analysis Services], modèles d’exploration de données"
...
###  <a name="BKMK_Relational"></a> Modèles d'exploration de données relationnels et modèles d'exploration de données OLAP  
