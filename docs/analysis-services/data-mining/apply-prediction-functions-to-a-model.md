...
ms.topic: "article"
helpviewer_keywords: 
  - "Prévision de modèle d’exploration de données [Analysis Services], sélection de modèles d’exploration de données"
...
1.  Si aucun modèle de clustering n’est disponible pour générer cet exemple de requête, créez le modèle, [TM_Clustering], en utilisant le [Didacticiel sur l’exploration de données de base](../Topic/Basic%20Data%20Mining%20Tutorial.md).  
