...
---
# Utiliser l&#39;extraction des visionneuses de mod&#232;le
...
### Utiliser l'extraction dans la Visionneuse d'arborescences Microsoft  
...
### Utiliser l'extraction dans Microsoft Cluster Viewer  
...
### Utiliser l'extraction dans la Visionneuse de l'algorithme MAR (Microsoft Association Rules)  
...
### Utiliser l'extraction dans la Visionneuse de l'algorithme MSC (Microsoft Sequence Cluster)  
