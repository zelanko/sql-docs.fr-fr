---
title: "R&#233;f&#233;rences techniques relatives &#224; l&#39;algorithme MDT (Microsoft Decision Trees) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
### Résultat des méthodes et sélection des fonctionnalités  
 L'algorithme MDT (Microsoft Decision Trees) offre trois formules pour définir le score du gain d'informations : l'entropie de Shannon, le réseau bayésien avec a priori K2 et le réseau bayésien de Dirichlet avec a priori uniforme. Les trois méthodes sont bien établies dans le champ d'exploration de données. Nous vous recommandons d'expérimenter des paramètres et des méthodes différents pour déterminer ceux qui fournissent les meilleurs résultats. Pour plus d'informations sur ces méthodes de calcul de score, consultez [Feature Selection](../Topic/Feature%20Selection.md).  
 ...
 *MAXIMUM_INPUT_ATTRIBUTES*  
 ...
 [Disponible que dans certaines éditions de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]]  
...
|4|Équivalent bayésien de Dirichlet (BDE) avec à priori uniforme<br /><br /> (par défaut)|  
 ...
 Pour obtenir une explication de ces méthodes, consultez [Feature Selection](../Topic/Feature%20Selection.md).  
