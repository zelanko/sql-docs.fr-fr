---
title: "R&#233;f&#233;rences techniques relatives &#224; l&#39;algorithme MLR (Microsoft Logistic Regression) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## Implémentation de l'algorithme MLR (Microsoft Logistic Regression)  
 ...
 ![Données incorrectement modélisées utilisant une régression linéaire](../../analysis-services/data-mining/media/logistic-linear-regression.gif "Données incorrectement modélisées utilisant une régression linéaire")  
 ...
 ![Données modélisées à l'aide d'une régression logistique](../../analysis-services/data-mining/media/logistic-regression.gif "Données modélisées à l'aide d'une régression logistique")  
