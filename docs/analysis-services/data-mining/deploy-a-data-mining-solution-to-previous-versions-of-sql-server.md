...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Cette section décrit les problèmes de compatibilité connus qui peuvent survenir lorsque vous tentez de déployer un modèle d’exploration de données ou la structure d’exploration de données qui a été créé dans une instance de [!INCLUDE[ssASCurrent](../../includes/ssascurrent-md.md)] à une base de données qui utilise SQL Server 2005 Analysis Services, ou lorsque vous déployez les modèles créés dans SQL Server 2005 à une instance de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].  
