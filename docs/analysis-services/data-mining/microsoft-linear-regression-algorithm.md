---
title: "Algorithme MLR (Microsoft Linear Regression) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
# Algorithme MLR (Microsoft Linear Regression)
 ...
 ![Ligne qui modélise un ensemble de données](../../analysis-services/data-mining/media/linear-regression.png "Ligne qui modélise un ensemble de données")  
