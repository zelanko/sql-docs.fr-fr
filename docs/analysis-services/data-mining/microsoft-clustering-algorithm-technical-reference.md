---
title: "R&#233;f&#233;rences techniques relatives &#224; l&#39;algorithme de gestion de clusters Microsoft | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "MAXIMUM_INPUT_ATTRIBUTES, paramètre"
  - "CLUSTER_SEED, paramètre"
  - "MODELLING_CARDINALITY, paramètre"
  - "MINIMUM_SUPPORT, paramètre"
  - "STOPPING_TOLERANCE, paramètre"
  - "MAXIMUM_STATES parameter"
  - "SAMPLE_SIZE, paramètre"
  - "CLUSTERING_METHOD, paramètre"
  - "méthode de type soft clustering [exploration de données]"
  - "algorithmes de gestion de clusters [Analysis Services]"
  - "CLUSTER_COUNT, paramètre"
...
## Implémentation de l'algorithme de gestion de clusters Microsoft  
...
### Mises à jour apportées à l'algorithme de gestion de clusters Microsoft dans SQL Server 2008  
...
## Personnalisation de l'algorithme de gestion de clusters Microsoft  
