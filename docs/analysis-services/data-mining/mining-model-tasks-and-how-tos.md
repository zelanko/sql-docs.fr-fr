...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Utilisez le **les modèles d’exploration de données** onglet du Concepteur d’exploration de données dans [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)] pour gérer et traiter les modèles d’exploration de données dans une structure d’exploration de données.  
...
-   [Supprimer un modèle d’exploration de données dans une structure d’exploration de données](../../analysis-services/data-mining/delete-a-mining-model-from-a-mining-structure.md)  
...
-   [Afficher ou modifier les paramètres d’un algorithme](../../analysis-services/data-mining/view-or-change-algorithm-parameters.md)  
  
-   [Créer une copie d'un modèle d'exploration de données](../../analysis-services/data-mining/make-a-copy-of-a-mining-model.md)  
