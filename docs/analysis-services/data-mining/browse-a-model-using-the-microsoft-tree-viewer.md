...
ms.topic: "article"
helpviewer_keywords: 
  - "visionneuse d'arbre [Analysis Services]"
  ...
  - "légende d'exploration de données [Analysis Services]"
  - "attributs discrets [Analysis Services]"
  - "algorithme MDT (Microsoft Decision Trees) [Analysis Services]"
  - "algorithmes d'arbre de décision [Analysis Services]"
  - "visionneuse d'arbres Microsoft"
...
#### Prédiction d'attributs discrets  
...
#### Prédiction d'attributs continus  
...
#### Options d'affichage supplémentaires pour les arbres de décision  
