...
###  <a name="bkmk_DataSources"></a> Sources de données  
...
###  <a name="bkmk_DSV"></a> Vues de source de données  
...
-   Vous pouvez également définir des structures d'exploration de données en utilisant DMX. Pour plus d’informations, consultez [Instructions de définition de données DMX &#40;Data Mining Extensions&#41;](../Topic/Data%20Mining%20Extensions%20\(DMX\)%20Data%20Definition%20Statements.md).  
...
###  <a name="bkmk_ViewExplore"></a> Afficher et explorer les modèles  
...
###  <a name="bkmk_Predict"></a> Créer des prédictions  
