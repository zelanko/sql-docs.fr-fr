...
helpviewer_keywords: 
  ...
  - "visualisation de la précision d'exploration de données"
  - "affichage de la précision d'exploration de données"
  - "matrice de confusion [exploration de données]"
  - "matrice de classification [Analysis Services]"
...
## Restrictions relatives à la matrice de classification  
...
|Décrit les étapes permettant de créer des graphiques de courbes d'élévation et d'autres graphiques d'analyse de précision.|[Tâches de test et validation et procédures &#40;exploration de données&#41;](../../analysis-services/data-mining/testing-and-validation-tasks-and-how-tos-data-mining.md)|  
