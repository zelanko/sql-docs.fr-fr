...
ms.topic: "article"
helpviewer_keywords: 
  - "attributs [exploration de données]"
  - "structures d’exploration de données [Analysis Services], à propos des structures d’exploration de données"
  - "structures d'exploration de données [Analysis Services]"
  - "exploration de données [Analysis Services], structure"
  - "objets Analysis Services, objets d’exploration de données"
...
### Affichage des structures d'exploration de données  
 ...
 L'instruction `SELECT * FROM <model>.CASES` renvoie les mêmes colonnes, mais uniquement pour les cas inclus dans le modèle en question. Pour plus d’informations, consultez [SELECT FROM &#60;structure&#62;.CASES](../Topic/SELECT%20FROM%20%3Cstructure%3E.CASES.md) et [SELECT FROM &#60;modèle&#62;.CASES &#40;DMX&#41;](../Topic/SELECT%20FROM%20%3Cmodel%3E.CASES%20\(DMX\).md).  
...
|Utiliser des structures d'exploration de données basées sur des cubes OLAP|[Créer une structure d’exploration de données OLAP](../../analysis-services/data-mining/create-a-new-olap-mining-structure.md)<br /><br /> [Filtrer le cube source d'une structure d'exploration de données](../Topic/Filter%20the%20Source%20Cube%20for%20a%20Mining%20Structure.md)|  
