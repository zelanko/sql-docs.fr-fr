...
L’algorithme d’arbres de décision fournit un ajustement supplémentaire qui permet de compenser la présence de filtres sur le modèle, ce qui peut provoquer de nombreux États à exclure pendant l’apprentissage.  
