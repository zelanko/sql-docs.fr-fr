...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Si votre structure d’exploration de données contient une table imbriquée, vous pouvez appliquer un filtre à la table de cas, la table imbriquée ou les deux.  
