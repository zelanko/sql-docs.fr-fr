...
# Algorithme Microsoft Association
 ...
 ![Ensemble de règles pour un modèle d'association](../../analysis-services/data-mining/media/association.gif "Ensemble de règles pour un modèle d'association")  
