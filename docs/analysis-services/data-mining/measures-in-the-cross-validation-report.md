...
ms.topic: "article"
helpviewer_keywords: 
  - "erreur quadratique moyenne [exploration de données]"
  - "validation croisée [exploration de données]"
  - "erreur d'absolue moyenne [exploration de données]"
  - "score du journal [exploration de données]"
  - "vraisemblance [exploration de données]"
