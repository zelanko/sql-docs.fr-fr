...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Cette section fournit des informations détaillées sur la syntaxe des filtres de modèle, ainsi que des exemples d’expressions.  
