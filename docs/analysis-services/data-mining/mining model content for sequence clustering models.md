...
ms.topic: "article"
helpviewer_keywords: 
  - "contenu du modèle d’exploration de données, modèles Sequence Clustering"
...
## Présentation de la structure d'un modèle Sequence Clustering  
...
## Contenu d'un modèle Sequence Clustering  
...
## Structure des séquences, des états et des transitions  
...
## Procédure pas à pas de structure  
...
#### Pour consulter des séquences connexes à l'aide de la visionneuse Sequence Clustering  
...
#### Pour consulter les séquences connexes à l'aide de la visionneuse du contenu de modèle générique  
