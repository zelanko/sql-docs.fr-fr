---
title: "R&#233;f&#233;rences techniques relatives &#224; l&#39;algorithme MTS (Microsoft Time Series) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "ARTXP"
  - "HISTORICAL_MODEL_GAP, paramètre"
  - "AUTO_DETECT_PERIODICITY, paramètre"
  - "algorithmes MTS (Microsoft Time Series) [Analysis Services]"
  - "ARIMA"
  - "INSTABILITY_SENSITIVITY, paramètre"
  - "PERIODICITY_HINT, paramètre"
  - "MAXIMUM_SERIES_VALUE, paramètre"
  - "série chronologique [Analysis Services]"
  - "MINIMUM_SUPPORT, paramètre"
  - "HISTORIC_MODEL_COUNT, paramètre"
  - "FORECAST_METHOD, paramètre"
  - "MISSING_VALUE_SUBSTITUTION, paramètre"
  - "MINIMUM_SERIES_VALUE, paramètre"
  - "COMPLEXITY_PENALTY, paramètre"
  - "PREDICTION_SMOOTHING, paramètre"
...
-   Si vous attribuez à *PREDICTION_SMOOTHING* une valeur comprise entre 0 et 1, le modèle pondère l’algorithme ARTXP comme une fonction exponentiellement décroissante des étapes de prédiction. Parallèlement, le modèle pondère également l'algorithme ARIMA comme complément à 1 du poids d'ARTXP. Le modèle utilise la normalisation et une constante de stabilisation pour lisser les courbes.  
 ...
 ![courbe de délai pour combinaison de modèles de série chronologique](../../analysis-services/data-mining/media/time-series-blending-curve.gif "courbe de délai pour combinaison de modèles de série chronologique")  
