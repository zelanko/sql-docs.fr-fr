...
9. Dans la liste de champs, développez la dimension **Employee** , développez **Organization**, faites glisser **Sick Leave Hours** vers **Étiquettes de colonne**.  
    ...
    ![Ventes dimensionnées par les heures de congé de maladie d'employé](../analysis-services/media/l4-discretizationmethod-2.gif "Ventes dimensionnées par les heures de congé de maladie d'employé")  
...
[Masquage et désactivation des hiérarchies d'attributs](../analysis-services/hiding-and-disabling-attribute-hierarchies.md)  
  
## Voir aussi  
[Regrouper des membres d’un attribut &#40;Discrétisation&#41;](../analysis-services/multidimensional-models/group-attribute-members-discretization.md)  
