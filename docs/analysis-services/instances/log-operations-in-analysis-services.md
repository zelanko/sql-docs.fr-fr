---
title: "Enregistrer les op&#233;rations dans Analysis Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Enregistrer les op&#233;rations dans Analysis Services
...
|Fichiers SQLDmp\<guid>.mdmp|Blocages et exceptions|Dépannage approfondi|Non|  
...
##  <a name="bkmk_general"></a> Informations générales sur les paramètres de configuration des fichiers journaux  
 ...
 ![Section du fichier de configuration qui affiche les paramètres de journal](../../analysis-services/instances/media/ssas-logfilesettings.png "Section du fichier de configuration qui affiche les paramètres de journal")  
...
4.  Éventuellement, modifiez **QueryLogSampling** ou **QueryLogTableName** si vous souhaitez échantillonner les requêtes à une fréquence différente ou utiliser un autre nom pour la table.  
 ...
 ![Paramètres de journal des requêtes dans Management Studio](../../analysis-services/instances/media/ssas-querylogsettings.png "Paramètres de journal des requêtes dans Management Studio")  
