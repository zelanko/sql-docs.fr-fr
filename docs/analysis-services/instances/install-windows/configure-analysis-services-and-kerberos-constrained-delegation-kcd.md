---
title: "Configurer Analysis Services et la d&#233;l&#233;gation Kerberos contrainte (KCD) | Microsoft Docs"
ms.custom: ""
ms.date: "03/20/2017"
...
## Scénario 1 : classeur en tant que source de données (WDS).  
 ![see 1](../../../analysis-services/instances/install-windows/media/ssas-callout1.png "see 1") Office Online Server ouvre un classeur Excel et ![see 2](../../../analysis-services/instances/install-windows/media/ssas-callout2.png "see 2") détecte une connexion de données à un autre classeur. Office Online Server envoie une demande au Service Redirecteur [!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)] ![see 3](../../../analysis-services/instances/install-windows/media/ssas-callout3.png "see 3") pour ouvrir le second classeur et les données ![see 4](../../../analysis-services/instances/install-windows/media/ssas-callout4.png "see 4").  
...
### Moteur de Base de données SQL Server 2016 et Analysis services en mode PowerPivot  
 ...
 ![remarque](../../../analysis-services/instances/install-windows/media/ssrs-fyi-note.png "remarque") Dans l’Assistant Installation de [!INCLUDE[ssCurrent](../../../includes/sscurrent-md.md)], [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] en mode PowerPivot est installé dans le cadre du flux de travail de sélection de fonctionnalités.  
...
4.  Notez que, par défaut, le type d’objet « Computer » n’est pas inclus dans la recherche. Cliquez sur ![click objects to add computer account](../../../analysis-services/instances/install-windows/media/ss-objects-button.png "click objects to add computer account") pour ajouter l’objet Computers.  
...
5.  Configurez le Service d’émission de jetons Revendications vers Windows (C2WTS) **Ceci est nécessaire pour le scénario 1**. Pour plus d’informations, consultez [Vue d’ensemble des revendications au service d’émission de jeton Windows (c2WTS)](https://msdn.microsoft.com/en-us/library/ee517278.aspx).  
...
6.  Configurez les fournisseurs d’authentification SharePoint pour Kerberos. **Ceci est nécessaire pour le scénario 1**. Pour plus d’informations, consultez [Planifier l’authentification Kerberos dans SharePoint 2013](https://technet.microsoft.com/en-us/library/ee806870.aspx).  
