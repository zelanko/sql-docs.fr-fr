---
title: Installer ou désinstaller le PowerPivot pour SharePoint Add-in (SharePoint 2016) | Microsoft Docs
ms.date: 05/02/2018
ms.prod: sql
...
-   **Autorisations :** Pour installer [!INCLUDE[ssGeminiShort2016](../../../includes/ssgeminishort2016-md.md)], l’utilisateur actuel doit être un administrateur sur l’ordinateur et du groupe Administrateurs de batterie de serveurs SharePoint.  
 ...
 **Pour démarrer l'outil de configuration de :**  
 ...
 Sur le démarrage de Windows écran, tapez « power » et dans les résultats de recherche d’applications, sélectionnez  **[!INCLUDE[ssGeminiShort2016](../../../includes/ssgeminishort2016-md.md)] Configuration**. Notez que les résultats de la recherche peuvent inclure deux liens car le programme d'installation de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] installe des outils de configuration de [!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)] distincts pour SharePoint 2013 et SharePoint 2016. Assurez-vous de lancer l'outil de configuration [!INCLUDE[ssGeminiShort2016](../../../includes/ssgeminishort2016-md.md)] .  
  
 ![Configuration PowerPivot pour SharePoint 2016](../../../analysis-services/instances/install-windows/media/powerpivot-for-sharepoint-2016-configuration.png "Configuration PowerPivot pour SharePoint 2016")  
 ...
 **Ligne de commande :** Pour réparer ou désinstaller [!INCLUDE[ssGeminiShort2016](../../../includes/ssgeminishort2016-md.md)] à l’aide de la ligne de commande, ouvrez une invite de commandes **avec des autorisations d’administrateur** et exécutez une des commandes suivantes :  
