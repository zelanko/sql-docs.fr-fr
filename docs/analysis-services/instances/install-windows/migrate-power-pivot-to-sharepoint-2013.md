...
4.  Dans l'Administration centrale de SharePoint 2013, configurez l'application de service Excel Services de sorte à utiliser le serveur [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] en mode SharePoint créé à l'étape précédente. Pour plus d’informations, consultez la section « Configurer Analysis Services intégration SharePoint de base » de [installer Analysis Services en Mode Power Pivot](../../../analysis-services/instances/install-windows/install-analysis-services-in-power-pivot-mode.md).  
  
##  <a name="bkmk_backup_restore"></a>Sauvegarder, copier et restaurer les bases de données  
 Le processus « SharePoint de base de données-mise à niveau liaison » est une séquence d’étapes pour sauvegarder, copier et restaurer [!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)] contenu connexe et les bases de données à la batterie de serveurs SharePoint 2013.  
...
##  <a name="bkmk_prepare_mount_databases"></a>Préparer des Applications Web et bases de données de contenu de montage  
...
2.  Rechercher la [!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)] service application, par exemple « par défaut [!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)] Application de Service », cliquez sur le nom de l’application de service, puis cliquez sur **propriétés** dans le ruban SharePoint.  
