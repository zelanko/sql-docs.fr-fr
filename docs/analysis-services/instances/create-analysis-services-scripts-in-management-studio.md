...
ms.topic: "article"
helpviewer_keywords: 
  - "objets Analysis Services, scripts"
  - "objets [Analysis Services], scripts"
  - "scripts [Analysis Services], objets"
...
## Voir aussi  
 ...
 [Éditeur de requête XMLA &#40;Analysis Services - Données multidimensionnelles&#41;](../Topic/XMLA%20Query%20Editor%20\(Analysis%20Services%20-%20Multidimensional%20Data\).md)  
