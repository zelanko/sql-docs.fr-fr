...
ms.topic: "article"
helpviewer_keywords: 
  - "sécurité [Analysis Services], comptes d'ouverture de session"
  - "comptes de connexion [Analysis Services]"
  - "comptes [Analysis Services]"
  - "comptes d'ouverture de session [Analysis Services], à propos des comptes d'ouverture de session"
...
## Octroi d'autorisations à Analysis Services  
...
2.  Utilisez **Gestion de l’ordinateur** | **Utilisateurs et groupes locaux** | **Groupes** pour inspecter l’appartenance du groupe de sécurité SQLServerMSASUser$\<nom_serveur>$\<nom_instance>.  
