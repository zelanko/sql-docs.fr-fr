---
title: "Inscription du nom SPN pour une instance Analysis Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
 ...
 **Exemple de syntaxe pour une instance nommée exécutée en tant que NT Service\MSOLAP$\<instance-name>**  
 ...
 Cet exemple illustre la syntaxe **setspn** pour une instance nommée s'exécutant sous le compte virtuel par défaut. Dans cet exemple, le nom d’hôte de l’ordinateur est **AW-SRV02** et le nom de l’instance **AW-FINANCE**. Là encore, il s’agit du compte d’ordinateur qui est spécifié pour le SPN, plutôt que le compte virtuel **NT Service\MSOLAP$**\<instance-name>.  
