...
2.  Développez **Instructions d’installation**. ADOMD.NET, le fournisseur OLE DB et AMO sont inclus dans la liste. Chaque bibliothèque est disponible dans les versions 32 bits ou 64 bits. Les serveurs et les stations de travail les plus récentes exécutant un système d'exploitation à 64 bits nécessiteront la version 64 bits.  
...
##  <a name="bkmk_ADOMD"></a> ADOMD.NET  
 ...
 Pour plus d’informations sur la connexion par programmation, consultez [Établissement de connexions dans ADOMD.NET](../Topic/Establishing%20Connections%20in%20ADOMD.NET.md).  
