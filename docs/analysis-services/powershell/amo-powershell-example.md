---
title: "Exemple d’AMO&#160;PowerShell | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Exemple d’AMO&#160;PowerShell
  Voici un exemple de script PowerShell qui appelle des types d’objet AMO (Analysis Services Management) pour créer une base de données tabulaire (présentant un niveau de compatibilité 1200) sur la base de données relationnelle SQL Server.  
  
 Cet exemple est fourni à des fins de démonstration uniquement. Il s’arrête au niveau de la définition des relations de table et n’inclut pas l’importation de données.  De ce fait, le script correspond davantage à un extrait de code qu’à un code prêt à être exécuté. Pour que cet élément soit exécutable, il faudrait d’autres fonctions d’assistance et des commandes supplémentaires pour remplir les écarts.  
  
## DatabaseGenerate.ps1 - Exemple  
...
## Voir aussi  
 ...
 [Référence PowerShell Analysis Services](../../analysis-services/powershell/analysis-services-powershell-reference.md)   
 [Analysis Services Management Objects &#40;AMO&#41; (Objets AMO &#40;Analysis Services Management Objects&#41;)](../Topic/Analysis%20Services%20Management%20Objects%20\(AMO\).md)   
