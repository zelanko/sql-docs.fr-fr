...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Définit les propriétés globales de l’objet PowerPivotSystemService au niveau de la batterie de serveurs.  
