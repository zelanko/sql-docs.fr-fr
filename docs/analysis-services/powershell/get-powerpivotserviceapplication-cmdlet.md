...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Retourne un ou plusieurs [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] applications de service.  
