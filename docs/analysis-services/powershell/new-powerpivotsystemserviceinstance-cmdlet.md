...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Ajoute une nouvelle instance de [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] Service système pour un serveur d’applications.  
