...
## Conditions préalables  
 Vous devez être administrateur d’application de service pour modifier les propriétés de configuration de l’instance d’Analysis Services et de l’application de service [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] .  
...
2.  Dans la section Configuration, recherchez les règles qui ont le préfixe **[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]:** . Toutes les règles d’intégrité liées à [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] ont ce préfixe, pour vous aider à les distinguer des règles SharePoint intégrées.  
...
2.  En haut de la page, sélectionnez le serveur dans votre batterie de serveurs SharePoint dotée d'une instance d'Analysis Services (dans l'illustration suivante, le nom du serveur est AW-SRV033). **SQL Server Analysis Services** apparaît dans la liste des services.  
     ...
     ![Capture d'écran de la page Gérer les services sur le serveur](../../analysis-services/power-pivot-sharepoint/media/ssas-centraladmin-servicesonserver.gif "Capture d'écran de la page Gérer les services sur le serveur")  
...
4.  Dans les pages de propriétés du service, dans Paramètres de règle d'intégrité, modifiez les paramètres suivants :  
     ...
     Ce paramètre de configuration correspond à la définition de règle suivante sur la page **Examiner les problèmes et solutions** : **[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]: Analysis Services ne dispose pas de suffisamment de ressources processeur pour effectuer les opérations demandées.**  
     ...
     Ce paramètre de configuration correspond à la définition de règle suivante sur la page **Examiner les problèmes et solutions** : **[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]: l’utilisation globale du processeur est trop élevée.**  
     ...
     Ce paramètre de configuration correspond à la définition de règle suivante sur la page **Examiner les problèmes et solutions** : **[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]: Analysis Services ne dispose pas de suffisamment de mémoire pour effectuer les opérations demandées.**  
...
2.  Dans la page Applications de service, cliquez sur **Application de service [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] par défaut**.  
  
     ![Capture d'écran de la page Gérer l'application de service](../../analysis-services/power-pivot-sharepoint/media/ssas-centraladmin-app.gif "Capture d'écran de la page Gérer l'application de service")  
  
3.  Le Tableau de bord de gestion [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] apparaît. Cliquez sur **Configurer les paramètres d'application de service** dans la liste **Actions** pour ouvrir la page des paramètres d'application de service.  
  
     ![Capture d'écran du tableau de bord, et plus particulièrement de la liste Actions](../../analysis-services/power-pivot-sharepoint/media/ssas-centraladmin-actionslist.gif "Capture d'écran du tableau de bord, et plus particulièrement de la liste Actions")  
...
4.  Dans les paramètres de la règle d'intégrité modifiez les paramètres suivants :  
     ...
     Ce paramètre de configuration correspond à la définition de règle suivante sur la page **Examiner les problèmes et solutions** : **[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]: le taux d’événements de chargement par rapport aux connexions est trop élevé.**  
     ...
     Rechercher les mises à jour du fichier [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] Management Dashboard.xlsx (la valeur par défaut est 5 jours)  
     Le fichier [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] Management Dashboard.xlsx est une source de données utilisée par les rapports du Tableau de bord de gestion [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]. Dans une configuration de serveur par défaut, ce fichier .xlsx est actualisé quotidiennement, à l’aide des données d’utilisation collectées par SharePoint et le service système [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] . Si le fichier n'est pas mis à jour, une règle d'intégrité le signale comme un problème. Par défaut, la règle est déclenchée si l'horodateur du fichier n'a pas changé pendant 5 jours.  
     ...
     Ce paramètre de configuration correspond à la définition de règle suivante sur la page **Examiner les problèmes et solutions** : **[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]: les données d’utilisation ne sont pas mises à jour à la fréquence prévue.**  
