---
title: L’alimentation de l’actualisation des données PowerPivot avec SharePoint 2013 | Microsoft Docs
ms.date: 05/02/2018
ms.prod: sql
...
> [!NOTE]
>  L'actualisation interactive des données est disponible uniquement pour les classeurs créés dans Excel 2013. Si vous actualisez un classeur Excel 2010, Excel Services affiche un message d’erreur semblable à « [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] Échec de l’opération : Le classeur a été créé dans une version antérieure d’Excel et [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] ne peut pas être actualisé tant que le fichier est mis à niveau ». Pour plus d’informations sur la mise à niveau des classeurs, consultez [Mettre à niveau les classeurs et l’actualisation planifiée des données &#40;SharePoint 2013&#41;](../../analysis-services/instances/install-windows/upgrade-workbooks-and-scheduled-data-refresh-sharepoint-2013.md).  
...
###  <a name="bkmk_windows_auth_interactive_data_refresh"></a> Authentification Windows pour les connexions de données du classeur et l'actualisation interactive des données  
 ...
 Expérience utilisateur typique : Lorsqu’un client sélectionne « Actualiser toutes les connexions » dans un classeur Excel 2013 qui contient un [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] modèle, ils affiche une message d’erreur semblable au suivant :  
...
-   **Classeurs pris en charge :** Classeurs créés à l’aide de la [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] complément pour Excel 2010 ou à l’aide d’Excel 2013. Les classeurs créés dans Excel 2010 avec le complément [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)][!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] ne sont pas pris en charge. Mettre à niveau le classeur au moins au format [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)][!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] . Pour plus d’informations, consultez [Mettre à niveau les classeurs et l’actualisation planifiée des données &#40;SharePoint 2013&#41;](../../analysis-services/instances/install-windows/upgrade-workbooks-and-scheduled-data-refresh-sharepoint-2013.md).  
...
4.  À l’heure indiquée, le service système [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] envoie une requête dans Excel Services pour :  
 ...
 ![gérer le menu de contexte de l’actualisation de données](../../analysis-services/power-pivot-sharepoint/media/as-manage-datarefresh-sharepoint2013.gif "gérer du menu de contexte de l’actualisation de données")  
  
> [!TIP]  
>  Pour plus d’informations sur l’actualisation des classeurs depuis SharePoint online, consultez [actualisation des classeurs Excel avec des modèles PowerPivot incorporés à partir de SharePoint Online (livre blanc)](http://technet.microsoft.com/library/jj992650.aspx) (http://technet.microsoft.com/library/jj992650.aspx).  
...
##  <a name="bkmk_refresh_architecture"></a> Architecture de l'actualisation planifiée des données dans SharePoint 2013  
 ...
 ![architecture d’actualisation des données de SQL Server 2012 SP1](../../analysis-services/power-pivot-sharepoint/media/as-scheduled-data-refresh2012sp1-architecture.gif "architecture d’actualisation des données de SQL Server 2012 SP1")  
 ...
 **Données d’utilisation :** Vous pouvez afficher les données d’utilisation actualisation des données dans le [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] tableau de bord de gestion. Pour afficher les données d'utilisation :  
...
##  <a name="bkmk_moreinformation"></a> Informations supplémentaires  
 ...
 [Excel Services dans SharePoint](/sharepoint/dev/general-development/excel-services-in-sharepoint).  
