---
title: "Actualisation des donn&#233;es Power Pivot avec SharePoint 2013 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
|Déclencher l'actualisation des données|**Interactive :** Utilisateur authentifié<br /><br /> **Planifiée :** Service système [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]|[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] Service système|  
...
##  <a name="bkmk_scheduled_refresh"></a> actualisation planifiée des données  
...
4.  À l’heure indiquée, le service système [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] envoie une requête dans Excel Services pour :  
 ...
 ![Menu contextuel Gérer l'actualisation des données](../../analysis-services/power-pivot-sharepoint/media/as-manage-datarefresh-sharepoint2013.gif "Menu contextuel Gérer l'actualisation des données")  
  
> [!TIP]  
>  Pour plus d’informations sur l’actualisation des classeurs à partir de SharePoint Online, consultez [Actualisation des classeurs Excel avec des modèles PowerPivot incorporés à partir de SharePoint Online (livre blanc)](http://technet.microsoft.com/library/jj992650.aspx) (https://technet.microsoft.com/library/jj992650.aspx).  
...
##  <a name="bkmk_refresh_architecture"></a> Architecture de l'actualisation planifiée des données dans SharePoint 2013  
 ...
 ![Actualisation des données de l'architecture de SQL Server 2012 SP1](../../analysis-services/power-pivot-sharepoint/media/as-scheduled-data-refresh2012sp1-architecture.gif "Actualisation des données de l'architecture de SQL Server 2012 SP1")  
...
4.  Dans **Propriétés de connexion** , cliquez sur **Définition**, puis cliquez sur le bouton **Paramètres d'authentification…** .  
 ...
 ![Paramètres d'authentification Excel Services](../../analysis-services/power-pivot-sharepoint/media/as-authentication-settings-4-ecs-in-excel2013.gif "Paramètres d'authentification Excel Services")  
