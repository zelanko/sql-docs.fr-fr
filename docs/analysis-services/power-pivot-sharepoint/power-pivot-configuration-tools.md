---
title: "Outils de configuration de Power Pivot | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
|[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] Outil de configuration|SharePoint 2010 avec SharePoint 2010|[Configurer ou réparer Power Pivot pour SharePoint 2010 (outil de configuration de Power Pivot)](http://msdn.microsoft.com/fr-fr/d61f49c5-efaa-4455-98f2-8c293fa50046)|  
...
> -   [Installer le mode SharePoint de Reporting Services pour SharePoint 2010](http://msdn.microsoft.com/fr-fr/47efa72e-1735-4387-8485-f8994fb08c8c).  
...
1.  Dans l’écran **Démarrer** , tapez **powerpivot**  
    ...
    -   **Outil de configuration[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]**.  
...
3.  Selon l'état actuel de votre installation, une ou plusieurs tâches peuvent être effectuées, dont :  
    ...
    3.  Cliquez sur **Mettre à niveau des fonctionnalités, des services, des applications et des solutions** pour mettre à niveau les fonctionnalités et les solutions qui ont été installées à l'aide d'une version antérieure de [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)].  
     ...
     ![Outil de configuration de PowerPivot pour SharePoint 2013](../../analysis-services/power-pivot-sharepoint/media/ssas-powerpivot-configtool-4-sharepoint2013-choosemode.gif "Outil de configuration de PowerPivot pour SharePoint 2013")  
