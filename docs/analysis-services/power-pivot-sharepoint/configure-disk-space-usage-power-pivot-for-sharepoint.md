...
## Comment limiter la quantité d'espace disque utilisée pour le stockage des fichiers mis en cache  
...
## Comment limiter la durée de conservation dans le cache d'une base de données  
