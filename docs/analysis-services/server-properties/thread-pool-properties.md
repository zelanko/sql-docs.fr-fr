...
ms.topic: "reference"
helpviewer_keywords: 
  - "PriorityRatio, propriété"
  - "threads [Analysis Services]"
  - "MinThreads, propriété"
  - "NumThreads, propriété"
  - "MaxThreads, propriété"
...
### Étapes pour calculer le masque d'affinité du processeur  
 ...
 **Paramètre PerNumaNode=0**  
 ...
 ![Correspondance Numa, processeur et pool de threads](../../analysis-services/server-properties/media/ssas-threadpool-numaex0.PNG "Correspondance Numa, processeur et pool de threads")  
 ...
 **Paramètre PerNumaNode=1**  
 ...
 ![Correspondance Numa, processeur et pool de threads](../../analysis-services/server-properties/media/ssas-threadpool-numaex1.PNG "Correspondance Numa, processeur et pool de threads")  
 ...
 **Paramètre PerNumaNode=2**  
 ...
 ![Correspondance Numa, processeur et pool de threads](../../analysis-services/server-properties/media/ssas-threadpool-numaex2.PNG "Correspondance Numa, processeur et pool de threads")  
...
## Voir aussi  
 ...
 [Analysis Services 2012 Configuration settings (blog Wordpress).](http://go.microsoft.com/fwlink/?LinkId=330387)   
