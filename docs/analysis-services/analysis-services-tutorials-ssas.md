...
Exemples de projets de modélisation des données et obtenir des bases de données model exemple terminé [Adventure Works pour Analysis Services sur GitHub](https://github.com/Microsoft/sql-server-samples/releases/tag/adventureworks-analysis-services).

### <a name="code-samples"></a>Exemples de code
Ouvrir les exemples de code source et des projets de communautés disponibles à l’adresse [référentiel Analysis Services sur GitHub](https://github.com/Microsoft/Analysis-Services).
...
Bases de données exemple Adventure Works et Wide World Importers sont disponibles à l’adresse [référentiel d’exemples SQL Server sur GitHub](https://github.com/Microsoft/sql-server-samples).
