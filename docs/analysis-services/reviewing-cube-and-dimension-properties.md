...
## Voir aussi  
[Explorer les données d'une dimension dans le Concepteur de dimensions](../analysis-services/multidimensional-models/browse-dimension-data-in-dimension-designer.md)  
