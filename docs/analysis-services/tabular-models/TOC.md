...
### [Importer des données à l’aide d’une requête native](ssas-import-query.md)
...
## [Traductions](translations-in-tabular-models-analysis-services.md)  
...
# [Déployer des solutions de modèles tabulaires](tabular-model-solution-deployment-ssas-tabular.md)  
