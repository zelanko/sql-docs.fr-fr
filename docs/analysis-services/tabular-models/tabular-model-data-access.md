...
### DAX  
 ...
 Pour obtenir des exemples de requêtes sur un modèle tabulaire utilisant DAX, voir [Référence syntaxique des requêtes DAX](http://msdn.microsoft.com/fr-fr/4dd0cf0e-191d-411d-987c-f606813fc39e).  
...
-   [DISCOVER_XEVENT_TRACE_DEFINITION, ensemble de lignes](../Topic/DISCOVER_XEVENT_TRACE_DEFINITION%20Rowset.md)  
