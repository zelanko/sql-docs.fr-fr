---
title: Propriétés des colonnes dans les modèles tabulaires Analysis Services | Microsoft Docs
ms.date: 05/07/2018
ms.prod: sql
...
|--------------|---------------------|-----------------|  
|**Dossier d’affichage**||Un dossier unique ou imbriqué pour organiser des colonnes dans une liste de champs d’application cliente.|  
...
|**Unique**||Peut être définie pour garantir l’unicité des valeurs dans la colonne. Toujours true pour les colonnes calculées, même si l’unicité a la valeur false.|  
