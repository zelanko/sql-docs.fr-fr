...
manager: "erikre"
---
# Configurer les propri&#233;t&#233;s de comportement de table pour les rapports Power View (SSAS Tabulaire)
...
-   Suppression des sous-totaux inutiles d'un rapport de matrice. Le regroupement par défaut au niveau du champ crée un sous-total pour chaque champ. Si vous souhaitez qu'un seul sous-total soit calculé au niveau de la ligne, la définition de l'identificateur de ligne produit ce résultat.  
 ...
 Vous ne pouvez pas définir d'identificateur de ligne pour les tables marquées comme tables de date. Pour les tables de date, l'identificateur de ligne est spécifié quand vous marquez la table. Pour plus d’informations, consultez [Boîte de dialogue Marquer en tant que table de dates &#40;SSAS&#41;](../Topic/Mark%20as%20Date%20Table%20Dialog%20Box%20\(SSAS\).md).  
...
### Des images sont manquantes  
 ...
 ![URL des images affichées comme texte dans un rapport](../../analysis-services/tabular-models/media/ssas-rptprop-noimageurl.gif "URL des images affichées comme texte dans un rapport")  
...
### Il manque une ou plusieurs lignes dans les tables  
 ...
 ![Données de ligne contenant des doublons basées sur un ID de ligne](../../analysis-services/tabular-models/media/ssas-jonyang.gif "Données de ligne contenant des doublons basées sur un ID de ligne")  
 ...
 **Avant : regroupement par défaut en fonction des champs dans la matrice**  
 ...
 ![Disposition de matrice avec regroupement par identificateur de ligne](../../analysis-services/tabular-models/media/ssas-rptprop-matrixrowid.gif "Disposition de matrice avec regroupement par identificateur de ligne")  
 ...
 **Avant : regroupement par défaut en fonction des champs dans le graphique**  
 ...
 ![Graphique basé sur le regroupement par défaut au niveau des champs](../../analysis-services/tabular-models/media/ssas-rptprop-chartfieldgroup.gif "Graphique basé sur le regroupement par défaut au niveau des champs")  
  
 **Après : regroupement en fonction de l'identificateur de ligne (l'identificateur de ligne devient l'axe)**  
  
 ![Graphique basé sur le regroupement par ID de ligne](../../analysis-services/tabular-models/media/ssas-rptprop-chartrowid.gif "Graphique basé sur le regroupement par ID de ligne")  
