...
---
# <a name="import-data---data-feed"></a>Importer des données - flux de données
...
> [!NOTE]  
>  Cela s’applique uniquement à SharePoint 2010 et SharePoint 2013.  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Prise en charge des Types de données &#40; SSAS tabulaire &#41;](../../analysis-services/tabular-models/data-types-supported-ssas-tabular.md)   
