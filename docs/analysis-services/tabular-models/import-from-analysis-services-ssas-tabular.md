...
---
# Importer &#224; partir d&#39;Analysis Services (SSAS Tabulaire)
...
## Créer un modèle en important des métadonnées d'un modèle existant dans Analysis Services  
...
#### Pour créer un modèle en important des métadonnées à partir d'un modèle existant  
