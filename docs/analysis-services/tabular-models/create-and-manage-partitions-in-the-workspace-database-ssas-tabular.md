---
title: Créer et gérer des partitions dans la base de données Analysis Services espace de travail | Microsoft Docs
ms.date: 05/07/2018
ms.prod: sql
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Traiter les partitions dans la base de données de l’espace de travail](../../analysis-services/tabular-models/process-partitions-in-the-workspace-database-ssas-tabular.md)  
