---
title: "Processus de base de donn&#233;es, table ou partition (Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Processus de base de donn&#233;es, table ou partition (Analysis Services)
  Les tâches de cette rubrique décrivent comment traiter manuellement une base de données model tabulaire, une table ou des partitions à l’aide de la boîte de dialogue **Traiter \<objet>** dans [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)].  
