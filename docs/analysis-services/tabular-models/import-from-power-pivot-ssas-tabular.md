---
title: "Importer &#224; partir de Power Pivot (SSAS Tabulaire) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
## Créer un nouveau modèle tabulaire à partir d’un fichier Power Pivot pour Excel  
...
#### Pour créer un nouveau projet de modèle tabulaire à partir d’un fichier Power Pivot pour Excel  
...
## Voir aussi  
 ...
 [Copier et coller des données &#40;SSAS Tabulaire&#41;](../../analysis-services/tabular-models/copy-and-paste-data-ssas-tabular.md)  
