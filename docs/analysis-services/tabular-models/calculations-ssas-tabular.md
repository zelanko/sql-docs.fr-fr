---
title: Calculs dans les modèles tabulaires Analysis Services | Microsoft Docs
ms.date: 05/07/2018
ms.prod: sql
...
ms.locfileid: "52984070"
---
# <a name="calculations-in-tabular-models"></a>Calculs dans les modèles tabulaires
...
|[Référence DAX (Data Analysis Expressions)](http://msdn.microsoft.com/70a82136-0926-4a91-bcb3-e18e82593b0d)|Cette section fournit une description détaillée de la syntaxe, des opérateurs et des fonctions DAX.|  
