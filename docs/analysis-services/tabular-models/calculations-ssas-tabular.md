...
|[Référence DAX (Data Analysis Expressions)](/dax/data-analysis-expressions-dax-reference)|Cette section fournit une description détaillée de la syntaxe, des opérateurs et des fonctions DAX.|  
