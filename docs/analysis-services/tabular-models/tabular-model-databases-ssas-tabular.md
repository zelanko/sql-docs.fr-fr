---
title: Analysis Services tabulaires des bases de données model | Microsoft Docs
ms.date: 05/07/2018
ms.prod: sql
...
ms.locfileid: "53072246"
---
# <a name="manage-deployed-tabular-model-databases"></a>Gérer les bases de données Model tabulaire déployée
