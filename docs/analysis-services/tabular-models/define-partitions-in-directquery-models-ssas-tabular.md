---
title: "D&#233;finition de partitions dans les mod&#232;les DirectQuery (SSAS tabulaire) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/01/2017"
...
---
# D&#233;finition de partitions dans les mod&#232;les DirectQuery (SSAS tabulaire)
...
## Modification d’une partition DirectQuery  
...
|DataView=Sample<br /><br /> S’applique aux modèles tabulaires 1200 qui utilisent des exemples de vues de données|Autoriser le traitement de la partition|Si le modèle utilise des exemples de données, vous pouvez traiter la table pour retourner un jeu de données filtré qui fournit des signaux visuels pendant la conception du modèle.|  
