...
1. [Compatibilité descendante de Analysis Services (2017 SQL)](analysis-services-backward-compatibility-sql2017.md)
2. [Sécurité au niveau de l’objet](tabular-models/object-level-security.md)
