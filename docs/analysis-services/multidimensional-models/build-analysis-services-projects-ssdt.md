...
ms.topic: "article"
helpviewer_keywords: 
  - "projets [Analysis Services], génération"
  - "Business Intelligence Development Studio, génération de projets [Analysis Services]"
...
|-----------------------------|-----------------|  
|\<nom_configuration>\LastBuilt.xml|Contient le cachet temporel et le code de hachage qui identifient la dernière fois où le projet [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] a été généré.|  
  
 Ces fichiers XML ne contiennent pas les balises \<Create> et \<Alter>, qui sont créées pendant le déploiement.  
