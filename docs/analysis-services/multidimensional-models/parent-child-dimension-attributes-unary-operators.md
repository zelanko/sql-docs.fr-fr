...
## <a name="see-also"></a>Voir aussi  
 ...
 [Opérateurs de cumul personnalisé dans les dimensions parent-enfant](../../analysis-services/multidimensional-models/parent-child-dimension-attributes-custom-rollup-operators.md)   
