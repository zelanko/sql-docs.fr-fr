---
title: "D&#233;finir la propri&#233;t&#233; Secteur de partition (Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "partitions [Analysis Services], tranches de données"
  - "tranches de données [Analysis Services]"
...
---
# D&#233;finir la propri&#233;t&#233; Secteur de partition (Analysis Services)
...
> [!NOTE]  
>  Notez que les fonctions MDX dynamiques (telles que [Generate &#40;MDX&#41;](../../mdx/generate-mdx.md) ou [Except &#40;MDX&#41;](../Topic/Except%20\(MDX\).md)) ne sont pas prises en charge dans la propriété Slice des partitions. Vous devez définir la tranche à l'aide de tuples explicites ou de références à des membres.  
>   
