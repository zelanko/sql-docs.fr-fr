---
title: "Instructions de sous-s&#233;lection dans les requ&#234;tes | Microsoft Docs"
ms.custom: ""
ms.date: "03/16/2017"
...
---
# Instructions de sous-s&#233;lection dans les requ&#234;tes
...
## Instructions de sous-sélection par exemple  
...
-   Par défaut, les membres calculés ne sont pas autorisés dans les instructions de sous-sélection ; toutefois, cette restriction peut être modifiée, session par session, en affectant une valeur à la propriété de chaîne de connexion **SubQueries** dans <xref:Microsoft.AnalysisServices.AdomdClient.AdomdConnection.ConnectionString%2A> ou à la propriété **DBPROP_MSMD_SUBQUERIES** dans [Propriétés XMLA prises en charge &#40;XMLA&#41;](../Topic/Supported%20XMLA%20Properties%20\(XMLA\).md). Consultez [Membres calculés dans les sous-sélections et les sous-cubes](../../../analysis-services/multidimensional-models/mdx/calculated-members-in-subselects-and-subcubes.md) pour obtenir une explication détaillée du comportement des membres calculés en fonction des valeurs de **SubQueries** ou **DBPROP_MSMD_SUBQUERIES**.  
