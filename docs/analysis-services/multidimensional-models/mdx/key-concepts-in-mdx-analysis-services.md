...
ms.topic: "article"
helpviewer_keywords: 
  - "Expressions multidimensionnelles [Analysis Services], à propos de MDX"
  - "modélisation dimensionnelle [MDX]"
  - "MDX [Analysis Services], à propos de MDX"
  - "Expressions multidimensionnelles [Analysis Services], modélisation dimensionnelle"
  - "MDX [Analysis Services], modélisation dimensionnelle"
...
# Concepts cl&#233;s dans MDX (Analysis Services)
 ...
 ![Tableau croisé dynamique avec légende mesures et dimensions](../../../analysis-services/multidimensional-models/media/ssas-keyconcepts-pivot1-measures-dimensions.png "Tableau croisé dynamique avec légende mesures et dimensions")  
...
-   Le membre (All) pour Pacific est $1 594 335,38  
 ...
 ![Tableau croisé dynamique avec légende tous les membres](../../../analysis-services/multidimensional-models/mdx/media/ssas-keyconcepts-pivot2-allmember.png "Tableau croisé dynamique avec légende tous les membres")  
 ...
 ![Tableau croisé dynamique avec légende membre feuille](../../../analysis-services/multidimensional-models/mdx/media/ssas-keyconcepts-pivot3-leafparent.png "Tableau croisé dynamique avec légende membre feuille")  
...
## Étendue de requête (espace du cube)  
...
-   [Requête MDX de base &#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/the-basic-mdx-query-mdx.md)  
