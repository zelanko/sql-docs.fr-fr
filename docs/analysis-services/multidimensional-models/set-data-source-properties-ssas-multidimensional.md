...
helpviewer_keywords: 
  - "boîte de dialogue Propriétés de la source de données"
...
## Définir les propriétés de la source de données dans les SQL Server Data Tools  
...
## Définir les propriétés de la source de données dans Management Studio  
