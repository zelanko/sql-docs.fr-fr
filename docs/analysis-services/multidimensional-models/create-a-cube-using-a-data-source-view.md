...
---
# Cr&#233;er un cube &#224; l&#39;aide d&#39;une vue de source de donn&#233;es
...
## Sélection de la vue de source de données  
...
## Identifier les tables de faits et de dimension  
...
## Examen de nouvelles dimensions  
...
>  Vous pouvez augmenter ou optimiser la fenêtre de l'Assistant pour afficher l'arborescence de manière plus appropriée.  
 ...
 Vous pouvez renommer une dimension, un attribut, une hiérarchie ou un niveau en cliquant sur le nom ou en cliquant avec le bouton droit sur le nom puis, dans le menu contextuel, en sélectionnant **Renommer \<objet>**, où **\<objet>** correspond à **Dimension**, **Attribut** ou **Niveau**.  
