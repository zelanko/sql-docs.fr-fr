...
ms.topic: "article"
helpviewer_keywords: 
  - "partitions locales [Analysis Services]"
  - "partitions [Analysis Services], locales"
  - "partitions [Analysis Services], création"
...
## Voir aussi  
 ...
 [Partitions distantes](../Topic/Remote%20Partitions.md)   
