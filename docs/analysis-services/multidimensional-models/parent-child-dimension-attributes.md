...
## <a name="using-data-members"></a>Utilisation des membres de données  
 ...
 ![Dimension du volume des ventes avec trois niveaux](../../analysis-services/multidimensional-models/media/agdatamember1.gif "dimension du volume des ventes avec trois niveaux")  
