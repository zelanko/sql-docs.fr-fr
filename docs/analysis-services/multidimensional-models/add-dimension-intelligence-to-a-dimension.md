---
title: "Ajouter de l&#39;intelligence de dimensions &#224; une dimension | Microsoft Docs"
ms.custom: ""
ms.date: "12/09/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "améliorations de Business Intelligence [Analysis Services], intelligence des dimensions"
  - "dimensions [Analysis Services], améliorations de Business Intelligence"
  - "intelligence des dimensions [Analysis Services]"
  - "Type (propriété)"
...
manager: "erikre"
---
# Ajouter de l&#39;intelligence de dimensions &#224; une dimension
...
> [!NOTE]  
>  Si vous sélectionnez **Compte** comme dimension, vous spécifierez l’intelligence comptable pour la dimension. Pour plus d’informations, consultez [Ajouter de l’intelligence comptable à une dimension](../../analysis-services/multidimensional-models/add-account-intelligence-to-a-dimension.md).  
  
## Spécification des attributs de dimension  
