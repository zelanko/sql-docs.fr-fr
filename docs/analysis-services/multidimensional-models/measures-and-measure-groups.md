...
ms.topic: "article"
helpviewer_keywords: 
  - "groupes de mesures [Analysis Services]"
  - "mesures [Analysis Services], à propos des mesures"
  - "OLAP (objets) [Analysis Services], mesures"
  - "fonctions d'agrégation [Analysis Services]"
  - "granularité"
  - "groupes de mesures [Analysis Services], à propos des groupes de mesures"
  - "mesures [Analysis Services]"
  - "agrégations [Analysis Services], mesures"
  - "tables de faits [Analysis Services]"
