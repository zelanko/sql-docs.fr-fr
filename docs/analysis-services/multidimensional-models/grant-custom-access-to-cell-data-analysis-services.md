---
title: "Octroyer un acc&#232;s personnalis&#233; &#224; des donn&#233;es de cellule (Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
helpviewer_keywords: 
  - "droits d’accès utilisateur [Analysis Services], données de cellule"
  - "autorisations [Analysis Services], cellules"
  - "autorisations Lire le contingent"
  - "autorisations Lecture"
  - "cellules [Analysis Services]"
  - "accès personnalisés aux données d'une cellule [Analysis Services]"
...
# Octroyer un acc&#232;s personnalis&#233; &#224; des donn&#233;es de cellule (Analysis Services)
 ...
 ![Tableau croisé dynamique montrant les cellules autorisées et refusées](../../analysis-services/multidimensional-models/media/ssas-permscellsallowed.png "Tableau croisé dynamique montrant les cellules autorisées et refusées")  
 ...
 Pour masquer complètement la cellule, vous devez limiter les membres (dimensions, attributs de dimension et membres d'attributs de dimension) qui sont visibles. Pour plus d’informations, consultez [Octroi d’accès personnalisés aux données d’une dimension &#40;Analysis Services&#41;](../../analysis-services/multidimensional-models/grant-custom-access-to-dimension-data-analysis-services.md).  
...
## Autoriser l'accès à des mesures spécifiques  
...
## Refuser l'accès à des mesures spécifiques  
...
```  
 ...
 ![Colonnes Excel montrant les cellules comme n'étant pas disponibles](../../analysis-services/multidimensional-models/media/ssas-permscellshidemeasure.png "Colonnes Excel montrant les cellules comme n'étant pas disponibles")  
  
## Définir des autorisations de Lecture sur des mesures calculées  
...
```  
 ...
 ![Table Excel avec cellules disponibles et non disponibles](../../analysis-services/multidimensional-models/media/ssas-permscalculatedcells.png "Table Excel avec cellules disponibles et non disponibles")  
  
## Définir des autorisations de Lecture du contingent sur des mesures calculées  
...
## Définir des autorisations de Lecture/Écriture sur une cellule  
...
## Voir aussi  
 [Générateur MDX &#40;Analysis Services - Données multidimensionnelles&#41;](../Topic/MDX%20Builder%20\(Analysis%20Services%20-%20Multidimensional%20Data\).md)   
