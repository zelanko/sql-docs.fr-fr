...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Vous pouvez exécuter le traitement sur un ordinateur en mode sans assistance ou planifié [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] instance, où la demande de traitement proviendra d’un ordinateur, mais s’exécute sur un autre ordinateur sur le même réseau.  
