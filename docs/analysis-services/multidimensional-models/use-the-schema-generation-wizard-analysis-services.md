...
ms.topic: "article"
helpviewer_keywords: 
  - "Assistant Génération de schéma, étapes"
  - "schéma relationnel [Analysis Services], Assistant Génération de schéma"
...
---
# Utiliser l&#39;Assistant G&#233;n&#233;ration de sch&#233;ma (Analysis Services)
...
## Étape 3 : spécifier des options de schéma pour la base de données de la zone de sujet  
