...
|-----------|-----------------|  
|[Composants serveur du moteur OLAP](../../../analysis-services/multidimensional-models/olap-physical/olap-engine-server-components.md)|Décrit les composants d'un serveur [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)].|  
