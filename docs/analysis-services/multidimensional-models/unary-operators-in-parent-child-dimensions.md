...
helpviewer_keywords: 
  ...
  - "attributs [Analysis Services], opérateurs unaires"
  - "opérateurs unaires"
...
manager: "erikre"
---
# Op&#233;rateurs unaires dans les dimensions parent-enfant
...
## Voir aussi  
 ...
 [Opérateurs de cumul personnalisé dans les dimensions parent-enfant](../../analysis-services/multidimensional-models/custom-rollup-operators-in-parent-child-dimensions.md)   
 [Démarrer l'Assistant Business Intelligence dans le Concepteur de dimensions](../../analysis-services/multidimensional-models/start-the-business-intelligence-wizard-in-dimension-designer.md)  
