...
ms.topic: "article"
helpviewer_keywords: 
  - "vues de sources de données [Analysis Services], liaisons"
  - "DSO, liaisons"
  - "Analysis Services Scripting Language, sources de données"
  - "cubes [Analysis Services], liaisons"
  - "modèles d'exploration de données OLAP [Analysis Services Scripting Language]"
  - "liaisons [Analysis Services Scripting Language]"
  - "reliaisons [Analysis Services Scripting Language]"
  - "ASSL, liaisons"
  - "modèles d'exploration de données relationnels [ASSL]"
  - "sources de données [Analysis Services Scripting Language]"
  - "ASSL, sources de données"
  - "dimensions [Analysis Services], liaisons"
  - "mesures [Analysis Services], liaisons"
  - "sources de données relationnelles [Analysis Services Scripting Language]"
  - "Analysis Services Scripting Language, liaisons"
  - "ensembles de lignes avec chapitre"
  - "granularité"
  - "modèles d’exploration de données (Analysis Services), sources de données"
  - "liaisons insérées [ASSL]"
  - "liaisons hors ligne"
  - "groupes de mesures [Analysis Services], liaisons"
  - "partitions [Analysis Services], liaisons"
...
## Types de données Analysis Services  
...
## Liaisons pour MeasureGroups, les mesures et les partitions  
...
### Attributs de granularité de MeasureGroup  
...
### Migration d'objets d'aide à la décision (DSO, Decision Support Objects)  
...
## Liaisons pour modèles d'exploration de données  
...
### Liaisons pour un modèle d'exploration de données relationnel  
