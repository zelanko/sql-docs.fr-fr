...
---
# Parcourir les donn&#233;es et m&#233;tadonn&#233;es de cube
...
##### Spécification d'une perspective  
...
##### Spécification d'une traduction  
...
##### Mise en forme du volet Données  
...
-   Dans la colonne **Dimension** du volet **Filtre**, cliquez sur **\<Sélectionner une dimension>**, sélectionnez une dimension dans la liste, puis cliquez sur **\<Sélectionner une hiérarchie>** dans la colonne **Hiérarchie** et sélectionnez une hiérarchie dans la liste.  
