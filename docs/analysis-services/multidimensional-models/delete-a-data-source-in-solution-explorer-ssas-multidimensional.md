...
helpviewer_keywords: 
  - "sources de données [Analysis Services], suppression"
  - "suppression de sources de données"
  - "retrait de sources de données"
...
---
# Supprimer une source de donn&#233;es dans l&#39;Explorateur de solutions (SSAS Multidimensionnel)
