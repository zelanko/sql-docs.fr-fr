...
ms.topic: "article"
helpviewer_keywords: 
  - "génération incrémentielle [Analysis Services]"
  - "Assistant Génération de schéma, génération incrémentielle"
  - "schéma relationnel [Analysis Services], génération incrémentielle"
...
## Prise en charge de la préservation des données  
...
## Prise en charge des modifications de cubes et de dimensions  
...
## Prise en charge des modifications de source de données ou de vue de source de données  
