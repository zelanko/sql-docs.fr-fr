...
ms.topic: "article"
helpviewer_keywords: 
  - "autorisations [Analysis Services], assemblys"
  - "appel de fonctions définies par l’utilisateur"
  - "emprunt de l'identité d'un utilisateur [Analysis Services]"
  - "emprunt d'identité [Analysis Services]"
  - "extensions DMX [Analysis Services], assemblys"
  - "DMX [Analysis Services], assemblys"
  - "fonctions définies par l'utilisateur [Analysis Services]"
  - "objets Analysis Services, assemblys"
  - "assemblys [Analysis Services]"
  - "domaines d'application [Analysis Services]"
