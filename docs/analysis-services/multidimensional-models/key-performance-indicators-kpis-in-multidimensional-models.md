...
ms.topic: "article"
helpviewer_keywords: 
  - "indicateurs de performance clés, visualisation"
  - "indicateurs de performance clés [Analysis Services]"
  - "Indicateurs de performance clés [Analysis Services]"
  - "objets OLAP [Analysis Services], indicateurs de performance"
  - "pondérations [Analysis Services]"
  - "affichage d'indicateurs de performance clés"
  - "Indicateurs de performance clés parents [Analysis Services]"
  - "Indicateurs de performance clés enfants"
...
---
# Indicateurs de performance cl&#233;s (KPI) dans les mod&#232;les multidimensionnels
...
## Extraction et affichage des KPI  
