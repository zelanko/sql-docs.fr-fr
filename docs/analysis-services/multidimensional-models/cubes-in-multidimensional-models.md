...
ms.topic: "article"
helpviewer_keywords: 
  - "objets OLAP [Analysis Services], cubes"
  - "cubes [Analysis Services], à propos des cubes"
...
|Hierarchies|[Créer des hiérarchies définies par l'utilisateur](../../analysis-services/multidimensional-models/create-user-defined-hierarchies.md)|  
