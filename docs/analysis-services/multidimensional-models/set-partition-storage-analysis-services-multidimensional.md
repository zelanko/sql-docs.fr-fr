...
helpviewer_keywords: 
  ...
  - "stockage standard [Analysis Services]"
  - "OLAP hybride"
  - "MOLAP automatique"
  - "OLAP relationnel"
  - "OLAP multidimensionnel"
  - "MOLAP planifié [Analysis Services]"
  - "partitions [Analysis Services], stockage"
  - "HOLAP"
  - "MOLAP"
  - "ROLAP en temps réel"
  - "HOLAP en temps réel"
...
---
# D&#233;finir un stockage de partitions (Analysis Services - Multidimensionnel)
...
## Instructions pour le choix d'un mode de stockage  
