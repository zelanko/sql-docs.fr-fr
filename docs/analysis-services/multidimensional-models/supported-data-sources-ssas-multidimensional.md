...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server Analysis Services, sources de données"
  - "sources de données [Analysis Services], à propos"
  - "Analysis Services, sources de données"
  - "connexions [Analysis Services]"
  - "SSAS, sources de données"
