...
helpviewer_keywords: 
  - "OrderBy (propriété)"
  - "dimensions [Analysis Services], organisation"
  - "améliorations de Business Intelligence [Analysis Services], organisation"
  - "dimensions [Analysis Services], améliorations de Business Intelligence"
  - "organisation des dimensions [Analysis Services]"
  - "OrderByAttributeID (propriété)"
...
manager: "erikre"
---
# D&#233;finir le classement d&#39;une dimension
...
## Spécification du classement  
 ...
 Dans la colonne **Attribut de classement** , vous pouvez modifier l'attribut utilisé pour effectuer le classement. Si l’attribut que vous voulez utiliser pour classer les membres ne se trouve pas dans la liste, faites défiler la liste vers le bas, puis sélectionnez **\<Nouvel attribut...>** pour ouvrir la boîte de dialogue **Sélectionner une colonne**, où vous pouvez sélectionner une colonne dans une table de dimension. En sélectionnant une colonne à l'aide de la boîte de dialogue **Sélectionner une colonne** , vous allez créer un attribut supplémentaire qui servira à classer les membres d'un attribut.  
