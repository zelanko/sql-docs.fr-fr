---
title: "Configuration requise et consid&#233;rations relatives au d&#233;ploiement d&#39;Analysis Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/16/2017"
...
helpviewer_keywords: 
  ...
  - "extensibilité [Analysis Services]"
  - "espace [Analysis Services]"
  - "déploiements Analysis Services, configuration requise"
  - "déploiement [Analysis Services], configuration requise"
  - "espace disque [Analysis Services]"
  - "spécifications [Analysis Services]"
  - "processeurs [Analysis Services]"
  - "spécifications [Analysis Services]"
  - "disponibilité [Analysis Services]"
