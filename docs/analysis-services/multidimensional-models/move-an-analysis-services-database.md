...
ms.topic: "article"
helpviewer_keywords: 
  - "déplacement de bases de données [Analysis Services]"
  - "déplacement de bases de données"
  - "opérations [Analysis Services - Données multidimensionnelles]"
...
## Voir aussi  
 ...
 [Élément StorageLocation](../../analysis-services/xmla/xml-elements-properties/dbstoragelocation-element.md)  
