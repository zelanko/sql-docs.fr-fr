...
ms.topic: "article"
helpviewer_keywords: 
  - "requêtes nommées [Analysis Services], création"
  - "modification des requêtes nommées"
  - "vues de sources de données [Analysis Services], requêtes nommées"
