---
title: Configurer les propriétés de projet Analysis Services (SSDT) | Microsoft Docs
ms.date: 05/02/2018
ms.prod: sql
...
|Générer / Version de serveur de déploiement|La version utilisée pour développer les projets|Indique la version du serveur sur lequel les projets seront déployés.|  
