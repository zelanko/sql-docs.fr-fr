...
ms.topic: "article"
helpviewer_keywords: 
  - "membres [Analysis Services], personnalisés"
  - "formules de cumul personnalisées [Analysis Services]"
  - "MDX [Analysis Services], formules de cumul personnalisées"
...
## Voir aussi  
 ...
 [Définir des formules de membre personnalisées pour les attributs d'une dimension](../../analysis-services/multidimensional-models/set-custom-member-formulas-for-attributes-in-a-dimension.md)  
