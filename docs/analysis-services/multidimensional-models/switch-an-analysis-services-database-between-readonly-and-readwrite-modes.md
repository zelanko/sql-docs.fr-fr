...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)][!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] les administrateurs de base de données peuvent modifier le mode de lecture/écriture d’une base de données tabulaire ou multidimensionnel dans le cadre d’une démarche plus vaste distribue une charge de travail de requête entre plusieurs serveurs de requêtes uniquement.  
