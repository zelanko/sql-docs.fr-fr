...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Objets dans Analysis Services Scripting Language (ASSL) suivent des recommandations spécifiques en ce qui concerne les groupes d’objets, l’héritage, d’affectation de noms, d’extension et le traitement.  
