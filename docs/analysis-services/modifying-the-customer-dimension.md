...
[Modification de la dimension Product](../analysis-services/modifying-the-product-dimension.md)  
...
[Supprimer un attribut d'une dimension](../analysis-services/multidimensional-models/remove-an-attribute-from-a-dimension.md)  
[Renommer un attribut](../analysis-services/multidimensional-models/rename-an-attribute.md)  
