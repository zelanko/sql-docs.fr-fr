...
Pour plus d’informations, consultez [Dimensions parent-enfant](../analysis-services/multidimensional-models/parent-child-dimensions.md) et [Attributs dans des hiérarchies de type parent-enfant](../analysis-services/multidimensional-models/attributes-in-parent-child-hierarchies.md).  
...
4.  Dans la deuxième ligne, la ligne **\***, tapez **Employee Level \*** dans la colonne **Name**, puis sélectionnez la troisième ligne.  
    ...
    ![Boîte de dialogue Modèle de nom de niveau](../analysis-services/media/l4-namingtemplate.gif "Boîte de dialogue Modèle de nom de niveau")  
...
5.  Faites glisser la hiérarchie **Employees** vers la zone Étiquettes de ligne.  
    ...
    ![Hiérarchie Employees modifiée](../analysis-services/media/l4-employee-2.png "Hiérarchie Employees modifiée")  
  
## Tâche suivante de la leçon  
[Regroupement automatique des membres d'attribut](../analysis-services/automatically-grouping-attribute-members.md)  
