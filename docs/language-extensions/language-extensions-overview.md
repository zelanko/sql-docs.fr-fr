...
titleSuffix: ''
description: Les extensions de langage sont une fonctionnalité de SQL Server utilisée pour l’exécution de code externe. Dans SQL Server 2019, Java, R et Python sont pris en charge. Les données relationnelles peuvent être utilisées dans le code externe avec le framework d’extensibilité.
author: dphansen
ms.author: davidph
ms.date: 08/19/2020
ms.topic: overview
...
+ **Utilisez [Azure Data Studio](../azure-data-studio/what-is.md) ou [SQL Server Management Studio](../ssms/sql-server-management-studio-ssms.md)** pour exécuter du code externe sur SQL Server.
...
+ Installer un [runtime personnalisé Python pour SQL Server](../machine-learning/install/custom-runtime-python.md)
+ Installer un [runtime personnalisé R pour SQL Server](../machine-learning/install/custom-runtime-r.md)
