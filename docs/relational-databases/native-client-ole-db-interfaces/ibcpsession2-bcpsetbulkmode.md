---
description: 'IBCPSession2 :: BCPSetBulkMode (fournisseur Native Client OLE DB)'
title: 'IBCPSession2 :: BCPSetBulkMode (fournisseur Native Client OLE DB) | Microsoft Docs'
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
...
ms.locfileid: "88475710"
---
# <a name="ibcpsession2bcpsetbulkmode-native-client-ole-db-provider"></a>IBCPSession2 :: BCPSetBulkMode (fournisseur Native Client OLE DB)
