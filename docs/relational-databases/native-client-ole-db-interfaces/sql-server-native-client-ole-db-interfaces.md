---
title: Référence SQL Server Native Client (OLE DB) | Documents Microsoft
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
[!INCLUDE[SNAC_Deprecated](../../includes/snac-deprecated.md)]
 ...
 Cela [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] fournisseur OLE DB Native Client référence de programmation ne documente pas la totalité des interfaces OLE DB et des méthodes, uniquement les interfaces et les méthodes qui présenter un comportement spécifique au fournisseur lors de l’utilisation du [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] OLE DB Native Client fournisseur.  
