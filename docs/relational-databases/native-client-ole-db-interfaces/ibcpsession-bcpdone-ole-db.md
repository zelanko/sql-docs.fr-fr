---
description: 'IBCPSession :: BCPDone (fournisseur Native Client OLE DB)'
title: 'IBCPSession :: BCPDone (fournisseur Native Client OLE DB) | Microsoft Docs'
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97464890"
---
# <a name="ibcpsessionbcpdone-native-client-ole-db-provider"></a>IBCPSession :: BCPDone (fournisseur Native Client OLE DB)
