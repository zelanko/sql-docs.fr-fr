...
ms.topic: "article"
helpviewer_keywords: 
  - "suivi des modifications [SQL Server], apporter des modifications"
  - "suivi des modifications [SQL Server], résolution des problèmes"
  - "mise à jour des données [SQL Server]"
  - "résolution des problèmes [SQL Server], suivi des modifications"
  - "modifications des données [SQL Server]"
  - "suivi des modifications de données [SQL Server]"
  - "données [SQL Server], modification"
  - "suivi des modifications [SQL Server], restauration des données"
  - "suivi des modifications [SQL Server], garantie de résultats cohérents"
  - "suivi des modifications [SQL Server], gestion des modifications"
...
---
# Utiliser le suivi des modifications (SQL Server)
...
#### Alternatives à l'utilisation du niveau d'isolement d'instantané  
