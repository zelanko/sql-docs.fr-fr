---
title: "Suivi des modifications de donn&#233;es (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "08/08/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "capture de données modifiées [SQL Server], comparaison avec le suivi des modifications"
  - "capture de données modifiées comparée au suivi des modifications"
  - "capture de données modifiées [SQL Server], comportements des types de données"
  - "Sync Services for ADO.NET"
  - "suivi des modifications [SQL Server], Sync Services for ADO.NET"
  - "suivi des modifications [SQL Server]"
  - "capture de données modifiées [SQL Server], sécurité"
  - "capture de données modifiées [SQL Server], et autres fonctionnalités SQL Server"
...
|Horodateur|Oui|Le type de données dans la table des modifications est converti en binaire.|  
...
-   Si une base de données est restaurée sur un autre serveur, par défaut, la capture de données modifiées est désactivée et toutes les métadonnées connexes sont supprimées.  
     ...
     Pour conserver la fonction de capture de données modifiées, utilisez l’option **KEEP_CDC** lors de la restauration de la base de données. Pour plus d'informations sur cette option, consultez [RESTORE](../Topic/RESTORE%20\(Transact-SQL\).md).  
...
## Voir aussi  
 ...
 [Vues de gestion dynamique liées à la capture des données modifiées &#40;Transact-SQL&#41;](../Topic/Change%20Data%20Capture%20Related%20Dynamic%20Management%20Views%20\(Transact-SQL\).md)  
