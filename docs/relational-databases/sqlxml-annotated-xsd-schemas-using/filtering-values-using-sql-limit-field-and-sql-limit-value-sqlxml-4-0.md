...
description: 'Découvrez comment utiliser les annotations SQL : Limit-Field et SQL : limit-value dans SQLXML 4,0 pour filtrer les données retournées par une requête sur la base d’une valeur de limitation.'
ms.date: 03/16/2017
ms.prod: sql
