...
description: Affichez une liste d’annotations XSD (SQLXML 4,0) introduite dans SQL Server 2005 (9. x), avec une comparaison avec les annotations XDR introduites dans SQL Server 2000 (8. x).
ms.date: 03/17/2017
ms.prod: sql
...
> [!NOTE]  
>  L’attribut **targetNamespace** natif XSD remplace l’annotation de l' **espace de noms cible** qui a été introduite dans le [!INCLUDE[ssVersion2000](../../includes/ssversion2000-md.md)] schéma de mappage XDR.  
