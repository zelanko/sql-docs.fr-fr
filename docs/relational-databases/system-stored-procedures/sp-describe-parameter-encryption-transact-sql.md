...
ms.locfileid: "37974494"
---
# <a name="spdescribeparameterencryption-transact-sql"></a>sp_describe_parameter_encryption (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2016-asdb-xxxx-xxx-md](../../includes/tsql-appliesto-ss2016-asdb-xxxx-xxx-md.md)]

  Analyse le texte spécifié [!INCLUDE[tsql](../../includes/tsql-md.md)] instruction et ses paramètres, afin de déterminer quels paramètres correspondent aux colonnes de base de données qui sont protégés à l’aide de la fonctionnalité Always Encrypted. Retourne les métadonnées de chiffrement pour les paramètres qui correspondent aux colonnes chiffrées.  
...
## <a name="arguments"></a>Arguments  
 ...
 [ @params =] 'N'parameters  
 *@params* Fournit une chaîne de déclaration pour les paramètres pour le lot Transact-SQL, qui est similaire à sp_executesql. Les paramètres peuvent être nvarchar (n) ou nvarchar (max).  
...
## <a name="return-value"></a>Valeur de retour  
 0 indique la réussite. Rien d’autre indiquer un échec.  
...
-   Le jeu décrivant la manière dont certains paramètres de résultats doivent être chiffrées. Ce jeu de résultats références les clés décrites dans le premier jeu de résultats.  
...
|**column_master_key_path**|**nvarchar(4000)**|Le chemin de clé de la clé principale de colonne, qui a été utilisée pour générer la valeur chiffrée de la clé de chiffrement de colonne.|  
