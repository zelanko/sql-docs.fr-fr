...
|**year**|La période de rétention est spécifiée en années.|  
 ...
 [  **@generation_leveling_threshold=** ] *generation_leveling_threshold*  
 Spécifie le nombre de modifications qui sont contenus dans une génération. Une génération est une collection de modifications remises à un serveur de publication ou à un Abonné. *generation_leveling_threshold* est **int**, avec une valeur par défaut de 1000.  
