...
### <a name="a-listing-all-locks"></a>R. Affichage de tous les verrous  
 L’exemple suivant affiche des informations sur tous les verrous actuellement détenus dans une [!INCLUDE[ssDE](../../includes/ssde-md.md)]instance du.  
