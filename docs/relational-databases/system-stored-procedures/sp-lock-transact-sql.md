...
## <a name="arguments"></a>Arguments  
 ...
 [  **@spid2 =** ] **'***session ID2***'**  
 Autre [!INCLUDE[ssDE](../../includes/ssde-md.md)] numéro d’ID de session du **sys.dm_exec_sessions** qui peut détenir un verrou en même temps que *session ID1* et sur lequel l’utilisateur souhaite également obtenir des informations. *session ID2* est **int** avec une valeur par défaut NULL.  
