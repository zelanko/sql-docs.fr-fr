...
## <a name="arguments"></a>Arguments  
 ...
 Type de l'Agent. *agent_type* est de **type int**, sans valeur par défaut, et peut prendre l’une des valeurs suivantes.  
