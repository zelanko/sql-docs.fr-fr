...
## <a name="examples"></a>Exemples  
 Cet exemple illustre l’utilisation de **sp_help_log_shipping_primary_database** pour récupérer les paramètres de base de [!INCLUDE[ssSampleDBobject](../../includes/sssampledbobject-md.md)]données primaire de la base de données.  
