...
ms.locfileid: "47810417"
---
# <a name="spdropalias-transact-sql"></a>sp_dropalias (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]

  **sp_dropalias** a été supprimé pour [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]. Pour la syntaxe, consultez [sp_dropalias (Transact-SQL)](sp-dropalias-transact-sql.md) dans la documentation antérieure.  
