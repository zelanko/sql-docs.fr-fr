...
4.  Exécutez **sp_reinitmergepullsubscription** sur tous les abonnés à l’aide d’abonnement par extraction nommé ou anonyme pour garantir la convergence des données.  
...
-   Désactiver la publication avec **sp_changemergepublication** pour vous assurer que les fusions en mode continu sollicitant l’état de publication.  
