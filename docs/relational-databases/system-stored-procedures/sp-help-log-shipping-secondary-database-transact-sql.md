...
## <a name="remarks"></a>Notes  
 Si vous incluez le *secondary_database* paramètre, le jeu de résultats contient des informations sur cette base de données secondaire ; si vous incluez le *secondary_id* paramètre, le jeu de résultats contiendra plus d’informations sur toutes les bases de données secondaires associées à cet identificateur secondaire.  
