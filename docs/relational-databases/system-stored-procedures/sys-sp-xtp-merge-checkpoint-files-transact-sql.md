...
||  
|-|  
|**Remarque**: cette procédure stockée est déconseillée dans [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)]. Il n’est plus nécessaire et ne peut pas être utilisé, [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)]à partir de.|  
