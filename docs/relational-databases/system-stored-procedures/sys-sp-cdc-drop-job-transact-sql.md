...
## <a name="arguments"></a>Arguments  
 [ @job_type **=** ] '*job_type*'  
 Type du travail à supprimer. *job_type* est de type **nvarchar (20)** et ne peut pas être null. Les entrées valides sont 'capture' et 'cleanup'.  
