...
|**7**|Tous|  
 ...
 [  **@event_description_keyword =**] **'***motclé_description_événement***'**  
 ...
 [  **@count_reset_date =**] *date_réinitialisation_compte*  
 ...
 [  **@last_occurrence_date =**] *date_dernière_occurrence*  
 ...
 [  **@last_response_date =**] *date_dernière_réponse*  
