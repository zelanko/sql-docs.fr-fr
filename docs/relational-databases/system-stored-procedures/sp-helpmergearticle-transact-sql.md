...
|**pre_creation_command**|**tinyint**|Méthode de précréation, qui peut être l'une des suivantes :<br /><br /> **0** = none<br /><br /> **1** = drop<br /><br /> **2** = delete<br /><br /> **3** = truncate|  
...
|**column_tracking**|**Int**|Paramètre pour le suivi au niveau des colonnes ; où **1** signifie que le suivi au niveau colonne est activé, et **0** signifie que le suivi au niveau de la colonne est désactivée.|  
