---
title: Magasin de requêtes procédures stockées (Transact-SQL) | Documents Microsoft
ms.custom: ''
ms.date: 03/29/2016
ms.prod: sql
...
ms.locfileid: "33238100"
---
# <a name="query-store-stored-procedures-transact-sql"></a>Magasin de requêtes procédures stockées (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2016-asdb-xxxx-xxx-md](../../includes/tsql-appliesto-ss2016-asdb-xxxx-xxx-md.md)]

  Cette section contient les procédures stockées suivantes permettent de configurer le magasin de requêtes.  
