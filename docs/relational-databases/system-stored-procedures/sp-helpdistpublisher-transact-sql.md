...
`[ @publisher = ] 'publisher'` Est le serveur de publication pour lequel les propriétés sont retournées. *serveur de publication* est **sysname**, avec une valeur par défaut **%** .  
