...
## <a name="arguments"></a>Arguments  
 ...
 Pour savoir quel type d’agent cela *profile_id* représente, recherchez le *profile_id* dans le [MSagent_profiles &#40; Transact-SQL &#41; ](../../relational-databases/system-tables/msagent-profiles-transact-sql.md) table et notez la *agent_type* valeur du champ. Les valeurs sont les suivantes :  
