...
## <a name="arguments"></a>Arguments  
 [ **@publisher** =] **'***publisher***'**  
 Nom du serveur de publication dont l'état fait l'objet d'une surveillance. *serveur de publication* est **sysname**, avec NULL comme valeur par défaut. Si **null**, informations sont retournées pour tous les éditeurs qui utilisent le serveur de distribution.  
...
|**sous-type**|**Int**|Type d'abonnement, qui peut prendre l'une des valeurs suivantes :<br /><br /> **0** = push<br /><br /> **1** = par extraction<br /><br /> **2** = anonyme|  
