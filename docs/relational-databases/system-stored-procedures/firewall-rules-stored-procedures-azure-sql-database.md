---
title: Règles de pare-feu de procédures (base de données SQL Azure) | Documents Microsoft
ms.custom: ''
ms.date: 07/28/2016
ms.prod: ''
...
---
# <a name="firewall-rules-stored-procedures-azure-sql-database"></a>Règles de pare-feu de procédures (base de données SQL Azure)
[!INCLUDE[tsql-appliesto-xxxxxx-asdb-asdw-xxx-md](../../includes/tsql-appliesto-xxxxxx-asdb-asdw-xxx-md.md)]

  Cette section contient les procédures stockées suivantes qui définissent ou suppriment les règles de pare-feu. [!INCLUDE[tsql_md](../../includes/tsql-md.md)] règles de pare-feu peuvent être utilisées avec [!INCLUDE[ssSDS_md](../../includes/sssds-md.md)] et [!INCLUDE[ssSDW_md](../../includes/sssdw-md.md)]. Pour plus d’informations, consultez [règles de pare-feu de base de données SQL Azure configurer - vue d’ensemble](https://azure.microsoft.com/documentation/articles/sql-database-firewall-configure/).
