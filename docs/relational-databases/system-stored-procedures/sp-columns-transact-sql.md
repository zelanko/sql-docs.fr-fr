...
|**RADICAL**|**smallint**|Base pour les types de données numériques.|  
...
|**POSITION ORDINALE**|**int**|Numéro d'ordre de la colonne dans l'objet. La première colonne de l'objet est la colonne 1. Cette colonne renvoie toujours une valeur.|  
