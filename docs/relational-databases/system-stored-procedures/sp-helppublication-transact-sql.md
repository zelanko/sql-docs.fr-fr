...
## <a name="permissions"></a>Autorisations  
 ...
 Pour un [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Publisher, seuls les membres du rôle sysadmin fixe rôle serveur sur le serveur de distribution ou les membres du rôle de base de données fixe db_owner sur la base de données de distribution ou les utilisateurs dans la PAL peuvent exécuter sp_helppublication.  
