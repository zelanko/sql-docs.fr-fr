...
## <a name="remarks"></a>Notes  
 ...
 Pour démarrer Database Mail, utilisez **sysmail_start_sp**. Notez que **sp_send_dbmail** accepte toujours le courrier lorsque [!INCLUDE[ssSB](../../includes/sssb-md.md)] les objets sont arrêtés.  
