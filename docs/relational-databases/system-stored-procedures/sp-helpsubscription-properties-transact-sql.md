...
`[ @publication_type = ] publication_type`Type de publication. *publication_type* est de **type int**, avec NULL comme valeur par défaut. S’il est fourni, *publication_type* doit avoir l’une des valeurs suivantes:  
...
|**publisher_security_mode**|**int**|Mode de sécurité utilisé sur le serveur de publication.<br /><br /> **0**  =  authentification[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]<br /><br /> **1** = authentification Windows|  
...
|**distributor_security_mode**|**Int**|Mode de sécurité utilisé sur le serveur de distribution.<br /><br /> **0**  =  authentification[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]<br /><br /> **1** = authentification Windows|  
