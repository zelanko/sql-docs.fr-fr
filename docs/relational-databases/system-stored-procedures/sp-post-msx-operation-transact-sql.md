...
`[ @value = ] value`Intervalle d’interrogation, en secondes. la *valeur* est de **type int**, avec NULL comme valeur par défaut. Spécifiez ce paramètre uniquement si l' *opération* est **Set-Poll**.  
