...
`[ @publication = ] 'publication'` Est la publication pour laquelle actualiser les abonnements. *publication* est **sysname**, sans valeur par défaut.  
