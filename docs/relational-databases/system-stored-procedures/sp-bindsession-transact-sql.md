 ...
 **'** *bind_token* **'**  
 Est le jeton qui identifie la transaction obtenu à l’origine à l’aide de **sp_getbindtoken** ou Open Data Services **srv_getbindtoken** (fonction). *bind_token*is **varchar(255)**.  
