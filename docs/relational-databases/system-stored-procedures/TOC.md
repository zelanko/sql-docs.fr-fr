...
## [Sauvegarde instantanée - sp_delete_backup_file_snapshot](snapshot-backup-sp-delete-backup-file-snapshot.md)  
## [Sauvegarde instantanée - sp_delete_backup](snapshot-backup-sp-delete-backup.md)  
# PolyBase
...
# [Règles de pare-feu (Azure SQL Database)](firewall-rules-stored-procedures-azure-sql-database.md)  
...
# [Recherche en texte intégral et recherche sémantique](full-text-search-and-semantic-search-stored-procedures-transact-sql.md)  
...
## [Syntaxe de la hiérarchie d’objets](object-hierarchy-syntax-transact-sql.md)  
...
# [Gestion basée sur des stratégies](policy-based-management-stored-procedures-transact-sql.md)  
...
# [Étendues (Stretch Database)](stretch-database-extended-stored-procedures-transact-sql.md)  
