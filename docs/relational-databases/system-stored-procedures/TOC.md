# [Vue d’ensemble](system-stored-procedures-transact-sql.md)  
# [Index spatiaux](spatial-index-stored-procedures-arguments-and-properties.md)  
...
# Tables temporelles
## [Table temporelle - sys.sp_cleanup_temporal_history](temporal-table-sys-sp-cleanup-temporal-history.md)  
## [Table temporelle - sp_xtp_flush_temporal_history](temporal-table-sp-xtp-flush-temporal-history.md)  
# Sauvegarde d’instantanés
## [Sauvegarde d’instantanés - sp_delete_backup_file_snapshot](snapshot-backup-sp-delete-backup-file-snapshot.md)  
## [Sauvegarde d’instantanés - sp_delete_backup](snapshot-backup-sp-delete-backup.md)  
# PolyBase
## [Procédures stockées PolyBase - sp_polybase_join_group](polybase-stored-procedures-sp-polybase-join-group.md)  
## [Procédures stockées PolyBase - sp_polybase_leave_group](polybase-stored-procedures-sp-polybase-leave-group.md)  
# FileStream et Filetable
## [FileStream et FileTable - sp_filestream_force_garbage_collection](filestream-and-filetable-sp-filestream-force-garbage-collection.md)  
## [FileStream et FileTable - sp_kill_filestream_non_transacted_handles](filestream-and-filetable-sp-kill-filestream-non-transacted-handles.md)  
# Géoréplication active
## [sp_wait_for_database_copy_sync](active-geo-replication-sp-wait-for-database-copy-sync.md)  
# [Catalogue](catalog-stored-procedures-transact-sql.md)  
...
# [Capture de données modifiées](change-data-capture-stored-procedures-transact-sql.md)  
...
# [Curseur](cursor-stored-procedures-transact-sql.md)  
...
# [Collecteur de données](data-collector-stored-procedures-transact-sql.md)  
...
# [Moteur de base de données](database-engine-stored-procedures-transact-sql.md)  
...
## [sp_execute_remote (de base de données SQL Azure)](sp-execute-remote-azure-sql-database.md)  
...
# [Messagerie de base de données](database-mail-stored-procedures-transact-sql.md)  
...
# [Plan de Maintenance de base de données](database-maintenance-plan-stored-procedures-transact-sql.md)  
...
# [Requêtes distribuées](distributed-queries-stored-procedures-transact-sql.md)  
...
# [Règles de pare-feu (base de données SQL Azure)](firewall-rules-stored-procedures-azure-sql-database.md)  
## [sp_set_firewall_rule (base de données de SQL Azure)](sp-set-firewall-rule-azure-sql-database.md)  
## [sp_set_database_firewall_rule (base de données de SQL Azure)](sp-set-database-firewall-rule-azure-sql-database.md)  
## [sp_delete_firewall_rule (base de données de SQL Azure)](sp-delete-firewall-rule-azure-sql-database.md)  
## [sp_delete_database_firewall_rule (base de données de SQL Azure)](sp-delete-database-firewall-rule-azure-sql-database.md)  
# [Recherche en texte intégral et la recherche sémantique](full-text-search-and-semantic-search-stored-procedures-transact-sql.md)  
...
# [Étendues générales](general-extended-stored-procedures-transact-sql.md)  
...
# [Copie des journaux de transaction](log-shipping-stored-procedures-transact-sql.md)  
...
## [procédure sp_upgrade_log_shipping](sp-upgrade-log-shipping-transact-sql.md)  
# [Gestion de sauvegarde](managed-backup-stored-procedures-transact-sql.md)  
...
# [Entrepôt de données de gestion](management-data-warehouse-stored-procedures-transact-sql.md)  
...
## [Syntaxe de hiérarchie d’objet](object-hierarchy-syntax-transact-sql.md)  
...
# [Gestion basée sur la stratégie](policy-based-management-stored-procedures-transact-sql.md)  
...
# [Magasin de requêtes](query-store-stored-procedures-transact-sql.md)  
...
# [Sécurité](security-stored-procedures-transact-sql.md)  
...
## [la procédure sp_dropalias](sp-dropalias-transact-sql.md)  
...
# [Entrepôt de données SQL](sql-data-warehouse-stored-procedures.md)  
...
## [sp_pdw_database_encryption pour](sp-pdw-database-encryption-sql-data-warehouse.md)  
...
# [Agent SQL Server](sql-server-agent-stored-procedures-transact-sql.md)  
...
## [__sp_help_downloadlist](sp-help-downloadlist-transact-sql.md)  
...
# [Étendue de base de données Stretch](stretch-database-extended-stored-procedures-transact-sql.md)  
...
## [aide de sp_xml_removedocument](sp-xml-removedocument-transact-sql.md)  
## [sp_db_selective_xml_index](sp-db-selective-xml-index-transact-sql.md)  
# [Réplication](replication-stored-procedures-transact-sql.md)  
...
## [sp_addpullsubscription_agent](sp-addpushsubscription-agent-transact-sql.md)  
...
## [procédure sp_dropmergealternatepublisher](sp-dropmergealternatepublisher-transact-sql.md)  
## [sp_dropmergearticle](sp-dropmergearticle-transact-sql.md)  
## [sp_dropmergefilter](sp-dropmergefilter-transact-sql.md)  
## [sp_dropmergepublication](sp-dropmergepartition-transact-sql.md)  
