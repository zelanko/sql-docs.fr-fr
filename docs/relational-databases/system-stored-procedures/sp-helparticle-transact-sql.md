...
|**status**|**tinyint**|Peut être le [& (Bitwise AND)](../../t-sql/language-elements/bitwise-and-transact-sql.md) résultat d’une ou plusieurs ou ces propriétés de l’article :<br /><br /> **0 x 00** = [!INCLUDE[ssInternalOnly](../../includes/ssinternalonly-md.md)]<br /><br /> **0 x 01** = article est actif.<br /><br /> **0 x 08** = inclut le nom de colonne dans les instructions insert.<br /><br /> **0 x 16** = utilise des instructions paramétré.<br /><br /> **0 x 32** = utilise des instructions paramétré et inclure le nom de colonne dans les instructions insert.|  
