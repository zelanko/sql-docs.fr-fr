...
## <a name="arguments"></a>Arguments  
 [  **@publisher=** ] **'***publisher***'**  
 Est le nom de non - [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] serveur de publication. *publication* est **sysname**, avec NULL comme valeur par défaut. Ne spécifiez pas ce paramètre pour un serveur de publication [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
