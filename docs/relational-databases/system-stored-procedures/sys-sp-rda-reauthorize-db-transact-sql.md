...
description: Découvrez comment utiliser sys. sp_rda_reauthorize_db pour restaurer la connexion authentifiée entre une base de données Stretch locale et une base de données distante.
ms.custom: ''
ms.date: 06/10/2016
ms.prod: sql
ms.reviewer: ''
