...
`[ @original_publisher = ] 'original_publisher'` Le nom de l’instance de SQL Server qui a publié à l’origine de la base de données. *original_publisher* est **sysname**, sans valeur par défaut.
