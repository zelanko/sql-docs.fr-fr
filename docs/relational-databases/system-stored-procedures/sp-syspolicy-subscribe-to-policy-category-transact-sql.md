...
`[ @policy_category = ] 'policy_category'` Est le nom de catégorie de stratégie que vous souhaitez vous abonner à la base de données. *policy_category* est **sysname**et est requis.  
