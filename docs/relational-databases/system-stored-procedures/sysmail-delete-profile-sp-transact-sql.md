...
## <a name="arguments"></a>Arguments  
 ...
 Nom du profil à supprimer. *nom_profil* est **sysname**, avec NULL comme valeur par défaut. Soit *profile_id* ou *profile_name* doit être spécifié.  
