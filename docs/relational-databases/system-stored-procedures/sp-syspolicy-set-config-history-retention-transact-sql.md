...
`[ @value = ] value` Est le nombre de jours pendant lesquels conserver l’historique de gestion basée sur des stratégies. *valeur* est **sqlvariant**.  
...
## <a name="remarks"></a>Notes  
 ...
 Si *valeur* est définie sur 0, l’historique n’est pas être automatiquement supprimé.  
