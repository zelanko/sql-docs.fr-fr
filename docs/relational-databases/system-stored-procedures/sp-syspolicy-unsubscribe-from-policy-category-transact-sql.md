...
`[ @policy_category = ] 'policy_category'` Est le nom de l’abonnement aux catégories de stratégie que vous souhaitez supprimer. *policy_category* est **sysname**et est requis.  
