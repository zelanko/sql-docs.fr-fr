...
`[ @value = ] value` Détermine si les évaluations de stratégies réussies sont consignées. *valeur* est **sqlvariant**, et peut prendre l’une des valeurs suivantes :  
...
## <a name="remarks"></a>Notes  
 ...
 Lorsque *valeur* est définie sur 0 ou 'false', uniquement des évaluations de stratégies sont consignées.  
