---
title: sp_syspolicy_set_log_on_success (Transact-SQL) | Documents Microsoft
ms.custom: ''
ms.date: 08/09/2016
ms.prod: sql
...
ms.locfileid: "33255269"
---
# <a name="spsyspolicysetlogonsuccess-transact-sql"></a>sp_syspolicy_set_log_on_success (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]

  Indique si des évaluations de stratégies réussies sont consignées dans le journal Historique de la stratégie pour la Gestion basée sur des stratégies.  
