 ...
 **sp_markpendingschemachange** est une procédure stockée conçue pour la prise en charge de la réplication de fusion et doit être utilisée uniquement lorsque les autres actions correctives, telles que la réinitialisation, ont échoué corriger la situation ou sont trop coûteuses en termes de performances.  
