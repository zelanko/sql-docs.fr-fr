...
|**Type**|**int**|Identifie la classe d'objets auditée.|  
...
|**minor_id**|**Tiers**|ID secondaire de l'objet audité, interprété d'après la classe, telle que l'ID de colonne d'une action d'audit de table.|  
