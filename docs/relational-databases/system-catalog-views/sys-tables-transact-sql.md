...
|is_filetable|**bit**|**S’applique à**: [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] et versions [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)]ultérieures et.<br /><br /> 1 = La table est un FileTable.<br /><br /> Pour plus d’informations sur les FileTables, consultez [FileTables &#40;SQL Server&#41;](../../relational-databases/blob/filetables-sql-server.md).|  
|durabilité|**tinyint**|**S’applique à**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] et versions [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)]ultérieures et.<br /><br /> Les valeurs possibles sont les suivantes :<br /><br /> 0 = SCHEMA_AND_DATA<br /><br /> 1 = SCHEMA_ONLY<br /><br /> La valeur 0 est la valeur par défaut.|  
|durability_desc|**nvarchar (60)**|**S’applique à**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] et versions [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)]ultérieures et.<br /><br /> Les valeurs possibles sont les suivantes :<br /><br /> SCHEMA_ONLY<br /><br /> SCHEMA_AND_DATA<br /><br /> La valeur de SCHEMA_AND_DATA indique que la table est une table en mémoire durable. SCHEMA_AND_DATA est la valeur par défaut des tables optimisées en mémoire. La valeur de SCHEMA_ONLY indique que les données de la table ne seront pas conservées lors du redémarrage de la base de données contenant des objets optimisés en mémoire.|  
|is_memory_optimized|**bit**|**S’applique à**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] et versions [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)]ultérieures et.<br /><br /> Les valeurs possibles sont les suivantes :<br /><br /> 0 = Non optimisé en mémoire.<br /><br /> 1 = optimisé en mémoire.<br /><br /> La valeur 0 est la valeur par défaut.<br /><br /> Les tables optimisées en mémoire sont des tables utilisateur en mémoire dont le schéma est rendu persistant sur le disque, de la même façon que les autres tables utilisateur. Les tables optimisées en mémoire sont accessibles à partir des procédures stockées compilées en mode natif.|  
|temporal_type|**tinyint**|**S’applique à**: [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] et versions [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)]ultérieures et.<br /><br /> Valeur numérique représentant le type de table :<br /><br /> 0 = NON_TEMPORAL_TABLE<br /><br /> 1 = HISTORY_TABLE<br /><br /> 2 = SYSTEM_VERSIONED_TEMPORAL_TABLE|  
|temporal_type_desc|**nvarchar (60)**|**S’applique à**: [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] et versions [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)]ultérieures et.<br /><br /> Description textuelle du type de table :<br /><br /> NON_TEMPORAL_TABLE<br /><br /> HISTORY_TABLE<br /><br /> SYSTEM_VERSIONED_TEMPORAL_TABLE|  
|history_table_id|**int**|**S’applique à**: [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] et versions [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)]ultérieures et.<br /><br /> Lorsque temporal_type dans (2, 4) retourne object_id de la table qui conserve les données d’historique, sinon retourne la valeur NULL.|  
...
|is_node|**bit**|**S’applique à** [!INCLUDE[sssql17-md.md](../../includes/sssql17-md.md)] : [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)]et. <br/><br/>1 = il s’agit d’une table de nœuds de graphique. <br /><br />0 = il ne s’agit pas d’une table de nœud graphique. |  
|is_edge|**bit**|**S’applique à** [!INCLUDE[sssql17-md.md](../../includes/sssql17-md.md)] : [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)]et. <br/><br/>1 = il s’agit d’une table de bord du graphique. <br /><br />0 = il ne s’agit pas d’une table de bord de graphique. |  
...
**S’applique à**: [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] et versions [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)]ultérieures et.
