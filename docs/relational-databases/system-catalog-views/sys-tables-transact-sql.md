...
|temporal_type|**tinyint**|**S’applique à** : [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] à [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] et [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)].<br /><br /> La valeur numérique représentant le type de table :<br /><br /> 0 = NON_TEMPORAL_TABLE<br /><br /> 1 = HISTORY_TABLE<br /><br /> 2 = SYSTEM_VERSIONED_TEMPORAL_TABLE|  
|temporal_type_desc|**nvarchar(60)**|**S’applique à** : [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] à [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] et [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)].<br /><br /> La description textuelle du type de table :<br /><br /> NON_TEMPORAL_TABLE<br /><br /> HISTORY_TABLE<br /><br /> SYSTEM_VERSIONED_TEMPORAL_TABLE|  
|history_table_id|**int**|**S’applique à** : [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] à [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] et [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)].<br /><br /> Lorsque temporal_type IN (2, 4) object_id retourne de la table qui conserve des données historiques, sinon retourne la valeur NULL.|  
...
|history_retention_period_unit|**int**|**S'applique à**: [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)]. <br/><br/>La valeur numérique représentant le type d’unité de période de rétention historique temporelle. <br /><br />-1 : INFINI <br /><br />3 : DAY <br /><br />4 : WEEK <br /><br />5 : MONTH <br /><br />6 : YEAR |  
...
L’exemple suivant montre les données temporelles étroitesse peuvent être exposées.  
