...
|**property_int_id**|**int**|L'entier qui identifie cette propriété de recherche dans le jeu de propriétés. **paramètre property_int_id** est unique dans le jeu de propriétés.|  
