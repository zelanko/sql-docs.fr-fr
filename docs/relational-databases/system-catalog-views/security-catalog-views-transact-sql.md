---
description: Affichages catalogue liées à la sécurité (Transact-SQL)
title: Affichages catalogue de sécurité (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 02/27/2017
ms.prod: sql
