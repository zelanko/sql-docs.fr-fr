---
title: Groupes de disponibilité Always On catalogue vues (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "47627477"
---
# <a name="always-on-availability-groups-catalog-views-transact-sql"></a>Groupes de disponibilité Always On affichages catalogue (Transact-SQL)
...
> [!NOTE]  
>  Pour plus d’informations sur les bases de données de disponibilité joints, consultez le **replica_id** et **group_database_id** colonnes dans [sys.databases (Transact-SQL) ;](../../relational-databases/system-catalog-views/sys-databases-transact-sql.md).  
