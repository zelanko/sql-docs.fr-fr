# [Vue d’ensemble](catalog-views-transact-sql.md)
...
# [Propriétés étendues - sys.extended_properties](extended-properties-catalog-views-sys-extended-properties.md)  
...
## [Témoin de mise en miroir de bases de données - sys.database_mirroring_witnesses](database-mirroring-witness-catalog-views-sys-database-mirroring-witnesses.md)  

# Applications de la couche Données
## [Vues de l’application de la couche Données - dbo.sysdac_instance](data-tier-application-views-dbo-sysdac-instances.md)  
...
# [Collecteur de données](data-collector-views-transact-sql.md)  
...
## [sysmail_sentitems](sysmail-unsentitems-transact-sql.md)  

# [Bases de données et fichiers](databases-and-files-catalog-views-transact-sql.md)  
...
# [Recherche en texte intégral et recherche sémantique](full-text-search-and-semantic-search-catalog-views-transact-sql.md)  
...
# [Vues de la gestion basée sur des stratégies](policy-based-management-views-transact-sql.md)  
...
# [Types scalaires](scalar-types-catalog-views-transact-sql.md)  
...
# [Configuration à l’échelle du serveur](server-wide-configuration-catalog-views-transact-sql.md)  
...
# [Schémas XML (système de type XML)](xml-schemas-xml-type-system-catalog-views-transact-sql.md)  
