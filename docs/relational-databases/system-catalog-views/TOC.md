...
# [Bases de données et des fichiers](databases-and-files-catalog-views-transact-sql.md)  
...
## [Sys.database_event_sessions (de base de données SQL Azure)](sys-database-event-sessions-azure-sql-database.md)  
