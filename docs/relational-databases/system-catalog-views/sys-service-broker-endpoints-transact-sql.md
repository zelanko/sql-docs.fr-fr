...
|**encryption_algorithm**|**tinyint**|Algorithme de chiffrement. Voici les valeurs possibles avec leurs descriptions et les options de DDL correspondantes.<br /><br /> **0** : AUCUN. Option DDL correspondante : désactivé.<br /><br /> **1** : RC4. Option DDL correspondante : {requis &#124; Required algorithm RC4}.<br /><br /> **2** : AES. Option DDL correspondante : requises algorithme AES.<br /><br /> **3** : NONE, RC4. Option DDL correspondante : {pris en charge &#124; pris en charge algorithme RC4}.<br /><br /> **4** : AUCUN, AES. Option DDL correspondante : prise en charge d’algorithme AES.<br /><br /> **5** : RC4, AES. Option DDL correspondante : requises algorithme RC4 AES.<br /><br /> **6** : AES, RC4. Option DDL correspondante : requises algorithme AES RC4.<br /><br /> **7** : NONE, RC4, AES. Option DDL correspondante : prise en charge d’algorithme RC4 AES.<br /><br /> **8** : AUCUN, AES, RC4. Option DDL correspondante : prise en charge d’algorithme AES RC4.<br /><br /> Cette colonne n'accepte pas la valeur NULL.|  
|**encryption_algorithm_desc**|**nvarchar(60)**|Description d’algorithme de chiffrement. Les valeurs possibles et leurs options correspondantes de la DDL sont répertoriées ci-dessous :<br /><br /> NONE : désactivé<br /><br /> RC4 : {requis &#124; requis algorithme RC4}<br /><br /> AES : Algorithme AES obligatoire<br /><br /> NONE, RC4 : {pris en charge &#124; pris en charge d’algorithme RC4}<br /><br /> Aucun, AES : Algorithme AES pris en charge<br /><br /> RC4, AES : Requise algorithme RC4 AES<br /><br /> AES, RC4 : Algorithme AES RC4 obligatoire<br /><br /> NONE, RC4, AES : Prise en charge l’algorithme RC4 AES<br /><br /> Aucun, AES, RC4 : Prise en charge l’algorithme AES RC4<br /><br /> Accepte la valeur NULL.|  
