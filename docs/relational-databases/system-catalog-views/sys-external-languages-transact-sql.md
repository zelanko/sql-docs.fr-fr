...
Cet affichage catalogue fournit une liste des langues dans la base de données externes. **R** et **Python** sont des noms réservés et aucun langage externe ne peut être créé avec ces noms.
...
|langue |sysname |Nom du langage externe. Unique dans la base de données. R et Python sont des noms réservés par instance|
