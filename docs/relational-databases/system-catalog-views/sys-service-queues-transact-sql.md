...
|**is_poison_message_handling_enabled**|**bit**|**S'applique à**: [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] et [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].<br /><br /> 1 = la gestion des messages incohérents est activée.|  
