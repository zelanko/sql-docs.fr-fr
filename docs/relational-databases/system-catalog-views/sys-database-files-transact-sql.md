...
|**entrer**|**tinyint**|Type de fichier :<br/><br /> 0 = lignes<br /><br/> 1 = journal<br/><br /> 2 = FILESTREAM<br /><br /> 3 =[!INCLUDE[ssInternalOnly](../../includes/ssinternalonly-md.md)]<br /><br /> 4 = texte intégral|  
...
|**nomme**|**sysname**|Nom logique du fichier dans la base de données.|  
...
|**Département**|**tinyint**|État du fichier :<br /><br /> 0 = ONLINE<br /><br /> 1 = RESTORING<br /><br /> 2 = RECOVERING<br /><br /> 3 = RECOVERY_PENDING<br /><br /> 4 = SUSPECT<br /><br /> 5 = [!INCLUDE[ssInternalOnly](../../includes/ssinternalonly-md.md)]<br /><br /> 6 = OFFLINE<br /><br /> 7 = DEFUNCT|  
...
|**create_lsn**|**numérique (25, 0)**|Numéro séquentiel dans le journal (LSN) auquel le fichier a été créé.|  
|**drop_lsn**|**numérique (25, 0)**|LSN auquel le fichier a été supprimé.<br /><br /> 0 = Le nom de fichier n'est pas disponible pour réutilisation.|  
|**read_only_lsn**|**numérique (25, 0)**|LSN auquel le groupe de fichiers qui contient le fichier est passé de l'état lecture/écriture à l'état lecture seule (changement le plus récent).|  
|**read_write_lsn**|**numérique (25, 0)**|LSN auquel le groupe de fichiers qui contient le fichier est passé de l'état lecture seule à l'état lecture/écriture (changement le plus récent).|  
|**differential_base_lsn**|**numérique (25, 0)**|Base des sauvegardes différentielles. Les étendues de données modifiées après ce LSN sont incluses dans une sauvegarde différentielle.|  
...
|**redo_start_lsn**|**numérique (25, 0)**|LSN auquel doit démarrer la restauration par progression suivante.<br /><br /> A pour valeur NULL sauf si state a pour valeur RESTORING ou RECOVERY_PENDING.|  
...
|**redo_target_lsn**|**numérique (25, 0)**|LSN auquel peut s'arrêter la restauration par progression en ligne sur ce fichier.<br /><br /> A pour valeur NULL sauf si state a pour valeur RESTORING ou RECOVERY_PENDING.|  
...
|**backup_lsn**|**numérique (25, 0)**|LSN de la sauvegarde de données ou différentielle du fichier la plus récente.|  
