---
description: Vues de catalogue des types scalaires (Transact-SQL)
title: Affichages catalogue des types scalaires (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
...
ms.locfileid: "89545052"
---
# <a name="scalar-types-catalog-views-transact-sql"></a>Vues de catalogue des types scalaires (Transact-SQL)
