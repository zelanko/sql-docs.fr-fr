...
|-----------------|---------------|-----------------|  
|**type**|**tiers**|Identifie la classe de l’élément sur lequel la classification existe. Aura toujours la valeur 1 (représentant une colonne)|  
...
|**major_id**|**tiers**|Représente l’ID de la table contenant la colonne classifiée, correspondant à sys. all_objects. object_id|  
|**minor_id**|**tiers**|Représente l’ID de la colonne sur laquelle la classification existe, correspondant à sys. all_columns. column_id|   
|**noms**|**sysname**|Étiquette (lisible) affectée à la classification de sensibilité|  
...
|**rank**|**tiers**|Valeur numérique du rang : <br><br>0 pour aucun<br>10 pour faible<br>20 pour moyen<br>30 pour la haute<br>40 pour critique| 
