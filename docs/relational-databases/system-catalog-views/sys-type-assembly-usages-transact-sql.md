...
|-----------------|---------------|-----------------|  
|**user_type_id**|**Int**|ID du type<br /><br /> Pour retourner le nom du type, joindre à la [sys.types](../../relational-databases/system-catalog-views/sys-types-transact-sql.md) vue sur cette colonne de catalogue.|  
