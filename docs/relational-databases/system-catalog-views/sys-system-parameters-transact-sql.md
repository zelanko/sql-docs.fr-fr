...
|**valeur par défaut**|**sql_variant**|Si **has_default_value** est 1, la valeur de cette colonne est la valeur de la valeur par défaut pour le paramètre ; sinon, NULL.|  
