...
|**avg_log_bytes_used**|**float**|Nombre moyen d’octets dans le journal de base de données utilisé par le plan de requête, dans l’intervalle d’agrégation. S’applique **uniquement à la base de données SQL Azure**.<br/>**Remarque :** Azure SQL Data Warehouse retourne toujours zéro (0).|
|**last_log_bytes_used**|**bigint**|Nombre d’octets dans le journal de base de données utilisée par la dernière exécution du plan de requête, dans l’intervalle d’agrégation. S’applique **uniquement à la base de données SQL Azure**.<br/>**Remarque :** Azure SQL Data Warehouse retourne toujours zéro (0).|
|**min_log_bytes_used**|**bigint**|Nombre minimal d’octets dans le journal de base de données utilisé par le plan de requête, dans l’intervalle d’agrégation.  S’applique **uniquement à la base de données SQL Azure**.<br/>**Remarque :** Azure SQL Data Warehouse retourne toujours zéro (0).|
|**max_log_bytes_used**|**bigint**|Nombre maximal d’octets dans le journal de base de données utilisé par le plan de requête, dans l’intervalle d’agrégation.  S’applique **uniquement à la base de données SQL Azure**.<br/>**Remarque :** Azure SQL Data Warehouse retourne toujours zéro (0).|
|**stdev_log_bytes_used**|**float**|Écart type du nombre d’octets dans le journal de base de données utilisé par un plan de requête, au sein de l’intervalle d’agrégation.  S’applique **uniquement à la base de données SQL Azure**.<br/>**Remarque :** Azure SQL Data Warehouse retourne toujours zéro (0).|
