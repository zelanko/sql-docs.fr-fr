---
title: Affichages catalogue de la SQL Data Warehouse et des Data Warehouse parallèles | Microsoft Docs
ms.custom: ''
ms.date: 10/29/2019
...
ms.locfileid: "73632977"
---
# <a name="sql-data-warehouse-and-parallel-data-warehouse-catalog-views"></a>Affichages catalogue de la SQL Data Warehouse et des Data Warehouse parallèles

[!INCLUDE[tsql-appliesto-xxxxxx-xxxx-asdw-pdw-md](../../includes/tsql-appliesto-xxxxxx-xxxx-asdw-pdw-md.md)]

 Cette rubrique répertorie les affichages catalogue [!INCLUDE[ssSDW](../../includes/sssdw-md.md)] et [!INCLUDE[ssPDW](../../includes/sspdw-md.md)].  
  
## <a name="includesssdwincludessssdw-mdmd-and-includesspdwincludessspdw-mdmd-catalog-views"></a>Affichages catalogue [!INCLUDE[ssSDW](../../includes/sssdw-md.md)] et [!INCLUDE[ssPDW](../../includes/sspdw-md.md)]  
 Les affichages catalogue suivants s’appliquent à la fois à [!INCLUDE[ssSDW](../../includes/sssdw-md.md)] et [!INCLUDE[ssPDW](../../includes/sspdw-md.md)]:  
...
## <a name="includesssdwincludessssdw-mdmd-catalog-views"></a>Affichages catalogue [!INCLUDE[ssSDW](../../includes/sssdw-md.md)]

 Les affichages catalogue suivants s’appliquent à [!INCLUDE[ssSDW](../../includes/sssdw-md.md)] uniquement :

 [sys. pdw_materialized_view_column_distribution_properties &#40;Transact-SQL&#41; ](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-column-distribution-properties-transact-sql?view=azure-sqldw-latest) (version préliminaire)

 [sys. pdw_materialized_view_distribution_properties &#40;Transact-SQL&#41; ](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-distribution-properties-transact-sql?view=azure-sqldw-latest) (version préliminaire)

 [sys. pdw_materialized_view_mappings &#40;Transact-SQL&#41; ](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-mappings-transact-sql?view=azure-sqldw-latest) (version préliminaire)
 ...
 [sys. workload_management_workload_groups &#40;Transact-SQL&#41; ](/sql/relational-databases/system-catalog-views/sys-workload-management-workload-groups-transact-sql?view=azure-sqldw-latest) (version préliminaire)


## <a name="includesspdwincludessspdw-mdmd-catalog-views"></a>Affichages catalogue [!INCLUDE[ssPDW](../../includes/sspdw-md.md)]
