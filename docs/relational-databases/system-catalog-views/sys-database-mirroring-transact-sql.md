...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
 ...
 Pour afficher la ligne d’une base de données autre que master ou tempdb, vous devez être le propriétaire de la base de données ou avoir au moins les autorisations de niveau serveur ALTER ANY DATABASE ou VIEW ANY DATABASE ou CREATE DATABASE dans la base de données master. Pour afficher les valeurs non NULL sur une base de données miroir, vous devez être un membre de la **sysadmin** rôle serveur fixe.  
