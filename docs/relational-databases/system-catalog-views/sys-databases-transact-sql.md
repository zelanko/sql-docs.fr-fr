...
|**state**|**tinyint**|**La valeur &#124; s’applique à**<br /> 0 = ONLINE <br /> 1 = RESTORING <br /> 2 = récupération [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] de &#124; et versions ultérieures<br /> 3 = RECOVERY_PENDING &#124; [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] et versions ultérieures<br /> 4 = SUSPECT <br /> 5 = &#124; d’urgence [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] et versions ultérieures<br /> 6 = &#124; hors connexion [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] et versions ultérieures<br /> 7 = &#124; [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)] de copie[!INCLUDE[ssGeoDR](../../includes/ssgeodr-md.md)] <br /> 10 = OFFLINE_SECONDARY &#124; [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)][!INCLUDE[ssGeoDR](../../includes/ssgeodr-md.md)] <br /><br /> **Remarque :** Pour les bases de données Always On, interrogez les `database_state` `database_state_desc` colonnes ou de [sys. dm_hadr_database_replica_states](../../relational-databases/system-dynamic-management-views/sys-dm-hadr-database-replica-states-transact-sql.md).|  
...
|**physical_database_name**|**nvarchar(128)**|Pour SQL Server, nom physique de la base de données. Par Azure SQL Database, ID courant pour les bases de données sur un serveur. <br />**S’applique à**: SQL Server 2019 (15. x) et versions ultérieures, et Azure SQL Database|
