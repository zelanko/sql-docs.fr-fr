...
|**chemin d’accès**|**nvarchar (260)**|Chemin du fichier de trace Cette valeur est NULL lorsque la trace représente une trace d'ensemble de lignes.|  
...
|**heure_fin**|**datetime**|Heure d'arrêt de trace d'exécution.|  
...
|**heure_début**|**datetime**|Heure de début de trace.|  
