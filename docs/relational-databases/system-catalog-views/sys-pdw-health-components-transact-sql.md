...
|group_id|**Tiers**|Groupe de composants logiques auquel ce composant appartient. Consultez [sys. pdw_health_components (Parallel Data Warehouse)](../../relational-databases/system-catalog-views/sys-pdw-health-components-transact-sql.md).|NOT NULL|  
