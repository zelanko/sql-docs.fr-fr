...
## <a name="see-also"></a>Voir aussi
 ...
 [Créer et gérer un pool de bases de données élastiques SQL Database](https://azure.microsoft.com/documentation/articles/sql-database-elastic-pool-portal/)   
