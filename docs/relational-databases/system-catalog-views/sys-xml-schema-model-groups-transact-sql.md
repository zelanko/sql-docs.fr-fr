---
title: Sys.xml_schema_model_groups (Transact-SQL) | Documents Microsoft
ms.custom: 
ms.date: 06/10/2016
...
|**compositeur**|**char (1)**|Type de compositeur du groupe :<br /><br /> A = XSD \<tous les > groupe<br /><br /> C = XSD \<choix > groupe<br /><br /> S = XSD \<séquence > groupe|  
