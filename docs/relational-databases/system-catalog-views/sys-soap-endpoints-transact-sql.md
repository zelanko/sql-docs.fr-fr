...
|**default_namespace**|**nvarchar(384)**|L’espace de noms par défaut spécifié dans l’espace de noms = option, ou `https://tempuri.org` si la valeur par défaut a été spécifiée à la place.|  
