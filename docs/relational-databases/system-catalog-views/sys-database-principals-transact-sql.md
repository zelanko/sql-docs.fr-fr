...
## <a name="see-also"></a>Voir aussi  
 ...
 [Utilisateurs de la base de données de relation contenant-contenu - rendre votre base de données Portable](../../relational-databases/security/contained-database-users-making-your-database-portable.md)   
