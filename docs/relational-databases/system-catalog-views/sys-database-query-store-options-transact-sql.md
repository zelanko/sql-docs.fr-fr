...
|**wait_stats_capture_mode**|**smallint**|Contrôle si le magasin de requêtes exécute la capture de statistiques d’attente : <br /><br /> 0 = désactivé <br /><br /> 1 = ON|
|**wait_stats_mode_capture_desc**|**nvarchar (60)**|Description textuelle du mode de capture de statistiques attente réel : <br /><br /> OFF <br /><br /> (Par défaut)| 
