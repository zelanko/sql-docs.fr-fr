---
title: Vues de catalogue Store de requête (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 04/12/2019
ms.prod: sql
...
ms.locfileid: "59542129"
---
# <a name="query-store-catalog-views-transact-sql"></a>Vues de catalogue Store de requête (Transact-SQL)
