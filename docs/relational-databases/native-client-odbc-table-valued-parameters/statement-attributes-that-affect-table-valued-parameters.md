---
description: Attributs d'instruction qui affectent des paramètres table
title: Attributs qui affectent les paramètres de Table-Valued
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
