---
description: Métadonnées de paramètres table supplémentaires
title: Métadonnées de paramètres de Table-Valued supplémentaires | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
