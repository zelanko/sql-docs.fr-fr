...
description: Le CLR fournit un mécanisme pour annoter les API managées dans le .NET Framework avec des attributs tels que SharedState, Synchronization et ExternalProcessMgmt.
...
### <a name="disallowed-types-and-members"></a>Types et membres rejetés  
 Les rubriques suivantes identifient les types et les membres dont les valeurs **HostProtectionResource** ne sont pas autorisées par [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .  
