...
description: En savoir plus sur la hiérarchie des entités qui peuvent être sécurisées avec des autorisations, appelées éléments sécurisables, dans le moteur de base de données SQL Server.
ms.custom: ''
ms.date: 03/23/2016
ms.prod: sql
