...
ms.topic: "article"
helpviewer_keywords: 
  - "ALTER LOGIN, instruction"
  - "mots de passe [SQL Server], application de la stratégie"
  - "connexions [SQL Server], mots de passe"
  - "CHECK_EXPIRATION (option)"
  - "mots de passe complexes [SQL Server]"
  - "mots de passe [SQL Server], expiration"
  - "réinitialisation manuelle du nombre de mots de passe erronés"
  - "MUST_CHANGE (option)"
  - "expiration [SQL Server]"
  - "mot de passe expiré [SQL Server]"
  - "symboles [SQL Server]"
  - "NetValidatePasswordPolicy() (API)"
  - "mots de passe [SQL Server]"
  - "stratégie de mot de passe [SQL Server]"
  - "réinitialisation du nombre de mots de passe erronés"
  - "sécurité [SQL Server], mots de passe"
  - "CHECK_POLICY (option)"
  - "mots de passe [SQL Server], symboles"
  - "nombre de mots de passe erronés"
  - "mots de passe [SQL Server], complexité"
