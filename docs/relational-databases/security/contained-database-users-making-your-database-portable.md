...
ms.topic: "article"
helpviewer_keywords: 
  - "base de données à relation contenant-contenu, utilisateurs"
  - "utilisateur [SQL Server], à propos des utilisateurs de base de données à relation contenant-contenu"
...
## Modèle utilisateur de base de données à relation contenant-contenu  
...
### [!INCLUDE[ssSDS](../../includes/sssds-md.md)] Pare-feux  
