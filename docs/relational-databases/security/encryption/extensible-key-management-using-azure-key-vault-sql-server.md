...
##  <a name="what-is-extensible-key-management-ekm-and-why-use-it"></a><a name="Uses"></a> Qu’est-ce que la gestion de clés extensible et pourquoi l’utiliser ?  
 ...
 ![Diagramme qui compare la hiérarchie de clés de gestion de service classique au système Azure Key Vault.](../../../relational-databases/security/encryption/media/ekm-key-hierarchy-traditional.png "ekm-key-hierarchy-traditional")  
