...
ms.topic: "article"
helpviewer_keywords: 
  - "gestion de clés extensible avec le coffre de clés"
  - "Chiffrement transparent des données, à l'aide de la gestion de clés extensible et du coffre de clés"
  - "gestion de clés extensible, avec le coffre de clés"
  - "Chiffrement transparent des données, gestion de clés extensible et coffre de clés"
  - "gestion de clés avec le coffre de clés"
  - "connecteur SQL Server, à propos de"
