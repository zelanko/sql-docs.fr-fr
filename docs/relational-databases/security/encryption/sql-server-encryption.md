...
description: Utilisez ces ressources pour comprendre comment SQL Server utilise le chiffrement pour améliorer la sécurité de vos bases de données.
ms.custom: ''
ms.date: 05/15/2017
ms.prod: sql
