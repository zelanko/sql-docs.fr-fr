...
ms.topic: "article"
helpviewer_keywords: 
  - "gestion de clés extensible (EKM), configuration avec le coffre de clés"
  - "connecteur SQL Server, configuration"
...
## Partie I : Configurer un principal du service Azure Active Directory  
...
## Partie II : Créer un coffre de clés et une clé  
...
5.  **Générer une clé asymétrique dans le coffre de clés**  
    ...
    ##### Exemple :  
    Si vous le souhaitez, vous pouvez créer une nouvelle clé de chiffrement directement dans Azure Key Vault, et la doter d’une protection logicielle ou HSM. Dans cet exemple, nous allons créer une clé à protection logicielle à l’aide de l’`Add-AzureRmKeyVaultKey cmdlet` :  
...
## Partie III : Installer le connecteur [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]  
...
-   [A. Instruction de maintenance du connecteur SQL Server](../../../relational-databases/security/encryption/sql-server-connector-maintenance-troubleshooting.md#AppendixA)  
...
## Partie IV : Configurer  [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]  
