...
helpviewer_keywords: 
  - "rôles [SQL Server], niveau serveur"
  - "principaux [SQL Server], niveau serveur"
  - "autorisation CONTROL SERVER"
  - "rôles de serveur fixe [SQL Server]"
  - "informations d’identification [SQL Server], rôles"
  - "rôle serveur fixe sysadmin"
  - "rôles de niveau serveur [SQL Server]"
