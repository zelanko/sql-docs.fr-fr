...
4.  Dans la boîte de dialogue **Nouveau rôle serveur –**_nom\_rôle\_server_, dans la page **Général**, entrez le nom du nouveau rôle serveur dans la zone **Nom du rôle serveur**.  
