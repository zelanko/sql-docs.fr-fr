...
helpviewer_keywords: 
  - "db_denydatareader, rôle"
  - "utilisateurs [SQL Server], rôles de base de données"
  - "rôles au niveau de la base de données [SQL Server]"
  - "db_denydatawriter, rôle"
  - "rôles [SQL Server], base de données"
  - "principaux [SQL Server], niveau base de données"
  - "db_backupoperator, rôle"
  - "informations d’identification [SQL Server], rôles"
  - "db_accessadmin, rôle"
  - "schémas [SQL Server], rôles"
  - "autorisations [SQL Server], rôles"
  - "rôles de base de données [SQL Server], liste"
  - "db_datareader, rôle"
  - "db_ddladmin, rôle"
  - "db_datawriter, rôle"
  - "db_securityadmin, rôle"
  - "db_owner, rôle"
  - "rôles de base de données [SQL Server]"
  - "rôles de base de données fixes [SQL Server]"
...
## <a name="special-roles-for-includesssdsmdtokensssdsmdmd-and-includesssdwmdtokensssdwmdmd"></a>Rôles spéciaux pour [!INCLUDE[ssSDS_md](../../../includes/sssds-md.md)] et [!INCLUDE[ssSDW_md](../../../includes/sssdw-md.md)]
