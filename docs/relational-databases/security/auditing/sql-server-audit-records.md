...
description: Les audits SQL Server sont constitués d’éléments d'action d'audit, enregistrés dans une cible d'audit. Recherchez dans ce résumé les enregistrements qui peuvent être envoyés à une cible.
ms.custom: ''
ms.date: 08/03/2017
ms.prod: sql
