...
ms.topic: "article"
helpviewer_keywords: 
  - "visibilité des sous-composants [SQL Server]"
  - "métadonnées [SQL Server], visibilité"
  - "autorisations [SQL Server], accès aux métadonnées"
  - "affichage des métadonnées"
  - "objets [SQL Server], métadonnées"
  - "affichage des métadonnées"
  - "métadonnées de base de données [SQL Server]"
  - "métadonnées [SQL Server], autorisations"
...
|||  
|-|-|  
|vues de catalogue ;|[!INCLUDE[ssDE](../../includes/ssde-md.md)] Procédures stockées **sp_help**|  
...
|Tables système de réplication|Procédures stockées **sp_help** de la réplication et de l’Agent [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|  
...
-   Les procédures stockées **sp_help** du [!INCLUDE[ssDE](../../includes/ssde-md.md)] peuvent retourner uniquement un sous-ensemble de lignes ou la valeur NULL.  
...
## Voir aussi  
 ...
 [Affichages de compatibilité &#40;Transact-SQL&#41;](../Topic/Compatibility%20Views%20\(Transact-SQL\).md)  
