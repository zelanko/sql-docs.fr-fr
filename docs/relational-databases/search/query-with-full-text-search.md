...
ms.topic: "article"
helpviewer_keywords: 
  - "requêtes [recherche en texte intégral], à propos des requêtes de texte intégral"
  - "requêtes [recherche en texte intégral], prédicats"
  - "requêtes de texte intégral [SQL Server], à propos des requêtes de texte intégral"
  - "requêtes de texte intégral [SQL Server], exécution de requêtes SQL Server"
  - "requêtes de texte intégral [SQL Server]"
  - "requêtes [recherche en texte intégral], fonctions"
...
> [!NOTE]  
>  Pour plus d’informations sur la syntaxe et les arguments de ces prédicats, consultez [CONTAINS &#40;Transact-SQL&#41;](../../t-sql/queries/contains-transact-sql.md) et [FREETEXT &#40;Transact-SQL&#41;](../../t-sql/queries/freetext-transact-sql.md).  
...
> [!NOTE]  
>  Les prédicats de texte intégral ne sont pas autorisés dans la [clause OUTPUT](../../t-sql/queries/output-clause-transact-sql.md) lorsque le niveau de compatibilité de la base de données a la valeur 100.  
...
> [!NOTE]  
>  Pour plus d’informations sur la syntaxe et les arguments de ces fonctions, consultez [CONTAINSTABLE &#40;Transact-SQL&#41;](../../relational-databases/system-functions/containstable-transact-sql.md) et [FREETEXTTABLE &#40;Transact-SQL&#41;](../../relational-databases/system-functions/freetexttable-transact-sql.md).  
...
##  <a name="Using_Boolean_Operators"></a> Utilisation des opérateurs booléens AND, OR, AND NOT dans CONTAINS et CONTAINSTABLE  
...
##  <a name="varbinary"></a> Exécution de requêtes sur des colonnes varbinary(max) et xml  
...
> [!IMPORTANT]  
>  La recherche en texte intégral fonctionne également avec des colonnes de type image. Cependant, le type de données **image** sera supprimé dans une version ultérieure de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Évitez d'utiliser ce type de données dans un nouveau travail de développement et prévoyez de modifier les applications qui l'utilisent actuellement. Utilisez plutôt le type de données **varbinary(max)**.  
...
### Données xml  
 ...
 Pour plus d’informations sur l’interrogation sur un **xml** colonne, consultez [Utiliser la recherche en texte intégral avec des colonnes XML](../../relational-databases/xml/use-full-text-search-with-xml-columns.md).  
  
 [Dans cette rubrique](#top)  
  
##  <a name="supported"></a> Formulaires de termes de requête pris en charge  
...
##  <a name="tokens"></a> Affichage du résultat de la segmentation du texte en unités lexicales pour une combinaison d'analyseur lexical, de dictionnaire des synonymes et de liste de mots vides  
