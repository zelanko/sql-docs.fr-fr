...
ms.topic: "article"
helpviewer_keywords: 
  - "recherche sémantique [SQL Server], activation"
...
###  <a name="HowToEnableAlter"></a> Procédure : créer un index sémantique lorsqu'un index de recherche en texte intégral existe  
...
###  <a name="HowToCheckLanguages"></a> Procédure : vérifier les langues prises en charge pour la recherche sémantique  
