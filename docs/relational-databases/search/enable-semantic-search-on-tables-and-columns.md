...
##  <a name="create-a-semantic-index"></a><a name="BasicEnabling"></a> Créer un index sémantique  
  
###  <a name="requirements-and-restrictions-for-creating-a-semantic-index"></a><a name="reqenable"></a> Exigences et restrictions concernant la création d'un index sémantique  
...
##  <a name="create-a-semantic-index-when-there-is-no-full-text-index"></a><a name="HowToEnableCreate"></a> Créer un index sémantique lorsqu’il n’y a pas d’index de recherche en texte intégral  
...
##  <a name="create-a-semantic-index-when-there-is-an-existing-full-text-index"></a><a name="HowToEnableAlter"></a> Créer un index sémantique lorsqu’un index de recherche en texte intégral existe  
...
###  <a name="requirements-and-restrictions-for-altering-an-existing-index"></a><a name="addreq"></a> Exigences et restrictions concernant la modification d'un index existant  
...
##  <a name="drop-a-semantic-index"></a><a name="dropping"></a> Supprimer un index sémantique  
...
Pour supprimer l'indexation sémantique uniquement à partir d'une ou de plusieurs colonnes, appelez l'instruction **ALTER FULLTEXT INDEX** avec l'option **ALTER COLUMN**_column\_name_**DROP STATISTICAL_SEMANTICS**. Vous pouvez supprimer l'indexation de plusieurs colonnes dans une instruction **ALTER** unique.  
...
###  <a name="check-which-languages-are-supported-for-semantic-search"></a><a name="HowToCheckLanguages"></a> Vérifier quelles langues sont prises en charge pour la recherche sémantique  
...
###  <a name="determine-which-document-types-can-be-indexed"></a><a name="doctypes"></a> Déterminer les types de documents pouvant être indexés  
