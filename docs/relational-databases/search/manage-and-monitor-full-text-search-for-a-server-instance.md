---
description: Gérer et surveiller la recherche en texte intégral pour une instance de serveur
title: Gérer et superviser la recherche en texte intégral pour une instance SQL Server
ms.date: 03/14/2017
ms.prod: sql
