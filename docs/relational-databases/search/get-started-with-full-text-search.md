---
description: Commencer à utiliser la recherche en texte intégral
...
##  <a name="choose-options-for-a-full-text-index"></a><a name="options"></a>Choisir des options pour un index de recherche en texte intégral 
