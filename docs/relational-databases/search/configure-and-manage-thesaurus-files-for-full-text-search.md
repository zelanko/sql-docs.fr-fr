...
ms.topic: "article"
helpviewer_keywords: 
  - "index de recherche en texte intégral [SQL Server], fichiers du dictionnaire des synonymes"
  - "dictionnaire des synonymes [recherche en texte intégral], configuration"
  - "dictionnaire des synonymes [recherche en texte intégral]"
...
##  <a name="initial_thesaurus_files"></a> Contenu initial des fichiers de dictionnaires des synonymes  
...
##  <a name="location"></a> Emplacement des fichiers des dictionnaires des synonymes  
 L'emplacement par défaut des fichiers de dictionnaires des synonymes est :  
  
 *<chemin_fichiers_données_SQL_Server>*\MSSQL13.MSSQLSERVER\MSSQL\FTDATA\  
...
##  <a name="how_queries_use_tf"></a> Utilisation par les requêtes des fichiers de dictionnaires des synonymes  
...
-   Structure XML du paramètre de signes diacritiques  
    ...
    |------------------------|-----------|---------|  
    |Non-respect des accents|0|`<diacritics_sensitive>0</diacritics_sensitive>`|  
    |Respecter les accents|1|`<diacritics_sensitive>1</diacritics_sensitive>`|  
...
##  <a name="working_with_thesaurus_files"></a> Utilisation des fichiers de dictionnaires des synonymes  
