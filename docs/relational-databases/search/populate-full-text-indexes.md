...
ms.topic: "article"
helpviewer_keywords: 
  - "alimentation d'index [recherche en texte intégral]"
  - "alimentations incrémentielles [recherche en texte intégral]"
  - "alimentations [recherche en texte intégral]"
  - "recherche en texte intégral [SQL Server], alimentations"
  - "analyses [recherche en texte intégral]"
  - "mises à jour automatiques des index de recherche en texte intégral"
  - "modifier des alimentations basées sur le suivi [recherche en texte intégral]"
  - "mises à jour manuelles [recherche en texte intégral]"
  - "alimentations manuelles [recherche en texte intégral]"
  - "alimentations automatiques [recherche en texte intégral]"
  - "index de texte intégral [SQL Server], colonne clé"
  - "alimentations complètes [recherche en texte intégral]"
  - "index de texte intégral [SQL Server], alimentations"
...
##  <a name="types"></a> Types d'alimentation  
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] prend en charge les types suivants d’alimentation : alimentation complète, alimentation automatique ou manuelle basée sur le suivi des modifications et alimentation incrémentielle basée sur un horodateur.  
...
### Alimentation incrémentielle basée sur un horodateur  
...
##  <a name="examples"></a> Exemples d'alimentation d'index de recherche en texte intégral  
...
### C. Création d'un index de recherche en texte intégral avec le suivi manuel des modifications  
...
### E. Modification d'un index de recherche en texte intégral pour qu'il utilise le suivi automatique des modifications  
...
##  <a name="create"></a> Création ou modification d'une planification d'alimentation incrémentielle  
  
#### Pour créer ou modifier une planification pour l'alimentation incrémentielle dans Management Studio  
...
1.  Dans le volet **Sélectionner une page** , sélectionnez Planifications.  
    ...
    -   Pour créer une planification, cliquez **Nouveau**.  
