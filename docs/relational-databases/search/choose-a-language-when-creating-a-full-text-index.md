...
helpviewer_keywords: 
  ...
  - "index de texte intégral [SQL Server], langues"
  - "considérations internationales [recherche en texte intégral]"
  - "générateurs de formes dérivées [recherche en texte intégral]"
  - "considérations générales [recherche en texte intégral]"
  - "recherche de texte intégral [SQL Server], considérations internationales"
  - "langues [SQL Server], index de texte intégral"
