---
description: DDL, fonctions, procédures stockées et vues de recherche en texte intégral
title: DDL, fonctions, procédures stockées et vues de recherche en texte intégral
ms.date: 03/14/2017
ms.prod: sql
