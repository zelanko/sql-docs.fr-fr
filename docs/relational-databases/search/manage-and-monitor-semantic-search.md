...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Décrit le processus d’indexation sémantique et les tâches associées à la gestion et au contrôle des index.  
