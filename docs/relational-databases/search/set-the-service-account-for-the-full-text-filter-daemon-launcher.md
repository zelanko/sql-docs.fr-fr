...
ms.topic: "article"
helpviewer_keywords: 
  - "Recherche en texte intégral [SQL Server], compte de service de lanceur FDHOST (MSSQLFDLauncher)"
  - "lanceur FDHOST (MSSQLFDLauncher) [SQL Server]"
...
-   [Recommandations de sécurité](#rec)  
  
-   [Définition du compte de service](#setting)  
  
-   [Si le service du Lanceur de démon de filtre de texte intégral SQL ne démarre pas](#error)  
...
4.  Après avoir fermé la boîte de dialogue, cliquez sur **Redémarrer** pour redémarrer le service du Lanceur de démon de filtre de texte intégral SQL.  
 ...
 [Dans cette section](#TOP)  
  
##  <a name="error"></a> Si le service du Lanceur de démon de filtre de texte intégral SQL ne démarre pas  
