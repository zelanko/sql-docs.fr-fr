...
[!INCLUDE[tsql-appliesto-ss2014-xxxx-xxxx-xxx_md](../../includes/tsql-appliesto-ss2014-xxxx-xxxx-xxx-md.md)]
 ...
 En plus des [Configurations matérielle et logicielle requises pour l’installation de SQL Server 2016](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md), voici les conditions d’utilisation de la fonction OLTP en mémoire :  
...
## <a name="important-notes-on-using-includehek2tokenhek2mdmd"></a>Notes importantes lors de l'utilisation de l'[!INCLUDE[hek_2](../../includes/hek-2-md.md)]  
