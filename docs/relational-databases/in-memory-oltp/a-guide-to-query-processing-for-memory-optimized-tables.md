---
title: "Guide du traitement des requ&#234;tes pour les tables m&#233;moire optimis&#233;es | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Traitement des requêtes pour les tables sur disque  
...
## Accès en [!INCLUDE[tsql](../../includes/tsql-md.md)] interprété aux tables mémoire optimisées  
...
```  
 ...
 ![Plan de requête pour joindre des tables optimisées en mémoire.](../../relational-databases/in-memory-oltp/media/hekaton-query-plan-5.gif "Plan de requête pour joindre des tables optimisées en mémoire.")  
 ...
 **Détection des paramètres**  
 ...
 La détection des paramètres n'est pas utilisée pour compiler des procédures stockées compilées en mode natif. Tous les paramètres de la procédure stockée sont considérés comme ayant des valeurs UNKNOWN. À l’instar des procédures stockées interprétées, les procédures stockées compilées en mode natif prennent également en charge l’indicateur **OPTIMIZE FOR**. Pour plus d’informations, consultez [Indicateurs de requête &#40;Transact-SQL&#41;](../Topic/Query%20Hints%20\(Transact-SQL\).md).  
