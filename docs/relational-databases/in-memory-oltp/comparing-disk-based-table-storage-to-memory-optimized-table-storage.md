...
description: Comparez le stockage sur disque et sur tables à mémoire optimisée dans les catégories de DDL, de structure, d’index, d’opération DML et de fragmentation des données.
