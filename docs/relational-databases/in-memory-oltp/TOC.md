...
# [Comparaison du stockage des tables sur disque et du stockage des tables mémoire optimisées](comparing-disk-based-table-storage-to-memory-optimized-table-storage.md)
...
# [Index de hachage pour les tables mémoire optimisées](hash-indexes-for-memory-optimized-tables.md)
...
# [Exemple de base de données pour OLTP en mémoire](sample-database-for-in-memory-oltp.md)
...
# [Implémentation d'IDENTITY dans une table mémoire optimisée](implementing-identity-in-a-memory-optimized-table.md)
...
# [Garbage collection de l'OLTP en mémoire](in-memory-oltp-garbage-collection.md)
# [Accéder aux tables mémoire optimisées à l'aide du Transact-SQL interprété](accessing-memory-optimized-tables-using-interpreted-transact-sql.md)
# [Sauvegarde d'une base de données avec des tables mémoire optimisées](backing-up-a-database-with-memory-optimized-tables.md)
# [Surveiller l'utilisation de la mémoire et résoudre les problèmes connexes](monitor-and-troubleshoot-memory-usage.md)
# [Restauration fragmentaire de bases de données avec des tables mémoire optimisées](piecemeal-restore-of-databases-with-memory-optimized-tables.md)
# [Configuration du stockage des tables mémoire optimisées](configuring-storage-for-memory-optimized-tables.md)
# [DDL pris en charge pour les modules T-SQL compilés en mode natif](supported-ddl-for-natively-compiled-t-sql-modules.md)
...
# [Blocs atomiques dans des procédures en mode natif](blocs-atomiques-dans-des-procédures-en-mode-natif.md)
...
# [Restauration et récupération de tables mémoire optimisées](restore-and-recovery-of-memory-optimized-tables.md)
...
# [Démarrage rapide 1 : technologies OLTP en mémoire pour accélérer les performances Transact-SQL](quick-start-1-in-memory-oltp-technologies-for-faster-transact-sql-performance.md)
