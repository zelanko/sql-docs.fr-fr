---
title: "Lier une base de donn&#233;es avec des tables m&#233;moire optimis&#233;es &#224; un pool de ressources | Microsoft Docs"
ms.custom: ""
ms.date: "08/29/2016"
...
###  <a name="bkmk_CreateDatabase"></a> Créer la base de données  
 Le code [!INCLUDE[tsql](../../includes/tsql-md.md)] suivant crée la base de données IMOLTP_DB destinée à contenir une ou plusieurs tables mémoire optimisées. Le chemin d’accès \<driveAndPath> doit exister avant d’exécuter cette commande.  
...
###  <a name="bkmk_CreateResourcePool"></a> Créer un pool de ressources et configurer la mémoire  
 ...
 Pour plus d’informations sur le fonctionnement dans un environnement de machines virtuelles, consultez [Meilleures pratiques : utilisation de l’OLTP en mémoire dans un environnement de machine virtuelle](../Topic/Using%20In-Memory%20OLTP%20in%20a%20VM%20Environment.md).  
