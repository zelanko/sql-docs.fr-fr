---
title: "Estimer les besoins en m&#233;moire des tables m&#233;moire optimis&#233;es | Microsoft Docs"
ms.custom: ""
ms.date: "12/02/2016"
...
###  <a name="a-namebkmkexampletablea-example-memory-optimized-table"></a><a name="bkmk_ExampleTable"></a> Exemple de table optimisée en mémoire  
...
###  <a name="a-namebkmkmemoryfortablea-memory-for-the-table"></a><a name="bkmk_MemoryForTable"></a> Mémoire pour la table  
...
###  <a name="a-namebkmkindexmeemorya-memory-for-indexes"></a><a name="bkmk_IndexMeemory"></a> Mémoire pour les index  
...
Pour plus d’informations sur le fonctionnement des index de hachage dans les tables optimisées en mémoire [!INCLUDE[hek_2](../../includes/hek-2-md.md)], consultez [Index de hachage](../Topic/Hash%20Indexes.md).  
...
###  <a name="a-namebkmkmemoryforrowversionsa-memory-for-row-versioning"></a><a name="bkmk_MemoryForRowVersions"></a> Mémoire pour le contrôle de version de ligne
...
###  <a name="a-namebkmktablevariablesa-memory-for-table-variables"></a><a name="bkmk_TableVariables"></a> Mémoire pour les variables de table
...
###  <a name="a-namebkmkmemoryforgrowtha-memory-for-growth"></a><a name="bkmk_MemoryForGrowth"></a> Mémoire pour la croissance
