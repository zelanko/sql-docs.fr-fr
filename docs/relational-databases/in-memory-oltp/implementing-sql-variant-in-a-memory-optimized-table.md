---
title: SQL_VARIANT dans une table à mémoire optimisée
description: Utilisez cet exemple pour apprendre à implémenter SQL_VARIANT dans une table à mémoire optimisée dans SQL Server et Azure SQL Database.
