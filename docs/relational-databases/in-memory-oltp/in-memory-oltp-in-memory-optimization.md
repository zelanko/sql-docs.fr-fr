...
[!INCLUDE[tsql-appliesto-ss2016-asdb-xxxx-xxx_md](../../includes/tsql-appliesto-ss2016-asdb-xxxx-xxx-md.md)]
 ...
 -  [Démarrage rapide 1 : technologies OLTP en mémoire pour accélérer les performances Transact-SQL](../../relational-databases/in-memory-oltp/quick-start-1-in-memory-oltp-technologies-for-faster-transact-sql-performance.md).  
...
- [In-Memory OLTP Performance Demo v1.0](https://github.com/Microsoft/sql-server-samples/releases/tag/in-memory-oltp-demo-v1.0) (Démo v1.0 des performances de la fonction OLTP en mémoire)
...
|-----------|-----------------|  
|[Démarrage rapide 1 : technologies OLTP en mémoire pour accélérer les performances Transact-SQL](../../relational-databases/in-memory-oltp/quick-start-1-in-memory-oltp-technologies-for-faster-transact-sql-performance.md)|Plongez directement au cœur de l’OLTP en mémoire.|
...
|[Variables de table mémoire optimisée](../Topic/Memory-Optimized%20Table%20Variables.md)|L'exemple de code illustre comment utiliser une variable de table optimisée en mémoire plutôt qu'une variable de table traditionnelle pour réduire l'utilisation de tempdb.|  
|[Index sur des tables optimisées en mémoire](../Topic/Indexes%20on%20Memory-Optimized%20Tables.md)|Présente les index optimisés en mémoire.|  
...
|[Gestion de la mémoire pour l’OLTP en mémoire](../Topic/Managing%20Memory%20for%20In-Memory%20OLTP.md)|Comprendre et gérer l'utilisation de la mémoire sur votre système.|  
...
|[Sauvegarder, restaurer et récupérer des tables optimisées en mémoire](../Topic/Backup,%20Restore,%20and%20Recovery%20of%20Memory-Optimized%20Tables.md)|Décrit la sauvegarde, la restauration et la récupération des tables optimisées en mémoire.|  
