...
### <a name="step-1a-prerequisite-if-using-ssnoversion"></a>Étape 1a : Condition préalable requise si vous utilisez [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
