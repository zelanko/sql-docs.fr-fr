...
manager: "jhubbard"
---
# D&#233;marrage rapide&#160;1&#160;: technologies OLTP en m&#233;moire pour acc&#233;l&#233;rer les performances Transact-SQL
...
- [Guide des index columnstore](Columnstore%20Indexes%20Guide.xml)  
  
  
> [AZURE.NOTE] Une vidéo de deux minutes sur les fonctionnalités en mémoire est disponible à la page [Azure SQL Database - In-Memory Technologies](http://channel9.msdn.com/Blogs/Windows-Azure/Azure-SQL-Database-In-Memory-Technologies)(Azure SQL Database - Technologies en mémoire). La vidéo date de décembre 2015.  
...
Pour appliquer de manière fiable ce niveau aux tables optimisées en mémoire dans une transaction entre conteneurs, [modifiez le paramétrage de votre base de données](ALTER%20DATABASE%20SET%20Options%20%28Transact-SQL%29.xml) en exécutant le code T-SQL suivant.  
...
- Pour plus d’informations, consultez [Modification des tables mémoire optimisées](../../relational-databases/in-memory-oltp/altering-memory-optimized-tables.md).  
...
- [Gestion de la mémoire pour l’OLTP en mémoire](Managing%20Memory%20for%20In-Memory%20OLTP.xml)  
...
- [Sauvegarder, restaurer et récupérer des tables optimisées en mémoire](Backup,%20Restore,%20and%20Recovery%20of%20Memory-Optimized%20Tables.xml)  
