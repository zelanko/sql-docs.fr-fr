...
Pour les variables de table de plus grande taille, les index non cluster utilisent plus de mémoire que pour les _tables* à mémoire optimisée. Plus le nombre de lignes et la clé d’index sont importants, plus la différence augmente.  
