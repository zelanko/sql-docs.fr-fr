---
title: Fonction MERGE - Procédure stockée compilée nativement
description: Cet exemple vous permet de découvrir comment simuler l’instruction Transact-SQL MERGE dans un module compilé en mode natif.
