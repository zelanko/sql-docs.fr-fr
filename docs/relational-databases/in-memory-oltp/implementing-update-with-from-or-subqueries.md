...
description: Découvrez les éléments de syntaxe pris en charge sur l’instruction Transact-SQL UPDATE dans un module T-SQL compilé en mode natif.
ms.custom: ''
ms.date: 11/17/2016
ms.prod: sql
