...
description: En savoir plus sur la JOINTURE EXTERNE GAUCHE ET DROITE. LEFT et RIGHT OUTER JOIN sont pris en charge dans les modules T-SQL compilés en mode natif dans SQL Server.
ms.custom: ''
ms.date: 06/01/2019
ms.prod: sql
