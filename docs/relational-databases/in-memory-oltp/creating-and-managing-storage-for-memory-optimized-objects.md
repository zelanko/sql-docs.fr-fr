...
description: En savoir plus sur les attributs des tables à mémoire optimisée et des tables basées sur disque. Utilisez ces ressources pour créer et gérer le stockage des objets à mémoire optimisée.
