---
title: "Acc&#233;der aux tables m&#233;moire optimis&#233;es &#224; l&#39;aide du Transact-SQL interpr&#233;t&#233; | Microsoft Docs"
ms.custom: ""
ms.date: "05/31/2016"
...
---
# Acc&#233;der aux tables m&#233;moire optimis&#233;es &#224; l&#39;aide du Transact-SQL interpr&#233;t&#233;
...
- Requêtes de rapports qui utilisent généralement des constructions non disponibles dans les procédures stockées compilées en mode natif (telles que les fonctions de *fenêtre*, parfois désignées sous le terme de fonctions [OVER](../Topic/OVER%20Clause%20\(Transact-SQL\).md)).  
...
Pour plus d'informations sur les indicateurs de table, consultez. [Indicateurs de table &#40;Transact-SQL&#41;](../Topic/Table%20Hints%20\(Transact-SQL\).md). L'isolement SNAPSHOT a été ajouté pour prendre en charge [!INCLUDE[hek_2](../../includes/hek-2-md.md)].  
...
- Définissez l’option de base de données [MEMORY_OPTIMIZED_ELEVATE_TO_SNAPSHOT](../Topic/ALTER%20DATABASE%20SET%20Options%20\(Transact-SQL\).md) sur ON.  
  
Un indicateur de table de niveau d’isolation n’est pas obligatoire pour les tables optimisées en mémoire accessibles par des requêtes qui s’exécutent en [mode de validation automatique](http://msdn.microsoft.com/fr-fr/c8de5b60-d147-492d-b601-2eeae8511d00).  
