...
|**sépar**|**SqlDecimal**|**Décimal, Nullable\<>décimal**|  
...
|**ntext**|None|None|  
|**chiffre**|**SqlDecimal**|**Décimal, Nullable\<>décimal**|  
...
|**smallint**|**Type SqlInt16**|**Int16, Nullable\<Int16>**|  
...
|**varbinary (1), binaire (1)**|**SqlBytes, SqlBinary**|**Byte, Byte [],>\<d’octets Nullable**|  
|**varchar**|None|None|  
|**langage**|**ISAPI**|None|  
