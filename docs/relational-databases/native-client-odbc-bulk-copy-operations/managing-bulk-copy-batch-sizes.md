...
description: Découvrez comment la taille de lot pour une copie en bloc définit l’étendue d’une transaction, ce qui a une incidence sur le comportement des erreurs et la surcharge de verrouillage dans SQL Server Native Client ODBC.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
