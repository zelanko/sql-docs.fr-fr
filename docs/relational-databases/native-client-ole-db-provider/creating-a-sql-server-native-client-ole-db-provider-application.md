---
title: APPLICATION de fournisseur SQL Native Client OLE DB
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
  ...
  La [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] création d’une application fournisseur de fournisseur OLE DB de client autochtone comporte ces étapes :  
...
-   [À propos des propriétés OLE DB](../../relational-databases/native-client-ole-db-provider/about-ole-db-properties.md)  
