---
description: Traitement des résultats (fournisseur Native Client OLE DB)
title: Traitement des résultats (fournisseur Native Client OLE DB)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97463480"
---
# <a name="processing-results-native-client-ole-db-provider"></a>Traitement des résultats (fournisseur Native Client OLE DB)
