# [Informations de référence sur la base de données locale SQL Server Express - Messages d’erreur](sql-server-express-localdb-reference-error-messages.md)

# Erreurs LOCALDB_ERROR_
