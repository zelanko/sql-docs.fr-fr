---
title: "Importer en bloc des donn&#233;es LOB au moyen du fournisseur d&#39;ensembles de lignes OPENROWSET (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "fonction OPENROWSET, importation en bloc de données volumineuses"
  - "SINGLE_CLOB (option)"
  - "formats de données [SQL Server], données LOB"
  - "données volumineuses, importations en bloc"
  - "SINGLE_BLOB (option)"
...
manager: "jhubbard"
---
# Importer en bloc des donn&#233;es LOB au moyen du fournisseur d&#39;ensembles de lignes OPENROWSET (SQL Server)
