...
ms.topic: "article"
helpviewer_keywords: 
  - "importation en bloc [SQL Server], planification"
  - "importation en bloc [SQL Server], à partir d’un fichier CSV"
  - "formats de données [SQL Server], planification des opérations"
  - "fichiers CSV [SQL Server]"
  - "champs entre guillemets dans les fichiers CSV [SQL Server]"
