...
description: Cet article décrit le champ de préfixe, qui encode la longueur d’un champ pour fournir un stockage de fichiers compact lors de l’exportation en bloc au format natif vers un fichier de données.
ms.date: 07/28/2016
ms.prod: sql
