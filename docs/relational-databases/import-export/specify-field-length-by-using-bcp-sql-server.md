...
description: Dans SQL Server, si nécessaire, bcp demande la longueur des champs, les longueurs des champs par défaut et l’impact de la longueur des champs sur le stockage des données dans les fichiers qui contiennent des données char.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
