...
helpviewer_keywords: 
  ...
  - "données [SQL Server], exporter et importer en bloc"
  - "transfert de données"
  - "données d’importation, (consultez également importation en bloc [SQL Server])"
  - "copie de données [SQL Server]"
  - "exportation en bloc [SQL Server]"
  - "données d’importation, importer en bloc"
  - "copie de données [SQL Server], exporter et importer en bloc"
  - "exportation de données, (consultez également exportation en bloc [SQL Server])"
  - "exportation en bloc [SQL Server], à propos de l’exportation en bloc"
  - "importation en bloc [SQL Server]"
...
|[Assistant Importation et Exportation SQL Server](https://msdn.microsoft.com/library/ms141209.aspx)|L’Assistant crée des packages simples qui importent et exportent des données dans plusieurs formats de données courants (bases de données, feuilles de calcul, fichiers texte, etc.).|Oui|Oui|  
