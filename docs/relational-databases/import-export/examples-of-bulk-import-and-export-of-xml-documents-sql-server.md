---
title: Importer et exporter en bloc des documents XML
description: Ces exemples illustrent l’importation en bloc de documents XML dans une base de données SQL Server et l’exportation en bloc à partir d’une base de données SQL Server.
