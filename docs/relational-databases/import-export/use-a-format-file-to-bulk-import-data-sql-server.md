...
## <a name="before-you-begin"></a>Avant de commencer<a name="begin"></a>
...
## <a name="using-a-format-file-to-bulk-import-data"></a>Utilisation d'un fichier de format pour importer des données en bloc<a name="import_data"></a>
