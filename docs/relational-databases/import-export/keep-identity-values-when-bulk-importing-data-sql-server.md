...
description: Quand vous importez en bloc des données contenant des valeurs d’identité dans une instance de SQL Server, de nouvelles valeurs sont affectées par défaut. Vous pouvez choisir de conserver les valeurs d’origine.
ms.date: 09/21/2016
ms.prod: sql
