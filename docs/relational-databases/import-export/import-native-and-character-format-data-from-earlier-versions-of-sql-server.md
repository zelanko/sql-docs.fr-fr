...
ms.topic: "article"
helpviewer_keywords: 
  - "versions antérieures [SQL Server], importation et exportation de formats de données"
  - "-V (commutateur)"
  - "formats de données [SQL Server], versions antérieures"
  - "versions précédentes [SQL Server], importation et exportation de formats de données"
