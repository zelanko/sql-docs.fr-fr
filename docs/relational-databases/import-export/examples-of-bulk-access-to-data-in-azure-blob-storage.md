...
description: Ces exemples Transact-SQL montrent comment utiliser les instructions BULK INSERT et OPENROWSET pour accéder directement à un fichier dans un compte de stockage d’objets blob Azure.
