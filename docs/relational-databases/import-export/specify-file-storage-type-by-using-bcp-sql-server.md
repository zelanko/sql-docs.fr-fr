...
ms.topic: "article"
helpviewer_keywords: 
  - "utilitaire bcp [SQL Server], types de stockage de fichiers"
  - "importation de données, types de stockage de fichiers"
  - "format natif des données [SQL Server]"
  - "types de stockage de fichier [SQL Server]"
  - "formats de données [SQL Server], types de stockage de fichiers"
