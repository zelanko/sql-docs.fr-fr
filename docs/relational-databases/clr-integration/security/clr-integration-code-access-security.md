...
|----------------|-----------------------------|  
|**SecurityPermission**|**L’exécution :** autorisé à exécuter le code managé.|  
...
|**DNSPermission**|**Unrestricted :** autorisation pour demander des informations à partir de serveurs de noms de domaine.|  
...
|**FileIOPermission**|**Unrestricted :** complète d’accès aux fichiers et dossiers est autorisé.|  
|**KeyContainerPermission**|**Unrestricted :** complète l’accès aux conteneurs de clés est autorisé.|  
...
|**SecurityPermission**|**Assertion :** possibilité de déclarer que tous les appelants de ce code ont l’autorisation requise pour l’opération.<br /><br /> **ControlPrincipal :** possibilité de manipuler l’objet principal.<br /><br /> **L’exécution :** autorisé à exécuter le code managé.<br /><br /> **SerializationFormatter :** possibilité de fournir des services de sérialisation.|  
|**SmtpPermission**|**Accès :** des connexions sortantes au port 25 hôte SMTP sont autorisées.|  
...
|**StorePermission**|**Unrestricted :** accès complet à un certificat X.509 magasins est autorisée.|  
|**WebPermission**|**Se connecter :** des connexions sortantes vers les ressources web sont autorisées.|  
