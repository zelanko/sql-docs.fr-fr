...
description: Dans SQL Server l’intégration du CLR, vous souhaiterez peut-être emprunter l’identité de l’appelant dans l’authentification Windows à l’aide de la propriété SqlContext. WindowsIdentity.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
