...
-   Procédures stockées CLR. Pour plus d’informations, consultez [procédures stockées CLR](/dotnet/framework/data/adonet/sql/clr-stored-procedures).  
