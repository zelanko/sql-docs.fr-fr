...
## <a name="see-also"></a>Voir aussi  
   de sécurité de l' [intégration du CLR](../../relational-databases/clr-integration/security/clr-integration-security.md)  
