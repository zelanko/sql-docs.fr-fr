...
###### <a name="scalability-common-threading-scheduling-and-synchronization"></a>Évolutivité Threads, planification et synchronisation courants  
...
###### <a name="reliability-application-domains-and-unrecoverable-exceptions"></a>Beaucoup Domaines d’application et exceptions irrécupérables  
