---
title: "Propriété PropertyIndex (classe SqlServiceAdvancedProperty) | Documents Microsoft"
ms.custom: 
ms.date: 03/03/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]Obtient ou définit l’index de la propriété qui spécifie la position d’une propriété avancée dans un tableau de propriétés avancées qui appartiennent à un service référencé.  
...
## <a name="property-valuereturn-value"></a>Valeur de propriété/valeur de retour  
 A **uint32** valeur qui spécifie la position de la propriété avancée dans le tableau de propriétés avancées qui appartient au service référencé.  
