---
description: Méthode SetStringValue (classe SqlServiceAdvancedProperty)
title: Méthode SetStringValue (classe SqlServiceAdvancedProperty)
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
