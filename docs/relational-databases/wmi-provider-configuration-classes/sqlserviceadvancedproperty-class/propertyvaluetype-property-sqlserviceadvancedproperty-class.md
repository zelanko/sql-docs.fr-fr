---
title: Propertyvaluetype, propriété (classe SqlServiceAdvancedProperty) | Microsoft Docs
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
...
## <a name="property-valuereturn-value"></a>Valeur de propriété/valeur de retour  
 Un **uint32** valeur qui représente le type de données de la propriété.  
