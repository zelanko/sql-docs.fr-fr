---
title: Propriété InstanceName (classe CInstance) | Documents Microsoft
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
---
# <a name="cinstance-class---instancename-property"></a>Classe CInstance - InstanceName, propriété
