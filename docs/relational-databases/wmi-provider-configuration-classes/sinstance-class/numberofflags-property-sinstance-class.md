...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]Obtient le nombre d’indicateurs pour l’instance de [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)].  
...
## <a name="property-valuereturn-value"></a>Valeur de propriété/valeur de retour  
 A **uint32** valeur qui spécifie le nombre d’indicateurs pour l’instance de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)].  
