...
## <a name="property-valuereturn-value"></a>Valeur de propriété/valeur de retour  
 Valeur booléenne qui spécifie si plusieurs adresses IP sont prises en charge par le protocole réseau serveur : **true** si plusieurs adresses IP sont prises en charge par le protocole réseau serveur, ou **false** si plusieurs adresses IP ne sont pas prises en charge par le protocole réseau du serveur.  
