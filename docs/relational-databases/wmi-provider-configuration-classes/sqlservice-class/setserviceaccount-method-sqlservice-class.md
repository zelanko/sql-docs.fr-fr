...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]Tente de modifier le nom d’utilisateur et un mot de passe l’instance de service sous lequel s’exécute.  
