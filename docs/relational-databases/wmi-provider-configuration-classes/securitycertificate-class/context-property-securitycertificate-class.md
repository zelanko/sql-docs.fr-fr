---
title: Propriété Context (classe SecurityCertificate) | Documents Microsoft
ms.custom: ''
ms.date: 03/04/2017
ms.prod: sql
...
## <a name="property-valuereturn-value"></a>Valeur de propriété/valeur de retour  
 Un **sint32** valeur qui spécifie le contexte du certificat de sécurité de tableau.  
