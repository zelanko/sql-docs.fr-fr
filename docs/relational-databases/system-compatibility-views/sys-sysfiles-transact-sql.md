...
|**corps**|**int**|Taille du fichier, en pages de 8 Ko.|  
...
|**statu**|**int**|Bits d’état de la valeur de **croissance** en mégaoctets (Mo) ou kilo-octets (Ko).<br /><br /> 0x2 = Fichier disque.<br /><br /> 0x40 = Fichier journal.<br /><br /> 0x100000 = Croissance. Cette valeur est un pourcentage et non le nombre de pages.|  
