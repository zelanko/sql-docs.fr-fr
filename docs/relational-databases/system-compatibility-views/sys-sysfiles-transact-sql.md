...
|**growth**|**int**|Taille de croissance de la base de données. Peut être le nombre de pages ou le pourcentage de la taille du fichier, en fonction de la valeur de **état**.<br /><br /> 0 = Croissance nulle.|  
