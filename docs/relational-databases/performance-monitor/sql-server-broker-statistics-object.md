...
description: Découvrez l’objet de performance SQLServer:Broker Statistics, qui contient des compteurs de performances chargés de rendre compte d’informations Service Broker sur le moteur de base de données.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
