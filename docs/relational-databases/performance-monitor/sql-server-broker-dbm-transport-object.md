...
description: Découvrez l’objet de performance Broker/DBM Transport, qui contient des compteurs de performances pour les informations concernant l’activité réseau relative à Service Broker et à la mise en miroir de bases de données.
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
