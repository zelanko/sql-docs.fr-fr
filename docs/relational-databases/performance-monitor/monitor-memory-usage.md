...
ms.topic: "article"
helpviewer_keywords: 
  - "paramétrage des bases de données [SQL Server], mémoire"
  - "surveillance des performances du serveur [SQL Server], utilisation de la mémoire"
  - "isolement de mémoire [SQL Server]"
  - "taux de pagination [SQL Server]"
  - "mémoire [SQL Server], surveillance de l’utilisation"
  - "surveillance [SQL Server], utilisation de la mémoire"
  - "états de la mémoire basse"
  - "surveillance des bases de données [SQL Server], utilisation de la mémoire"
  - "mémoire disponible [SQL Server]"
  - "défauts de page [SQL Server]"
  - "surveillance des performances [SQL Server], utilisation de la mémoire"
  - "performances du serveur [SQL Server], mémoire"
...
## Isolement de la mémoire utilisée par SQL Server  
...
## Détermination de l'allocation de mémoire actuelle  
