...
description: Découvrez l’objet SQLServer:Cursor Manager Total, qui fournit des compteurs permettant de superviser les curseurs dans SQL Server.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
