...
helpviewer_keywords: 
  ...
  - "compteurs de performances [SQL Server], groupes de disponibilité AlwaysOn"
  - "SQLServer : réplica de disponibilité"
  - "groupes de disponibilité [SQL Server], compteurs de performances"
