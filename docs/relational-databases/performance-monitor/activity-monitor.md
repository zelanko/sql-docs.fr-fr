...
description: Découvrez comment utiliser le Moniteur d’activité pour afficher des informations sur les processus SQL Server et la façon dont ces processus affectent l’instance actuelle de SQL Server.
ms.custom: ''
ms.date: 04/07/2019
ms.prod: sql
