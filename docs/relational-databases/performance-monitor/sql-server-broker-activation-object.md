...
description: Découvrez l’objet de performance SQLServer:BrokerActivation, qui contient des compteurs de performances fournissant des informations sur l’activation des procédures stockées.
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
