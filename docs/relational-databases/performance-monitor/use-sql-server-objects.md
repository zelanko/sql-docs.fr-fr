...
ms.topic: "article"
helpviewer_keywords: 
  - "performances du serveur [SQL Server], objets de surveillance"
  - "surveillance des bases de données [SQL Server], objets de surveillance"
  - "graphiques [SQL Server]"
  - "Moniteur système [SQL Server], compteurs"
  - "compteurs [SQL Server], liste"
  - "objets [SQL Server], surveillance des performances"
  - "objets [SQL Server], Moniteur système Windows"
  - "compteurs de performances [SQL Server], à propos des compteurs de performances"
  - "Moniteur système [SQL Server], objets"
  - "compteurs de performance [SQL Server]"
  - "compteurs [SQL Server], à propos des compteurs de performances"
  - "paramétrage des bases de données [SQL Server], objets de surveillance"
  - "performances des bases de données [SQL Server], objets de surveillance"
  - "SQL Server, objets"
  - "surveillance des performances [SQL Server], objets de surveillance"
  - "Moniteur système Windows [SQL Server], objets"
  - "Moniteur système Windows [SQL Server], compteurs"
  - "compteurs [SQL Server]"
  - "compteurs de performance [SQL Server], liste"
