...
ms.topic: "article"
helpviewer_keywords: 
  - "Moniteur système [SQL Server], graphiques et rapports"
  - "graphiques [SQL Server]"
  - "rapports [SQL Server]"
  - "rapports [SQL Server], création"
  - "moniteur système Windows [SQL Server], graphiques et rapports"
  - "journaux [SQL Server], moniteur système"
  - "moniteur système [SQL Server], journaux"
  - "moniteur système Windows [SQL Server], journaux"
...
---
# Cr&#233;er des graphiques, des alertes, des journaux et des rapports
