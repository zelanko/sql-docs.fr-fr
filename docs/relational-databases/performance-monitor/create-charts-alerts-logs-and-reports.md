...
description: Découvrez comment créer des graphiques, des alertes, des journaux et des rapports pour superviser une instance de SQL Server à l’aide du Moniteur système.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
