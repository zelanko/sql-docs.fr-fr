...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] L’objet de performance **SQLServer:LogPool FreePool** fournit des compteurs pour les statistiques du pool libre à l’intérieur du pool du journal.
