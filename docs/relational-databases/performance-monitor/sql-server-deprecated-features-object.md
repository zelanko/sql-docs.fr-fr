...
## <a name="see-also"></a>Voir aussi  
 ...
 [Fonctionnalités de recherche en texte intégral abandonnées dans SQL Server 2016](../../database-engine/discontinued-database-engine-functionality-in-sql-server-2016.md)   
