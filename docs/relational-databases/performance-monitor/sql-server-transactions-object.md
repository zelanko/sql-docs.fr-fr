...
description: Découvrez l’objet Transactions, qui fournit des compteurs chargés de superviser les transactions actives dans le moteur de base de données et les effets des transactions dans SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
