...
description: Utilisez le Moniteur système pour mesurer les performances des objets SQL Server, les compteurs de performances et le comportement d’autres objets, tels que les processeurs et la mémoire.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
