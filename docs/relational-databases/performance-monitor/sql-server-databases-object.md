...
description: Découvrez l’objet SQLServer:Databases, qui fournit des compteurs pour les opérations de copie en bloc, le débit des sauvegardes et des restaurations ainsi que l’activité des journaux des transactions.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
