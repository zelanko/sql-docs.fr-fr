...
description: Découvrez l’objet de performances Bases de données SQL Server XTP, qui fournit des compteurs spécifiques de base de données OLTP en mémoire.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
