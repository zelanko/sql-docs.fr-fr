...
description: Découvrez comment ouvrir le Moniteur d’activité dans SQL Server Management Studio. Le Moniteur d’activité interroge l’instance supervisée pour obtenir des informations à afficher.
