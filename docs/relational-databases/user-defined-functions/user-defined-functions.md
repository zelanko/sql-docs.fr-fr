...
ms.topic: "article"
helpviewer_keywords: 
  - "fonctions définies par l’utilisateur [réplication SQL Server], composants"
  - "fonctions définies par l’utilisateur [SQL Server], à propos des fonctions définies par l’utilisateur"
...
|Décrit comment exécuter une fonction définie par l'utilisateur.|[Exécuter les fonctions définies par l'utilisateur](../../relational-databases/user-defined-functions/execute-user-defined-functions.md)|  
...
|Décrit comment afficher la définition d'une fonction définie par l'utilisateur.|[Afficher les fonctions définies par l'utilisateur](../../relational-databases/user-defined-functions/view-user-defined-functions.md)|  
