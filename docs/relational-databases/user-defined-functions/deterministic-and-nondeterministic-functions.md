...
ms.topic: "article"
helpviewer_keywords: 
  - "fonctions intégrées [SQL Server]"
  - "fonctions non déterministes"
  - "procédures stockées étendues [SQL Server], fonctions qui appellent"
  - "fonctions déterministes"
  - "fonctions définies par l’utilisateur [SQL Server], déterministes"
