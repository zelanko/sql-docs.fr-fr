...
description: Découvrez comment utiliser la gestion du cycle de vie des bases de données dans SQL Server pour gérer les bases de données et les ressources de données en termes de performances, de protection, de disponibilité et de coût.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
...
[!INCLUDE [SQL Server Azure SQL Database](../includes/applies-to-version/sql-asdb.md)]
 ...
 Pour lire l’intégralité de la rubrique, consultez [Gestion du cycle de vie de la base de données (DLM)](/previous-versions/sql/sql-server-guides/jj907294(v=sql.110)).  
