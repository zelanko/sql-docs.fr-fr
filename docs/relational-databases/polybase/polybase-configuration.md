...
## <a name="pushdown-configuration"></a>Configuration de la poussée vers le bas  
 Pour améliorer les performances des requêtes, activez le calcul de poussée vers le bas sur un cluster Hadoop dont vous avez besoin pour fournir à SQL Server des paramètres de configuration spécifiques à votre environnement Hadoop :  
