...
ms.topic: "article"
helpviewer_keywords: 
  - "résultats [SQL Server], curseurs"
  - "curseurs Transact-SQL, à propos des curseurs"
  - "curseurs [SQL Server]"
  - "accès aux données [SQL Server], curseurs"
  - "ensembles de résultats [SQL Server], curseurs"
  - "demande de curseurs"
  - "curseurs [SQL Server], à propos des curseurs"
