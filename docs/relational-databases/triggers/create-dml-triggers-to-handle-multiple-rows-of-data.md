---
description: Créer de déclencheurs DML pour gérer plusieurs lignes de données
title: Créer de déclencheurs DML pour gérer plusieurs lignes de données
