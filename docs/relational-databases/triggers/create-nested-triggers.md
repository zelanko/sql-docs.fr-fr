...
ms.topic: "article"
helpviewer_keywords: 
  - "déclencheurs DML récursifs [SQL Server]"
  - "Déclencheurs DML, imbriqués"
  - "déclencheurs [SQL Server], imbriqués"
  - "récurrence directe [SQL Server]"
  - "déclencheurs [SQL Server], récursifs"
  - "déclencheurs DML, récursifs"
  - "option RECURSIVE_TRIGGERS"
  - "récurrence indirecte [SQL Server]"
  - "déclencheurs DML imbriqués"
