...
helpviewer_keywords: 
  - "déclencheurs CRL"
  - "déclencheurs DML, déclencheurs CLR"
  - "déclencheurs DDL, déclencheurs CLR"
...
-   Définissez le déclencheur en tant que classe dans un langage .NET Framework. Pour plus d’informations sur la programmation de déclencheurs dans le CLR, consultez [Déclencheurs CLR](../Topic/CLR%20Triggers.md). Ensuite, compilez la classe pour créer un assembly dans le [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] à l'aide du compilateur du langage approprié.  
