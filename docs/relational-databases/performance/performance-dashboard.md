...
description: Découvrez le tableau de bord Performances de SQL Server Management Studio, qui fournit un insight rapide de SQL Server et d’Azure SQL Database Managed Instance.
ms.custom: ''
ms.date: 12/14/2019
ms.prod: sql
ms.reviewer: ''
