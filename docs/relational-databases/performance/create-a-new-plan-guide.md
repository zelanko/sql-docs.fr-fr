...
description: Découvrez comment créer un repère de plan à l’aide de SQL Server Management Studio ou de Transact-SQL. Un repère de plan applique un plan de requête fixe et des indicateurs de requête à une requête.
ms.custom: ''
ms.date: 08/02/2016
ms.prod: sql
ms.reviewer: ''
