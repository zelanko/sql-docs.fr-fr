...
description: Découvrez les outils de supervision et de paramétrage de SQL Server et la manière de choisir celui qui convient en fonction du type de supervision et des événements à superviser.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
