...
ms.topic: "article"
helpviewer_keywords: 
  - "outils [SQL Server], surveillance des performances"
  - "surveillance des performances du serveur [SQL Server], outils"
  - "surveillance des performances [SQL Server], outils"
  - "performances de base de données [SQL Server], outils"
  - "paramétrage des bases de données [SQL Server], outils"
  - "surveillance de base de données [SQL Server], outils"
  - "performances [SQL Server], outils de surveillance"
  - "performances du serveur [SQL Server], outils"
