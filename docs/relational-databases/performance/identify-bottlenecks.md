...
description: Découvrez les causes des goulots d’étranglement, telles que le manque de ressources et le dysfonctionnement/la mauvaise configuration des ressources dans SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
