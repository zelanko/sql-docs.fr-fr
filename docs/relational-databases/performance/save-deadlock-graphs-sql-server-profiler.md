...
description: Découvrez comment enregistrer un événement Deadlock Graph à l’aide de SQL Server Profiler. Les événements Deadlock Graph sont enregistrés sous forme de fichiers XML.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
ms.reviewer: ''
