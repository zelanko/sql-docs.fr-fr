...
description: Découvrez comment générer des plans d’exécution estimés au format graphique à l’aide de SQL Server Management Studio. Un plan d’exécution estimé ne contient pas d’informations d’exécution.
ms.custom: ''
ms.date: 11/21/2018
ms.prod: sql
