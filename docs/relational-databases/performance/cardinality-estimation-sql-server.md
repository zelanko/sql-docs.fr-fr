...
ms.topic: "article"
helpviewer_keywords: 
  - "estimateur de la cardinalité"
  - "CE (estimateur de la cardinalité)"
...
---
# &#201;valuation de la cardinalit&#233; (SQL Server)
 ...
 **Niveau de compatibilité** : Vous pouvez vérifier le niveau de votre base de données à l’aide du code Transact-SQL suivant pour [COMPATIBILITY_LEVEL](ALTER%20DATABASE%20Compatibility%20Level%20\(Transact-SQL\).md).  
...
## Descriptions de l’estimation de cardinalité avancée  
