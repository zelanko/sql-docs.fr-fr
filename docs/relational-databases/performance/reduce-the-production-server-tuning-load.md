...
description: Découvrez comment l’Assistant Paramétrage du moteur de base de données compte sur l’optimiseur de requête pour analyser une charge de travail et faire des recommandations de paramétrage dans SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
