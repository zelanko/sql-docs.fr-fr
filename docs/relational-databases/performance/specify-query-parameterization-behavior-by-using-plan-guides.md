---
title: Définir le comportement du paramétrage de requêtes à l’aide des repères de plan
description: Découvrez les options de paramétrage, qui permettent d’utiliser des paramètres à la place de valeurs littérales dans une requête dans SQL Server.
