---
title: "Surveiller et r&#233;gler les performances | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "07/18/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "instances de SQL Server, surveillance des performances"
  - "analyse des performances du serveur [SQL Server]"
  - "Moteur de base de données [SQL Server], performances"
  - "surveillance des performances [SQL Server], à propos des performances"
  - "performances du serveur [SQL Server]"
  - "surveillance des performances [SQL Server]"
  - "performances de base de données [SQL Server], à propos des performances"
  - "paramétrage des bases de données [SQL Server], à propos des performances"
  - "informations d’état [SQL Server], surveillance des performances"
  - "surveillance de base de données [SQL Server], à propos des performances"
  - "surveillance [SQL Server], performances de requête"
  - "performances de serveur [SQL Server], à propos des performances"
  - "paramétrage des bases de données [SQL Server]"
  - "performances des bases de données [SQL Server]"
  - "surveillance [SQL Server], performances de serveur"
  - "surveillance des bases de données [SQL Server]"
  - "surveillance des performances de serveur [SQL Server], à propos de la surveillance des performances de serveur"
