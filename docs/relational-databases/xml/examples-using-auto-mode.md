...
## Exemple : extraction des informations sur les clients, les commandes et les détails des commandes  
...
## Exemple : spécification de la clause GROUP BY et de fonctions d'agrégation  
