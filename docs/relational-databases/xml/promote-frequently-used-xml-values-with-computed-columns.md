...
ms.topic: "article"
helpviewer_keywords: 
  - "promotion des propriétés [XML dans SQL Server]"
  - "promotion des propriétés [XML dans SQL Server]"
...
---
# Promouvoir les valeurs XML les plus fr&#233;quentes &#224; l&#39;aide de colonnes calcul&#233;es
...
### Exemple : recherche des instances XML dont les auteurs portent le même prénom  
...
### Exemple : solution utilisant la fonction table multidiffusion CLR  
