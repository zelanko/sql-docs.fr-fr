...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)] Les autorisations de créer une collection de schémas XML ou d’en utiliser une qui existe déjà peuvent être refusées.  
