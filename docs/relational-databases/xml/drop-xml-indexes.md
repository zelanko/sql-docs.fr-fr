...
helpviewer_keywords: 
  - "suppression d'index"
  - "élimination d'index"
  - "index XML [SQL Server], suppression"
...
## Exemple : création puis suppression d'un index XML primaire  
...
## Exemple : création d'un index XML par le biais de l'option d'index DROP_EXISTING  
