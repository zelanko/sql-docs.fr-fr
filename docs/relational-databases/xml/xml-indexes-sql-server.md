...
helpviewer_keywords: 
  - "suppression d'index"
  - "suppression d'index"
  - "index secondaire [XML dans SQL Server]"
  - "type de données xml [SQL Server], index"
  - "élimination d'index"
  - "PATH, index"
  - "DROP_EXISTING, clause"
  - "XML [SQL Server], index"
  - "index principal [XML dans SQL Server]"
  - "index [SQL Server], XML"
  - "index XML [SQL Server], secondaires"
  - "BLOB, index XML"
  - "désactivation d'index"
  - "index XML [SQL Server], modification"
  - "index XML [SQL Server]"
  - "index XML [SQL Server], primaires"
  - "index, modification"
  - "index XML [SQL Server], suppression"
  - "VALUE, index"
  - "index XML [SQL Server], type de données XML"
  - "PROPERTY, index"
...
-   `/book[@* = "someValue"]` où la requête recherche l’élément <`book`> dont un attribut a la valeur `"someValue"`.  
