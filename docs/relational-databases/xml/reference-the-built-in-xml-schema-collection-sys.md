...
description: Découvrez comment faire référence à la collection de schémas XML intégrée sys prédéfinie pour chaque base de données que vous créez.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
