...
description: Découvrez les avantages des requêtes FOR XML imbriquées en consultant un exemple qui compare une requête FOR XML d’un seul niveau à une requête FOR XML imbriquée.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
