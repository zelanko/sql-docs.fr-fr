...
description: Découvrez les colonnes de l'ensemble de lignes avec nom dans les requêtes SQL et les conditions spécifiques dans lesquelles elles sont mappées au document XML obtenu.
