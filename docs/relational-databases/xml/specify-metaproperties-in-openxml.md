...
description: Apprenez à spécifier des attributs de métapropriété dans une instruction OPENXML pour extraire des informations à partir de nœuds XML.
ms.custom: ''
ms.date: 03/04/2017
ms.prod: sql
