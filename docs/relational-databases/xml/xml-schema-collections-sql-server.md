...
helpviewer_keywords: 
  ...
  - "Collections de schémas XML [SQL Server], à propos des collections de schémas XML"
  - "métadonnées [SQL Server], collections de schémas XML"
  - "requêtes [XML dans SQL Server], collections de schémas XML"
  - "collections de schémas [SQL Server]"
  - "schémas [SQL Server], XML"
  - "XML [SQL Server], collections de schémas XML"
  - "collections de schémas XML [SQL Server]"
  - "collections de schémas [SQL Server], à propos des collections de schémas XML"
