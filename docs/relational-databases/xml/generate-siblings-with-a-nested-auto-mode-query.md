...
description: Découvrez comment générer des frères XML à l’aide d’une requête imbriquée en mode AUTO comme alternative à l’utilisation du mode EXPLICIT.
ms.custom: ''
ms.date: 03/04/2017
ms.prod: sql
