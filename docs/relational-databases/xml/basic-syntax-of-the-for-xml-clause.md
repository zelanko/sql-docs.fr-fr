...
description: Découvrez la syntaxe de base de la clause FOR XML et comment elle est utilisée pour déterminer la forme du code XML résultant d’une requête SQL.
