...
description: Découvrez en quoi le mode FOR XML EXPLICIT offre une flexibilité maximale dans le cadre de la génération de données XML à partir du résultat d’une requête.
ms.custom: ''
ms.date: 03/04/2017
ms.prod: sql
