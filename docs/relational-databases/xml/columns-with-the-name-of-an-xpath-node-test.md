...
description: Découvrez comment le contenu XML est mappé quand une requête SQL contient des colonnes portant le nom d’un test de nœud XPath, par exemple Text () ou comment ().
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
