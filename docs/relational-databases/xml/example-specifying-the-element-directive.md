...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)] Cette directive récupère des informations sur les employés et génère des données XML centrées sur l’élément, comme illustré par le code suivant :  
