...
description: Consultez un exemple indiquant que SQL Server ne prend pas en charge la création d’un schéma XML qui restreint un type mixte à un contenu simple.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
