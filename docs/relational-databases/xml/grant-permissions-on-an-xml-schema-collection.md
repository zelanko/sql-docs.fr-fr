...
description: Découvrez comment attribuer des autorisations de création d’une collection de schémas XML et accorder des autorisations sur un objet de collection de schémas XML.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
