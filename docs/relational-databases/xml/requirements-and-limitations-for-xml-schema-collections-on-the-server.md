...
ms.topic: "article"
helpviewer_keywords: 
  - "identificateurs [collections de schémas XML]"
  - "collections de schémas XML [SQL Server], limites"
  - "groupes de remplacement [XML dans SQL Server]"
  - "collections de schémas XML [SQL Server], directives"
  - "lax, validation"
  - "facets [XML dans SQL Server], énumération"
  - "chiffres après la virgule [XML dans SQL Server]"
  - "valeurs de collections de schémas XML répétées"
  - "collections de schémas [SQL Server], limites"
  - "fuseaux horaires [XML dans SQL Server]"
  - "chiffres après la virgule [XML dans SQL Server]"
  - "collections de schémas [SQL Server], directives"
...
|[Le type xs:QName](../../relational-databases/xml/the-xs-qname-type.md)|Décrit la limitation relative au type xs:QName.|  
