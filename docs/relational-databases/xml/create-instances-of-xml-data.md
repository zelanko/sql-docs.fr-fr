...
ms.topic: "article"
helpviewer_keywords: 
  - "conversion des types d'instances de chaînes [XML dans SQL Server]"
  - "XML [SQL Server], typé"
  - "type de données XML [SQL Server], génération d’instances"
  - "conversion des instances de chaînes [XML dans SQL Server]"
  - "XML typé"
  - "génération d'instances XML [SQL Server]"
  - "XML [SQL Server], génération d’instances"
  - "espace [XML dans SQL Server]"
