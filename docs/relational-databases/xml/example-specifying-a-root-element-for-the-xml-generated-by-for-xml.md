...
description: Consultez un exemple de requête qui spécifie l’option ROOT de la clause FOR XML pour demander un élément de niveau supérieur unique dans les données XML résultantes.
ms.date: 03/01/2017
ms.prod: sql
