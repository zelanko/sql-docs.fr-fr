...
helpviewer_keywords: 
  - "collections de schémas [SQL Server], attribution de particule unique"
  - "collections de schémas XML [SQL Server], attribution de particule unique"
  - "contrainte UPA, règle"
  - "contrainte d'attribution de particule unique, règle"
