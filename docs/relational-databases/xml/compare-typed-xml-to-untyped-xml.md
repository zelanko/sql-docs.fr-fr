...
ms.topic: "article"
helpviewer_keywords: 
  - "type de données xml [SQL Server], variables"
  - "paramètres [XML dans SQL Server]"
  - "facettes [XML dans SQL Server]"
  - "type de données xml [SQL Server], colonnes"
  - "XML non typé"
  - "type de données xml [SQL Server], xml typé"
  - "XML [SQL Server], typé"
  - "variables [XML dans SQL Server], création"
  - "type de données xml [SQL Server], XML non typé"
  - "colonnes [XML dans SQL Server], création"
  - "XML typé"
  - "traitement du mode document [SQL Server]"
  - "XML [SQL Server], non typé"
  - "type de données XML [SQL Server], paramètres"
...
## Mise à niveau de XML typé à partir de SQL Server 2005  
