...
description: Découvrez comment supprimer, ou éliminer, des statistiques de tables et de vues dans SQL Server à l’aide de SQL Server Management Studio ou de Transact-SQL.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
