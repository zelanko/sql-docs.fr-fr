...
helpviewer_keywords: 
  ...
  - "statistiques [SQL Server], mise à jour"
...
#### Pour mettre à jour un objet de statistiques  
...
#### Pour mettre à jour un objet de statistiques spécifique  
...
#### Pour mettre à jour toutes les statistiques d'une table  
...
#### Pour mettre à jour toutes les statistiques d'une base de données  
