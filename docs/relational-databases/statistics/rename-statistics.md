...
description: Découvrez comment renommer un objet de statistiques dans SQL Server à l’aide de Transact-SQL. Vous devez disposer d’une autorisation ALTER sur la table ou la vue.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
