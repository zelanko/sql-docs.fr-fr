...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Conversions de types de données DateTime &#40; ODBC &#41;](../../relational-databases/native-client-odbc-date-time/datetime-data-type-conversions-odbc.md)  
 ...
 [Améliorées de Date et le comportement de Type heure avec les précédentes Versions de SQL Server &#40; ODBC &#41;](../../relational-databases/native-client-odbc-date-time/enhanced-date-and-time-type-behavior-with-previous-sql-server-versions-odbc.md)  
