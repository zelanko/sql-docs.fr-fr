---
title: "Tables temporelles &#224; syst&#232;me par version avec tables optimis&#233;es en m&#233;moire | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "07/12/2016"
...
---
# Tables temporelles &#224; syst&#232;me par version avec tables optimis&#233;es en m&#233;moire
...
## Vue d'ensemble  
 ...
 Le diagramme suivant illustre cette architecture.![Temporal In-Memory Architecture](../../relational-databases/tables/media/temporal-in-memory-architecture.png "Temporal In-Memory Architecture")  
...
-   Vous pouvez appliquer un vidage des données en appelant [sp_xtp_flush_temporal_history](../Topic/sp_xtp_flush_temporal_history.md).  
...
## Tâche de vidage de données  
 ...
 Vous pouvez appliquer un vidage des données en appelant [sp_xtp_flush_temporal_history](../Topic/sp_xtp_flush_temporal_history.md) et en spécifiant le schéma et le nom de la table :   
