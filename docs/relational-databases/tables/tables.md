...
helpviewer_keywords: 
  - "tables [SQL Server]"
  - "composants de tables [SQL Server]"
...
## Types de tables  
 ...
 Tables système  
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] stocke les données qui définissent la configuration du serveur et toutes ses tables dans un ensemble de tables spécifique appelé « tables système ». Les utilisateurs ne peuvent pas directement interroger ou mettre à jour les tables système. Les informations contenues dans les tables système sont disponibles via les affichages système. Pour plus d’informations, consultez [Vues système &#40;Transact-SQL&#41;](../Topic/System%20Views%20\(Transact-SQL\).md).  
