---
description: Tables temporelles
...
- **Bien démarrer :**
  ...
  - [Prise en main des tables temporelles dans Azure SQL Database](/azure/azure-sql/temporal-tables)
...
![Diagramme illustrant le fonctionnement d’une table temporelle.](../../relational-databases/tables/media/temporal-howworks.PNG "Temporal-HowWorks")
...
- **Opérations INSERT :** lors d’une opération **INSERT**, le système définit la valeur de la colonne **SysStartTime** (nommée **ValidFrom** dans l’exemple) sur l’heure de début de la transaction en cours (dans le fuseau horaire UTC) d’après l’horloge du système et il attribue à la colonne **SysEndTime** (nommée **ValidTo** dans l’exemple) la valeur maximale de 9999-12-31. La ligne est alors marquée comme ouverte.
...
## <a name="how-do-i-query-temporal-data"></a>Comment interroger des données temporelles
...
![Diagramme montrant le fonctionnement de l’interrogation de données temporelles.](../../relational-databases/tables/media/temporal-querying.PNG "Temporal-Querying")
