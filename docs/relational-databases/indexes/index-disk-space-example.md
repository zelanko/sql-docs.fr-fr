...
ms.topic: "article"
helpviewer_keywords: 
  - "espace disque des index en ligne"
  ...
  - "espace disque des index hors connexion [SQL Server]"
...
## Calculs de l'espace disque pour une opération d'index hors ligne  
...
## Calculs de l'espace disque pour une opération d'index cluster en ligne  
...
## Récapitulatif au sujet de l'espace disque  
