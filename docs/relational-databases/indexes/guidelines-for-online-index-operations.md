...
ms.topic: "article"
helpviewer_keywords: 
  - "index cluster, opérations en ligne"
  - "opérations en ligne sur l'index"
  - "index [SQL Server], opérations en ligne"
  - "espace disque [SQL Server], index"
  - "index non cluster [SQL Server], opérations en ligne"
  - "journaux des transactions [SQL Server], index"
