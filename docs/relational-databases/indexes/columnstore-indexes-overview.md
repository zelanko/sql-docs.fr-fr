---
title: "Guide des index columnstore | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/07/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "création des index, columnstore"
  - "index [SQL Server], columnstore"
  - "index columnstore"
  - "index columnstore, description"
  - "xVelocity, index columnstore"
...
-   Chaque segment de colonne est compressé et stocké sur un support physique.  
 ...
 ![Index columnstore en cluster](../../relational-databases/indexes/media/sql-server-pdw-columnstore-physicalstorage.gif "Index columnstore en cluster")  
...
## Tâches associées  
 ...
 Lorsque vous créez une table avec l’instruction CREATE TABLE, vous pouvez la créer en tant que columnstore en spécifiant l’option WITH CLUSTERED COLUMNSTORE INDEX. Si vous avez déjà une table rowstore et que vous souhaitez la convertir en columnstore, vous pouvez utiliser l’instruction CREATE COLUMNSTORE INDEX. Pour obtenir des exemples, consultez.  
...
|Charger des données dans un index columnstore|[Chargement de données d’index columnstore](../Topic/Columnstore%20Indexes%20Data%20Loading.md)||  
