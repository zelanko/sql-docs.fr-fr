---
title: "Performances des requ&#234;tes d’index columnstore | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "01/27/2017"
 ...
 **Quels sont les rowgroups ignorés dans une analyse de table complète ?**    
 ...
 Pour plus d’informations sur les rowgroups, consultez [Guide des index columnstore](../Topic/Columnstore%20Indexes%20Guide.md)    
...
|Opérateurs en mode batch|Contexte d’utilisation|SQL Server 2012|SQL Server 2014|SQL Server 2016 et SQL Database¹|Commentaires|    
|---------------------------|------------------------|---------------------|---------------------|---------------------------------------|--------------|    
...
|Window Aggregates||N/A|N/A|oui|Nouvel opérateur dans SQL Server 2016.|    
