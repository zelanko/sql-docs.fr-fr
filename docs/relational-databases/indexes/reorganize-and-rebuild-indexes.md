...
> [!NOTE]
> [!INCLUDE[ssManStudio](../../includes/ssManStudio-md.md)] ne peut pas être utilisé pour calculer la fragmentation des index columnstore. Utilisez l’exemple [!INCLUDE[tsql](../../includes/tsql-md.md)] [ci-dessous](#TsqlProcedureFrag).
...
6. Sous **Sélectionner une page**, sélectionnez **Fragmentation**.
   ...
   **Taille maximale de lignes**     
   Taille maximale des lignes de niveau feuille.

   **Taille minimale de lignes**     
   ...
   **Enregistrement fantôme de version**     
