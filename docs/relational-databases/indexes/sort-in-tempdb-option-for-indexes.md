...
helpviewer_keywords: 
  ...
  - "base de données tempdb [SQL Server], index"
  - "index [SQL Server], base de données tempdb"
  - "création d’index [SQL Server], base de données tempdb"
...
## Phases de la construction d'un index  
