...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Un objet **GeometryCollection** est une collection de zéro ou plusieurs instances de **geometry** ou **geography**. Un objet **GeometryCollection** peut être vide.  
