...
# <a name="spatial-data-types-overview"></a>Présentation des types de données spatiales
 ...
 -  
 -> [!IMPORTANT]  
 ->  Pour obtenir une description détaillée et les exemples des nouvelles fonctionnalités spatiales de [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)], notamment les optimisations des types de données spatiales, téléchargez le livre blanc [Nouvelles fonctions spatiales dans SQL Server nom de code « Denali »](http://go.microsoft.com/fwlink/?LinkId=226407).  
 -  
