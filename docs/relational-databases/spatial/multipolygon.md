...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Une instance **MultiPolygon** est une collection de zéro ou plusieurs instances **Polygon**.  
