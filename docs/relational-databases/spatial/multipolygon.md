...
ms.topic: "article"
helpviewer_keywords: 
  - "MultiPolygon, sous-type géométrique [SQL Server]"
...
## Instances Polygon  
 ...
 ![Exemples d'instances MultiPolygon géométriques](../../relational-databases/spatial/media/multipolygon.png "Exemples d'instances MultiPolygon géométriques")  
