...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]Cette section décrit comment exécuter [!INCLUDE[msCoName](../../includes/msconame-md.md)] instructions WQL Windows Management Instrumentation Query Language () sur le fournisseur WMI pour la gestion de l’ordinateur.  
