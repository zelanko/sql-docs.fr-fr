...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Dans [!INCLUDE[tsql](../../includes/tsql-md.md)] des instructions SELECT, vous pouvez appeler common language runtime (CLR) définis par l’utilisateur agrégats, soumis à toutes les règles qui s’appliquent aux fonctions d’agrégation du système.  
