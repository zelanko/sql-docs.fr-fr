...
## <a name="see-also"></a>Voir aussi  
 ...
 [Vue d’ensemble des attributs personnalisés d’intégration du CLR](../clr-integration/database-objects/clr-integration-custom-attributes-for-clr-routines.md)   
