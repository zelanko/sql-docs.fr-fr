...
> [!NOTE]  
>  Objets de base de données Visual C++ compilés avec **/CLR : pure** ne sont pas pris en charge pour l’exécution sur [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Il s'agit par exemple d'objets de base de données tels que des fonctions scalaires.  
...
## <a name="see-also"></a>Voir aussi  
 [Mappage des données de paramètre CLR](../../relational-databases/clr-integration-database-objects-types-net-framework/mapping-clr-parameter-data.md)   
 [Vue d’ensemble d’attributs personnalisés de l’intégration de CLR](http://msdn.microsoft.com/library/ecf5c097-0972-48e2-a9c0-b695b7dd2820)   
