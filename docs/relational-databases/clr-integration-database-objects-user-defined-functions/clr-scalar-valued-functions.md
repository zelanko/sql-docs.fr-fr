---
title: Fonctions DE C.A.Scalar-Valued (fr) Microsoft Docs
description: Une fonction de valeur scalaire rapporte une seule valeur. Dans l’intégration SQL Server CLR, vous pouvez écrire des fonctions définies par l’utilisateur de valeur scalaire dans le code géré.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
ms.reviewer: ''
...
## <a name="see-also"></a>Voir aussi  
 [Cartographier les données de paramètres CLR](../../relational-databases/clr-integration-database-objects-types-net-framework/mapping-clr-parameter-data.md)   
 [Aperçu des attributs personnalisés d’intégration CLR](https://msdn.microsoft.com/library/ecf5c097-0972-48e2-a9c0-b695b7dd2820)   
