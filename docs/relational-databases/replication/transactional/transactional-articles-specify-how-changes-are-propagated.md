---
title: Spécifier le mode de propagation des modifications (articles transactionnels)
description: Découvrez comment spécifier la façon dont les modifications sont propagées pour une publication transactionnelle dans SQL Server.
