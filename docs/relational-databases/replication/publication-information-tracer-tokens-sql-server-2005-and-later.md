---
title: Jetons de suivi (Informations de publication)
description: Décrit l’onglet « Jetons de suivi » situé dans la page « Informations de publication » du moniteur de réplication dans SQL Server Management Studio (SSMS).
