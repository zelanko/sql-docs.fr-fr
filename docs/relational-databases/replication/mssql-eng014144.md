...
1.  Exécutez [sp_helpsubscription & #40 ; Transact-SQL & #41 ;](../../relational-databases/system-stored-procedures/sp-helpsubscription-transact-sql.md) dans la base de données de publication sur le serveur de publication pour rechercher les abonnements.  
  
2.  Exécutez [sp_dropsubscription & #40 ; Transact-SQL & #41 ;](../../relational-databases/system-stored-procedures/sp-dropsubscription-transact-sql.md) dans la base de données de publication pour les abonnements.  
