...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] L’onglet **Publications** fournit des informations récapitulatives pour toutes les publications sur le serveur de distribution sélectionné dans le volet gauche.  
