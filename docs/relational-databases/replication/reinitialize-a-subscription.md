...
description: Découvrez comment réinitialiser un abonnement dans SQL Server à l’aide de SQL Server Management Studio, de Transact-SQL ou de Replication Management Objects.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
