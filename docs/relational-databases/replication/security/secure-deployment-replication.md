...
ms.topic: "article"
helpviewer_keywords: 
  - "sécurité [réplication SQL Server], déploiement"
  - "sécurité du déploiement [réplication SQL Server]"
...
---
# D&#233;ploiement s&#233;curis&#233; (r&#233;plication)
...
## Dans cette section  
 ...
 Décrit les autorisations nécessaires pour accéder au dossier d'instantané, les méthodes préconisées pour définir l'emplacement des dossiers, et traite de la remise d'instantanés via FTP.  
  
 [Sécurité de la réplication sur Internet](../../../relational-databases/replication/security/securing-replication-over-the-internet.md)  
