...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] La sécurisation de la connectivité entre une instance du moteur de base de données [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] et [!INCLUDE[ssEW](../../../includes/ssew-md.md)] implique de configurer correctement la sécurité des services Internet (IIS) de Microsoft et de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)].  
