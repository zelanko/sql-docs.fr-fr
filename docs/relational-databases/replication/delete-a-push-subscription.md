...
4.  Définissez <xref:Microsoft.SqlServer.Management.Common.ServerConnection> de l’étape 1 pour la propriété <xref:Microsoft.SqlServer.Replication.ReplicationObject.ConnectionContext%2A>.  
