...
Si une erreur apparaît ici, consultez [Résoudre les erreurs liées à l’Agent d’instantané](../../troubleshooters/replication/troubleshoot-tran-repl-errors.md#troubleshoot-errors-with-snapshot-agent). 
