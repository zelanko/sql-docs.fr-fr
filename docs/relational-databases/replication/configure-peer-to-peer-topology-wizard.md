...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Cette section contient des informations sur toutes les pages de l’Assistant Configurer la topologie d’égal à égal :  
