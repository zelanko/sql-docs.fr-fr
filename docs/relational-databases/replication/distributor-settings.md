...
helpviewer_keywords: 
  - "Boîte de dialogue Paramètres du serveur de distribution"
...
---
# Param&#232;tres du serveur de distribution
 ...
 **Connexion**  
 Cliquez pour afficher les **se connecter au serveur** boîte de dialogue. Cela vous permet d'afficher et de modifier les propriétés de connexion et les informations d'identification que le Moniteur de réplication utilisent pour se connecter au serveur de distribution.  
