...
ms.topic: "article"
helpviewer_keywords: 
  - "publication [réplication SQL Server], publication Oracle"
  - "réplication de capture instantanée [SQL Server], publication Oracle"
  - "publication Oracle [réplication SQL Server]"
  - "réplication transactionnelle, publication Oracle"
  - "publication Oracle [réplication SQL Server], à propos de la publication Oracle"
