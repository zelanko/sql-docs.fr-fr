...
description: Le moniteur de réplication est un outil graphique. Utiliser le moniteur de réplication pour surveiller une topologie de réplication dans le Microsoft SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
