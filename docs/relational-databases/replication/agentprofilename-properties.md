...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Utilisez la boîte de dialogue **Propriétés** des profils de l’Agent pour afficher les valeurs spécifiées pour chaque paramètre d’agent dans un profil et pour modifier les valeurs des profils définis par l’utilisateur.  
