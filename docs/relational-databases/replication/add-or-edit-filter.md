...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Les boîtes de dialogue **Ajouter un filtre** et **Modifier le filtre** permettent d’ajouter et de modifier des filtres de lignes statiques ou paramétrables.  
