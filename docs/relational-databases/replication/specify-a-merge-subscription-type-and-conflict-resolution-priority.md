...
1.  Dans la boîte de dialogue **Propriétés de l'abonnement - \<Serveur de publication> : \<base_de_données_de_publication>** sur le serveur de publication, affectez une valeur (0,00 à 99,99) à l’option **Priorité**.  
