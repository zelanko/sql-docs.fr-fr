...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Les instantanés sont générés par l’Agent d’instantané après la création d’une publication. Elles peuvent être générées :  
