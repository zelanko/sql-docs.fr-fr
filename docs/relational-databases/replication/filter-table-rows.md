...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] La page **Filtrer les lignes de la table** vous permet d’effectuer les opérations suivantes :  
