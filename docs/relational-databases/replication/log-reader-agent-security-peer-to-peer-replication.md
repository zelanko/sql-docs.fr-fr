---
title: Sécurité de l’Agent de lecture du journal (SSMS)
description: Décrit la page « Sécurité de l’Agent de lecture du journal » pour une publication transactionnelle et d’égal à égal dans SQL Server Management Studio (SSMS).
