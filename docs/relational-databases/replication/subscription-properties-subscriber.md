---
title: Propriétés de l’abonnement, boîte de dialogue
description: Décrit la boîte de dialogue « Propriétés de l’abonnement » dans SQL Server Management Studio (SSMS).
