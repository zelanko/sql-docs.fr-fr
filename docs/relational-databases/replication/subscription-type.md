...
---
# Type d&#39;abonnement
  Réplication de fusion propose deux types d’abonnement : serveur et client (connus dans les versions précédentes de [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] comme globaux et locaux, respectivement). Les abonnés disposant d'un abonnement serveur peuvent :  
 ...
 **Propriétés de l'abonnement**  
 Pour chaque abonné, sélectionnez **Client** ou **Server** dans la zone de liste déroulante dans le **Type d’abonnement** colonne. Pour les abonnés avec des abonnements serveur, entrez un nombre compris entre 0 et 99,99 dans la **priorité pour la résolution de conflit** colonne (le nombre est élevé, plus la priorité de l’abonné).  
