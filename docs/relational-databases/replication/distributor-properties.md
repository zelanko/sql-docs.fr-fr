...
-   [Propriétés du serveur de distribution, Serveurs de publication](../../relational-databases/replication/distributor-properties-publishers.md)  
  
-   [Propriétés de la base de données de distribution](../../relational-databases/replication/distribution-database-properties.md)  
