...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] La réplication utilise de nombreux programmes indépendants, appelés « Agents », pour effectuer les tâches associées au suivi des modifications et à la distribution des données. Cette section de la documentation contient des références de paramètre pour les Agents de réplication suivants.  
