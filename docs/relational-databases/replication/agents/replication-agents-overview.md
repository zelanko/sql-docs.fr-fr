...
description: Découvrez les agents utilisés par la réplication SQL Server pour effectuer les tâches associées au suivi des modifications et à la distribution des données.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
