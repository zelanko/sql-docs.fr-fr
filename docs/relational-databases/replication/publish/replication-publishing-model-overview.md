---
title: "Pr&#233;sentation du mod&#232;le de publication de r&#233;plication | Microsoft Docs"
ms.custom: ""
ms.date: "09/01/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "réplication [SQL Server], modèle de publication"
  - "abonnements [réplication SQL Server], à propos des abonnements"
  - "articles [SQL Server replication]"
  - "publications [réplication SQL Server]"
  - "serveurs de publication [réplication SQL Server], à propos des serveurs de publication"
  - "Abonnés [SQL Server replication]"
  - "serveurs de distribution [réplication SQL Server], à propos des serveurs de distribution"
  - "abonnés [réplication SQL Server], à propos des abonnés"
  - "articles [réplication SQL Server], à propos des articles"
  - "publications [réplication SQL Server], à propos des publications"
  - "Serveurs de distribution [SQL Server replication]"
