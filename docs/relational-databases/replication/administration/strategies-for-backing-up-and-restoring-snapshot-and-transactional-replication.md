...
description: En savoir plus sur les considérations relatives à la conception d’une stratégie de sauvegarde et de restauration de la réplication transactionnelle et d’instantané dans SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
