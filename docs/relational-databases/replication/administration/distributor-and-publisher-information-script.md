...
ms.topic: "article"
helpviewer_keywords: 
  - "serveurs de publication [réplication SQL Server], scripts d’information"
  - "serveurs de distribution [réplication SQL Server], scripts d’information"
...
---
# Script d&#39;information du serveur de distribution et du serveur de publication
...
-   Supprimez les commentaires (`--`) à partir de la ligne `exec sp_helparticle @publication='<PublicationName>'` et remplacez \< PublicationName> avec le nom d’une publication.  
...
## Voir aussi  
 [Forum Aux Questions pour les Administrateurs de réplication](../../../relational-databases/replication/administration/frequently-asked-questions-for-replication-administrators.md)   
 ...
 [sysservers & #40 ; Transact-SQL & #41 ;](../../../relational-databases/system-catalog-views/sys-servers-transact-sql.md)   
