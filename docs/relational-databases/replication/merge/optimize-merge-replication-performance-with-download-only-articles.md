---
title: Optimiser les performances des articles en téléchargement seul (Fusion)
description: Décrit comment optimiser les performances des articles en téléchargement seul utilisés par la réplication de fusion.
...
## <a name="download-only-articles"></a>articles disponibles uniquement par téléchargement  
 ...
 Pour spécifier qu’un article est en téléchargement uniquement, consultez [Spécifier les propriétés de la réplication de fusion](../../../relational-databases/replication/merge/specify-merge-replication-properties.md).  
