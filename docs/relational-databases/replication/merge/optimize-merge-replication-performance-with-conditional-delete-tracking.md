...
-   Programmation de la réplication [!INCLUDE[tsql](../../../includes/tsql-md.md)] : [Spécifier les propriétés de la réplication de fusion](../../../relational-databases/replication/merge/specify-merge-replication-properties.md)  
