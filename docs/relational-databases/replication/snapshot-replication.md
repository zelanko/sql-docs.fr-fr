...
description: La réplication d’instantané distribue les données telles qu’elles apparaissent à un moment donné. Elle ne surveille pas les mises à jour. Un instantané est généré et envoyé aux abonnés.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
