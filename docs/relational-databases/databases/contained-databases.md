...
helpviewer_keywords: 
  ...
  - "database_uncontained_usage, événement"
  - "base de données partiellement à relation contenant-contenu"
  - "bases de données à relation contenant-contenu, présentation"
...
### Avantage des utilisateurs de base de données à relation contenant-contenu avec Always On  
