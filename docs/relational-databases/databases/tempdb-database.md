...
ms.topic: "article"
helpviewer_keywords: 
  - "tables temporaires [SQL Server], base de données tempdb"
  - "base de données tempdb [SQL Server], à propos de tempdb"
  - "procédures stockées temporaires [SQL Server]"
  - "base de données temporaire [SQL Server]"
...
|TRUSTWORTHY|OFF|Non|  
 ...
 Pour obtenir une description de ces options de base de données, consultez [Options ALTER DATABASE SET &#40;Transact-SQL&#41;](../Topic/ALTER%20DATABASE%20SET%20Options%20\(Transact-SQL\).md).  
