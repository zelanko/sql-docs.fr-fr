...
ms.topic: "article"
helpviewer_keywords: 
  - "base de données à relation contenant-contenu, classements"
...
---
# Classements de base de donn&#233;es &#224; relation contenant-contenu
...
|Métadonnées temporaires|Classement de tempdb|CATALOG_DEFAULT|  
