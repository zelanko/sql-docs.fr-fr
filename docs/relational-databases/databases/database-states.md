...
helpviewer_keywords: 
  - "état de base de données d'urgence [SQL Server]"
  - "vérification des états de bases de données"
  - "affichage des états de bases de données"
  - "affichage des états de bases de données"
  - "états d'une base de données [SQL Server]"
  - "état actuel de base de données"
  - "état de base de données hors connexion [SQL Server]"
  - "état de base de données suspecte"
  - "état de base de données récupération en attente [SQL Server]"
  - "états [SQL Server], bases de données"
  - "état de base de données en ligne"
  - "états [SQL Server]"
  - "restauration de l'état de base de données [SQL Server]"
...
## Définition des états d'une base de données  
