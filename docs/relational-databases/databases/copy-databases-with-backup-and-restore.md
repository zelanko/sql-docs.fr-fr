...
helpviewer_keywords: 
  ...
  - "restauration des bases de données [SQL Server], versions de SQL Server précédentes"
  - "restaurations de bases de données [SQL Server], copie de bases de données"
  - "restauration des bases de données [SQL Server], sur une autre instance de serveur"
  - "restauration [SQL Server], sur une autre instance de serveur"
  - "sauvegarde des bases de données [SQL Server], copie de bases de données"
  - "sauvegardes de bases de données [SQL Server], copie de bases de données"
...
-   Transférez les fichiers de catalogues vers un nouvel emplacement lors de la restauration en utilisant la clause WITH MOVE dans l'instruction RESTORE DATABASE. Pour plus d’informations, consultez [RESTORE &#40;Transact-SQL&#41;](../Topic/RESTORE%20\(Transact-SQL\).md).  
