...
helpviewer_keywords: 
  ...
  - "bases de données OLTP [SQL Server]"
  - "bases de données [SQL Server], à propos des bases de données"
...
|[Groupes de fichiers et fichiers de base de données](../../relational-databases/databases/database-files-and-filegroups.md)|[Modifier le nom d'une base de données](../../relational-databases/databases/rename-a-database.md)|  
...
|[Attacher et détacher une base de données &#40;SQL Server&#41;](../../relational-databases/databases/database-detach-and-attach-sql-server.md)|[Afficher une liste des bases de données sur une instance de SQL Server](../../relational-databases/databases/view-a-list-of-databases-on-an-instance-of-sql-server.md)|  
...
|[Créer une base de données](../../relational-databases/databases/create-a-database.md)|[Créer un type de données d'alias défini par l'utilisateur](../../relational-databases/databases/create-a-user-defined-data-type-alias.md)|  
