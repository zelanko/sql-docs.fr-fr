...
ms.topic: "article"
helpviewer_keywords: 
  - "allocation de l’espace [SQL Server], taille de l’index"
...
## Étape 1. Calculer les variables à utiliser dans les étapes 2 et 3  
...
## Étape 2. Calculer l'espace utilisé pour le stockage des informations d'index au niveau feuille  
...
## Étape 3. Calculer l'espace utilisé pour le stockage des informations d'index aux niveaux non-feuille  
...
## Étape 4. Faire la somme des valeurs calculées  
