---
description: Objets BLOB et OLE (Native Client OLE DB fournisseur)
title: Objets BLOB et OLE (Native Client OLE DB fournisseur) | Microsoft Docs
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
