---
title: "Aide sur l&#39;Explorateur d&#39;objets accessible via la touche F1 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "Utilitaire"
  - "gestion"
  - "application de la couche Données"
...
manager: "jhubbard"
---
# Aide sur l&#39;Explorateur d&#39;objets accessible via la touche F1
  ...
  ## Tableau de bord de l'utilitaire (utilitaire SQL Server)
...
-   aucune donnée disponible : les données ne sont pas non plus disponibles pour les instances gérées de SQL Server parce que l'instance de SQL Server vient d'être inscrite et que la première opération de collecte de données n'est pas terminée, ou parce que l'instance gérée de SQL Server rencontre un problème pour recueillir et télécharger des données vers l'UCP.  
 ...
 Pour plus d’informations sur la consultation de l’état d’instances individuelles de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], ou pour afficher ou modifier des paramètres de configuration de stratégie, consultez [Détails de l’instance gérée &#40;utilitaire SQL Server&#41;](../Topic/Managed%20Instance%20Details%20\(SQL%20Server%20Utility\).md).  
...
-   1 an, affiché par intervalles de 1 mois.  
 ...
 ## Détails des applications de la couche Données déployées (utilitaire SQL Server)
...
-   Flèche haut rouge : ![](../../relational-databases/manage/media/utility-up-arrow.gif "Utility_up_arrow")- les ressources sont surexploitées.  
...
## Détails de l'instance gérée (utilitaire SQL Server)
...
## Administration de l'utilitaire (utilitaire SQL Server)
...
-   fréquence de téléchargement du jeu d'éléments de collecte : toutes les 15 minutes.  
 ...
 Le répertoire UMDW est configurable : \<Lecteur système>:\Program Files\Microsoft SQL Server\MSSQL10_50.<Nom_UCP>\MSSQL\Data\\, dans lequel \<Lecteur système> est normalement le lecteur C:\. Le fichier journal, UMDW_\<GUID>_LOG, se trouve dans le même répertoire.  
