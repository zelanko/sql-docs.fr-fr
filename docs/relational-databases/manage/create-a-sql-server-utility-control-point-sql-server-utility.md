...
---
# Cr&#233;er un point de contr&#244;le de l&#39;utilitaire SQL&#160;Server (utilitaire SQL&#160;Server)
...
|L’instance de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] doit être une édition prise en charge. Pour obtenir la liste des fonctionnalités prises en charge par les éditions de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], consultez [Fonctionnalités prises en charge par les éditions de SQL Server 2016](../Topic/Features%20Supported%20by%20the%20Editions%20of%20SQL%20Server%202016.md).|Spécifiez une instance différente de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] pour héberger l’UCP.|  
