...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
  ...
  Le [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] fournisseur native Client OLE DB prend en charge la méthode **IOpenRowset ::OpenRowset** avec les restrictions suivantes :  
...
-   Le paramètre *pIndexID* de **OpenRowset** doit être Null.  
 ...
 Le jeu de résultats de **IOpenRowset::OpenRowset** contient un seul ensemble de lignes. Les ensembles de résultats qui contiennent [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] un seul jeu de ligne peuvent être pris en charge par des curseurs. La prise en charge des curseurs permet au développeur d'utiliser les mécanismes d'accès concurrentiel de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
