---
description: Ajouter un nœud racine à la sortie JSON avec l’option ROOT (SQL Server)
title: Ajouter un nœud racine à la sortie JSON avec l’option ROOT
ms.date: 06/03/2020
ms.prod: sql
ms.technology: ''
ms.topic: conceptual
