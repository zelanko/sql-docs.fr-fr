...
### <a name="use-openjson-instead-of-jsonvalue-to-return-long-text-values"></a>Utiliser OPENJSON à la place de JSON_VALUE pour retourner des valeurs de texte long  
...
### <a name="use-openjson-instead-of-jsonvalue-to-handle-duplicate-keys"></a>Utiliser OPENJSON à la place de JSON_VALUE pour gérer des clés en double  
