---
description: Analyser et transformer des données JSON avec OPENJSON (SQL Server)
title: Analyser et transformer des données JSON avec OPENJSON
ms.date: 06/03/2020
ms.prod: sql
ms.technology: ''
ms.topic: conceptual
