...
ms.topic: "article"
helpviewer_keywords: 
  - "guide, architecture de thread et de tâche"
...
### Utilisation de l'option Regroupement léger
...
### Affectation de threads matériels avec des unités centrales
...
### Utilisation de Trace SQL et du Générateur de profils SQL
