...
ms.topic: "article"
helpviewer_keywords: 
  - "architecture [SQL Server], Messagerie de base de données"
  - "messagerie de base de données [SQL Server], architecture"
  - "messagerie de base de données [SQL Server], composants"
...
-   [Avantages liés à l'utilisation de la messagerie de base de données](#Benefits)  
  
-   [Architecture de la messagerie de base de données](#VisualElement)  
  
-   [Présentation des composants de la messagerie de base de données](#ComponentsAndConcepts)  
