...
helpviewer_keywords: 
  - "audit [SQL Server]"
  - "messagerie de base de données [SQL Server], audit"
  - "journaux [messagerie de base de données]"
  - "audits [SQL Server], messagerie de base de données"
  - "messagerie de base de données [SQL Server], journalisation"
