...
helpviewer_keywords: 
  - "messagerie de base de données [SQL Server], objets de configuration"
  - "messagerie de base de données [SQL Server], comptes"
  - "objets de configuration [Database Mail]"
  - "messagerie de base de données [SQL Server], profils"
  - "profils [SQL Server], messagerie de base de données"
  - "comptes [Database Mail]"
...
-   [Relation entre les objets configuration de la messagerie de base de données](#VisualElement)  
  
-   [Compte de messagerie de base de données](#DBAccount)  
  
-   [Profil de messagerie de base de données](#DBProfile)  
  
-   [Tâches de configuration de la messagerie de base de données](#RelatedTasks)  
  
-   [Tâches de configuration supplémentaires de la messagerie de base de données (procédure stockée système)](#Add_Tasks)  
  
-   [Références supplémentaires](#RelatedContent)  
