...
ms.topic: "article"
helpviewer_keywords: 
  - "débogueur Transact-SQL, fenêtre Variables locales"
  - "débogueur Transact-SQL, fenêtre Espion"
  - "débogueur Transact-SQL, fenêtre Threads"
  - "débogueur Transact-SQL, fenêtre Pile des appels"
  - "débogueur Transact-SQL, Espion express"
  - "débogueur Transact-SQL, affichage d’informations"
...
## Voir aussi  
 ...
 [Fenêtre Points d'arrêt](../../relational-databases/scripting/breakpoints-window.md)   
 [Fenêtre Pile des appels](../../relational-databases/scripting/call-stack-window.md)   
 [Fenêtre Threads](../../relational-databases/scripting/threads-window.md)   
 [Fenêtre Sortie](../../relational-databases/scripting/output-window.md)   
