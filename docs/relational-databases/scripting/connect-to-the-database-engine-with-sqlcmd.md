...
ms.topic: "article"
helpviewer_keywords: 
  - "utilitaire sqlcmd, connexions du moteur de base de données"
  - "Canaux nommés [SQL Server], utilitaire sqlcmd"
  - "TCP/IP [SQL Server], protocoles clients"
  - "protocoles réseau [SQL Server], utilitaire sqlcmd"
  - "protocoles [SQL Server], utilitaire sqlcmd"
  - "VIA"
