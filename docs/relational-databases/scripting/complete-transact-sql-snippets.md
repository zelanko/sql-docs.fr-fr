...
ms.topic: "article"
helpviewer_keywords: 
  - "IntelliSense [SQL Server], compléter des extraits de code"
  - "extraits de code [Transact-SQL], compléter"
  - "extraits de code Transact-SQL, compléter"
...
---
# Compl&#233;ter des extraits de code Transact-SQL
...
## Compléter des extraits de code  
...
#### Compléter l'instruction de l'extrait de code  
