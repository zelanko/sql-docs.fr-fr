...
ms.topic: "article"
helpviewer_keywords: 
  - "IntelliSense [SQL Server], extraits de code"
  - "extraits de code Transact-SQL, code"
  - "extraits de code [Transact-SQL], insertion"
...
---
# Ins&#233;rer des extraits de code Transact-SQL
...
#### Insertion d'un extrait de code à l'aide du menu Insérer un extrait  
