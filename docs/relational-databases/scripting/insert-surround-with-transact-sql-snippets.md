...
ms.topic: "article"
helpviewer_keywords: 
  - "extraits de code [Transact-SQL], entourer de"
  - "IntelliSense [SQL Server], entourer d’extraits de code"
  - "extraits de code Transact-SQL, entourer de"
...
## Insertion d'extraits de code d'entourage  
...
#### Pour insérer un extrait de code d'entourage  
