...
### Utilisation du menu Fichier/Nouveau  
...
### Utilisation du menu Fichier/Ouvrir  
...
### Utilisation de l'Explorateur de modèles pour ouvrir l'Éditeur de requête du moteur de base de données  
