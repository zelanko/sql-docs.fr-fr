...
ms.topic: "article"
helpviewer_keywords: 
  - "éditeur de requêtes [SQL Server Management Studio], code en mode Plan"
  - "éditeur de requêtes [SQL Server Management Studio], masquage de code"
...
### Régions de l'éditeur de requête XMLA Analysis Services  
 ...
 ![Code XML avec nœud interne masqué](../../relational-databases/scripting/media/editoutlinexmlinnercol.png "Code XML avec nœud interne masqué")  
 ...
 ![Code XML avec balises internes et intermédiaires masquées](../../relational-databases/scripting/media/editoutlinexmlmiddlecol.png "Code XML avec balises internes et intermédiaires masquées")  
 ...
 ![Code XML montrant les trois balises masquées](../../relational-databases/scripting/media/editoutlinexmloutercol.png "Code XML montrant les trois balises masquées")  
