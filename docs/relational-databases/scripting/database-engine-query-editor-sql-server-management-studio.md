...
dev_langs: 
  - "TSQL"
helpviewer_keywords: 
  - "Éditeur de requête [Moteur de base de données]"
  - "Éditeur Transact-SQL Voir Éditeur de requête [Moteur de base de données]"
  - "Éditeur de requête du moteur de base de données Voir Éditeur de requête [moteur de base de données]"
  - "Éditeur de requête [Moteur de base de données], barre d’outils"
  - "éditeurs [SQL Server Management Studio], éditeur de requête du moteur de base de données"
  - "Éditeur de requête [Moteur de base de données], fonctionnalités"
  - "SQL Server Management Studio [SQL Server], éditeur de requête du moteur de base de données"
