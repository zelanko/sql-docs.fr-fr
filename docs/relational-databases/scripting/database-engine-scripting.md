...
helpviewer_keywords: 
  ...
  - "scripts [SQL Server]"
  - "script [Moteur de base de données SQL Server]"
  - "script [Moteur de base de données SQL Server], PowerShell"
...
-   Utilisez le menu **Fichier**/**Ouvrir** de [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] pour ouvrir le fichier dans une nouvelle fenêtre de l’éditeur de requête du [!INCLUDE[ssDE](../../includes/ssde-md.md)].  
  
-   Utilisez le paramètre **-i***fichier_entrée* pour exécuter le fichier avec l’utilitaire **sqlcmd**.  
...
|Explique comment utiliser l’utilitaire **sqlcmd** pour exécuter des scripts [!INCLUDE[tsql](../../includes/tsql-md.md)] à partir de l’invite de commandes, notamment la possibilité de développer interactivement des scripts.|[Rubriques de procédures liées à sqlcmd](../Topic/sqlcmd%20How-to%20Topics.md)|  
