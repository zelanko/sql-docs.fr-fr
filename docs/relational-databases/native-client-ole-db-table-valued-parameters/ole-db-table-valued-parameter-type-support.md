---
description: Prise en charge du type de paramètre OLE DB Table-Valued (fournisseur OLE DB Native Client)
title: Prise en charge du type de paramètre table (fournisseur Native Client OLE DB)
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
ms.locfileid: "97469270"
---
# <a name="ole-db-table-valued-parameter-type-support-native-client-ole-db-provider"></a>Prise en charge du type de paramètre OLE DB Table-Valued (fournisseur OLE DB Native Client)
