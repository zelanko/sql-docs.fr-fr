---
description: Prise en charge du type de paramètre table OLE DB (fournisseur Native Client OLE DB)
...
ms.locfileid: "88482595"
---
# <a name="ole-db-table-valued-parameter-type-support-native-client-ole-db-provider"></a>Prise en charge du type de paramètre table OLE DB (fournisseur Native Client OLE DB)
