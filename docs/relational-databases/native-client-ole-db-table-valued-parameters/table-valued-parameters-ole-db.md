---
description: Paramètres de Table-Valued dans SQL Server Native Client (OLE DB)
...
ms.locfileid: "97476010"
---
# <a name="table-valued-parameters--in-sql-server-native-client-ole-db"></a>Paramètres de Table-Valued dans SQL Server Native Client (OLE DB)
