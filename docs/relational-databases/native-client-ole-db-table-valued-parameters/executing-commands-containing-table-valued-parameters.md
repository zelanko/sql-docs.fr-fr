---
description: Exécution de commandes SQL Server Native Client contenant des paramètres de Table-Valued
title: Commandes avec des paramètres de Table-Valued
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
ms.locfileid: "97419050"
---
# <a name="executing-sql-server-native-client-commands-containing-table-valued-parameters"></a>Exécution de commandes SQL Server Native Client contenant des paramètres de Table-Valued
