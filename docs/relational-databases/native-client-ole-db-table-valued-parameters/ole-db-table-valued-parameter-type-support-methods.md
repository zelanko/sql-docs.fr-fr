...
## <a name="see-also"></a>Voir aussi  
 ...
 [Création d’ensemble de lignes de paramètre table](../../relational-databases/native-client-ole-db-table-valued-parameters/table-valued-parameter-rowset-creation.md)   
