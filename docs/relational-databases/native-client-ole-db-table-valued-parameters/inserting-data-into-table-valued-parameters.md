...
ms.locfileid: "97476020"
---
# <a name="inserting-data-into-table-valued-parameters-native-client-ole-db-provider"></a>Insertion de données dans des paramètres Table-Valued (fournisseur Native Client OLE DB)
