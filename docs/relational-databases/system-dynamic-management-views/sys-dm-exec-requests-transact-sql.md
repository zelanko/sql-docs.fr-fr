...
L’exemple suivant interroge **sys. dm_exec_requests** pour trouver le lot intéressant et copier ses `transaction_id` à partir de la sortie.
...
Ensuite, pour rechercher des informations de verrou, utilisez le `transaction_id` copié avec la fonction système **sys. dm_tran_locks**.  
...
[SQL Server, SQL Statistics, objet](../../relational-databases/performance-monitor/sql-server-sql-statistics-object.md)     
