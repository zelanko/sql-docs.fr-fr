...
|-----------------|---------------|-----------------|  
|**Nom_lecteur**|**NCHAR(2)**|Nom (ou lettre) du lecteur qui représente un disque individuel appartenant au groupe de disques partagés en clusters. Colonne n'acceptant pas la valeur NULL.|  
