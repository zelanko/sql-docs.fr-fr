...
|-----------------|---------------|-----------------|  
|**object_id**|**tiers**|ID de la table sous-jacente.|  
|**index_id**|**tiers**|ID de cet index ColumnStore sur la table *object_id* .|  
|**partition_number**|**tiers**|ID de la partition de table qui contient *row_group_id*. Utilisez partition_number pour joindre cette vue DMV à sys.partitions.|  
|**row_group_id**|**tiers**|ID de ce groupe de lignes. Pour les tables partitionnées, la valeur est unique dans la partition.<br /><br /> -1 pour une fin en mémoire.|  
...
|**Département**|**sa**|Numéro d’identification associé *state_description*.<br /><br /> 0 = INVISIBLE<br /><br /> 1 = OPEN<br /><br /> 2 = CLOSED<br /><br /> 3 = COMPRESSED<br /><br /> 4 = OBJET TOMBSTONE<br /><br /> Compressed est le seul État qui s’applique aux tables en mémoire.|  
