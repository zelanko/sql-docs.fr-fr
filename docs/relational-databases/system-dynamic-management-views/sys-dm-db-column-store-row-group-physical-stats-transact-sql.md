...
### <a name="a-calculate-fragmentaton-to-decide-when-to-reorganize-or-rebuild-a-columnstore-index"></a>R. Calculer fragmentaton pour décider quand réorganiser ou reconstruire un index columnstore.  
