---
title: I, O les fonctions (Transact-SQL) et les vues de gestion dynamique liées | Documents Microsoft
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "34463175"
---
# <a name="i-o-related-dynamic-management-views-and-functions-transact-sql"></a>I, O et liées aux vues de gestion dynamique fonctions (Transact-SQL)
