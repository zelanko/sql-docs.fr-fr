...
|OBJECT|< id_objet >|ID de l'objet représenté par cette ressource. Cet objet peut être n’importe quel objet figurant dans **sys.objects**, pas seulement d’une table.|  
