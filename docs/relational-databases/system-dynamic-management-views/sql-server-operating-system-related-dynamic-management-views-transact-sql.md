---
title: Système d’exploitation SQL Server liées à des vues de gestion dynamique (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 04/17/2018
ms.prod: sql
ms.reviewer: ''
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  Cette section présente les vues de gestion dynamique associées au système d'exploitation [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (SQLOS). Le système d'exploitation SQL Server est chargé de gérer les ressources système propres à [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
...
|[système d’exploitation sys.DM-objet travail &#40;Transact-SQL&#41;](../../relational-databases/system-dynamic-management-views/sys-dm-os-job-object-transact-sql.md)||
...
|[sys.dm_os_memory_objects &#40;Transact-SQL&#41;](../../relational-databases/system-dynamic-management-views/sys-dm-os-memory-objects-transact-sql.md)|[Sys.dm_os_workers &#40;Transact-SQL&#41;](../../relational-databases/system-dynamic-management-views/sys-dm-os-workers-transact-sql.md)|  
 ...
 Les vues de gestion dynamique suivantes liées au système d'exploitation [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] sont [!INCLUDE[ssInternalOnly](../../includes/ssinternalonly-md.md)].  
