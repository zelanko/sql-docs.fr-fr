...
|**entrer**|**varchar(60)**|Type de cache. N'accepte pas la valeur NULL.|  
...
|**pages_allocated_count**|**bigint**|**S’applique à** [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] : [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]jusqu’à.<br /><br /> Nombre de pages de 8 Ko pour stocker cette entrée en mémoire cache. N'accepte pas la valeur NULL.|  
