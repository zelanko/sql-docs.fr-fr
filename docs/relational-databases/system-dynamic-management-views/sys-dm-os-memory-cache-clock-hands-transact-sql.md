...
|**clock_hand**|**nvarchar(60)**|Type d'aiguille. Il s’agit d’une des opérations suivantes :<br /><br /> Ressource externe<br /><br /> Interne<br /><br /> N'accepte pas la valeur NULL.|  
|**clock_status**|**nvarchar(60)**|Statut de l'horloge. Il s’agit d’une des opérations suivantes :<br /><br /> Interrompu<br /><br /> Exécution<br /><br /> N'accepte pas la valeur NULL.|  
