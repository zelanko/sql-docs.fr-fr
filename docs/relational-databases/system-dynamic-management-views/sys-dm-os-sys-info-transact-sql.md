...
|Nom de la colonne|Type de données|Description et les notes de version spécifiques |  
|-----------------|---------------|-----------------|  
...
|**time_source_desc**|**nvarchar(60)**|**S’applique à** : [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] jusqu’à [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].<br /><br /> Décrit le **time_source** colonne. N'accepte pas la valeur NULL.<br /><br /> QUERY_PERFORMANCE_COUNTER = le [QueryPerformanceCounter](https://go.microsoft.com/fwlink/?LinkId=163095) API récupère le temps horloge.<br /><br /> MULTIMEDIA_TIMER = le [minuteur multimédia](https://go.microsoft.com/fwlink/?LinkId=163094) API qui Récupère le temps horloge.|  
...
|**numa_node_count** |**int** | **S’applique à :** [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] SP2 à [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].<br /><br />Spécifie le nombre de nœuds numa disponibles sur le système. Cette colonne inclut les nœuds numa physiques, ainsi que les nœuds soft-numa. |  
