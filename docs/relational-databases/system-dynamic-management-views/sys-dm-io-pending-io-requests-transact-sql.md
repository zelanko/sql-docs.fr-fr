...
|**io_pending_ms_ticks**|**bigint**|Usage interne uniquement. N'accepte pas la valeur NULL.| 
...
|**io_user_data_address**|**varbinary (8)**|Usage interne uniquement. Autorise la valeur NULL.|  
