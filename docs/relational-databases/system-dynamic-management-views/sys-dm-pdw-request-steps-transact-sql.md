...
|location_type|**nvarchar(32)**|Où l’étape est en cours d’exécution.|« Calcul », « Contrôle », « DMS »|  
...
|command|**nvarchar(4000)**|Contient le texte complet de la commande de cette étape.|Toute chaîne de requête valide pour une étape. NULL lorsque l’opération est du type MetaDataCreateOperation. Tronquée à 4 000 caractères.|  
