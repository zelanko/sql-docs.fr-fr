...
## [Sys.dm_operation_status (base de données de SQL Azure)](sys-dm-operation-status-azure-sql-database.md)  
...
# [J’AI O](i-o-related-dynamic-management-views-and-functions-transact-sql.md)  
