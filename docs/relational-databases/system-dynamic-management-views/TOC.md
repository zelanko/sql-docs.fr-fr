# [Vue d’ensemble](system-dynamic-management-views.md)  
...
# [Recherche en texte intégral et recherche sémantique](full-text-and-semantic-search-dynamic-management-views-functions.md)  
...
# [E/S](i-o-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [Table à mémoire optimisée](memory-optimized-table-dynamic-management-views-transact-sql.md)  
...
# [gouverneur de ressources](resource-governor-related-dynamic-management-views-transact-sql.md)  
...
# [Sécurité](security-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [Serveur](server-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [SQL Data Warehouse et Parallel Data Warehouse](sql-and-parallel-data-warehouse-dynamic-management-views.md)  
