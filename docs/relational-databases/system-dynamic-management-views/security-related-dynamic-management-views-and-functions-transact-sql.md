---
description: Fonctions et vues de gestion dynamique relatives à la sécurité (Transact-SQL)
title: Fonctions et vues de gestion dynamique liées à la sécurité (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/20/2017
ms.prod: sql
ms.reviewer: ''
