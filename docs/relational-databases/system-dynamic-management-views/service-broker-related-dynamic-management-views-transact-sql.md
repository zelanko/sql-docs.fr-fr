---
description: Vues de gestion dynamique liées à Service Broker (Transact-SQL)
title: Vues de gestion dynamique associées à Service Broker (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "89542355"
---
# <a name="service-broker-related-dynamic-management-views-transact-sql"></a>Vues de gestion dynamique liées à Service Broker (Transact-SQL)
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

  Cette section contient les vues de gestion dynamique suivantes :  
