...
> [!NOTE]  
>  Pour appeler cette vue à partir [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] ou [!INCLUDE[ssPDW](../../includes/sspdw-md.md)], utilisez **sys.dm_pdw_nodes_db_index_usage_stats**.  
...
|**user_updates**|**bigint**|Nombre de mises à jour par requête utilisateur. Cela inclut Insert, Delete et met à jour représentant le nombre d’opérations n'effectuées pas les lignes réelles affectées. Par exemple, si vous supprimez les 1000 lignes dans une seule instruction, ce nombre incrémente de 1|  
