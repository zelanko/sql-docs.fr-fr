...
## <a name="remarks"></a>Notes  
 ...
 Utilisez **sys.dm_exec_query_resource_semaphores** pour la résolution des problèmes, mais ne l’incluez pas dans les applications qui utilisent des versions futures de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
