...
|Nom de la colonne|Type de données|Description et des informations spécifiques à la version|  
|-----------------|---------------|-----------------|  
...
## <a name="remarks"></a>Notes  
 Lorsque le **conformité des critères communs activée** option de configuration de serveur est activée, l’ouverture de session sont affichées dans les colonnes suivantes.  
...
-   unsuccessful_logons  
 ...
 Les connexions d’administrateur sur la base de données SQL Azure seront affiche une ligne par session authentifiée. Les sessions de « sa » qui s’affichent dans le jeu de résultats, ont un impact sur le quota de l’utilisateur pour les sessions. Les connexions non-admin seront affiche uniquement les informations relatives à leurs sessions d’utilisateur de base de données.
