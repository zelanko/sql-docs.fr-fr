...
|**heure_début**|**datetime**|Heure de début de la session.<br /><br /> Lorsque **session_id** = 0, l’heure de début de la collecte des données agrégées.|  
|**heure_fin**|**datetime**|Heure à laquelle la session est terminée.<br /><br /> NULL = la session est active.<br /><br /> Lorsque **session_id** = 0, heure de la dernière session s’est terminée.|  
