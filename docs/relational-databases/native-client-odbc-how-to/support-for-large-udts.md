---
description: Prise en charge de tables UDT volumineuses
...
[!INCLUDE[SQL Server Azure SQL Database Synapse Analytics PDW ](../../includes/applies-to-version/sql-asdb-asdbmi-asa-pdw.md)]
 ...
 Pour plus d’informations sur la prise en charge des UDT volumineux, consultez [types de User-Defined CLR volumineux &#40;&#41;ODBC ](../../relational-databases/native-client/odbc/large-clr-user-defined-types-odbc.md).  
...
## <a name="example"></a>Exemple  
 ...
 La deuxième [!INCLUDE[tsql](../../includes/tsql-md.md)] liste de code () crée l’assembly dans la base de données Master.  
 ...
 La quatrième [!INCLUDE[tsql](../../includes/tsql-md.md)] liste de code () supprime l’assembly de la base de données Master.  
