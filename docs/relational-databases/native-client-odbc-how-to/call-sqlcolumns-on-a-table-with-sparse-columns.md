---
description: Appeler SQLColumns sur une table avec des colonnes éparses
...
## <a name="example"></a>Exemple  
 ...
 La deuxième [!INCLUDE[tsql](../../includes/tsql-md.md)] liste de code () supprime la table créée par cet exemple.  
