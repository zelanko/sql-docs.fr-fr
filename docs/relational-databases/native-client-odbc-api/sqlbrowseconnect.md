...
|DRIVER|Néant|Non|Le nom du pilote ODBC de Microsoft® [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client est {[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client 11}. Le mot clé DRIVER ne peut pas être utilisé si le mot clé DSN est utilisé.|  
...
## <a name="sqlbrowseconnect-support-for-high-availability-disaster-recovery"></a>Prise en charge par SQLBrowseConnect des fonctionnalités de récupération d'urgence, haute disponibilité  
 Pour plus d’informations sur l’utilisation de **SQLBrowseConnect** pour la connexion à un cluster [!INCLUDE[ssHADR](../../includes/sshadr-md.md)], consultez [prise en charge des SQL Server Native Client pour la haute disponibilité et la récupération d’urgence](../../relational-databases/native-client/features/sql-server-native-client-support-for-high-availability-disaster-recovery.md).  
