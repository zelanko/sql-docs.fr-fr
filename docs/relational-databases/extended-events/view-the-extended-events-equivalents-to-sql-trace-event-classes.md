---
title: Événements étendus équivalents aux classes d’événements Trace SQL
description: Cet article vous montre comment afficher les événements et les actions des événements étendus qui sont équivalents à chaque événement Trace SQL et à ses colonnes associées.
ms.date: 03/05/2017
ms.prod: sql
