---
title: Surveiller l'activité système à l’aide d’événements étendus
description: Utilisez les événements étendus avec le suivi d’événements pour Windows afin de superviser l’activité du système. Découvrez CREATE EVENT SESSION, ALTER EVENT SESSION et DROP EVENT SESSION.
ms.date: 03/06/2017
ms.prod: sql
