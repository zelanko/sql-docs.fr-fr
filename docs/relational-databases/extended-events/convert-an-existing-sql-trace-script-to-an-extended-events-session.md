...
description: Utilisez les procédures suivantes pour créer une session d’événements étendus équivalant à un script Trace SQL existant que vous souhaitez convertir.
ms.date: 03/04/2017
ms.prod: sql
