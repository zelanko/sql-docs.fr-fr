...
|**numéro_fichier**|**NUMERIC(10,0)**|Numéro d’identification de fichier unique dans une base de données (correspond à **sys.database_files**. **FILE_ID**).|  
