...
|**nomme**|**sysname**|Nom de l'article de schéma uniquement dans une publication.|  
|**ID**|**int**|Identificateur de l'objet de base de l'article. Il peut s’agir de l’identificateur d’objet d’une procédure, d’une vue, d’une vue, d’une vue ou d’une fonction définie par l’index.|  
...
|**statu**|**int**|Bitmap utilisé pour indiquer l'état de l'article.|  
|**entrer**|**tinyint**|Les valeurs indiquant le type d'article de schéma uniquement sont les suivantes :<br /><br /> **32** = procédure stockée.<br /><br /> **64** = vue ou vue indexée. <br /><br /> **96** = fonction d’agrégation.<br /><br /> **128** = fonction.|  
