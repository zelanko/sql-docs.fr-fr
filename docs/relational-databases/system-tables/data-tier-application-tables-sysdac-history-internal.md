...
|12|3|renommer|base de données|  
 ...
 Les opérations DAC, telles que supprimer, ne suppriment pas les lignes à partir de **sysdac_history_internal**. Vous pouvez utiliser la requête suivante pour supprimer manuellement les lignes pour les DAC ne sont plus déployées sur une instance de la [!INCLUDE[ssDE](../../includes/ssde-md.md)]:  
