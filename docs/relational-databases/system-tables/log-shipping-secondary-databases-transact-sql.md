...
|**max_transfer_size**|**int**|La taille, en octets, de l’entrée maximale ou de la demande de sortie qui est émise par [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] à l’unité de sauvegarde.|  
