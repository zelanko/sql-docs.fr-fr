...
|**rétention**|**int**|La période de rétention pour l’ensemble de l’ensemble de la publication, où l’unité est indiquée par la valeur de la **retention_period_unit** colonne.|  
