...
|**srvid avec**|**smallint**|L’ID du serveur de l’abonné.|  
...
|**id_tâche_distribution**|**binary (16)**|ID de travail de l’Agent de distribution|  
...
|**argument détection_de_boucle**|**bit**|S'applique aux abonnements qui font partie d'une topologie de réplication transactionnelle bidirectionnelle. La détection de boucle détermine si l'Agent de distribution renvoie à l'Abonné les transactions émanant de ce dernier :<br /><br /> **0** = renvoie les transactions.<br /><br /> **1** = ne pas renvoyer.|  
