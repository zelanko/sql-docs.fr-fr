# [Vue d’ensemble](system-tables-transact-sql.md)  
# [Tables d’événements étendus - trace_xe_action_map](extended-events-tables-trace-xe-action-map.md)  
# [Tables d’événements étendus - trace_xe_event_map](extended-events-tables-trace-xe-event-map.md)  
# [Tables d’applications de la couche Données - sysdac_history_internal](data-tier-application-tables-sysdac-history-internal.md)  
# [Tables d’applications de la couche Données - sysdac_instances_internal](data-tier-application-tables-sysdac-instances-internal.md)  
# [Mappage de tables système avec des vues système](mapping-system-tables-to-system-views-transact-sql.md)  
# [Tables de base système](system-base-tables.md)  
# [Tables de sauvegarde et de restauration](backup-and-restore-tables-transact-sql.md)  
...
# [Tables de capture de données modifiées](change-data-capture-tables-transact-sql.md)  
...
# [Tables de copie des journaux de transaction](log-shipping-tables-transact-sql.md)  
...
# [Tables SQL Server Agent](sql-server-agent-tables-transact-sql.md)  
...
# [Tables de réplication](replication-tables-transact-sql.md)  
