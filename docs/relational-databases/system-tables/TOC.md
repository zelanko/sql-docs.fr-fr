...
# [Étendue des Tables des événements - nécessaires](extended-events-tables-trace-xe-action-map.md)  
# [Étendue des Tables des événements - trace_xe_event_map](extended-events-tables-trace-xe-event-map.md)  
# [Tables d’Application de couche données - sysdac_history_internal](data-tier-application-tables-sysdac-history-internal.md)  
# [Tables d’Application de couche données - sysdac_instances_internal](data-tier-application-tables-sysdac-instances-internal.md)  
# [Mappage des Tables système avec les vues système](mapping-system-tables-to-system-views-transact-sql.md)  
# [Tables de Base système](system-base-tables.md)  
# [Tables de sauvegarde et restauration](backup-and-restore-tables-transact-sql.md)  
...
## [capture de données modifiées. < instance_capture >](cdc-capture-instance-ct-transact-sql.md)  
