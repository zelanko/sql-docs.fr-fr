...
|**id_de_la_publication**|**int**|L’ID de publication.|  
...
|**éléments agent_id**|**int**|ID de l'Agent de réplication.|  
...
|**rétention**|**int**|La période de rétention pour la publication.|  
