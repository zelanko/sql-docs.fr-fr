...
## <a name="remarks"></a>Notes  
 Plusieurs bases de données secondaires sur le même serveur secondaire pour une base de données primaire spécifique partagent certains paramètres dans le **log_shipping_secondary** table. En cas de modification d'un paramètre partagé pour l'une d'entre elles, ce paramètre est modifié pour toutes.  
