...
description: Découvrez les plans de maintenance, qui créent un flux de travail pour s’assurer que votre base de données SQL Server est optimisée, sauvegardée régulièrement et exempte d’incohérences.
ms.custom: ''
ms.date: 08/01/2016
ms.prod: sql
