...
description: Apprenez à mettre à jour les informations SQL Server sur les données des tables et des index à l’aide de la tâche Mettre à jour les statistiques.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
