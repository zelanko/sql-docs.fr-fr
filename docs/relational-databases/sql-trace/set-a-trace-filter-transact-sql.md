...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Cette rubrique explique comment utiliser des procédures stockées pour créer un filtre qui ne récupère que les informations nécessaires lors d’un événement en cours de traçage.  
