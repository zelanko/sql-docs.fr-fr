...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
 ...
 Lorsque la conversion automatique est définie sur « Oui », le pilote ODBC [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client utilise Unicode pour convertir les données déplacées entre SQL_C_CHAR variables sur le client et les colonnes de **type char**, **varchar**ou **Text** , les variables ou les paramètres d’une base de données [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] :  
  
-   Lorsque des données sont envoyées à partir d’une variable de SQL_C_CHAR sur le client vers une colonne de **type char**, **varchar**ou **Text** , une variable ou un paramètre d’une base de données [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], le pilote ODBC convertit d’abord de SQL_C_CHAR en Unicode à l’aide de l’ACP du client, puis de retour Unicode en caractère à l’aide de l’ACP du serveur.  
  
-   Lorsque des données sont envoyées à partir d’une colonne de **type char**, **varchar**ou **Text** , d’une variable ou d’un paramètre d’une base de données [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] vers une variable de SQL_C_CHAR sur le client, le pilote ODBC [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] native client convertit d’abord le format de caractère en Unicode à l’aide de l’ACP du serveur, puis de l’Unicode vers SQL_C_CHAR à l’aide de l’ACP  
