...
description: Découvrez qu’une procédure stockée dans SQL Server peut être un groupe composé d’une ou plusieurs instructions Transact-SQL, ou une référence à une méthode CLR .NET Framework.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
