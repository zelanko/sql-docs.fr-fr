...
ms.topic: "article"
helpviewer_keywords: 
  - "stockage de programmes en tant que procédures stockées"
  - "procédures stockées [SQL Server], à propos des procédures stockées"
...
## <a name="related-content"></a>Contenu connexe  
 [Procédures stockées du CLR](../Topic/CLR%20Stored%20Procedures.md)  
