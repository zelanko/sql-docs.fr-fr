...
description: Découvrez les codes de retour OLE Automation, et découvrez comment utiliser une procédure stockée volumineuse en vue d’afficher les informations d’erreur OLE Automation.
ms.custom: ''
ms.date: 07/05/2017
ms.prod: sql
ms.reviewer: ''
