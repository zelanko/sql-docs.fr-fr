...
description: Découvrez comment utiliser les propriétés stockées (page Général) pour consulter des informations en lecture seule concernant une procédure stockée.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
