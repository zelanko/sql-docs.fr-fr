...
description: Découvrez comment retourner des données à partir d’une procédure pour un programme appelant à l’aide de jeux de résultats, de paramètres de sortie et de codes de retour.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
