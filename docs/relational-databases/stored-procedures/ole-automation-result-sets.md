...
description: Découvrez comment, lorsqu’une propriété ou une méthode OLE Automation retourne des données dans un tableau à une ou deux dimensions, ce tableau est retourné au client sous la forme d’un jeu de résultats.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
