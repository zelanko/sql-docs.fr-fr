...
|**GetDate()**|DateTime GetDate()|Retourne la date système.|Aucun|Retourne la date système sous forme de valeur DateTime.|`@DateLastModified = GetDate()`|  
