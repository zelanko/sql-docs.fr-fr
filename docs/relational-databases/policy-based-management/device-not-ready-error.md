...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Cette règle recherche l’ID d’événement 15 dans le journal des événements système. Cette erreur peut être due à des problèmes de configuration de l'adaptateur hôte SCSI ou à des problèmes connexes.  
