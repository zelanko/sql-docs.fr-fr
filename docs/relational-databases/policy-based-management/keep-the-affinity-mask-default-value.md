...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Cette règle vérifie si le paramètre [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] relatif au masque d’affinité est défini sur 0 (valeur par défaut). L'option affinity mask (masque d'affinité) contrôle de manière dynamique l'affinité du processeur.  
