...
description: Découvrez comment le moteur de base de données SQL Server implémente la compression de page afin de vous aider à planifier l’espace de stockage dont vous avez besoin pour vos données.
ms.custom: ''
ms.date: 06/30/2016
ms.prod: sql
