...
description: SQL Server utilise l’algorithme SCSU (Standard Compression Scheme for Unicode) pour compresser les valeurs Unicode stockées dans des objets à compression de ligne ou de page.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
