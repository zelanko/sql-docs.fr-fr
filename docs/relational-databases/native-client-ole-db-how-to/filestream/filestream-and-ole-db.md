---
description: FileStream et OLE DB (fournisseur Native Client OLE DB)
title: FileStream et OLE DB (fournisseur Native Client OLE DB) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97464910"
---
# <a name="filestream-and-ole-db-native-client-ole-db-provider"></a>FileStream et OLE DB (fournisseur Native Client OLE DB)
...
-   [Lire une colonne FILESTREAM dans un fichier avec IBCPSession (OLE DB) &#40;OLE DB&#41;](../../../relational-databases/native-client-ole-db-how-to/filestream/read-a-filestream-column-to-file-using-ibcpsession-ole-db.md)  
  
-   [Récupérer des données d’une colonne FILESTREAM avec ISequentialStream (OLE DB) &#40;OLE DB&#41;](../../../relational-databases/native-client-ole-db-how-to/filestream/retrieve-data-from-a-filestream-column-using-isequentialstream-ole-db.md)  
