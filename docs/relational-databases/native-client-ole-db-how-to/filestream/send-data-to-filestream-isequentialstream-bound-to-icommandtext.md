---
description: Envoyer des données à FILESTREAM dans SQL Server Native Client-ISequentialStream liée à ICommandText
title: FILESTREAM de données, ISequentialStream ICommandText
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "88455769"
---
# <a name="send-data-to-filestream-in-sql-server-native-client---isequentialstream-bound-to-icommandtext"></a>Envoyer des données à FILESTREAM dans SQL Server Native Client-ISequentialStream liée à ICommandText
