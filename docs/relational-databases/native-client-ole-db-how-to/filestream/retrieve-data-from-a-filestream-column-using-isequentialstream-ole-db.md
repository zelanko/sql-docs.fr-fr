---
description: Récupérer des données à partir d’une colonne FILESTREAM à l’aide de ISequentialStream dans SQL Server Native Client (OLE DB)
...
ms.locfileid: "88455725"
---
# <a name="retrieve-data-from-a-filestream-column-using-isequentialstream-in-sql-server-native-client-ole-db"></a>Récupérer des données à partir d’une colonne FILESTREAM à l’aide de ISequentialStream dans SQL Server Native Client (OLE DB)
