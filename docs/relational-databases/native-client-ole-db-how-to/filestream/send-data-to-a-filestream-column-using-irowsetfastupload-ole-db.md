---
description: Envoyer des données à une colonne FILESTREAM à l’aide de IRowsetFastUpload SQL Server Native Client (OLE DB)
title: FILESTREAM de données, IRowsetFastUpload (OLE DB)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97464880"
---
# <a name="send-data-to-a-filestream-column-using-irowsetfastupload-sql-server-native-client-ole-db"></a>Envoyer des données à une colonne FILESTREAM à l’aide de IRowsetFastUpload SQL Server Native Client (OLE DB)
