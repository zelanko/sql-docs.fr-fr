---
description: Lire une colonne FILESTREAM dans un fichier à l’aide de IBCPSession dans SQL Server Native Client (OLE DB)
...
ms.locfileid: "97464900"
---
# <a name="read-a-filestream-column-to-file-using-ibcpsession-in-sql-server-native-client-ole-db"></a>Lire une colonne FILESTREAM dans un fichier à l’aide de IBCPSession dans SQL Server Native Client (OLE DB)
