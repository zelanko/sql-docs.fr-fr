...
-   Affichage de la gestion des erreurs pour les erreurs de SQLNCLI11.  
 ...
 Pour de plus amples renseignements sur les paramètres évalués à la table, voir [Paramètres de valeur de la table &#40;SQL Server Native Client&#41;](../../relational-databases/native-client/features/table-valued-parameters-sql-server-native-client.md).  
