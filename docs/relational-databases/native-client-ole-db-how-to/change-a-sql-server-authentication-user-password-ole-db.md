---
description: Modifier le mot de passe d’un utilisateur d’authentification SQL Server Native Client (OLE DB)
title: Mot de passe de l’utilisateur de l’authentification SQL (OLE DB)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97476130"
---
# <a name="change-a-sql-server-native-client-authentication-user-password-ole-db"></a>Modifier le mot de passe d’un utilisateur d’authentification SQL Server Native Client (OLE DB)
