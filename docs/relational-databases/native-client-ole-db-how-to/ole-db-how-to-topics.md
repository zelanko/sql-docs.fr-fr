---
description: Rubriques de procédures relatives à OLE DB (Native Client OLE DB Provider)
title: Rubriques de procédures (fournisseur Native Client OLE DB)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97481080"
---
# <a name="ole-db-how-to-topics-native-client-ole-db-provider"></a>Rubriques de procédures relatives à OLE DB (Native Client OLE DB Provider)
...
-   [Extraire des lignes avec des signets (OLE DB)](../../relational-databases/native-client-ole-db-how-to/retrieve-rows-using-bookmarks-ole-db.md)  
...
-   [Changer un mot de passe utilisateur pour l’authentification SQL Server (OLE DB)](../../relational-databases/native-client-ole-db-how-to/change-a-sql-server-authentication-user-password-ole-db.md)  
  
-   [Utiliser les fonctionnalités de date et d’heure améliorées (OLE DB)](../../relational-databases/native-client-ole-db-how-to/use-enhanced-date-and-time-features-ole-db.md)  
...
-   [Utiliser des types définis pas l’utilisateur pour des données volumineuses &#40;OLE DB&#41;](../../relational-databases/native-client-ole-db-how-to/use-large-clr-udts-ole-db.md)  
