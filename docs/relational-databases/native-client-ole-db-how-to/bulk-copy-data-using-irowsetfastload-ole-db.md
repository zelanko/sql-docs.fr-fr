---
description: Copier des données en bloc à l’aide de IRowsetFastLoad (OLE DB) dans SQL Server Native Client
title: Copie en bloc de données à l’aide de IRowsetFastLoad (Native Client OLE DB Provider) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "91869211"
---
# <a name="bulk-copy-data-using-irowsetfastload-ole-db-in--sql-server-native-client"></a>Copier des données en bloc à l’aide de IRowsetFastLoad (OLE DB) dans SQL Server Native Client
