---
description: Utiliser les fonctionnalités de date et d’heure améliorées dans SQL Server Native Client (OLE DB)
title: Utiliser les fonctionnalités de date et d’heure améliorées (fournisseur Native Client OLE DB)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97481050"
---
# <a name="use-enhanced-date-and-time-features-in-sql-server-native-client-ole-db"></a>Utiliser les fonctionnalités de date et d’heure améliorées dans SQL Server Native Client (OLE DB)
