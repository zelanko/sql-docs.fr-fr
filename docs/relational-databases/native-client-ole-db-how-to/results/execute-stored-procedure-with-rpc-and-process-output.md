---
title: Exécuter une procédure stockée avec RPC et traiter la sortie | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
6.  Appelez le **Execute** commande (dans ce cas, un appel à une procédure stockée).  
