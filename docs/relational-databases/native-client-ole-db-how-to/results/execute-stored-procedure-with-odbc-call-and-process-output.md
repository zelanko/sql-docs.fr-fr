---
description: Exécuter SQL Server Native Client procédure stockée avec un appel ODBC et traiter la sortie
title: Procédure stockée, appel ODBC, sortie
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "91867649"
---
# <a name="execute-sql-server-native-client-stored-procedure-with-odbc-call-and-process-output"></a>Exécuter SQL Server Native Client procédure stockée avec un appel ODBC et traiter la sortie
