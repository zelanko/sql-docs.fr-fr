---
description: Énumérer les sources de données SQL Server Native Client OLE DB (OLE DB)
title: Énumérer les sources de données OLE DB (fournisseur Native Client OLE DB) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
