---
title: Fonction LocalDBDeleteInstance | Documents Microsoft
ms.custom: 
ms.date: 03/06/2017
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Supprime l’instance de SQL Server Express LocalDB spécifiée.  
