...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Retourne des informations pour l’instance spécifiée de SQL Server Express LocalDB, comme si elle existe, la version de LocalDB qu’elle utilise, si elle est en cours d’exécution et ainsi de suite.  
