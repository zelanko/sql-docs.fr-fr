...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Retourne toutes les versions de SQL Server Express LocalDB disponibles sur l’ordinateur.  
