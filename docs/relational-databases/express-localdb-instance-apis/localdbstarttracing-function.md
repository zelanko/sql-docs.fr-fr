...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Active le suivi de l’API appels pour toutes les instances de SQL Server Express LocalDB détenues par l’utilisateur Windows actuel.  
