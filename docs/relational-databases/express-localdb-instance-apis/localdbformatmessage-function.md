...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Retourne la description textuelle localisée pour l’erreur SQL Server Express LocalDB spécifiée.  
