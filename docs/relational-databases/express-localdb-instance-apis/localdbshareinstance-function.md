---
title: Fonction LocalDBShareInstance | Documents Microsoft
ms.custom: 
ms.date: 03/06/2017
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Partage l’instance de SQL Server Express LocalDB spécifiée avec d’autres utilisateurs de l’ordinateur, à l’aide du nom partagé spécifié.  
