...
## <a name="sample-foreign-keys-primary-keys-and-unique-constraint-columns"></a>Aperçu : Clés étrangères, clés primaires et colonnes de contrainte unique  
