...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Dans SMO, les messages système sont représentés par le <xref:Microsoft.SqlServer.Management.Smo.SystemMessageCollection> objet auquel appartient le **Server** objet. Comme les messages système ne peuvent pas être modifiés, les propriétés d'objet **SystemMessage** sont en lecture seule.  
