...
3. Dans le [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] volet **installé** , accédez à **modèles**\\**Visual C#**  \\ **Windows** , puis sélectionnez **application console**.  
