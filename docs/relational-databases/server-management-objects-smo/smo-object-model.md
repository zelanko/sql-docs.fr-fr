...
[!INCLUDE[appliesto-ss-asdb-asdw-xxx-md](../../includes/appliesto-ss-asdb-asdw-xxx-md.md)]
 ...
 La classe <xref:Microsoft.SqlServer.Management.Smo.Wmi.ManagedComputer> est une classe de niveau supérieur avec une hiérarchie d'objets distincte. L' <xref:Microsoft.SqlServer.Management.Smo.Wmi.ManagedComputer> objet représente [!INCLUDE[msCoName](../../includes/msconame-md.md)]lesservicesetles paramètresréseaudisponiblesvialefournisseurWMI[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .  
