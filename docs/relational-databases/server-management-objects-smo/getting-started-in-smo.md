...
[Tâches de programmation spécifiques](../../relational-databases/server-management-objects-smo/tasks/programming-specific-tasks.md) inclut des concepts et procédures sur la programmation des tâches spécifiques à l’aide de SMO. Cette rubrique décrit également la gestion par programme complète de SQL Server.  
