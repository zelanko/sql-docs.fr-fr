...
|-----------|-----------------|  
|[Prise en main de Visual C &#35; .NET](../../relational-databases/server-management-objects-smo/smo-programming-getting-started-in-visual-csharp-net.md)|Fournit des informations sur l’écriture d’un programme SMO dans Visual c# .NET|  
