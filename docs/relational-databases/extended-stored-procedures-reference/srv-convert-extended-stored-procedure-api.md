...
description: Découvrez comment srv_convert dans l’API de procédure stockée étendue modifie les données d’un type de données à un autre.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
