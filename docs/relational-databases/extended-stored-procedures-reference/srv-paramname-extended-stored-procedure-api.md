...
## <a name="returns"></a>Valeur renvoyée  
 Pointeur vers une chaîne de caractères terminée par le caractère NULL qui contient le nom du paramètre. La longueur du nom de paramètre est stockée dans *len*. S’il existe aucune *n*ième paramètre ni aucune procédure stockée distante, il renvoie la valeur NULL, *len* a la valeur -1, et un message d’erreur d’information est envoyé. Si le nom de paramètre est NULL, la valeur 0 est affectée à *len* et une chaîne vide se terminant par NULL est retournée.  
