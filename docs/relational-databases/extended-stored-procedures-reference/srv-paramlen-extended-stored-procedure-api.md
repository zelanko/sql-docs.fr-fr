...
## <a name="returns"></a>Valeur renvoyée  
 Longueur réelle, en octets, des données de paramètre. S’il existe aucune *n*ième paramètre ou il n’existe aucune procédure stockée distante, la valeur -1. Si le *n*ième paramètre est NULL, retourne 0.  
