...
## <a name="returns"></a>Valeur renvoyée  
 Longueur maximale, en octets, des données du paramètre. S’il existe aucune *n*ième paramètre ou s’il n’existe aucune procédure stockée distante, il retourne -1.  
