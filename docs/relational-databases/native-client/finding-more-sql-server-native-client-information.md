---
description: Recherche d'informations supplémentaires concernant SQL Server Native Client
title: Sources d'informations complémentaires
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
...
[!INCLUDE[SQL Server Azure SQL Database Synapse Analytics PDW ](../../includes/applies-to-version/sql-asdb-asdbmi-asa-pdw.md)]
 ...
 [Blog Data Access](https://docs.microsoft.com/archive/blogs/dataaccess/quick-update-re-data-access-blog)  
