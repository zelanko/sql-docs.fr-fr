...
ms.locfileid: "87246722"
---
# <a name="using-encryption-without-validation-in-sql-server-native-client"></a>Utilisation du chiffrement sans validation dans SQL Server Native Client
