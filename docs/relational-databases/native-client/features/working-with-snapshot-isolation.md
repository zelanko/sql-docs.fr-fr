...
## <a name="sql-server-native-client-ole-db-provider"></a>Fournisseur OLE DB SQL Server Native Client  
 Le [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] fournisseur native Client OLE DB a des améliorations [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)]qui tirent parti de l’isolement instantané introduit dans . Ces améliorations incluent des modifications aux jeux de propriétés DBPROPSET_DATASOURCEINFO et DBPROPSET_SESSION.  
...
## <a name="sql-server-native-client-odbc-driver"></a>Pilote ODBC SQL Server Native Client  
 Le [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] conducteur de Native Client ODBC fournit un soutien à l’isolement instantané, bien que les améliorations apportées aux fonctions [SQLSetConnectAttr](../../../relational-databases/native-client-odbc-api/sqlsetconnectattr.md) et [SQLGetInfo.](../../../relational-databases/native-client-odbc-api/sqlgetinfo.md)  
...
### <a name="sqlgetinfo"></a>SQLGetInfo  
 La fonction [SQLGetInfo](../../../relational-databases/native-client-odbc-api/sqlgetinfo.md) prend désormais en charge la valeur SQL_TXN_SS_SNAPSHOT ajoutée au type d’information SQL_TXN_ISOLATION_OPTION.  
  
 Pour obtenir de l’information sur la façon dont l’isolement instantané est pris en charge dans les transactions, consultez [le niveau d’isolement des transactions cursor](../../../relational-databases/native-client-odbc-cursors/properties/cursor-transaction-isolation-level.md).  
