...
ms.locfileid: "87243871"
---
# <a name="using-multiple-active-result-sets-mars-in-sql-server-native-client"></a>Utilisation de MARS (Multiple Active Result Sets) dans SQL Server Native Client
