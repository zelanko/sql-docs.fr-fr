...
ms.locfileid: "97418440"
---
# <a name="performing-asynchronous-operations-in-sql-server-native-client"></a>Exécution d’opérations asynchrones dans SQL Server Native Client
