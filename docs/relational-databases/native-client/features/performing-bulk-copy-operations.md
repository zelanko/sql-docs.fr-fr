...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
 ...
 Pour obtenir un exemple d’application qui illustre cette fonctionnalité, consultez [Bulk copier des données &#40;à&#41;l’aide de IRowsetFastLoad OLE DB](../../../relational-databases/native-client-ole-db-how-to/bulk-copy-data-using-irowsetfastload-ole-db.md).  
