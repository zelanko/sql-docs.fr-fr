...
|IDBProperties::GetPropertyInfo|IdbProperties::GetPropertyInfo inclura les nouvelles propriétés source de données d’initialisation SSPROP_INIT_SERVERSPN et ssprop_init_failoverpartnerspn n’ou les nouvelles propriétés de source de données SSPROP_AUTHENTICATION_METHOD et SSPROP_MUTUALLYAUTHENTICATED.|  
