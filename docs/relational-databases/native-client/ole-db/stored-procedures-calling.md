---
description: Procédures stockées-appel dans SQL Server Native Client
...
ms.locfileid: "88498812"
---
# <a name="stored-procedures---calling-in-sql-server-native-client"></a>Procédures stockées-appel dans SQL Server Native Client
