---
description: Procédures stockées-s’exécutant dans SQL Server Native Client
...
ms.locfileid: "88498834"
---
# <a name="stored-procedures---running-in-sql-server-native-client"></a>Procédures stockées-s’exécutant dans SQL Server Native Client
