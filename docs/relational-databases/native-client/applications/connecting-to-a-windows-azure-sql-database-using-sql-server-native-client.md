...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
  ...
  Pour un échantillon qui montre [!INCLUDE[ssSDSfull](../../../includes/sssdsfull-md.md)] comment [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] se connecter à un client natif en utilisant, voir [Développement: Comment faire sur les sujets (Azure SQL Database)](https://msdn.microsoft.com/library/ee621787.aspx).  
