...
ms.locfileid: "38979361"
---
# <a name="installing-sql-server-native-client"></a>Installation de SQL Server Native Client
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
 > Pour accéder au contenu relatif aux versions précédentes de SQL Server, consultez [l’installation de SQL Server Native Client](https://msdn.microsoft.com/library/ms131321(SQL.120).aspx).
