...
|**Network**|Les valeurs valides sont **dbnmpntw** (canaux nommés) et **dbmssocn** (TCP/IP).<br /><br /> Il s’agit d’une erreur pour spécifier à la fois une valeur pour le **réseau** (mot clé) et le protocole de préfixe dans les **Server** (mot clé).|  
