...
description: Découvrez comment créer des applications, avec des mises à niveau de MDAC, des fichiers d’en-tête et de bibliothèque et des chaînes de connexion, à l’aide de la bibliothèque de SQL Server Native Client.
ms.custom: ''
ms.date: 12/16/2019
ms.prod: sql
ms.reviewer: ''
