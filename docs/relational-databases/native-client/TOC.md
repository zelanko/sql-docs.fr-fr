...
# [Recherche de plus d’informations sur SQL Server Native Client](finding-more-sql-server-native-client-information.md)
...
# [Configuration système requise pour SQL Server Native Client](system-requirements-for-sql-server-native-client.md)
