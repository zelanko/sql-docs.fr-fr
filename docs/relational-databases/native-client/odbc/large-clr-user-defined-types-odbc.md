...
[!INCLUDE[SNAC_Deprecated](../../../includes/snac-deprecated.md)]
 ...
 Pour obtenir un exemple montrant la prise en charge ODBC pour les UDT volumineux du CLR, consultez [prennent en charge pour les UDT volumineux](../../../relational-databases/native-client-odbc-how-to/support-for-large-udts.md).  
...
|UDT CLR|SQL_SS_UDT|-151 (sqlncli.h)|  
 ...
 Le tableau suivant indique la correspondance entre la structure et le type ODBC C. CLR UDT est essentiellement un **varbinary** type avec des métadonnées supplémentaires.  
