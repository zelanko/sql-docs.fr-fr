---
title: Mode Asynchrone et SQLCancel (fr) Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
```  
 ...
 Une commande peut parfois rester longtemps en attente. Si l’application doit annuler la commande sans attendre une réponse, elle peut le faire en appelant **SQLCancel** avec la même poignée de déclaration que la commande en cours. C’est la seule fois **où SQLCancel** doit être utilisé. Certains programmeurs utilisent **SQLCancel** lorsqu’ils ont traité à mi-chemin à travers un ensemble de résultats et que vous souhaitez annuler le reste de l’ensemble de résultats. [SQLMoreResults](../../../relational-databases/native-client-odbc-api/sqlmoreresults.md) ou [SQLCloseCursor](../../../relational-databases/native-client-odbc-api/sqlclosecursor.md) devraient être utilisés pour annuler le reste d’un ensemble de résultats exceptionnels, et non **SQLCancel**.  
