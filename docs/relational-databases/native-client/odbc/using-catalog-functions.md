---
title: Utilisation des fonctions de catalogue (fr) Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
-   **SQLLinkedCatalogs**  
 ...
 Après avoir un nom de serveur lié [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] et un nom de catalogue, le pilote Native Client ODBC prend en charge l’obtention d’informations à partir du catalogue en utilisant un nom en deux parties de _linked_server_name_**.** _catalogue_ pour *CatalogName* sur les fonctions suivantes du catalogue ODBC :  
...
-   **SQLTables**  
 ...
 Le linked_server_name _en_deux parties **.** _catalogue_ est également pris en charge pour *FKCatalogName* et *PKCatalogName* sur [SQLForeignKeys](../../../relational-databases/native-client-odbc-api/sqlforeignkeys.md).  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [SQLTables (SQLTables)](../../../relational-databases/native-client-odbc-api/sqltables.md)   
