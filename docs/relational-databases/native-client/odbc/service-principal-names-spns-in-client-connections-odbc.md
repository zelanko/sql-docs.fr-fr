...
description: En savoir plus sur les attributs et les fonctions ODBC qui prennent en charge les noms de principal du service (SPN) dans les applications clientes.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
