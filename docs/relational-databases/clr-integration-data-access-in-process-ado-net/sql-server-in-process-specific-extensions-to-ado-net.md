---
title: SQL Server des extensions in-process à ADO.NET
description: Liens vers des articles sur les quatre extensions fonctionnelles principales de ADO.NET qui sont spécifiquement destinées à une utilisation in-process.
