---
title: Fonctions (Transact-SQL) de groupes de disponibilité AlwaysOn | Documents Microsoft
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
...
ms.locfileid: "33223754"
---
# <a name="always-on-availability-groups-functions-transact-sql"></a>Fonctions (Transact-SQL) de groupes de disponibilité AlwaysOn
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]

  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] fournit les fonctions de groupes de disponibilité AlwaysOn suivantes.  
