---
title: Fonctions de métadonnées système | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "85738544"
---
# <a name="system-metadata-functions"></a>Fonctions de métadonnées système
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] offre les fonctions de métadonnées suivantes.  
