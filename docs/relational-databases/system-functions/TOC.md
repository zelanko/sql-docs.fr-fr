# [Vue d’ensemble](system-functions-for-transact-sql.md)  
# [Groupes de disponibilité Always On](always-on-availability-groups-functions-transact-sql.md)  
...
# [Capture de données modifiées](change-data-capture-functions-transact-sql.md)  
## [CDC.fn_cdc_get_all_changes_ < instance_capture >](cdc-fn-cdc-get-all-changes-capture-instance-transact-sql.md)  
## [CDC.fn_cdc_get_net_changes_ < instance_capture >](cdc-fn-cdc-get-net-changes-capture-instance-transact-sql.md)  
...
## [Sys.fn_all_changes_ < instance_capture >](sys-fn-all-changes-capture-instance-transact-sql.md)  
## [Sys.fn_net_changes_ < instance_capture >](sys-fn-net-changes-capture-instance-transact-sql.md)  
# [Suivi des modifications](change-tracking-functions-transact-sql.md)  
...
## [AVEC CHANGE_TRACKING_CONTEXT](with-change-tracking-context-transact-sql.md)  
# [Collecteur de données](data-collector-functions-transact-sql.md)  
...
## [snapshots.fn_trace_getdata remplacé](snapshots-fn-trace-getdata-transact-sql.md)  
# [FileStream et FileTable](filestream-and-filetable-functions-transact-sql.md)  
...
## [Chemin d’accès](pathname-transact-sql.md)  
# [Gestion de sauvegarde](managed-backup-functions-transact-sql.md)  
...
# [Recherche en texte intégral et la recherche sémantique](full-text-search-and-semantic-search-functions-transact-sql.md)  
...
# [Métadonnées système](system-metadata-functions.md)  
...
# [Sécurité du système](system-security-functions.md)  
...
# [Trace du système](system-trace-functions.md)  
