---
title: Fonctions de sauvegarde managée (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
---
# <a name="managed-backup-functions-transact-sql"></a>Fonctions de sauvegarde managée (Transact-SQL)
