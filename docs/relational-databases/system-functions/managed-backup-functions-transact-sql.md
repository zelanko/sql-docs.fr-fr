---
title: Les fonctions de sauvegarde (Transact-SQL) managées | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "47808517"
---
# <a name="managed-backup-functions-transact-sql"></a>Fonctions managées sauvegarde (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2016-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2016-xxxx-xxxx-xxx-md.md)]

  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] fournit les fonctions suivantes pour [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)].  
