...
helpviewer_keywords: 
  - "Assistants [SQL Server Management Studio] Voir Assistant Gestion de partition"
...
---
# Aide sur l&#39;Assistant Gestion de partition via la touche F1
...
### Pour démarrer l'Assistant Gestion de partition  
 ...
 **Gérer les données partitionnées dans un scénario de fenêtre glissante**  
 ...
 ![Icône de flèche utilisée avec le lien Retour en haut](../../analysis-services/instances/media/uparrow16x16.png "Icône de flèche utilisée avec le lien Retour en haut") [Dans cette section](#Top)  
...
### Options des types de planification périodique  
...
### Options des types de planification unique  
