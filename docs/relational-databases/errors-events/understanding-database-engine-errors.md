...
description: Découvrez les attributs des erreurs déclenchées par le Moteur de base de données SQL Server et comment accéder aux messages d’erreur système et définis par l’utilisateur à partir de sys.messages.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
