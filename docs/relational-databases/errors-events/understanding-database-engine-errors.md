...
ms.topic: "article"
helpviewer_keywords: 
  - "erreurs [SQL Server], à propos des erreurs"
  - "erreurs [SQL Server], moteur de base de données"
  - "erreurs [SQL Server]"
  - "Moteur de base de données [SQL Server], erreurs"
...
# Pr&#233;sentation des erreurs du moteur de base de donn&#233;es
  Les erreurs déclenchées par le [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)] de [!INCLUDE[msCoName](../../includes/msconame-md.md)] ont les attributs décrits dans le tableau ci-après.  
...
```  
 ...
 Pour plus d’informations, consultez [sys.messages &#40;Transact-SQL&#41;](../Topic/sys.messages%20\(Transact-SQL\).md).  
