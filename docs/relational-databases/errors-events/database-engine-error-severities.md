...
description: Utilisez cette liste de niveaux de gravité pour comprendre le type de problème que SQL Server a rencontré lorsque le Moteur de base de données SQL Server génère une erreur.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
ms.reviewer: ''
