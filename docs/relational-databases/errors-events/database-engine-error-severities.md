...
helpviewer_keywords: 
  ...
  - "niveaux de gravité [SQL Server]"
  - "extraction de la gravité des erreurs"
  - "erreurs [SQL Server], gravité"
...
## Récupération de la gravité d'une erreur  
...
## Voir aussi  
 ...
 [Fonctions système &#40;Transact-SQL&#41;](../../t-sql/functions/system-functions-transact-sql.md)   
