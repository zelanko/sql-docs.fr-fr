...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Cette rubrique fournit un exemple fonctionnel d’usingOLE DB pour exécuter une mise à jour.  
