...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Cette application Active Server Pages (ASP) vous permet de mettre à jour les informations client dans la table Person.Contact dans la base de données AdventureWorks dans Microsoft [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]. L'application effectue les actions suivantes :  
