---
title: Exécution de requêtes XPath (SQLXML)
description: Découvrez comment exécuter une requête XPath sur un schéma de mappage à l’aide de classes managées SQLXML.
ms.date: 03/14/2017
ms.prod: sql
