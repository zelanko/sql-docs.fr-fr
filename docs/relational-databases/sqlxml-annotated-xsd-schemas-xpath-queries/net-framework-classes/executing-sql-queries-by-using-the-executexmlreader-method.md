---
title: "Exécution de requêtes SQL à l’aide de la méthode ExecuteXMLReader | Documents Microsoft"
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Au lieu d’utiliser la méthode ExecuteToStream, vous pouvez utiliser la méthode ExecuteXmlReader de l’objet SqlXmlCommand pour exécuter des commandes. Cette méthode retourne un objet XmlReader qui peut être utilisé pour un traitement ultérieur du résultat (qui, dans cet exemple, imprime les noms d’élément ou d’attribut et les valeurs).  
