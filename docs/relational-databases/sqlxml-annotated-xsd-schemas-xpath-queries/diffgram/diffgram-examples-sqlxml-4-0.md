...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Les exemples dans cette rubrique se composent de DiffGrams qui réalisent des opérations delete sur la base de données, update et insert. Avant d'utiliser les exemples, notez les points suivants :  
