...
description: Affichez des exemples de DiffGrams dans SQLXML 4,0 qui effectuent des opérations d’insertion, de mise à jour et de suppression dans une base de données.
ms.date: 03/04/2017
ms.prod: sql
