...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)][!INCLUDE[msCoName](../../../includes/msconame-md.md)] SQLXML 4.0 inclut trois fournisseurs de données qui peuvent insérer des données XML dans et récupérer des données XML à partir d’une base de données [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]:  
...
## <a name="in-this-section"></a>Dans cette section  
 [Fournisseur SQLXMLOLEDB &#40; SQLXML 4.0 &#41;](http://msdn.microsoft.com/library/fc489682-690a-4bb0-b5ac-237d376dc110)  
