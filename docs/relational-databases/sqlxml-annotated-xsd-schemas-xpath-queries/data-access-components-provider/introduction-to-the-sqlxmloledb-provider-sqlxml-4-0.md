...
description: En savoir plus sur le fournisseur SQLXMLOLEDB, un fournisseur OLE DB qui expose la fonctionnalité SQLXML via ActiveX Data Objects (ADO).
ms.date: 03/16/2017
ms.prod: sql
