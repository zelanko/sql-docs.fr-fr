---
title: Présentation de l’utilisation de requêtes XPath (SQLXML 4.0) | Microsoft Docs
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
...
-   **Ordre du document**  
     ...
     Dans SQLXML 4.0, l'ordre du document n'est pas toujours déterminé. Par conséquent et les prédicats numériques cet ordre de document d’utilisation des axes (tel que **suivant**) ne sont pas implémentées.  
    ...
    > [!NOTE]  
    >  Dans certains cas, le **key-fields** annotation ou des clés à partir de la **relation** annotation peut générer un ordre de document déterministe. Toutefois, il ne s’agit pas de la principale utilisation de ces annotations pour plus d’informations, consultez [colonnes clé identifiant à l’aide de SQL : Key-champs &#40;SQLXML 4.0&#41; ](../../relational-databases/sqlxml-annotated-xsd-schemas-using/identifying-key-columns-using-sql-key-fields-sqlxml-4-0.md) et [spécification de relations à l’aide de sql : relation &#40;SQLXML 4.0&#41;](../../relational-databases/sqlxml-annotated-xsd-schemas-using/specifying-relationships-using-sql-relationship-sqlxml-4-0.md).  
  
-   **Types de données**  
  
     SQLXML 4.0 présente des limitations dans l’implémentation de XPath **chaîne**, **nombre**, et **booléenne** types de données. Pour plus d’informations, consultez [les Types de données XPath &#40;SQLXML 4.0&#41;](../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/xpath-data-types-sqlxml-4-0.md).  
  
-   **Requêtes de produit croisé**  
