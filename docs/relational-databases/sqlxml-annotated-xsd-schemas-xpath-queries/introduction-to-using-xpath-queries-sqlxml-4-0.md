...
```  
 ...
 Le langage XPath est défini par le W3C (World Wide Web Consortium) en tant que langage de navigation standard. SQLXML 4.0 implémente un sous-ensemble de la spécification XPath W3C, décrit à l'adresse http://www.w3.org/TR/1999/PR-xpath-19991008.html.  
...
-   **Ordre du document**  
    ...
    > [!NOTE]  
    >  Dans certains cas, le **key-fields** annotation ou des clés de la **relation** annotation peut générer un ordre de document déterministe. Toutefois, cela n’est pas la principale utilisation de ces annotations pour plus d’informations, consultez [colonnes clé identifiant à l’aide de SQL : Key-champs &#40; SQLXML 4.0 &#41; ](../../relational-databases/sqlxml-annotated-xsd-schemas-using/identifying-key-columns-using-sql-key-fields-sqlxml-4-0.md) et [spécification de relations à l’aide de SQL : Relationship &#40; SQLXML 4.0 &#41; ](../../relational-databases/sqlxml-annotated-xsd-schemas-using/specifying-relationships-using-sql-relationship-sqlxml-4-0.md).  
  
-   **Types de données**  
  
     SQLXML 4.0 présente des limitations de l’implémentation de XPath **chaîne**, **nombre**, et **booléenne** des types de données. Pour plus d’informations, consultez [Types de données XPath &#40; SQLXML 4.0 &#41; ](../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/xpath-data-types-sqlxml-4-0.md).  
