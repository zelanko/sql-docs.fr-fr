---
title: Exécution de la charge en vrac de données XML (SQLXML)
description: Découvrez comment utiliser XML Bulk Load dans SQLXML 4.0 pour charger des données XML semi-structurées dans les tables Microsoft SQL Server.
ms.date: 03/17/2017
ms.prod: sql
...
## <a name="in-this-section"></a>Dans cette section  
 [Introduction à la charge en vrac XML &#40;SQLXML 4.0&#41;](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/bulk-load-xml/introduction-to-xml-bulk-load-sqlxml-4-0.md)  
 ...
 [Processus de génération record &#40;SQLXML 4.0&#41;](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/bulk-load-xml/record-generation-process-sqlxml-4-0.md)  
 Décrit le processus et les règles régissant la génération des enregistrements pour le chargement en masse XML.  
  
 [Interprétation de l’annotation &#40;SQLXML 4.0&#41;](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/bulk-load-xml/annotation-interpretation-sqlxml-4-0.md)  
 ...
 [XML Bulk Load Exemples &#40;SQLXML 4.0&#41;](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/bulk-load-xml/xml-bulk-load-examples-sqlxml-4-0.md)  
 Fournit un exemple de code utilisant le chargement en masse XML.  
  
 [Types de données et comportement de charge en vrac XML &#40;SQLXML 4.0&#41;](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/bulk-load-xml/data-types-and-xml-bulk-load-behavior-sqlxml-4-0.md)  
 Décrit le comportement du chargement en masse XML avec différents types dans XSD et XDR.  
  
 [Lignes directrices et limites de la charge en vrac XML &#40;SQLXML 4.0&#41;](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/bulk-load-xml/guidelines-and-limitations-of-xml-bulk-load-sqlxml-4-0.md)  
