...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Les exemples suivants montrent comment spécifier des axes dans les requêtes XPath.  
...
```  
 ...
 Le **enfant** axe est l’axe par défaut. Par conséquent, la requête peut être spécifiée sous la forme :  
