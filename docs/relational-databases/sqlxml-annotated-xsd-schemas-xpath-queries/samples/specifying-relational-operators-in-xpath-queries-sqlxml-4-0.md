---
title: Utiliser des opérateurs relationnels dans des requêtes XPath (SQLXML)
description: Découvrez comment utiliser des opérateurs relationnels dans des requêtes XPath SQLXML 4,0.
ms.date: 03/16/2017
ms.prod: sql
