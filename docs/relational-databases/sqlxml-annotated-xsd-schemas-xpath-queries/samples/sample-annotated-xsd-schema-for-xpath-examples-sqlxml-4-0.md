...
description: Affichez le schéma XSD annoté utilisé par les exemples de cette section pour illustrer des requêtes XPath dans SQLXML 4,0.
ms.date: 03/16/2017
ms.prod: sql
