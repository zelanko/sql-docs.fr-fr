...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Lorsque vous travaillez avec SQLXML 4.0, n’oubliez pas les éléments suivants :  
