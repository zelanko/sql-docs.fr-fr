...
|13|La sémantique de conversion antérieure à [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] pour DBTYPE_FILETIME est conservée. Si vous utilisez l’API Windows FileTimeToSystemTime, la précision en fractions de seconde est limitée à 1 milliseconde.|  
