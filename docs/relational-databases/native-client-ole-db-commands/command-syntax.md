---
description: Syntaxe de commande (Native Client OLE DB Provider)
...
ms.locfileid: "97439910"
---
# <a name="sql-server-native-client-command-syntax"></a>Syntaxe de commande SQL Server Native Client
