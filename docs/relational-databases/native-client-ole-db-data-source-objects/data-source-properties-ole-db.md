---
description: SQL Server Native Client les propriétés de la source de données (OLE DB)
...
ms.locfileid: "88455998"
---
#  <a name="sql-server-native-client-data-source-properties-ole-db"></a>SQL Server Native Client les propriétés de la source de données (OLE DB)
