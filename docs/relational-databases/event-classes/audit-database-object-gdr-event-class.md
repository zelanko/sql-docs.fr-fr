...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements **Audit Database Object GDR** se produit quand une instruction GRANT, REVOKE ou DENY, a été émise pour des objets de base de données, tels que des assemblys et des schémas.  
