...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements **Audit Server Scope GDR** se produit quand une instruction GRANT, REVOKE ou DENY est émise comme autorisation dans l’étendue d’un serveur, par exemple en cas de création d’une connexion.  
