...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements **Audit Add Login to Server Role** se produit chaque fois qu’une connexion est ajoutée ou supprimée dans un rôle serveur fixe. Cette classe d’événements est utilisée pour les procédures stockées **sp_addsrvrolemember** et **sp_dropsrvrolemember** .  
