...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements **Audit Server Operation** se produit quand des opérations d’audit de sécurité sont utilisées, telles que la modification des paramètres, des ressources, de l’accès externe ou de l’autorisation.  
