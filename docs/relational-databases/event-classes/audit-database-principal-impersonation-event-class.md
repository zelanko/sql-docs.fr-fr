---
description: Classe d'événements Audit Database Principal Impersonation
title: Classe d'événements Audit Database Principal Impersonation
ms.date: 06/03/2020
ms.prod: sql
ms.reviewer: ''
