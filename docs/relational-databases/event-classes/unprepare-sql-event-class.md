...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements Unprepare SQL indique que SqlClient, ODBC, OLE DB ou la bibliothèque de base de données a annulé (supprimé) la préparation d’une ou plusieurs instructions [!INCLUDE[tsql](../../includes/tsql-md.md)].  
