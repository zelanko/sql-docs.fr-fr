...
## <a name="tm-begin-tran-completed-event-class-data-columns"></a>TM : Colonnes de données de la classe d’événements TM: Begin Tran Completed  
