...
---
# <a name="server-event-category"></a>Catégorie d'événement Serveur
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]La catégorie d’événement **Serveur** contient des événements généraux relatifs au serveur.  
  
## <a name="in-this-section"></a>Dans cette section  
  
|Rubrique|Description|  
|-----------|-----------------|  
|[Classe d'événements Mount Tape](../../relational-databases/event-classes/mount-tape-event-class.md)|Indique qu'une requête de montage de bande a été reçue.|  
