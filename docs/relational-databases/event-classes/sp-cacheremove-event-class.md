...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements SP:CacheRemove indique que la procédure stockée a été supprimée du cache de plan.  
