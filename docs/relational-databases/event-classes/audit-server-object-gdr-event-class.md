...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements **Audit Server Object GDR** intervient quand une instruction GRANT, REVOKE ou DENY est émise, pour une autorisation d’objet serveur, par un utilisateur de Microsoft SQL Server.  
