...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements SP:StmtStarting indique qu’une instruction [!INCLUDE[tsql](../../includes/tsql-md.md)] à l’intérieur d’une procédure stockée a démarré.  
