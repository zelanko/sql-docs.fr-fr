...
ms.locfileid: "68125140"
---
# <a name="tm-commit-tran-starting-event-class"></a>TM : Commit Tran Starting (classe d'événements)
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]
  La classe d’événements TM : Commit Tran Starting indique qu’une requête COMMIT TRANSACTION démarre. La requête est envoyée depuis le client par le biais de l'interface de gestion des transactions. La colonne EventSubClass indique si une nouvelle transaction sera démarrée une fois la transaction actuelle validée.  
  
## <a name="tm-commit-tran-starting-event-class-data-columns"></a>TM : Commit Tran Starting, classe d’événements - Colonnes de données  
