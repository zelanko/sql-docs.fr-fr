...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements Lock:Released indique qu’un verrou sur une ressource (une page par exemple) a été débloqué.  
