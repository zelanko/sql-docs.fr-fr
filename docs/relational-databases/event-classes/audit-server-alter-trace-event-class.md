...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements **Audit Server Alter Trace** se produit pour toutes les instructions qui vérifient l’autorisation ALTER TRACE. Les instructions qui vérifient ALTER TRACE incluent celles utilisées pour créer et configurer une trace, ou bien pour définir un filtre sur une trace.  
