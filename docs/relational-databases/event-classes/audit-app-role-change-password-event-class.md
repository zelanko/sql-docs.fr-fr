...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements **Audit App Role Change Password** se produit quand le mot de passe d’un rôle d’application est modifié.  
