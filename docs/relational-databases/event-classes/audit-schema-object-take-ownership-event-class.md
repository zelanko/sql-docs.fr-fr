---
title: "Classe d&#39;&#233;v&#233;nements Audit Schema Object Take Ownership | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit Schema Object Take Ownership (classe d'événements)"
...
---
# Classe d&#39;&#233;v&#233;nements Audit Schema Object Take Ownership
...
## Colonnes de données de la classe d'événements Audit Schema Object Take Ownership  
...
|**ObjectType**|**int**|Valeur représentant le type de l'objet qui intervient dans l'événement. La valeur retournée pour cette colonne est une combinaison de la valeur correspondante dans la colonne **type** de l’affichage catalogue **sys.objects** et des valeurs répertoriées dans [ObjectType Trace Event Column](../../relational-databases/event-classes/objecttype-trace-event-column.md).|28|Oui|  
