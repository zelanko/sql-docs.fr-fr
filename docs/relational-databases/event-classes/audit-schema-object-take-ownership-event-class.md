...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements **Audit Schema Object Take Ownership** se produit quand les autorisations de modifier le propriétaire d’un objet de schéma (tel qu’une table, une procédure ou une fonction) sont vérifiées. Cela intervient lorsque l'instruction ALTER AUTHORIZATION est utilisée pour affecter un propriétaire à un objet.  
