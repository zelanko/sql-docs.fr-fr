...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements SQLTransaction permet de surveiller le début et la fin des transactions, notamment quand vous testez des applications, des déclencheurs ou des procédures stockées.  
