...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements **Audit Add Member to DB Role** intervient chaque fois qu’une connexion est ajoutée à un rôle de base de données ou qu’elle en est supprimée. Cette classe d’événements est utilisée avec les procédures stockées **sp_addrolemember**, **sp_changegroup**et **sp_droprolemember** .  
