...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements **Audit Add Role** se produit quand un rôle de base de données est ajouté ou supprimé dans une base de données. Cette classe d’événements est utilisée par les procédures stockées **sp_addrole** et **sp_droprole** .  
