...
ms.topic: "article"
helpviewer_keywords: 
  - "Showplan XML Statistics Profile (classe d'événements)"
...
---
# Classe d&#39;&#233;v&#233;nements Showplan XML Statistics Profile
...
## Colonnes de données de la classe d'événements Showplan XML Statistics Profile  
