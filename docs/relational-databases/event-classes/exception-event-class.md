...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements Exception indique qu’une exception s’est produite dans [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
