...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements SQL:StmtStarting indique qu’une instruction [!INCLUDE[tsql](../../includes/tsql-md.md)] a démarré.  
