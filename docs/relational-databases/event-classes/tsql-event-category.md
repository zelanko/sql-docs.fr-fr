...
---
# <a name="tsql-event-category"></a>Catégorie d'événements TSQL
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La catégorie d’événements **TSQL** contient des événements TSQL généraux.  
