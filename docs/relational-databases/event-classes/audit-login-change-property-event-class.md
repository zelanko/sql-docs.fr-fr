...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements **Audit Login Change Property** intervient quand vous utilisez la procédure **stockée sp_defaultdb** ou **sp_defaultlanguage**, ou bien l’instruction ALTER LOGIN pour modifier une propriété de connexion.  
