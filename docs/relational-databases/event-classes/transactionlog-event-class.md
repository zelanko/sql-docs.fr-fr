...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Utilisez la classe d’événements TransactionLog pour analyser l’activité des journaux de transactions dans une instance de [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)].  
