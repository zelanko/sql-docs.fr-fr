...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements User Error Message affiche le message d’erreur tel qu’il est vu par l’utilisateur en cas d’erreur ou d’exception. Le texte du message d'erreur s'affiche dans le champ TextData.  
