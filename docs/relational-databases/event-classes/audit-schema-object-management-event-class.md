...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements **Audit Schema Object Management** intervient pour indiquer la création, la modification ou la suppression d’un objet serveur.  
