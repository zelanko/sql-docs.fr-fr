...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La catégorie d’événements **Sessions** contient la classe d’événements **ExistingConnection**.  
