...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d'événements SQL:BatchCompleted indique que le lot [!INCLUDE[tsql](../../includes/tsql-md.md)] est exécuté.  
