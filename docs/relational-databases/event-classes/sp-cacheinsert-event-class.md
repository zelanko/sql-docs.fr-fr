...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements SP:CacheInsert indique que la procédure stockée a été insérée dans le cache de procédure.  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Classe d'événements SP:CacheMiss](../../relational-databases/event-classes/sp-cachemiss-event-class.md)  
