...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements EventLog indique que des événements ont été consignés dans le journal des événements [!INCLUDE[msCoName](../../includes/msconame-md.md)] Windows.  
