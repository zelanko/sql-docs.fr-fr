...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements **Audit Server Object Management** se produit dans le cas d’une instruction CREATE, ALTER ou DROP portant sur des objets de serveur.  
