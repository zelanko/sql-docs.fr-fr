...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] La classe d’événements **Audit Backup/Restore** se produit quand une commande de sauvegarde ou de restauration est exécutée.  
