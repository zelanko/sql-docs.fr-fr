...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe d’événements Missing Join Predicate indique qu’une requête en cours d’exécution n’a pas de prédicat de jointure. Ceci peut rendre la requête longue à exécuter. Pour plus d’informations sur les prédicats de jointure, consultez [Prédicats &#40;Transact-SQL&#41;](~/t-sql/queries/predicates.md).  
