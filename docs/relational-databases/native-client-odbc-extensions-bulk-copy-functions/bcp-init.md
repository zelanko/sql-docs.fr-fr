 ...
 *szTable*  
 ...
 Si *eDirection* est DB_OUT et qu’une instruction SELECT est spécifiée à l’aide de [bcp_control](../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-control.md) avant l’appel de [bcp_exec](../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-exec.md) , **bcp_init** *szTable* doit avoir la valeur null.  
  
 *szDataFile*  
 Nom du fichier utilisateur depuis ou vers lequel s'effectue la copie. Si les données sont copiées directement à partir de variables à l’aide de [bcp_sendrow](../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-sendrow.md), affectez la valeur null à *szDataFile* .  
...
## <a name="remarks"></a>Notes  
 Appelez **bcp_init** avant d’appeler toute autre fonction de copie en bloc. **bcp_init** effectue les initialisations nécessaires pour une copie en bloc de données entre la station [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]de travail et.  
