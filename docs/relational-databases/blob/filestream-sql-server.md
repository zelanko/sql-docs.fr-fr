...
helpviewer_keywords: 
  ...
  - "FILESTREAM [SQL Server], à propos"
  - "FILESTREAM [SQL Server], présentation"
...
##  Tâches associées  
 [Activer et configurer FILESTREAM](../../relational-databases/blob/enable-and-configure-filestream.md)  
  ...
  [Accéder aux données FILESTREAM avec Transact-SQL](../../relational-databases/blob/access-filestream-data-with-transact-sql.md)  
