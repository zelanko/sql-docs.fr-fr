...
description: Les applications qui lisent ou écrivent des données blob FILESTREAM peuvent rencontrer des erreurs de conflit avec les instructions Transact-SQL. Découvrez comment éviter ces types de conflits.
