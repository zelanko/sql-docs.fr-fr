...
ms.topic: "article"
helpviewer_keywords: 
  - "Pare-feu Windows [moteur de base de données], FILESTREAM"
  - "FILESTREAM [SQL Server], pare-feu Windows"
...
### Pour ouvrir les ports de partage de fichiers Windows sur un ordinateur qui exécute Windows 7  
