...
description: Découvrez comment créer une table pour stocker des données FILESTREAM dans SQL Server. Découvrez les colonnes et les attributs à utiliser dans le code Transact-SQL.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
