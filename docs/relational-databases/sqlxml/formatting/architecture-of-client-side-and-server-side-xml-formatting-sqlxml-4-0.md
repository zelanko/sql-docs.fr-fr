...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]L’illustration suivante montre l’architecture de code XML de mise en forme côté serveur.  
