...
description: Découvrez comment exécuter des requêtes SQLXML 4,0 dans une application COM en utilisant des extensions SQLXML pour ActiveX Data Objects (ADO).
ms.custom: ''
ms.date: 12/15/2019
ms.prod: sql
