...
helpviewer_keywords: 
  ...
  - "sécurité [collecteur de données]"
  - "collecteur de données [SQL Server], sécurité"
...
---
# S&#233;curit&#233; du collecteur de donn&#233;es
...
## Autorisations de configuration et d'utilisation du collecteur de données  
...
## Autorisations de configuration et d'utilisation de l'entrepôt de données de gestion  
