...
ms.topic: "article"
helpviewer_keywords: 
  - "collecteur de données [SQL Server], activité du secteur"
  - "activité du serveur [SQL Server]"
  - "rapports [SQL Server], collecte de données"
  - "rapports [SQL Server], utilisation du disque"
  - "jeu d’éléments de collecte [SQL Server], rapports"
  - "collecteur de données [SQL Server], rapports"
  - "rapports [SQL Server], statistiques sur les requêtes"
  - "rapports de statistiques sur les requêtes [SQL Server]"
  - "rapports d'utilisation de disque [SQL Server]"
...
### Rapport Jeu d'éléments de collecte Utilisation du disque  
...
#### Sous-rapport Jeu d'éléments de collecte Utilisation du disque - Base de données : <nom_base_de_données>  
...
#### Sous-rapport Utilisation du disque pour la base de données : <nom_base_de_données>  
...
### Sélection des données à inclure dans le rapport  
...
#### Rapport Historique des statistiques sur les requêtes  
...
#### Sous-rapport Détails de la requête  
...
#### Sous-rapport Détails du plan de requête  
...
## Rapport Historique de l'activité du serveur  
