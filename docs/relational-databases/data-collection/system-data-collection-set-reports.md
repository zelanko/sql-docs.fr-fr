...
description: Le collecteur de données fournit un rapport pour chaque jeu d’éléments de collecte de données système à des fins de surveillance de la capacité et des performances du système dans SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
