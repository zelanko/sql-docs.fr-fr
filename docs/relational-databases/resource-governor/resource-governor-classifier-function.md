...
description: Le processus de classification de SQL Server Resource Governor affecte les sessions entrantes à un groupe de charge de travail en fonction des caractéristiques de la session.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
...
2.  Exécution du déclencheur LOGON (se produit uniquement si des déclencheurs LOGON se trouvent dans l’instance)
