...
description: Découvrez comment créer ou configurer des entités Resource Governor à l’aide de la page Propriétés de Resource Governor dans SQL Server Management Studio.
ms.custom: ''
ms.date: 07/18/2016
ms.prod: sql
ms.reviewer: ''
