...
ms.topic: "article"
helpviewer_keywords: 
  - "Resource Governor, création de groupe de charge de travail"
  - "groupes de charge de travail [SQL Server], création"
...
-   **Pour créer un groupe de charge de travail, à l’aide de :**  [SQL Server Management Studio](#CreRPProp), [Transact-SQL](#CreRPTSQL)  
