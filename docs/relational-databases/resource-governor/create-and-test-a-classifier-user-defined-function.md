...
description: Découvrez comment créer et tester une fonction classifieur définie par l’utilisateur qui implique l’exécution d’instructions Transact-SQL dans l’Éditeur de requête de SQL Server Management Studio.
