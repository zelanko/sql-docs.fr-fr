...
helpviewer_keywords: 
  ...
  - "sauvegarde de bases de données [SQL Server], SQL Server Management Studio"
  - "sauvegardes [SQL Server], création"
  - "sauvegardes de bases de données [SQL Server], SQL Server Management Studio"
...
### Exemples  
#### **A.  Sauvegarde complète sur disque à l’emplacement par défaut**
...
#### **D.  Sauvegarde du service de stockage d’objets blob Microsoft Azure**
#### **Étapes courantes**  
...
1.  Exécutez l'instruction BACKUP DATABASE en spécifiant les éléments suivants :  
    ...
    |Option|Description|  
    |------------|-----------------|  
    |*Base de données*|Base de données à sauvegarder|  
