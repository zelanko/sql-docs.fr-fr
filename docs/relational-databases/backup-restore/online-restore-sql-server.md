...
description: Dans Microsoft SQL Server Entreprise, vous pouvez dans certains cas restaurer des données par restauration fragmentaire, de fichiers ou de pages pendant que la base de données est en ligne.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
