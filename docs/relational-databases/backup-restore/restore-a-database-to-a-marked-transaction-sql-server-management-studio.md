...
helpviewer_keywords: 
  - "restaurations de bases de données [SQL Server], transactions marquées"
  - "restauration des bases de données [SQL Server], transactions marquées"
...
### Pour restaurer une transaction marquée  
