---
title: "Sauvegarde et restauration des bases de donn&#233;es SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "07/29/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "récupération d'urgence [SQL Server], voir restauration [SQL Server]"
  - "sauvegardes [SQL Server]"
  - "restauration des bases de données [SQL Server]"
  - "sauvegarde [SQL Server], voir sauvegarde [SQL Server]"
  - "bases de données [SQL Server], restauration"
  - "sauvegarde des bases de données [SQL Server]"
  - "restaurer [SQL Server], voir restauration [SQL Server]"
  - "récupération d'urgence [SQL Server], voir sauvegarde [SQL Server]"
  - "sauvegarde [SQL Server]"
  - "Moteur de base de données [SQL Server], sauvegardes"
  - "bases de données [SQL Server], sauvegardes"
...
## Restaurer des journaux de transactions (mode de récupération complète)
### Utilisation d'SSMS  
