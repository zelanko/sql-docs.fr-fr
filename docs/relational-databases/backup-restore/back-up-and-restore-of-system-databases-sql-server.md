...
ms.topic: "article"
helpviewer_keywords: 
  - "bases de données système [SQL Server], sauvegarde et restauration"
  - "restauration des bases de données système [SQL Server]"
  - "sauvegarde [SQL Server], bases de données système"
  - "sauvegardes de bases de données [SQL Server], bases de données système"
  - "serveurs [SQL Server], sauvegarde"
