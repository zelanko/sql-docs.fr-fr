---
title: Récupérer des bases de données associées avec une transaction marquée
description: SQL Server prend en charge les marques nommées dans le journal des transactions afin de permettre une récupération vers une marque spécifique. Les marques peuvent être liées à un travail spécifique.
