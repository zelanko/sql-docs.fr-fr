---
title: "Utiliser PowerShell pour sauvegarder plusieurs bases de donn&#233;es dans le service de stockage d’objets Blob Microsoft Azure | Microsoft Docs"
ms.custom: ""
ms.date: "05/20/2016"
...
---
# Utiliser PowerShell pour sauvegarder plusieurs bases de donn&#233;es dans le service de stockage d’objets Blob Microsoft Azure
[!INCLUDE[tsql-appliesto-ss2016-xxxx-xxxx-xxx_md](../../includes/tsql-appliesto-ss2016-xxxx-xxxx-xxx-md.md)]

  Cette rubrique fournit des exemples de script pouvant être utilisés pour automatiser les sauvegardes dans le service de stockage d'objets blob Windows Azure à l'aide d'applets de commande PowerShell.  
...
### Sauvegarde complète de base de données pour toutes les bases de données (y compris les bases de données système)  
...
### Sauvegarde complète de base de données pour toutes les bases de données utilisateur  
...
### Sauvegarde complète des bases de données MASTER et MSDB (bases de données système) sur toutes les instances de SQL Server  
...
### Sauvegarde complète de toutes les bases de données utilisateur sur une instance de SQL Server  
...
### Sauvegarde complète des bases de données système (MASTER et MSDB) sur une instance de SQL Server  
