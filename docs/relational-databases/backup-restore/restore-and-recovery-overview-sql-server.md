...
ms.topic: "article"
helpviewer_keywords: 
  - "restauration des tables [SQL Server]"
  - "sauvegardes [SQL Server], scénarios de restauration"
  - "sauvegardes de bases de données [SQL Server], scénarios de restauration"
  - "restaurations de base de données [SQL Server]"
  - "restauration [SQL Server]"
  - "restaurations [SQL Server]"
  - "restaurations de tables [SQL Server]"
  - "restauration de bases de données [SQL Server], à propose de la restauration de bases de données"
  - "restaurations de bases de données [SQL Server], scénarios"
...
### Restrictions relatives à la récupération jusqu'à une date et heure  
