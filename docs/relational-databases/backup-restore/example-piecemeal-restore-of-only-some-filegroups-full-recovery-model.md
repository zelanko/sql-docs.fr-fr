---
title: 'Restauration fragmentaire : quelques groupes de fichiers (mode de récupération complète)'
description: Cet exemple montre la restauration fragmentaire de certains groupes de fichiers d’une base de données dans SQL Server, à l’aide du mode de récupération complète.
