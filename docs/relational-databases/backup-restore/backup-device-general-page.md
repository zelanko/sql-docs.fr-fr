...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Utilisez la page **Général** pour spécifier ou afficher les propriétés générales d’une unité logique de sauvegarde.  
