...
ms.topic: "article"
helpviewer_keywords: 
  - "sauvegarde [SQL Server], journaux des transactions"
  - "sauvegardes du journal des transactions [SQL Server], création"
  - "sauvegardes de journaux [SQL Server]"
  - "sauvegardes du journal des transactions [SQL Server], séquencement"
