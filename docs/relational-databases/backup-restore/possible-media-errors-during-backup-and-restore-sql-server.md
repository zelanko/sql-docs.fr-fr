...
ms.topic: "article"
helpviewer_keywords: 
  - "erreurs de support [SQL Server]"
  - "CONTINUE_AFTER_ERROR (option)"
  - "erreurs [SQL Server], sauvegardes"
  - "sauvegardes [SQL Server], erreurs"
  - "RESTORE VERIFYONLY, instruction"
  - "support de sauvegarde [SQL Server], gestion des erreurs"
  - "sommes de contrôle de page [SQL Server]"
  - "sommes de contrôle de sauvegarde [SQL Server]"
  - "sauvegarde [SQL Server], erreurs de support"
  - "instruction RESTORE, erreurs de support"
  - "NO_CHECKSUM, option"
...
---
# Erreurs de support possibles pendant les op&#233;rations de sauvegarde et de restauration (SQL Server)
...
-   [Sommes de contrôle de sauvegarde](#BckChecksums)  
  
-   [Réponse aux erreurs de somme de contrôle de page pendant une opération de sauvegarde ou de restauration](#ResponsetoPageChecksumErrors)  
...
1.  Avant d'écrire une page sur le support de sauvegarde, l'opération de sauvegarde vérifie les informations de niveau page : somme de contrôle de page ou détection de page endommagée, si elles existent. En l'absence d'informations, la sauvegarde ne peut pas vérifier la page. Non vérifiées, les pages sont incluses en l'état, et leur contenu est ajouté à la somme de contrôle de sauvegarde globale.  
    ...
    > [!NOTE]  
    >  Pour plus d'informations sur les sommes de contrôle de page et sur la détection de page endommagée, consultez l'option PAGE_VERIFY de l'instruction ALTER DATABASE. Pour plus d’informations, consultez [Options ALTER DATABASE SET &#40;Transact-SQL&#41;](../Topic/ALTER%20DATABASE%20SET%20Options%20\(Transact-SQL\).md).  
