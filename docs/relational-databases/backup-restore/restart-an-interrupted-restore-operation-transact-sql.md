---
title: Redémarrer une restauration interrompue (Transact-SQL)
description: Cet exemple montre comment redémarrer une opération de restauration interrompue dans SQL Server en utilisant Transact-SQL.
