...
description: Cet article explique comment restaurer des fichiers vers un nouvel emplacement SQL Server en utilisant SQL Server Management Studio ou Transact-SQL.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
