...
description: Cet article explique comment restaurer la base de données MASTER dans SQL Server à partir d’une sauvegarde complète de base de données, à l’aide de Transact-SQL.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
