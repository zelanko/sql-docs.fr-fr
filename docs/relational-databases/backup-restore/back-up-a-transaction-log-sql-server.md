...
ms.topic: "article"
helpviewer_keywords: 
  - "sauvegardes du journal des transactions [SQL Server], SQL Server Management Studio"
  - "sauvegardes [SQL Server], création"
  - "sauvegarde des journaux des transactions [SQL Server], SQL Server Management Studio"
...
-   Si une base de données est configurée pour le [mode de récupération](https://msdn.microsoft.com/library/ms189275.aspx) complète ou le mode de récupération utilisant les journaux de transactions, vous devez sauvegarder le journal des transactions assez régulièrement pour protéger vos données et éviter une [saturation de ce dernier](https://msdn.microsoft.com/library/ms175495.aspx). Cela tronque le journal et prend en charge la restauration de la base de données à un point précis dans le temps. Ce n’est pas vraiment idéal !
...
## Sauvegarder un journal des transactions à l’aide de SSMS  
...
## Sauvegarder un journal des transactions à l’aide de T-SQL  
