...
ms.topic: "article"
helpviewer_keywords: 
  - "sauvegarde [SQL Server], fin de journal"
  - "sauvegardes de journal des transactions [SQL Server], sauvegardes de la fin du journal"
  - "NO_TRUNCATE, clause"
  - "sauvegardes [SQL Server], sauvegardes de fichier journal"
  - "sauvegardes de la fin du journal"
  - "sauvegardes [SQL Server], sauvegardes de la fin du journal"
