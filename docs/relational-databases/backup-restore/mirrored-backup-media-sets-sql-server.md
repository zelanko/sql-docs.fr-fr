...
description: SQL Server prend en charge la mise en miroir des supports de sauvegarde, ce qui augmente la fiabilité des sauvegardes en réduisant l’impact des dysfonctionnements des unités de sauvegarde.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
