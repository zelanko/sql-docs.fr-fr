...
ms.topic: "article"
helpviewer_keywords: 
  - "supports de sauvegarde [SQL Server], à propos des supports de sauvegarde"
  - "supports de sauvegarde [SQL Server], à propos des supports de sauvegarde"
  - "sauvegardes [SQL Server], supports de sauvegarde"
  - "supports de sauvegarde [SQL Server]"
  - "en-têtes de support [SQL Server]"
  - "supports de sauvegarde [SQL Server], à propos des supports de sauvegarde"
  - "support de sauvegarde [SQL Server], supports de sauvegarde"
  - "sauvegardes [SQL Server], familles de supports"
  - "supports de sauvegarde [SQL Server], familles de supports"
  - "familles de supports [SQL Server]"
  - "sauvegardes [SQL Server], supports de sauvegarde"
...
```  
 ...
 ![En-tête de support de sauvegarde et premier jeu de sauvegarde sur 3 bandes](../../relational-databases/backup-restore/media/bnr-mediaset-new.gif "En-tête de support de sauvegarde et premier jeu de sauvegarde sur 3 bandes")  
...
> **REMARQUE !** NOINIT est l'option par défaut, mais elle indiquée pour des raisons de clarté.  
 ...
 Au cours de la restauration de sauvegardes, vous pouvez utiliser l'option FILE pour spécifier les sauvegardes à utiliser. L’exemple suivant illustre l’utilisation des clauses FILE **=***backup_set_file_number* lors de la restauration d’une sauvegarde complète de la base de données [!INCLUDE[ssSampleDBobject](../../includes/sssampledbobject-md.md)] suivie d’une sauvegarde différentielle sur le même jeu de supports. Le jeu de supports fait appel à trois bandes de sauvegardes qui figurent sur les lecteurs de bande `\\.\tape0`, `tape1`, et `tape2`.  
