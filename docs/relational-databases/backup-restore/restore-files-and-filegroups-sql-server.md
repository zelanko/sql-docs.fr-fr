...
description: Cet article explique comment restaurer des fichiers et des groupes de fichiers dans SQL Server à l’aide de SQL Server Management Studio ou de Transact-SQL.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
