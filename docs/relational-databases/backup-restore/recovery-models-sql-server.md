...
description: Dans SQL Server, un mode de récupération contrôle la façon dont les transactions sont journalisées, si le journal des transactions nécessite ou non une sauvegarde, et quelles opérations de restauration sont disponibles.
ms.custom: ''
ms.date: 07/16/2016
ms.prod: sql
