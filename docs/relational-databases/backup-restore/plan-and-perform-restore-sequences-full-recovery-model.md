...
ms.topic: "article"
helpviewer_keywords: 
  - "séquences de restauration [SQL Server], planification"
  - "mode de récupération complète [SQL Server], planification de séquences de restauration"
