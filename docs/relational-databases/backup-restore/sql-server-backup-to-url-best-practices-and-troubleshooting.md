---
title: "Meilleures pratiques et d&#233;pannage de sauvegarde SQL Server vers une URL | Microsoft Docs"
ms.custom: ""
ms.date: "08/09/2016"
...
---
# Meilleures pratiques et d&#233;pannage de sauvegarde SQL Server vers une URL
...
## Dépannage des problèmes de sauvegarde vers une URL ou de restauration depuis une URL  
...
2.  Placez le fichier de configuration dans le dossier Binn de l'instance de SQL Server. Par exemple, si mon instance SQL Server est installée sur le lecteur C de l’ordinateur, placez le fichier de configuration ici : *C:\Program Files\Microsoft SQL Server\MSSQL13.\<nom_instance>\MSSQL\Binn*.  
