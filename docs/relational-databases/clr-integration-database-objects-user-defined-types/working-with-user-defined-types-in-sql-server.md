...
description: Vous pouvez accéder à la fonctionnalité UDT dans SQL Server à partir du langage Transact-SQL à l’aide de la syntaxe de requête standard. Définir des tables et des colonnes UDT et manipuler des données UDT.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
