...
```  
 ...
 Si le type défini par l’utilisateur a été défini avec **** la valeur [!INCLUDE[tsql](../../includes/tsql-md.md)] true pour l’ordonnancement des octets, peut évaluer la colonne UDT dans une clause WHERE.  
