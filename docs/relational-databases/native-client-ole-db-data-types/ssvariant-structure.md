...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
  ...
  La structure **SSVARIANT** , qui est définie dans sqlncli. h, correspond à une valeur DBTYPE_SQLVARIANT dans le fournisseur OLEDB [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client.  
...
|fltRealVal|DBTYPE_R4|**float**|**VT_SS_R4**|Prend en charge le type de données[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] **réel** .|  
...
|cyMoneyVal|DBTYPE_CY|**LARGE_INTEGER**|**VT_SS_MONEY VT_SS_SMALLMONEY**|Prend en charge les types de données[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] **Money** et **smallmoney** .|  
...
|numNumericVal|DBTYPE_NUMERIC|**DB_NUMERIC**|**VT_SS_NUMERIC**|Prend en charge le type de données[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] **numérique** .|  
