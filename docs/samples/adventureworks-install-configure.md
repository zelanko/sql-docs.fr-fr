---
title: Installer & configurer l’exemple de base de données AdventureWorks
ms.prod: sql
ms.prod_service: sql
...
1. Sélectionnez le fichier, puis cliquez sur **OK**. 
