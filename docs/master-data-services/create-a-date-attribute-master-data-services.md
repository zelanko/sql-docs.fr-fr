...
ms.topic: "article"
helpviewer_keywords: 
  - "création d'attributs de date [Master Data Services]"
  - "attributs [Master Data Services], création d'attributs de date"
...
---
# Cr&#233;er un attribut de date (Master Data Services)
...
### Pour créer un attribut de date  
...
## Pour afficher la partie heure d'une valeur datetime  
