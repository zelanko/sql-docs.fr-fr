...
**Pour obtenir des instructions sur l’installation et la configuration d’IIS**, consultez [installation et configuration d’IIS](../../master-data-services/master-data-services-installation-and-configuration.md#InstallIIS).
