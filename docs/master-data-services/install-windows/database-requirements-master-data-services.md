---
title: "Configuration requise (Master Data Services) de base de données | Documents Microsoft"
ms.custom: 
ms.date: 03/14/2017
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Se connecter à une boîte de dialogue base de données Master Data Services](../../master-data-services/connect-to-a-master-data-services-database-dialog-box.md)   
 [Créer l’Assistant de base de données &#40; Gestionnaire de Configuration de Master Data Services &#41;](../../master-data-services/create-database-wizard-master-data-services-configuration-manager.md)  
