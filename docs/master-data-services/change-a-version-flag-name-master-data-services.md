...
---
# <a name="change-a-version-flag-name-master-data-services"></a>Renommer un indicateur de version (Master Data Services)
  Dans [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)], vous pouvez renommer un indicateur de version.  
