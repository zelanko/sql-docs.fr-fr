...
-   L’entité **Type du journal des transactions** doit être **Membre** ou **Attribut**.  
...
2.  Cliquez avec le bouton droit, puis, dans le menu qui s’affiche, cliquez sur **Afficher les transactions** ou sur **Afficher l’historique**.  
