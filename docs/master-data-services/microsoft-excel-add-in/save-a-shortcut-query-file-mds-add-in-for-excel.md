...
---
# Enregistrer un fichier de requ&#234;te de raccourci (Compl&#233;ment MDS pour Excel)
...
### Pour enregistrer un fichier de requête de raccourci  
...
2.  Ce paramètre est facultatif. Pour renommer la requête, cliquez sur la flèche sous **Enregistrer la requête** et cliquez sur **Gérer les requêtes**. Sélectionnez la requête et cliquez sur **Renommer**.  
