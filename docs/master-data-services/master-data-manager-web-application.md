...
description: Découvrez comment utiliser l’application Web Data Manager maître pour effectuer des tâches d’administration pour Master Data Services.
ms.custom: ''
ms.date: 12/20/2016
ms.prod: sql
ms.prod_service: mds
