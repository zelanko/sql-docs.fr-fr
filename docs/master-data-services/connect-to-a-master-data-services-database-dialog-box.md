---
description: Se connecter à la boîte de dialogue Base de données Master Data Services
title: Boîte de dialogue se connecter à une base de données MDS
