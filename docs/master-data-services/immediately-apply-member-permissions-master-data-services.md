...
ms.topic: "article"
helpviewer_keywords: 
  - "membres [Master Data Services], application immédiate d’autorisations"
  - "autorisations [Master Data Services], application immédiate d’autorisations de membre"
...
### Pour appliquer immédiatement des autorisations de membres de la hiérarchie  
