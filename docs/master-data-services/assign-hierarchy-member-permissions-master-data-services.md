...
ms.topic: "article"
helpviewer_keywords: 
  - "autorisations [Master Data Services], affectation d’autorisations de membres"
  - "membres [Master Data Services], affectation d’autorisations"
...
### Pour affecter des autorisations de membre de hiérarchie  
