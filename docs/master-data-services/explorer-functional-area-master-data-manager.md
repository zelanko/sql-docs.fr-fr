---
description: Zone fonctionnelle Explorateur (Master Data Manager)
title: Zone fonctionnelle Explorateur
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
ms.prod_service: mds
...
## <a name="data-management"></a>Gestion des données  
 ...
 [Modifier le type d’attribut &#40;Complément MDS pour Excel&#41;](../master-data-services/microsoft-excel-add-in/change-the-attribute-type-mds-add-in-for-excel.md)  
 ...
 [Annoter une transaction &#40;Master Data Services&#41;](../master-data-services/annotate-a-transaction-master-data-services.md)  
