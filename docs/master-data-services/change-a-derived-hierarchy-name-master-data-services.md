---
description: Modifier le nom d'une hiérarchie dérivée (Master Data Services)
title: Modifier le nom d'une hiérarchie dérivée
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
ms.prod_service: mds
...
6.  Dans la page **Modifier la hiérarchie dérivée** , cliquez sur l’icône crayon en regard du nom de la hiérarchie dérivée.  
