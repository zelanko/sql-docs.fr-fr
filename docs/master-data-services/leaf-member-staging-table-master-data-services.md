...
|**ImportStatus_ID**<br /><br /> Obligatoire|État du processus d'importation.|**0**, que vous spécifiez pour indiquer que l’enregistrement est prêt pour la mise en lots.<br /><br /> **1**, qui est affecté automatiquement et indique que le processus de site pour l’enregistrement a réussi.<br /><br /> **2**, qui est affecté automatiquement et indique que le processus de site pour l’enregistrement a échoué.|  
