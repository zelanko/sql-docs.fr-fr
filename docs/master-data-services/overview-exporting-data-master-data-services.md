...
ms.topic: "article"
helpviewer_keywords: 
  - "exportation de données [Master Data Services]"
  - "vues d’abonnement [Master Data Services]"
  - "vues d’abonnement [Master Data Services], à propos des vues d’abonnement"
...
---
# Vue d’ensemble&#160;: exportation de donn&#233;es [Master Data Services]
...
## Les vues d'abonnement peuvent devenir obsolètes  
