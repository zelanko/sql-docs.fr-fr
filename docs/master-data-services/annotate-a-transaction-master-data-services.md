...
ms.topic: "article"
helpviewer_keywords: 
  - "annotations [Master Data Services], pour les transactions"
...
---
# Annoter une transaction (Master Data Services)
...
### Pour annoter une transaction dans l'Explorateur  
...
### Pour annoter une transaction dans la zone Gestion des versions (administrateurs uniquement)  
