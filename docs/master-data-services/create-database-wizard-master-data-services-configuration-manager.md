---
title: Assistant Création d'une base de données
ms.custom: ''
ms.date: 03/20/2017
ms.prod: sql
ms.prod_service: mds
...
|**Classement par défaut SQL Server**|Sélectionnez cette option pour utiliser le paramètre de classement de base de données actuel de l'instance [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] spécifiée pour la nouvelle base de données.|  
