---
description: Supprimer des autorisations d'objet de modèle (Master Data Services)
title: Supprimer des autorisations d'objet de modèle
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
ms.prod_service: mds
...
7.  Dans le volet **Résumé des autorisations du modèle** , sélectionnez la ligne de l’autorisation à supprimer.  
