...
|**Ce serveur demande une connexion sécurisée (SSL)**|Chiffre les communications à l’aide du protocole TLS (Transport Layer Security), précédemment appelé protocole SSL (SSL).|  
