---
title: "Exemples de règles d’entreprise (Master Data Services) | Documents Microsoft"
ms.custom: 
ms.date: 01/05/2017
...
Pour obtenir des instructions sur la façon de déployer les exemples de modèles, consultez [Configuration et Installation de Services de données Master](../master-data-services/master-data-services-installation-and-configuration.md).  
...
Pour obtenir des instructions sur la configuration du site Web, consultez [Configuration et Installation de Services de données Master](../master-data-services/master-data-services-installation-and-configuration.md).  
