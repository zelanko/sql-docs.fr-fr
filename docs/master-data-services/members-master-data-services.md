---
title: Membres
description: Dans Master Data Services, les membres sont les données de référence physiques, telles qu’un vélo Road-150 dans une entité Product ou un client spécifique dans une entité Customer.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
ms.prod_service: mds
