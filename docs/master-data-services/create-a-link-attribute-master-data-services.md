...
ms.topic: "article"
helpviewer_keywords: 
  - "attributs [Master Data Services], créer des attributs de lien"
  - "création d'attributs de lien [Master Data Services]"
...
---
# Cr&#233;er un attribut de lien (Master Data Services)
...
### Pour créer un attribut de lien  
