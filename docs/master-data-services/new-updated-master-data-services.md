---
title: "Mise à jour - Master Data Services pour les documents de SQL Server | Documents Microsoft"
description: "Extraits de l’affichage de contenu mis à jour pour la documentation récemment modifié, de Master Data Services (MDS) pour Microsoft SQL Server."
services: na
documentationcenter: 
author: MightyPen
manager: jhubbard
...
---
# <a name="new-and-recently-updated-master-data-services-for-sql-server"></a>Nouveaux et mis à jour récemment : Master Data Services pour SQL Server
...
- *Zone de sujet :* &nbsp; **Master Data Services (MDS) pour SQL Server**.
