---
title: Versions
description: Vous pouvez créer plusieurs versions des données de référence dans un modèle dans Master Data Services. En savoir plus sur les versions et leur utilisation.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
ms.prod_service: mds
