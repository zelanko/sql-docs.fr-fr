...
ms.topic: "article"
helpviewer_keywords: 
  - "modèles [Master Data Services], autorisations effectives"
  - "autorisations [Master Data Services], chevauchements de modèles et de membres"
  - "membres [Master Data Services], autorisations effectives"
...
-   **Administrateur** autorisation au niveau du modèle remplace toutes les autres autorisations et l’autorisation d’accès (CRUD) de tous les niveaux de sub est modifiée.  
...
## Voir aussi  
 [Comment les autorisations sont déterminées & #40 ; Master Data Services & #41 ;](../master-data-services/how-permissions-are-determined-master-data-services.md)   
 [Chevauchement des utilisateurs et des autorisations de groupe & #40 ; Master Data Services & #41 ;](../master-data-services/overlapping-user-and-group-permissions-master-data-services.md)  
