...
ms.locfileid: "56662823"
---
# <a name="tutorial-script-objects-in-sql-server-management-studio"></a>Didacticiel : Générer des scripts d’objet dans SQL Server Management Studio
