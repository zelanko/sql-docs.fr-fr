...
ms.locfileid: "67140617"
---
# <a name="tutorial-script-objects-in-sql-server-management-studio"></a>Tutoriel : Générer des scripts d’objet dans SQL Server Management Studio
...
> [Étapes suivantes](ssms-configuration.md)
