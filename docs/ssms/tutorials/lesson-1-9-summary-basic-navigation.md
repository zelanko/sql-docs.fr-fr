...
---
# <a name="lesson-1-9---summary---basic-navigation"></a>Leçon 1-9 - Récapitulatif : Navigation de base
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] La zone de conception [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] peut être personnalisée en fonction de vos préférences personnelles et des besoins propres à votre activité.  
