...
description: La fonctionnalité Compléter le mot de Microsoft IntelliSense peut compléter votre saisie une fois que vous avez tapé un texte suffisamment long pour être identifié de manière unique, ou vous pouvez choisir parmi une liste de possibilités. Découvrez les quatre façons d’appeler cette fonctionnalité.
