...
description: 'Découvrez comment naviguer dans un document à l’aide de différentes techniques : définir un signet pour un emplacement afin de faciliter le retour à cet emplacement ; procéder à une recherche incrémentielle ; utiliser la souris et le clavier ; et utiliser la commande Atteindre pour accéder à une ligne en spécifiant son numéro de ligne.'
