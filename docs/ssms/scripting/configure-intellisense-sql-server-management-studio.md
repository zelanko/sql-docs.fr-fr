---
title: Configurer IntelliSense (SQL Server Management Studio)
description: La plupart des options IntelliSense sont activées par défaut. Découvrez comment désactiver une option IntelliSense et l'appeler à l'aide d'une commande de menu ou d'une combinaison de touches.
...
> [!NOTE]
> Azure Synapse Analytics ne prend pas en charge IntelliSense.
>
>
