---
description: Volet Schéma (Visual Database Tools)
title: Volet Schéma
...
|Icône|Type d'objet|  
|--------|---------------|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbi1.gif":::|Table de charge de travail|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbi2.gif":::|Requête ou Vue|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbi3.gif":::|Table liée|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dvudficon.gif":::|Fonction définie par l'utilisateur|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbi5.gif":::|Vue liée|  
...
|-----------------------|---------------|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbi7.gif":::<br /><br />:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbi8.gif":::<br /><br />:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbi9.gif":::<br /><br />:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbia.gif":::|Spécifie si une colonne de données apparaît dans l'ensemble des résultats de la requête (requête Select) ou si elle est utilisée dans une requête Update, Insert From, Make Table ou Insert Into. Sélectionnez la colonne pour l'ajouter aux résultats. Si **(Toutes les colonnes)** est sélectionné, toutes les colonnes de données figurent dans le résultat.<br /><br />L'icône utilisée avec la case à cocher dépend du type de requête que vous créez. Lorsque vous créez une requête Delete, vous ne pouvez pas sélectionner des colonnes individuelles.|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbib.gif":::<br /><br />:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbic.gif":::|Indique si la colonne de données sert à trier les résultats de la requête (fait partie d'une clause ORDER BY). L'icône indique A-Z pour un ordre de tri croissant et Z-A pour un ordre de tri décroissant.|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbid.gif":::|Indique si la colonne de données sert à créer un ensemble de résultats groupés (fait partie d'une clause GROUP BY) dans une requête d'agrégation.|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbie.gif":::|Indique si la colonne de données est incluse dans une condition de recherche de la requête (fait partie d'une clause WHERE ou HAVING).|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbif.gif":::|Indique si le contenu de la colonne de données est utilisé dans une synthèse (s'il est inclus dans une fonction d'agrégation telle que SUM ou AVG).|  
...
|------------------|---------------|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbih.gif":::|Jointure interne (créée avec l'opérateur « égal »).|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbii.gif":::|Jointure interne basée sur l'opérateur « plus grand que ». (L'opérateur affiché dans la ligne de jointure est celui qui est utilisé pour la jointure.)|  
...
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbio.gif ":::|Le Concepteur de requêtes et de vues ne peut pas déterminer le type de jointure|  
