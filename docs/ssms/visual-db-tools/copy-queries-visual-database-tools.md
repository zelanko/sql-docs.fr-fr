...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] Vous pouvez copier le corps d’une requête dans une nouvelle requête afin de l’utiliser comme point de départ.  
