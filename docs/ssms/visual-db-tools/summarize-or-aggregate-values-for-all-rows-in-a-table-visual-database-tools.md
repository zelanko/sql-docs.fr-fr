---
description: Synthétiser ou regrouper des valeurs de toutes les lignes d'une table (Visual Database Tools)
title: Synthétiser ou regrouper des valeurs de toutes les lignes d’une table
