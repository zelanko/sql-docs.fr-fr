---
description: Rapprocher les modifications effectuées par plusieurs utilisateurs (Visual Database Tools)
title: Rapprocher des modifications effectuées par plusieurs utilisateurs
