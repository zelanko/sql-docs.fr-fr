...
> [!NOTE]  
> Si vous souhaitez supprimer complètement une colonne de la requête, consultez [Remove Columns from Queries &#40;Visual Database Tools&#41;](../../ssms/visual-db-tools/remove-columns-from-queries-visual-database-tools.md).  
