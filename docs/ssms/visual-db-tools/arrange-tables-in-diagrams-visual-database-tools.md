...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] Vous pouvez réorganiser rapidement les tables dans un schéma de base de données afin d’afficher clairement chaque table et chaque relation.  
