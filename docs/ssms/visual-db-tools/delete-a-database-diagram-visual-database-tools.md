...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] Quand vous n’avez plus besoin d’un schéma de base de données, vous pouvez le supprimer.  
