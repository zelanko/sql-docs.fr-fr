---
description: Associer des conditions avec priorité à l'opérateur OR (Visual Database Tools)
title: Associer des conditions avec priorité à l’opérateur OR
