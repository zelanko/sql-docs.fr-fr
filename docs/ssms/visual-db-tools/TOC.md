...
# [Index/Clés, boîte de dialogue (Visual Database Tools)](indexes-keys-dialog-box-visual-database-tools.md)
...
# [Ouvrir le Concepteur de tables (Visual Database Tools)](open-table-designer-visual-database-tools.md)
