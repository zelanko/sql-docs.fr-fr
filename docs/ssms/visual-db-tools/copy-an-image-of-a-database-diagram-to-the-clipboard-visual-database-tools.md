---
description: Copier une image d’un diagramme de base de données dans le Presse-papiers (Visual Database Tools)
title: Copier une image d’un diagramme de base de données dans le Presse-papiers
