...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] Vous pouvez ajouter rapidement à un schéma de base de données toutes les tables impliquées dans une relation avec une table sélectionnée.  
