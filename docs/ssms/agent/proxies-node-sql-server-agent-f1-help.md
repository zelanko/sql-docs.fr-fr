...
Cette section contient l'aide obtenue via la touche F1 pour le nœud **Proxies** de l'Explorateur d'objets de [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull_md.md)].  
