...
## <a name="download-ssms-180-ga"></a>Télécharger SSMS 18.0 (DG)

**La version Disponibilité générale (DG) de SSMS 18.0, maintenant disponible, est la nouvelle génération de *SQL Server Management Studio* avec prise en charge de [!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)] !**

**[![télécharger](../ssdt/media/download.png) Télécharger SQL Server Management Studio 18.0 (DG)](https://go.microsoft.com/fwlink/?linkid=2088649)**

SSMS 18.0 n’est plus en préversion. Il s’agit de la première version en disponibilité générale (DG) de SSMS 18.0. Si des préversions de SSMS 18.0 sont installées, désinstallez-les avant d’installer SSMS 18.0 DG.

**Informations sur la version**

- Numéro de version : 18.0 (DG)<br>
...
## <a name="available-languages-ssms-180-ga"></a>Langues disponibles (SSMS 18.0 DG)

Cette version de SSMS peut être installée dans les langues suivantes :

SQL Server Management Studio 18.0 (DG) :<br>
...
Aucune option de mise à niveau n’est disponible à l’heure actuelle. Si une préversion précédente de SSMS 18.0 est installée, désinstallez-la avant d’installer SSMS 18.0 DG.
...
## <a name="new-in-this-release-ssms-180-ga"></a>Nouveautés de cette version (SSMS 18.0 DG)

SSMS 18.0 (DG) est la dernière version de SQL Server Management Studio. La génération 18.x de SSMS prend en charge presque tous les composants de SQL Server 2008 à la préversion de SQL Server 2019.

Pour plus d’informations sur les nouveautés de cette version, voir les [notes de publication de SSMS](release-notes-ssms.md).

## <a name="supported-sql-offerings-ssms-180-ga"></a>Offres SQL prises en charge (SSMS 18.0 DG)
...
## <a name="supported-operating-systems-ssms-180-ga"></a>Systèmes d’exploitation pris en charge (SSMS 18.0 DG)
...
## <a name="release-notes-ssms-180-ga"></a>Notes de publication (SSMS 18.0 DG)

- L’**Assistant de création de runtime d’intégration de SSIS** affiche uniquement les bases de données SQL sous un abonné lorsque le compte client appartient à plusieurs abonnés.
