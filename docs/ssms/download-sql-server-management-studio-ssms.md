...
>[!NOTE]
> L’installation de SSMS 17.x ne se met pas à niveau ou ne remplace pas les versions précédentes de SSMS.  SSMS 17.x s’installe côte à côte avec les versions antérieures afin que les deux versions soient disponibles.
> Si un ordinateur contient des installations côte à côte de SSMS, vérifiez que vous démarrez la version correcte adaptée à vos besoins spécifiques.
