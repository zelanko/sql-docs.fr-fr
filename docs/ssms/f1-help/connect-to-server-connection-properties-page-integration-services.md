---
title: "Se connecter au serveur SSIS (page Propriétés de connexion) | Microsoft Docs"
ms.custom: 
ms.date: 01/19/2017
...
Utilisez cet onglet pour afficher ou spécifier les options de connexion à [!INCLUDE[msCoName](../../includes/msconame_md.md)] [!INCLUDE[ssISnoversion](../../includes/ssisnoversion_md.md)] ou d’inscription de [!INCLUDE[ssIS](../../includes/ssis_md.md)] dans **Serveurs inscrits**. **Se connecter** et **Options** s’affichent uniquement dans cette boîte de dialogue lors d’une connexion. **Tester** et **Enregistrer** s’affichent uniquement dans cette boîte de dialogue lors de l’inscription de [!INCLUDE[ssIS](../../includes/ssis_md.md)].  
  
## <a name="options"></a>Options  
**Numéro de port**  
Entrez le numéro de port utilisé par [!INCLUDE[ssIS](../../includes/ssis_md.md)].  
...
**Testerer**  
Quand vous inscrivez [!INCLUDE[ssIS](../../includes/ssis_md.md)] dans **Serveurs inscrits**, cliquez ici pour tester la connexion.  
