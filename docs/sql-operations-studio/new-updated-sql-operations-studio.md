...
### <a name="1-nbsp-download-and-install-sql-operations-studio-previewdownloadmd"></a>1. &nbsp;[Télécharger et installer des opérations de SQL Studio (version préliminaire)](download.md)
