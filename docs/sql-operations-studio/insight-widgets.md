---
title: Utiliser des widgets d’analyse pour surveiller les serveurs et bases de données SQL Operations Studio (version préliminaire) | Microsoft Docs
description: Découvrez les widgets d’analyse dans SQL Operations Studio (version préliminaire).
ms.custom: tools|sos
ms.date: 11/15/2017
ms.prod: sql
ms.technology: ssops
