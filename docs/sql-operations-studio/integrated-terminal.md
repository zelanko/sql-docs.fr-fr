---
title: Terminal intégrée dans SQL Operations Studio (preview) | Documents Microsoft
description: En savoir plus sur le terminal intégré dans SQL Operations Studio (preview).
ms.custom: tools|sos
ms.date: 11/15/2017
