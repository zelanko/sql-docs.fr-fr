---
title: Utiliser l’authentification Active Directory (Kerberos) lors de la connexion avec SQL Operations Studio (version préliminaire) | Microsoft Docs
description: Découvrez comment activer l’authentification Kerberos utiliser l’authentification Active Directory pour SQL Operations Studio (version préliminaire)
ms.custom: tools|sos
ms.date: 11/17/2017
ms.prod: sql
...
Modifier le `/etc/krb5.conf` dans un éditeur de votre choix. Configurer les clés suivantes
