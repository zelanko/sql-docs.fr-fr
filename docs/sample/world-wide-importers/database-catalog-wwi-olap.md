...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Explications des schémas, tables et procédures stockées dans la base de données WideWorldImportersDW. 
