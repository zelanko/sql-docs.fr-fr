...
- [SQL Server Management Studio](https://msdn.microsoft.com/library/mt238290.aspx). Pour obtenir les meilleurs résultats utilisent la version de juin 2016 ou version ultérieure.
