...
Consultez le fichier exemple-scripts.zip qui est inclus dans le [version](http://go.microsoft.com/fwlink/?LinkID=800630) de l’exemple, ou reportez-vous au code source :
