...
|**MAINTENANT ()** (ODBC 1.0)|Retourne la date et l’heure en tant qu’une valeur d’horodatage.|  
|**TRIMESTRE (** *date_exp* **)** (ODBC version 1.0)|Retourne le trimestre dans *date_exp* en tant qu’entier dans la plage de 1 à 4, où 1 représente le 1er janvier au 31 mars.|  
