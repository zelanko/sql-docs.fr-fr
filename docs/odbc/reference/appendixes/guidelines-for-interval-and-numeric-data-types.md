---
title: Lignes directrices pour les types d’intervalles et de données numériques (en anglais seulement) Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
Les sections suivantes traitent des types d’intervalle et de données numériques.  
