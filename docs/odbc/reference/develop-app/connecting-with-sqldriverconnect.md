...
-   [Informations de connexion spécifiques au pilote](../../../odbc/reference/develop-app/driver-specific-connection-information.md)  
  
-   [Demander à l’utilisateur des informations de connexion](../../../odbc/reference/develop-app/prompting-the-user-for-connection-information.md)  
  
-   [Connexion à l’aide de Sources de données fichier](../../../odbc/reference/develop-app/connecting-using-file-data-sources.md)  
  
-   [Se connecter directement à des pilotes](../../../odbc/reference/develop-app/connecting-directly-to-drivers.md)
