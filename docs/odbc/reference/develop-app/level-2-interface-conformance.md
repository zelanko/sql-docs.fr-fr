...
Niveau de la conformité de l’interface de niveau 2 inclut des fonctionnalités : niveau de conformité de l’interface de niveau 1 ainsi que les fonctionnalités suivantes :  
