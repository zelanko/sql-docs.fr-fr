---
title: 'Étape 4 a : extraire les résultats | Microsoft Docs'
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
L’étape suivante consiste à extraire les résultats, comme indiqué dans l’illustration suivante.  
 ...
 À présent, l’application retourne à le « Étape 3 : générer et exécuter une instruction SQL » pour exécuter une autre instruction dans la même transaction ; ou passe à « Étape 5 : la Transaction de validation » de valider ou restaurer la transaction.
