---
title: 'Étape 3 : Créer et exécuter une instruction SQL | Microsoft Docs'
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|**Mise à jour**, **supprimer**, ou **insérer**|[Étape 4b : Extraire le nombre de lignes](../../../odbc/reference/develop-app/step-4b-fetch-the-row-count.md)|  
