---
title: Exemples de traitement diagnostique Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "81305850"
---
# <a name="diagnostic-handling-examples"></a>Exemples de gestion des diagnostics
Les exemples suivants montrent comment divers composants d’une connexion ODBC peuvent générer des messages diagnostiques et comment divers conducteurs pourraient retourner le diagnostic à l’application avec **SQLGetDiagRec**.  
