---
title: Instructions SQL | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
Les applications ODBC effectuent presque tous les accès de base de données en exécutant des instructions SQL. Le formulaire de ces instructions, codé en dur ou construit au moment de l’exécution interopérable ou des données spécifiques à la source et ainsi de suite, dépend des besoins de l’application.  
