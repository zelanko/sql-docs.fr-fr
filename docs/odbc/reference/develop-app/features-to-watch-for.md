...
-   [Plusieurs instructions actives et connexions](../../../odbc/reference/develop-app/multiple-active-statements-and-connections.md)  
  
-   [Prise en charge de la transaction dans le SGBD](../../../odbc/reference/develop-app/transaction-support-in-dbmss.md)  
  
-   [La validation et le comportement de restauration](../../../odbc/reference/develop-app/commit-and-rollback-behavior.md)  
...
-   [Grammaire SQL ODBC](../../../odbc/reference/develop-app/odbc-sql-grammar.md)  
