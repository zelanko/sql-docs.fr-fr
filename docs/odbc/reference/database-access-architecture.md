...
-   [Réseau de base de données Access](../../odbc/reference/network-database-access.md)  
  
-   [Architectures d’accès de base de données standard](../../odbc/reference/standard-database-access-architectures.md)  
  
-   [La Solution d’ODBC](../../odbc/reference/the-odbc-solution.md)
