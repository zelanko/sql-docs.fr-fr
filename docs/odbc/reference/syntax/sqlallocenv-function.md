---
title: Fonction de SQLAllocEnv | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 **Résumé**  
 Dans ODBC 3. *x*, ODBC 2. *x* fonction **SQLAllocEnv** a été remplacé par **SQLAllocHandle**. Pour plus d’informations, consultez [SQLAllocHandle, fonction](../../../odbc/reference/syntax/sqlallochandle-function.md).  
