...
|HY010|Erreur de séquence de fonction|(DM) **SQL_ATTR_ODBC_VERSION** n’a pas encore été défini via **SQLSetEnvAttr**. Vous n’avez pas besoin de définir explicitement **SQL_ATTR_ODBC_VERSION** si vous utilisez **SQLAllocHandleStd**.|  
