---
title: Fonction SQLNumParams | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 **SQLNumParams** peut être appelée uniquement après que **SQLPrepare** a été appelée.  
