---
title: Fonction de SQLParamOptions | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 **Résumé**  
 La fonction ODBC 2.0 **SQLParamOptions** a été remplacé dans ODBC 3. *x* par les appels à [SQLSetStmtAttr](../../../odbc/reference/syntax/sqlsetstmtattr-function.md).  
