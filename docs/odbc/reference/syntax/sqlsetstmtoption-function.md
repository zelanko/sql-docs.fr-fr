 ...
 **Résumé**  
 Dans ODBC 3 *. x*, la fonction ODBC 2,0 **SQLSetStmtOption** a été remplacée par **SQLSetStmtAttr**. Pour plus d’informations, consultez [SQLSetStmtAttr](../../../odbc/reference/syntax/sqlsetstmtattr-function.md).  
