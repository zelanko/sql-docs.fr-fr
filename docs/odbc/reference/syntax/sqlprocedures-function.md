...
|NUM_INPUT_PARAMS (ODBC 2,0)|4|N/A|réservé à une utilisation future. Les applications ne doivent pas s’appuyer sur les données retournées dans ces colonnes de résultats.|  
|NUM_OUTPUT_PARAMS (ODBC 2,0)|5|N/A|réservé à une utilisation future. Les applications ne doivent pas s’appuyer sur les données retournées dans ces colonnes de résultats.|  
|NUM_RESULT_SETS (ODBC 2,0)|6|N/A|réservé à une utilisation future. Les applications ne doivent pas s’appuyer sur les données retournées dans ces colonnes de résultats.|  
