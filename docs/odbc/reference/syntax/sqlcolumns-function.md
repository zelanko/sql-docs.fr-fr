...
|TYPE_NAME (ODBC 1.0)|6\.|Varchar non NULL|Nom de type de données dépendant de la source de données ; par exemple, « CHAR », « VARCHAR », « Argent », « VARBINAR LONG » ou « CHAR () pour les données BIT ».|  
