...
|Mot clé|Usage|  
|-------------|-----------|  
|**APILevel**|Nombre indiquant le niveau de conformité de l’interface ODBC pris en charge par le pilote :<br /><br /> 0 = Aucun(e)<br /><br /> 1 = niveau 1 pris en charge<br /><br /> 2 = niveau 2 pris en charge<br /><br /> Ce doit être identique à la valeur retournée pour l’option SQL_ODBC_INTERFACE_CONFORMANCE dans **SQLGetInfo**.|  
