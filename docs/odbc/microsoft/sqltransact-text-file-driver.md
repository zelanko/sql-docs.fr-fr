---
title: SQLTransact (pilote du fichier texte) | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32905004"
---
# <a name="sqltransact-text-file-driver"></a>SQLTransact (pilote du fichier texte)
> [!NOTE]  
