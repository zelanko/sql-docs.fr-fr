---
title: SQLTransact (pilote de fichier texte) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "62521219"
---
# <a name="sqltransact-text-file-driver"></a>SQLTransact (pilote de fichier texte)
> [!NOTE]  
