...
-   [À l’aide d’Applications 16 bits et 32 bits avec les pilotes 32 bits](../../odbc/microsoft/using-16-bit-and-32-bit-applications-with-32-bit-drivers.md)  
  
-   [Pilotes de bureau de base de données ODBC de Microsoft](../../odbc/microsoft/microsoft-odbc-desktop-database-drivers.md)  
