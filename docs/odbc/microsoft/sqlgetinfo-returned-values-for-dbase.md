---
title: Valeurs de retournées par SQLGetInfo pour dBASE | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|SQL_IDENTIFIER_CASE|SQL_IC_UPPER (le qualificateur est retourné en casse mixte pour que Windows NT puissent localiser le répertoire.)|  
...
|SQL_MAX_COLUMNS_IN_INDEX|0 (limiter inconnu ou non Applicable)|  
