---
title: SQLGetInfo Valeurs retournées pour dBASE (fr) Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|SQL_IDENTIFIER_CASE|SQL_IC_UPPER (Le qualificatif est retourné dans le cas mixte afin que Windows NT peut localiser le répertoire.)|  
