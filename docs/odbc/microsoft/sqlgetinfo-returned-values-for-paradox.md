---
description: Valeurs retournées par SQLGetInfo pour Paradox
title: La valeur de SQLGetInfo a été retournée pour Paradox | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
