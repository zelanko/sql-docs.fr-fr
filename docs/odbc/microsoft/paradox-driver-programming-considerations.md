...
-   [Définition des Options par programmation pour le pilote Paradox](../../odbc/microsoft/setting-options-programmatically-for-the-paradox-driver.md)  
  
-   [Types de données Paradox](../../odbc/microsoft/paradox-data-types.md)  
  
-   [SQLGetInfo les valeurs renvoyées pour Paradox](../../odbc/microsoft/sqlgetinfo-returned-values-for-paradox.md)  
