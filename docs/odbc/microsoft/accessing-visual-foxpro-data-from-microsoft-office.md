---
title: L’accès aux données Visual FoxPro à partir de Microsoft Office | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "63198592"
---
# <a name="accessing-visual-foxpro-data-from-microsoft-office"></a>Accès aux données Visual FoxPro à partir de Microsoft Office
Vous pouvez utiliser le pilote ODBC Visual FoxPro Microsoft pour accéder aux données Visual FoxPro à partir de vos applications Microsoft Office pour Windows 95 ou Windows 98.  
  
 Cette section contient les rubriques suivantes.  
  
|Pour|Consultez|  
|--------|---------|  
|Utiliser Microsoft Access|[Interrogation et mise à jour de données Visual FoxPro à partir d’Access](../../odbc/microsoft/querying-and-updating-visual-foxpro-data-from-microsoft-access.md)<br /><br /> [Importation de données Visual FoxPro dans Microsoft Access](../../odbc/microsoft/importing-visual-foxpro-data-into-microsoft-access.md)|  
