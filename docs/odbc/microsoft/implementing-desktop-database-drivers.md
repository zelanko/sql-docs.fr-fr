...
-   [Fichiers à utiliser avec les pilotes de la base de données de bureau](../../odbc/microsoft/files-to-use-with-the-desktop-database-drivers.md)  
  
-   [Fichiers de composants ODBC](../../odbc/microsoft/odbc-component-files.md)  
...
-   [Tests de diagnostic pour les pilotes de la base de données de bureau](../../odbc/microsoft/diagnostics-for-desktop-database-drivers.md)  
  
-   [Fonctions acceptant des paramètres de chaîne](../../odbc/microsoft/functions-accepting-string-parameters.md)  
  
-   [Conformité SQL-92](../../odbc/microsoft/sql-92-compliance.md)  
  
-   [Adresse de base des pilotes](../../odbc/microsoft/base-address-of-drivers.md)  
  
-   [DLL d’installation](../../odbc/microsoft/setup-dll.md)  
  
-   [DLL de traduction et les pilotes de base de données de bureau](../../odbc/microsoft/translation-dlls-and-desktop-database-drivers.md)  
  
-   [Compatibilité de pilote de base de données de bureau](../../odbc/microsoft/desktop-database-driver-compatibility.md)  
  
-   [Problèmes de performances du pilote bureau de base de données](../../odbc/microsoft/desktop-database-driver-performance-issues.md)
