...
Pour télécharger le pilote ODBC Visual FoxPro, consultez [le site de téléchargement du pilote ODBC Visual FoxPro](http://go.microsoft.com/fwlink/?LinkId=121318).  
...
-   [Versions prises en charge de FoxPro](../../odbc/microsoft/supported-versions-of-foxpro.md)  
  
-   [Configurer le pilote ODBC Visual FoxPro](../../odbc/microsoft/setting-up-the-visual-foxpro-odbc-driver.md)  
