---
title: SQLBindCol (le pilote ODBC Visual FoxPro) | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32902954"
---
# <a name="sqlbindcol-visual-foxpro-odbc-driver"></a>SQLBindCol (le pilote ODBC Visual FoxPro)
> [!NOTE]  
