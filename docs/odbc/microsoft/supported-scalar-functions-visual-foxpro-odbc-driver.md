---
title: Fonctions Scalar prises en charge (Visual FoxPro ODBC Driver) Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
Le visual FoxPro ODBC Driver prend en charge trois types de fonctions scalaires telles que définies dans la grammaire SQL ODBC : les fonctions de chaîne, de numérique et d’heure et de date.  
