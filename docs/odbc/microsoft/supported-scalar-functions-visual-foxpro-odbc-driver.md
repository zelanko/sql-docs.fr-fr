---
title: Prise en charge des fonctions scalaires (pilote ODBC de Visual FoxPro) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
Le pilote ODBC Visual FoxPro prend en charge trois types de fonctions scalaires définies dans la grammaire SQL ODBC : chaîne, numériques et fonctions de date et heure.  
