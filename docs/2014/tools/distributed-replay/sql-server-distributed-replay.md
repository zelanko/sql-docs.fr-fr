...
## <a name="benefits-of-distributed-replay"></a>Avantages de Distributed Replay  
 ...
 La [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] fonctionnalité Distributed Replay peut utiliser plusieurs ordinateurs pour relire les données de trace et simuler une charge de travail stratégique. Utilisez Distributed Replay pour tester la compatibilité des applications, tester les performances ou planifier la capacité.  
