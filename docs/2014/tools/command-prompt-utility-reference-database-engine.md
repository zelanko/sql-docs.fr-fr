...
|[Utilitaire Ssms](../ssms/ssms-utility.md)|Sert à démarrer [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)] à partir d'une invite de commandes.|
 ...
 **Pour accéder [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] à Configuration Manager à l’aide de[!INCLUDE[win8](../includes/win8-md.md)]**  
