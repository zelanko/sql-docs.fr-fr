 ...
 **Nom d’hôte**  
 Affiche le nom de l’ordinateur ou du cluster exécutant [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] le service.  
