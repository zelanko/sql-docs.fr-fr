...
-   [Exemple de fichier avec une charge de travail Inline d’entrée XML &#40;DTA&#41;](xml-input-file-sample-with-inline-workload-dta.md)  
  
-   [Exemple de fichier avec la Configuration spécifiée par l’utilisateur d’entrée XML &#40;DTA&#41;](xml-input-file-sample-with-user-specified-configuration-dta.md)  
