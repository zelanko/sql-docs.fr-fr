---
title: À l’aide de SQLXML des Classes managées | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
## <a name="in-this-section"></a>Dans cette section  
 [Exécution de requêtes SQL &#40;Classes managées SQLXML&#41;](../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/net-framework-classes/sqlxml-4-0-net-framework-support-managed-classes.md)  
