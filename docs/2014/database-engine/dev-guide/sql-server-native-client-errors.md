---
title: Erreurs SQL Server Native Client | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "62780646"
---
# <a name="sql-server-native-client-errors"></a>Erreur de SQL Server Native Client
  Cette section contient la rubrique qui décrit une erreur pouvant se produire lorsque vous installez [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client.  
