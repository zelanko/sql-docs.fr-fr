---
title: Interfaces (OLE DB) | Documents Microsoft
ms.custom: ''
ms.date: 03/08/2017
...
ms.locfileid: "36040940"
---
# <a name="interfaces-ole-db"></a>Interfaces (OLE DB)
  Outre les interfaces OLE DB principales fournies par le Microsoft Data Access composants (MDAC), le [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB fournisseur implémente les interfaces OLE DB supplémentaires suivantes :  
