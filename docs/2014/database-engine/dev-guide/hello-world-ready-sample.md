---
title: Exemple helloworldready | Documents Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
1.  Modification d’un fichier XML (le fichier.`resx` fichier) pour la culture spécifique dans le répertoire des ressources  
