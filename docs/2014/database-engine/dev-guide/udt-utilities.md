...
-   Base de données [!INCLUDE[ssSampleDBnormal](../../includes/sssampledbnormal-md.md)] qui est disponible sur le site Web [Codeplex](http://go.microsoft.com/fwlink/?linkid=62796)  
