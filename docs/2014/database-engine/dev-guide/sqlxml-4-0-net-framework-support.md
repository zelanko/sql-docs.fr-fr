---
title: Prise en charge SQLXML 4.0 pour Microsoft .NET Framework | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Utilisation du chargement en bloc SQLXML dans l’environnement .NET](../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/sqlxml-4-0-net-framework-support-using-bulk-load.md)  
