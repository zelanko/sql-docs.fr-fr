...
>  Le Gestionnaire de configuration [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ne peut pas gérer les services [!INCLUDE[ssVersion2000](../../includes/ssversion2000-md.md)] .  
 ...
 Vous pouvez également utiliser le Gestionnaire de configuration [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] pour afficher les propriétés du service sélectionné. 
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Le Gestionnaire de configuration est un composant logiciel enfichable MMC ( [!INCLUDE[msCoName](../../includes/msconame-md.md)] Management Console). Pour plus d’informations sur MMC et le fonctionnement d’un composant logiciel enfichable, consultez l’aide de Windows.  
  
 **Pour accéder à Gestionnaire de configuration SQL Server**  
 ...
 **Pour accéder à Gestionnaire de configuration SQL Server à l’aide de Windows 8**  
...
|[Configurer les comptes de service Windows et les autorisations](configure-windows-service-accounts-and-permissions.md)|[Modifiez le compte de démarrage du service pour SQL Server &#40;Gestionnaire de configuration SQL Server&#41;](scm-services-change-the-service-startup-account.md)|  
...
|[SQL Server Browser &#40;service Moteur de base de données et SSAS&#41;](sql-server-browser-service-database-engine-and-ssas.md)|[Modifiez le mot de passe des comptes utilisés par SQL Server &#40;Gestionnaire de configuration SQL Server&#41;](scm-services-change-the-password-of-the-accounts-used.md)|  
...
|[Démarrer, arrêter, suspendre, reprendre, redémarrer le moteur de base de données, SQL Server Agent ou le service SQL Server Browser](start-stop-pause-resume-restart-sql-server-services.md)|[Changer le mode d'authentification du serveur](change-server-authentication-mode.md)|  
...
|[Connectez-vous à un autre ordinateur &#40;Gestionnaire de configuration SQL Server&#41;](scm-services-connect-to-another-computer.md)|[Connectez-vous à une instance de SQL Server &#40;invite de commandes&#41;](log-in-to-an-instance-of-sql-server-command-prompt.md)|  
...
## <a name="related-content"></a>Contenu associé  
 [Configurer SQL Server Agent](../../ssms/agent/sql-server-agent.md)  
