...
4.  Dans la boîte de dialogue ** \<***instancename***> propriétés du SQL Server** , cliquez sur l’onglet **ouvrir** une session et sélectionnez un type de compte **ouvrir une session en tant que** .  
