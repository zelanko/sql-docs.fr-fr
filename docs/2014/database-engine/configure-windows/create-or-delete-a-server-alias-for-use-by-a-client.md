---
title: Créer ou supprimer un Alias de serveur pour une utilisation par un Client (Gestionnaire de Configuration SQL Server) | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
