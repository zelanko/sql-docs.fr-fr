...
-   [Autorisations de service](#Serv_Perm)  
    ...
    -   [Configuration du service et Access Control](#Serv_SID)  
    ...
    -   [Autorisations du système de fichiers liées aux emplacements de disque inhabituels](#Unusual_Locations)  
  
    -   [Examen des considérations supplémentaires](#Review_additional_considerations)  
  
    -   [Autorisations du Registre](#Registry)  
...
-   [Approvisionnement](#Provisioning)  
    ...
    -   [Approvisionnement de Moteur de base de données](#DE_Prov)  
  
        -   [Principaux Windows](#Win_Principals)  
  
        -   [Compte sa](#sa)  
  
        -   [SQL Server de la connexion SID par service et des privilèges](#Logins)  
  
        -   [Connexion SQL Server Agent et privilèges](#Agent)  
  
        -   [HADRON et des privilèges et une instance de cluster de basculement SQL](#Hadron)  
...
-   [Annexe](#Appendix)  
    ...
    -   [Identification des services prenant en charge les instances et les instances](#Identify_instance_aware_and_unaware)  
...
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Services de base de données** : service pour le [!INCLUDE[ssDE](../../includes/ssde-md.md)]relationnel. Le fichier exécutable est \<MSSQLPATH>\MSSQL\Binn\sqlservr.exe.  
  
-   Agent : exécute les travaux, surveille [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], déclenche les alertes et active l’automatisation de certaines tâches d’administration. ** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ** Le service Agent [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] est présent mais désactivé sur les instances de [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)]. Le fichier exécutable est \<MSSQLPATH>\MSSQL\Binn\sqlagent.exe.  
...
-   **[!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]**-Assure la prise en [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] charge de la gestion du stockage et de l’exécution des packages. Le chemin d’accès de \<l’exécutable est MSSQLPATH> \120\dts\binn\msdtssrvr.exe  
  
-   Browser : service de résolution de noms qui [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] fournit des informations de connexion pour les ordinateurs clients. ** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ** Le chemin d’accès du fichier exécutable est c:\Program Files (x86)\Microsoft SQL Server\90\Shared\sqlbrowser.exe  
  
-   **Recherche en texte intégral** : crée rapidement des index de recherche en texte intégral sur le contenu et les propriétés des données structurées et semi-structurées pour fournir un filtrage [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]de document et une césure des mots pour.  
  
-   **SQL Writer** : permet aux applications de sauvegarde et de restauration de fonctionner dans l’infrastructure service VSS (VSS).  
  
-   Distributed Replay Controller : fournit l’orchestration de relecture de trace sur plusieurs ordinateurs clients Distributed Replay. ** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] **  
  
-   Distributed Replay client : un ou plusieurs ordinateurs clients Distributed Replay qui fonctionnent avec un contrôleur Distributed Replay pour simuler des charges de travail simultanées par rapport [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]à une instance du. ** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] **  
  
##  <a name="Serv_Prop"></a>Propriétés et configuration du service  
...
-   [Configuration du service StartupType](#Configure_services)  
...
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Contrôleur de Distributed Replay|[SERVICE RÉSEAU](#Network_Service)|[Compte virtuel](#VA_Desc)<sup>*</sup>|  
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Client Distributed Replay|[SERVICE RÉSEAU](#Network_Service)|[Compte virtuel](#VA_Desc)<sup>*</sup>|  
|Lanceur FD (recherche en texte intégral)|[SERVICE LOCAL](#Local_Service)|[Compte virtuel](#VA_Desc)|  
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Navigateur|[SERVICE LOCAL](#Local_Service)|[SERVICE LOCAL](#Local_Service)|  
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Enregistreur VSS|[SYSTÈME LOCAL](#Local_System)|[SYSTÈME LOCAL](#Local_System)|  
  
 <sup>*</sup>Lorsque des ressources externes à [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] l’ordinateur sont requises [!INCLUDE[msCoName](../../includes/msconame-md.md)] , recommande d’utiliser un compte de service administré (MSA), configuré avec le minimum de privilèges nécessaires.  
  
 **Instance de cluster de basculement SQL Server**  
  
|Composant|[!INCLUDE[nextref_longhorn](../../includes/nextref-longhorn-md.md)]|[!INCLUDE[nextref_longhorn](../../includes/nextref-longhorn-md.md)]2|  
|---------------|------------------------------------|---------------------------------------|  
...
-   <a name="VA_Desc"></a>**Comptes virtuels**  
    ...
    |-------------|--------------------------|  
    |Instance par défaut du service [!INCLUDE[ssDE](../../includes/ssde-md.md)]|**SERVICE\MSSQLSERVER NT**|  
    |Instance nommée d'un service nommé [!INCLUDE[ssDE](../../includes/ssde-md.md)]**PAYROLL**|**PAIE NT SERVICE\MSSQL $**|  
    |
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent sur l’instance par défaut de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|**SERVICE\SQLSERVERAGENT NT**|  
    |[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Service agent sur une instance de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] nommée **Payroll**|**PAIE NT SERVICE\SQLAGENT $**|  
...
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Contrôleur de Distributed Replay|DRU_CTLR, CTLRSVCACCOUNT,CTLRSVCPASSWORD, CTLRSTARTUPTYPE, CTLRUSERS|  
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Client Distributed Replay|DRU_CLT, CLTSVCACCOUNT, CLTSVCPASSWORD, CLTSTARTUPTYPE, CLTCTLRNAME, CLTWORKINGDIR, CLTRESULTDIR|  
 ...
 <sup>2</sup> Le [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] service agent est désactivé sur les instances [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] de [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] et with Advanced Services.  
...
-   [Autorisations du système de fichiers accordées à SQL Server SID par service ou SQL Server groupes Windows locaux](#Reviewing_ACLs)  
  
-   [Autorisations du système de fichiers accordées à d’autres comptes ou groupes d’utilisateurs Windows](#File_System_Other)  
...
|**[!INCLUDE[ssIS](../../includes/ssis-md.md)]:**<br /><br /> (Tous les droits sont accordés au SID par service. Instance par défaut et instance nommée : **NT SERVICE\MsDtsServer120**. 
  [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] n’a pas de processus séparé pour une instance nommée.)|**Ouvrir une session en tant que service** (SeServiceLogonRight)<br /><br /> Autorisation d'écrire dans le journal des événements d'application<br /><br /> **Outrepasser le contrôle de parcours** (SeChangeNotifyPrivilege)<br /><br /> **Emprunter l’identité d’un client après l’authentification** (SeImpersonatePrivilege)|  
|**Recherche en texte intégral :**<br /><br /> (Tous les droits sont accordés au SID par service. Instance par défaut : **NT Service\MSSQLFDLauncher**. Instance nommée : **NT Service\ MSSQLFDLauncher$**_NomInstance_.)|**Ouvrir une session en tant que service** (SeServiceLogonRight)<br /><br /> **Ajuster les quotas de mémoire pour un processus** (SeIncreaseQuotaPrivilege)<br /><br /> **Outrepasser le contrôle de parcours** (SeChangeNotifyPrivilege)|  
|**[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Navigateur:**<br /><br /> (Tous les droits sont accordés à un groupe Windows local. Instance par défaut ou instance nommée : **SQLServer2005SQLBrowserUser**_$ComputerName_. 
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Browser n'a pas de processus séparé pour une instance nommée.)|**Ouvrir une session en tant que service** (SeServiceLogonRight)|  
|**[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Enregistreur VSS :**<br /><br /> (Tous les droits sont accordés au SID par service. Instance par défaut ou instance nommée : **NT Service\SQLWriter**. L’enregistreur VSS[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] n’a pas de processus séparé pour une instance nommée.)|Le service SQLWriter s'exécute sous le compte LOCAL SYSTEM qui a toutes les autorisations requises. Le programme d'installation de[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ne vérifie pas et n'accorde pas d'autorisations pour ce service.|  
|**[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Contrôleur de Distributed Replay :**|**Ouvrir une session en tant que service** (SeServiceLogonRight)|  
|**[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Distributed Replay client :**|**Ouvrir une session en tant que service** (SeServiceLogonRight)|  
 ...
 <sup>1</sup> Le [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] service agent est désactivé sur les instances [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)]de.  
  
###  <a name="Reviewing_ACLs"></a>Autorisations du système de fichiers accordées pour SQL Server les SID par service ou les groupes Windows locaux  
...
||120\shared|Lecture, exécution|  
||120\shared\Errordumps|Lecture, écriture|  
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Navigateur|120\shared\ASConfig|Lire|  
||120\shared|Lecture, exécution|  
||120\shared\Errordumps|Lecture, écriture|  
...
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Contrôleur de Distributed Replay|
  \<ToolsDir>\DReplayController\Log\ (répertoire vide)|Lecture, exécution, listage du contenu des dossiers|  
||
...
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Client Distributed Replay|
  \<ToolsDir>\DReplayClient\Log\|Lecture, exécution, listage du contenu des dossiers|  
||
...
||
 ...
 <sup>1</sup> Le [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] service agent est désactivé sur les instances [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] de [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] et with Advanced Services.  
...
###  <a name="File_System_Other"></a>Autorisations du système de fichiers accordées à d’autres comptes ou groupes d’utilisateurs Windows  
...
|[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]|Compte de service Windows Report Server|installer>\Reporting Services\LogFiles * \< *|Suppression<br /><br /> READ_CONTROL<br /><br /> SYNCHRONIZE<br /><br /> FILE_GENERIC_READ<br /><br /> FILE_GENERIC_WRITE<br /><br /> FILE_READ_DATA<br /><br /> FILE_WRITE_DATA<br /><br /> FILE_APPEND_DATA<br /><br /> FILE_READ_EA<br /><br /> FILE_WRITE_EA<br /><br /> FILE_READ_ATTRIBUTES<br /><br /> FILE_WRITE_ATTRIBUTES|  
||Compte de service Windows Report Server, tout le monde|Installez>\Reporting Services\ReportManager, * \<installez>* \Reporting Services\ReportManager\Pages\\\*. * \< * \*\\\* *, \<installez>* \Reporting Services\ReportManager\Styles. \* *, \<installez>* \Reporting services\reportmanager\ webctrl_client \ 1_0\\*.\*|Lecture, exécution|  
||Compte de service Windows Report Server|installer>\Reporting Services\ReportServer * \< *|Lire|  
||Compte de service Windows Report Server|installer>\Reporting Services\ReportServer\global.asax * \< *|Complète|  
||Tout le monde|installer>\Reporting Services\ReportServer\global.asax * \< *|READ_CONTROL<br /><br /> FILE_READ_DATA<br /><br /> FILE_READ_EA<br /><br /> FILE_READ_ATTRIBUTES|  
||Compte des services Windows Report Server|installer>\Reporting Services\ReportServer\RSReportServer.config * \< *|Suppression<br /><br /> READ_CONTROL<br /><br /> SYNCHRONIZE<br /><br /> FILE_GENERIC_READ<br /><br /> FILE_GENERIC_WRITE<br /><br /> FILE_READ_DATA<br /><br /> FILE_WRITE_DATA<br /><br /> FILE_APPEND_DATA<br /><br /> FILE_READ_EA<br /><br /> FILE_WRITE_EA<br /><br /> FILE_READ_ATTRIBUTES<br /><br /> FILE_WRITE_ATTRIBUTES|  
...
###  <a name="Unusual_Locations"></a>Autorisations du système de fichiers liées aux emplacements de disque inhabituels  
...
###  <a name="Review_additional_considerations"></a>Examen des considérations supplémentaires  
...
###  <a name="Registry"></a>Autorisations du Registre  
...
-   Autorisation **Create DDL Event notification** sur le serveur.  
  
-   Autorisation **Create trace Event notification** dans [!INCLUDE[ssDE](../../includes/ssde-md.md)]le.  
  
-   Autorisation **View any Database** au niveau du serveur.  
...
###  <a name="DE_Prov"></a>Approvisionnement de Moteur de base de données  
...
####  <a name="Logins"></a>SQL Server de la connexion SID par service et des privilèges  
...
####  <a name="Agent"></a>Connexion SQL Server Agent et privilèges  
...
####  <a name="Hadron"></a>[!INCLUDE[ssHADRc](../../includes/sshadrc-md.md)] et l’instance de cluster de basculement SQL et les privilèges  
...
####  <a name="SQLWMI"></a>WMI et privilèges SQL  
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Le programme d’installation configure le compte [!INCLUDE[ssDE](../../includes/ssde-md.md)] **NT SERVICE\Winmgmt** comme une connexion et l’ajoute au rôle serveur fixe **sysadmin** .  
...
##  <a name="Upgrade"></a>Mise à niveau à partir de versions antérieures  
...
####  <a name="Any_OS"></a>Comptes disponibles avec n’importe quel système d’exploitation  
...
###  <a name="Identify_instance_aware_and_unaware"></a>Identification des services prenant en charge les instances et les instances  
