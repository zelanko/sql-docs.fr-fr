...
1.  Dans [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Configuration Manager, développez **configuration du réseau SQL Server**, puis cliquez sur **protocoles pour** *\<instance name>* .  
