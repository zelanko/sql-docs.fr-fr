...
5.  Connectez-vous maintenant à à l' [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] aide de la commande suivante et exécutez l’opération nécessaire : sqlcmd-E-S \<servername> .  
