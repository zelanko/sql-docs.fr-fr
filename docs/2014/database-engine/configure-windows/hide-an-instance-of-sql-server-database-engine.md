...
1.  Dans **Gestionnaire de configuration SQL Server**, développez **Configuration du réseau SQL Server**, cliquez avec le bouton droit sur **protocoles pour** *\<server instance>* , puis sélectionnez **Propriétés**.  
