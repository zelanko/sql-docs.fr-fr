---
title: Établir une base de données mise en miroir de la Session à l’aide de l’authentification Windows (SQL Server Management Studio) | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
