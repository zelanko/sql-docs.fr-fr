 ...
 **Journal miroir (** * \<temps>* **)**  
 État du journal sur l’instance de serveur miroir à l’heure locale de l’instance de serveur, indiquée par * \<l’heure>*. Les paramètres suivants s'affichent :  
