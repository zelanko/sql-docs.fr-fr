---
title: Utiliser les alertes et les seuils d’avertissement sur la mise en miroir (SQL Server) des métriques de performances | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
