---
title: 'Exemple : Configuration de la base de données mise en miroir à l’aide de l’authentification Windows (Transact-SQL) | Documents Microsoft'
ms.custom: ''
ms.date: 06/13/2017
