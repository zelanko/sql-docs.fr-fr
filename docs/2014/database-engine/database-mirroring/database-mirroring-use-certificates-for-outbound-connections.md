---
title: Autoriser une base de données mise en miroir du point de terminaison pour utiliser des certificats pour les connexions sortantes (Transact-SQL) | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
