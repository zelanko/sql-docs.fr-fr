---
title: Autoriser une base de données mise en miroir de point de terminaison pour utiliser des certificats pour les connexions sortantes (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
