...
|-----------|-----------------|  
|[Fonctionnalités dépréciées du moteur de base de données dans SQL Server 2014](deprecated-database-engine-features-in-sql-server-2016.md)|Fonctionnalités [!INCLUDE[ssDE](../includes/ssde-md.md)] déconseillées dans cette version.|  
