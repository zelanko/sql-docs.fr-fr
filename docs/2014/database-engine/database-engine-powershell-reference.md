...
|-----------------|------------|  
|Exécute les scripts Transact-SQL et XQuery, tels que les scripts qui peuvent être exécutés à l’aide de la `sqlcmd` utilitaire.|[Invoke-Sqlcmd, applet de commande](../../2014/database-engine/invoke-sqlcmd-cmdlet.md)|  
