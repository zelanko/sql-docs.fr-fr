...
-   [Installation de fonctionnalités Windows sur un serveur exécutant une installation Server Core de Windows server 2008 R2 : vue d’ensemble](https://go.microsoft.com/fwlink/?LinkId=245961) (https://go.microsoft.com/fwlink/?LinkId=245961)  
