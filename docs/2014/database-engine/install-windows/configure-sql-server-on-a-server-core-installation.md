...
-   [Installation des mises à jour pour SQL Server 2014 pendant une nouvelle Installation](#installing-updates-during-a-new-installation) 
  
-   [Installation des mises à jour pour SQL Server 2014 après que qu’il a été installé](#installing-updates-after-installation) 
  
### <a name="installing-updates-during-a-new-installation"></a>Installation des mises à jour pendant une nouvelle installation  
...
##  <a name="startstop-sql-server-service"></a>Service de démarrage/arrêt de SQL Server  
...
## <a name="enable-alwayson-availability-groups"></a>Activer les groupes de disponibilité AlwaysOn  
...
### <a name="using-sql-server-configuration-manager-remotely"></a>Utilisation du Gestionnaire de Configuration SQL Server à distance  
...
### <a name="enable-remote-connections-on-an-instance-of-sql-server"></a>Activer les connexions distantes sur une instance de SQL Server 
...
##  <a name="sql-servevr-command-prompt-utilities"></a>Utilitaires d’invite de commande de Servevr SQL  
