...
|**/IAcceptSQLServerLicenseTerms**|Obligatoire uniquement lorsque le paramètre /Q ou /QS est spécifié pour les installations sans assistance.|  
 ...
 <sup>1</sup> vous ne pouvez pas spécifier ce paramètre pour appliquer une mise à jour à [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]une instance préparée de. Vous devez spécifier à la place le paramètre /instanceID.  
