---
title: Cible d’histogramme | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
```  
 ...
 Pour plus d’informations, consultez [trouver les objets comportant le plus de verrous sur les](../relational-databases/extended-events/find-the-objects-that-have-the-most-locks-taken-on-them.md), et [Moniteur système activité à l’aide d’événements étendus](../relational-databases/extended-events/monitor-system-activity-using-extended-events.md).  
