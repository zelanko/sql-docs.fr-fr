...
## <a name="see-also"></a>Voir aussi  
 ...
 [Plus d’informations sur les dernières modifications des fonctionnalités des outils de gestion dans SQL Server 2014](breaking-changes-to-database-engine-features-in-sql-server-2016.md?view=sql-server-2014)  
