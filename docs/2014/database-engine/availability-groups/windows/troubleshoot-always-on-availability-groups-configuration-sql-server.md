...
##  <a name="accounts"></a><a name="Accounts"></a>Clients
...
##  <a name="endpoints"></a><a name="Endpoints"></a>Terminaison
...
|![Activé](../../media/checkboxemptycenterxtraspacetopandright.gif "Case à cocher")|Système client|Vérifiez que le pilote client prend en charge le routage en lecture seule.|-|[Connectivité client AlwaysOn (SQL Server)](always-on-client-connectivity-sql-server.md)|
