...
###  <a name="publisher-redirection"></a><a name="PublisherRedirect"></a>Redirection de l’éditeur  
...
-   **Applications clientes qui accèdent aux données de modifications de capture de données modifiées et AlwaysOn**  
