---
title: Spécifiez l’URL de point de terminaison lorsque vous ajoutez ou modifiez un réplica de disponibilité (SQL Server) | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
