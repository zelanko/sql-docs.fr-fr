...
-   **Blogs :**  
     ...
     [Analyse l’intégrité AlwaysOn avec PowerShell - partie 4 : intégration avec SQL Server Agent](http://blogs.msdn.com/b/sqlalwayson/archive/2012/02/15/the-always-on-health-model-part-4.aspx)  
