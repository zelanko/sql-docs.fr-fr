---
title: Créer une base de données mise en miroir du point de terminaison pour les groupes de disponibilité AlwaysOn (SQL Server PowerShell) | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
