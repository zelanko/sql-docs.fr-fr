---
title: Les tâches et les fonctionnalités du moteur de base de données | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "52524548"
---
# <a name="database-engine-features-and-tasks"></a>Fonctionnalités et tâches du moteur de base de données
  Trouver des informations que tout le monde-concepteur, développeur, analyste ou administrateur-nécessaires à la création [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] bases de données.  
