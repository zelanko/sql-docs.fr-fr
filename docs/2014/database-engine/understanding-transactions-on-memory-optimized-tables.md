---
title: Présentation des Transactions sur les Tables mémoire optimisées | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
-   [Logique de nouvelle tentative pour les instructions pour les Transactions sur les Tables mémoire optimisées](guidelines-for-retry-logic-for-transactions-on-memory-optimized-tables.md)  
