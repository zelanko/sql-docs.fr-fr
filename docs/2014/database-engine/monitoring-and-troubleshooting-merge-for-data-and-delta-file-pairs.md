...
## <a name="see-also"></a>Voir aussi  
 [Création et gestion du stockage pour les objets optimisés en mémoire](../relational-databases/in-memory-oltp/creating-and-managing-storage-for-memory-optimized-objects.md)  
