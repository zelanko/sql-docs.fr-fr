...
-   Vous souhaiterez envisager de désactiver les paramètres de niveau d’instance si vous créez une nouvelle base de données de disponibilité, et vous ne prévoyez pas d’appliquer les paramètres de niveau instance à la base de données  
