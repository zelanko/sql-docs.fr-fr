---
title: 'Leçon 2 : Écrire du code Transact-SQL | Microsoft Docs'
ms.custom: ''
ms.date: 06/13/2017
...
> [!NOTE]  
>  Cette leçon porte sur les fonctionnalités de l'outil. Pour obtenir un didacticiel sur l’écriture [!INCLUDE[tsql](../../includes/tsql-md.md)] instructions, consultez [didacticiel : Écriture d’instructions Transact-SQL](../../t-sql/tutorial-writing-transact-sql-statements.md).  
