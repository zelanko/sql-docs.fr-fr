---
title: Options (Page Général de l’environnement) | Documents Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
ms.locfileid: "36152953"
---
# <a name="options-environment-general-page"></a>Options (Page Général de l’environnement)
