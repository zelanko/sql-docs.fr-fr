...
ms.locfileid: "52778781"
---
# <a name="proxy-account-properties-references-tab"></a>Propriétés du compte de proxy (onglet Références)
  Cette page en lecture seule répertorie les étapes de travail qui font référence à un compte proxy de [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent.  
