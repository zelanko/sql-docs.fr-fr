...
ms.locfileid: "52797631"
---
# <a name="job-propertiesnew-job-steps-page"></a>Propriétés du travail : Nouveau travail (page Étapes)
  Utilisez cette page pour consulter et organiser les étapes d'un travail de l'Agent [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .  
