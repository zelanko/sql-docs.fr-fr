 ...
 **Pour supprimer une catégorie de travaux**  
 ...
 Appelez la `JobCategory` classe à l’aide d’un langage de programmation que vous choisissez, tel que Visual Basic, Visual c# ou PowerShell.  
