...
3.  Dans le **propriétés de l’Agent SQL Server-*** nom_serveur* boîte de dialogue **journal des erreurs** sur le **général** page, sélectionnez le **inclure trace d’exécution messages** case à cocher.  
