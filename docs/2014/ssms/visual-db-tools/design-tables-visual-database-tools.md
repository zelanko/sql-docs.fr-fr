...
## <a name="in-this-section"></a>Dans cette section  
 [Ouvrez Concepteur de tables &#40;Visual Database Tools&#41;](visual-database-tools.md)  
 Ouvrez une table de base de données nouvelle ou existante.  
  
 [Enregistrez votre travail dans Concepteur de tables &#40;Visual Database Tools&#41;](../../database-engine/save-your-work-in-table-designer-visual-database-tools.md)  
