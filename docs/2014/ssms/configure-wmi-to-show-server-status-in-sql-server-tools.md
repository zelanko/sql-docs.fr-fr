...
2.  Dans le **ouvrir** zone `wmimgmt.msc`, puis cliquez sur **OK**.  
...
7.  Dans le **autorisations pour ***\<groupe ou utilisateur >* boîte, sélectionnez le **autoriser** colonne, pour le **activer à distance** autorisation, pour les utilisateurs auxquels vous souhaitez à distance détecter l’état du service.  
