---
title: Installation de SQL Server 2014 de démarrage rapide | Microsoft Docs
ms.custom: ''
ms.date: 05/25/2017
...
-   **SysPrep**  
     ...
     Consultez [installer SQL Server 2014 à l’aide de SysPrep](../database-engine/install-windows/install-sql-server-using-sysprep.md) pour obtenir des informations sur l’installation [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] à l’aide de SysPrep.  
...
|Passez en revue les détails des fonctionnalités prises en charge par les différentes éditions de [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)].|[Éditions et fonctionnalités](features-supported-by-the-editions-of-sql-server-2014.md)|  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Bien démarrer avec la Documentation produit de SQL Server](../2014-toc/books-online-for-sql-server-2014.md) [la compatibilité descendante](backward-compatibility.md)  
