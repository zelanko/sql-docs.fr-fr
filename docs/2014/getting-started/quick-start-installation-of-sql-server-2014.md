...
-   Composants de connectivité  
 ...
 Vous pouvez installer chaque composant individuellement ou sélectionner une combinaison de composants ci-dessus. Pour obtenir le meilleur choix parmi les éditions et les composants disponibles [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]dans, consultez [éditions et composants de SQL Server 2014](../sql-server/editions-and-components-of-sql-server-2016.md).  
...
-   **Assistant Installation**  
     ...
     Pour obtenir des informations procédurales sur l’installation [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] à l’aide de l’Assistant Installation, consultez Installation de [SQL Server 2014 à partir de l’Assistant &#40;&#41; installation](../database-engine/install-windows/install-sql-server-from-the-installation-wizard-setup.md) .  
...
-   **Installation Server Core**  
     ...
     Pour obtenir des informations procédurales sur l’installation [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] de sur Windows Server Core, consultez [installer SQL Server 2014 sur Server Core](../database-engine/install-windows/install-sql-server-on-server-core.md) .  
  
-   **[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]Installation des fonctionnalités BI**  
  
     Pour plus d’informations sur l’installation des fonctionnalités qui font partie de la plateforme bi de Microsoft, consultez [installer les fonctionnalités bi de SQL Server 2014](../sql-server/install/install-sql-server-business-intelligence-features.md) [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)], notamment, [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)],, [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]et plusieurs applications clientes utilisées pour créer ou utiliser des données analytiques.  
  
-   **Installation d’un cluster de basculement**  
  
     Pour obtenir des informations procédurales sur l’installation [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] de sur un [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] cluster de basculement, consultez [SQL Server installation](../sql-server/failover-clusters/install/sql-server-failover-cluster-installation.md) d’un cluster de basculement.  
...
## <a name="includessnoversionincludesssnoversion-mdmd-installation"></a>[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]Programme  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Prise en main de la documentation produit pour SQL Server](../2014-toc/books-online-for-sql-server-2014.md) [Compatibilité descendante](backward-compatibility.md)  
