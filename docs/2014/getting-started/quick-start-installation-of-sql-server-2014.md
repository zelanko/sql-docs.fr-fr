...
|Consultez cette rubrique pour créer une nouvelle instance de cluster de basculement [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)].|[Créer un cluster de basculement SQL Server &#40;d’installation&#41;](../sql-server/failover-clusters/install/create-a-new-sql-server-failover-cluster-setup.md)|  
