...
> [!NOTE]  
>  Les informations contenues dans cette section s’applique uniquement aux utilisateurs qui ont acheté [!INCLUDE[msCoName](../includes/msconame-md.md)] produits aux États-Unis. Si vous vous êtes procuré ce produit en dehors des États-Unis, votre coffret contient une fiche d'informations qui répertorie les services de Support technique, les numéros de téléphone et les adresses de [!INCLUDE[msCoName](../includes/msconame-md.md)]. Contactez votre filiale pour savoir si les produits et services décrits dans cette rubrique sont disponibles dans votre pays. Pour plus d'informations, disponibles en anglais, français, espagnol, chinois, japonais et italien, consultez le site Web [Microsoft Accessibility](http://go.microsoft.com/fwlink/?LinkID=8287).  
  
## <a name="includessnoversionincludesssnoversion-mdmd-accessibility-features"></a>Fonctionnalités d'accessibilité [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]  
 Outre les fonctionnalités d’accessibilité de Windows et les utilitaires décrits dans la section suivante, la visionneuse d’aide rend [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] plus accessible aux personnes présentant un handicap.  
  
### <a name="the-help-viewer"></a>Visionneuse de l'aide  
 La Visionneuse de l'aide Microsoft 1.1 est l'outil de consultation de la documentation du produit. Il dispose de fonctions d'accessibilité, notamment de touches de raccourci pour la navigation et les commandes, incluses dans [!INCLUDE[msCoName](../includes/msconame-md.md)] Internet Explorer. Il vous permet, par exemple, de changer les couleurs d'affichage sur l'écran de votre ordinateur. Pour plus d’informations sur l’accessibilité des fonctionnalités pour Microsoft aident 1.1 de la visionneuse, consultez [accessibilité fonctionnalités de Microsoft visionneuse d’aide 1.1](http://go.microsoft.com/fwlink/?LinkID=220144).  
...
## <a name="adjusting-includemsconameincludesmsconame-mdmd-products-for-people-with-accessibility-needs"></a>Personnalisation des produits [!INCLUDE[msCoName](../includes/msconame-md.md)] pour les personnes atteintes d'handicaps  
 Fonctionnalités et options d’accessibilité sont intégrées à de nombreux [!INCLUDE[msCoName](../includes/msconame-md.md)] produits, notamment la famille de systèmes d’exploitation Windows. Ces options et fonctionnalités d'accessibilité s'adressent aux personnes ayant des difficultés à utiliser un clavier ou une souris, aveugles ou malvoyantes, sourdes ou malentendantes.  
  
### <a name="free-step-by-step-tutorials"></a>Didacticiels gratuits étape par étape  
  
-   [!INCLUDE[msCoName](../includes/msconame-md.md)] propose une série de didacticiels pas à pas pour vous aider à apprendre comment ajuster les options d’accessibilité et les paramètres sur votre ordinateur. Les didacticiels expliquent en détail les procédures à suivre pour régler les options, les fonctionnalités et les paramètres qui facilitent l'utilisation des ordinateurs par les personnes présentant une incapacité physique. Ces informations sont présentées en vis-à-vis, afin que vous puissiez visualiser d'un seul coup d'œil la marche à suivre pour utiliser la souris, le clavier ou une combinaison des deux. Les didacticiels pas à pas d’une série de produits sont disponibles sur le site web [Microsoft Accessibility](http://go.microsoft.com/fwlink/?LinkID=67163).  
...
## <a name="assistive-technology-products-for-windows"></a>Produits de technologies d'assistance pour Windows  
 ...
 [!INCLUDE[msCoName](../includes/msconame-md.md)] fournit un catalogue de produits de technologie d’assistance qui s’exécutent sur des systèmes d’exploitation Windows la [Site Web de Microsoft accessibilité](http://go.microsoft.com/fwlink/?LinkID=67166).  
...
### <a name="obtaining-documentation-for-includessnoversionincludesssnoversion-mdmd"></a>Obtention de la documentation pour [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]  
 La documentation pour [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] est disponible en ligne. Pour plus d’informations, consultez [utilisez Documentation du produit SQL Server](../2014-toc/books-online-for-sql-server-2014.md).  
...
## <a name="obtaining-documentation-for-additional-includemsconameincludesmsconame-mdmd-products"></a>Obtention de documentation pour d'autres produits [!INCLUDE[msCoName](../includes/msconame-md.md)]  
 Vous pouvez obtenir une documentation pour [!INCLUDE[msCoName](../includes/msconame-md.md)] produits à partir de la [Site Web de Microsoft accessibilité](http://go.microsoft.com/fwlink/?LinkID=67164).  
...
### <a name="recording-for-the-blind--dyslexic-inc"></a>Recording for the Blind & Dyslexic, Inc.  
 ...
 Télécopie : (609) 987-8116 Web : [http://www.rfbd.org/](http://go.microsoft.com/fwlink/?LinkId=48621)  
...
### <a name="customer-service"></a>Service clients  
 Vous pouvez contacter le [!INCLUDE[msCoName](../includes/msconame-md.md)] Sales Information Center sur un téléphone texte en (800) 892-5234 numérotation entre 6 h 30 du matin. et 17h30, Heure du Pacifique, du lundi au vendredi, sauf les jours fériés.  
...
## <a name="getting-more-accessibility-information"></a>Informations complémentaires sur l'accessibilité  
 Des informations sur les technologies d'assistance améliorant la vie des personnes souffrant d'un handicap sont disponibles sur le site Web [Microsoft Accessibility](http://go.microsoft.com/fwlink/?LinkID=8287).  
 ...
 Un bulletin électronique gratuit est mis à votre disposition pour vous informer des questions d'accessibilité relatives aux produits [!INCLUDE[msCoName](../includes/msconame-md.md)]. Pour vous abonner, consultez le site Web [Microsoft Accessibility](http://go.microsoft.com/fwlink/?LinkID=8287).  
