...
## <a name="see-also"></a>Voir aussi 
 ...
 [Série de blogs Cloud de Microsoft SQL Server hybride](https://azure.microsoft.com/blog/microsoft-sql-server-hybrid-cloud-blog-series/)  
