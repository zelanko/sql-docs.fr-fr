---
title: Sur le termes du contrat de licence SQL Server | Microsoft Docs
ms.custom: ''
ms.date: 05/24/2017
...
## <a name="includessnoversionincludesssnoversion-mdmd-licensing-options"></a>Options de licences de [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]  
 Pour plus d’informations sur [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] les prix et options de licence, consultez le [Microsoft SQL Server](http://www.microsoft.com/sqlserver/sql-server-2014.aspx) (http://www.microsoft.com/sqlserver/sql-server-2014.aspx) site Web.  
