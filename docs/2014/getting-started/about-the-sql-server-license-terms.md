...
## <a name="includessnoversionincludesssnoversion-mdmd-licensing-options"></a>Options de licences de [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]  
 Pour plus d’informations sur [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] les prix et options de licence, consultez le [Microsoft SQL Server](https://www.microsoft.com/sqlserver/sql-server-2014.aspx) (https://www.microsoft.com/sqlserver/sql-server-2014.aspx) site Web.  
