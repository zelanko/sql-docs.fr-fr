...
4.  Dans le menu contextuel, vous pouvez effectuer les tâches suivantes :  
    ...
    2.  **Déverrouiller**: vous pouvez déverrouiller la base de connaissances si vous êtes l’utilisateur qui travaillait sur la base de connaissances dans l’une des étapes de la gestion des domaines, de la découverte des connaissances et de l’activité de stratégie de correspondance, et que vous l’avez fermée. Si vous déchargez la base de connaissances, une autre personne peut l'ouvrir et travailler dessus. Cette commande n'est pas disponible si la base de connaissances n'est pas dans un état d'une activité. Pour plus d'informations, consultez [Open a Knowledge Base](../../2014/data-quality-services/open-a-knowledge-base.md).  
