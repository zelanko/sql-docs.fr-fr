---
title: Topologies de déploiement pour les fonctionnalités SQL Server BI dans SharePoint (fr) Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
##  <a name="sharepoint-2013-example-deployment-topologies"></a><a name="bkmk_example_deployments_2013"></a>SharePoint 2013 Exemple déploiement Topologies  
 ...
 Le mode SharePoint nécessite le serveur SharePoint 2013 et utilise l’architecture d’application de service SharePoint. ** [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] **  
  
 Les sections suivantes présentent les topologies de déploiement courantes :  
  
###  <a name="powerpivot-for-sharepoint-2013-and-reporting-services-three-server-deployment"></a><a name="bkmk_bi_Sharepoint2013_3tier"></a>PowerPivot pour SharePoint 2013 et Reporting Services Three Server Deployment  
...
|**(2)**|[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]Demande de service. Le nom par défaut est **Application de service PowerPivot par défaut**.|  
...
|**(5)**|Exécutez le **spPowerPivot.msi** pour [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] installer des [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] fournisseurs de données, l’outil de configuration, La Galerie et planifier les données actualiser.|  
...
|**(7)**|Bases de données de contenu, de configuration et d'application de service SharePoint.|  
 ...
 ![Paramètres SharePoint](../../analysis-services/media/as-sharepoint2013-settings-gear.gif "Paramètres SharePoint") [Soumettez vos commentaires et informations de contact via Microsoft SQL Server Connect](https://connect.microsoft.com/SQLServer/Feedback) (https://connect.microsoft.com/SQLServer/Feedback).  
  
###  <a name="powerpivot-for-sharepoint-2013-single-server-deployment"></a><a name="bkmk_powerpivot_sharepoint2013_1server"></a>PowerPivot pour sharePoint 2013 Déploiement de serveur unique  
...
###  <a name="powerpivot-for-sharepoint-2013-two-server-deployment"></a><a name="bkmk_powerpivot_sharepoint2013_2server"></a>PowerPivot pour SharePoint 2013 Deux déploiements de serveurs  
 ...
 [!INCLUDE[ssGeminiShortvnext](../../includes/ssgeminishortvnext-md.md)]étend SharePoint Server 2013 pour ajouter le traitement [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] des données côté [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] serveur, les fournisseurs de données, la Galerie et le support de gestion pour les cahiers de travail et les cahiers de travail Excel avec des modèles de données avancés.  
  
 Le package d'installation est disponible dans le cadre du Feature Pack [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] . Le pack d’entités [!INCLUDE[msCoName](../../includes/msconame-md.md)] peut être téléchargé à partir du centre de téléchargement de [Microsoft® SQL Server® 2014 PowerPivot® pour Microsoft® SharePoint®](https://go.microsoft.com/fwlink/?LinkID=296473) ( HYPERLINK "<https://go.microsoft.com/fwlink/?LinkID=296473>'t '_blank'). <https://go.microsoft.com/fwlink/?LinkID=296473>  
...
###  <a name="powerpivot-for-sharepoint-2013-three-server-deployment"></a><a name="bkmk_powerpivot_sharepoint2013_3server"></a>PowerPivot pour SharePoint 2013 Déploiement de trois serveurs  
...
###  <a name="powerpivot-for-sharepoint-2013-and-reporting-services-single-server-deployment"></a><a name="bkmk_powerpivot_ssrs_sharepoint2013_1server"></a>PowerPivot pour SharePoint 2013 et Reporting Services Single Server Deployment  
 Un déploiement de serveur unique est utile à des fins de test mais n'est pas recommandée pour les déploiements de production.  
  
 ![SSAS et SSRS SharePoint mode 1 Déploiement du serveur](../../../2014/sql-server/install/media/as-and-rs-1server-deployment.gif "SSAS et SSRS SharePoint mode 1 Déploiement du serveur")  
...
###  <a name="powerpivot-for-sharepoint-2013-and-reporting-services-two-server-deployment"></a><a name="bkmk_powerpivot_ssrs_sharepoint2013_2server"></a>PowerPivot pour SharePoint 2013 et Reporting Services Two Server Deployment  
...
##  <a name="sharepoint-2010-example-deployment-topologies"></a><a name="bkmk_example_deployments_2010"></a>SharePoint 2010 Exemple Déploiement Topologies  
...
##  <a name="single-server-deployments"></a><a name="bkmk_sharepoint2010_1server"></a>Déploiements de serveurs uniques  
 ...
 Pour installer toutes les fonctionnalités sur un seul serveur, vous installez [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] et [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)] de manière séquentielle, sur le même serveur physique. Pour obtenir des instructions sur une configuration de serveur autonome, consultez [la liste de contrôle du déploiement : Services de reporting, Power View et PowerPivot pour SharePoint](deployment-checklist-reporting-services-power-view-power-pivot-for-sharepoint.md).  
  
##  <a name="two-tier-deployment"></a><a name="bkmk_sharepoint2010_2server"></a>Déploiement à deux niveaux  
...
##  <a name="three-tier-deployment"></a><a name="bkmk_sharepoint2010_3server"></a>Déploiement à trois niveaux  
 ...
 ![Toplogy 3 serveurs](../../../2014/sql-server/install/media/sql11bisetup-3server.gif "Toplogy 3 serveurs")  
  
##  <a name="three-tier-scale-out-deployment"></a><a name="bkmk_sharepoint2010_scaleserver"></a>Déploiement à trois niveaux d’échelle  
...
## <a name="see-also"></a>Voir aussi  
 [Reporting Services SharePoint Mode Installation &#40;SharePoint 2010 et SharePoint 2013&#41;](../../reporting-services/install-windows/install-reporting-services-sharepoint-mode.md)   
 [PowerPivot pour SharePoint 2013 Installation](https://docs.microsoft.com/analysis-services/instances/install-windows/install-analysis-services-in-power-pivot-mode)   
