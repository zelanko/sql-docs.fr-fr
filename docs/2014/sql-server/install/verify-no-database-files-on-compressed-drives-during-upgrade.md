---
title: Vérifiez qu’aucun fichier de base de données n’est sur des lecteurs compressés pendant le processus de mise à niveau | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
