...
# <a name="hardware-and-software-requirements-for-analysis-services-server-in-sharepoint-mode-sql-server-2014"></a>Configurations matérielle et logicielle requises pour le serveur Analysis Services en mode SharePoint (SQL Server 2014)
  ...
  [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)] prend en charge SharePoint 2010 et SharePoint 2013. 
  [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)] 2013 s'exécute en dehors de la batterie de serveurs SharePoint, bien qu'il puisse être installé sur des serveurs SharePoint. 
...
##  <a name="bkmk_sqleditions"></a>Configuration requise pour l’édition SQL Server  
...
-   [SQL Server feuille](https://download.microsoft.com/download/6/6/F/66FF3259-1466-4BBA-A505-2E3DA5B2B1FA/SQL_Server_2014_Licensing_Datasheet.pdf) de données dehttps://download.microsoft.com/download/6/6/F/66FF3259-1466-4BBA-A505-2E3DA5B2B1FA/SQL_Server_2014_Licensing_Datasheet.pdf)licences 2014 (.  
