...
##  <a name="bkmk_sqllicense"></a>Licences SQL Server  
 Pour plus d'informations sur les licences SQL Server, reportez-vous aux sites Web suivants :  
  
-   Feuille de données de [licence SQL Server 2014](https://download.microsoft.com/download/6/6/F/66FF3259-1466-4BBA-A505-2E3DA5B2B1FA/SQL_Server_2014_Licensing_Datasheet.pdf) (https://download.microsoft.com/download/6/6/F/66FF3259-1466-4BBA-A505-2E3DA5B2B1FA/SQL_Server_2014_Licensing_Datasheet.pdf).  
  
-   [How à acheter : Les modèles de licence SQL Server prennent en charge @ no__t-0 (https://www.microsoft.com/licensing/product-licensing/sql-server-2014?activetab=sql-server-2014-pivot%3aprimaryr2).  
...
##  <a name="bkmk_ssas__sharepoint_2010"></a>Analysis Services installé sur un serveur SharePoint 2010  
