...
# <a name="sql-server-2005-report-server-web-service-group-detected-upgrade-advisor"></a>Le groupe de service Web du serveur de rapports SQL Server 2005 a été détecté (Conseiller de mise à niveau)
  Le conseiller de mise à niveau a détecté que l’instance de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] est associée à un groupe de service Web Report Server [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)].  
