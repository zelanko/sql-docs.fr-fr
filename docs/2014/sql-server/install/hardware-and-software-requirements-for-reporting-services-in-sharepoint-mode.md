...
-   [Configuration requise pour la Power View](#bkmk_powerview)  
...
-   
  [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] en mode SharePoint requiert SharePoint Server. Pour plus d'informations sur les configurations requises et les configurations SharePoint, consultez les rubriques suivantes :  
    ...
    -   [Configuration logicielle requise pour Business Intelligence (SharePoint 2013)](https://go.microsoft.com/fwlink/p/?LinkId=256367)  
    ...
    -   [Gestion et dimensionnement de la capacité pour SharePoint Server 2010](https://technet.microsoft.com/library/cc261700.aspx\(v=office.14\))  
...
###  <a name="bkmk_report_server_database"></a>Configuration requise pour la base de données du serveur de rapports  
...
##  <a name="bkmk_powerview"></a>[!INCLUDE[ssCrescent](../../includes/sscrescent-md.md)] Configuration requise
