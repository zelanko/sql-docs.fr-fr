---
title: Installer les fonctionnalités BI de SQL Server avec SharePoint (PowerPivot et Reporting Services) | Documents Microsoft
ms.custom: ''
ms.date: 03/09/2017
...
-   [Scénarios BI de SQL Server et SharePoint 2013](#bkmk_bi_scenarios)  
...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Listes de contrôle pour l’installation des fonctionnalités BI avec SharePoint](../../../2014/sql-server/install/checklists-for-installing-bi-features-with-sharepoint.md)  
...
##  <a name="bkmk_bi_scenarios"></a> Scénarios BI de SQL Server et SharePoint 2013  
 ...
 Déploiement de le [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)] complément 2013 permet à de nouvelles fonctionnalités dans votre batterie de serveurs SharePoint. Les fonctionnalités supplémentaires comprennent [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] la galerie, la planification d’actualisation des données et le tableau de bord de gestion PowerPivot. Pour plus d'informations, reportez-vous au tableau.  
...
2.  Installez [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] en mode SharePoint, et accordez à la batterie SharePoint et aux comptes de services des droits d'administrateur de serveur dans [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)].  
     ...
     ![Le programme d’installation de rôle](../../../2014/sql-server/install/media/gmni-setupui-featurerole-sql2012sp1.gif "rôle d’installation")  
  
3.  Pour SharePoint 2013, vous pouvez étendre le [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] fonctionnalités et l’expérience. Téléchargez et exécutez **spPowerPivot.msi** données côté serveur actualiser le traitement, la collaboration et gestion de prise en charge [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] classeur. Pour plus d'informations, consultez [Microsoft SQL Server 2014 PowerPivot pour Microsoft® SharePoint](http://go.microsoft.com/fwlink/?LinkID=324854).  
...
4.  Pour configurer [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] pour SharePoint 2013, utilisez **Configuration PowerPivot pour SharePoint 2013** outil.  
     ...
     L’Assistant installation de SQL Server installe deux [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] outils de Configurations. L'un des outils de configuration prend en charge SharePoint 2013 et l'autre prend en charge SharePoint 2010.  
...
2.  L’Assistant installation de SQL Server installe deux [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] outils de Configurations. L'un des outils de configuration prend en charge SharePoint 2013 et l'autre prend en charge SharePoint 2010.  
...
1.  L’installation pour [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] en mode SharePoint est inchangé par rapport à la version précédente.  
  
     Le [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] étapes d’installation de SharePoint 2010 et SharePoint 2013 sont très similaires. Remarques importantes concernant les versions de SharePoint :  
    ...
    1.  Installez [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] en mode SharePoint. [Installation en Mode SharePoint de Reporting Services &#40;SharePoint 2010 et SharePoint 2013&#41; ](../../reporting-services/install-windows/install-reporting-services-sharepoint-mode.md) et [installer Reporting Services en Mode de SharePoint pour SharePoint 2010](../../../2014/sql-server/install/install-reporting-services-sharepoint-mode-for-sharepoint-2010.md).  
...
3.  Installer une instance de SQL Server Analysis Services en mode SharePoint et accordez les droits d’administrateur de serveur dans les comptes de services et de la batterie de serveurs SharePoint [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)].  
