...
## <a name="see-also"></a>Voir aussi  
 [Guide pratique : Lancer le conseiller de mise à niveau](../../../2014/sql-server/install/how-to-launch-upgrade-advisor.md)   
 [Exécution de l' &#40;interface utilisateur du conseiller de mise à niveau&#41;](../../../2014/sql-server/install/running-upgrade-advisor-user-interface.md)   
