---
title: 'Comment : exécuter l’Assistant analyse du Conseiller de mise à niveau | Documents Microsoft'
ms.custom: ''
ms.date: 06/13/2017
...
3.  Passez en revue la liste des composants détectés, modifiez les sélections selon les besoins, puis cliquez sur **suivant**.  
  
4.  Sur le **les paramètres de connexion** , sélectionnez l’instance de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] vous souhaitez analyser, sélectionnez la méthode d’authentification et, si nécessaire, entrez les informations de nom et mot de passe utilisateur, puis cliquez sur **suivant**.  
  
     MSSQLSERVER est le nom de l'instance par défaut.  
  
5.  Pour les composants sélectionnés, entrez les informations demandées. Pour plus d’informations sur les boîtes de dialogue individuelles, consultez [référence l’Interface utilisateur Conseiller de mise à niveau](../../../2014/sql-server/install/upgrade-advisor-user-interface-reference.md).  
  
6.  Sur le **paramètre confirmer du Conseiller de mise à niveau** passez en revue les informations que vous avez entré. Vous pouvez sélectionner **envoyer des rapports à [!INCLUDE[msCoName](../../includes/msconame-md.md)]**  si vous souhaitez soumettre votre rapport de mise à niveau. Vous pouvez également examiner la politique de confidentialité.  
