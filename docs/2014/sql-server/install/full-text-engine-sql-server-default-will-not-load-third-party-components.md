---
title: Le moteur de recherche en texte intégral Microsoft pour SQL Server ne chargera pas les composants tiers non signés par défaut | Documents Microsoft
ms.custom: ''
ms.date: 03/06/2017
