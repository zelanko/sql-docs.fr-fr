...
|Vérifiez que la batterie est opérationnelle.|D'abord, démarrez l'Administration centrale et confirmez sa disponibilité. Ensuite, ouvrez le site d’équipe en http://localhost entrant.  Vous devez voir un site d'équipe SharePoint.|  
