 ...
 **Serveur de base de données**  
 Spécifie le nom de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssDE](../../includes/ssde-md.md)] l’instance qui exécute la base de données du serveur de rapports.  
