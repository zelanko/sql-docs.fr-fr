---
title: Remplacé des plans de maintenance de base de données | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
-   Le **tenter de réparer tout problème mineur** option de le **vérifier l’intégrité de base de données** tâche  
