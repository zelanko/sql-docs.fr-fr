---
title: Paramètres de connexion | Documents Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
> [!NOTE]  
>  Si vous sélectionnez l’authentification Windows, le nom d’utilisateur de l’utilisateur actuellement connecté figure dans le **nom d’utilisateur** zone de texte.  
