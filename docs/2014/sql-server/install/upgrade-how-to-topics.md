---
title: Rubriques de procédures de mise à niveau | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="see-also"></a>Voir aussi  
 [Réduire le temps mort pour les bases de données miroir lors de la mise à niveau des Instances de serveur](../../database-engine/database-mirroring/upgrading-mirrored-instances.md)   
