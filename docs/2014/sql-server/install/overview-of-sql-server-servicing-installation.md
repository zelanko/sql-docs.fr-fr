...
-   **Sauvegardez votre [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] bases de données, fichier de configuration et référentiel** - mettre à jour une instance de [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)], vous devez sauvegarder les éléments suivants :  
