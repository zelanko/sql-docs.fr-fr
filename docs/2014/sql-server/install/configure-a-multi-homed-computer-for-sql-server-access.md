...
2.  Dans la fenêtre d’invite de commandes, tapez `ipconfig,` et appuyez sur entrée à la liste des adresses IP disponibles sur cet ordinateur.  
...
2.  Cliquez sur **Démarrer**, cliquez sur **exécuter**, type `wf.msc`, puis cliquez sur **OK**.  
