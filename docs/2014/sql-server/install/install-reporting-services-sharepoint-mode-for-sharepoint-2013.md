...
2.  Cliquez sur **paramètres**paramètres![SharePoint]paramètres(https://docs.microsoft.com/analysis-services/analysis-services/media/as-sharepoint2013-settings-gear.gif "SharePoint").  
