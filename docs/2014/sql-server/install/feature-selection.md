...
## <a name="installing-includessnoversionincludesssnoversion-mdmd-features"></a>Installation des fonctionnalités [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
 Sur le **sélection des fonctionnalités** page, le [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] fonctionnalités sont divisées en deux sections principales : **Fonctionnalités de l’instance** et **les fonctionnalités partagées**.  
