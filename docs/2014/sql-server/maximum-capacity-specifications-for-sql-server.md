...
# <a name="maximum-capacity-specifications-for-sql-server"></a>Spécifications des capacités maximales pour SQL Server
 ...
 [SQL Server les objets Moteur de base de données](#Engine)  
  
 [Objets Utilitaire SQL Server](#Utility)  
  
 [SQL Server les objets d’application de la couche données](#DAC)  
  
 [Objets Réplication SQL Server](#Replication)  
...
|Octets par ligne<br /><br /> Remarque :<br />        
