...
-   Pour le **métadonnées** modèle, vous devez avoir **ajouter** autorisation pour les métadonnées de type membre de l’entité ou feuille que vous souhaitez ajouter.  
