...
3.  Sur le **Maintenance du modèle** , sélectionnez la ligne pour le modèle que vous souhaitez supprimer.  
  
4.  Cliquez sur **supprimer du modèle sélectionné**.  
