...
3.  Sur le **Maintenance du modèle** page, sélectionnez la ligne pour le modèle que vous souhaitez supprimer.  
  
4.  Cliquez sur **modèle sélectionné Delete**.  
