...
5.  Cliquez sur le signe plus (+) pour développer **groupes feuille**, groupes **consolidés**ou **groupes de collections**, selon le type de groupe que vous souhaitez mettre à jour.  
  
6.  Cliquez sur le nom du groupe d'attributs dont vous souhaitez modifier le nom.  
  
7.  Cliquez sur **modifier l’élément sélectionné**.  
  
8.  Dans la zone Nom du **groupe feuille** , zone **nom du groupe consolidé** ou **nom du groupe de collection** , tapez le nom mis à jour du groupe d’attributs.  
