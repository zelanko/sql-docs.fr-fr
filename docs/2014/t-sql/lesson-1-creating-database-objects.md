---
title: 'Leçon 1 : Création d’objets de base de données | Microsoft Docs'
ms.custom: ''
ms.date: 06/13/2017
...
-   [Résumé : Création d’objets de base de données](lesson-1-5-summary-creating-database-objects.md)  
