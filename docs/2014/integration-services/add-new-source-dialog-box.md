...
|Gestionnaires de connexions|Sélectionnez un gestionnaire de connexions existant ou cliquez sur **\<New>** pour créer un gestionnaire de connexions.|  
