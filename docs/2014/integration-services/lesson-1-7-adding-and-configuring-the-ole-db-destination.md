...
14. Dans la fenêtre Propriétés, vérifiez que le `LocaleID` est définie sur **anglais (États-Unis)** et`DefaultCodePage` est définie sur **1252**.  
