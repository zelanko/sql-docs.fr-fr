...
description: Apprendre à importer ou exporter des données Excel avec SQL Server Integration Services (SSIS), ainsi que les conditions préalables, les problèmes connus et les limitations.
ms.date: 04/10/2018
ms.prod: sql
