...
# <a name="ssis-designer"></a>Concepteur SSIS
  ...
  [!INCLUDE[ssIS](../includes/ssis-md.md)] est un outil graphique permettant de créer et de gérer des packages [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] . 
  [!INCLUDE[ssIS](../includes/ssis-md.md)] est disponible dans [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)] , en tant que projet [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] .  
...
### <a name="control-flow-tab"></a>Onglet Flux de contrôle  
 Vous construisez le workflow de contrôle dans un package sur l’aire de conception de l’onglet **Flow Control** . faites glisser des éléments de la **boîte à outils** vers l’aire de conception et connectez-les à un contrôle en cliquant sur l’icône de l’élément, puis en faisant glisser la flèche d’un élément vers un autre.  
...
### <a name="data-flow-tab"></a>Onglet Flux de données  
 Si un package contient une tâche de flux de données, vous pouvez ajouter des flux de données au package. Vous construisez les flux de données dans un package sur l’aire de conception de l’onglet **flux de données** . faites glisser des éléments de la **boîte à outils** vers l’aire de conception et connectez-les à un flux de données en cliquant sur l’icône de l’élément, puis en faisant glisser la flèche d’un élément à un autre.  
...
### <a name="event-handlers-tab"></a>Onglet Gestionnaires d'événements  
 Vous construisez les événements dans un package sur l’aire de conception de l’onglet **gestionnaires d’événements** . Sous l’onglet **gestionnaires d’événements** , sélectionnez le package ou l’objet du package pour lequel vous souhaitez créer un gestionnaire d’événements, puis sélectionnez l’événement à associer au gestionnaire d’événements. Un gestionnaire d'événements contient un flux de contrôle et des flux de données facultatifs.  
...
##### <a name="connection-managers-area"></a>Zone Gestionnaires de connexion  
 Ajoutez et modifiez les gestionnaires de connexions utilisés par un package dans la zone **Gestionnaires de connexions** . 
  [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] inclut des gestionnaires de connexions permettant de se connecter à différentes sources de données, telles que des fichiers texte, des bases de données OLE DB et des fournisseurs .NET.  
