...
4.  Pour mettre à jour les configurations de package lors du déploiement **** de packages `True`, affectez à AllowConfigurationChanges la valeur.  
  
5.  Réglez `CreateDeploymentUtility` sur `True`.  
