...
ms.locfileid: "84965499"
---
# <a name="welcome-to-sql-server-import-and-export-wizard"></a>Assistant Importation et Exportation SQL Server
  Utilisez l' **Assistant Importation et Exportation SQL Server** pour copier et transformer des données entre des sources et des destinations de données prises en charge.  
