...
# <a name="preview-data-dialog-box-sql-server-import-and-export-wizard"></a>Boîte de dialogue Aperçu des données (Assistant Importation et Exportation SQL Server)
  Utilisez le **aperçu des données** boîte de dialogue pour afficher la requête qui la [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Assistant Importation et exportation enverra à la source de données. Vous pouvez également utiliser cette boîte de dialogue pour afficher jusqu'à 200 lignes de données exemple.  
  
 Pour en savoir plus sur la [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] importer et exporter l’Assistant, consultez [SQL Server Assistant Importation et exportation](import-and-export-data-with-the-sql-server-import-and-export-wizard.md). Pour en savoir plus sur les options de démarrage de l’Assistant et sur les autorisations requises pour exécuter l’Assistant avec succès, consultez [exécuter le SQL Server Assistant Importation et exportation](start-the-sql-server-import-and-export-wizard.md).  
...
-   Sur le **sélectionner les Tables Source et vues** page de la [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Assistant Importation et exportation, cliquez sur **aperçu**.  
