...
### <a name="table-list"></a>Liste Table  
 La partie supérieure de la **vérifier le mappage de Type de données** page est une **Table** liste qui répertorie les tables à transférer de la source vers la destination. Le tableau suivant décrit les colonnes figurant dans cette liste.  
