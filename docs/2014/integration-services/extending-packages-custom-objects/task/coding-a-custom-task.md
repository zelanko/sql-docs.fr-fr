...
ms.locfileid: "85469294"
---
# <a name="coding-a-custom-task"></a>Codage d'une tâche personnalisée
  Après avoir créé une classe qui hérite de la classe de base [Microsoft. SqlServer. Dts. Runtime. Task](/dotnet/api/microsoft.sqlserver.dts.runtime.task) et appliqué l' <xref:Microsoft.SqlServer.Dts.Runtime.DtsTaskAttribute> attribut à la classe, vous devez substituer l’implémentation des propriétés et des méthodes de la classe de base pour fournir vos fonctionnalités personnalisées.
