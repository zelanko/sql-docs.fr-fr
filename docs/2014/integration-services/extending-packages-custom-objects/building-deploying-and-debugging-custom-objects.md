...
##  <a name="top"></a>Étapes de la génération, du déploiement et du débogage d’un objet personnalisé pour Integration Services  
...
1.  [Signez](#signing) l’assembly à générer avec un nom fort.  
  
2.  [Générez](#building) l’assembly.  
  
3.  [Déployez](#deploying) l’assembly en le déplaçant ou en [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] le copiant dans le dossier approprié.  
...
5.  [Dépannez](#troubleshooting) le déploiement, si nécessaire.  
