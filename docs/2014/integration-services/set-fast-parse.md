---
title: Définir l’analyse rapide | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
4.  Dans la fenêtre Propriétés, développez le **propriétés personnalisées** nœud et définissez la `FastParse` propriété `True`.  
