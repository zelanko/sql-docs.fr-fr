 ...
 **WebMethodDocumentation**  
 Tapez une description de la méthode Web ou cliquez sur le bouton Parcourir **(...)** , puis tapez la description dans la boîte de dialogue documentation de la **méthode Web** .  
