...
12. Sur le **entrées et sorties** page de la **éditeur de Transformation de Script**, sélectionnez sortie 0, renommez-le ParentRecords et définir son `SynchronousInputID` None. Créez 2 colonnes de sortie :  
