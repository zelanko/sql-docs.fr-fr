...
> [!NOTE]  
>  L'option `/CheckPointing on` de dtexec revient à affecter la valeur True à la propriété `SaveCheckpoints` du package et la valeur Toujours à la propriété `CheckpointUsage`. Pour plus d’informations, consultez l' [utilitaire dtexec](packages/dtexec-utility.md).  
  
###  <a name="Execution"></a>Production  
...
###  <a name="Identification"></a>Détermination  
...
###  <a name="Transactions"></a>Mouvements  
