...
-   Pour vérifier la signature numérique d’un package individuel, spécifiez la `/VerifyS[igned]` option lorsque vous utilisez la **dtexec** utilitaire pour exécuter le package. Pour plus d’informations, voir [dtexec Utility](../packages/dtexec-utility.md).  
...
## <a name="see-also"></a>Voir aussi  
 [Services d’intégration &#40;SSIS&#41; Packages](../integration-services-ssis-packages.md)   
