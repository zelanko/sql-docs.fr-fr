...
```  
 ...
 ![Requête pour regrouper des erreurs XML dans Management Studio](../media/queryforxmlerrors.jpg "Requête pour regrouper des erreurs XML dans Management Studio")  
