...
5.  Sélectionnez la variable dans la liste, puis mettez à jour les valeurs `Name`dans les colonnes, `Value`type `Namespace`de **données**,,, **déclencher**la modification `Expression` , **Description** et colonnes.  
