...
## <a name="related-content"></a>Contenu associé  
 ...
 Réponse organisée, [How to Create a Dynamic Connection String in SSIS](http://go.microsoft.com/fwlink/?LinkId=321994)(Comment créer une chaîne de connexion dynamique dans SSIS), sur curatedviews.cloudapp.net.  
