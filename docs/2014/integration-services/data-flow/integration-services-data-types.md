...
-   Utilisez la transformation de colonne dérivée pour créer une copie d'une colonne ayant un type de données différent de celui de la colonne d'origine. Pour plus d’informations, voir [Derived Column Transformation](transformations/derived-column-transformation.md).  
