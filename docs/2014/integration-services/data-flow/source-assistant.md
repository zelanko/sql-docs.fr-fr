...
## <a name="related-tasks"></a>Tâches associées  
 Pour obtenir des instructions sur l'ajout d'une source et d'un gestionnaire de connexions à l'aide de l'Assistant Source, consultez [Add a Source using Source Assistant](../add-a-source-using-source-assistant.md).  
