...
-   [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]Tableau  
...
-   [Étape 4 : Test de la leçon 5 du Package du didacticiel](lesson-5-4-testing-the-lesson-5-tutorial-package.md)  
