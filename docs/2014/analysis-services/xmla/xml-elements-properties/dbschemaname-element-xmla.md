---
title: Élément DbSchemaName (XMLA) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "37323269"
---
# <a name="dbschemaname-element-xmla"></a>Élément DbSchemaName (XMLA)
  Contient le nom du schéma qu'utilise l'élément [TableNotification](tablenotification-element-xmla.md) parent dans la table identifiée par l'élément [DbTableName](name-element-xmla.md) .  
