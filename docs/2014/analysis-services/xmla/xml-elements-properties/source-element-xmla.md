...
ms.locfileid: "36042564"
---
# <a name="source-element-xmla"></a>Élément Source (XMLA)
  Représente une partition source à fusionner lors une [MergePartitions](../xml-elements-commands/mergepartitions-element-xmla.md) commande.  
