...
ms.locfileid: "48095689"
---
# <a name="storage-element-xmla"></a>Élément Storage (XMLA)
  Spécifie le volume de stockage maximal (en octets) utilisé par la commande [DesignAggregations](../xml-elements-commands/designaggregations-element-xmla.md) pour concevoir des agrégations.  
