---
title: DatabaseID, élément (XMLA) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
|------------------------|-----------------|  
|[Source](source-element-xmla.md), [Target](../xml-elements-properties/target-element-xmla.md)|1-1 : élément requis qui apparaît une fois et une seule.|  
