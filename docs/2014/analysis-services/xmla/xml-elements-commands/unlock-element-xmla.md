---
title: Élément Unlock (XMLA) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="remarks"></a>Notes  
 La commande `Unlock` supprime un verrou établi dans le contexte de la transaction actuellement active. Seuls les administrateurs de base de données ou serveur peut émettre explicitement un `Unlock` commande.  
