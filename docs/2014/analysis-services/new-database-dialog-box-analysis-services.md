---
title: Boîte de dialogue Nouvelle base de données (Analysis Services) | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
|**Nom d'utilisateur**|Tapez le domaine et le nom du compte d’utilisateur à utiliser par la base de données [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] sélectionnée. Utilisez le format suivant :<br /><br /> *\<Nom de domaine >* **\\**  *\<nom de compte d’utilisateur >*<br /><br /> Remarque : Cette option est activée uniquement si vous avez sélectionné **Utiliser un nom d’utilisateur et un mot de passe spécifiques** .|  
