---
title: Assistants (données multidimensionnelles) Analysis Services | Microsoft Docs
ms.custom: ''
ms.date: 06/14/2017
...
|[Aide (F1) de l’Assistant Importation de base de données Analysis Services](import-analysis-services-database-wizard-f1-help.md)|Utilisez l'Assistant Importation de base de données Analysis Services 9.0 pour importer une base de données [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] existante.|  
