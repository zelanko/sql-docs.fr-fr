---
title: Mettez en surbrillance les Exceptions (outils d’analyse de Table pour Excel) | Documents Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
1.  Ouvrez une table Excel et cliquez sur **mettre en surbrillance les Exceptions**.  
  
2.  Spécifiez les colonnes à analyser.  
  
3.  Cliquez sur **Exécuter**.  
  
4.  Ouvrez la feuille de calcul intitulée \<nom de table > valeurs hors norme pour afficher un résumé des observations aberrantes qui ont été trouvés.  
  
5.  Pour modifier le nombre de mises en surbrillance, cliquez sur le haut et flèches dans le **seuil des exceptions** ligne de la **mettre en surbrillance le rapport d’Exceptions**.  
...
-   Il crée une requête de prédiction en fonction des séquences de données remarquables pour déterminer si des valeurs de la feuille de calcul sont improbables.  
 ...
 Le **mettre en surbrillance les Exceptions** outil met en surbrillance les cellules de la table de données d’origine qui sont suspectes. Une couleur sombre signifie que la ligne doit faire l'objet d'une attention particulière. Une couleur claire indique que la valeur d'une cellule spécifique a été identifiée comme étant suspecte. Si vous modifiez le seuil pour les exceptions, les valeurs en surbrillance changeront également.  
