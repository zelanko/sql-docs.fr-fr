...
##  <a name="beyond-the-single-server-installation--powerpivot-for-microsoft-sharepoint"></a><a name="bkmk_multiple_servers"></a>Au-delà de l’installation à serveur unique -PowerPivot pour Microsoft SharePoint  
