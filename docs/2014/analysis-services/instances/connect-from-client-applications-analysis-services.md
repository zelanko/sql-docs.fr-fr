...
## <a name="see-also"></a>Voir aussi  
 ...
 [Méthodologies d’authentification pris en charge par Analysis Services](authentication-methodologies-supported-by-analysis-services.md)   
