...
-   [Téléchargez la version Business Intelligence de SQL Server Data Tools](http://go.microsoft.com/fwlink/p/?LinkID=322038). Le fichier est enregistré dans le dossier Téléchargements. Exécutez le programme d'installation pour installer l'outil.  
