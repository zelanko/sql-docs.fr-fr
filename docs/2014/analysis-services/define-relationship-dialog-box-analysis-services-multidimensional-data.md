...
|**Réguliers**|Spécifie une relation de dimension régulière. Les options suivantes s'affichent dans le volet **Détail** :|**Attribut de granularité**: <br />                      Sélectionnez l'attribut qui définit la granularité du groupe de mesures par rapport à la dimension. Cet attribut est généralement l'attribut clé de la dimension.|  
