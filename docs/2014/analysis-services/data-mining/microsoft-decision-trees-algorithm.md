...
### <a name="predicting-discrete-columns"></a>Prévision de colonnes discrètes  
 ...
 ![Histogramme d’algorithme MDT](../media/dt-histogram.gif "histogramme à partir de l’algorithme MDT")  
