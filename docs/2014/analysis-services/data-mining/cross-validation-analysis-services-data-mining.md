...
### <a name="setting-the-number-of-partitions"></a>Définition du nombre de partitions  
 ...
 ![Comment les segments de données de validation croisée](../media/xvoverviewmain.gif "la validation croisée les segments de données")  
...
|Décrit les étapes de création de différents graphiques d'analyse de précision.|[Test et des tâches de Validation et des procédures &#40;d’exploration de données&#41;](testing-and-validation-tasks-and-how-tos-data-mining.md)|  
