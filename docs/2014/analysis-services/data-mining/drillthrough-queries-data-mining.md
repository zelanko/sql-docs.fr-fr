...
-   Extraction des **cas de structure**  
 ...
 [Considérations relatives à l’utilisation de l’extraction](#bkmk_Considerations)  
...
##  <a name="bkmk_Considerations"></a>Considérations relatives à l’utilisation de l’extraction  
...
|Activation de l'extraction sur une structure d'exploration de données à l'aide de la clause DMX WITH DRILLTHROUGH|[CRÉER UNE STRUCTURE D’EXPLORATION DE DONNÉES &#40;DMX&#41;](/sql/dmx/create-mining-structure-dmx)|  
|Pour plus d'informations sur l'assignation d'autorisations qui s'appliquent à l'extraction sur des structures d'exploration de données et des modèles d'exploration de données|[Accordez des autorisations sur les modèles et les structures d’exploration de données &#40;Analysis Services&#41;](../multidimensional-models/grant-permissions-on-data-mining-structures-and-models-analysis-services.md)|  
