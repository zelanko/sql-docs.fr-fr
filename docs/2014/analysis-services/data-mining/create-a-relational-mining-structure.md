...
## <a name="see-also"></a>Voir aussi  
 ...
 [Propriétés de Structure d’exploration de données et les colonnes de Structure](properties-for-mining-structure-and-structure-columns.md)   
