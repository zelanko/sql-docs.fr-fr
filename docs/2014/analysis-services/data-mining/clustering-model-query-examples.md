 ...
 **Requêtes de contenu**  
 ...
 [Récupération de métadonnées de modèle à partir de l’ensemble de lignes de schéma](#bkmk_Query2)  
 ...
 **Requêtes de prédiction**  
 ...
 [Prédiction des résultats à partir d’un modèle de clustering](#bkmk_Query8)  
...
###  <a name="bkmk_Query2"></a>Exemple de requête 2 : récupération des métadonnées de modèle à partir de l’ensemble de lignes de schéma  
...
###  <a name="bkmk_Query8"></a>Exemple de requête 8 : prédiction des résultats à partir d’un modèle de clustering  
...
|[&#41;DMX &#40;cluster](/sql/dmx/cluster-dmx)|Retourne le cluster qui est le plus susceptible de contenir le cas d'entrée.|  
