...
##  <a name="bkmk_Logon"></a>Configuration du compte d’ouverture de session pour Analysis Services  
...
##  <a name="bkmk_Instance"></a>Sécurisation d’une instance de Analysis Services  
