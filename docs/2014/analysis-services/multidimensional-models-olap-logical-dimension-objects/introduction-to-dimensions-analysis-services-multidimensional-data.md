...
## <a name="dimension-based-on-a-star-schema-design"></a>Dimension basée sur un schéma en étoile  
 ...
 ![Schéma logique pour la relation de dimension de fait](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/dimfactrelationship.gif "Schéma logique pour la relation de dimension de fait")  
...
## <a name="dimension-based-on-a-snowflake-schema-design"></a>Dimension basée sur un schéma en flocon  
 ...
 ![Tables pour la dimension Product AdventureWorksAS](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/dimproduct.gif "Tables pour la dimension Product AdventureWorksAS")  
  
 Pour décrire complètement un produit, la catégorie et la sous-catégorie du produit doivent être incluses dans la dimension Product. Toutefois, ces informations ne résident pas directement dans la table principale pour la dimension **DimProduct** . Une relation de clé étrangère entre **DimProduct** et **DimProductSubcategory**, qui a à son tour une relation de clé étrangère avec la table **DimProductCategory** , permet d’inclure les informations pour les catégories de produits et sous-catégories dans la dimension Product.  
...
## <a name="snowflake-schema-versus-reference-relationship"></a>Schéma en flocon et relation de référence  
 ...
 ![Schéma logique pour l’exemple de dimension référencée](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/dimindirect.gif "Schéma logique pour l’exemple de dimension référencée")  
