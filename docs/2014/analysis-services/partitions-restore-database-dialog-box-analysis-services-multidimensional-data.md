---
title: Partitions (boîte de dialogue Restauration de base de données) (Analysis Services - données multidimensionnelles) | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
