...
|**Afficher**|Cliquez pour faire défiler les options suivantes ou pour sélectionner l'une des options suivantes pour changer la vue du volet **Vue de source de données** :<br /><br /> **Vue arborescente**: affiche les tables, nommées des requêtes, des colonnes, des calculs nommés et des relations dans une arborescence.<br /><br /> **Affichage des diagrammes**: affiche les tables, nommées des requêtes, des colonnes, des calculs nommés et des relations dans un diagramme de base de données.|  
