...
|**Traiter**|Cliquez pour afficher la boîte de dialogue **Traiter** et traiter le cube sélectionné.|  
|**Nouvelle Perspective**|Permet de créer une perspective dans le cube sélectionné.|  
|**Supprimer la Perspective**|Cliquez pour afficher la boîte de dialogue **Supprimer les objets** et supprimer la perspective sélectionnée.<br /><br /> Remarque : Cette option est activée uniquement si une perspective est sélectionnée dans le **détails des perspectives** volet.|  
