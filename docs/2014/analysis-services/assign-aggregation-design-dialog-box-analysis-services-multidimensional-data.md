---
title: Boîte de dialogue de conception d’agrégation (Analysis Services - données multidimensionnelles) affecter | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
|**Partitions de destination**|Sélectionnez les partitions auxquelles affecter la conception d'agrégation. La grille suivante permet de définir les partitions de destination :<br /><br /> \<case à cocher > : Activez ou désactivez la case à cocher dans l’en-tête de colonne à inclure ou exclure des partitions répertoriées toutes les partitions de destination. Activez ou désactivez la case à cocher située en regard d'une partition pour inclure ou exclure cette partition en tant que partition de destination.<br /><br /> **Partition**: Affiche le nom de la partition.<br /><br /> **Source**: Affiche la table ou la requête source pour la partition.<br /><br /> **Conception d’agrégation**: Affiche le nom de la conception d'agrégation existante pour la partition.|  
