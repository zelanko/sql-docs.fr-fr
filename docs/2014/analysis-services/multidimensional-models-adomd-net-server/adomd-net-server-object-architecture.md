---
title: ADOMD.NET Server Object Architecture (en anglais seulement) Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
# <a name="adomdnet-server-object-architecture"></a>Architecture des objets serveur ADOMD.NET
  Les objets ADOMD.NET serveur sont des objets d’assistance qui peuvent être utilisés pour créer des [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]fonctions définies par l’utilisateur (UDF) ou des procédures stockées dans .  
