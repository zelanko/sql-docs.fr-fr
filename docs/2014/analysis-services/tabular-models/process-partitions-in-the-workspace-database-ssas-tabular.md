...
ms.locfileid: "62794629"
---
# <a name="process-partitions-in-the-workspace-database-ssas-tabular"></a>Traiter les Partitions dans la base de données d’espace de travail (SSAS tabulaire)
