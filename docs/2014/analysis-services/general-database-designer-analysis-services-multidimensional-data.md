---
title: Général (Concepteur de base de données) (Analysis Services - données multidimensionnelles) | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
 ...
 **Langage**  
 ...
 Pour ajouter une nouvelle traduction dans la grille, cliquez sur  **\<ajouter nouvelle traduction >**.  
