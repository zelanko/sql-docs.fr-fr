---
title: Boîte de dialogue de propriétés (SSAS - tabulaire) de la table | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
|**ID**|Affiche l'identificateur de la table.|  
...
|**État**|Affiche l'état de traitement de la table. Pour plus d’informations sur les valeurs de cette propriété, consultez <xref:Microsoft.AnalysisServices.ProcessableMajorObject.State%2A>.|  
