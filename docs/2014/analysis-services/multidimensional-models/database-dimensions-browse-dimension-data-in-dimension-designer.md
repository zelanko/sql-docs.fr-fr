...
# <a name="browse-dimension-data-in-dimension-designer"></a>Explorer les données d'une dimension dans le Concepteur de dimensions
 ...
 Pour que les données d’une dimension soient affichées dans la vue **Navigateur** , la dimension doit avoir été traitée. Pour plus d’informations, consultez [traitement d’un objet de modèle multidimensionnel](processing-a-multidimensional-model-analysis-services.md).  
