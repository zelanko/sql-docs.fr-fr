---
title: Programmation des Classes complémentaires AMO et méthodes | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
3.  Démarrez et arrêtez la trace en fonction des besoins.  
     ...
     Même après avoir été arrêtée, la trace continue d'exister dans le serveur et doit redémarrer si elle a été définie comme suit : AutoRestart=`true`.  
...
1.  Commencez à capturer le journal XMLA en définissant l'attribut serveur CaptureXml à `true`.  
...
3.  Arrêtez la capture du journal XMLA en redéfinissant CaptureXml à `false`.  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [AMO autres Classes et méthodes](amo-other-classes-and-methods.md)   
