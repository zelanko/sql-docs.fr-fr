...
> [!NOTE]  
>  Cette rubrique s'applique aux solutions multidimensionnelles et d'exploration de données. Pour plus d’informations sur les solutions tabulaires, consultez [processus de base de données, la Table ou Partition](../tabular-models/process-database-table-or-partition-analysis-services.md).  
