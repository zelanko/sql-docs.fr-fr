...
|Caractère|Description|  
|---------------|-----------------|  
|**:**|Représente un séparateur horaire qui sépare les heures, les minutes et les secondes lors de la mise en forme de valeurs horaires.<br /><br /> Le caractère réel utilisé comme séparateur d'heure dans le résultat mis en forme est déterminé par les paramètres système de votre ordinateur.<br /><br /> Remarque : Dans certains paramètres régionaux, d’autres caractères peuvent utilisés comme séparateur horaire.|  
|**/**|Représente un séparateur de date qui sépare le jour, le mois et l'année lorsque les valeurs de date sont mises en forme.<br /><br /> Le caractère réel utilisé comme séparateur de date dans le résultat mis en forme est déterminé par les paramètres système de votre ordinateur.<br /><br /> Remarque : Dans certains paramètres régionaux, les autres caractères peuvent être utilisés pour représenter le séparateur de date|  
...
|**jj**|Affiche le jour sous la forme d’un nombre avec un zéro non significatif (de 01 à 31).|  
|**ddd**|Affiche le jour sous forme abrégée (Dim à SAM).|  
|**dddd**|Affiche le jour sous forme non abrégée (dimanche à samedi).|  
...
|**mm**|Affiche le mois sous la forme d’un nombre avec un zéro non significatif (de 01 à 12).<br /><br /> Si **m** suit immédiatement **h** ou **hh**, les minutes sont affichées au lieu du mois.|  
|**mmm**|Affiche le mois sous forme abrégée (Jan à Dec).|  
|**mmmm**|Affiche le mois sous forme non abrégée (janvier à décembre).|  
|**q**|Affiche le trimestre de l’année sous la forme d’un nombre (1-4).|  
|**y**|Affiche le jour de l’année sous la forme d’un nombre (1 à 366).|  
...
|**hh**|Affiche l’heure sous la forme d’un nombre avec des zéros non significatifs (de 00 à 23).|  
|**n**|Affiche la minute sous la forme d’un nombre sans zéro non significatif (0-59).|  
|**nn**|Affiche la minute sous la forme d’un nombre avec des zéros non significatifs (de 00 à 59).|  
|**s**|Affiche la seconde sous la forme d’un nombre sans zéro non significatif (0-59).|  
|**ss**|Affiche la seconde sous la forme d’un nombre avec des zéros non significatifs (de 00 à 59).|  
...
|**AM/PM**|Affiche **AM** en majuscules avec toute heure comprise entre minuit et midi et **PM** en majuscules avec toute heure comprise entre midi et minuit.<br /><br /> Remarque : Utilise l’horloge de 12 heures.|  
|**am/pm**|Affiche **am** en minuscules avec toute heure comprise entre minuit et midi, et **pm** en minuscules avec toute heure comprise entre midi et minuit.<br /><br /> Remarque : Utilise l’horloge de 12 heures.|  
|**A/P**|Affiche un **A** majuscule avec toute heure comprise entre minuit et midi et **P** majuscule avec toute heure comprise entre midi et minuit.<br /><br /> Remarque : Utilise l’horloge de 12 heures.|  
|**a/p**|Affiche un **a** minuscule avec toute heure comprise entre minuit et midi, et **p** minuscule avec toute heure comprise entre midi et minuit.<br /><br /> Remarque : Utilise l’horloge de 12 heures.|  
|**AMPM**|Affiche la constante de chaîne AM telle qu'elle est définie par votre système avec toute heure comprise entre minuit et midi, et la constante de chaîne PM telle qu'elle est définie par votre système avec toute heure comprise entre midi et minuit.<br /><br /> Remarque : Utilise l’horloge de 12 heures.<br /><br /> **AMPM** peut être exprimé en majuscules ou en minuscules, mais la casse de la chaîne affichée correspond à la définition de la chaîne dans les paramètres de votre système.<br /><br /> Pour Windows, le format par défaut est **AM/PM**.|  
