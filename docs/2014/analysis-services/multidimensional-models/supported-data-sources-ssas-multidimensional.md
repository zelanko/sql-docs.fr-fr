---
title: Sources de données pris en charge (SSAS multidimensionnel) | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "36144181"
---
# <a name="data-sources-supported-ssas-multidimensional"></a>Sources de données pris en charge (SSAS multidimensionnel)
...
|Autres bases de données relationnelles|(non applicable)|(non applicable)|Un fournisseur OLE°DB|  
 ...
 <sup>1</sup> des sources de données ODBC ne sont pas pris en charge dans les solutions multidimensionnelles. Bien qu’Analysis Services gère la connexion, les concepteurs de [!INCLUDE[ssBIDevStudio](../../includes/ssbidevstudio-md.md)] utilisés pour générer des solutions ne peuvent pas se connecter à une source de données ODBC, même en utilisant le pilote MSDASQL. Si vos besoins commerciaux exigent une source de données ODBC, envisagez de créer une solution tabulaire à la place.  
 ...
 <sup>5</sup> certaines fonctionnalités requièrent une base de données relationnelle SQL Server qui s’exécute localement. Plus particulièrement, le stockage des données d'écriture différée et le stockage ROLAP requièrent une base de données relationnelle SQL Server comme la source de données sous-jacente.  
