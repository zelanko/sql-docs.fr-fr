...
# <a name="local-cubes-analysis-services---multidimensional-data"></a>Cubes locaux (Analysis Services - Données multidimensionnelles)
 ...
 ![Architecture de client pour les cubes locaux et les modèles](../../../analysis-services/dev-guide/media/as-localcubearch9.gif "architecture du Client pour les cubes locaux et des modèles")  
