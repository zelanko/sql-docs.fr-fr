...
4.  Tapez le nouveau nom.  
    ...
    > [!NOTE]  
    >  Vous pouvez également définir le `Name` propriété d’un attribut sélectionné dans le **propriétés** fenêtre de [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)].  
