...
|**Lien**|**Description**|  
|--------------|---------------------|  
|[Créer des mesures et des groupes de mesures dans les modèles multidimensionnels](create-measures-and-measure-groups-in-multidimensional-models.md)|Choisissez entre les différentes approches permettant de créer des mesures et des groupes de mesures.|  
...
##  <a name="bkmk_mg"></a>Groupes de mesures  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Créer des mesures et des groupes de mesures dans les modèles multidimensionnels](create-measures-and-measure-groups-in-multidimensional-models.md)  
