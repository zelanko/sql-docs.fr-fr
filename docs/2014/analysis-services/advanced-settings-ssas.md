---
title: Paramètres (SSAS) avancés | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
|-|-|  
|Terme|Définition|  
|**Encoding**|Spécifiez le type de codage à utiliser : ANSI ou Unicode.<br /><br /> La valeur **Unicode** correspond à l’encodage UTF-16.|  
