...
|**Intervalle d’interrogation**|Définit la fréquence et l'unité de temps du délai qui doit s'écouler avant que [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] exécute les requêtes d'interrogation et les requêtes de traitement définies dans la grille d'interrogation.|  
