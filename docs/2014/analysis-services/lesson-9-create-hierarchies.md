...
2.  Dans le générateur de modèles, cliquez avec le `Product` bouton droit sur la table, puis cliquez sur **créer une hiérarchie**. Une hiérarchie apparaît en bas de la fenêtre de la table.  
