---
title: Catégorie d’événement état du serveur découverte | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
|Server State Discover End|35|Collecte tous les événements de fin de découverte XMLA de l'état du serveur depuis le début de la trace.|  
 ...
 Pour plus d’informations sur les colonnes associées à chaque classe d’événements Session Events, consultez [Colonnes de données des événements de découverte d’état du serveur](discover-server-state-events-data-columns.md).  
