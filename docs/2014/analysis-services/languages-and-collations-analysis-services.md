...
-   0x0416 ou 1046 pour **Portugais (Brésil)**.  
 ...
 Pour afficher une liste plus longue, consultez [ID de paramètres régionaux assignés par Microsoft](https://msdn.microsoft.com/goglobal/bb964664.aspx). Pour plus d'informations, consultez [Codage et pages de codes](https://msdn.microsoft.com/goglobal/bb688114.aspx).  
