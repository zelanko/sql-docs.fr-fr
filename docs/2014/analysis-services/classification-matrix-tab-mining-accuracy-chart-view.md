---
title: Onglet matrice de classification (vue graphique d’analyse de précision d’exploration de données) | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
 ...
 **Nombre de \<modèle > sur \< colonne prédictible >**  
