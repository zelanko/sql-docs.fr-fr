---
title: "Le chemin d'accès à la connexion de données dans le classeur pointe vers un fichier sur le lecteur local, ou est un URI non valide. Les connexions suivantes n'ont pas pu s'actualiser : Les données PowerPivot | Microsoft Docs"
ms.custom: ''
ms.date: 06/13/2017
...
|Texte du message|Le chemin d'accès à la connexion de données dans le classeur pointe vers un fichier sur le lecteur local, ou est un URI non valide. Les connexions suivantes n'ont pas pu s'actualiser : données PowerPivot|  
