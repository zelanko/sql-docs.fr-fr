 ...
 **Dans cette rubrique :**  
 ...
 [Limiter la durée de stockage de l’historique des données d’utilisation](#confighist)  
  
 [Définir des catégories de réponse de requête rapides, moyennes et lentes à des fins de création de rapports](#qrh)  
  
 [Spécifier la fréquence à laquelle les statistiques des requêtes sont signalées dans le système de collecte des données d’utilisation](#ttr)  
...
5.  Vous pouvez également mettre à jour l'emplacement du fichier journal. Pour en savoir plus, consultez la section suivante.  
...
##  <a name="confighist"></a>Limiter la durée de stockage de l’historique des données d’utilisation  
...
##  <a name="qrh"></a>Définir des catégories de réponse de requête rapides, moyennes et lentes à des fins de création de rapports  
...
##  <a name="ttr"></a>Spécifier la fréquence à laquelle les statistiques des requêtes sont signalées dans le système de collecte des données d’utilisation  
...
##  <a name="openconfig"></a>Ouvrir la page de l’application de service PowerPivot pour accéder aux paramètres de configuration  
...
|-------------|-------------------|----------|-----------------|  
|**Analysis Services les événements d’utilisation** (connexion, chargement, déchargement, requêtes)|\<> activé|Boolean|Ces valeurs sont activées ou désactivées.|  
