...
##  <a name="LoadingData"></a>Délai de chargement des données  
...
|Name|Default|Valeurs valides|Description|  
|----------|-------------|------------------|-----------------|  
