---
title: Détails (boîte de dialogue Source de Partition) de la liaison de table (Analysis Services - données multidimensionnelles) | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
