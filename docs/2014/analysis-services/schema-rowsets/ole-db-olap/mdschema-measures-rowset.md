---
title: Ensemble de lignes MDSCHEMA_MEASURES | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
|`MEASURE_CAPTION`|`DBTYPE_WSTR`||Étiquette ou légende associée à la mesure. Principalement utilisée à des fins d'affichage. Si une légende n’existe pas, `MEASURE_NAME` est retournée.|  
...
|`MEASURE_VISIBILITY`|`DBTYPE_UI2`|(Facultatif) Bitmap avec l'une des valeurs valides suivantes :<br /><br /> -1 Visible<br />-2 non Visible<br /><br /> La restriction par défaut est la valeur 1.|  
