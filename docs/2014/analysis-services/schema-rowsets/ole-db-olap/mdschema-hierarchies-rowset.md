---
title: Ensemble de lignes MDSCHEMA_HIERARCHIES | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
|`STRUCTURE`|`DBTYPE_I2`||Structure de la hiérarchie. Les valeurs valides incluent les valeurs suivantes :<br /><br /> -   `MD_STRUCTURE_FULLYBALANCED` (`0`)<br />-   `MD_STRUCTURE_RAGGEDBALANCED` (`1`)<br />-   `MD_STRUCTURE_UNBALANCED` (`2`)<br />-   `MD_STRUCTURE_NETWORK` (`3`)|  
...
|`HIERARCHY_ORIGIN`|`DBTYPE_UI2`||Masque de bits qui détermine la source de la hiérarchie :<br /><br /> -   `MD_USER_DEFINED` identifie les hiérarchies définies par l’utilisateur, et a la valeur `0x0000001`.<br />-   `MD_SYSTEM_ENABLED` identifie des hiérarchies d’attributs, et a la valeur `0x0000002`.<br />-   `MD_SYSTEM_INTERNAL` identifie des attributs sans hiérarchies d’attribut et a la valeur **0 x 0000004**.<br /><br /> Une hiérarchie d'attribut parent-enfant est à la fois `MD_USER_DEFINED` et `MD_SYSTEM_ENABLED`.|  
...
|`INSTANCE_SELECTION`|`DBTYPE_UI2`||Indicateur fourni à l'application cliente sur la manière d'afficher la hiérarchie. Les valeurs valides incluent les valeurs suivantes :<br /><br /> -   `MD_INSTANCE_SELECTION_NONE`<br />-   `MD_INSTANCE_SELECTION_DROPDOWN`<br />-   `MD_INSTANCE_SELECTION_LIST`<br />-   `MD_INSTANCE_SELECTION_FILTEREDLIST`<br />-   `MD_INSTANCE_SELECTION_MANDATORYFILTER`|  
...
|`STRUCTURE_TYPE`|`DBTYPE_WSTR`||Indique le type de hiérarchie. Les valeurs valides incluent les valeurs suivantes :<br /><br /> -   `Natural`<br />-   `Unnatural`<br />-   `Unknown`|  
