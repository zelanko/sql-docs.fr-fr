...
|`COLUMN_DEFAULT`|`DBTYPE_WSTR`||La valeur par défaut de la colonne.<br /><br /> Si la valeur par défaut est la valeur `NULL`, `COLUMN_HASDEFAULT` contient `TRUE` et cette colonne contient `NULL`.|  
