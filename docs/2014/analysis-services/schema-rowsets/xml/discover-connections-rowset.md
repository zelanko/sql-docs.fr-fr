---
title: Ensemble de lignes DISCOVER_CONNECTIONS | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
## <a name="rowset-columns"></a>Colonnes de l'ensemble de lignes  
 Le `DISCOVER_CONNECTIONS` ensemble de lignes contient les colonnes suivantes.  
  
|Nom de colonne|Indicateur de type|Restrictions|Description|  
|-----------------|--------------------|------------------|-----------------|  
|`CONNECTION_ID`|`DBTYPE_I4`|Oui|Numéro unique qui identifie la connexion.|  
