---
title: Procédure pas à pas diagramme arbre (compléments d’exploration de données) de décision | Documents Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
## <a name="build-a-decision-tree-diagram"></a>Créer un diagramme d'arbre de décision  
 Vous déposez la forme d’arbre de décision sur la page Visio pour lancer le **Assistant Création de forme arbre de décision arborescence Visio** et définir les options du diagramme.  
...
3.  Sur la page d’accueil de la **Assistant Création de forme arbre de décision arborescence Visio**, cliquez sur **suivant**.  
...
## <a name="explore-and-modify-the-finished-diagram"></a>Explorer et modifier le diagramme terminé  
 Après avoir terminé la **Assistant Création de forme arbre de décision arborescence Visio**, Visio crée un diagramme d’arbre sur la page qui affiche graphiquement les règles qui mènent au résultat prédit.  
...
1.  Cliquez sur le **compléments** de ruban et afficher une barre d’outils personnalisées utilisées pour travailler avec des diagrammes d’exploration de données :  
...
2.  Utilisez le **Re-Layout Page** option dans Visio **conception** ruban pour faire des essais avec des dispositions différentes d’arborescence.  
