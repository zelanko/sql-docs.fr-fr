...
-   [Client et les Applications de création de rapports](#bkmk_client)  
...
##  <a name="bkmk_deploymentmode"></a> Modes de déploiement serveur des solutions multidimensionnelles et tabulaires  
...
|2- Mode tabulaire|Exécute les solutions tabulaires sur une instance autonome d'Analysis Services configurée pour le mode de déploiement 2. Pour plus d’informations, consultez [installer Analysis Services en Mode tabulaire](instances/install-windows/install-analysis-services.md).|  
...
##  <a name="bkmk_Next"></a> Étape suivante : créer une solution  
...
-   Générez un modèle PowerPivot à l'aide du [Didacticiel PowerPivot pour Excel](http://go.microsoft.com/fwlink/?LinkId=251135).  
