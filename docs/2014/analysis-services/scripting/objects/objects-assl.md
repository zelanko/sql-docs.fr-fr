...
# <a name="objects-assl"></a>Objets (ASSL)
 ...
 Bien que le schéma ASSL renferme uniquement des éléments XML à partir du point de vue d’un développeur, les éléments décrits dans cette section correspondent aux objets, tels que `Database`, `Cube`, et `Dimension` objets, dans la hiérarchie des objets contenus dans un instance de [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)].  
...
|[Élément AllMemberTranslation &#40;ASSL&#41;](translation-element-assl.md)|Contient une traduction de la légende du membre All d’un [hiérarchie](hierarchy-element-assl.md) élément.|  
...
|[Élément AttributeAllMemberTranslation &#40;ASSL&#41;](attributeallmembertranslation-element-assl.md)|Contient une traduction de la légende du membre All d’un [DimensionAttribute](../data-type/dimensionattribute-data-type-assl.md) élément.|  
...
|[Bloquer l’élément &#40;ASSL&#41;](block-element-assl.md)|Contient l’ensemble ou une partie du contenu binaire d’un [ClrAssemblyFile](../data-type/clrassemblyfile-data-type-assl.md) élément.|  
...
|[Élément CalculationProperty &#40;ASSL&#41;](calculationproperty-element-assl.md)|Contient une collection de propriétés d’interface utilisateur pour un calcul utilisé dans une [MdxScript](mdxscript-element-assl.md) élément.|  
...
|[Élément de la colonne &#40;ASSL&#41;](column-element-assl.md)|Décrit une colonne dans la collection de colonnes associée à l'élément parent.|  
...
|[Élément de source de données &#40;ASSL&#41;](datasource-element-assl.md)|Définit une source de données dans un [base de données](database-element-assl.md) élément.|  
...
|[Élément de dimension &#40;ASSL&#41;](dimension-element-assl.md)|Définit une dimension.|  
|[Élément DimensionPermission &#40;ASSL&#41;](dimensionpermission-element-assl.md)|Définit les autorisations qui appartiennent à un particulier [rôle](role-element-assl.md) élément pour une dimension de base de données spécifique ou de la dimension de cube.|  
...
|[Élément Event &#40;ASSL&#41;](event-element-assl.md)|Définit un événement à capturer dans le cadre d’un [Trace](trace-element-assl.md) élément.|  
|[Élément de fichier &#40;ASSL&#41;](file-element-assl.md)|Définit un des fichiers qui composent un [ClrAssembly](../data-type/assembly-data-type-assl.md) élément.|  
...
|[Élément de groupe &#40;ASSL&#41;](group-element-assl.md)|Définit un groupe de membres liés à un attribut.|  
...
|[Élément niveau &#40;ASSL&#41;](level-element-assl.md)|Définit un niveau dans un [hiérarchie](hierarchy-element-assl.md) élément.|  
...
|[Élément de mesures &#40;ASSL&#41;](measure-element-assl.md)|Définit une mesure.|  
...
|[Élément MiningModelPermission &#40;ASSL&#41;](miningmodelpermission-element-assl.md)|Définit les autorisations de membres d’un [rôle](role-element-assl.md) élément avoir un individu [MiningModel](miningmodel-element-assl.md) élément.|  
...
|[Élément MiningStructurePermission &#40;ASSL&#41;](miningstructurepermission-element-assl.md)|Définit les autorisations que les membres d’un [rôle](role-element-assl.md) élément avoir un individu [MiningStructure](miningstructure-element-assl.md) élément.|  
...
|[Élément NamingTemplateTranslation &#40;ASSL&#41;](namingtemplatetranslation-element-assl.md)|Fournit une traduction localisée de la `NamingTemplate` élément un parent [DimensionAttribute](../data-type/dimensionattribute-data-type-assl.md) type de données.|  
...
|[Élément serveur &#40;ASSL&#41;](server-element-assl.md)|Décrit une instance de [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)].|  
...
|[Élément TableNotification &#40;ASSL&#41;](tablenotification-element-assl.md)|Contient des informations pour le [ProactiveCaching](proactivecaching-element-assl.md) élément sur une table ou une vue dans une source de données qui a été modifiée.|  
