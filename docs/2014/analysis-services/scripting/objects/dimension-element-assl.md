---
title: Dimension, élément (ASSL) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
|------------------------|---------------|  
|[Base de données](../data-type/dimension-data-type-assl.md)|  
|[Agrégation](../data-type/aggregationdimension-data-type-assl.md)|  
...
|[Groupe de mesures](../data-type/measuregroupdimension-data-type-assl.md)|  
|[Point de vue](../data-type/perspectivedimension-data-type-assl.md)|  
  
## <a name="element-relationships"></a>Relations entre les éléments  
  
|Relation|Élément|  
|------------------|-------------|  
|Éléments parents|[Dimensions](../collections/dimensions-element-assl.md)|  
