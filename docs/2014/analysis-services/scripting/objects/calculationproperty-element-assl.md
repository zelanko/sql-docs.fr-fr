...
ms.locfileid: "36140387"
---
# <a name="calculationproperty-element-assl"></a>Élément CalculationProperty (ASSL)
  Contient une collection de propriétés d’interface utilisateur pour un calcul utilisé dans une [MdxScript](mdxscript-element-assl.md) élément.  
