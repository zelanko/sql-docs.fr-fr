---
title: Élément IntermediateCubeDimensionID (ASSL) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="remarks"></a>Notes  
 L’élément qui correspond au parent de `IntermediateCubeDimensionID` dans l’objet d’objets AMO (Analysis Management) modèle est <xref:Microsoft.AnalysisServices.ReferenceMeasureGroupDimension>.  
