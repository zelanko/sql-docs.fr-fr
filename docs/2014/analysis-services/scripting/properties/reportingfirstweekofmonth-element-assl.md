---
title: Élément ReportingFirstWeekOfMonth (ASSL) | Microsoft Docs
ms.custom: ''
ms.date: 04/27/2017
...
## <a name="remarks"></a>Notes  
 L’élément qui correspond au parent de `ReportingFirstWeekOfMonth` dans l’objet d’objets AMO (Analysis Management) modèle est <xref:Microsoft.AnalysisServices.TimeBinding>.  
