---
title: Type de données TabularBinding (ASSL) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
|Types de données dérivés|[DSVTableBinding](tablebinding-data-type-assl.md), [QueryBinding](querybinding-data-type-assl.md), [TableBinding](tablebinding-data-type-assl.md)|  
