...
|Éléments enfants|[AttributeID](../properties/id-element-assl.md), [Ordinal](../properties/ordinal-element-assl.md), [Type](../properties/type-element-binding-assl.md)|  
|Éléments dérivés|Consultez [de liaison](binding-data-type-assl.md)|  
  
## <a name="remarks"></a>Notes  
 Pour plus d’informations sur la `Binding` type de données, notamment des tableaux des objets Analysis Services Scripting Language (ASSL) dérivés de la `Binding` de type de données, consultez [Type de données de liaison &#40;ASSL&#41;](binding-data-type-assl.md).  
