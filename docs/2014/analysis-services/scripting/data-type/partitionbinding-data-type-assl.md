---
title: Type de données PartitionBinding (ASSL) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "37281915"
---
# <a name="partitionbinding-data-type-assl"></a>Type de données PartitionBinding (ASSL)
  Définit un type de données dérivé qui représente une liaison à un [Partition](../objects/partition-element-assl.md) élément.  
...
|Éléments enfants|[CubeID](../../xmla/xml-elements-properties/id-element-xmla.md), [DatabaseID](../../xmla/xml-elements-properties/databaseid-element-xmla.md), [PartitionID](../../xmla/xml-elements-properties/partitionid-element-xmla.md), [Source](../properties/source-element-binding-assl.md)|  
