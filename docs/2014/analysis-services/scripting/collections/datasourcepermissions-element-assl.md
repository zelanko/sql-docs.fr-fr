...
ms.locfileid: "36153336"
---
# <a name="datasourcepermissions-element-assl"></a>Élément DataSourcePermissions (ASSL)
  Contient la collection de [DataSourcePermission](../objects/datasourcepermission-element-assl.md) éléments associés à un [source de données](../data-type/datasource-data-type-assl.md) type de données.  
