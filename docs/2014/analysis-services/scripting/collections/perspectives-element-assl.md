---
title: Perspectives, élément (ASSL) | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
ms.locfileid: "48171479"
---
# <a name="perspectives-element-assl"></a>Élément Perspectives (ASSL)
  Contient la collection de [Perspective](../objects/perspective-element-assl.md) éléments associés à un [Cube](../objects/cube-element-assl.md) élément.  
...
|Éléments enfants|[Point de vue](../objects/perspective-element-assl.md)|  
