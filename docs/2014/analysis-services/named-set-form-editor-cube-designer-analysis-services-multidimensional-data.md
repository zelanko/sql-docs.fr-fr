---
title: Éditeur de formulaire de jeu (onglet calculs, Concepteur de Cube) nommé (Analysis Services - données multidimensionnelles) | Microsoft Docs
ms.custom: ''
ms.date: 06/14/2017
