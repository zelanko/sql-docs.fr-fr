---
title: Spécifier les Conventions d’affectation de noms (Assistant génération de schéma) (Analysis Services - données multidimensionnelles) | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
|**Préfixe de colonne de clé primaire**|Spécifie la chaîne de préfixe du nom de chaque colonne clé primaire. La valeur par défaut est **PK**.|  
|**Préfixe de colonne de clé étrangère**|Spécifie la chaîne de préfixe du nom de chaque colonne clé étrangère. La valeur par défaut est **FK**.|  
|**Suffixe de nom d’attribut**|Spécifie la chaîne à ajouter au nom de chaque colonne d'attribut. La valeur par défaut est **Name**.|  
