...
|Option|Description|  
|------------|-----------------|  
|**Concevoir des agrégations**|Cliquez pour afficher l' **Assistant Conception d'agrégation**.|  
|**L’optimisation basée sur l’utilisation**|Cliquez pour afficher l'Assistant **Optimisation basée sur l'utilisation** .|  
