---
title: Modifications avec rupture Analysis Services des fonctionnalités de SQL Server 2014 | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
##  <a name="bkmk_sql2014"></a> Modifications avec rupture dans [!INCLUDE[ssSQL14](../includes/sssql14-md.md)]  
 Il existe aucune nouvelle annoncées tabulaire, multidimensionnel, exploration de données, des modifications avec rupture ou [!INCLUDE[ssGeminiShort](../includes/ssgeminishort-md.md)] fonctionnalités dans cette version.  Toutefois, étant donné que [!INCLUDE[ssASCurrent](../includes/ssascurrent-md.md)] est similaire à celle du [!INCLUDE[ssSQL11](../includes/sssql11-md.md)] et [!INCLUDE[ssSQL11SP1](../includes/sssql11sp1-md.md)] versions, les modifications avec rupture des deux versions précédentes sont fournies ici à titre informatif au cas où vous mettez à niveau à partir de [!INCLUDE[ssKatmai](../includes/sskatmai-md.md)].  
 ...
 **Respect de la casse des identificateurs d’objet**  
