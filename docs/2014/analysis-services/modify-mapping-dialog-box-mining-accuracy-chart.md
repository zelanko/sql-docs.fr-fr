---
title: Modifier le mappage de la boîte de dialogue (graphique de précision d’exploration de données) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
