...
|[Objects &#40;XMLA&#41;](https://docs.microsoft.com/bi-reference/xmla/xml-elements-objects)|Décrit les éléments les plus hauts reçus par une application dans une enveloppe SOAP émanant d'une instance [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] en réponse à une méthode XMLA.|  
