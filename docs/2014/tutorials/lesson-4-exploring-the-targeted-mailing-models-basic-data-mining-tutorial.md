---
title: 'Leçon 4 : Exploration des modèles de publipostage ciblé (didacticiel d’exploration de données de base de données) | Documents Microsoft'
ms.custom: ''
ms.date: 06/13/2017
...
-   [Exploration du modèle Naive Bayes &#40;didacticiel d’exploration de données de base de données&#41;](../../2014/tutorials/exploring-the-naive-bayes-model-basic-data-mining-tutorial.md)  
 ...
 Les trois modèles peuvent être affichés à l’aide de la **visionneuse d’arborescence de contenu générique**, pour extraire les formules, des valeurs de données et ainsi de suite.  
