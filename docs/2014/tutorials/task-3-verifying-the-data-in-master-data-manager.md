...
1.  Si vous avez gardé ouvert **Master Data Manager** , cliquez sur **SQL Server 2012 Master Data Services** en haut pour accéder à la page d'accueil. Dans le cas contraire `http://localhost/MDS` , accédez à pour lancer le **Data Manager maître**.
