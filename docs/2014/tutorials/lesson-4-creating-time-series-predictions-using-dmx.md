---
title: 'Leçon 4 : Création de prédictions de série chronologique à l’aide de DMX | Documents Microsoft'
ms.custom: ''
ms.date: 06/13/2017
...
-   Ajout de nouvelles données au modèle ou mise à jour du modèle  
 ...
 Utilisez [PredictTimeSeries &#40;DMX&#41; ](/sql/dmx/predicttimeseries-dmx) pour retourner le nombre spécifié de prédictions à partir du modèle d’exploration de données qualifié.  
  
 Par exemple, consultez [PredictTimeSeries &#40;DMX&#41; ](/sql/dmx/predicttimeseries-dmx) ou [temps Series Model Query Examples](../../2014/analysis-services/data-mining/time-series-model-query-examples.md).  
 ...
 REPLACE_MODEL_CASES  
 Utilisez [PredictTimeSeries &#40;DMX&#41; ](/sql/dmx/predicttimeseries-dmx) avec l’argument REPLACE_MODEL_CASES pour remplacer les données d’origine par une nouvelle série de données et créer des prédictions basées sur l’application des modèles dans le modèle d’exploration de données pour les nouvelles données série.  
  
 Pour obtenir un exemple d’utilisation de REPLACE_MODEL_CASES, consultez [leçon 2 : génération d’un scénario de prévision &#40;didacticiel d’exploration de données intermédiaire&#41;](../../2014/tutorials/lesson-2-building-a-forecasting-scenario-intermediate-data-mining-tutorial.md).  
