---
title: En spécifiant le Type de données et le Type de contenu (didacticiel d’exploration de données de base de données) | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
1.  Sur le **Type de données et de contenu des colonnes spécifier** , cliquez sur **détecter** pour exécuter un algorithme qui détermine les données par défaut et les types de contenu pour chaque colonne.  
  
2.  Passez en revue les entrées dans le **le Type de contenu** et **Type de données** colonnes et modifiez-les si nécessaire, pour vous assurer que les paramètres sont les mêmes que ceux répertoriés dans le tableau suivant.  
  
     En général, l'Assistant détecte les nombres et attribue un type de données numériques approprié. Toutefois, dans de nombreux scénarios, vous pouvez souhaiter gérer un nombre comme texte. Par exemple, le **GeographyKey** doivent être traités en tant que texte, car il ne convient pas effectuer des opérations mathématiques sur cet identificateur.  
  
    |colonne|Type de contenu|Type de données|  
    |------------|------------------|---------------|  
    |**Adresse ligne1**|**Discrètes**|**Texte**|  
    |**Adresse ligne2**|**Discrètes**|**Texte**|  
    |**Durée de vie**|**Continue**|**Long**|  
...
## <a name="next-task-in-lesson"></a>Tâche suivante de la leçon  
 [Spécification d’un jeu de données de test pour la Structure &#40;didacticiel d’exploration de données de base de données&#41;](../../2014/tutorials/specifying-a-testing-data-set-for-the-structure-basic-data-mining-tutorial.md)  
  
## <a name="previous-task-in-lesson"></a>Tâche précédente de la leçon  
 [Création d’une Structure de modèle d’exploration de données publipostage ciblé &#40;didacticiel d’exploration de données de base de données&#41;](../../2014/tutorials/creating-a-targeted-mailing-mining-model-structure-basic-data-mining-tutorial.md)  
