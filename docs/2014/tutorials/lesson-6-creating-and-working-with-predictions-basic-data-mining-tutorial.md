---
title: 'Leçon 6 : Création et utilisation de prédictions (didacticiel d’exploration de données de base) | Microsoft Docs'
ms.custom: ''
ms.date: 06/13/2017
...
---
# <a name="lesson-6-creating-and-working-with-predictions-basic-data-mining-tutorial"></a>Leçon 6 : Création et utilisation de prédictions (didacticiel d’exploration de données de base)
 ...
 Dans cette leçon, que vous allez créer une requête pour prédire quels clients sont susceptibles d’acheter un vélo. Vous récupérerez également le *probabilité* que la prédiction soit correcte, afin que le service marketing peut décider si à vous pouvez décider s’il faut utiliser la prédiction ou non.  
...
## <a name="see-also"></a>Voir aussi  
 [Contenu pour les modèles d’arbre de décision du modèle d’exploration de données &#40;Analysis Services - Exploration de données&#41;](../../2014/analysis-services/data-mining/mining-model-content-for-decision-tree-models-analysis-services-data-mining.md)   
