---
title: 'Leçon 5 : Test des modèles (didacticiel d’exploration de données de base) | Microsoft Docs'
ms.custom: ''
ms.date: 06/13/2017
...
1.  Vous apporterez des prédictions sur le jeu de test pour voir le modèle de niveau de précision est sur des résultats connus. Vous allez utiliser un *graphique de courbes d’élévation* pour mesurer son efficacité.  
