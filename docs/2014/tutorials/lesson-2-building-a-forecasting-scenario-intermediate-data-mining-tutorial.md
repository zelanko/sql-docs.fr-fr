...
# <a name="lesson-2-building-a-forecasting-scenario-intermediate-data-mining-tutorial"></a>Leçon 2 : Création d’un scénario de prévision (didacticiel d’exploration de données intermédiaire)
 ...
 Pour trouver les informations demandées, dans cette leçon vous résume les données de ventes de l’entreprise au niveau mensuel et synthétiser les chiffres des ventes en trois régions : Europe, Amérique du Nord et Pacifique.  
...
## <a name="all-lessons"></a>Toutes les leçons  
 ...
 Leçon 2 : Prévision de scénario (didacticiel d’exploration de données intermédiaire)  
