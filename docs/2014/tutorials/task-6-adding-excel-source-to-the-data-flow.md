---
title: 'Tâche 6 : Ajout de Source Excel au flux de données | Documents Microsoft'
ms.custom: ''
ms.date: 03/06/2017
...
## <a name="next-step"></a>Étape suivante  
 [Tâche 7 : Ajout d’une transformation au flux de données de nettoyage DQS](../integration-services/data-flow/data-flow.md)  
