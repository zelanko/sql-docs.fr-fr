---
title: Modification de la Structure de prévision (didacticiel sur l’exploration des données intermédiaires) | Documents Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
2.  Faites glisser la colonne de quantité à partir de la **vue de Source de données** volet dans la liste des colonnes pour le **Forecasting** structure.  
     ...
     La colonne Amount est désormais incluse dans le **Forecasting** structure d’exploration de données.  
