---
title: Création d’une données de Source de vue (didacticiel d’exploration de données de base de données) | Documents Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
3.  Sur le **sélectionner une Source de données** sous **sources de données relationnelles**, sélectionnez la source de données Adventure Works DW 2012 que vous avez créé dans la dernière tâche. Cliquez sur **Suivant**.  
...
## <a name="see-also"></a>Voir aussi  
 [Vue de Source de définition de données &#40;Analysis Services&#41;](../analysis-services/multidimensional-models/defining-a-data-source-view-analysis-services.md)  
