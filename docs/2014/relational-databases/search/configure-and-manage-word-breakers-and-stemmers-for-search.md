...
##  <a name="register"></a>Inscription des analyseurs lexicaux  
...
##  <a name="lang"></a>Choix de la langue d’une colonne indexée  
...
##  <a name="tshoot"></a>Résolution des erreurs d’expiration de la césure des mots  
