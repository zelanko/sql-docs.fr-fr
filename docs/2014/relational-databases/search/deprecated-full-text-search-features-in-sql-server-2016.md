...
|------------------------|-----------------|------------------|----------------|  
|Propriété FULLTEXTCATALOGPROPERTY : LogSize|Aucune.|FULLTEXTCATALOGPROPERTY **('LogSize')**|211|  
|Propriété FULLTEXTSERVICEPROPERTY :<br /><br /> ConnectTimeout<br /><br /> DataTimeout|Aucune.|FULLTEXTSERVICEPROPERTY **('ConnectTimeout')**<br /><br /> FULLTEXTSERVICEPROPERTY **('DataTimeout'**)|210<br /><br /> 209|  
...
|Option CREATE FULLTEXT CATALOG :<br /><br /> DANS le chemin d’accès'*RootPath*'<br /><br /> ON FILEGROUP *filegroup*|Aucune.|CREATE FULLTEXT CATLOG IN PATH<br /><br /> Aucun.*|237<br /><br /> None.<sup>*</sup>|  
|Propriété DATABASEPROPERTYEX : IsFullTextEnabled|Aucune.|DATABASEPROPERTYEX **('IsFullTextEnabled')**|202|  
|Option sp_detach_db :<br /><br /> [ @keepfulltextindexfile = ] '*conserver_fichier_index_recherche_en_texte-intégral*'|Aucune.|sp_detach_db @keepfulltextindexfile|226|  
