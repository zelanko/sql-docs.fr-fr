...
|Valeurs d’action sp_fulltext_service : resource_usage n’a pas de fonction.|None|sp_fulltext_service @action=resource_usage|200|  
 ...
 \*L’objet **SQL Server : fonctionnalités déconseillées** n’analyse pas les occurrences de CREATE FULLTEXT CATLOG on FileGroup sur le *groupe*de fichiers FileGroup.  
