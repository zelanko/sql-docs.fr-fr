...
###  <a name="like"></a> Comparaison de LIKE et la recherche en texte intégral  
...
##  <a name="architecture"></a> Composants et Architecture de recherche en texte intégral  
...
-   Processus hôte de démon de filtre (fdhost.exe).  
 ...
 ![architecture de recherche en texte intégral](../../database-engine/media/ifts-arch.gif "architecture de recherche en texte intégral")  
...
##  <a name="components"></a> Composants linguistiques et prise en charge linguistique dans la recherche en texte intégral  
