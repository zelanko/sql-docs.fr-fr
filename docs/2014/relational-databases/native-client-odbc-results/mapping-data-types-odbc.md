...
### <a name="retrieving-data-from-the-server"></a>Récupération de données à partir du serveur  
 ...
 Si aucune liaison n’est spécifié, le [SQLGetData](../native-client-odbc-api/sqlgetdata.md) fonction peut être utilisée pour déterminer le type de données d’une instance dans le **sql_variant** colonne.  
