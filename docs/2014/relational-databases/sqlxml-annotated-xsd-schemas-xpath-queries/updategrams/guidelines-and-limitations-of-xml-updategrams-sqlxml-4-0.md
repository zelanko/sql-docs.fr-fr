...
-   Si vous utilisez une mise à jour avec plusieurs  **\<avant >** et  **\<après >** blocs dans le  **\<synchronisation >** de balise, à la fois  **\<avant >** blocs et  **\<après >** doivent être spécifiés pour le formulaire  **\<avant >** et  **\<après >** paires.  
