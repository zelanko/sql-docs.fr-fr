...
-   Spécifier des colonnes supplémentaires dans la table dans le  **\<avant >** bloc.  
     ...
     Par exemple, la mise à jour suivant met à jour le nom de l’équipe, mais spécifie des colonnes supplémentaires (StartTime, EndTime) dans le  **\<avant >** bloc, en demandant ainsi un niveau supérieur de protection contre les simultanées mises à jour.  
