...
ms.locfileid: "36141788"
---
# <a name="sqlrowcount"></a>SQLRowCount
  Lorsque les tableaux de valeurs de paramètre sont liés pour l’exécution des instructions, `SQLRowCount` retourne SQL_ERROR si n’importe quelle ligne de valeurs de paramètre génère une condition d’erreur dans l’exécution des instructions. Aucune valeur n'est retournée via l'argument *RowCountPtr* de la fonction.  
