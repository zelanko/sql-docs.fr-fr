---
title: Gérer les métadonnées lors de la disposition d’une base de données sur une autre Instance de serveur (SQL Server) | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
