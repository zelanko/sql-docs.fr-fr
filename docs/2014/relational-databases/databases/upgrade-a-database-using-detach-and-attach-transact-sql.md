...
##  <a name="SSMSProcedure"></a>Pour mettre à niveau une base de données à l’aide du détachement et de l’attachement  
...
3.  Attachez les fichiers copiés à l'instance de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]. Pour plus d’informations, consultez la rubrique [Attacher une base de données](attach-a-database.md).  
