...
6.  Dans le **propriétés des statistiques -**_statistics_name_ boîte de dialogue, sélectionnez le **mettre à jour des statistiques pour ces colonnes** case à cocher, puis cliquez sur **OK**.  
