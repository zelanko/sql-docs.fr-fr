...
-   [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)] est l’outil principal pour administrer le [!INCLUDE[ssDE](../includes/ssde-md.md)] et en écriture [!INCLUDE[tsql](../includes/tsql-md.md)] code. Il est hébergé dans le shell [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] . Il n’est pas inclus dans [!INCLUDE[ssExpress](../includes/ssexpress-md.md)] mais reste disponible en téléchargement séparé à partir de [Microsoft Download Center](http://go.microsoft.com/fwlink/?LinkId=144346).  
...
2.  Sur le **général** page, dans le **nom de connexion** , tapez une connexion Windows au format  *\<domaine >\\< connexion\>*.  
