...
|-----------------|-----------------|  
|DBPROP_INDEX_AUTOUPDATE|R/W : en lecture/écriture<br /><br /> Valeur par défaut : None<br /><br /> Description : Le [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Client fournisseur OLE DB natif ne prend pas en charge cette propriété. Les tentatives de définir la propriété dans **CreateIndex** provoquent une valeur de retour DB_S_ERRORSOCCURRED. Le membre *dwStatus* de la structure de propriété indique DBPROPSTATUS_BADVALUE.|  
|DBPROP_INDEX_CLUSTERED|R/W : en lecture/écriture<br /><br /> Valeur par défaut : VARIANT_FALSE<br /><br /> Description : Contrôles le clustering d’index.<br /><br /> VARIANT_TRUE : Le [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Client fournisseur OLE DB natif tente de créer un index cluster sur le [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] table. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] prend en charge au plus un index cluster sur une table.<br /><br /> VARIANT_FALSE : Le [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] les fournisseur OLE DB Native Client tente de créer un index non cluster sur le [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] table.|  
|DBPROP_INDEX_FILLFACTOR|R/W : en lecture/écriture<br /><br /> Valeur par défaut : 0<br /><br /> Description : Spécifie le pourcentage d’une page d’index utilisé pour le stockage. Pour plus d’informations, consultez [CREATE INDEX](/sql/t-sql/statements/create-index-transact-sql).<br /><br /> Le type de la variante est VT_I4. La valeur doit être supérieure ou égale à 1 et inférieure ou égale à 100.|  
|DBPROP_INDEX_INITIALIZE|R/W : en lecture/écriture<br /><br /> Valeur par défaut : None<br /><br /> Description : Le [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Client fournisseur OLE DB natif ne prend pas en charge cette propriété. Les tentatives de définir la propriété dans **CreateIndex** provoquent une valeur de retour DB_S_ERRORSOCCURRED. Le membre *dwStatus* de la structure de propriété indique DBPROPSTATUS_BADVALUE.|  
|DBPROP_INDEX_NULLCOLLATION|R/W : en lecture/écriture<br /><br /> Valeur par défaut : None<br /><br /> Description : Le [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Client fournisseur OLE DB natif ne prend pas en charge cette propriété. Les tentatives de définir la propriété dans **CreateIndex** provoquent une valeur de retour DB_S_ERRORSOCCURRED. Le membre *dwStatus* de la structure de propriété indique DBPROPSTATUS_BADVALUE.|  
|DBPROP_INDEX_NULLS|R/W : en lecture/écriture<br /><br /> Valeur par défaut : None<br /><br /> Description : Le [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Client fournisseur OLE DB natif ne prend pas en charge cette propriété. Les tentatives de définir la propriété dans **CreateIndex** provoquent une valeur de retour DB_S_ERRORSOCCURRED. Le membre *dwStatus* de la structure de propriété indique DBPROPSTATUS_BADVALUE.|  
|DBPROP_INDEX_PRIMARYKEY|R/W : en lecture/écriture<br /><br /> Valeur par défaut : VARIANT_FALSE Description : Crée l’index comme intégrité référentielle, contrainte PRIMARY KEY.<br /><br /> VARIANT_TRUE : L’index est créé pour prendre en charge de la contrainte de clé primaire de la table. Les colonnes ne doivent pas accepter les valeurs null.<br /><br /> VARIANT_FALSE : L’index n’est pas utilisé comme une contrainte PRIMARY KEY pour les valeurs de ligne dans la table.|  
|DBPROP_INDEX_SORTBOOKMARKS|R/W : en lecture/écriture<br /><br /> Valeur par défaut : None<br /><br /> Description : Le [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Client fournisseur OLE DB natif ne prend pas en charge cette propriété. Les tentatives de définir la propriété dans **CreateIndex** provoquent une valeur de retour DB_S_ERRORSOCCURRED. Le membre *dwStatus* de la structure de propriété indique DBPROPSTATUS_BADVALUE.|  
|DBPROP_INDEX_TEMPINDEX|R/W : en lecture/écriture<br /><br /> Valeur par défaut : None<br /><br /> Description : Le [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Client fournisseur OLE DB natif ne prend pas en charge cette propriété. Les tentatives de définir la propriété dans **CreateIndex** provoquent une valeur de retour DB_S_ERRORSOCCURRED. Le membre *dwStatus* de la structure de propriété indique DBPROPSTATUS_BADVALUE.|  
|DBPROP_INDEX_TYPE|R/W : en lecture/écriture<br /><br /> Valeur par défaut : None<br /><br /> Description : Le [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Client fournisseur OLE DB natif ne prend pas en charge cette propriété. Les tentatives de définir la propriété dans **CreateIndex** provoquent une valeur de retour DB_S_ERRORSOCCURRED. Le membre *dwStatus* de la structure de propriété indique DBPROPSTATUS_BADVALUE.|  
|DBPROP_INDEX_UNIQUE|R/W : en lecture/écriture<br /><br /> Valeur par défaut : VARIANT_FALSE<br /><br /> Description : Crée l’index comme une contrainte UNIQUE sur l’ou les colonnes participantes.<br /><br /> VARIANT_TRUE : L’index est utilisé pour la contrainte unique sur les valeurs de ligne de la table.<br /><br /> VARIANT_FALSE : L’index ne contraint pas identifie de façon unique les valeurs de ligne.|  
