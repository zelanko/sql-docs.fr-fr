...
5.  Appelez [bcp_control](../../native-client-odbc-extensions-bulk-copy-functions/bcp-control.md), définissez eOption sur BCPHINTS et placez dans iValue un pointeur vers un tableau SQLTCHAR contenant l’instruction SELECT.  
