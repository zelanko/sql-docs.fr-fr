...
-   **Pour afficher ou modifier le mode de récupération d’une base de données, à l’aide de :**  
...
##  <a name="FollowUp"></a> Recommandations de suivi : Après avoir modifié le modèle de récupération  
