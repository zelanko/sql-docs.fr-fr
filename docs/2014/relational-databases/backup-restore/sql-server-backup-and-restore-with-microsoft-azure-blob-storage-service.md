...
---
# <a name="sql-server-backup-and-restore-with-azure-blob-storage-service"></a>SQL Server la sauvegarde et la restauration avec le service de stockage d’objets BLOB Azure
