...
> [!NOTE]  
>  Lorsque vous spécifiez une tâche de restauration [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]à l’aide de, vous [!INCLUDE[tsql](../../includes/tsql-md.md)]pouvez générer le script de [restauration](/sql/t-sql/statements/restore-statements-transact-sql) correspondant en cliquant sur **script** , puis en sélectionnant une destination pour le script.  
