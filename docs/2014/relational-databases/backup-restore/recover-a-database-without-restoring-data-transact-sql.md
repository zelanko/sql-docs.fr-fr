...
> [!NOTE]  
>  La **=** \<*backup_device> clause from * n’est pas utilisée pour les restaurations avec récupération uniquement, car aucune sauvegarde n’est nécessaire.  
