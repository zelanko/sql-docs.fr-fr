---
title: Spécifier si une sauvegarde ou une opération de restauration continue ou s’arrête après la survenue d’une erreur (SQL Server) | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
