...
```  
 ...
 Les éléments suivants [!INCLUDE[tsql](../../includes/tsql-md.md)] instruction inscrit l’assembly à l’aide de *< assembly_bits >* argument dans la clause FROM. Cette valeur `varbinary` représente le fichier sous la forme d'un flux d'octets.  
