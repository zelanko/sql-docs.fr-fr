---
title: Compteurs de Performance XTP (OLTP en mémoire) | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
|[Stockage XTP](sql-server-xtp-storage.md)|L'objet de performance XTP Storage contient des compteurs associés au stockage XTP dans [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].|  
