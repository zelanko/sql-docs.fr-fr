...
```  
 ...
 Le consommateur peut annuler la commande à l’aide de [ISSAbort::Abort](../native-client-ole-db-interfaces/issabort-abort-ole-db.md) ou en libérant toutes les références détenues sur l’objet de commande et de l’ensemble de lignes dérivée.  
