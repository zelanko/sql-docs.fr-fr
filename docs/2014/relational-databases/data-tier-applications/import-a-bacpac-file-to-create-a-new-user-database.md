...
-   **Importer à partir d’un disque local** : cliquez sur **Parcourir** pour naviguer sur l’ordinateur local ou spécifiez le chemin d’accès dans l’espace prévu à cet effet. Le chemin d'accès doit inclure un nom de fichier et l'extension .bacpac.  
...
-   **Chemin du fichier de données** : fournissez un répertoire local pour les fichiers de données. Cliquez sur **Parcourir...** pour explorer l’ordinateur local, ou spécifiez le chemin d’accès dans l’espace fourni.  
  
-   **Chemin d’accès du fichier journal** -fournissez un répertoire local pour les fichiers journaux. Cliquez sur **Parcourir...** pour explorer l’ordinateur local, ou spécifiez le chemin d’accès dans l’espace fourni.  
