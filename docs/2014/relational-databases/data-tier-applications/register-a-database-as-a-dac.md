 ...
 **Nom de l'application.** -Une chaîne qui spécifie le nom utilisé pour identifier la définition de la DAC, le champ est rempli avec le nom de la base de données.  
