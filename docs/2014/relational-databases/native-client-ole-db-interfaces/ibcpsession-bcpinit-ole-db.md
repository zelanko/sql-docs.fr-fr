...
> [!NOTE]  
>  Pour modifier les valeurs de format de données spécifiés pour un fichier de données, utilisez la [IBCPSession::BCPColumns](ibcpsession-bcpcolumns-ole-db.md) et [IBCPSession::BCPColFmt](ibcpsession-bcpcolfmt-ole-db.md) méthodes.  
