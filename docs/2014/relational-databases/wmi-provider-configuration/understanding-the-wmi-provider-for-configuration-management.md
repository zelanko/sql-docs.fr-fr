...
# <a name="understanding-the-wmi-provider-for-configuration-management"></a>Présentation du fournisseur WMI pour la gestion de la configuration
 ...
 Pour plus d’informations sur la programmation d’applications de gestion à l’aide du fournisseur WMI, [!INCLUDE[msCoName](../../includes/msconame-md.md)] consultez la documentation WMI dans le kit de développement logiciel (SDK) .NET Framework.  
