...
3.  Dans la fenêtre de requête, entrez les instructions suivantes qui utilisent la `sys.sql_modules` vue de catalogue. Modifiez le nom de la base de données et celui de la procédure stockée pour faire référence à la base de données et à la procédure stockée de votre choix.  
