...
-   Index ordonnés en clusters doivent être créés, reconstruits ou supprimés hors connexion lorsque la table sous-jacente contient les types de données LOB (large object) suivants : `image`, **ntext**, et `text`.  
