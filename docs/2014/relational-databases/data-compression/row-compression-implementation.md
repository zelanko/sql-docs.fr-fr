...
|`float`|Oui|Les octets les moins significatifs avec des zéros ne sont pas stockés. `float` la compression est principalement applicable aux valeurs non fractionnaires de la mantisse.|  
|`real`|Oui|Les octets les moins significatifs avec des zéros ne sont pas stockés. `real` la compression est principalement applicable aux valeurs non fractionnaires de la mantisse.|  
