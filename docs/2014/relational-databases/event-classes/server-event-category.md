...
|[Classe d'événements Server Memory Change](server-memory-change-event-class.md)|Indique que l’utilisation de la mémoire de [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] a changé.|  
