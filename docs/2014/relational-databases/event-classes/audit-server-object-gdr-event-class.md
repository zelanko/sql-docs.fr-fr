...
ms.locfileid: "63012529"
---
# <a name="audit-server-object-gdr-event-class"></a>Audit Server Object GDR (classe d'événements)
  La classe **d’événements Audit Server Object GDR** se produit chaque fois qu’une instruction Grant, Revoke ou Deny est émise pour une autorisation d’objet serveur par n’importe quel utilisateur dans Microsoft SQL Server.  
