...
ms.locfileid: "62932420"
---
# <a name="audit-change-database-owner-event-class"></a>Classe d'événements Audit Change Database Owner
  La classe **d’événements Audit change database owner** se produit lorsque vous utilisez l’instruction ALTER AUTHORIZATION pour changer le propriétaire d’une base de données, et que les autorisations requises pour cette opération sont activées.  
