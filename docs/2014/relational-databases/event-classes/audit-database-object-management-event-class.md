...
# <a name="audit-database-object-management-event-class"></a>Classe d'événements Audit Database Object Management
  La classe **d’événements Audit Database Object Management** se produit lorsqu’une instruction CREATE, ALTER ou Drop est exécutée sur des objets de base de données, tels que des schémas.  
