...
|TextData|`ntext`|*nom de l’unité physique* [(nom de l' *unité logique* )]. Le nom de l'unité logique ne s'affiche que s'il est défini dans l'affichage catalogue sys.backup_devices.|1|Oui|  
