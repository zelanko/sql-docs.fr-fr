...
|-----------|-----------------|  
|[Classe d'événements Audit Add DB User](audit-add-db-user-event-class.md)|Indique qu'une connexion en tant qu'utilisateur de la base de données a été ajoutée à la base de données ou supprimée de celle-ci.|  
...
|[Audit Backup/Restore, classe d’événements](audit-backup-and-restore-event-class.md)|Indique qu'une instruction de sauvegarde ou de restauration a été émise.|  
...
|[Classe d'événements Audit Statement Permission](audit-statement-permission-event-class.md)|Indique qu'une autorisation relative aux instructions a été utilisée.|  
