...
ms.locfileid: "62761990"
---
# <a name="audit-add-member-to-db-role-event-class"></a>Audit Add Member to DB Role (classe d'événements)
  La classe **d’événements audit Add Member to DB Role** se produit chaque fois qu’une connexion est ajoutée à un rôle de base de données ou en est supprimée. Cette classe d’événements est utilisée avec les procédures stockées **sp_addrolemember**, **sp_changegroup**et **sp_droprolemember** .  
