...
# <a name="audit-database-object-gdr-event-class"></a>Audit Database Object GDR (classe d'événements)
  La classe **d’événements Audit Database Object GDR** se produit lorsqu’une instruction Grant, Revoke ou Deny a été émise pour des objets de base de données, tels que des assemblys et des schémas.  
