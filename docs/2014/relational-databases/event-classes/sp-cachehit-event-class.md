...
|EventSubClass|`int`|Types de sous-classe d’événements.<br /><br /> 1 = accès au contexte d’exécution : un plan d’exécution libre a été trouvé dans le cache du plan.<br /><br /> 2 = accès au plan de calcul : un plan compilé a été trouvé dans le cache du plan.|21|Oui|  
