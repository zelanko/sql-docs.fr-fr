...
ms.locfileid: "85053310"
---
# <a name="audit-database-principal-impersonation-event-class"></a>Classe d'événements Audit Database Principal Impersonation
  La classe **d’événements Audit Database principal Impersonate** se produit lorsqu’un emprunt d’identité se produit dans l’étendue de la base de données, par exemple Execute As \<*user*> ou SETUSER.  
