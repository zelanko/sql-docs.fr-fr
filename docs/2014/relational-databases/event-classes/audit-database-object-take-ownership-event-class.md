...
# <a name="audit-database-object-take-ownership-event-class"></a>Classe d'événements Audit Database Object Take Ownership
  La classe **d’événements Audit Database Object Take Ownership** se produit lorsqu’une modification du propriétaire des objets dans l’étendue de la base de données se produit.  
