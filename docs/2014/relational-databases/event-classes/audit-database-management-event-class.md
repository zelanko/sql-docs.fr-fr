...
ms.locfileid: "62932440"
---
# <a name="audit-database-management-event-class"></a>Audit Database Management (classe d'événements)
  La classe **d’événements Audit Database Management** intervient lors de la création, de la modification ou de la suppression d’une base de données.  
