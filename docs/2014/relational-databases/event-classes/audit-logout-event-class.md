...
|**POURCENTAGE**|**int**|Temps processeur (en millisecondes) utilisé par l'utilisateur pendant sa connexion.|18|Oui|  
...
|**Lectures**|**bigint**|Quantité d’E/S de lecture logique de cet utilisateur au cours de la connexion.|16|Oui|  
...
|**Écritures**|**bigint**|Quantité d’E/S d'écriture logique de cet utilisateur au cours de la connexion.|17|Oui|  
