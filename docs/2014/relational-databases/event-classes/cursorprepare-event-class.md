...
|**Traitée**|**int**|Descripteur de la classe d'événements.|33|Oui|  
...
|**Identifi**|**int**|Identification de la demande qui a préparé le curseur.|49|Oui|  
