...
##  <a name="HowToDirectories"></a>Comment : utiliser des répertoires et des chemins d’accès dans FileTables  
...
##  <a name="fullpath"></a>Chemin d’accès complet à un élément stocké dans un filetable  
...
##  <a name="roots"></a>Sémantique des répertoires racines aux niveaux de l’instance, de la base de données et du filetable  
...
##  <a name="is_directory"></a>Colonne is_directory dans le schéma filetable  
...
##  <a name="alwayson"></a>Utilisation de noms de réseau virtuel (VNN) avec groupes de disponibilité AlwaysOn  
