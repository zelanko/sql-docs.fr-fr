---
title: Envoyer des données à une colonne FILESTREAM à l’aide d’interface ISequentialStream liée au paramètre ICommandText (OLE DB) | Documents Microsoft
ms.custom: ''
ms.date: 03/08/2017
...
## <a name="example"></a>Exemple  
 Avant de compiler et exécuter cet exemple, activer la prise en charge FILESTREAM ([activer et configurer FILESTREAM](../../blob/enable-and-configure-filestream.md)).  
