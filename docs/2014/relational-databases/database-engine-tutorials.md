...
# <a name="database-engine-tutorials"></a>Didacticiels sur le moteur de base de données
 ...
 [Tutoriel : Évaluation des meilleures pratiques à l’aide de la gestion basée sur des stratégies](../tutorials/tutorial-evaluating-best-practices-by-using-policy-based-management.md)  
 ...
 Ce didacticiel explique comment effectuer une sauvegarde et une restauration SQL Server vers le service de stockage d’objets BLOB Azure.  
 ...
 Ce didacticiel vous aide à comprendre comment stocker directement des fichiers de données SQL Server dans le service de stockage d’objets BLOB Azure.  
