...
# <a name="database-engine-tutorials"></a>Didacticiels sur le moteur de base de données
 ...
 [Tutoriel : Évaluation des meilleures pratiques à l’aide de gestion basée sur des stratégies](../tutorials/tutorial-evaluating-best-practices-by-using-policy-based-management.md)  
