...
|Texte du message|Erreur de table, Un répertoire Filestream que f_id d’ID existe pour une partition, mais la partition correspondante n’existe pas dans la base de données.|  
