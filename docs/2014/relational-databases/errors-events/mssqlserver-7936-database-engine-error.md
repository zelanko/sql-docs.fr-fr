...
|Texte du message|Erreur de table, Répertoire FileStream existe pour l’ID de colonne C_ID de l’ID d’objet O_ID, ID d’index I_ID, ID de partition PN_ID, mais cette colonne n’est pas une colonne Filestream.|  
