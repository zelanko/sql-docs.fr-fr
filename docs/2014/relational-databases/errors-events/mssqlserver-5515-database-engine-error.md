...
## <a name="user-action"></a>Action de l'utilisateur  
 Pour la cause de l'erreur, consultez le code d'état Windows spécifique. Pour plus d’informations, consultez le [Events and Errors Message Center de prise en charge](https://support.microsoft.com/search?query=events%20and%20errors).  
