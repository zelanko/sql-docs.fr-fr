...
## <a name="examples"></a>Exemples  
 L’exemple suivant crée un `TRY-CATCH` Entourage extrait de code et l’importe vers [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)].  
