...
1.  **Avant de commencer :**[couleurs](#StatusBarColors) de la barre d’État    
...
3.  **Pour utiliser une couleur d’État :**  [ouvrir l’éditeur de requête à l’aide d’une couleur de serveur](#OpenServerColor), [ouvrir un éditeur de requête en spécifiant une couleur d’État](#OpenSpecColor)  
...
##  <a name="SetOEServerColor"></a>Définir la couleur d’état d’un serveur dans l’Explorateur d’objets  
...
##  <a name="SetRegServerColor"></a>Définir la couleur d’état d’un serveur inscrit  
