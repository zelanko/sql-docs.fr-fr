...
|Authentification : qui êtes-vous ?|Autorisation : que pouvez-vous faire ?|Chiffrement : stockage de données secrètes|Sécurité de la connexion : restriction et sécurisation|Audit : enregistrement de l'accès|  
|----------------------------------|-------------------------------------|-------------------------------------|---------------------------------------------------|--------------------------------|  
