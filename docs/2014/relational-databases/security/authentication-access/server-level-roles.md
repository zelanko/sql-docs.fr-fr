...
## <a name="see-also"></a>Voir aussi  
 ...
 [REFUSER des autorisations de principal de serveur &#40;Transact-SQL&#41;](/sql/t-sql/statements/deny-server-principal-permissions-transact-sql)   
 [Créer un rôle de serveur](../authentication-access/create-a-server-role.md)  
