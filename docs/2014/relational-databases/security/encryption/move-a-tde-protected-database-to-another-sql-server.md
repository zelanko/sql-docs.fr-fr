...
1.  Créez une clé principale de base de données et un certificat dans le `master` base de données. Pour plus d’informations, consultez **Utilisation de Transact-SQL** ci-dessous.  
  
2.  Créer une sauvegarde du certificat du serveur dans le `master` base de données. Pour plus d’informations, consultez **Utilisation de Transact-SQL** ci-dessous.  
