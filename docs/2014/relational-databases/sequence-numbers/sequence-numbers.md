...
# <a name="sequence-numbers"></a>Numéros séquentiels
 ...
 Une séquence peut être définie comme n'importe quel type de données integer. Si le type de données n’est pas spécifié, une séquence de valeur par défaut est `bigint`.  
