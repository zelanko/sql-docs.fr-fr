...
|Décrit comment configurer des alertes afin d'informer les administrateurs de stratégie en cas d'échec de stratégie.|[Configurer des alertes pour informer les administrateurs de stratégie en cas d’échec de stratégie](configure-alerts-to-notify-policy-administrators-of-policy-failures.md)|  
