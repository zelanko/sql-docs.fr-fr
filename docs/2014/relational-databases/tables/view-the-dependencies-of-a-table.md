...
3.  Dans la boîte de dialogue **Dépendances d’objets**_\<nom_objet>_, sélectionnez soit **Objets dépendants de** *\<nom_objet>*, soit **Objets dont**_\<nom_objet>_**dépend**.  
