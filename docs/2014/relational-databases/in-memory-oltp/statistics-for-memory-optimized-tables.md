...
5.  Exécuter la charge de travail, qui peut contenir une combinaison d’en mode natif compilées et interprétées [!INCLUDE[tsql](../../../includes/tsql-md.md)] stockées procédures, ainsi que les lots ad hoc.  
