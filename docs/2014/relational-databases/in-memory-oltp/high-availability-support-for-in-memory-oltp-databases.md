...
-   **Une expérience entièrement intégrée**   
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Abonnés de réplication sur des tables optimisées en mémoire](../replication/replication-to-memory-optimized-table-subscribers.md)  
