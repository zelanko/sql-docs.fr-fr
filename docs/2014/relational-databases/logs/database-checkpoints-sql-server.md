...
###  <a name="InteractionBwnSettings"></a>Interaction des options de TARGET_RECOVERY_TIME et de l’intervalle de récupération  
...
-   [Modifier le temps de récupération cible d’une base de données &#40;SQL Server&#41;](change-the-target-recovery-time-of-a-database-sql-server.md)  
