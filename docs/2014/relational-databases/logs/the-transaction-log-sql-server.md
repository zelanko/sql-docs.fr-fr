...
-   [Opérations qui peuvent être consignées](#MinimallyLogged)  
...
-  [Restaurer une sauvegarde de journal des transactions](../backup-restore/restore-a-transaction-log-backup-sql-server.md)   
