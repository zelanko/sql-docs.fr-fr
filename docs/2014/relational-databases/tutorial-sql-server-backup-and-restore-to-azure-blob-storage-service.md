---
title: 'Didacticiel : SQL Server sauvegarde et restauration de Windows Azure Blob Storage Service | Documents Microsoft'
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="what-you-will-learn"></a>Contenu du didacticiel  
 ...
 [Leçon 1 : Créer des objets de stockage Azure de Windows](../tutorials/lesson-1-create-windows-azure-storage-objects.md)  
 ...
 [Leçon 3 : Écrire une sauvegarde complète de la base de données dans le Service de stockage Windows Azure Blob](../tutorials/lesson-3-write-a-full-database-backup-to-the-windows-azure-blob-storage-service.md)  
