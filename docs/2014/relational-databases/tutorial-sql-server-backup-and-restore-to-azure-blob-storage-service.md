---
title: 'Didacticiel : Service de stockage d’objets Blob SQL Server Backup and Restore sur Windows Azure | Microsoft Docs'
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "52811241"
---
# <a name="tutorial-sql-server-backup-and-restore-to-windows-azure-blob-storage-service"></a>Didacticiel : SQL Server Backup and Restore au Service de stockage Windows Azure Blob
...
## <a name="what-you-will-learn"></a>Contenu du didacticiel  
 ...
 [Leçon 4 : Effectuer une restauration à partir d’une sauvegarde de base de données complète](../tutorials/lesson-4-perform-a-restore-from-a-full-database-backup.md)  
