...
# <a name="finding-more-sql-server-native-client-information"></a>Recherche d'informations supplémentaires concernant SQL Server Native Client
 ...
 Des informations supplémentaires sur [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client peut être trouvé en recherchant le [Base de connaissances Microsoft](http://go.microsoft.com/fwlink?linkid=5757).  
