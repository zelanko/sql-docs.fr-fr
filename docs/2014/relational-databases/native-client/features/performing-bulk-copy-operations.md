...
# <a name="performing-bulk-copy-operations"></a>Exécution d'opérations de copie en bloc
 ...
 Pour obtenir un exemple d’application qui illustre cette fonctionnalité, consultez [copier des données en bloc à l’aide de IRowsetFastLoad &#40;OLE DB&#41;](../../native-client-ole-db-interfaces/irowsetfastload-ole-db.md).  
