...
|*MachineName*$@*Domain*|Spécification directe d'un compte d'ordinateur.<br /><br /> (Si le serveur que vous êtes connecté s’exécute sous système LOCAL ou compte de SERVICE réseau, pour obtenir l’authentification Kerberos, `ServerSPN` peut se trouver dans le *MachineName*$@*domaine* format.)|  
