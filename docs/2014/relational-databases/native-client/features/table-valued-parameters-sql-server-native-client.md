...
# <a name="table-valued-parameters-sql-server-native-client"></a>Paramètres table (SQL Server Native Client)
 ...
 Pour plus d’informations sur les paramètres table et les OLE DB, consultez [paramètres table &#40;OLE DB&#41;](../../native-client-ole-db-table-valued-parameters/table-valued-parameters-ole-db.md).  
