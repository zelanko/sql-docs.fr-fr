...
-   **Pour modifier les paramètres pour un pool de ressources, à l’aide de :**  [SQL Server Management Studio](#ChgRPProp), [Transact-SQL](#ChgRPTSQL)  
