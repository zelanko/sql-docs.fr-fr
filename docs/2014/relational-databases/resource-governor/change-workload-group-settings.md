...
-   **Pour modifier les paramètres pour une charge de travail de groupe, à l’aide de :**  [SQL Server Management Studio](#ChgWGProp), [Transact-SQL](#ChgWGTSQL)  
