---
title: Informations sur l’éditeur, abonnement regarder liste (Publication d’instantané, SQL Server 2005 et versions ultérieur) | Documents Microsoft
ms.custom: ''
ms.date: 03/06/2017
