...
-   [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]: [Spécifier l’emplacement d’instantanés par défaut](snapshot-options.md#snapshot-folder-locations)
