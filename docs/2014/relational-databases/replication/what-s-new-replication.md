...
ms.locfileid: "36040381"
---
# <a name="what39s-new-replication"></a>Nouveautés (Réplication)
  [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] ne propose pas de nouvelles fonctionnalités importantes pour la réplication [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .  
