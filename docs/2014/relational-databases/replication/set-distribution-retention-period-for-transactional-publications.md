---
title: Définir la période de rétention de Distribution pour les Publications transactionnelles (SQL Server Management Studio) | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
