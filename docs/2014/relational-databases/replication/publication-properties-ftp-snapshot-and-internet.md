...
ms.locfileid: "36142462"
---
# <a name="publication-properties-ftp-snapshot-and-internet"></a>Propriétés de la publication, Instantané FTP et Internet
  Cette page vous permet de :  
  
-   définir les propriétés d'envoi de l'instantané via FTP (File Transfer Protocol). Pour plus d’informations, consultez [instantanés via FTP Transfer](transfer-snapshots-through-ftp.md) votre documentation Windows pour plus d’informations.  
