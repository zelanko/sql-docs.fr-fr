...
4.  Entrez `repl_snapshot` dans les **nom d’utilisateur** zone, fournissez le mot de passe et d’autres informations pertinentes, puis cliquez sur **créer** pour créer le compte repl_snapshot.  
...
4.  Entrez `repl_distribution` dans les **nom d’utilisateur** zone, fournissez le mot de passe et d’autres informations pertinentes, puis cliquez sur **créer** pour créer le compte repl_distribution.  
