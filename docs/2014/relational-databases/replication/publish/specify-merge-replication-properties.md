...
3.  Dans la page **Propriétés de \<Article> l’article-** ou **Propriétés de l’article \<ArticleType> -** , cliquez sur l’onglet **résolveur** .    
...
2.  Cliquez sur **Propriétés de l'article**, puis cliquez sur **Définir les propriétés de l'article de Table en surbrillance** ou sur **Définir les propriétés de tous les articles de table**.   
3.  Sous l’onglet **Propriétés** de la boîte de dialogue **propriétés \<Article> de l’article** , sélectionnez l’une des valeurs suivantes pour la propriété **niveau de suivi** : **suivi au niveau des lignes** ou **suivi au niveau des colonnes**.    
4.  Si vous êtes dans la boîte de dialogue Propriétés de la **publication- \<Publication> ** , cliquez sur **OK** pour enregistrer et fermer la boîte de dialogue.  
