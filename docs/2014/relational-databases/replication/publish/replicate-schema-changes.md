...
1.  Dans la **page Options d’abonnement** de la boîte de dialogue Propriétés de la **publication- \<Publication> ** , affectez la valeur **false**à la propriété **répliquer les modifications de schéma** .  
