...
## <a name="see-also"></a>Voir aussi  
 [Publication de l’exécution des procédures stockées dans la réplication transactionnelle](../transactional/publishing-stored-procedure-execution-in-transactional-replication.md)  
