...
## <a name="see-also"></a>Voir aussi  
 [Spécifier la façon dont les modifications sont propagées pour les articles transactionnels](../transactional/transactional-articles-specify-how-changes-are-propagated.md)   
