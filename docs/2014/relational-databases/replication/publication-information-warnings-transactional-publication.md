---
title: Informations de publication, avertissements (Publication transactionnelle, SQL Server 2005 et versions ultérieur) | Documents Microsoft
ms.custom: ''
ms.date: 03/06/2017
