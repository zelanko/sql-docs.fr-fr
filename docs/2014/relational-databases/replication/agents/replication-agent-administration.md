...
|Exécutable de l'agent|Nom du fichier|  
|----------------------|---------------|  
|[Agent d’instantané de réplication](replication-snapshot-agent.md)|snapshot.exe|  
...
-   Programmation de réplication : [Concepts des exécutables de l'agent de réplication](../concepts/replication-agent-executables-concepts.md)  
...
|------------------|-----------------|----------------------|  
|Historique de l’agent de nettoyage : Distribution|Supprime les enregistrements historiques des agents de réplication dans la base de données de distribution.|S'exécute toutes les dix minutes|  
|Distribution de nettoyage : Distribution|Suppression des transactions répliquées de la base de données de distribution. Désactive les abonnements qui n’ont été pas été synchronisés au cours de la période maximale de rétention de distribution.|S'exécute toutes les dix minutes|  
