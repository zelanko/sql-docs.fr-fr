 ...
 **-ExchangeType** [ **1**| **2**| **3**]  
 > [!WARNING]  
>  [!INCLUDE[ssNoteDepFutureDontUse](../../../includes/ssnotedepfuturedontuse-md.md)] Pour limiter le téléchargement, utilisez la `@subscriber_upload_options` de `sp_addmergearticle` à la place.  
