...
ms.locfileid: "63191662"
---
# <a name="replication-queue-reader-agent"></a>Agent de lecture de la file d'attente de réplication
  Le agent de lecture de la file d’attente de réplication est un fichier exécutable qui lit les messages [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] stockés dans une [!INCLUDE[msCoName](../../../includes/msconame-md.md)] file d’attente ou une file d’attente de messages, puis applique ces messages au serveur de publication. L'Agent de lecture de la file d'attente est utilisé avec les publications transactionnelles et les publications d'instantané qui autorisent la mise à jour en attente.  
...
|**1,3**|Insère de nouveaux enregistrements d'historique incluant des détails supplémentaires qui peuvent s'avérer utiles pour le dépannage.|  
