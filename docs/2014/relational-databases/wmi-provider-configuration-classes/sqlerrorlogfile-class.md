...
|Créer une vue d’abonnement|Type de données : `string`<br /><br /> Type d'accès : Lecture seule<br /><br /> Qualificateurs : Touche<br /><br /> <br /><br /> Nom du fichier journal.|  
