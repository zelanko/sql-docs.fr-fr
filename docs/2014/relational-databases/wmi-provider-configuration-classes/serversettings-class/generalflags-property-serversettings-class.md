---
title: Generalflags, propriété (classe ServerSettings) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="property-valuereturn-value"></a>Valeur de propriété/valeur de retour  
 Tableau d'objets de [classe ServerSettingsGeneralFlag](../serversettingsgeneralflag-class/serversettingsgeneralflag-class.md) qui spécifie les indicateurs généraux associés à l'instance de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)].  
