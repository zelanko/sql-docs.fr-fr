 ...
 *object*  
 A [ProtocolName, propriété (classe ServerNetworkProtocol)](servernetworkprotocol-class.md) objet qui représente le protocole réseau utilisé par l’instance de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)].  
