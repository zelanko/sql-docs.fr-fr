...
ms.locfileid: "36042188"
---
# <a name="setflag-method-clientnetworkprotocolproperty-class"></a>Méthode SetFlag (classe ClientNetworkProtocolProperty)
  Définit l’indicateur de la propriété actuelle référencée par la [propertyidx, propriété (classe ClientNetworkProtocolProperty)](clientnetworkprotocolproperty-class.md) valeur.  
