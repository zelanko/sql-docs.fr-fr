...
-   Les valeurs spécifiées pour la bibliothèque DB-Library [bcp_bind](../native-client-odbc-extensions-bulk-copy-functions/bcp-bind.md)*varlen* paramètre sont interprétées différemment ODBC **bcp_bind *** cbData* paramètre.  
