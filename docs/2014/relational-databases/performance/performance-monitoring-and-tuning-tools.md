...
# <a name="performance-monitoring-and-tuning-tools"></a>Outils d'analyse et de paramétrage des performances
  [!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] fournit un ensemble complet d’outils permettant de surveiller les [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] événements dans et de paramétrer la conception physique de la base de données. Le choix de l'outil dépend du type de surveillance ou de paramétrage à effectuer et des événements spécifiques à contrôler.  
