...
|Utilisation dans une application personnalisée|Oui <sup>1</sup>||||Oui||  
 ...
 <sup>1</sup> Using [!INCLUDE[ssSqlProfiler](../../../includes/sssqlprofiler-md.md)] procédures stockées système.  
