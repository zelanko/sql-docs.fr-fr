...
-   **Expression** Définit ce que vous filtrez. En général, il s'agit d'un champ de dataset.  
...
|**Type de données de schéma de définition de rapport**|**Type (s) CLR**|  
|--------------------------------------------|-----------------------|  
|`Boolean`|`Boolean`|  
...
|**TopN, Basn**|Compare l'expression à une valeur `Integer`.|  
|**Pourcentage, BottomPercent**|Compare l'expression à une valeur `Integer` ou `Float`.|  
|**Différents**|Teste si l'expression est comprise entre deux valeurs (y compris ces valeurs).|  
