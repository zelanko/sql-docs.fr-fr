...
-   Histogrammes [&#40;générateur de rapports et SSRS&#41;](charts-report-builder-and-ssrs.md): les histogrammes de base, empilées et les histogrammes empilés 100%.  
  
-   [Graphiques en courbes &#40;générateur de rapports et les&#41;SSRS ](line-charts-report-builder-and-ssrs.md): tous à l’exception du graphique en courbes 3D.  
  
-   [Graphiques en aires &#40;générateur de rapports et les&#41;SSRS ](area-charts-report-builder-and-ssrs.md): tous sauf les graphiques en aires 3D  
  
-   Les [graphiques en secteurs &#40;générateur de rapports et SSRS&#41;](pie-charts-report-builder-and-ssrs.md): et les graphiques en anneau, à la fois en 2D et en 3D, mais pas les autres formes, telles que les graphiques en entonnoir et en pyramide.  
  
-   [Graphiques d’étendue &#40;générateur de rapports et SSRS&#41;](range-charts-report-builder-and-ssrs.md): les graphiques boursiers, en bougies, à barres d’erreur et à surfaces.  
...
-   [Graphiques à barres &#40;générateur de rapports et SSRS&#41;](bar-charts-report-builder-and-ssrs.md): graphiques à barres empilées de base, empilées et 100%.  
  
-   Histogrammes [&#40;générateur de rapports et SSRS&#41;](charts-report-builder-and-ssrs.md): les histogrammes de base, empilées et les histogrammes empilés 100%. Les histogrammes peuvent être des graphiques sparkline ou des barres de données.  

##  <a name="AlignDatainTableMatrix"></a>Alignement des données du graphique sparkline dans une table ou une matrice  
...
##  <a name="UnderstandScope"></a>Comprendre les données fournies à un graphique sparkline ou une barre de données  
...
##  <a name="ConvertSparklinetoChart"></a>Conversion d’un graphique sparkline ou d’une barre de données en un graphique complet  
