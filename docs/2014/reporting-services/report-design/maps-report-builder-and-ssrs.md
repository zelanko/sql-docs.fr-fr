...
-   **Rapports de la bibliothèque de cartes.** Les données spatiales sont incorporées dans les rapports situés dans la bibliothèque de cartes. Par défaut, la bibliothèque de cartes est installée dans * \<le lecteur>*: \Program Files\Microsoft SQL Server\Report Builder builder\mapgallery.  
...
-   De la source de données spatiales :  
    ...
    -   **Nomme.** Champ spécifiant le nom de la ville.  
