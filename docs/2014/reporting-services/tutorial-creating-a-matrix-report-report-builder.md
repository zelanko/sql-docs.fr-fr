...
1.  [Créer un rapport de matrice et un Dataset à partir de l’Assistant nouveau tableau ou matrice](#CreateMatrix)  
...
7.  [Ajouter un en-tête de rapport et le titre de rapport](#HeaderTitle)  
...
7.  Cliquez sur le (***fx***) bouton **couleur de remplissage**.  
...
3.  Sur le **insérer** onglet du ruban, cliquez sur **en-tête** puis cliquez sur **ajouter un en-tête**.  
...
6.  Sélectionnez le texte que vous avez tapé, avec le bouton droit, puis cliquez sur **propriétés de texte**.  
...
4.  Vérifiez que la propriété CanGrow est définie sur `True`.  
