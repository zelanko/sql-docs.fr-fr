...
-   [!INCLUDE[msCoName](../../includes/msconame-md.md)]pour les modèles MDX, [!INCLUDE[msCoName](../../includes/msconame-md.md)] DMX, PowerPivot et tabulaires [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]  
...
-   Source des données de rapport: Le type de données qui fait l’objet d’un accès; par exemple, base de données relationnelle, base de données multidimensionnelle, fichier plat ou XML. Cette colonne répond à la question suivante: «Quels types de données peuvent [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] être utilisés pour un rapport?»  
  
-   [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]Type de source de données: L’un des types de sources de données que vous voyez dans la liste déroulante lorsque vous définissez une [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]source de données dans. Cette liste est renseignée à partir des fournisseurs de données et extensions installés et inscrits. Cette colonne répond à la question suivante: «Quel type de source de données dois-je sélectionner dans la liste déroulante lors de la création d’une source de données de rapport?»  
  
-   Nom de l’extension pour le traitement des données/Fournisseur de données: Extension pour le traitement des [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] donnéesouautrefournisseurdedonnéesquicorrespondautypedesourcededonnéessélectionné.[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] Cette colonne répond à la question suivante: «Quand je sélectionne un type de source de données, qui correspond à l’extension pour le traitement des données ou au fournisseur de données?»  
  
-   Version du Fournisseur de données sous-jacent (facultatif): Certains types de sources de données prennent en charge plusieurs fournisseurs de données. Il peut s'agir de versions différentes du même fournisseur ou de différentes implémentations tierces pour un type de fournisseur de données. Le nom du fournisseur apparaît souvent dans la chaîne de connexion une fois que vous avez configuré une source de données. Cette colonne répond à la question suivante: « Après avoir sélectionné le type de source de données, quel fournisseur de données faut-il sélectionner dans la boîte de dialogue **Propriétés de connexion** ? »  
  
-   *\<plateforme>* de la source de données : Plateforme de source de données prise en charge par l’extension pour le traitement des données ou le fournisseur de données pour la source de données cible. Cette colonne répond à la question suivante: «Cette extension pour le traitement des données ou ce fournisseur de données peut-il récupérer des données d’une source de données sur ce type de plateforme?»  
  
-   Version de la source de données: Version de la source de données cible prise en charge par le DPE ou le fournisseur de données. Cette colonne répond à la question suivante: «Cette extension pour le traitement des données ou ce fournisseur de données peut-il récupérer des données à partir de cette version de la source de données?»  
  
-   *\<plateforme>* du serveur de rapports : Les plateformes pour le serveur de rapports et le client de création de rapports où vous pouvez installer un DPE ou un fournisseur de données personnalisé. Les extensions pour le traitement des données [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] intégrées sont fournies avec toutes les installations de [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]. Une extension pour le traitement des données personnalisée ou un fournisseur de données [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] doit être compilé en mode natif pour une plateforme spécifique. Cette colonne répond à la question suivante: «Cette extension pour le traitement des données ou ce fournisseur de données peut-il être installé sur ce type de plateforme?»  
...
|-------------------------------|-----------------------------------------|------------------------------------------------------|-------------------------------------------------------|--------------------------------------|--------------------------------------|----------------------------|-------------------------|-------------------------|  
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] base de données relationnelle|[Microsoft SQL Server](#MicrosoftSQLServer)|Extension pour le traitement des données [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] intégrée|Étend System.Data.SqlClient|Y|Y|[!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] et versions ultérieures.|Y|Y|  
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] base de données relationnelle|[OLEDB](#OLEDBSQL)|Extension pour le traitement des données [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] intégrée|Étend System.Data.OledbClient|Y|Y|[!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] et versions ultérieures.|Y|Y|  
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] base de données relationnelle|[ODBC](#ODBC)|Extension pour le traitement des données [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] intégrée|Étend System.Data.OdbcClient|Y|Y|[!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] et versions ultérieures.|Y|Y|  
|[!INCLUDE[ssSDS](../../includes/sssds-md.md)]|[Base de données SQL Azure](#Azure)|Extension pour le traitement des données [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] intégrée|Étend System.Data.SqlClient|N/A|N/A|[!INCLUDE[ssSDS](../../includes/sssds-md.md)]|Y|Y|  
|[!INCLUDE[ssDW](../../includes/ssdw-md.md)] Appliance|[Microsoft Parallel Data Warehouse](#PWD)|Extension pour le traitement des données [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] intégrée|N/A|N/A|N/A|[!INCLUDE[ssDWfull](../../includes/ssdwfull-md.md)]|Y|Y|  
|[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] Base de données multidimensionnelle|[Microsoft SQL Server Analysis Services](#AnalysisServices)|Extension pour le traitement des données [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] intégrée|Utilise ADOMD.NET|Y|Y|[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]et versions ultérieures<br /><br /> [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)]et versions ultérieures|Y|Y|  
|[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] Base de données multidimensionnelle|[OLEDB](#OLEDBAS9)|Extension pour le traitement des données [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] intégrée|Étend System.Data.OledbClient<br /><br /> Version 10.0|Y|Y|[!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]|Y|Y|  
|[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] Base de données multidimensionnelle|[OLEDB](#OLEDBAS9)|Extension pour le traitement des données [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] intégrée|Étend System.Data.OledbClient<br /><br /> Version 9.0|Y|Y|[!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]|Y|Y|  
|[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] Base de données multidimensionnelle|OLEDB|Extension pour le traitement des données [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] intégrée|Étend System.Data.OledbClient<br /><br /> Version 8.0|Y|N|N/A|Y|N|  
|Listes SharePoint|[Liste Microsoft SharePoint](#SharePointList)|Extension pour le traitement des données [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] intégrée|Obtient des données de Lists.asmx ou des interfaces API du modèle d'objet SharePoint.<br /><br /> Consultez [Remarque](#SharePointList).|N|Y|Produits SharePoint 2013<br /><br /> Produits SharePoint 2010|Y|Y|  
|Listes SharePoint|[Liste Microsoft SharePoint](#SharePointList)|Extension pour le traitement des données [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] intégrée|Obtient des données de Lists.asmx ou des interfaces API du modèle d'objet SharePoint.<br /><br /> Consultez [Remarque](#SharePointList).|Y|Y|[!INCLUDE[winSPServ](../../includes/winspserv-md.md)]3,0 et [!INCLUDE[offSPServ](../../includes/offspserv-md.md)] 2007|Y|Y|  
|XML|[XML](#XML)|Extension pour le traitement des données [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] intégrée|Les sources de données XML n'ont pas de dépendance de plateforme.|N/A|N/A|[!INCLUDE[vstecwebservices](../../includes/vstecwebservices-md.md)] ou documents|Y|Y|  
|Modèle Report Server|Modèle de rapport|Extension pour le traitement des données [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] intégrée pour un fichier SMDL publié|Les sources de données pour un modèle font appel aux extensions pour le traitement des données intégrées.<br /><br /> Les modèles basés sur Oracle requièrent les composants du client Oracle.<br /><br /> Les modèles basés sur Teradata requièrent le fournisseur de données .NET pour Teradata de Teradata.<br /><br /> Consultez la documentation Teradata pour la prise en charge de plateforme.|N/A|N/A|Les modèles peuvent être créés à partir de[!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] et versions ultérieures.<br /><br /> [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]<br /><br /> Oracle 9.2.0.3 ou version ultérieure<br /><br /> Teradata V14, v13, v12 et v6.2|Y|Y|  
|Base de données multidimensionnelle SAP|[SAP BI NetWeaver](#SapBINetWeaver)|Extension pour le traitement des données [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] intégrée|Consultez la documentation SAP pour la prise en charge de plateforme.|N/A|N/A|SAP BI NetWeaver 3.5|Y|N/A|  
...
###  <a name="Azure"></a>Extension pour le traitement des Azure SQL Database  
 ...
 [!INCLUDE[ss_dtbi](../../includes/ss-dtbi-md.md)]différencie **[!INCLUDE[ssSDS](../../includes/sssds-md.md)]** automatiquement les types de sources de données et **Microsoft SQL Server** et ouvre le concepteur de requêtes graphique associé au type de source de données.  
