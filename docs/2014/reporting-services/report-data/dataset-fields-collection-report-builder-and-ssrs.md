...
##  <a name="Defaults"></a>Compréhension des expressions par défaut pour les champs  
...
-   **Processeur de rapports** Les types de données sont basés sur la version du CLR installée lorsque vous avez [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]installé.  
...
##  <a name="MissingFields"></a>Détection des champs manquants au moment de l’exécution  
