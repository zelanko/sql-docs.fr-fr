---
title: Utiliser une connexion de données Office (.odc) avec des rapports (Reporting Services en Mode intégré SharePoint) | Documents Microsoft
ms.custom: ''
ms.date: 03/06/2017
