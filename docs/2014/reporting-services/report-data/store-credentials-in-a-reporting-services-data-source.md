...
7.  Tapez un nom d'utilisateur et un mot de passe.
    ...
    -   Si le compte est un compte d’utilisateur de domaine Windows, spécifiez-le \<au format \\ suivant :\>domaine><compte, puis sélectionnez **utiliser comme informations d’identification Windows lors de la connexion à la source de données.**
