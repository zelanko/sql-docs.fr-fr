...
-   Expérience de développement dans [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)]un langage compatible, tel [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[csprcs](../../includes/csprcs-md.md)] que [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)]ou, si vous envisagez [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] d’utiliser en tant que plateforme de développement.  
