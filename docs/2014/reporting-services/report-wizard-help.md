---
title: Aide de l’Assistant de rapport | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
# <a name="report-wizard-help"></a>Aide de l'Assistant Rapport
 ...
 Pour ouvrir l’Assistant rapport, sur le **projet** menu, cliquez sur **ajouter un nouvel élément**.  
  
## <a name="in-this-section"></a>Dans cette section  
  
-   [Bienvenue dans l’Assistant Rapport](../../2014/reporting-services/welcome-to-the-report-wizard.md)  
...
-   [Choisir la disposition du tableau](../../2014/reporting-services/choose-the-table-layout.md)  
