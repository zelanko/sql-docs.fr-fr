...
-   Le Conseiller de mise à niveau [!INCLUDE[ssCurrent](../../../includes/sscurrent-md.md)] ne vérifie pas que la protection étendue est activée sur le système d'exploitation ou l'installation actuelle de [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)].  
