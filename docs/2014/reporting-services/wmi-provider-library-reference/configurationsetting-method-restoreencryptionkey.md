...
## <a name="remarks"></a>Notes  
 ...
 Cette méthode est plus efficace lorsqu’elle est appelée après la [DeleteEncryptionKey](configurationsetting-method-deleteencryptionkey.md) (méthode), ce qui efface la liste des clés de chiffrement.  
