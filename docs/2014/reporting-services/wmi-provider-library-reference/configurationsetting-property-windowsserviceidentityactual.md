---
title: Propriété de WindowsServiceIdentityActual (WMI MSReportServer_ConfigurationSetting) | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="property-values"></a>Valeurs de la propriété  
 A `String` objet contenant l’identité du service Windows Report Server est en cours d’exécution sous.  
