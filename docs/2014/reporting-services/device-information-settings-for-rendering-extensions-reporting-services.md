...
|-----------|-----------------|  
|[Paramètres d'informations de périphérique ATOM](../../2014/reporting-services/atom-device-information-settings.md)|Décrit les paramètres d'informations de périphérique associés au format de rendu conforme à Atom.|  
|[Paramètres d'informations de périphérique CSV](csv-device-information-settings.md)|Décrit les paramètres d'informations de périphérique associés au format de rendu CSV.|  
|[Paramètres d'informations de périphérique Excel](excel-device-information-settings.md)|Décrit les paramètres d'informations de périphérique associés au format de rendu Excel.|  
|[Paramètres d'informations de périphérique Word](word-device-information-settings.md)|Décrit les paramètres d'informations de périphérique associés au format de rendu Word.|  
...
|[Paramètres d'informations de périphérique PDF](pdf-device-information-settings.md)|Décrit les paramètres d'informations de périphérique associés au format de rendu PDF.|  
|[Paramètres d'informations de périphérique XML](xml-device-information-settings.md)|Décrit les paramètres d'informations de périphérique associés au format de rendu XML.|  
|[Paramètres d'informations de périphérique RGDI](rgdi-device-information-settings.md)|Décrit les paramètres d'informations de périphérique associés au format de rendu RGDI.|  
