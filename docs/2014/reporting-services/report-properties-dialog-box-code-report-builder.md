---
title: Code (Générateur de rapports), boîte de dialogue Propriétés de rapport | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
 ...
 **Code personnalisé**  
 Tapez les méthodes à utiliser dans le rapport. Le code doit être écrit en [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[vbprvb](../includes/vbprvb-md.md)].  
