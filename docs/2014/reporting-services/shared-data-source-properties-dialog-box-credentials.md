---
title: Boîte de dialogue de propriétés de Source des données partagées, les informations d’identification | Documents Microsoft
ms.custom: ''
ms.date: 06/14/2017
 ...
 **Utiliser ce nom d’utilisateur et un mot de passe**  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Boîte de dialogue Propriétés des données partagées Source, général](../../2014/reporting-services/shared-data-source-properties-dialog-box-general.md)  
