...
|Instance nommée|service Web Report Server|http://\<ServerName>/reportserver_\<nom_instance>|http://\<ServerName>:80/reportserver_\<nom_instance>|  
|Instance nommée|Gestionnaire de rapports|http://\<ServerName>/reports_\<nom_instance>|http://\<ServerName>:80/reports_\<nom_instance>|  
...
##  <a name="URLPermissionsAccounts"></a>Authentification et identité de service pour les URL de Reporting Services  
