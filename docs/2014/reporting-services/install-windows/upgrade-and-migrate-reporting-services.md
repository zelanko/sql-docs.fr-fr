...
-   [Mettre à niveau un déploiement avec montée en puissance parallèle de Reporting Services en Mode natif](#bkmk_native_scaleout)  
  
-   [Mise à niveau en Mode SharePoint et les scénarios de Migration](#bkmk_sharePoint_scenarios)  
...
> -   Utilisez [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Conseiller de mise à niveau. Pour plus d’informations, consultez [problèmes de mise à niveau des Services Reporting &#40;Upgrade Advisor&#41; ](../../../2014/sql-server/install/reporting-services-upgrade-issues-upgrade-advisor.md) et [Comment : installer le Conseiller de mise à niveau](../../../2014/sql-server/install/how-to-install-upgrade-advisor.md).  
 ...
 ![Icône de flèche utilisée avec différée lien en haut](../../2014-toc/media/uparrow16x16.gif "icône de flèche utilisée avec différée lien en haut") [dans cette rubrique :](#bkmk_top)  
...
-   Exécutez [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Conseiller de mise à niveau sur le serveur de rapports pour déterminer les problèmes susceptibles d’empêcher la mise à niveau avec succès. Pour plus d'informations, consultez [Use Upgrade Advisor to Prepare for Upgrades](../../../2014/sql-server/install/use-upgrade-advisor-to-prepare-for-upgrades.md).  
...
8.  L'installation met à niveau les bases de données du serveur de rapports vers le nouveau schéma et modifie le `RSExecRole` en ajoutant les autorisations du propriétaire de la base de données au rôle. Cette étape se produit uniquement lorsque vous mettez à niveau à partir de [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] avant le SP1.  
...
-   **SharePoint 2010 :** In situ mise à niveau de [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] est pris en charge, mais le scénario de mise à niveau nécessite l’arrêt de l’environnement SharePoint.  
...
-   Exécutez [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] installation pour mettre à niveau le mode SharePoint pour chaque serveur de rapports. L’Assistant installation de SQL Server installera le [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] Service et créez une nouvelle application de Service.  
