...
-   À une invite de commandes, utilisez l'option **RS_SHPWFE** pour installer le complément. Pour plus d’informations sur [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] installations de l’invite de commandes, voir [invite de commandes de Reporting Services SharePoint Mode d’Installation et en Mode natif](install-reporting-services-at-the-command-prompt.md).  
...
##  <a name="bkmk_sql2008r2"></a> Complément SQL Server 2008 R2 Reporting Services pour les produits SharePoint 2010  
 Le complément SQL Server 2008 R2 Reporting Services pour les produits SharePoint 2010 est installé par l'Outil de préparation des produits SharePoint 2010 (**PreRequisiteInstaller.exe**). Si vous souhaitez télécharger et installer le complément séparément, la version la plus récente de ce fichier est disponible en ligne à la [!INCLUDE[msCoName](../../includes/msconame-md.md)] centre de téléchargement, [SQL Server 2008 R2 Reporting Services Add-in pour Microsoft SharePoint Technologies 2010 ](http://go.microsoft.com/fwlink/?LinkID=164654).  
  
> [!TIP]  
>  Lors de l'utilisation de ce complément avec SQL Server 2008, Service Pack 1 (SP1) avec la mise à jour cumulative n° 8 ou supérieure, consultez les problèmes connus dans la section Intégration SharePoint 2010 de la rubrique [Intégration de serveurs de rapports SQL Server 2008 SP2 avec SharePoint 2010](http://technet.microsoft.com/library/ff946055%28SQL.100%29.aspx)  
...
##  <a name="bkmk_sql2008sp2"></a> SQL Server 2008 SP2 Reporting Services Add-in pour 2007 produits et Technologies SharePoint  
 ...
 La version la plus récente de ce fichier est disponible en ligne à la [!INCLUDE[msCoName](../../includes/msconame-md.md)] centre de téléchargement, [Microsoft SQL Server 2008 SP2 Reporting Services Add-in pour Microsoft SharePoint Technologies](http://go.microsoft.com/fwlink/?LinkID=204594).  
...
##  <a name="bkmk_sql2008"></a> SQL Server 2008 Reporting Services Add-in pour 2007 produits et Technologies SharePoint  
 ...
 La version la plus récente de ce fichier est disponible en ligne à la [!INCLUDE[msCoName](../../includes/msconame-md.md)] centre de téléchargement, [Microsoft SQL Server 2008 Reporting Services Add-in pour Microsoft SharePoint Technologies](http://go.microsoft.com/fwlink/?LinkID=204813).  
