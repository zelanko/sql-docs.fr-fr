...
##  <a name="bkmk_native_to_sharepoint"></a>Outil de migration Reporting Services  
 ...
 Pour plus d’informations, consultez [Reporting Services outil](https://www.microsoft.com/download/details.aspx?id=29560) dehttps://www.microsoft.com/download/details.aspx?id=29560)migration (.  
...
2.  ** [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] Scripts RSS :** Écrire un script Visual Basic qui appelle des méthodes SOAP du service Web Report Server pour copier des données entre des bases de données. Utilisez l'utilitaire **RS.exe** pour exécuter le script. Rs.exe est installé avec [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)].  
