...
|Planifications|Oui|Consultez la méthode ListSchedules [méthodes d’abonnement et remise](../report-server-web-service/methods/subscription-and-delivery-methods.md)|  
