...
-   Lorsque vous ouvrez un rapport dans le Concepteur de rapports de [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)], la définition du rapport est mise à niveau vers le schéma RDL actuellement pris en charge. Lorsque vous spécifiez un [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] ou [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] serveur de rapports dans les propriétés du projet, la définition de rapport est enregistrée dans un schéma qui est compatible avec le serveur cible.  
...
-   Le rapport principal et tous les sous-états ne peuvent pas être mis à niveau. Ils sont traités par le [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 2005 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] processeur de rapports.  
