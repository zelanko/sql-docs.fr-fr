...
|Effectuer des analyses prédictives en libre-service||||||[Compléments d’exploration de données pour Excel](https://docs.microsoft.com/analysis-services/data-mining-client-for-excel-sql-server-data-mining-add-ins)|  
