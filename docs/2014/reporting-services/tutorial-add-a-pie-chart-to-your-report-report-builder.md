...
5.  Facultatif Pour spécifier le nombre de décimales affichées sur l’étiquette `#PERCENT{Pn}` , tapez où *n* est le nombre de décimales à afficher. Par exemple, pour ne pas afficher de décimales `#PERCENT{P0}`, tapez.  
