...
-   **Export (facultatif).** Exporte le rapport vers un autre format de fichier.  
...
-   **Déterminez où vous pouvez trouver plus d’informations.** Par exemple, pour la création de rapports qui inclut des expressions, l'outil Concepteur de rapports fournit plus d'informations sur les problèmes d'évaluation d'expression que l'outil Générateur de rapports. Pour les erreurs de traitement des rapports, les fichiers journaux contiennent des informations détaillées.  
