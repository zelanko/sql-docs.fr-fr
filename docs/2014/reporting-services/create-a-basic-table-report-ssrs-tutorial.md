...
## <a name="tasks"></a>Tâches  
 ...
 [Leçon 3 : Définition d’un Dataset pour le rapport de tableau &#40;Reporting Services&#41;](lesson-3-defining-a-dataset-for-the-table-report-reporting-services.md)  
...
> [!NOTE]  
>  Lorsque vous parcourez les didacticiels, nous vous conseillons **suivant** et **précédent** boutons à la barre d’outils Visionneuse de document. Pour plus d'informations, consultez  
