...
# <a name="technical-reference-ssrs"></a>Références techniques (SSRS)
 ...
 ![Petite icône de dossier de fichiers](../../2014/integration-services/media/filefolder-small.gif "Petite icône de dossier de fichiers") **Références relatives aux fonctions**  
