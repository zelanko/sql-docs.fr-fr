...
|[!INCLUDE[ssSDS](../includes/sssds-md.md)] dans le nuage (cloud)|`Data Source=<host>;Initial Catalog=AdventureWorks; Encrypt=True`|Définissez `Windows Azure SQL Database` comme type de source de données. Pour plus d’informations, consultez [Type de connexion SQL Azure &#40;SSRS&#41;](report-data/sql-azure-connection-type-ssrs.md).|  
