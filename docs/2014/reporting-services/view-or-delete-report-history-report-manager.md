---
title: Afficher ou supprimer l’historique de rapport (Gestionnaire de rapports) | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
3.  Cliquez sur l’onglet **Historique** . Les instantanés d’historique sont affichent dans le **quand exécuter** colonne.  
...
2.  Cliquez sur l’onglet **Historique** . Les instantanés d’historique sont affichent dans le **quand exécuter** colonne.  
  
3.  Sélectionnez la case à cocher en regard de l’instantané d’historique que vous souhaitez supprimer, puis cliquez sur **supprimer**.  
