...
##  <a name="folders"></a><a name="bkmk_Folders"></a>Contenus
...
##  <a name="resources"></a><a name="bkmk_Resources"></a>Situées
...
|$ (signe $)|[dollar]|*User* $Le*nom* d’utilisateur devient *User*[] [Dollar]*Name*|
