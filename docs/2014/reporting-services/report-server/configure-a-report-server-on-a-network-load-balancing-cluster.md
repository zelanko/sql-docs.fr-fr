...
5.  Vérifiez que tous les fichiers Web.Config des dossiers \Reporting Services\ReportManager contiennent des éléments <`machineKey`> identiques dans la section <`system.web`>.  
