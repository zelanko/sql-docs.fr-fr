...
3.  Cliquez avec le bouton droit sur la zone de texte, puis cliquez sur **Propriétés de la zone de texte**.  
...
6.  Cliquez sur **Ajouter** sous **utiliser ces paramètres pour exécuter la section du rapport** .  
  
7.  Tapez **ProductID** dans la zone **nom** , puis cliquez sur **ProductID** dans la liste déroulante **valeur** .  
