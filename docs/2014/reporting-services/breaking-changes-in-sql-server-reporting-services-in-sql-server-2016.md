---
title: Modifications avec rupture dans SQL Server Reporting Services dans SQL Server 2014 | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
##  <a name="bkmk_sql14"></a> [!INCLUDE[ssSQL14](../includes/sssql14-md.md)] Modifications avec rupture de Reporting Services  
 Il n’y aucun [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] modifications avec rupture dans [!INCLUDE[ssSQL14](../includes/sssql14-md.md)].  
