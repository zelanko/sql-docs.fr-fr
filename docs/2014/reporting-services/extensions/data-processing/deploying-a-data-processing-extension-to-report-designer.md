...
-   Ajoutez l’entrée suivante au fichier RSReportDesigner.config sous le **concepteur** élément, en remplaçant le `Name` attribut avec le nom que vous avez fourni dans les entrées précédentes.  
