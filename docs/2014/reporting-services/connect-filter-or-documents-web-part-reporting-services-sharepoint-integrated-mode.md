---
title: Connecter un filtre ou le composant WebPart Documents (Reporting Services en Mode intégré SharePoint) | Documents Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Personnaliser le composant Web de la Visionneuse de rapports](../../2014/reporting-services/customize-the-report-viewer-web-part.md)  
