...
-   [Pour activer la gestion des types de contenu pour une seule bibliothèque de documents (SharePoint 2013)](#bkmk_enable_content_management)  
  
-   [Pour ajouter des types de contenu Reporting Services (SharePoint 2013)](#bkmk_add_single)  
  
-   [Pour activer la gestion des types de contenu pour une seule bibliothèque de documents (SharePoint 2010)](#bkmk_enable_content_management_2010)  
...
##  <a name="bkmk_enable_content_management"></a>Pour activer la gestion des types de contenu pour une seule bibliothèque de documents (SharePoint 2013)  
...
##  <a name="bkmk_enable_content_management_2010"></a>Pour activer la gestion des types de contenu pour une seule bibliothèque de documents (SharePoint 2010)  
