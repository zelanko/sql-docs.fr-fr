---
title: Boîte de dialogue Sections d’un rapport | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "59935495"
---
# <a name="report-sections-dialog-box"></a>Boîte de dialogue Sections de rapport
  Lorsque vous ouvrez un rapport, le Concepteur de rapports vérifie que le rapport contient uniquement un seul langage RDL (Report Definition)  **\<Section >** élément. L’ouverture d’un rapport avec plusieurs éléments **\<Section>** n’est pas prise en charge.  
