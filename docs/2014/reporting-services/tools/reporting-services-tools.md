...
## <a name="tools-for-report-content-management"></a>Outils pour la gestion de contenu du rapport  
 Un ensemble d’outils graphiques et de script sont disponibles pour gérer le contenu [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]dans. Les outils à utiliser dépendent du mode de déploiement de votre serveur de rapports.  
