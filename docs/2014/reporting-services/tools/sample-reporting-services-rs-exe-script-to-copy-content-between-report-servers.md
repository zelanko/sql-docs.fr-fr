---
title: Exemple de Reporting Services script RS. exe pour migrer du contenu entre des serveurs de rapports | Microsoft Docs
ms.custom: ''
ms.date: 07/27/2015
...
|----------|--------------|----------------|-----------------|  
|Mot de passe|**Non**|**Non**|Les mots de passe **NE sont PAS** migrés. Une fois que les éléments de contenu sont migrés, mettez à jour les informations d'identification sur le serveur de destination. Par exemple, les sources de données avec les informations d'identification stockées.|  
...
|Planification|<xref:ReportService2010.ReportingService2010.ListSchedules%2A>|<xref:ReportService2010.ReportingService2010.CreateSchedule%2A>|  
...
##  <a name="bkmk_how_to_use_the_script"></a>Comment utiliser le script  
...
##  <a name="bkmk_parameter_description"></a>Description du paramètre  
  
|Paramètre|Description|Obligatoire|  
|---------------|-----------------|--------------|  
|**-s** Source_URL|URL du serveur de rapports source|Oui|  
|**-u** Mot de passe Domain\password **-p**|Informations d'identification pour le serveur source.|FACULTATIF, les informations d'identification par défaut sont utilisées si manquantes|  
...
|**-v tu**= "domaine\nom_utilisateur" **-v TP**= "mot de passe"|Informations d'identification du serveur cible.|FACULTATIF, les informations d'identification par défaut sont utilisées si manquantes. **Remarque :** l’utilisateur sera listé comme « créateur » des planifications partagées et par le compte « modifié par » pour les éléments de rapport, sur le serveur cible.|  
...
##  <a name="bkmk_more_examples"></a>Autres exemples  
...
###  <a name="bkmk_native_to_native_Azure_vm"></a>Mode natif vers mode natif-machine virtuelle Azure  
 L'exemple suivant migre le contenu :  
