...
1.  Dans l’écran de démarrage de `sql server` Windows, tapez, puis dans les résultats de la recherche d' **applications** , cliquez sur **SQL Server Management Studio**.  
