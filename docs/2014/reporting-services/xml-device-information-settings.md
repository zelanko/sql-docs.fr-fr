...
|**Mis en retrait**|Indique s'il faut générer du code XML mis en retrait. La valeur par défaut `false` génère un code XML compressé sans mise en retrait.|  
