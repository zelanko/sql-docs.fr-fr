---
title: Créer une Source de données incorporée ou partagée (SSRS) | Documents Microsoft
ms.custom: ''
ms.date: 03/08/2017
...
3.  Pour une source de données incorporée, vérifiez que **connexion incorporée** est sélectionnée.  
...
4.  Pour une source de données partagée, vérifiez que **utiliser une référence de source de données partagée** est sélectionnée.  
...
-   Dans le volet des données, avec le bouton droit de la source de données, puis **convertir en Source de données partagée**.  
...
-   Dans le volet des données, avec le bouton droit de la source de données et ouvrez **propriétés Source de données**.  
  
-   Cliquez sur **connexion incorporée** et terminer la création de la source de données incorporée comme décrit précédemment.  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Convertir une Source de données incorporée en source partagée &#40;rapport Générateur et SSRS&#41;](report-data/convert-data-sources-report-builder-and-ssrs.md)   
