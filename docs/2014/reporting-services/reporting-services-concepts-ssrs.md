...
ms.locfileid: "67046743"
---
# <a name="reporting-services-concepts-ssrs"></a>Concepts de Reporting Services (SSRS)
  Cette rubrique fournit un bref résumé des [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] concepts.  
  
||  
|-|  
|**[!INCLUDE[applies](../includes/applies-md.md)]**  [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]Mode SharePoint &#124; [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] en mode natif|  
  
 **Dans cette rubrique :**  
  
-   [Concepts du serveur de rapports](#bkmk_ReportServerConcepts)  
 ...
 **Régions de données et mappages**  
 ...
 **Rapports de modèle et rapports générés interactifs**  
...
##  <a name="bkmk_StagesofReports"></a>Phases de développement des rapports  
 ...
 **Rapports exportés**  
 Un rapport exporté est un rapport totalement paginé enregistré dans un format de fichier spécifique. Les formats d'exportation dépendent des extensions de rendu installées et peuvent être personnalisés. Par défaut, les formats d'exportation comprennent Excel, Word, XML, PDF, TIFF et CSV. Pour plus d’informations, consultez [exportation de rapports &#40;générateur de rapports et&#41;SSRS ](report-builder/export-reports-report-builder-and-ssrs.md).  
  
## <a name="see-also"></a>Voir aussi  
 [Fonctionnalités et tâches de Reporting Services &#40;SSRS&#41;](reporting-services-features-and-tasks-ssrs.md)   
