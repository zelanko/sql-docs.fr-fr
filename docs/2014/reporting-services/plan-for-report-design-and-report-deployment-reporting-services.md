...
-   **Par programmation :** publiez par programmation un rapport à l'aide des interfaces SOAP API vers un serveur de rapports. Pour plus d’informations, consultez [Service Web Report Server](report-server-web-service/report-server-web-service.md).  
...
-   [Microsoft SQL Server Data Tools - Business Intelligence pour Visual Studio 2012](http://www.microsoft.com/download/details.aspx?id=36843).  
