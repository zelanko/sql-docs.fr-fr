---
title: Interface utilisateur De concepteur de requête basée sur le texte (en anglais seulement) Microsoft Docs
ms.custom: ''
ms.date: 03/08/2017
...
-   **Requête** Affiche le texte de la requête, le nom de table ou le nom de procédure stocké.
...
```
 ...
 Vous pouvez utiliser toute instruction [!INCLUDE[tsql](../includes/tsql-md.md)] pour le texte de type de commande, y compris des instructions `EXEC`. La requête suivante [!INCLUDE[ssSampleDBobject](../includes/sssampledbobject-md.md)] appelle `uspGetEmployeeManagers` la procédure stockée et renvoie la chaîne de commandement pour l’employé avec le numéro d’identification 1.
...
#### <a name="example"></a>Exemple
 ...
 Lorsque vous entrez le nom de table Sales.Customer, c’est l’équivalent de la création de l’instruction [!INCLUDE[tsql](../includes/tsql-md.md)] `SELECT * FROM Sales.Customer;`.

## <a name="see-also"></a>Voir aussi
 [Outils de conception de requête dans report Designer SQL Server Data Tools &#40;SSRS&#41;](report-data/query-design-tools-ssrs.md) [Report Embedded Datasets and Shared Datasets &#40;Report Builder and SSRS&#41;](report-data/report-embedded-datasets-and-shared-datasets-report-builder-and-ssrs.md) [SQL Server Connection Type &#40;SSRS&#41;](report-data/sql-server-connection-type-ssrs.md) [OLE D Type de connexion BB &#40;SSRS&#41;](report-data/ole-db-connection-type-ssrs.md) type de connexion [ODBC &#40;SSRS&#41;](report-data/odbc-connection-type-ssrs.md) Rapport [ensembles de données intégrés et ensembles de données partagés &#40;Report Builder et SSRS&#41;](report-data/report-embedded-datasets-and-shared-datasets-report-builder-and-ssrs.md) [RSReportDesigner Configuration File](report-server/rsreportdesigner-configuration-file.md)
