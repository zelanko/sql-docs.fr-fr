---
title: Importer des rapports à partir de Microsoft Access (Reporting Services) | Documents Microsoft
ms.custom: ''
ms.date: 03/07/2017
...
# <a name="import-reports-from-microsoft-access-reporting-services"></a>Importer des rapports depuis Microsoft Access (Reporting Services)
  Dans le Concepteur de rapports, vous pouvez importer des rapports à partir d’un [!INCLUDE[msCoName](../includes/msconame-md.md)] base de données Access ou de projet. Microsoft Access 2002 (ou version ultérieure) doit être installé sur le même ordinateur que le Concepteur de rapports.  
...
> [!NOTE]  
>  [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] ne prend pas en charge tous les objets de rapport Access. Les éléments qui ne sont pas convertis sont affichés dans le **liste des tâches** fenêtre. Pour plus d’informations, consultez [prise en charge des fonctionnalités de rapport Access &#40;SSRS&#41;](../../2014/reporting-services/supported-access-report-features-ssrs.md).  
...
3.  Dans le **ouvrir** boîte de dialogue, sélectionnez la base de données Access (.mdb, .accdb) ou un projet (.adp) qui contient les rapports, puis cliquez sur **ouvrir**. Tous les rapports contenus dans le fichier de base de données ou de projet sont importés et répertoriés dans le dossier Rapports de l'Explorateur de solutions.  
  
4.  Vérifiez le **liste des tâches** fenêtre pour les erreurs de build. Pour afficher le **liste des tâches** fenêtre, ouvrez le **vue** menu, pointez sur **autres fenêtres**, puis cliquez sur **liste des tâches**.  
