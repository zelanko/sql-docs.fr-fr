...
##  <a name="ReportServers"></a>Fonctionnement de la sécurité pour les serveurs de rapports  
...
##  <a name="Interactive"></a>Comprendre la sécurité pour la création de rapports pour les fonctionnalités interactives  
