...
|fichier ESRI .shp|Spécification Open développée par Environmental Systems Research Institute, Inc. (Environmental) pour les données spatiales.|  
|fichier de forme ESRI|Spécification Open développée par Environmental Systems Research Institute, Inc. (Environmental) pour les données spatiales.|  
...
|HTML|Voir autre terme : Hypertext Markup Language|  
...
|IPsec|Voir autre terme : sécurité du protocole Internet|  
...
|MDX|Voir autre terme : MDX (Multidimensional Expressions)|  
...
|RDL|Voir autre terme : Report Definition Language (RDL)|  
...
|SMDL|Voir autre terme : Semantic Model Definition Language (SMDL)|  
...
|SQL|Voir autre terme : SQL (Structured Query Language)|  
...
|WMI|Voir autre terme : Windows Management Instrumentation|  
