...
|le chiffrement|Méthode permettant de préserver la confidentialité des informations sensibles en modifiant les données dans un format non lisible.|  
...
|map|Élément de rapport qui est un conteneur pour des titres, différents types de légendes et des couches.|  
