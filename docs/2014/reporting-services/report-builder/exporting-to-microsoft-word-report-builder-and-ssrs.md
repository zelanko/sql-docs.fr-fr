...
##  <a name="WordStyleRendering"></a>Rendu de style Word  
...
##  <a name="SquigglyLines"></a>Lignes ondulées dans les rapports exportés  
...
##  <a name="WordLimitations"></a>Limitations relatives au mot  
...
-   Utilisation du composant WebPart Visionneuse de rapports en mode distant.  
 ...
 L'extension WORDOPENXML définit le convertisseur Word pour [!INCLUDE[ofprword](../../includes/ofprword-md.md)] 2007-2010. L'extension WORD définit la version [!INCLUDE[ofprword](../../includes/ofprword-md.md)] 2003. 
  `Visible = "false"` indique que le convertisseur Word 2003 est masqué. Pour plus d'informations, consultez [RSReportServer Configuration File](../report-server/rsreportserver-config-configuration-file.md) et [RSReportDesigner Configuration File](../report-server/rsreportdesigner-configuration-file.md).  
