...
<div id="main" class="v2">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Obtenir une machine virtuelle Azure avec SQL Server</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <h1 class="screenReader">Documentation Microsoft SQL</h1>
        <ul class="pivots">
            <li>
                              ...
                              <div class="cardSize">
                                  <div class="cardPadding">
                                      <div class="card">
                                          ...
                                          <div class="cardText">
                                              <h3>SQL Server sur Windows</h3>
                                              <ul class="noBullet">
                                              <li><a class="barLink" href="/sql/sql-server/sql-server-technical-documentation/"><strong>Local</strong></a></li>
                                              <li><a class="barLink" href="/azure/virtual-machines/windows/sql/virtual-machines-windows-sql-server-iaas-overview/"> <strong>Sur une machine virtuelle Azure</strong></a></li>
                                              <li><a class="barLink" href="/sql/sql-server/what-s-new-in-sql-server-ver15/"><strong>Nouveautés</strong></a></li>
                                              </ul>
                                          </div>
                                      </div>
                                  </div>
                              ...
                              <div class="cardSize">
                                  <div class="cardPadding">
                                      <div class="card">
                                          ...
                                          <div class="cardText">
                                              <h3>SQL en tant que service Azure</h3>
                                              <ul class="noBullet">
                                                  ...
                                                  <li><a class="barLink" href="https://azure.microsoft.com/updates/?status=all&product=sql-database"><strong>Nouveautés</strong></a></li>
                                              </ul>
                                          </div>
                                      </div>
                                  </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>SQL Server sur Linux</h3>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/sql/linux/sql-server-linux-overview/"><strong>Local</strong></a></li>
                                                    <li><a class="barLink" href="/sql/linux/quickstart-install-connect-clouds/"><strong>Sur une machine virtuelle Azure</strong></a></li>
                                                    <li><a class="barLink" href="/sql/linux/sql-server-linux-whats-new/"><strong>Nouveautés</strong></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>Installer ou mettre à niveau</h3>
                                                          <p>Bien démarrer avec la documentation décrivant comment installer et mettre à niveau SQL Server et les services associés.</p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>Continuité de l’activité</h3>
                                                          <p><b>Haute disponibilité, récupération d’urgence, groupe de disponibilité Always On, instance de cluster de basculement Always On, mise en miroir de base de données, sauvegarde et restauration</b></p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>Sécurité</h3>
                                                          <p><b>Autorisations, gestion de l’accès, Always Encrypted, TDE, SSL</b></p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>Migrer, charger et déplacer des données</h3>
                                                          <p><b>Assistants de migration, Integration Services (SSIS), Assistant d’importation/exportation, réplication </b> </p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>Découvrir SQL Server</h3>
                                                          <p>En savoir plus sur les mécanismes internes architecturaux de SQL Server avec une série de tutoriels et de guides. </p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                                  ...
                                                  <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                          <li><a class="barLink" href="/sql/relational-databases/database-features/">Concepts des bases de données relationnelles</a></li>
                                                            <li><a class="barLink" href="/sql/connect/homepage-sql-connection-programming/">Connecter avec des applications clientes locales</a></li>
                                                            <li><a class="barLink" href="/azure/sql-database/sql-database-libraries">Bibliothèques de connectivité Azure SQL DB</a></li>
                                                            <li><a class="barLink" href="https://docs.microsoft.com/azure/sql-database/sql-database-develop-overview">Applications Azure SQL DB</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card">
                                                  <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                            ...
                                                            <li><a class="barLink" href="/sql/tools/overview-sql-tools">Autres outils SQL</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="cardSize">
                                            <div class="cardPadding">
                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li><a class="barLink" href="/rest/api/sql/">API Rest SQL</a></li>
                                                </ul></td>
                                                <td style="border-top-color:transparent!important;padding-left:0;">
                                                <ul class="noBullet">
                                                     <li><a class="barLink" href="/dotnet/api/?view=sqlserver-2017">API du SDK .NET SQL</a></li>
                                                     <li><a class="barLink" href="/sql/t-sql/language-reference">Transact-SQL (T-SQL)</a></li>
                                                     <li><a class="barLink" href="/sql/samples/sql-samples-where-are/">Exemples de base de données</a></li>
                                                     <li><a class="barLink" href="/previous-versions/sql/">Contenu archivé (SQL 2005-2012)</a></li>
                                                </ul></td></tr></table>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card">
                                                  <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                            ...
                                                            <li><a class="barLink" href="/power-bi/service-get-started/">Service Power BI</a></li>
                                                ...
                                                <div class="card">
                                                  <div class="cardText">
                                                        ...
                                                        <li><a class="barLink" href="/sql/analytics-platform-system/">Microsoft Analytics Platform System</a></li>
                                                            ...
                                                            <li><a class="barLink" href="/sql/relational-databases/polybase/polybase-guide/">PolyBase</a></li>                                                            <li><a class="barLink" href="/sql/big-data-cluster/big-data-cluster-overview/">Clusters de Big Data SQL Server 2019</a></li>
                                                       </ul>
                                                    </div>
                                                </div>
                                            </div>
