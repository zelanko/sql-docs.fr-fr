                                        ...
                                        <div class="card">
                                            <div class="cardText">
                                                <div style="height:100px; border-bottom-color: #dbdbdb; border-bottom-width: 1px; border-bottom-style: solid; position: relative;">
                                                   <h3 style="bottom: 20px; color: rgb(110, 110, 110); font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif; font-size: 2rem; vertical-align: bottom; position: absolute;">Bases de données</h3>
                                                </div>
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="/sql/analytics-platform-system/index">Analytics Platform System - Parallel Data Warehouse</a></li>
                                                    </ul>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">Exemples sur GitHub</h4>
                                                <ul>
                                                    <li><a href="https://github.com/Microsoft/sql-server-samples/tree/master/samples">Exemples de code</a></li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <div style="height:100px; border-bottom-color: #dbdbdb; border-bottom-width: 1px; border-bottom-style: solid; position: relative;">
                                                   <h3 style="bottom: 20px; color: rgb(110, 110, 110); font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif; font-size: 2rem; vertical-align: bottom; position: absolute;">Analytique des données</h3>
                                                </div>
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="https://azuremarketplace.microsoft.com/marketplace/apps/microsoft-ads.standard-data-science-vm">Machine virtuelle pour la science des données</a></li>
                                                </ul>
                                                ...
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">Signalement</h4>
                                                <ul>
                                                    ...
                                                    <li><a href="https://powerbi.microsoft.com/documentation/powerbi-service-get-started/">Service Power BI</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
