                ...
                <ul id="main">
                        ...
                        <ul id="get-started" class="cardsW">
                            <li class="fullSpan">
                                <div class="container intro" style="color: #535353; font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif;">
                                    <p>Rechercher des rubriques et des téléchargements courants pour la plateforme SQL de Microsoft</p>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <div style="height:100px; border-bottom-color: #dbdbdb; border-bottom-width: 1px; border-bottom-style: solid; position: relative;">
                                                   <h3 style="bottom: 20px; color: rgb(110, 110, 110); font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif; font-size: 2rem; vertical-align: bottom; position: absolute;">Nouveautés</h3>
                                                </div>
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">SQL Server</h4>
                                                <ul>
                                                    <li><a href="/sql/sql-server/what-s-new-in-sql-server-2017">Préversion de SQL Server 2017</a></li>
                                                    <li><a href="https://docs.microsoft.com/sql/reporting-services/what-s-new-in-sql-server-reporting-services-ssrs">Préversion de SQL Server 2017 Reporting Services</a></li>
                                                    <li><a href="/sql/linux/sql-server-linux-whats-new">SQL Server sur Linux</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <div style="height:100px; border-bottom-color: #dbdbdb; border-bottom-width: 1px; border-bottom-style: solid; position: relative;">
                                                   <h3 style="bottom: 20px; color: rgb(110, 110, 110); font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif; font-size: 2rem; vertical-align: bottom; position: absolute;">Explorer</h3>
                                                </div>
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">Créer votre première base de données</h4>
                                                <ul>
                                                    ...
                                                    <li><a href="/azure/machine-learning/machine-learning-create-experiment">Expérimentation de la science des données</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <div style="height:100px; border-bottom-color: #dbdbdb; border-bottom-width: 1px; border-bottom-style: solid; position: relative;">
                                                   <h3 style="bottom: 20px; color: rgb(110, 110, 110); font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif; font-size: 2rem; vertical-align: bottom; position: absolute;">Télécharger et installer</h3>
                                                </div>
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">SQL Server</h4>
                                                <ul>
                                                    <li><a href="https://www.microsoft.com/en-us/sql-server/sql-server-downloads">SQL Server 2016</a></li>
                                                    <li><a href="https://www.microsoft.com/en-us/sql-server/sql-server-2017">Préversion de SQL Server 2017</a></li>
                                                ...
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">Outils</h4>
                                                <ul>
                                                    ...
                                                    <li><a href="https://www.microsoft.com/download/details.aspx?id=55253">Power BI Report Server et outils</a></li>
                                                </ul>
                    ...
                    <li>
                        ...
                        <ul id="databases" class="cardsW">
                            <li class="fullSpan">
                                <div class="container intro" style="color: #535353; font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif;">
                                    <p>Gérer les données relationnelles avec les bases de données SQL dans votre centre de données ou sur Azure</p>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">Dernières versions</h4>
                                                <ul>
                                                ...
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">Exécuter sur Windows ou Linux</h4>
                                                <ul>
                                                    <li><a href="/sql/linux/?toc=/sql/linux/toc.json">SQL Server sur Linux</a></li>
                                                    <li><a href="/azure/virtual-machines/linux/">Machines virtuelles Linux</a></li>
                                                    <li><a href="/azure/virtual-machines/windows/">Machines virtuelles Windows</a></li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <div style="height:100px; border-bottom-color: #dbdbdb; border-bottom-width: 1px; border-bottom-style: solid; position: relative;">
                                                   <h3 style="bottom: 20px; color: rgb(110, 110, 110); font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif; font-size: 2rem; vertical-align: bottom; position: absolute;">Base de données en tant que service</h3>
                                                </div>
                                                ...
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">SQL en open source</h4>
                                                <ul>
                                                    <li><a href="/azure/postgresql/">Base de données Azure pour PostgreSQL</a></li>
                                                    <li><a href="/azure/mysql/">Base de données Azure pour MySQL</a></li>
                                                </ul>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <ul>
                                                    <li><a href="/sql/connect/sql-server-driver-documentation">Connecter avec des applications clientes</a></li>
                                                ...
                                                <ul>
                                                    <li><a href="/sql/ssms/download-sql-server-management-studio-ssms">SQL Server Management Studio (SSMS)</a></li>
                                                    <li><a href="/sql/ssdt/download-sql-server-data-tools-ssdt">SQL Server Data Tools (SSDT)</a></li>
                                                    <li><a href="/sql/tools/command-prompt-utility-reference-database-engine">Voir tous les outils SQL</a></li>
                                                </ul>
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">Référence</h4>
                                                <ul>
                    ...
                    <li>
                        <a href="#movement">Déplacement des données</a>
                        <ul id="movement" class="cardsW">
                            <li class="fullSpan">
                                <div class="container intro" style="color: #535353; font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif;">
                                    <p>Migrer votre base de données ou déplacer des données entre bases de données</p>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="https://www.microsoft.com/en-us/download/details.aspx?id=54257">SSMA pour MySql</a></li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <div style="height:135px; border-bottom-color: #dbdbdb; border-bottom-width: 1px; border-bottom-style: solid; position: relative;">
                                                   <h3 style="bottom: 20px; color: rgb(110, 110, 110); font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif; font-size: 2rem; vertical-align: bottom; position: absolute;">Déplacer des données vers Stockage Azure pour la préparation des données</h3>
                                                </div>
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">Réseau</h4>
                                                <ul>
                                                    <li><a href="/azure/networking/networking-overview">Vue d’ensemble</a></li>
                                                    <li><a href="/azure/networking/networking-overview">ExpressRoute</a></li>
                                                </ul>
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">Déplacer vers Stockage Blob Azure</h4>
                                                <ul>
                                                    <li><a href="/azure/vs-azure-tools-storage-manage-with-storage-explorer">Explorateur de stockage Azure</a></li>
                                                    <li><a href="/azure/storage/storage-use-azcopy">AZCopy</a></li>
                                                    <li><a href="/azure/storage/storage-import-export-service">Service d’importation/exportation</a></li>
                                                    <li>
                                                        <a href="/sql/integration-services/sql-server-integration-services"> SQL Server Integration Services (SSIS) </a>
                                                    </li>
                                                </ul>
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">Déplacer vers Azure Data Lake Store</h4>
                                                <ul>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <div style="height:135px; border-bottom-color: #dbdbdb; border-bottom-width: 1px; border-bottom-style: solid; position: relative;">
                                                   <h3 style="bottom: 20px; color: rgb(110, 110, 110); font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif; font-size: 2rem; vertical-align: bottom; position: absolute;">Déplacer des données vers une base de données</h3>
                                                </div>
                                                ...
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">NoSQL</h4>
                                                <ul>
                                                    <li><a href="/azure/documentdb/documentdb-import-data">Importer des données dans Azure Cosmos DB</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        ...
                        <ul id="analytics" class="cardsW">
                            <li class="fullSpan">
                                <div class="container intro" style="color: #535353; font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif;">
                                    <p>Utiliser l’apprentissage automatique et l’analytique pour obtenir des insights sur des données SQL</p>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">Apprentissage automatique</h4>
                                                <ul>
                                                    <li><a href="https://docs.microsoft.com/sql/advanced-analytics/r/r-services">SQL Server Machine Learning Services</a></li>
                                                    <li><a href="https://docs.microsoft.com/sql/advanced-analytics/r/r-server-standalone">Machine Learning Server (Autonome)</a></li>
                                                </ul>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <div style="height:100px; border-bottom-color: #dbdbdb; border-bottom-width: 1px; border-bottom-style: solid; position: relative;">
                                                   <h3 style="bottom: 20px; color: rgb(110, 110, 110); font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif; font-size: 2rem; vertical-align: bottom; position: absolute;">Analytique en tant que service</h3>
                                                </div>
                                                <ul>
                                                    ...
                                                    <li><a href="https://azuremarketplace.microsoft.com/en-us/marketplace/apps/microsoft-ads.standard-data-science-vm">Machine virtuelle pour la science des données</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <ul>
                                                    <li><a href="https://powerbi.microsoft.com/en-us/documentation/powerbi-service-get-started/">Service Power BI</a></li>
                                                    <li><a href="https://powerbi.microsoft.com/en-us/documentation/powerbi-desktop-get-the-desktop/">Power BI Desktop</a></li>
                                                    <li><a href="https://powerbi.microsoft.com/en-us/documentation/powerbi-power-bi-apps-for-mobile-devices/">Applications mobiles Power BI</a></li>
