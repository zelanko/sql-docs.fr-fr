...
Pour plus d'informations sur les conditions de création d'objets de base de données CLR requises, consultez les rubriques appropriées dans [Création d'objets de base de données avec l'intégration CLR (Common Language Runtime)](http://msdn.microsoft.com/library/ms131046.aspx).  
...
[Avantages de l'utilisation du code managé pour créer des objets de base de données](http://msdn.microsoft.com/library/k2e1fb36.aspx)  
[Création d’objets de base de données avec intégration du Common Language Runtime (CLR)](http://msdn.microsoft.com/library/ms131046.aspx)  
