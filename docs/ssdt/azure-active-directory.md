...
description: En savoir plus sur les méthodes d’authentification Azure Active Directory fournies par SQL Server Data Tools (SSDT) pour Azure SQL Database et Azure SQL Data Warehouse.
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
