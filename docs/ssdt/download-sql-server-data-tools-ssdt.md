...
> - SSDT pour Visual Studio 2017 depuis la version 15.8.2 ne prend pas en charge la conception de packages qui contiennent une source/destination Teradata. Utilisez SSDT pour Visual Studio 2017 (15.8).
