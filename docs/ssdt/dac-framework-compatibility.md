---
title: Compatibilité avec DAC Framework| Microsoft Docs
ms.custom:
- SSDT
ms.date: 02/09/2017
ms.prod: sql
...
Vous pouvez télécharger une version plus récente de SSDT à partir de la page [Installer la dernière version de SQL Server Data Tools](https://go.microsoft.com/fwlink/?LinkID=616714).  
