...
![Icône de flèche utilisée avec le lien Retour au début](../release-notes/media/uparrow16x16.gif "Icône de flèche utilisée avec le lien Retour au début")[Début](#top)  
