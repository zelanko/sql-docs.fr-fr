---
title: Notes de publication de SQL Server | Microsoft Docs
ms.custom: 
ms.date: 06/15/2016
...
Le [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] document Notes de publication décrit les problèmes connus que vous devez examiner avant d'installer ou de dépanner [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]. Le document Notes de publication répertorié ici est uniquement disponible en ligne (absent du support d'installation), et est régulièrement mis à jour.  
  
## <a name="release-notes"></a>Notes de publication  
  
### <a name="sql-server-2016"></a>SQL Server 2016 
[Notes de publication de SQL Server 2016](https://msdn.microsoft.com/library/dn876712.aspx)  
...
[Notes de publication de SQL Server 2008](http://download.microsoft.com/download/4/9/e/49eeb41a-a769-4520-80d6-671b8ae2bd06/SQLServer2008ReleaseNotes.htm)  
  
[Notes de publication de SQL Server 2008 SP1](http://download.microsoft.com/download/1/6/3/163A851B-D956-42E9-B426-F5C0EBE6B654/ReleaseNotes.htm)  
  
[Notes de publication de SQL Server 2008 SP2](http://social.technet.microsoft.com/wiki/contents/articles/1486.microsoft-sql-server-2008-sp2-release-notes.aspx)  
  
[Notes de publication de SQL Server 2008 SP3](http://social.technet.microsoft.com/wiki/contents/articles/4937.microsoft-sql-server-2008-sp3-release-notes.aspx)  
