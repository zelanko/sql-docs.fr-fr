...
Ces notes de publication décrivent des problèmes connus que vous devez examiner avant d’installer ou de résoudre les problèmes de [!INCLUDE[msCoName](../includes/msconame-md.md)][!INCLUDE[ssSQL11](../includes/sssql11-md.md)] Service Pack 1. Ces notes de publication, uniquement disponibles en ligne (absent du support d’installation), sont régulièrement mises à jour.  
...
![Icône de flèche utilisée avec le lien Retour au début](../release-notes/media/uparrow16x16.gif "Icône de flèche utilisée avec le lien Retour au début")[Sommaire](#bkmk_top)  
