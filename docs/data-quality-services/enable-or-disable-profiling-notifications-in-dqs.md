---
description: Activer ou désactiver les notifications de profilage dans DQS
title: Activer ou désactiver les notifications de profilage dans DQS
ms.date: 03/01/2017
ms.prod: sql
