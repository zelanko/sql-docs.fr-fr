...
6.  Sélectionnez **Active** pour spécifier que la règle sera exécutée (par défaut), ou désélectionnez cette option pour empêcher l’exécution de la règle.  
  
7.  Dans la **une règle de génération** volet, sélectionnez une condition dans la liste déroulante dans la zone de clause de la règle.  
