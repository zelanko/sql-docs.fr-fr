 ...
 **Reference Data Services**  
 ...
 Pour plus d’informations sur la gestion des connaissances dans DQS, consultez [Bases de connaissances DQS et les domaines](../data-quality-services/dqs-knowledge-bases-and-domains.md).  
...
-   **Nettoyage assisté par ordinateur**: DQS utilise la base de connaissances dans la base de connaissances sélectionnée pour le projet de nettoyage pour proposer des corrections/suggestions aux valeurs dans une source de données.  
  
-   **Nettoyage interactif**: le Gestionnaire de données peut exécuter le processus de nettoyage interactif pour modifier ou augmenter les corrections des données qui ont été proposées par le processus de nettoyage de données assisté par ordinateur. Il utilise pour cela les niveaux de confiance et les statistiques identifiés par le processus de nettoyage de données, ou écrit manuellement ses propres modifications dans le projet.  
 ...
 **Profilage et notifications**  
 ...
 Pour plus d’informations sur les projets de qualité des données dans DQS, consultez [projets de qualité des données & #40 ; DQS & #41 ;](../data-quality-services/data-quality-projects-dqs.md).  
...
-   Définir les valeurs de seuil pour les activités de nettoyage et de correspondance. Pour plus d'informations, consultez [Configure Threshold Values for Cleansing and Matching](../data-quality-services/configure-threshold-values-for-cleansing-and-matching.md).  
