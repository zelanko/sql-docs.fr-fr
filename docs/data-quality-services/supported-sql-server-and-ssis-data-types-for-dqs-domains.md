...
---
# Types de donn&#233;es SQL Server et SSIS pris en charge pour les domaines&#160;DQS
...
|Chaîne|char<br /><br /> nchar<br /><br /> nvarchar<br /><br /> varchar|  
 ...
 Les autres types de données SQL Server ne sont pas pris en charge dans DQS. Pour plus d’informations sur tous les types de données SQL Server, consultez [des Types de données & #40 ; Transact-SQL & #41 ;](../t-sql/data-types/data-types-transact-sql.md).  
