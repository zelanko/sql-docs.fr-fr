...
ms.topic: "article"
helpviewer_keywords: 
  - "Gestion basée sur des stratégies, Invoke-PolicyEvaluation"
  - "Gestion basée sur des stratégies, PowerShell"
  - "Invoke-PolicyEvaluation (applet de commande)"
  - "Applets de commande [SQL Server], Invoke-PolicyEvaluation"
