...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx_md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]Récupère la quantité d’espace entre les colonnes de longueur variable supprimées dans les tables ou vues indexées.
