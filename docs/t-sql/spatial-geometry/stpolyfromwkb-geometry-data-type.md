---
title: "STPolyFromWKB (Type de données geometry) | Documents Microsoft"
ms.custom: 
ms.date: 08/03/2017
...
Retourne un **geometryPolygon** instance à partir d’une représentation de l’Open Geospatial Consortium (OGC) WKB Well-Known Binary ().
 ...
 *WKB_polygon*  
 Est la représentation WKB de le **geometryPolygon** instance à retourner. *WKB_polygon* est un **varbinary (max)** expression.  
