...
Les noms des certificats sont visibles dans l'affichage catalogue [sys.certificates](../../relational-databases/system-catalog-views/sys-certificates-transact-sql.md).
