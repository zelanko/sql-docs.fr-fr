---
title: ATAN (Transact-SQL) | Documents Microsoft
ms.custom: 
ms.date: 07/24/2017
...
Retourne l’angle en radians dont la tangente est spécifié **float** expression. Cette valeur est également appelée arc tangente.
...
*expression*  
Est un [expression](../../t-sql/language-elements/expressions-transact-sql.md) du type **float** ou d’un type qui peut être implicitement converti en **float**.
  
## <a name="return-types"></a>Types de retour
**float**
  
## <a name="examples"></a>Exemples  
L’exemple suivant prend un **float** expression et renvoie l’arc tangente de l’angle spécifié.
...
L’exemple suivant prend un **float** expression et retourne l’arc tangente de l’angle spécifié.
