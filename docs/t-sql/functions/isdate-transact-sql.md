 ...
 *expression* Chaîne de caractères ou [expression](../../t-sql/language-elements/expressions-transact-sql.md) qui peut être convertie en une chaîne de caractères. L'expression doit comporter moins de 4 000 caractères. Les types de données de date et d'heure, sauf datetime et smalldatetime, ne sont pas autorisés comme argument pour ISDATE.
