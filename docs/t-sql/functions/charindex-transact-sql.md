...
description: Référence Transact-SQL pour la fonction CHARINDEX.
ms.date: 07/24/2017
ms.prod: sql
...
### <a name="a-returning-the-starting-position-of-an-expression"></a>R. Retour de la position de départ d'une expression  
