---
title: SYMKEYPROPERTY (Transact-SQL) | Documents Microsoft
ms.custom: 
ms.date: 03/06/2017
 ...
 *ID*  
 ID d'une clé symétrique dans la base de données. Pour rechercher l'ID d'une clé dont vous connaissez uniquement le nom, utilisez SYMKEY_ID. *Key_ID* est de type de données **int**.  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [ID &#40; Transact-SQL &#41;](../../t-sql/functions/key-id-transact-sql.md)   
