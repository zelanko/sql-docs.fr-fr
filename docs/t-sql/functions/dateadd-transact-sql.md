...
description: Référence Transact-SQL pour la fonction DATEADD. Cette fonction retourne une date qui a été modifiée par le datepart spécifié.
ms.date: 07/29/2017
ms.prod: sql
