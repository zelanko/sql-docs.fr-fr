---
title: SIN (Transact-SQL) | Documents Microsoft
ms.custom: 
ms.date: 03/03/2017
...
[!INCLUDE[tsql-appliesto-ss2008-all_md](../../includes/tsql-appliesto-ss2008-all-md.md)]
  ...
  Retourne le sinus trigonométrique de l’angle spécifié, en radians et un type numérique approximatif, **float**, expression.  
