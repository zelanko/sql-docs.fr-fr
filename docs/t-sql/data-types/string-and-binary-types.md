---
title: Types string et binary | Microsoft Docs
ms.custom: ''
ms.date: 07/23/2017
ms.prod: sql
...
ms.locfileid: "56014550"
---
# <a name="string-and-binary-types"></a>Types binaires et de chaîne
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]

[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] prend en charge les types binaires et de chaîne suivants.
