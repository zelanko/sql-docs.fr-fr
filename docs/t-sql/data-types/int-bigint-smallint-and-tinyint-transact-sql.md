...
Types de données représentant des valeurs numériques exactes qui utilisent des entiers. Pour économiser de l’espace dans la base de données, utilisez le plus petit type de données qui peut contenir fiable de toutes les valeurs possibles. Par exemple, tinyint serait suffisant pour une durée de vie des personnes, car aucun habite à plus de 255 ans. Mais tinyint ne serait pas suffisant pour une durée de vie des bâtiments, car une génération peut être plus de 255 ans.
