...
MODIFY (SERVICE_OBJECTIVE = \<service-objective>) Spécifie le niveau de performance. L’exemple suivant remplace l’objectif de service d’une base de données Premium par `P6` :
