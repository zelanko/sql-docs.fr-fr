...
Sur SQL Server, requiert l'autorisation `ALTER ANY EVENT SESSION`. Sur SQL Database, requiert l’autorisation `ALTER ANY DATABASE EVENT SESSION` dans la base de données.
