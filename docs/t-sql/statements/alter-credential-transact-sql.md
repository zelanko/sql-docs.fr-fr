...
> [!IMPORTANT]
> Les meilleures pratiques sont des pratiques recommandées ; d’autres sont obligatoires pour effectuer la tâche. ![Icône du lien de la rubrique](../../database-engine/configure-windows/media/topic-link.gif "Icône du lien de la rubrique")[Conventions syntaxiques Transact-SQL](../../t-sql/language-elements/transact-sql-syntax-conventions-transact-sql.md)  
