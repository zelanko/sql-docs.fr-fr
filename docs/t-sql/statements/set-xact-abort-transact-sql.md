---
title: SET XACT_ABORT (Transact-SQL) | Documents Microsoft
ms.custom: 
ms.date: 07/07/2016
...
> [!NOTE]  
>  Le **lever** instruction respecte **RAISERROR de XACT_ABORT défini** n’est pas. Nouvelles Applications doivent utiliser **lever** au lieu de **RAISERROR**.  
