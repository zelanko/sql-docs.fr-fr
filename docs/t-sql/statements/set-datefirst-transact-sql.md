---
title: SET DATEFIRST (Transact-SQL) | Documents Microsoft
ms.custom: 
ms.date: 03/14/2017
...
## <a name="remarks"></a>Notes  
 Pour afficher la valeur actuelle de SET DATEFIRST, utilisez le [@@DATEFIRST ](../../t-sql/functions/datefirst-transact-sql.md) (fonction).  
