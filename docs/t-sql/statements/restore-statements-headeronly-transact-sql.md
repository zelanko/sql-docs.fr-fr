...
|**BackupType**|**smallint**|Type de sauvegarde :<br /><br /> **1** = base de données<br /><br /> **2** = journal des transactions<br /><br /> **4** = fichier<br /><br /> **5** = base de données différentielle<br /><br /> **6** = fichier différentiel<br /><br /> **7** = partiel<br /><br /> **8** = partielle différentielle|  
