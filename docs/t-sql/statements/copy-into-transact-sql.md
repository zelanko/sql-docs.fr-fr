...
### <a name="f-load-using-msi-credentials"></a>F. Charger en utilisant des informations d’identification MSI
...
Les fichiers doivent avoir une taille d’au moins 4 Mo.
