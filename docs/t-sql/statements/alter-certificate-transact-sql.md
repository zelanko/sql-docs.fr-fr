---
title: ALTER CERTIFICATE (Transact-SQL) | Documents Microsoft
ms.custom: 
ms.date: 04/12/2017
...
### <a name="e-importing-a-private-key-for-a-certificate-that-is-already-present-in-the-database"></a>E. Importation d'une clé privée pour un certificat déjà présent dans la base de données  
