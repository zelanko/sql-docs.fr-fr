...
## [DATABASE, niveau de compatibilité](alter-database-transact-sql-compatibility-level.md)  
## [DATABASE, mise en miroir de bases de données](alter-database-transact-sql-database-mirroring.md)  
## [DATABASE ENCRYPTION KEY](alter-database-encryption-key-transact-sql.md)
## [DATABASE, options de fichiers et de groupes de fichiers](alter-database-transact-sql-file-and-filegroup-options.md)  
...
## [INDEX (index XML sélectifs)](alter-index-selective-xml-indexes.md)  
...
## [RESTORE, instructions](restore-statements-for-restoring-recovering-and-managing-backups-transact-sql.md)  
...
## [TABLE (graphe SQL)](create-table-sql-graph.md)  
## [TABLE AS SELECT (Azure SQL Data Warehouse)](create-table-as-select-azure-sql-data-warehouse.md)
## [TABLE IDENTITY, propriété](create-table-transact-sql-identity-property.md) 
...
## [XML INDEX (index XML sélectifs)](create-xml-index-selective-xml-indexes.md)  
## [XML SCHEMA COLLECTION](create-xml-schema-collection-transact-sql.md)  

# Classements
## [COLLATE, clause](collations.md)  
## [Nom du classement SQL Server](sql-server-collation-name-transact-sql.md)  
## [Nom du classement Windows](windows-collation-name-transact-sql.md)  
## [Priorité de classement](collation-precedence-transact-sql.md)  
...
## [INDEX (index XML sélectifs)](drop-index-selective-xml-indexes.md)  
...
# [INSERT (graphe SQL)](insert-sql-graph.md) 
...
## [DENY - Autorisations sur un assembly](deny-assembly-permissions-transact-sql.md)  
## [DENY - Autorisations sur une clé asymétrique](deny-asymmetric-key-permissions-transact-sql.md)  
## [DENY - Autorisations sur un groupe de disponibilité](deny-availability-group-permissions-transact-sql.md)  
## [DENY - Autorisations sur un certificat](deny-certificate-permissions-transact-sql.md)  
## [DENY - Autorisations sur une base de données](deny-database-permissions-transact-sql.md)  
## [DENY - Autorisations sur un principal de base de données](deny-database-principal-permissions-transact-sql.md)  
## [DENY - Informations d’identification incluses dans l’étendue de la base de données](deny-database-scoped-credential-transact-sql.md)  
## [DENY - Autorisations sur un point de terminaison](deny-endpoint-permissions-transact-sql.md)  
## [DENY - Autorisations sur un texte intégral](deny-full-text-permissions-transact-sql.md)  
## [DENY - Autorisations sur un objet](deny-object-permissions-transact-sql.md)  
## [DENY - Autorisations sur un schéma](deny-schema-permissions-transact-sql.md)  
## [DENY - Autorisations sur une liste de propriétés de recherche](deny-search-property-list-permissions-transact-sql.md)  
## [DENY - Autorisations sur un serveur](deny-server-permissions-transact-sql.md)  
## [DENY - Autorisations sur un principal de serveur](deny-server-principal-permissions-transact-sql.md)  
## [DENY - Autorisations sur Service Broker](deny-service-broker-permissions-transact-sql.md)  
## [DENY - Autorisations sur une clé symétrique](deny-symmetric-key-permissions-transact-sql.md)  
## [DENY - Autorisations sur un objet système](deny-system-object-permissions-transact-sql.md)  
## [DENY - Autorisations sur un type](deny-type-permissions-transact-sql.md)  
## [DENY - Autorisations sur une collection de schémas XML](deny-xml-schema-collection-permissions-transact-sql.md)  
## [EXECUTE AS](execute-as-transact-sql.md)  
## [EXECUTE AS Clause](execute-as-clause-transact-sql.md)  
## [GRANT](grant-transact-sql.md)  
## [GRANT - Autorisations sur un assembly](grant-assembly-permissions-transact-sql.md)  
## [GRANT - Autorisations sur une clé asymétrique](grant-asymmetric-key-permissions-transact-sql.md)  
## [GRANT - Autorisations sur un groupe de disponibilité](grant-availability-group-permissions-transact-sql.md)  
## [GRANT - Autorisations sur un certificat](grant-certificate-permissions-transact-sql.md)  
## [GRANT - Autorisations sur une base de données](grant-database-permissions-transact-sql.md)  
## [GRANT - Autorisations sur un principal de base de données](grant-database-principal-permissions-transact-sql.md)  
## [GRANT - Informations d’identification incluses dans l’étendue de la base de données](grant-database-scoped-credential-transact-sql.md)  
## [GRANT - Autorisations sur un point de terminaison](grant-endpoint-permissions-transact-sql.md)  
## [GRANT - Autorisations sur un texte intégral](grant-full-text-permissions-transact-sql.md)  
## [GRANT - Autorisations sur un objet](grant-object-permissions-transact-sql.md)  
## [GRANT - Autorisations sur un schéma](grant-schema-permissions-transact-sql.md)  
## [GRANT - Autorisations sur une liste de propriétés de recherche](grant-search-property-list-permissions-transact-sql.md)  
## [GRANT - Autorisations sur un serveur](grant-server-permissions-transact-sql.md)  
## [GRANT - Autorisations sur un principal de serveur](grant-server-principal-permissions-transact-sql.md)  
## [GRANT - Autorisations sur Service Broker](grant-service-broker-permissions-transact-sql.md)  
## [GRANT - Autorisations sur une clé symétrique](grant-symmetric-key-permissions-transact-sql.md)  
## [GRANT - Autorisations sur un objet système](grant-system-object-permissions-transact-sql.md)  
## [GRANT - Autorisations de type](grant-type-permissions-transact-sql.md)  
## [GRANT - Autorisations sur une collection de schémas XML](grant-xml-schema-collection-permissions-transact-sql.md)  
## [OPEN MASTER KEY](open-master-key-transact-sql.md)  
## [OPEN SYMMETRIC KEY](open-symmetric-key-transact-sql.md)  
## [Autorisations : GRANT, DENY, REVOKE (Azure SQL Data Warehouse, Parallel Data Warehouse)](permissions-grant-deny-revoke-azure-sql-data-warehouse-parallel-data-warehouse.md)  
## [REVERT](revert-transact-sql.md)  
## [REVOKE](revoke-transact-sql.md)  
## [REVOKE - Autorisations sur un assembly](revoke-assembly-permissions-transact-sql.md)  
## [REVOKE - Autorisations sur une clé asymétrique](revoke-asymmetric-key-permissions-transact-sql.md)  
## [REVOKE - Autorisations sur un groupe de disponibilité](revoke-availability-group-permissions-transact-sql.md)  
## [REVOKE - Autorisations sur un certificat](revoke-certificate-permissions-transact-sql.md)  
## [REVOKE - Autorisations sur une base de données](revoke-database-permissions-transact-sql.md)  
## [REVOKE - Autorisations sur un principal de base de données](revoke-database-principal-permissions-transact-sql.md)  
## [REVOKE - Informations d’identification incluses dans l’étendue de la base de données](revoke-database-scoped-credential-transact-sql.md)  
## [REVOKE - Autorisations sur un point de terminaison](revoke-endpoint-permissions-transact-sql.md)  
## [REVOKE - Autorisations sur un texte intégral](revoke-full-text-permissions-transact-sql.md)  
## [REVOKE - Autorisations sur un objet](revoke-object-permissions-transact-sql.md)  
## [REVOKE - Autorisations sur un schéma](revoke-schema-permissions-transact-sql.md)  
## [REVOKE - Autorisations sur une liste de propriétés de recherche](revoke-search-property-list-permissions-transact-sql.md)  
## [REVOKE - Autorisations sur un serveur](revoke-server-permissions-transact-sql.md)  
## [REVOKE - Autorisations sur un principal de serveur](revoke-server-principal-permissions-transact-sql.md)  
## [REVOKE - Autorisations sur Service Broker](revoke-service-broker-permissions-transact-sql.md)  
## [REVOKE - Autorisations sur une clé symétrique](revoke-symmetric-key-permissions-transact-sql.md)  
## [REVOKE - Autorisations sur un objet système](revoke-system-object-permissions-transact-sql.md)  
## [REVOKE - Autorisations sur un type](revoke-type-permissions-transact-sql.md)  
## [REVOKE - Autorisations sur une collection de schémas XML](revoke-xml-schema-collection-permissions-transact-sql.md)  
...
# SET 
## [Vue d’ensemble](set-statements-transact-sql.md)
