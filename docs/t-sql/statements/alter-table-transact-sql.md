...
HISTORY_RETENTION_PERIOD = { **INFINITE** | number {DAY | DAYS | WEEK | WEEKS | MONTH | MONTHS | YEAR | YEARS} } **S’applique à** : [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)].
