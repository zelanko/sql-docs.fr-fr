...
### <a name="f-create-an-ordered-clustered-columnstore-index"></a>F. Créer un index columnstore en cluster ordonné

Créer un index columnstore en cluster ordonné sur SHIPDATE.
