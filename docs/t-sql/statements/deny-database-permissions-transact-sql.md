---
title: "REFUSER des autorisations de base de données (Transact-SQL) | Documents Microsoft"
ms.custom: 
ms.date: 05/15/2017
...
|MODIFIER UNE STRATÉGIE DE SÉCURITÉ<br /> **S’applique aux**: [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] via [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)], [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)].|CONTROL|CONTROL SERVER|  
...
|AFFICHER UNE CLÉ DE CHIFFREMENT DE COLONNE|CONTROL|VIEW ANY DEFINITION|  
|AFFICHER UNE DÉFINITION DE CLÉ PRINCIPALE|CONTROL|VIEW ANY DEFINITION|  
...
### <a name="c-denying-view-definition-with-cascade"></a>C. Refus d'une autorisation VIEW DEFINITION avec l'option CASCADE  
 L’exemple suivant refuse `VIEW DEFINITION` l’autorisation sur le [!INCLUDE[ssSampleDBobject](../../includes/sssampledbobject-md.md)] base de données à utilisateur `CarmineEs` et à tous les principaux auxquels `CarmineEs` a accordé `VIEW DEFINITION` autorisation.  
