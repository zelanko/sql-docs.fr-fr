...
-   L’affectation de la valeur 0 à *value* empêche l’exécution de requêtes avec les opérations SORT et HASH MATCH dans les groupes de charges de travail définis par l’utilisateur.  
...
### <a name="1-shows-how-to-create-a-workload-group-named-newreports"></a>1. Montre comment créer un groupe de charges de travail appelé newReports    
