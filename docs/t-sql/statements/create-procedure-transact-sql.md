...
## <a name="metadata"></a>Métadonnées  
 Le tableau suivant répertorie les vues de catalogue et vues de gestion dynamique que vous pouvez utiliser pour retourner des informations sur les procédures stockées.  
