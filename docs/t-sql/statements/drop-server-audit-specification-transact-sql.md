---
title: DROP SERVER AUDIT SPECIFICATION (Transact-SQL) | Documents Microsoft
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx_md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  Supprime un objet de spécification d'audit de serveur à l'aide de la fonctionnalité [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Audit. Pour plus d’informations, consultez [SQL Server Audit &#40moteur de base de données&#41;](../../relational-databases/security/auditing/sql-server-audit-database-engine.md).  
...
## <a name="remarks"></a>Notes  
 DROP SERVER AUDIT SPECIFICATION supprime les métadonnées pour la spécification d'audit, mais pas les données d'audit collectées avant l'exécution de la commande DROP. Spécification d’audit pour le désactiver à l’aide de ALTER SERVER AUDIT SPECIFICATION avant qu’il peut être supprimé, vous devez définir l’état d’un serveur.  
