...
:::row:::
    ...
    :::column-end:::
    :::column:::
        [Instance managée<br />SQL Database](alter-database-transact-sql-file-and-filegroup-options.md?view=azuresqldb-mi-current)
    :::column-end:::
:::row-end:::
...
:::row:::
    ...
    :::column-end:::
    :::column:::
        **_\* Instance managée<br />SQL Database \*_**<br />&nbsp;
    :::column-end:::
:::row-end:::
