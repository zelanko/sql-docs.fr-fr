...
###  <a name="TableHints"></a> Substitution du comportement par défaut de l’optimiseur de requête à l’aide d’indicateurs  
...
Imaginez que vous devez mettre à jour cette table :  
