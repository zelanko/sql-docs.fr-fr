...
description: Référence Transact-SQL pour les opérateurs relationnels PIVOT et UNPIVOT. Utilisez ces opérateurs sur des instructions SELECT pour transformer une expression table en une autre table.
ms.date: 10/14/2019
ms.prod: sql
