---
description: STSymDifference (type de données geography)
...
### <a name="a-computing-the-symmetric-difference-of-two-polygons"></a>R. Calcul de la différence symétrique de deux polygones  
