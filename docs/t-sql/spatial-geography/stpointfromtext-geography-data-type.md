---
title: "STPointFromText (Type de données geography) | Documents Microsoft"
ms.custom: 
ms.date: 07/30/2017
 ...
 *point_tagged_text*  
 Est la représentation WKT de le **geographyPoint** instance à retourner. *point_tagged_text* est un **nvarchar (max)** expression.  
  
 *SRID*  
 Est un **int** expression représentant les données spatiales ID de référence (SRID) de la **geographyPoint** instance à retourner.  
