---
title: "Opérateurs arithmétiques (Transact-SQL) | Documents Microsoft"
ms.custom: 
ms.date: 07/06/2017
...
[!INCLUDE[tsql-appliesto-ss2008-all_md](../../includes/tsql-appliesto-ss2008-all-md.md)]
  ...
  Les opérateurs arithmétiques effectuent des opérations mathématiques sur deux expressions d'au moins un type de données de catégorie numérique. Pour plus d’informations sur les catégories de type de données, consultez [Conventions de syntaxe Transact-SQL](../../t-sql/language-elements/transact-sql-syntax-conventions-transact-sql.md).  
