# [Vue d’ensemble](language-elements-transact-sql.md)  
# [-- (Commentaire)](comment-transact-sql.md)  
# [Barre oblique étoile (Bloc de commentaire)](slash-star-comment-transact-sql.md)  
...
# [Barre oblique inverse (continuation de ligne)](sql-server-utilities-statements-backslash.md)  
...
# [Curseurs](cursors-transact-sql.md)  
...
# [Opérateurs](operators-transact-sql.md)  
## [Unaires, positifs](unary-operators-positive.md)  
## [Unaires, négatifs](unary-operators-negative.md)  
## [Set - EXCEPT et INTERSECT](set-operators-except-and-intersect-transact-sql.md)  
## [Set - UNION](set-operators-union-transact-sql.md)  
## [Arithmétiques](arithmetic-operators-transact-sql.md)  
### [+ (Addition)](add-transact-sql.md)  
### [+= (Affectation après addition)](add-equals-transact-sql.md)  
### [- (Soustraction)](subtract-transact-sql.md)  
### [-= (Affectation après soustraction)](subtract-equals-transact-sql.md)  
### [* (Multiplication)](multiply-transact-sql.md)  
### [*= (Affectation après multiplication)](multiply-equals-transact-sql.md)  
### [/ (Division)](divide-transact-sql.md)  
### [/ = (Affectation après division)](divide-equals-transact-sql.md)  
### [% (Reste)](modulo-transact-sql.md)  
### [%= (Affectation du reste)](modulo-equals-transact-sql.md)  
## [= (Affectation)](assignment-operator-transact-sql.md)  
## [Au niveau du bit](bitwise-operators-transact-sql.md)  
### [& (AND au niveau du bit)](bitwise-and-transact-sql.md)  
### [& = (Affectation après AND au niveau du bit)](bitwise-and-equals-transact-sql.md)  
### [| (OR au niveau du bit)](bitwise-or-transact-sql.md)  
### [| = (Affectation après OR au niveau du bit)](bitwise-or-equals-transact-sql.md)  
### [^ (OR exclusif au niveau du bit)](bitwise-exclusive-or-transact-sql.md)  
### [^= (Affectation après OR exclusif au niveau du bit)](bitwise-exclusive-or-equals-transact-sql.md)  
...
### [+ (Concaténation de chaînes)](string-concatenation-transact-sql.md)  
### [+= (Affectation après concaténation de chaînes)](string-concatenation-equal-transact-sql.md)  
### [% (Caractère générique, caractère(s) à inclure)](percent-character-wildcard-character-s-to-match-transact-sql.md)  
