...
### <a name="h-using-the---wildcard-characters"></a>H. Utilisation des caractères génériques [ ]  
 L’exemple suivant recherche `DimEmployee` lignes dont le prénom de `Rob` ou `Bob`.  
