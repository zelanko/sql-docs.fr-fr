---
title: "Chaîne des opérateurs (Transact-SQL) | Documents Microsoft"
ms.custom: 
ms.date: 03/14/2017
...
## <a name="section-heading"></a>Titre de section  
 ...
 [+= (Concaténation de chaînes)](../../t-sql/language-elements/string-concatenation-equal-transact-sql.md)  
