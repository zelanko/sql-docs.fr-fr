---
title: '&amp;= (Assignation AND au niveau du bit) (Transact-SQL) | Documents Microsoft'
ms.custom: 
ms.date: 01/10/2017
...
---
# <a name="amp-bitwise-and-assignment-transact-sql"></a>&amp;= (Assignation AND au niveau du bit) (Transact-SQL)
