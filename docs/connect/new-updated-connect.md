...
1. [Page d’accueil de la programmation avec Microsoft SQL Server du client](homepage-sql-connection-programming.md)
2. [Connectez-vous à l’aide de l’authentification Azure Active Directory](php/azure-active-directory.md)
3. [Résilience des connexions inactives](php/connection-resiliency.md)
4. [PHP Linux et Mac pilotes Installation didacticiel](php/installation-tutorial-linux-mac.md)
5. [Modules de connexion pour les bases de données Microsoft SQL](sql-connection-libraries.md)
