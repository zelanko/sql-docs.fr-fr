...
* **OLE DB** (y compris les services OLE DB Core, le fournisseur de OLE DB SQL Server, le fournisseur Oracle OLE DB, le fournisseur OLE DB pour les pilotes ODBC, le fournisseur de la forme de données et la fournisseur de données à distance)
