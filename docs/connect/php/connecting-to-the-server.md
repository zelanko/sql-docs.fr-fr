...
|[Procédure : Se connecter avec l’authentification Azure Active Directory](../../connect/php/azure-active-directory.md)|Explique comment définir le mode d’authentification et se connecter avec des identités Azure Active Directory.|  
