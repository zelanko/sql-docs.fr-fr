...
|Authentification|Une des chaînes suivantes :<br /><br />'SqlPassword'<br /><br />« ActiveDirectoryPassword »|Spécifie le mode d’authentification.|Non défini.|  
