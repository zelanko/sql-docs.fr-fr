---
title: 'Procédure : Exécuter des requêtes paramétrables'
description: Découvrez comment utiliser des requêtes paramétrables en quelques étapes à l’aide des pilotes pour PHP pour SQL Server.
ms.custom: ''
ms.date: 03/26/2018
ms.prod: sql
...
3.  Utilisez les variables PHP de l’étape 2 pour créer ou mettre à jour un tableau de valeurs de paramètre correspondant aux espaces réservés de paramètre dans la chaîne Transact-SQL. Les valeurs de paramètre du tableau doivent être dans le même ordre que les espaces réservés qui les représentent.
