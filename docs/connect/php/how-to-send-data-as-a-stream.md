---
title: 'Procédure : Envoyer des données sous forme de flux'
description: Découvrez comment utiliser des flux pour envoyer des objets volumineux à la base de données à l’aide des Pilotes Microsoft SQLSRV et PDO_SQLSRV pour PHP pour SQL Server.
ms.custom: ''
ms.date: 02/28/2019
ms.prod: sql
