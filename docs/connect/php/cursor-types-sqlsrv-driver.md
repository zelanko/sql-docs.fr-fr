---
title: Types de curseurs (pilote SQLSRV)
description: Découvrez comment utiliser des types de curseurs pour créer un jeu de résultats auquel vous pouvez accéder dans n’importe quel ordre à l’aide des Pilotes Microsoft pour PHP pour SQL Server.
ms.custom: ''
ms.date: 02/11/2019
ms.prod: sql
