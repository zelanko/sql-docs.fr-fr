---
title: sqlsrv_rollback | Documents Microsoft
ms.custom: ''
ms.date: 03/26/2018
ms.prod: sql
...
ms.locfileid: "35309468"
---
# <a name="sqlsrvrollback"></a>sqlsrv_rollback
[!INCLUDE[Driver_PHP_Download](../../includes/driver_php_download.md)]

Annule la transaction actuelle sur la connexion spécifiée et retourne la connexion au mode de validation automatique. La transaction actuelle comprend toutes les instructions sur la connexion spécifiée qui ont été exécutées après l’appel à [sqlsrv_begin_transaction](../../connect/php/sqlsrv-begin-transaction.md) et avant tous les appels à **sqlsrv_rollback** ou [sqlsrv_commit](../../connect/php/sqlsrv-commit.md).  
