---
title: 'Procédure : Envoyer et récupérer des données UTF-8 à l’aide de la prise en charge UTF-8 intégrée'
description: Découvrez comment envoyer et récupérer des données encodées en UTF-8 à l’aide du support UTF-8 intégré aux pilotes pour PHP.
ms.custom: ''
ms.date: 03/23/2018
ms.prod: sql
...
## <a name="connection-example"></a>Exemple de connexion  
...
Pour plus d’informations sur le stockage des données Unicode, voir [Utiliser des données Unicode](/previous-versions/sql/sql-server-2008-r2/ms175180(v=sql.105)).  
  
## <a name="column-example"></a>Exemple de colonne  
