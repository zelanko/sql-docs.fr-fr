---
title: Classe PDOStatement | Documents Microsoft
ms.custom: ''
ms.date: 03/26/2018
ms.prod: sql
...
ms.locfileid: "35308278"
---
# <a name="pdostatement-class"></a>Classe PDOStatement
[!INCLUDE[Driver_PHP_Download](../../includes/driver_php_download.md)]

La classe PDOStatement représente une instruction et les résultats de cette instruction.  
...
La classe PDOStatement contient les méthodes suivantes :  
