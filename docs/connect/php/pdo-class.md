...
ms.locfileid: "47784737"
---
# <a name="pdo-class"></a>Classe PDO
[!INCLUDE[Driver_PHP_Download](../../includes/driver_php_download.md)]

La classe PDO contient des méthodes qui permettent à votre application PHP de se connecter à une instance [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
