---
title: Resynchronisation des lignes (pilote OLE DB)
description: Pour mettre à jour les ensembles de lignes, OLE DB Driver pour SQL Server prend en charge IRowsetResynch sur les ensembles de lignes pris en charge par le curseur SQL Server uniquement.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
