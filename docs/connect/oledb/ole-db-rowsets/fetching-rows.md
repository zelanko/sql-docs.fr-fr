---
title: Récupérer (fetch) des lignes (pilote OLE DB) | Microsoft Docs
description: Découvrez comment les contrôles serveur consommateur OLE DB Driver pour SQL Server utilisent l’interface IRowset pour extraire des lignes, obtenir des données à partir de lignes et gérer des lignes.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
