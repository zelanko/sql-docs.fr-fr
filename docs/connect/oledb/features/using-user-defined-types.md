...
description: OLE DB Driver pour SQL Server prend en charge les types définis par l’utilisateur comme types binaires avec des informations de métadonnées, ce qui vous permet de les gérer en tant qu’objets.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
