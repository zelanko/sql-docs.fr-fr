...
description: Découvrez comment le support de plusieurs MARS (Multiple Active Result Set) simplifie la conception d’applications dans SQL Server pour l’OLTP en mémoire et OLE DB Driver.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
