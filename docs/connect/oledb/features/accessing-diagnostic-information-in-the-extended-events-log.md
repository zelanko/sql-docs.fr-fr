...
description: Suivi OLE DB pilote pour la SQL Server et l’accès aux informations de diagnostic dans le journal des événements étendus
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
...
## <a name="control-file"></a>Fichier de contrôle  
 Le contenu du pilote de OLE DB pour SQL Server fichier de contrôle (Ctrl. Guid) est:  
...
## <a name="mof-file"></a>Fichier MOF  
 Le contenu du pilote OLE DB pour SQL Server fichier MOF est le suivant:  
