...
description: OLE DB Driver pour SQL Server prend en charge les opérations de bases de données asynchrones, ce qui active des méthodes pour un retour sans blocage sur le thread appelant.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
