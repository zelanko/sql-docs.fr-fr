...
description: OLE DB Driver pour SQL Server prend en charge la gestion de l'expiration du mot de passe par programme via les boîtes de dialogue de connexion à OLE DB Driver et SQL Server.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
