...
description: OLE DB Driver pour SQL Server prend en charge le retour des informations de schéma d’un serveur lié lors du traitement de requêtes distribuées Transact-SQL.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
