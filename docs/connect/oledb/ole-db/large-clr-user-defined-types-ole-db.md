...
description: Découvrez les modifications apportées au pilote OLE DB pour SQL Server pour prendre en charge les types volumineux définis par l’utilisateur du Common Language Runtime.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
