...
description: Découvrez comment créer un objet d’ensemble de lignes spécialisé pour les paramètres table dans OLE DB Driver pour SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
