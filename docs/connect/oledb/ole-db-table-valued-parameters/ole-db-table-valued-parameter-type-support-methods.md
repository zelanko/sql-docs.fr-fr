...
description: En savoir plus sur les méthodes OLE DB standard qui prennent en charge les paramètres table dans OLE DB Driver pour SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
