...
description: En savoir plus sur la spécification des types de paramètres et la liaison de données de paramètres dans l’exécution d’une commande avec des paramètres table dans OLE DB Driver pour SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
