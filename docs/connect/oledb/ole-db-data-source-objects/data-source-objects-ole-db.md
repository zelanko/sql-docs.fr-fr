---
title: Objets source de données (pilote OLE DB) | Microsoft Docs
description: Découvrez comment un contrôle serveur consommateur OLE DB Driver pour SQL Server crée une instance d’objet de source de données pour un fournisseur.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
