---
title: Établir la connexion à la source de données (pilote OLE DB) | Microsoft Docs
description: Découvrez comment un contrôle serveur consommateur établit une connexion à une source de données à l’aide d’OLE DB Driver pour SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
