...
description: Découvrez comment un contrôle serveur consommateur dans OLE DB Driver pour SQL Server exécute une commande en créant d’abord une session, en obtenant un ensemble de lignes et en utilisant Exécuter.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
