...
description: Découvrez comment la méthode ISSCommandWithParameters::SetParameterProperties définit les propriétés de paramètre dans OLE DB Driver pour SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
