...
>  Le pilote OLE DB pour SQL Server prend en charge les opérations de copie en bloc en mémoire via l’interface [IRowsetFastLoad](../../oledb/ole-db-interfaces/irowsetfastload-ole-db.md).  
 ...
 Pour plus d’informations sur l’utilisation du pilote OLE DB pour SQL Server pour les opérations de copie en bloc, consultez [exécution d’opérations de copie en bloc](../../oledb/features/performing-bulk-copy-operations.md).  
  
 Pour obtenir un exemple illustrant l’utilisation de l’interface **IBCPSession** , consultez [IBCPSession: &#40;:&#41;BCPDone OLE DB](../../oledb/ole-db-interfaces/ibcpsession-bcpdone-ole-db.md).  
