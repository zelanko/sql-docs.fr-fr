...
description: Découvrez comment la méthode IBCPSession::BCPColFmt crée une liaison entre des variables de programme et des colonnes SQL Server dans OLE DB Driver pour SQL Server.
ms.custom: ''
ms.date: 05/25/2020
ms.prod: sql
