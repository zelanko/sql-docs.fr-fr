...
description: À l’aide de IBCPSession::BCPReadFmt pour la lecture des données à partir d’un fichier de format (OLE DB)
ms.custom: ''
ms.date: 03/26/2018
ms.prod: sql
