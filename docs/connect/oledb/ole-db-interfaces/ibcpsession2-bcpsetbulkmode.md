...
description: 'Utilisation de IBCPSession2:: BCPSetBulkMode pour créer une copie en bloc à partir d’une requête ou d’une table'
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
