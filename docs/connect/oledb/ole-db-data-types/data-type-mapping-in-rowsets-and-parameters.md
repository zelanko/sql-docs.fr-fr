...
description: Mappage des types de données dans les ensembles de lignes et de paramètres
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
|**XML**|DBTYPE_XML|  
 ...
 Le pilote OLE DB pour SQL Server prend en charge les conversions de données demandées par le consommateur comme indiqué dans l’illustration.  
