...
-   [Mappage des types de données dans les ensembles de lignes et de paramètres](../../oledb/ole-db-data-types/data-type-mapping-in-rowsets-and-parameters.md)  
  
-   [Mappage des types de données dans ITableDefinition](../../oledb/ole-db-data-types/data-type-mapping-in-itabledefinition.md)  
