---
title: Types de données (pilote OLE DB) | Microsoft Docs
...
-   [Mappage de types de données dans les ensembles de lignes et les paramètres](../../oledb/ole-db-data-types/data-type-mapping-in-rowsets-and-parameters.md)  
  
-   [Mappage de types de données dans ITableDefinition](../../oledb/ole-db-data-types/data-type-mapping-in-itabledefinition.md)  
