...
description: Découvrez comment supprimer une table SQL Server d’une base de données à l’aide de la fonction ITableDefinition::DropTable dans OLE DB Driver pour SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
