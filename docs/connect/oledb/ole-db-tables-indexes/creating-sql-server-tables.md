...
description: Création de tables SQL Server à l’aide de OLE DB Driver pour SQL Server
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
## <a name="dbcolumndesc-usage"></a>Utilisation de la structure DBCOLUMNDESC  
 ...
 Le pilote OLE DB pour SQL Server reconnaît un sous-ensemble de valeurs DBTYPE énumérées à OLE DB dans le *wType* membre. Pour plus d’informations, consultez [mappage de Type de données dans ITableDefinition](../../oledb/ole-db-data-types/data-type-mapping-in-itabledefinition.md).  
