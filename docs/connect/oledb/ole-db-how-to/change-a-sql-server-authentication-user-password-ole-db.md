...
description: Découvrez comment utiliser OLE DB pour modifier le mot de passe d'un compte d'utilisateur sous l’authentification SQL Server avec cet exemple.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
