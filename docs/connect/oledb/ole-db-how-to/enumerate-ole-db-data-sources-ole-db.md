---
title: Énumérer les sources de données de OLE DB (OLE DB) | Microsoft Docs
description: Énumérer les sources de données OLE DB à l’aide de l’énumérateur MSOLEDBSQL
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
