...
description: Découvrez comment utiliser IRowsetFastLoad pour diffuser en continu des données BLOB de longueur variable par ligne vers SQL Server. Cet exemple illustre également ISequentialStream.
ms.custom: ''
ms.date: 05/25/2020
ms.prod: sql
