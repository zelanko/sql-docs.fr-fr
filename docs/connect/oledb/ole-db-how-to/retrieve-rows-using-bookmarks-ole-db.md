---
title: Récupérer des lignes à l’aide de signets (pilote OLE DB)
description: Découvrez comment les contrôles serveur consommateur peuvent récupérer des lignes à l’aide de signets dans OLE DB Driver pour SQL Server avec cet exemple.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
