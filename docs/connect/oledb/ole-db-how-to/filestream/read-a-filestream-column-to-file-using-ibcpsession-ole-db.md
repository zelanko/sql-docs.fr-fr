...
description: Découvrez comment lire une colonne FILESTREAM dans un fichier à l’aide de l’interface IBCPSession dans OLE DB Driver pour SQL Server et écrire un fichier de format avec cet exemple.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
