...
description: Découvrez comment utiliser l’interface IRowsetFastUpload pour envoyer entre 4 Mo et 4 Go de données vers une colonne FILESTREAM dans OLE DB Driver pour SQL Server avec cet exemple.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
