...
description: Consultez comment exécuter une fonction définie par l’utilisateur et imprimer un code de retour avec OLE DB Driver pour SQL Server. Cet exemple utilise l’exemple de base de données AdventureWorks.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
