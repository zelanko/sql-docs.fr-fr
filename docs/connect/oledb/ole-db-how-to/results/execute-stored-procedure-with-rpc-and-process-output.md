...
description: Découvrez comment exécuter des procédures stockées SQL Server avec appel de procédure distante et traiter des codes de retour et des paramètres de sortie dans cet exemple.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
