...
description: Découvrez les améliorations apportées à la date et à l’heure OLE DB en rapport avec l’ensemble de lignes COLUMNS et l’ensemble de lignes PROCEDURE_PARAMETERS dans OLE DB Driver pour SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
