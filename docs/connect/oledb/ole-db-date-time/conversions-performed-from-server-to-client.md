...
description: Découvrez les conversions de date/heure effectuées entre SQL Server et une application cliente écrite avec OLE DB Driver pour SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
