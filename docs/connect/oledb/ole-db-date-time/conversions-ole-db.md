...
description: Découvrez comment OLE DB Driver pour SQL Server convertit les valeurs DateHeure et datetimeoffset. Il existe plusieurs règles de conversion générales.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
