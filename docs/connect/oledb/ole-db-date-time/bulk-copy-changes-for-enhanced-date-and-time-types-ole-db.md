...
[!INCLUDE[Driver_OLEDB_Download](../../../includes/driver_oledb_download.md)]
  ...
  Cet article décrit les améliorations de date/heure pour la prise en charge de la fonctionnalité de copie en bloc dans OLE DB Driver for SQL Server.  
...
|type de stockage de fichier|Type de données du fichier hôte|Tapez msoledbsql. h pour l’utiliser avec IBCPSession:: BCPColFmt|Valeur|  
|-----------------------|-------------------------|-----------------------------------------------------------|-----------|  
