...
3.  Accédez au répertoire `msodbcsql-11.0.2270.0`, où devrait se trouver un fichier nommé `build_dm.sh`install.sh. Vous pouvez exécuter `build_dm.sh` pour installer le Gestionnaire de pilotes unixODBC.
