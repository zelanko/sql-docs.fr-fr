...
description: Découvrez comment installer Microsoft ODBC Driver for SQL Server sur des clients Linux pour permettre la connectivité de base de données.
ms.date: 04/24/2020
ms.prod: sql
