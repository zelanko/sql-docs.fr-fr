...
### <a name="redhat-enterprise-server-and-oracle-linux"></a>RedHat Enterprise Server et Oracle Linux
```
sudo su
...
[Configuration requise](../../../connect/odbc/linux-mac/system-requirements.md)
