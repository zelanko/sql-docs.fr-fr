...
## <a name="register-to-redistribute-the-microsoft-jdbc-40-driver"></a>S’inscrire pour redistribuer le pilote Microsoft JDBC 4.0.  
 ...
 Remarque: Microsoft utilise compte Microsoft pour une authentification et une inscription sécurisées. Quand vous vous inscrivez pour les droits de redistribution du pilote JDBC pour SQL Server via un compte Microsoft, vous devez fournir des informations qui feront partie de votre profil sécurisé.  
  
 Si vous n’en avez pas déjà un, vous pouvez obtenir un [compte Microsoft](https://signup.live.com/)  
