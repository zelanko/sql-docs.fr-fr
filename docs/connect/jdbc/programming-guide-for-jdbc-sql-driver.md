---
title: Guide de programmation pour le pilote JDBC SQL | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "66794082"
---
# <a name="programming-guide-for-jdbc-sql-driver"></a>Guide de programmation pour le pilote JDBC SQL
[!INCLUDE[Driver_JDBC_Download](../../includes/driver_jdbc_download.md)]

* [Se connecter à SQL Server avec le pilote JDBC](../../connect/jdbc/connecting-to-sql-server-with-the-jdbc-driver.md)
...
* [Utilisation de la copie en bloc avec le pilote JDBC](../../connect/jdbc/using-bulk-copy-with-the-jdbc-driver.md)
* [Utilisation du chiffrement intégral avec le pilote JDBC](../../connect/jdbc/using-always-encrypted-with-the-jdbc-driver.md)
* [Utilisation de paramètres table](../../connect/jdbc/using-table-valued-parameters.md)
* [Fonctionnalités internationales du pilote JDBC](../../connect/jdbc/international-features-of-the-jdbc-driver.md)
