...
* [À l’aide de la copie en bloc avec le pilote JDBC](../../connect/jdbc/using-bulk-copy-with-the-jdbc-driver.md)
* [Utilisation du chiffrement intégral avec le pilote JDBC](../../connect/jdbc/using-always-encrypted-with-the-jdbc-driver.md)
* [À l’aide des paramètres table](../../connect/jdbc/using-table-valued-parameters.md)
