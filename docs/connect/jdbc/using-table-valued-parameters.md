...
| public SQLServerMetaData (columnName de chaîne, int sqlType)                                                                                                                        | Initialise une nouvelle instance de SQLServerMetaData en utilisant le nom de colonne et le type sql.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| public SQLServerMetaData (columnName de chaîne, int sqlType, précision de type int, int mise à l’échelle)                                                                                              | Initialise une nouvelle instance de SQLServerMetaData à l’aide du nom de colonne, le type sql, la précision et la mise à l’échelle.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| SQLServerMetaData public (SQLServerMetaData sqlServerMetaData)                                                                                                                    | Initialise une nouvelle instance de SQLServerMetaData à partir d’un autre objet SQLServerMetaData.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| public getColumName() de chaîne                                                                                                                                                     | Récupère le nom de colonne.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| int publique getSqlType()                                                                                                                                                          | Récupère le Type de code java sql.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| public useServerDefault() booléenne                                                                                                                                                | Wheher retourne la colonne utilise la valeur par défaut du serveur.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| Carte publique\<Integer, SQLServerDataColumn > getColumnMetadata() | Récupère les métadonnées de colonne de cette table de données.       |
...
| Nom                                                          | Description                                                                      |
| ---------------------------------------------------------- | -------------------------------------------------------------------------------- |
| public SQLServerDataColumn (columnName de chaîne, int sqlType) | Initialise une nouvelle instance de SQLServerDataColumn avec le type et le nom de colonne. |
...
| getRowData() de [] objet public ;                           | Récupère les données de la ligne active sous forme de tableau d’objets.                                          |
| next() booléenne publique ;                                  | Se déplace vers la ligne suivante. Retourne la valeur True si le déplacement a réussi et qu’une ligne suivante, false sinon. |
...
| Nom                                                                                                           | Description                                                                                                                                                                                                                                                                                                                      |
| ----------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| setStructured finale public void (paratemeterName de chaîne, chaîne tvpName, SQLServerDataTable tvpDataTable)    | Remplit un paramètre de table valued transmis à une procédure stockée avec une table de données. paratemeterName est le nom du paramètre, tvpName est le nom du type TVP et tvpDataTable est l’objet de table de données.                                                                                                                 |
| setStructured finale public void (paratemeterName de chaîne, chaîne tvpName, tvpResultSet du jeu de résultats)             | Remplit un paramètre de table valued transmis à une procédure stockée avec un jeu de résultats récupéré à partir d’une autre table. paratemeterName est le nom du paramètre, tvpName est le nom du type TVP et tvpResultSet est l’objet source de l’ensemble de résultats.                                                                              |
| setStructured finale public void (paratemeterName de chaîne, chaîne tvpName, ISQLServerDataRecord tvpDataRecord) | Remplit un paramètre de table valued transmis à une procédure stockée avec un objet ISQLServerDataRecord. ISQLServerDataRecord est utilisé pour la diffusion des données et l’utilisateur décide comment l’utiliser. paratemeterName est le nom du paramètre, tvpName est le nom du type TVP et tvpDataRecord est un objet ISQLServerDataRecord. |
