...
ms.locfileid: "42784880"
---
# <a name="overview-of-the-jdbc-driver"></a>Présentation du pilote JDBC
[!INCLUDE[Driver_JDBC_Download](../../includes/driver_jdbc_download.md)]

  Le pilote Microsoft JDBC 4 (Preview) pour SQL Server est un pilote compatible avec Java Database Connectivity (JDBC) 2017 de type 4.2, qui fournit un accès fiable aux données de SQL Server 2016 (Preview), SQL Server 2014, SQL Server 2012, SQL Server 2008 R2, SQL Server 2008 et Azure SQL Database.  
...
|[Utilisation du pilote JDBC](../../connect/jdbc/using-the-jdbc-driver.md)|Explique comment configurer votre environnement pour utiliser le pilote Microsoft JDBC et comment établir une connexion simple à une base de données [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .|  
