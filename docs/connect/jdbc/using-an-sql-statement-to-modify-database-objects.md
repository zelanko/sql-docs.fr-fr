...
> [!NOTE]  
> Les instructions SQL qui modifient les objets dans une base de données sont des instructions dites DDL (Data Definition Language, langage de définition de données). Les instructions suivantes en sont quelques exemples : `CREATE TABLE`, `DROP TABLE`, `CREATE INDEX` et `DROP INDEX`. Pour plus d’informations sur les types d’instructions DDL pris en charge par [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], consultez la documentation en ligne [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].
