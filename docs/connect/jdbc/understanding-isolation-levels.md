...
Pour utiliser le nouveau niveau d'isolement d'instantané de [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)], vous pouvez utiliser l'une des constantes `SQLServerConnection` :  
