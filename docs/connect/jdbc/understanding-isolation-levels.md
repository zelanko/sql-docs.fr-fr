...
```  
 ...
 Pour appliquer le nouveau niveau d’isolement de capture instantanée de [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)], vous pouvez utiliser l’une des constantes SQLServerConnection :  
