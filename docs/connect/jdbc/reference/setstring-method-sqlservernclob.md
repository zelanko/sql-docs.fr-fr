---
title: SetString, méthode (SQLServerNClob) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|----------|-----------------|  
|[setString, méthode &#40;long, java.lang.String, int, int&#41; &#40;SQLServerNClob&#41;](../../../connect/jdbc/reference/setstring-method-long-java-lang-string-sqlservernclob.md)|Écrit le texte spécifié **chaîne** à la **NCLOB** en commençant à la position spécifiée.|  
