---
title: Méthode supportsANSI92IntermediateSQL (SQLServerDatabaseMetaData) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Notes  
 Cette méthode supportsANSI92IntermediateSQL est spécifiée par la méthode supportsANSI92IntermediateSQL de l’interface java.sql.DatabaseMetaData.  
