---
title: Constructeur SQLServerResource () | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32846034"
---
# <a name="sqlserverresource-constructor-"></a>Constructeur SQLServerResource ()
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Initialise une nouvelle instance de la [SQLServerResource](../../../connect/jdbc/reference/sqlserverresource-class.md) classe. Ce constructeur est réservé à l'usage interne uniquement.  
...
## <a name="see-also"></a>Voir aussi  
 [Constructeurs SQLServerResource](../../../connect/jdbc/reference/sqlserverresource-constructors.md)   
