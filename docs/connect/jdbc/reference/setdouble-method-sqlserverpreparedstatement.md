---
title: setDouble, méthode (SQLServerPreparedStatement) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Notes  
 Cette méthode setDouble est spécifiée par la méthode setDouble de l’interface java.sql.PreparedStatement.  
