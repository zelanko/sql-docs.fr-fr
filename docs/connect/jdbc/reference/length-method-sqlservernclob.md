---
title: Méthode Length (SQLServerNClob) | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="return-value"></a>Valeur retournée  
 La longueur de la **NClob** en nombre de caractères.  
  
## <a name="exceptions"></a>Exceptions  
 [SQLServerException](../../../connect/jdbc/reference/sqlserverexception-class.md)  
  
## <a name="remarks"></a>Notes  
 Cette méthode de longueur est spécifiée par la méthode de longueur dans l’interface java.sql.NClob.  
