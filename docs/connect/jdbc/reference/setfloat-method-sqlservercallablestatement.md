---
title: Méthode setFloat (SQLServerCallableStatement) | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Notes  
 Cette méthode setFloat est spécifiée par la méthode setFloat dans l’interface java.sql.CallableStatement.  
