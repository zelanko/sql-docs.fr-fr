---
description: TRANSACTION_SNAPSHOT, champ (SQLServerConnection)
title: Champ TRANSACTION_SNAPSHOT (SQLServerConnection) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "88431461"
---
# <a name="transaction_snapshot-field-sqlserverconnection"></a>TRANSACTION_SNAPSHOT, champ (SQLServerConnection)
