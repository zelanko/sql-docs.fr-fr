---
title: Méthode setShort (SQLServerCallableStatement) | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Notes  
 Cette méthode setShort est spécifiée par la méthode setShort dans l’interface java.sql.CallableStatement.  
