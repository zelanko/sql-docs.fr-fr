---
title: Méthode (SQLServerConnection) prepareCall | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.openlocfilehash: bfba8426af84342a4ce132158a4f1f8bf5607ed1
...
|[prepareCall (java.lang.String, int, int)](../../../connect/jdbc/reference/preparecall-method-java-lang-string-int-int.md)|Crée un objet SQLServerCallableStatement qui génère [SQLServerResultSet](../../../connect/jdbc/reference/sqlserverresultset-class.md) objets avec le type donné et la concurrence.|  
