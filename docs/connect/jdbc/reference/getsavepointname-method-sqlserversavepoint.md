---
title: Méthode getSavepointName (SQLServerSavepoint) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Notes  
 Cette méthode getSavepointName est spécifiée par la méthode getSavepointName de l’interface java.sql.Savepoint.  
