---
description: Méthode updateNull (java.lang.String)
title: Méthode updateNull (java.lang.String) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "88478341"
---
# <a name="updatenull-method-javalangstring"></a>Méthode updateNull (java.lang.String)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Met à jour la colonne désignée avec une valeur Null en fonction du nom de colonne.  
