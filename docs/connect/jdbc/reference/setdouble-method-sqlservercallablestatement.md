---
title: Méthode setDouble (SQLServerCallableStatement) | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Notes  
 Cette méthode setDouble est spécifiée par la méthode setDouble dans l’interface java.sql.CallableStatement.  
