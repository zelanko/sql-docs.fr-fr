...
|Nom| Description|  
|----------|-----------------|  
|[updateSQLXML méthode &#40; type int, java.sql.SQLXML &#41;](../../../connect/jdbc/reference/updatesqlxml-method-int-java-sql-sqlxml.md)|Met à jour la colonne désignée avec une **SQLXML** valeur.|  
