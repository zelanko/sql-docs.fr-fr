---
description: Méthode removeConnectionEventListener (SQLServerPooledConnection)
title: Méthode removeConnectionEventListener (SQLServerPooledConnection) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Notes  
 Cette méthode removeConnectionEventListener est spécifiée par la méthode removeConnectionEventListener de l’interface javax.sql.PooledConnection.  
