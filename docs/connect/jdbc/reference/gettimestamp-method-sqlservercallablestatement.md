---
title: Méthode getTimestamp (SQLServerCallableStatement) | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|[getTimestamp (int, java.util.Calendar)](../../../connect/jdbc/reference/gettimestamp-method-int-java-util-calendar.md)|Récupère la valeur du paramètre désigné en tant qu’objet java.sql.Timestamp dans le langage en fonction de l’index de paramètre de programmation Java à l’aide d’un objet de calendrier.|  
...
|[getTimestamp (java.lang.String, java.util.Calendar)](../../../connect/jdbc/reference/gettimestamp-method-java-lang-string-java-util-calendar.md)|Récupère la valeur du paramètre désigné en tant qu’objet java.sql.Timestamp dans le langage en fonction du nom du paramètre, de programmation Java à l’aide d’un objet de calendrier.|  
