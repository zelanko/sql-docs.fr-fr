---
title: Méthode updateFloat (java.lang.String, float) | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32849444"
---
# <a name="updatefloat-method-javalangstring-float"></a>Méthode updateFloat (java.lang.String, float)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Met à jour la colonne désignée avec une **float** valeur en fonction du nom de colonne.  
