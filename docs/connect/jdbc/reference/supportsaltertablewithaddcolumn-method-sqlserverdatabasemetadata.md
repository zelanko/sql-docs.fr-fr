---
title: Méthode supportsAlterTableWithAddColumn | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Notes  
 Cette méthode supportsAlterTableWithAddColumn est spécifiée par la méthode supportsAlterTableWithAddColumn dans l’interface java.sql.DatabaseMetaData.  
