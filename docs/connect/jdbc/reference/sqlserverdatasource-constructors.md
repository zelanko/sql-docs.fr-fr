...
ms.locfileid: "67971444"
---
# <a name="sqlserverdatasource-constructors"></a>Constructeurs SQLServerDataSource
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Pour plus d’informations sur les constructeurs SQLServerDataSource, consultez [membres SQLServerDataSource](../../../connect/jdbc/reference/sqlserverdatasource-members.md).  
