---
title: Méthode getByte (int) | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32830204"
---
# <a name="getbyte-method-int"></a>Méthode getByte (int)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Récupère la valeur du paramètre désigné en tant qu’un **octets** valeur en fonction de l’index de paramètre.  
