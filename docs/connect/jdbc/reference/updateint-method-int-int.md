---
title: Méthode updateInt (int, int) | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32850834"
---
# <a name="updateint-method-int-int"></a>Méthode updateInt (int, int)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Met à jour la colonne désignée avec une **int** valeur en fonction de l’index de colonne.  
