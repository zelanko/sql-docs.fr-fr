...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  Pour plus d’informations sur les membres de ISQLServerConnection, consultez [membres SQLServerConnection](../../../connect/jdbc/reference/sqlserverconnection-members.md).  
