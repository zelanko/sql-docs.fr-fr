---
title: Méthode getConnection (SQLServerPooledConnection) | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32831724"
---
# <a name="getconnection-method-sqlserverpooledconnection"></a>Méthode getConnection (SQLServerPooledConnection)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Crée un handle d’objet pour la connexion physique que cela [SQLServerPooledConnection](../../../connect/jdbc/reference/sqlserverpooledconnection-class.md) objet représente.  
