---
title: isbeforefirst, méthode (SQLServerResultSet) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 **true** si le curseur se trouve avant la première ligne. **false** si le curseur se trouve à un emplacement quelconque ou si le jeu de résultats ne contient aucune ligne.  
