---
description: Méthode setDate Méthode setDate pour dater la valeur – chaîne
title: Méthode setDate pour dater la valeur – chaîne | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
