---
description: Méthode supportsBatchUpdates (SQLServerDatabaseMetaData)
...
## <a name="remarks"></a>Notes  
 Cette méthode supportsBatchUpdates est spécifiée par la méthode supportsBatchUpdates de l’interface java.sql.DatabaseMetaData.  
