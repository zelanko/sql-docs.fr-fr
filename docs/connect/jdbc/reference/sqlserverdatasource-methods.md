...
ms.locfileid: "66802787"
---
# <a name="sqlserverdatasource-methods"></a>Méthodes SQLServerDataSource
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Pour plus d’informations sur les membres de SQLServerDataSource, consultez [SQLServerDataSource, membres](../../../connect/jdbc/reference/sqlserverdatasource-members.md).  
