---
title: Méthode getDatabaseProductName (SQLServerDatabaseMetaData) | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="return-value"></a>Valeur retournée  
 A **chaîne** qui contient le nom de produit de base de données.  
