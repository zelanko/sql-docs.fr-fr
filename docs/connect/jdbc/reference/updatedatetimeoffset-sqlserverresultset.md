...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
 ...
 Met à jour la valeur de la colonne spécifiée selon un [classe DateTimeOffset](../../../connect/jdbc/reference/datetimeoffset-class.md) valeur.  
