---
title: Membres de SQLServerResource | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32846454"
---
# <a name="sqlserverresource-members"></a>Membres de SQLServerResource
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Les tableaux suivants répertorient les membres qui sont exposées par le [SQLServerResource](../../../connect/jdbc/reference/sqlserverresource-class.md) classe.  
  
## <a name="constructors"></a>Constructeurs  
  
|Nom| Description|  
|----------|-----------------|  
|[SQLServerResource ()](../../../connect/jdbc/reference/sqlserverresource-constructor.md)|Initialise une nouvelle instance de la [SQLServerResource](../../../connect/jdbc/reference/sqlserverresource-class.md) classe. Ce constructeur est réservé à un usage interne uniquement.|  
