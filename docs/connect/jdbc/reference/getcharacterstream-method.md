---
title: Méthode getCharacterStream () | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32831756"
---
# <a name="getcharacterstream-method-"></a>Méthode getCharacterStream ()
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Retourne le **CLOB** données comme un objet de lecteur ou en tant que flux de caractères.  
