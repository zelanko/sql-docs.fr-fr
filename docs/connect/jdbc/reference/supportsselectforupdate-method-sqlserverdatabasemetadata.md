---
title: Méthode supportsSelectForUpdate (SQLServerDatabaseMetaData) | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Notes  
 Cette méthode supportsSelectForUpdate est spécifiée par la méthode supportsSelectForUpdate dans l’interface java.sql.DatabaseMetaData.  
