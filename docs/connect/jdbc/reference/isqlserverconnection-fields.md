...
ms.locfileid: "67977507"
---
# <a name="isqlserverconnection-fields"></a>Champs ISQLServerConnection
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Pour plus d’informations sur les membres de SQLServerConnection, consultez [membres SQLServerConnection](../../../connect/jdbc/reference/sqlserverconnection-members.md).  
