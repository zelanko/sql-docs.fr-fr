---
title: Méthode supportsColumnAliasing (SQLServerDatabaseMetaData) | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Notes  
 Cette méthode supportsColumnAliasing est spécifiée par la méthode supportsColumnAliasing dans l’interface java.sql.DatabaseMetaData.  
