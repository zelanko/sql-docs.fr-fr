...
## <a name="remarks"></a>Notes  
 ...
 Pour obtenir un exemple de code, consultez [mise à jour](../../../connect/jdbc/updating-large-data-sample.md)d’un exemple de données volumineuses ou désencapsuler [ &#40;la méthode SQLServerCallableStatement&#41;](../../../connect/jdbc/reference/unwrap-method-sqlservercallablestatement.md).  
