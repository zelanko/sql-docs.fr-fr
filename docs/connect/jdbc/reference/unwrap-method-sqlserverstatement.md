...
## <a name="remarks"></a>Notes  
 ...
 Par exemple de code, consultez [mise à jour des exemples de données volumineux](../../../connect/jdbc/updating-large-data-sample.md), ou [méthode unwrap &#40;SQLServerCallableStatement&#41;](../../../connect/jdbc/reference/unwrap-method-sqlservercallablestatement.md).  
