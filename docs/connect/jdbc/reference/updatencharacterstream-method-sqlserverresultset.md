...
|Nom| Description|  
|----------|-----------------|  
|[updateNCharacterStream méthode &#40; type int, java.io.Reader &#41;](../../../connect/jdbc/reference/updatencharacterstream-method-int-java-io-reader.md)|Met à jour la colonne désignée avec une valeur de flux de caractères.|  
|[updateNCharacterStream méthode &#40; type int, java.io.Reader, long &#41;](../../../connect/jdbc/reference/updatencharacterstream-method-int-java-io-reader-long.md)|Met à jour la colonne désignée avec une valeur de flux de caractères, qui dispose du nombre spécifié d'octets.|  
