---
title: Méthode getMajorVersion (SQLServerDriver) | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32834794"
---
# <a name="getmajorversion-method-sqlserverdriver"></a>Méthode getMajorVersion (SQLServerDriver)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Retourne le numéro de version principale de la [!INCLUDE[jdbcNoVersion](../../../includes/jdbcnoversion_md.md)].  
...
## <a name="return-value"></a>Valeur retournée  
 Un **int** qui contient le numéro de version majeure du pilote JDBC.  
