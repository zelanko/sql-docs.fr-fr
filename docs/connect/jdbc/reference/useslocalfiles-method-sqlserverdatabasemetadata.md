---
title: Méthode usesLocalFiles (SQLServerDatabaseMetaData) | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 **true** si la base de données utilise les fichiers locaux. Dans le cas contraire, la valeur est **false**.  
