---
title: "Méthode getSchemas (SQLServerDatabaseMetaData) | Documents Microsoft"
ms.custom: 
ms.date: 01/19/2017
...
|Nom| Description|  
|----------|-----------------|  
|[Méthode getSchemas &#40; &#41;](../../../connect/jdbc/reference/getschemas-method.md)|Récupère les noms de schémas disponibles dans la base de données actuelle.|  
