---
title: Méthode getBoolean (java.lang.String) | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32832073"
---
# <a name="getboolean-method-javalangstring"></a>Méthode getBoolean (java.lang.String)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Récupère la valeur du paramètre désigné en tant qu’un **booléenne** étant donné le nom du paramètre de valeur.  
