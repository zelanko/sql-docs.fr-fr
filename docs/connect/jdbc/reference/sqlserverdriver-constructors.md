...
ms.locfileid: "67971206"
---
# <a name="sqlserverdriver-constructors"></a>Constructeurs SQLServerDriver
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Pour plus d’informations sur les membres de [SQLServerDriver](../../../connect/jdbc/reference/sqlserverdriver-class.md), consultez [membres SQLServerDriver](../../../connect/jdbc/reference/sqlserverdriver-members.md).  
