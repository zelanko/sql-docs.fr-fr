...
ms.locfileid: "66793991"
---
# <a name="setclob-method-sqlserverpreparedstatement"></a>Méthode setClob (SQLServerPreparedStatement)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Définit le paramètre désigné selon l’objet java.sql.Clob donné.  
  
## <a name="overload-list"></a>Liste de surcharge  
  
|Créer une vue d’abonnement|Description|  
|----------|-----------------|  
|[setClob, méthode &#40;int, java.io.Reader&#41;](../../../connect/jdbc/reference/setclob-method-int-java-io-reader.md)|Définit le paramètre désigné selon l’objet java.sql.Clob donné.|  
