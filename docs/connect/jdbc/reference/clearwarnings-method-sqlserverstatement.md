---
title: clearWarnings (méthode) (SQLServerStatement) | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32827314"
---
# <a name="clearwarnings-method-sqlserverstatement"></a>clearWarnings (méthode) (SQLServerStatement)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Efface tous les avertissements signalés sur cet [SQLServerStatement](../../../connect/jdbc/reference/sqlserverstatement-class.md) objet.  
