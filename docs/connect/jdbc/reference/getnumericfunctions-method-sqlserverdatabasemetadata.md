---
title: Méthode getNumericFunctions (SQLServerDatabaseMetaData) | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="return-value"></a>Valeur retournée  
 A **chaîne** qui contient les fonctions mathématiques disponibles.  
  
## <a name="exceptions"></a>Exceptions  
 [SQLServerException](../../../connect/jdbc/reference/sqlserverexception-class.md)  
  
## <a name="remarks"></a>Notes  
 Cette méthode getNumericFunctions est spécifiée par la méthode getNumericFunctions dans l’interface java.sql.DatabaseMetaData.  
