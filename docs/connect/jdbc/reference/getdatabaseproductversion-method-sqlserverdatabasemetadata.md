---
title: Méthode getDatabaseProductVersion (SQLServerDatabaseMetaData) | Documents Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="return-value"></a>Valeur retournée  
 A **chaîne** qui contient le numéro de version de produit de base de données.  
