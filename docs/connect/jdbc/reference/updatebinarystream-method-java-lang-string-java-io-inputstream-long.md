---
description: Méthode updateBinaryStream (java.lang.String, java.io.InputStream, long)
title: updateBinaryStream, méthode (java.io.InputStream, long) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
