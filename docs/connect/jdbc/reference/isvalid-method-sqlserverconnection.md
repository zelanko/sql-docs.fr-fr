 ...
 **Entier** qui spécifie le nombre de secondes d’attente pour la validation de la connexion.  
  
## <a name="return-value"></a>Valeur retournée  
 **true** si la connexion est valide; **false** si la connexion n’est pas valide ou si la validité de la connexion ne peut pas être déterminée avant l’expiration du délai d’attente.  
