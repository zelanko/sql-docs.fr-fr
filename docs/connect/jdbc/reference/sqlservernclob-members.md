...
|Nom| Description|  
|----------|-----------------|  
|[libérer](../../../connect/jdbc/reference/free-method-sqlservernclob.md)|Cette méthode libère le **NCLOB** de l’objet et libère les ressources qu’il détient.|  
...
|[longueur](../../../connect/jdbc/reference/length-method-sqlservernclob.md)|Récupère le nombre de caractères dans le **NCLOB** valeur indiquée par le **java.sql.NClob** objet.|  
...
|[tronquer](../../../connect/jdbc/reference/truncate-method-sqlservernclob.md)|Tronque le **NCLOB** valeur à la longueur spécifiée.|  
