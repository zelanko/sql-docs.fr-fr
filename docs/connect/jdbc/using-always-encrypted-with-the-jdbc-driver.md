...
Vous pouvez également obtenir ou définir ces paramètres à l’aide de l’objet SQLServerDataSource. Pour plus d’informations, consultez [Informations de référence sur l’API Always Encrypted pour le pilote JDBC](../../connect/jdbc/always-encrypted-api-reference-for-the-jdbc-driver.md).
...
Pour plus d’informations sur les méthodes SQLServerPreparedStatement et SQLServerCallableStatement surchargées avec le paramètre force encryption, consultez [Informations de référence sur l’API Always Encrypted pour le pilote JDBC](../../connect/jdbc/always-encrypted-api-reference-for-the-jdbc-driver.md)  
