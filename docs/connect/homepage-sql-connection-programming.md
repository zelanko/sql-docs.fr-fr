...
## <a name="entity-framework-logoimage-ref-333-ef-entity-framework-ef-with-cx23"></a>![Logo de Entity Framework][image-ref-333-ef] Entity Framework (EF) avec C & #x 23 ;
...
![Logo d’ODBC][image-ref-350-odbc]
