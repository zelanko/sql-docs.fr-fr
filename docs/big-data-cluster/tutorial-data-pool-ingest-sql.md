...
1. Utilisez un `INSERT INTO` instruction pour insérer les résultats de la requête dans le pool de données (le **web_clickstream_clicks_data_pool** table externe).
