...
* [Gérer les ressources pour un cluster Spark sur HDInsight](https://docs.microsoft.com/en-us/azure/hdinsight/spark/apache-spark-resource-manager)
* [Configurer les paramètres Spark](https://docs.microsoft.com/en-us/azure/hdinsight/spark/apache-spark-settings)
