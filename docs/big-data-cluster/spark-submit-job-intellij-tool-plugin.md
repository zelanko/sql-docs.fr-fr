...
ms.locfileid: "68470701"
---
# <a name="submit-spark-jobs-on-sql-server-big-data-clusters-in-intellij"></a>Envoyer des travaux Spark vers des clusters Big Data SQL Server dans IntelliJ

[!INCLUDE[tsql-appliesto-ssver15-xxxx-xxxx-xxx](../includes/tsql-appliesto-ssver15-xxxx-xxxx-xxx.md)]

L’un des principaux scénarios impliquant les clusters Big Data SQL Server est l’envoi de travaux Spark. La fonctionnalité d’envoi de travaux Spark vous permet d’envoyer un fichier jar ou py local avec des références aux clusters Big Data SQL Server. Elle vous permet également d’exécuter des fichiers jar ou py, qui se trouvent déjà sur le système de fichiers HDFS. 
...
2. Si vous utilisez un certificat autosigné, vous devez désactiver la validation des certificats SSL. Pour cela, accédez au menu **Tools**, sélectionnez **Azure**, **Validate Spark Cluster SSL Certificate** (Valider les certificats SSL des clusters Spark), puis **Disable**.

    ![Lier un cluster Big Data SQL Server - Désactiver SSL](./media/spark-submit-job-intellij-tool-plugin/link-ariscluster-disableSSL.png)
...
Pour plus d’informations sur les clusters Big Data SQL Server et les scénarios associés, consultez [Présentation des clusters Big Data SQL Server 2019](big-data-cluster-overview.md).
