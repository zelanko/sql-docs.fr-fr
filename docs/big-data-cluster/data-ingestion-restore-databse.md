...
description: Cet article explique comment restaurer une base de données sur l’instance principale d’un cluster de données volumineuses de SQL Server.
author: rothja
ms.author: jroth
manager: craigg
ms.date: 10/09/2018
...
> [!TIP]
> Vous pouvez télécharger la sauvegarde AdventureWorks [ici](https://www.microsoft.com/en-us/download/details.aspx?id=49502).
