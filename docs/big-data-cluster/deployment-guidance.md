...
| **DOCKER_EMAIL** | Oui | N/A | Adresse de messagerie associé au référentiel privé ci-dessus. Il est nécessaire pour la durée de la version préliminaire privée contrôlée. |
