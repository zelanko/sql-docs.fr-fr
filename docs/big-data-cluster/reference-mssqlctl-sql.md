---
title: Guide de référence sql mssqlctl
...
|     |     |
| --- | --- |
[interpréteur de commandes sql mssqlctl](#mssqlctl-sql-shell) | L’interface de base de données SQL CLI permet à l’utilisateur d’interagir avec SQL Server par le biais de T-SQL.
[requête sql de mssqlctl](#mssqlctl-sql-query) | La commande de requête autorise l’exécution d’une requête T-SQL.
## <a name="mssqlctl-sql-shell"></a>interpréteur de commandes sql mssqlctl
