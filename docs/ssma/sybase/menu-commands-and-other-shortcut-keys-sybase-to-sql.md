---
description: Commandes de menu et autres touches de raccourci (SybaseToSQL)
title: Commandes de menu et autres touches de raccourci (Sybase vers SQL) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
ms.reviewer: ''
...
Les sections suivantes décrivent les raccourcis clavier permettant d’accéder aux commandes de menu et autres touches de raccourci utilisées dans les différentes boîtes de dialogue de l’application SSMA pour Sybase.  
...
|Affichez la boîte de dialogue se connecter ou se reconnecter à Sybase.|ALT + F + T|  
...
|Actualisation à partir de la base de données Sybase.|ALT + T + R|  
...
|Accédez au sous-menu de gestion des sauvegardes Sybase.|ALT + S + B|  
|Affichez la boîte de dialogue Ajouter des tables à la sauvegarde pour Sybase.|ALT + S + B + B|  
|Affiche la boîte de dialogue restaurer les tables à partir de la sauvegarde pour Sybase.|ALT + S + B + R|  
|Affichez gérer le contenu de la sauvegarde pour la boîte de dialogue Sybase.|ALT + S + B + C|  
...
|POUR EFFECTUER CETTE OPÉRATION|COMPRESSION|  
|--------------|---------|  
|Affiche à propos de SSMA pour la boîte de dialogue Sybase.|ALT + H + A|  
...
[Touches de raccourci&#40;Sybase à SQL&#41;](../../ssma/sybase/shortcut-keys-sybase-to-sql.md)  
