...
1.  [Créez un projet SSMA](http://msdn.microsoft.com/11091d95-c488-48c3-891a-743cac94ac93).  
...
2.  [Se connecter au serveur de base de données SAP ASE](http://msdn.microsoft.com/a45a2330-9175-4c9e-af38-ef920e350614).  
  
3.  [Se connecter à une instance SQL Server](http://msdn.microsoft.com/dd368a1a-45b0-40e9-b4d3-5cdb48c26606) ou [se connecter à une instance de base de données SQL Azure](http://msdn.microsoft.com/9e77e4b0-40c0-455c-8431-ca5d43849aa7).  
...
5.  Si vous le souhaitez, [créer des rapports d’évaluation](http://msdn.microsoft.com/eb996b7c-1eef-4f73-b5e6-2fa6faf7336c) pour évaluer certains objets de base de données pour la conversion et estimer le temps de conversion.  
