...
Pour un affichage sous forme des options de ligne de commande de la Console SSMA, reportez-vous à [annexe - 1 &#40;SybaseToSQL&#41;](../../ssma/sybase/appendix-1-sybasetosql.md).  
