---
description: Prise en main avec la console SSMA pour Sybase (SybaseToSQL)
...
![Capture dՎcran montrant un exemple de sortie Sybase de la console SSMA.](../../ssma/sybase/media/ssmaconsoleoutput_sybase.JPG "SSMAConsoleOutput_Sybase")  
