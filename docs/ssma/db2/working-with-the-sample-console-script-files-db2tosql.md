---
description: Utilisation des exemples de fichiers de script de console (DB2ToSQL)
...
4.  **SqlStatementConversionSample.xml :** Cet exemple permet à l’utilisateur de générer le `t-sql` script correspondant pour la commande de base de données source `sql` fournie en entrée.  
