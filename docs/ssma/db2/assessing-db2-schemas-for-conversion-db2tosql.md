...
Lorsqu’il crée ce rapport d’évaluation, SSMA convertit les objets de base [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] de données DB2 sélectionnés en syntaxe, puis affiche les résultats.  
