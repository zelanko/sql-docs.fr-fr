...
|Terme|Définition|  
|--------|--------------|  
|**Migration de Dates non valides**|Spécifie comment migrer des dates non valides avec comme ' 2007-04-23' ou ' 2000-06-31 10:00:00 » dans les formats de DATE et DATETIME.<br /><br />**Par défaut en Mode**: valeur NULL<br /><br />**Mode optimiste**: valeur NULL<br /><br />**Mode plein**: valeur NULL|  
|**Valeurs de temps négatif Migration**|Spécifie comment migrer les valeurs négatives comme «-30:11:00 » dans les colonnes de temps.<br /><br />**Par défaut en Mode**: valeur NULL<br /><br />**Mode optimiste**: valeur NULL<br /><br />**Mode plein**: valeur NULL|  
|**Valeurs d’heure plus de 24 heures de Migration**|Spécifie la manière de migrer les valeurs de temps de plus de « 23 : 59:59 » dans les colonnes de temps.<br /><br />**Par défaut en Mode**: valeur NULL<br /><br />**Mode optimiste**: valeur NULL<br /><br />**Mode plein**: valeur NULL|  
...
|**Aucune Migration de Dates**|Spécifie comment migrer les dates de zéro comme « 0000-00-00' ou ' 0000-00-00 00:00:00 » dans les colonnes DATE et DATETIME.<br /><br />**Par défaut en Mode**: valeur NULL<br /><br />**Mode optimiste**: valeur NULL<br /><br />**Mode plein**: valeur NULL|  
|**Un zéro dans la Migration de Dates**|Spécifie comment migrer les dates avec zéro parties comme « 2009-01-00' ou ' 2000-00-00 11:00:00 » dans les colonnes DATE et DATETIME.<br /><br />**Par défaut en Mode**: valeur NULL<br /><br />**Mode optimiste**: valeur NULL<br /><br />**Mode plein**: valeur NULL|  
