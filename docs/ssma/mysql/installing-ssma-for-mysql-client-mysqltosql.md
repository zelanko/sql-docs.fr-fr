...
SSMA pour MySQL est conçu pour fonctionner avec MySQL 4.1 ou ultérieur et toutes les éditions de SQL Server 2005, SQL Server 2008, SQL Server 2012, SQL Server 2014, SQL Server 2016 et base de données SQL Azure.  
...
-   Accès et des autorisations suffisantes sur l’ordinateur qui héberge l’instance cible de SQL Server où vous migrerez des objets de base de données et les données. Pour plus d’informations, consultez [la connexion à SQL Server &#40; MySQLToSQL &#41;](../../ssma/mysql/connecting-to-sql-server-mysqltosql.md)  
