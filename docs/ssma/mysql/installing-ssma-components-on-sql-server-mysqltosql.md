...
1.  Copie SSMA pour MySQL extension Pack. *n*.Install.exe, où *n* est le numéro de build, à l’ordinateur qui exécute [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .  
  
2.  Double-cliquez sur SSMA pour MySQL extension Pack. *n*.Install.exe.  
...
11. Pour installer les utilitaires sur une autre instance de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] , sélectionnez **Oui**, puis cliquez sur **suivant**. Ou, pour quitter l’Assistant, cliquez sur **non**.  
