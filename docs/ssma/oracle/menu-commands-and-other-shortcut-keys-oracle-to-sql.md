---
title: Commandes de menu et autres touches de raccourci (Oracle To SQL) | Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
|Sous-menu de gestion des sauvegardes accès Oracle.|ALT + S + B|  
|Affichage ajouter des tables à la sauvegarde de la boîte de dialogue Oracle.|ALT + S + B + B|  
|Affichage des tables de restauration à partir de la sauvegarde de la boîte de dialogue Oracle.|ALT + S + B + R|  
...
[Touches de raccourci&#40;Oracle To SQL&#41;](../../ssma/oracle/shortcut-keys-oracle-to-sql.md)  
