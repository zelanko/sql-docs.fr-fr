...
Cette section contient des rubriques d' [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] aide pour Assistant Migration (SSMA) pour Oracle.  
...
|[Rapport d’évaluation &#40;OracleToSQL&#41;](../../ssma/oracle/assessment-report-oracletosql.md)|Utilisez le rapport d’évaluation pour afficher les résultats de la conversion d’objets Oracle [!INCLUDE[tsql](../../includes/tsql-md.md)] en syntaxe et pour estimer le temps et la complexité d’une migration [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]vers.|  
...
|[Se connecter à SQL Server &#40;OracleToSQL&#41;](../../ssma/oracle/connect-to-sql-server-oracletosql.md)|Utilisez la boîte de dialogue **se connecter au SQL Server** pour vous connecter à [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] l’instance de vers laquelle vous souhaitez effectuer la migration.|  
|[Rapport de migration des données &#40;OracleToSQL&#41;](../../ssma/oracle/data-migration-report-oracletosql.md)|Affiche les résultats de la migration des données d' [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Oracle vers.|  
...
|[Paramètres du projet &#40;&#41; &#40;de migration OracleToSQL&#41;](../../ssma/oracle/project-settings-migration-oracletosql.md)|Utilisez la page migration de la boîte de dialogue **paramètres du projet** pour personnaliser la façon dont SSMA pour Oracle migre [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]les données d’Oracle vers.|  
|[Paramètres du projet&#40;synchronisation&#41; &#40;OracleToSQL&#41;](../../ssma/oracle/project-settings-synchronization-oracletosql.md)|Utilisez la page synchronisation de la boîte de dialogue **paramètres du projet** pour personnaliser la façon dont SSMA pour Oracle crée ou modifie les objets [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]de base de données migrés dans.|  
