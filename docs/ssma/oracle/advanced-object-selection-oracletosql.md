---
title: Avancé de sélection d’un objet (OracleToSQL) | Documents Microsoft
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "34776825"
---
# <a name="advanced-object-selection--oracletosql"></a>Sélection d’objet avancé (OracleToSQL)
