---
title: La gestion des sauvegardes (OracleToSQL) | Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
Pour ouvrir la gestion de contenu de sauvegarde, dans le menu de testeur, pointez sur la gestion de la sauvegarde Oracle, puis cliquez sur contenu de sauvegarde... Vous y trouverez une arborescence contenant les tables dans la sauvegarde.  
