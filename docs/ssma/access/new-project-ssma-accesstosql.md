...
> [!IMPORTANT]  
> Un nouveau projet de type’SQL Azure’requiert, SQL Server Native Client (SNAC) version 10,5 ou ultérieure pour lier les tables d’accès à SQL Azure base de données.   
