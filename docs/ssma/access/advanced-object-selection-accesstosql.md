---
title: Avancé de sélection d’un objet (AccessToSQL) | Documents Microsoft
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "34773275"
---
# <a name="advanced-object-selection--accesstosql"></a>Sélection d’objet avancé (AccessToSQL)
