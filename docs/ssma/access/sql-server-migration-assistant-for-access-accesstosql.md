...
|[Prise en main de SQL Server Migration Assistant pour accéder au &#40; AccessToSQL &#41;](../../ssma/access/getting-started-with-sql-server-migration-assistant-for-access-accesstosql.md)|Introduit SSMA et son interface utilisateur.|  
...
|[Référence de l’Interface utilisateur](http://msdn.microsoft.com/en-us/af24c303-4a41-449b-9c86-d6558a97e839)|Contient la documentation pour les boîtes de dialogue SSMA.|  
|[Utilisation de SSMA pour Access Console](http://msdn.microsoft.com/en-us/ef94e843-9f88-45a2-86c4-a0af268738c4)|Contient la documentation sur l’application Console de SSMA|  
