---
description: Commandes de menu et autres touches de raccourci (AccessToSQL)
...
|Affichez la boîte de dialogue Assistant Migration.|ALT + F + W|  
|Ajoutez des bases de données.|ALT + F + A|  
|Supprimer la base de données.|ALT + F + R|  
|Affichez la boîte de dialogue Assistant recherche de bases de données.|ALT + F + F|  
...
|Affichez la boîte de dialogue Assistant recherche de bases de données.|ALT + T + F|  
|Affichez la boîte de dialogue Assistant Conversion, chargement et migration.|ALT + T + V|  
|Liez des tables ou liez une table.|ALT + T + L|  
...
|POUR EFFECTUER CETTE OPÉRATION|COMPRESSION|  
|--------------|---------|  
|Affiche à propos de SSMA pour accéder à la boîte de dialogue.|ALT + H + A|  
