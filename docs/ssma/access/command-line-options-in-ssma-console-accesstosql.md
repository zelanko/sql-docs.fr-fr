...
---
# <a name="command-line-options-in-ssma-console-accesstosql"></a>Options de ligne de commande dans la Console SSMA (AccessToSQL)
...
Vous ne pouvez pas entrer de toute autre option ou mot de passe en tant que le paramètre de ligne de commande. Dans le cas contraire, il génère une erreur. Pour plus d’informations, reportez-vous à la [la gestion des mots de passe](http://msdn.microsoft.com/en-us/b099d0f9-dd37-4c87-8b6f-ed0177881ea4) section.  
