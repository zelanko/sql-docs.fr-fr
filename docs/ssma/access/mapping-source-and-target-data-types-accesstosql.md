...
L’étape suivante du processus de migration est [convertir des objets de base de données d’accès aux objets SQL Server](http://msdn.microsoft.com/e0ef67bf-80a6-4e6c-a82d-5d46e0623c6c)  
