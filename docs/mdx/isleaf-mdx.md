...
## <a name="remarks"></a>Notes  
 La fonction **IsLeaf** retourne la **valeur true** si le membre spécifié est un membre feuille. Dans le cas contraire, la fonction retourne **false**.  
