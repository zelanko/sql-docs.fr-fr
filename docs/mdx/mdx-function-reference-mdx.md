...
|Fonction| Description|  
|--------------|-----------------|  
|[Ancestor &#40;MDX&#41;](../mdx/ancestor-mdx.md)|Retourne l'ancêtre d'un membre au niveau spécifié ou à la distance spécifiée.|  
...
|[Count &#40;Tuple&#41; &#40;MDX&#41;](../mdx/count-tuple-mdx.md)|Retourne le nombre de dimensions d'un tuple.|  
...
|[Rank &#40;MDX&#41;](../mdx/rank-mdx.md)|Retourne le rang de base un d'un tuple dans un jeu.|  
...
|[Order &#40;MDX&#41;](../mdx/order-mdx.md)|Organise les membres d'un jeu spécifié, en conservant ou non la hiérarchie.|  
...
|[Name &#40;MDX&#41;](../mdx/name-mdx.md)|Retourne le nom d'une dimension, d'une hiérarchie, d'un niveau ou d'un membre.|  
|[Propriétés & #40 ; MDX & #41 ;](../mdx/properties-mdx.md)|Retourne une chaîne ou une valeur fortement typée, contenant une valeur de propriété de membre.|  
...
|[UserName &#40;MDX&#41;](../mdx/username-mdx.md)|Retourne le nom de domaine et le nom d'utilisateur de la connexion en cours.|  
  
## <a name="subcube-functions"></a>Fonctions de sous-cube  
  
|Fonction| Description|  
|--------------|-----------------|  
|[Ce & #40 ; MDX & #41 ;](../mdx/this-mdx.md)|Retourne le sous-cube actuel.|  
...
|Fonction| Description|  
|--------------|-----------------|  
|[Error &#40;MDX&#41;](../mdx/error-mdx.md)|Génère une erreur, et fournit éventuellement un message d'erreur spécifié.|  
