...
|\<étiquette> ::=|Indique le nom d'un bloc de syntaxe. Cette convention est utilisée pour regrouper et étiqueter des parties de syntaxe longue ou une unité de syntaxe pouvant apparaître à plusieurs endroits au sein d'une instruction. Chaque emplacement dans lequel le bloc de syntaxe peut être utilisé est indiqué avec une étiquette encadrée de chevrons : \<étiquette >.|  
