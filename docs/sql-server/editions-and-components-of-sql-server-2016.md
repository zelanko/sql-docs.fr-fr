---
title: "Éditions et des fonctionnalités prises en charge de SQL Server | Documents Microsoft"
ms.custom:
- SQL2016_New_Updated
ms.date: 05/24/2017
...
---
# <a name="editions-and-supported-features-of-sql-server"></a>Éditions et des fonctionnalités prises en charge de SQL Server

[!INCLUDE[tsql-appliesto-ss2016-xxxx-xxxx-xxx_md](../includes/tsql-appliesto-ss2016-xxxx-xxxx-xxx-md.md)]

Cette rubrique fournit des détails sur les fonctionnalités prises en charge par les éditions de SQL Server.  À ce stade, il n’existe aucune modification aux fonctionnalités prises en charge par les éditions de SQL Server 2017.  
