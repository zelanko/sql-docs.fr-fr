...
helpviewer_keywords: 
  - "nouvelles fonctionnalités [SQL Server]"
  - "SQL Server, nouveautés"
  - "nouveautés de SQL Server 2008"
  - "nouveautés [SQL Server]"
 ...
 **Essayez SQL Server aujourd’hui !**    
 - Obtenez **gratuitement** [**SQL Server 2016 Developer Edition !**](https://www.microsoft.com/en-us/cloud-platform/sql-server-editions-developers)
...
## <a name="see-also"></a>Voir aussi    
 + [![Notes de publication](../analysis-services/instances/install-windows/media/ssrs-fyi-note.png)](../Topic/SQL%20Server%202016%20Release%20Notes.md) [Notes de publication de SQL Server 2016](../sql-server/sql-server-2016-release-notes.md). 
...
+ [Fonctionnalités prises en charge par les éditions de SQL Server](https://msdn.microsoft.com/library/cc645993.aspx)
 ...
 + [Installer SQL Server 2016 à partir de l’Assistant Installation](../database-engine/install-windows/install-sql-server-2016-from-the-installation-wizard-setup.md)
 [Installation et installation de maintenance](Setup%20and%20Servicing%20Installation.md)    