...
---
# Supprimer les objets serveur DQS
...
## Désinstaller le serveur Data Quality Services d'une instance de SQL Server  
...
## Désinstaller une instance de SQL Server contenant le serveur Data Quality Services  
