...
ms.topic: "article"
helpviewer_keywords: 
  - "Programme d'installation [SQL Server], logiciel"
  - "logiciel [SQL Server]"
  - "installation de SQL Server, logiciel"
  - "systèmes d'exploitation [SQL Server], configuration requise pour SQL Server"
  - "Programme d'installation [SQL Server], prise en charge multilingue"
  - "systèmes d'exploitation [SQL Server], prise en charge multilingue"
  - "connexions réseau [SQL Server], configuration requise"
  - "espace disque [SQL Server], installations SQL Server"
  - "WOW [SQL Server]"
  - "Programme d'installation [SQL Server], matériel"
  - "dépendances [SQL Server], installations SQL Server"
  - "configuration matérielle de clusters [SQL Server]"
  - "points de terminaison [SQL Server], installations SQL Server"
  - "Internet [SQL Server], installations SQL Server"
  - "matériel [SQL Server]"
  - "Windows on Windows [SQL Server]"
  - "installation de SQL Server, matériel"
  - "outil d'analyse de configuration du programme d'installation"
  - "SCC [SQL Server]"
  - "systèmes d'exploitation [SQL Server]"
  - "espace [SQL Server], installations SQL Server"
  - "outil d'analyse de configuration système"
  - "installation de SQL Server, prise en charge multilingue"
  - "Internet [SQL Server]"
  - "espace [SQL Server]"
  - "prise en charge des systèmes étendus [SQL Server]"
  - "édition 64 bits [SQL Server]"
  - "clustering de basculement [SQL Server]"
  - "clustering de basculement [SQL Server], configuration matérielle requise"
  - "édition 32 bits [SQL Server]"
  - "paramètres régionaux [SQL Server], installations SQL Server"
  - "prise en charge multilingue"
  - "espace disque [SQL Server]"
  - "versions localisées de SQL Server"
...
-    Lancez une machine virtuelle sur laquelle [**SQL Server 2016**](https://azure.microsoft.com/en-us/marketplace/partners/microsoft/sqlserver2016rtmenterprisewindowsserver2012r2/?wt.mc_id=sqL16_vm) est déjà installé.  
...
-   [Configuration matérielle et logicielle requise](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#hwswr)  
  
-   [Processeur, mémoire et système d’exploitation requis](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#pmosr)  
  
-   [Prise en charge de langues différentes](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#CrossLanguageSupport)  
  
-   [Espace disque nécessaire](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#HardDiskSpace)  
  
-   [Types de stockage pour les fichiers de données](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#StorageTypes)  
  
-   [Installation de SQL Server sur un contrôleur de domaine](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#DC_support)  
  
##  <a name="a-namehwswra-hardware-and-software-requirements"></a><a name="hwswr"></a> Configuration matérielle et logicielle requise  
...
|Disque dur|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] requiert un minimum de 6 GO d'espace disque disponible.<br/><br/> L'espace disque nécessaire varie selon les composants [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] que vous installez. Pour plus d’informations, consultez [Espace disque nécessaire](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#HardDiskSpace) plus loin dans cette rubrique. Pour plus d'informations sur les types de stockage pris en charge pour les fichiers de données, consultez [Storage Types for Data Files](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#StorageTypes).|  
...
##  <a name="a-namepmosra-processor-memory-and-operating-system-requirements"></a><a name="pmosr"></a> Processeur, mémoire et système d’exploitation requis  
...
-   [Principales éditions de SQL Server 2016](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#TOP_Principal)  
  
-   [Éditions transversales de SQL Server 2016](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#TOP_Breadth)  
...
###  <a name="a-nametopprincipala-principal-editions-of-includesscurrenttokensscurrentmdmd"></a><a name="TOP_Principal"></a> Principales éditions de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
...
###  <a name="a-nametopbreadtha-breadth-editions-of-includesscurrenttokensscurrentmdmd"></a><a name="TOP_Breadth"></a> Éditions transversales de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
...
##  <a name="a-namecrosslanguagesupporta-cross-language-support"></a><a name="CrossLanguageSupport"></a> Prise en charge de langues différentes  
...
##  <a name="a-nameharddiskspacea-hard-disk-space-requirements"></a><a name="HardDiskSpace"></a> Espace disque nécessaire  
...
|Complément [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] pour les produits SharePoint|325 Mo|  
...
##  <a name="a-namestoragetypesa-storage-types-for-data-files"></a><a name="StorageTypes"></a> Types de stockage pour les fichiers de données  
...
-   Partage de fichiers SMB  
    ...
    > [!NOTE]  
    >  Le stockage de fichiers SMB n'est pas pris en charge pour les fichiers de données d' [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] pour les installations autonomes ou en clusters. Utilisez le stockage attaché direct ou un réseau de stockage à la place.  
...
##  <a name="a-namedcsupporta-installing-includessnoversiontokenssnoversionmdmd-on-a-domain-controller"></a><a name="DC_support"></a> Installation de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] sur un contrôleur de domaine  
 Pour des raisons de sécurité, nous recommandons de ne pas installer [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] sur un contrôleur de domaine. Le programme d’installation de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ne bloquera pas l’installation sur un ordinateur qui est contrôleur de domaine, mais les limitations suivantes s’appliquent :  
