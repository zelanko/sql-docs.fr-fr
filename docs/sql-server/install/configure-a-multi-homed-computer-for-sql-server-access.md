...
ms.topic: "article"
helpviewer_keywords: 
  - "ports [SQL Server], ordinateur multirésident"
  - "ordinateur multirésident [SQL Server] configuration des ports"
  - "systèmes de pare-feu [moteur de base de données], ordinateur multirésident"
...
#### Pour déterminer les adresses IP et les ports utilisés par [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
2.  Dans le volet de la console du **[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Gestionnaire de configuration** , développez **[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Configuration du réseau** , développez **Protocoles pour \<nom d’instance>\>**, puis double-cliquez sur **TCP/IP**.  
