...
- Découvrez le nouvel exemple [Wide World Importers](../samples/wide-world-importers-what-is.md) disponible dans le dépôt GitHub [sql-server-samples](https://github.com/Microsoft/sql-server-samples) . 
...
|[Didacticiel sur SQL Server Machine Learning](../machine-learning/tutorials/r-tutorials.md)|Apprenez à exploiter des données [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] à l’aide de R ou Python. Exécutez des scripts R ou Python à partir de [!INCLUDE[tsql](../includes/tsql-md.md)].|  
 ...
 - [Didacticiels pour SQL Server 2012](/previous-versions/sql/sql-server-2012/hh231699(v=sql.110))  
  
 - [Didacticiels pour SQL Server 2008 R2](/previous-versions/sql/sql-server-2008-r2/ms167593(v=sql.105))   
