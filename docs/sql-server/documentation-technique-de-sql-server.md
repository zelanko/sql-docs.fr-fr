...
f1_keywords: 
  - "sql13.portal.f1"
helpviewer_keywords: 
  - "documentation [SQL Server], page d'accueil"
  - "aide [SQL Server]"
  - "SQL Server, documentation"
  - "page d'accueil [SQL Server]"
  - "Aide [SQL Server], page d'accueil de la documentation"
  - "Documentation en ligne [SQL Server], page d'accueil"
  - "page de portail [SQL Server]"
...
manager: "jhubbard"
---
# Documentation technique de SQL Server
...
- **[Lancer une machine virtuelle sur laquelle SQL Server 2016 est déjà installé](https://azure.microsoft.com/en-us/marketplace/partners/microsoft/sqlserver2016rtmenterprisewindowsserver2012r2/?wt.mc_id=sqL16_vm)**    
