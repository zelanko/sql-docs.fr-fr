...
- [Notes de publication de SQL Server 2014](../sql-server/sql-server-2014-release-notes.md)
- [Versions précédentes](https://docs.microsoft.com/en-us/previous-versions/sql/)
::: moniker-end

**Essayer SQL Server**
    + [![Télécharger à partir du Centre d’évaluation](../includes/media/download2.png)](http://go.microsoft.com/fwlink/?LinkID=829477) [Télécharger SQL Server](http://go.microsoft.com/fwlink/?LinkID=829477)
