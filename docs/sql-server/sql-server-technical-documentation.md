...
- [![Télécharger à partir du Centre d’évaluation](/sql-docs/docs/ssms/download-sql-server-management-studio-ssms) [Télécharger SQL Server Management Studio (SSMS)](/sql-docs/docs/ssms/download-sql-server-management-studio-ssms)   
