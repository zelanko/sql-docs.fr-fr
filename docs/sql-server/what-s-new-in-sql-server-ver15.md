...
|Nouvelle fonctionnalité ou mise à jour | Détails | |PolyBase | Les noms des colonnes de table externe sont désormais utilisés pour interroger les sources de données SQL Server, Oracle, Teradata, MongoDB et ODBC. | | &nbsp; | &nbsp; |
