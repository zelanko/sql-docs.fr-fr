...
helpviewer_keywords: 
  - "objets [SQL Server]"
  - "spécifications de capacité de nombre [SQL Server]"
  - "taille [SQL Server], spécifications de capacité"
  - "nombre d'objets"
  - "spécifications de capacité [SQL Server]"
  - "spécifications de capacité maximale [SQL Server]"
  - "taille [SQL Server]"
  - "spécifications de capacité de réplication [SQL Server]"
  - "objets [SQL Server], spécifications de capacité"
  - "Moteur de base de données [SQL Server], spécifications de capacité"
...
|Colonnes par clé étrangère||16||  
|Colonnes par clé primaire||16||  
...
|Références de table de clé étrangère par table||Sortantes = 253. Entrantes = 10 000.|Pour connaître les restrictions associées, consultez [Create Foreign Key Relationships](../relational-databases/tables/créer-les-relations-entre-les-clés-étrangères.md).|  
...
|Colonnes dans une table** (publication d’instantané ou transactionnelle [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)])||1000|  
