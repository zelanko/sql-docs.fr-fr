...
Pour plus d’informations, consultez [Nouveautés de SQL Server Analysis Services 2017](https://docs.microsoft.com/analysis-services/what-s-new-in-sql-server-analysis-services-2017).
