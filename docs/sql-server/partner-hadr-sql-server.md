...
description: Listes de partenaires tiers proposant des solutions de haute disponibilité et récupération d’urgence pour les services SQL Server.
ms.topic: conceptual
