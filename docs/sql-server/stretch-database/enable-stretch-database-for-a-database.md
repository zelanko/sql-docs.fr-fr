...
ms.topic: "article"
helpviewer_keywords: 
  - "Stretch Database, activation de la base de données"
  - "activation de la base de données pour Stretch Database"
