...
ms.topic: "article"
helpviewer_keywords: 
  - "Dépannage du clustering de basculement"
  - "clustering de basculement, dépannage"
  - "dépannage de cluster"
 ...
 **Erreur 2 :** les comptes de service [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] ne sont pas identiques sur tous les nœuds du cluster ou le nœud ne redémarre pas un service [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] qui a fait l’objet d’une migration depuis un nœud défaillant.  
