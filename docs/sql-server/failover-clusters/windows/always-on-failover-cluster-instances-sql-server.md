...
helpviewer_keywords: 
  ...
  - "haute disponibilité [SQL Server], clustering de basculement"
  - "serveurs virtuels [SQL Server], à propos des serveurs virtuels"
  - "clusters [SQL Server]"
  - "serveurs [SQL Server], clustering de basculement"
  - "groupes de ressources [SQL Server]"
  - "disponibilité [SQL Server]"
  - "clustering de basculement [SQL Server]"
  - "AlwaysOn [SQL Server], voir clustering de basculement [SQL Server]"
...
|------------------------|-----------|  
|Décrit le mécanisme de détection de pannes et la stratégie flexible de basculement.|[Stratégie de basculement pour les instances de cluster de basculement](../../../sql-server/failover-clusters/windows/failover-policy-for-failover-cluster-instances.md)|  
