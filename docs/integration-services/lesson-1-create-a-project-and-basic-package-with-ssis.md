...
-   [Étape 1 : Création d'un nouveau projet Integration Services](../integration-services/step-1-creating-a-new-integration-services-project.md)  
...
-   [Étape 5 : Ajout et configuration de la source de fichier plat](../integration-services/step-5-adding-and-configuring-the-flat-file-source.md)  
...
-   [Étape 7 : ajout et configuration de la destination OLE DB](../integration-services/step-7-adding-and-configuring-the-ole-db-destination.md)  
