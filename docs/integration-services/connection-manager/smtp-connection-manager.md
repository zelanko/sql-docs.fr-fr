...
ms.topic: "article"
helpviewer_keywords: 
  - "connexions [Integration Services], SMTP"
  - "Gestionnaire de connexions SMTP [Integration Services]"
  - "gestionnaires de connexions [Integration Services], SMTP"
...
## Configuration du gestionnaire de connexions SMTP  
