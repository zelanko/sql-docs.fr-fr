---
title: "Créer l’instruction SQL de Table (SQL Server Assistant Importation et exportation) | Documents Microsoft"
ms.custom: 
ms.date: 02/16/2017
...
Dans cet exemple, le champ **Instruction SQL** contient la valeur par défaut de l’instruction **CREATE TABLE** générée par l’Assistant. Cette instruction crée une nouvelle table de destination nommée **Person.AddressNew** qui est une copie de la **Person.Address** table source. 
  
 ![Page de l’Assistant Importation et exportation de la table de créer](../../integration-services/import-export-data/media/create-table.png "page de l’Assistant Importation et exportation de la table de création")  
...
Si vous modifiez la commande CREATE TABLE par défaut, vous devrez peut-être également apporter des modifications aux mappages de colonne associée lorsque vous revenez à la **mappages de colonnes** boîte de dialogue.  
 ...
 **Créer automatiquement**  
 Restauration de l’instruction SQL par défaut, si vous avez modifié, en cliquant sur **générer automatiquement**.  
