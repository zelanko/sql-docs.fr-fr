---
description: Se connecter à des sources de données à l’aide de l’Assistant Importation et Exportation SQL Server
title: Se connecter à des sources de données (Assistant Importation et Exportation SQL Server) | Microsoft Docs
ms.custom: ''
ms.date: 02/15/2017
ms.prod: sql
ms.reviewer: ''
...
## <a name="connect-to-a-commonly-used-data-source"></a>Se connecter à une source de données couramment utilisée
Cliquez sur un lien pour en savoir plus sur la connexion à l’une des sources de données couramment utilisées suivantes.
...
-   [y accéder](../../integration-services/import-export-data/connect-to-an-access-data-source-sql-server-import-and-export-wizard.md)
-   [Stockage Blob Azure](../../integration-services/import-export-data/connect-to-azure-blob-storage-sql-server-import-and-export-wizard.md)
