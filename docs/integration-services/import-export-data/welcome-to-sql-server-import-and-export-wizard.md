---
title: Bienvenue dans SQL Server Assistant Importation et exportation | Documents Microsoft
ms.custom: 
ms.date: 02/15/2017
...
Si vous souhaitez exécuter l’Assistant, mais vous n’avez pas [ ! INCLURE[msCoName](../../ssdt/download-sql-server-data-tools-ssdt.md).
...
**Ne plus afficher cette page de démarrage.**  
 Ignorer la page d’accueil la prochaine fois que vous exécutez l’Assistant.  
