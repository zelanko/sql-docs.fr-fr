...
-   [Étape 1 : Copie du package de la leçon 1](../integration-services/step-1-copying-the-lesson-1-package.md)  
  
-   [Étape 2 : ajout et configuration du conteneur de boucles Foreach](../integration-services/step-2-adding-and-configuring-the-foreach-loop-container.md)  
  
-   [Étape 3 : modification du gestionnaire de connexions de fichiers plats](../integration-services/step-3-modifying-the-flat-file-connection-manager.md)  
