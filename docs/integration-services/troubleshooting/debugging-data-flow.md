...
helpviewer_keywords: 
  ...
  - "flux de données [Integration Services], débogage"
  - "débogage [Integration Services], flux de données"
  - "comptage des lignes"
...
-   [Ajouter une visionneuse de données à un flux de données](../../integration-services/troubleshooting/add-a-data-viewer-to-a-data-flow.md)  
