...
ms.topic: "article"
helpviewer_keywords: 
  - "rapport de progression [Integration Services]"
  - "points d'arrêt [Integration Services]"
  - "débogage [Integration Services], flux de contrôle"
  - "flux de contrôle [Integration Services], débogage"
  - "rapport de progression à codage en couleurs [Integration Services]"
...
-   [Déboguer un package en définissant des points d'arrêt sur une tâche ou un conteneur](../../integration-services/troubleshooting/debug-a-package-by-setting-breakpoints-on-a-task-or-a-container.md)  
