---
title: "Configurations de package | Microsoft Docs"
ms.custom: ""
ms.date: "08/25/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "syntaxe de configuration de package [Integration Services]"
  - "packages SQL Server Integration Services, configurations"
  - "packages SSIS, configurations"
  - "XML [Integration Services]"
  - "packages Integration Services, configurations"
  - "syntaxe de configuration [Integration Services]"
  - "configurations indirectes [Integration Services]"
  - "configurations [Integration Services]"
  - "configurations directes [Integration Services]"
  - "packages [Integration Services], configurations"
...
-   Vous ne pouvez pas utiliser l’option **/ConfigFile** pour charger des configurations qui remplacent celles que vous aviez spécifiées au moment de la conception.  
 ...
 Pour plus d’informations sur ces options, ainsi que sur les différences de comportement de ces options entre [!INCLUDE[ssISCurrent](../../includes/ssiscurrent-md.md)] et les versions antérieures, consultez [Changements de comportement des fonctionnalités Integration Services dans SQL Server 2016](../Topic/Behavior%20Changes%20to%20Integration%20Services%20Features%20in%20SQL%20Server%202016.md).  
