...
-   Vidéo intitulée [Résolution des problèmes : exécution du package SSIS à l’aide de l’Agent SQL Server (vidéo de SQL Server)](https://go.microsoft.com/fwlink/?LinkId=141772), dans MSDN Library.  
...
-   Vidéo intitulée [Procédure : automatiser l’exécution du package SSIS à l’aide de l’Agent SQL Server (vidéo de SQL Server)](https://go.microsoft.com/fwlink/?LinkId=141771)dans MSDN Library  
