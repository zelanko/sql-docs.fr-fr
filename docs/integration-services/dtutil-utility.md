...
helpviewer_keywords: 
  ...
  - "packages [Integration Services], options de ligne de commande"
  - "invite de commandes [Integration Services]"
  - "packages SQL Server Integration Services, options de lignes de commande"
  - "copie des packages"
  - "vérification de l'existence [Integration Services]"
  - "packages Integration Services, options de ligne de commande"
  - "packages SSIS, options de ligne de commande"
  - "Suppression de packages"
  - "dtutil (utilitaire)"
  - "retrait de packages"
  - "changement de place des packages"
...
-   Ouvrez une fenêtre d’invite de commandes, accédez au répertoire contenant la version 64 bits de l’utilitaire (*(\<lecteur>*:\Program Files\Microsoft SQL Server\130\DTS\Binn), puis exécutez celui-ci à partir de cet emplacement.  
  
-   À l’invite de commandes, exécutez l’utilitaire en entrant le chemin complet (*\<lecteur>*:\Program Files\Microsoft SQL Server\130\DTS\Binn) à la version 64 bits de l’utilitaire.  
