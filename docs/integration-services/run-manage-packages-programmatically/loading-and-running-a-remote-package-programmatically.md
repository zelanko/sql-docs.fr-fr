...
-   Vidéo, [Procédure : automatiser l’exécution du package SSIS à l’aide de SQL Server Agent (vidéo de SQL Server)](/previous-versions/dn912438(v=msdn.10)), sur technet.microsoft.com  
