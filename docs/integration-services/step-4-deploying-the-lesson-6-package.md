...
manager: "jhubbard"
---
# &#201;tape 4 : D&#233;ploiement du package de la Le&#231;on 6
...
### Pour rechercher ou ajouter le catalogue SSISDB  
...
### Pour ajouter le package au catalogue SSISDB  
...
### Pour faire pointer le paramètre du package vers le nouvel exemple de données  
...
### Pour tester le déploiement du package de la leçon 6  
