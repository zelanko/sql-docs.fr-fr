---
title: "Mettre &#224; niveau des packages Integration Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Integration Services, migration"
  - "migration de packages [Integration Services]"
...
# Mettre &#224; niveau des packages Integration Services
 ...
 Pour plus d'informations sur les packages de mise à niveau lorsque vous convertissez un projet en modèle de déploiement de projet, consultez [Deploy Projects to Integration Services Server](../../integration-services/packages/deploy-projects-to-integration-services-server.md).  
...
|Utilisez la méthode <xref:Microsoft.SqlServer.Dts.Runtime.Application.Upgrade%2A> pour mettre à niveau un ou plusieurs packages [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)].|La mise à niveau de packages est permanente.|  
...
-   DTExecUI.exe.config  
 ...
 Pour utiliser [!INCLUDE[ssBIDevStudio](../../includes/ssbidevstudio-md.md)] pour la conception de packages incluant des composants personnalisés [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)], [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] ou [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)], vous devez modifier le fichier devenv.exe.config situé dans *\<lecteur>*:\Program Files\Microsoft Visual Studio 10.0\Common7\IDE.  
