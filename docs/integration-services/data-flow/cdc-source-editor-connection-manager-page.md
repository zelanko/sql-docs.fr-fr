...
-   **Net avec masque de mise à jour** : ce mode est semblable au mode Net standard, à ceci près qu’il ajoute des colonnes booléennes au modèle de nom **__$<nom_colonne>\__Changed** indiquant les colonnes modifiées dans la ligne de modification actuelle.  
