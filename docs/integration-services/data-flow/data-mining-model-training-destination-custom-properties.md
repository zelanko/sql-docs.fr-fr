---
title: "Apprentissage des propriétés personnalisées des destinations de modèle d’exploration de données | Documents Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
|--------------|---------------|-----------------|  
|ASConnectionId|Chaîne|Identificateur unique du gestionnaire de connexions.|  
