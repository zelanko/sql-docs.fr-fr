...
helpviewer_keywords: 
  ...
  - "packages Integration Services, performances"
  - "performances [Integration Services]"
  - "flux de données [Integration Services], résolution des problèmes"
  - "packages Integration Services SQL Server, performances"
  - "chargement de données"
  - "flux de contrôle [Integration Services], résolution des problèmes"
  - "packages SSIS, performances"
  - "packages [Integration Services], performances"
  - "requêtes [Integration Services], résolution des problèmes"
  - "tri des données [Integration Services]"
  - "agrégations [Integration Services]"
