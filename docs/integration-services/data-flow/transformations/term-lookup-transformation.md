---
description: transformation de recherche de terme
 ...
 **Configurer la sortie d’erreur**  
 Utilisez la boîte de dialogue [Configurer l’affichage des erreurs](../error-handling-in-data.md) pour spécifier les options de gestion des erreurs dans les lignes qui provoquent des erreurs.  
