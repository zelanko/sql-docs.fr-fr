---
title: "Transformation d&#39;extraction de terme | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "limites de mots [Integration Services]"
  - "extraction de données [Integration Services]"
  - "limites de phrases"
  - "extractions de mots [Integration Services]"
  - "Transformation d'extraction de terme"
  - "balisage des mots"
  - "données normalisées [Integration Services]"
  - "création de jetons de texte [Integration Services]"
  - "parties du discours [Integration Services]"
  - "extraction de texte [Integration Services]"
  - "extractions de termes [Integration Services]"
  - "identification de la racine des mots [Integration Services]"
...
-   [Éditeur de transformation d’extraction de terme &#40;onglet Avancé&#41;](../../../integration-services/data-flow/transformations/term-extraction-transformation-editor-advanced-tab.md)  
