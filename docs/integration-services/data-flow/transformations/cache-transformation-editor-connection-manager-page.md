---
title: "Éditeur de Transformation du cache (Page Gestionnaire de connexions) | Documents Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
# <a name="cache-transformation-editor-connection-manager-page"></a>Éditeur de transformation du cache (Page Gestionnaire de connexions)
 ...
 Pour en savoir plus sur la transformation de cache, consultez [Transformation du cache](../../../integration-services/data-flow/transformations/cache-transform.md).  
...
## <a name="see-also"></a>Voir aussi  
 [Éditeur de Transformation de cache &#40; Page mappages &#41;](../../../integration-services/data-flow/transformations/cache-transformation-editor-mappings-page.md)  
