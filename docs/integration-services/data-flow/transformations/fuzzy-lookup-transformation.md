---
title: "Transformation de recherche floue | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "délimiteurs de jetons [Integration Services]"
  - "index temporaires [Integration Services]"
  - "tables temporaires [Integration Services]"
  - "transformation de recherche floue"
  - "tables de références [Integration Services]"
  - "correspondance de données semblables [Integration Services]"
  - "remplacement de valeurs manquantes"
  - "correction de données [Integration Services]"
  - "cache [Integration Services]"
  - "standardisation de données [Integration Services]"
  - "recherches [Integration Services]"
  - "scores de confiance [Integration Services]"
  - "correspondances floues"
  - "remplacement de valeurs manquantes [Integration Services]"
  - "seuils de similarité [Integration Services]"
...
## Contrôle du comportement de la correspondance floue  
...
## Exécution de la transformation de recherche floue  
...
## Configuration de la transformation de recherche floue  
