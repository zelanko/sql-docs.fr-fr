---
title: "Transformation de dimension &#224; variation lente | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "transformation SCD"
  - "mise à jour de dimensions à variation lente"
...
## Sorties de la transformation de dimension à variation lente  
...
|------------|-----------------|----------------------------|  
|**Modification de la sortie des mises à jour des attributs**|L'enregistrement de la table de recherche est mis à jour. Cette sortie est utilisée pour les lignes à attributs variables.|Une transformation de commande OLE DB met à jour l'enregistrement à l'aide d'une instruction UPDATE.|  
...
## Optimisation des performances de la transformation de dimension à variation lente  
...
## Résolution des problèmes liés à la transformation de dimension à variation lente  
...
## Configuration de la transformation de dimension à variation lente  
...
## Configuration des sorties de la transformation de dimension à variation lente  
