---
title: "Transformation de regroupement probable | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "colonnes [Integration Services], standardisation"
  - "seuils de similarité [Integration Services]"
  - "nettoyage de données [Integration Services]"
  - "données en double [Integration Services]"
