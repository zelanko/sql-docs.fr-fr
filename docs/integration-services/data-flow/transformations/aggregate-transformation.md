---
title: "Transformation d&#39;agr&#233;gation | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "propriété IsBig"
  - "fonctions d'agrégation [Integration Services]"
  - "transformation d'agrégation [Integration Services]"
  - "données volumineuses, transformations SSIS"
...
|---------------|-----------------|  
|Group by|Divise les datasets en groupes. Les colonnes contenant tout type de données peuvent être utilisées pour le regroupement. Pour plus d’informations, consultez [GROUP BY &#40;Transact-SQL&#41;](../Topic/GROUP%20BY%20\(Transact-SQL\).md).|  
