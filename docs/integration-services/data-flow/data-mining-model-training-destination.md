...
helpviewer_keywords: 
  - "destinations [Integration Services], apprentissage du modèle d’exploration de données"
  - "Destination d’apprentissage du modèle d’exploration de données"
  - "modèles d’exploration de données [Analysis Services], apprentissage"
...
## Configuration de la destination d'apprentissage du modèle d'exploration de données  
