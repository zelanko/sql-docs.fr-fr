...
ms.topic: "article"
helpviewer_keywords: 
  - "composants [Integration Services], propriétés"
...
### Pour définir les propriétés d'un composant de flux de données à l'aide d'un éditeur de composant  
...
### Pour définir les propriétés d'un composant de flux de données à l'aide de la fenêtre Propriétés  
...
### Pour définir les propriétés d'un composant de flux de données à l'aide de l'éditeur avancé  
