...
helpviewer_keywords: 
  ...
  - "types de données [Integration Services], répertoriés"
  - "types de données [Integration Services]"
  - "types de données de colonnes [Integration Services]"
  - "SSIS, type de données"
  - "Integration Services, type de données"
  - "SQL Server Integration Services, type de données"
