---
title: "Créer un InfoPackage | Documents Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
# <a name="create-infopackage"></a>Créer un InfoPackage
 ...
 Vous pouvez ouvrir la boîte de dialogue **Créer un InfoPackage** depuis la page **Gestionnaire de connexions** de **l’Éditeur de destination SAP BW**. Pour en savoir plus sur la destination SAP BW, consultez [SAP BW Destination](../../integration-services/data-flow/sap-bw-destination.md).  
