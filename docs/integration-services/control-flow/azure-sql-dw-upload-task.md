---
title: "Entrepôt de données SQL Azure télécharger tâche | Documents Microsoft"
ms.custom: 
ms.date: 12/16/2016
...
Le **tâche de chargement d’entrepôt de données SQL Azure** est un composant de la [SQL Server Integration Services (SSIS) Feature Pack pour Azure](../../integration-services/azure-feature-pack-for-integration-services-ssis.md).
