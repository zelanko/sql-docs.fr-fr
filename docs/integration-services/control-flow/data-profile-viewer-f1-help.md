---
title: "Aide (F1) de visionneuse du profil des données | Documents Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Tâche de profilage et la visionneuse de données](../../integration-services/control-flow/data-profiling-task-and-viewer.md)  
