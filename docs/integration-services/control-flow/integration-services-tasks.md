...
helpviewer_keywords: 
  ...
  - "fichiers [Integration Services], options de tâche"
  - "tâches de flux de travail [Integration Services]"
  - "Integration Services, tâches"
  - "ajout de tâches de package"
  - "tâches [Integration Services], répertoriées"
  - "tâches SSIS"
  - "SSIS, tâches"
  - "flux de contrôle [Integration Services], tâches"
  - "tâches [Integration Services]"
  - "regroupement de tâches"
  - "tâches [Integration Services], à propos des tâches"
  - "tâches SQL Server Integration Services"
  - "tâches de préparation des données [Integration Services]"
  - "opérations sur les répertoires [Integration Services]"
...
## Configuration des tâches  
 ...
 Chaque tâche peut être configurée séparément à l’aide des boîtes de dialogue personnalisées du concepteur [!INCLUDE[ssIS](../../includes/ssis-md.md)] ou de la fenêtre Propriétés de [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]. Un package peut contenir plusieurs tâches du même type — par exemple, six tâches d'exécution SQL — et chaque tâche peut être configurée différemment. Pour plus d’informations, consultez [Définir les propriétés d’une tâche ou d’un conteneur](../Topic/Set%20the%20Properties%20of%20a%20Task%20or%20Container.md).  
