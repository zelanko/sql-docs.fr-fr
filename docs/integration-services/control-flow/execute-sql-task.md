---
title: "Tâche d’exécution SQL | Documents Microsoft"
ms.custom:
- ssisdev020617
ms.date: 03/13/2017
...
|SQLMOBILE|[Gestionnaire de connexions SQL Server Compact Edition](../../integration-services/connection-manager/sql-server-compact-edition-connection-manager.md)|  
...
## <a name="send-multiple-statements-in-a-batch"></a>Envoyer plusieurs instructions dans un lot  
...
## <a name="specify-a-result-set-type"></a>Spécifiez le que type de jeu de résultats  
...
## <a name="configure-the-execute-sql-task"></a>Configurer la tâche d’exécution SQL  
...
## <a name="general-page---execute-sql-task-editor"></a>Page Général - exécuter l’éditeur de tâche SQL
 ...
 **Connexion**  
 Choisissez la connexion dans la liste des gestionnaires de connexions définis. Pour créer une nouvelle connexion, sélectionnez \< **nouvelle connexion...** >.  
...
## <a name="parameter-mapping-page---execute-sql-task-editor"></a>Page de mappage de paramètre - exécuter l’éditeur de tâche SQL
 ...
 **Nom de la variable**  
 Après avoir ajouté un mappage de paramètre en cliquant sur **ajouter**, sélectionnez un système ou une variable définie par l’utilisateur dans la liste ou cliquez sur \< **nouvelle variable...** > pour ajouter une variable à l’aide de la **ajouter une Variable** boîte de dialogue.  
 ...
 **Nom du paramètre**  
 ...
 En fonction du type de gestionnaire de connexions que la tâche utilise, vous devez utiliser des nombres ou des noms de paramètres. Certains types de gestionnaires de connexion nécessitent que le premier caractère du nom du paramètre est le signe @, et les noms spécifiques tels que @Param1, ou les noms de colonnes comme noms de paramètres.  
...
## <a name="result-set-page---execute-sql-task-editor"></a>Page de jeu de résultats - exécuter l’éditeur de tâche SQL
 ...
 **Nom de la variable**  
 Mapper le jeu de résultats à une variable en sélectionnant une variable ou un clic \< **nouvelle variable...** > pour ajouter une variable à l’aide de la **ajouter une Variable** boîte de dialogue.  
...
-   [À l’aide de marqueurs et les noms de paramètres](#Parameter_names_and_markers)  
  
-   [Utilisation de paramètres avec les types de données date et heure](#Date_and_time_data_types)  
  
-   [À l’aide des paramètres dans les clauses WHERE](#WHERE_clauses)  
...
###  <a name="Parameter_names_and_markers"></a>Marqueurs et les noms de paramètres  
 Selon le type de connexion que la tâche d'exécution SQL utilise, la syntaxe de la commande SQL utilise différents marqueurs de paramètres. Par exemple, le [!INCLUDE[vstecado](../../includes/vstecado-md.md)] type de gestionnaire de connexions nécessite que la commande SQL utilise un marqueur de paramètre dans le format  **@varParameter** , tandis que le type de connexion OLE DB nécessite le marqueur de paramètre point d’interrogation ( ?).  
...
|[!INCLUDE[vstecado](../../includes/vstecado-md.md)]|@\<nom du paramètre >|@\<nom du paramètre >|Sélectionnez FirstName, LastName, titre de Person.Contact où ContactID =@parmContactID|  
|ODBC|?|1, 2, 3, …|SELECT FirstName, LastName, Title FROM Person.Contact WHERE ContactID = ?|  
|EXCEL et OLE DB|?|0, 1, 2, 3, …|SELECT FirstName, LastName, Title FROM Person.Contact WHERE ContactID = ?|  
  
#### <a name="use-parameters-with-adonet-and-ado-connection-managers"></a>Utiliser des paramètres avec les gestionnaires de connexions ADO et ADO.NET  
 [!INCLUDE[vstecado](../../includes/vstecado-md.md)]et les gestionnaires de connexions ADO ont des exigences spécifiques pour les commandes SQL qui utilisent des paramètres :  
  
-   [!INCLUDE[vstecado](../../includes/vstecado-md.md)]gestionnaires de connexions requièrent que la commande SQL utilise des noms de paramètre en tant que marqueurs de paramètre. Cela signifie que des variables peuvent être mappées directement à des paramètres. Par exemple, la variable `@varName` est mappée au paramètre nommé `@parName` et fournit une valeur au paramètre `@parName`.  
...
#### <a name="use-parameters-with-excel-odbc-and-ole-db-connection-managers"></a>Utiliser des paramètres avec les gestionnaires de connexions OLE DB, ODBC et EXCEL  
...
###  <a name="Date_and_time_data_types"></a>Utiliser des paramètres avec les types de données date et heure  
  
#### <a name="use-date-and-time-parameters-with-adonet-and-ado-connection-managers"></a>Utiliser les paramètres de date et heure avec les gestionnaires de connexions ADO et ADO.NET  
...
#### <a name="use-date-and-time-parameters-with-ole-db-connection-managers"></a>Utiliser les paramètres de date et d’heure avec les gestionnaires de connexions OLE DB  
...
#### <a name="use-date-and-time-parameters-with-odbc-connection-managers"></a>Utiliser les paramètres de date et d’heure avec les gestionnaires de connexions ODBC  
...
-   Le [!INCLUDE[vstecado](../../includes/vstecado-md.md)] type de connexion utilise les noms de paramètres @parmMinProductID et @parmMaxProductID.  
...
### <a name="map-query-parameters-to-variables"></a>Mapper des paramètres de requête à des variables
Cette section décrit comment utiliser une instruction SQL paramétrée dans la tâche d’exécution SQL et créer des mappages entre les variables et les paramètres dans l’instruction SQL.  
...
##  <a name="Return_codes"></a>Obtenir les valeurs des codes de retour  
...
-   [Remplissage d’une variable avec un jeu de résultats](#Populate_variable_with_result_set)  
  
###  <a name="Result_set_type"></a>Spécifiez le que type de jeu de résultats  
...
###  <a name="Populate_variable_with_result_set"></a>Remplir une variable avec un jeu de résultats  
...
## <a name="troubleshoot-the-execute-sql-task"></a>Résoudre les problèmes de la tâche d’exécution SQL  
