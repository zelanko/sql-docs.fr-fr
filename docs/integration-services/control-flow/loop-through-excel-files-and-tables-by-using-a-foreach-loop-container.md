...
3.  Ajoutez un conteneur de boucles Foreach à l’onglet **Flux de contrôle**. Pour plus d’informations sur la configuration du conteneur de boucles Foreach, consultez [Configurer un conteneur de boucles Foreach](../Topic/Configure%20a%20Foreach%20Loop%20Container.md).  
