...
ms.topic: "article"
helpviewer_keywords: 
  - "tâche de profilage des données [Integration Services], configuration"
...
## Tâche de profilage des données dans un package  
...
## Exécution du package qui contient la tâche de profilage des données  
