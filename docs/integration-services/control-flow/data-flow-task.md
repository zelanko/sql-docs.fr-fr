---
title: "t&#226;che de flux de donn&#233;es | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "tâche de flux de données [Integration Services]"
  - "performances [Integration Services]"
  - "flux de données [Integration Services], performances"
  - "flux de données [Integration Services], tâche de flux de données"
  - "Integration Services, performances"
