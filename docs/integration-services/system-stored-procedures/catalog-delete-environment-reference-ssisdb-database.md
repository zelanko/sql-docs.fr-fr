---
description: catalog.delete_environment_reference (base de données SSISDB)
...
ms.locfileid: "88456919"
---
# <a name="catalogdelete_environment_reference-ssisdb-database"></a>catalog.delete_environment_reference (base de données SSISDB)
