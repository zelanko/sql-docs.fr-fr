---
description: catalog.delete_environment_variable (base de données SSISDB)
...
ms.locfileid: "88456935"
---
# <a name="catalogdelete_environment_variable-ssisdb-database"></a>catalog.delete_environment_variable (base de données SSISDB)
