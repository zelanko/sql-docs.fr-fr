---
title: "Catalog.delete_environment (base de données SSISDB) | Documents Microsoft"
ms.custom: 
ms.date: 03/04/2017
...
## <a name="arguments"></a>Arguments  
 ...
 Le nom de l’environnement doit être supprimé. Le *environment_name* est **nvarchar (128)**.  
