...
-   [Étape 1 : Copie du package de la leçon 3](../integration-services/step-1-copying-the-lesson-3-package.md)  
  
-   [Étape 2 : Création d'un fichier corrompu](../integration-services/step-2-creating-a-corrupted-file.md)  
  
-   [Étape 3 : Ajout de redirection de flux d'erreurs](../integration-services/step-3-adding-error-flow-redirection.md)  
  
-   [Étape 4 : Ajout d'une destination de fichier plat](../integration-services/step-4-adding-a-flat-file-destination.md)  
