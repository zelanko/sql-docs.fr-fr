...
-   [Étape 1 : Copie de l'application de déploiement](../integration-services/step-1-copying-the-deployment-bundle.md)  
  
-   [Étape 2 : Exécution de l'Assistant Installation de package](../integration-services/step-2-running-the-package-installation-wizard.md)  
  
-   [Étape 3 : Test des packages déployés](../integration-services/step-3-testing-the-deployed-packages.md)  
