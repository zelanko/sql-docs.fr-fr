---
description: 'Procédure : gérer un service de capture de données modifiées à partir de la console du concepteur CDC'
...
4.  Vous pouvez effectuer les tâches suivantes pour un service de capture de données modifiées :  
    ...
    -   **Arrêter toutes les instances** (qui sont incluses dans le service de capture de données modifiées sélectionné)  
     ...
     Pour plus d'informations sur ces tâches, consultez [Manage a CDC Service](../../integration-services/change-data-capture/manage-a-cdc-service.md).  
