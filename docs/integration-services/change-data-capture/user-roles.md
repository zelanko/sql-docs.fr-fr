...
### Administrateur de l'ordinateur : service de capture de données modifiées Oracle  
...
### Administrateur de service de capture de données modifiées Oracle  
...
### Consommateur de modifications de capture de données modifiées Oracle  
...
### Utilisateur d'exploration de données de journaux  
