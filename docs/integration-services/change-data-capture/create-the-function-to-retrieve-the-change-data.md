...
ms.topic: "article"
helpviewer_keywords: 
  - "chargement incrémentiel [Integration Services], création de fonction"
...
---
# Cr&#233;er la fonction de r&#233;cup&#233;ration des donn&#233;es modifi&#233;es
...
## Considérations relatives à la conception de fonctions de capture de données modifiées  
...
-   **cdc.fn_cdc_get_net_changes_<capture_instance>** Pour cette requête, la ligne unique renvoyée pour chaque mise à jour contient l’état final de chaque ligne modifiée. Dans la plupart des cas, vous n'avez besoin que des données retournées par une requête des modifications nettes. Pour plus d’informations, consultez [cdc.fn_cdc_get_net_changes_&#60;capture_instance&#62; &#40;Transact-SQL&#41;](../Topic/cdc.fn_cdc_get_net_changes_%3Ccapture_instance%3E%20\(Transact-SQL\).md).  
  
-   **cdc.fn_cdc_get_all_changes_<capture_instance>** Cette requête renvoie toutes les modifications qui se sont produites dans chaque ligne au cours de l’intervalle de capture. Pour plus d’informations, consultez [cdc.fn_cdc_get_all_changes_&#60;capture_instance&#62;  &#40;Transact-SQL&#41;](../Topic/cdc.fn_cdc_get_all_changes_%3Ccapture_instance%3E%20%20\(Transact-SQL\).md).  
...
## Appel d'une procédure stockée pour créer la fonction table  
...
### Présentation et utilisation de la procédure stockée  
...
### Présentation et utilisation des scripts créés par la procédure stockée  
...
### Présentation et utilisation des fonctions créées par la procédure stockée  
...
-   Le filtre de lignes. Pour les fonctions wrapper et les fonctions de capture de données modifiées, le paramètre *@row_filter_option* est le même. Pour plus d’informations, consultez [cdc.fn_cdc_get_all_changes_&#60;capture_instance&#62;  &#40;Transact-SQL&#41;](../Topic/cdc.fn_cdc_get_all_changes_%3Ccapture_instance%3E%20%20\(Transact-SQL\).md) et [cdc.fn_cdc_get_net_changes_&#60;capture_instance&#62; &#40;Transact-SQL&#41;](../Topic/cdc.fn_cdc_get_net_changes_%3Ccapture_instance%3E%20\(Transact-SQL\).md).  
...
## Écriture de votre propre fonction table  
...
### Exemple d'une fonction table qui interroge les données modifiées  
...
### Récupération de métadonnées supplémentaires avec les données modifiées  
...
|**\<colonnes de table source capturées>**|variable|Les colonnes restantes retournées par la fonction sont les colonnes de la table source qui ont été identifiées comme colonnes capturées lorsque l'instance de capture a été créée. Si aucune colonne n'a été spécifiée à l'origine dans la liste des colonnes capturées, toutes les colonnes de la table source sont retournées.|  
 ...
 Pour plus d’informations, consultez [cdc.fn_cdc_get_net_changes_&#60;capture_instance&#62; &#40;Transact-SQL&#41;](../Topic/cdc.fn_cdc_get_net_changes_%3Ccapture_instance%3E%20\(Transact-SQL\).md).  
