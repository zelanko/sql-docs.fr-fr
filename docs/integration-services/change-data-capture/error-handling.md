...
### Gestion des erreurs de connexion Oracle à la source  
...
### Gestion des erreurs de connexion à l'instance SQL Server cible  
...
### Gestion des erreurs de stockage saturé sur l'instance SQL Server cible  
...
### Gestion des erreurs Oracle CDC  
