...
ms.topic: "article"
helpviewer_keywords: 
  - "identificateurs standard [Integration Services]"
  - "variables [Integration Services], expressions"
  - "identificateurs [Integration Services]"
  - "expressions [Integration Services], variables"
  - "identificateur de lignage"
  - "colonnes [Integration Services], identificateurs"
  - "noms [Integration Services]"
  - "expressions [Integration Services], identificateurs"
  - "identificateurs qualifiés [Integration Services]"
...
## Noms de variable uniques  
 ...
 Toutes les variables ont une portée et appartiennent à un espace de noms. Une variable a la portée d'un package ou celle d'un conteneur ou d'une tâche appartenant au package. Le générateur d'expressions du concepteur [!INCLUDE[ssIS](../../includes/ssis-md.md)] ne répertorie que les variables comprises dans la portée. Pour plus d’informations, consultez [Variables Integration Services &#40;SSIS&#41;](../../integration-services/integration-services-ssis-variables.md) et [Utiliser des variables dans des packages](../Topic/Use%20Variables%20in%20Packages.md).  
