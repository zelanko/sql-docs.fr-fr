...
ms.topic: "article"
helpviewer_keywords: 
  - "énumérateurs [Integration Services]"
  - "packages [Integration Services], expressions"
  - "propriétés dynamiques"
  - "mise à jour des propriétés de package"
  - "constantes énumérées [Integration Services]"
  - "expressions de propriété [Integration Services]"
...
---
# Constantes &#233;num&#233;r&#233;es dans des expressions de propri&#233;t&#233;
...
### Tâches du système de fichiers  
 Propriété **Opération** : définie à l’aide de valeurs provenant de l’énumération **DTSFileSystemOperation**.  
