...
helpviewer_keywords: 
  - "string literals"
  - "littéraux numériques [Integration Services]"
  - "littéraux booléens"
  - "expressions [Integration Services], littéraux"
  - "littéraux [Integration Services]"
  - "mappage de littéraux [Integration Services]"
