...
ms.topic: "article"
helpviewer_keywords: 
  - "expressions [Integration Services], types de données"
...
## Littéraux  
 Les expressions peuvent aussi comprendre des littéraux de chaîne, booléens et numériques. Pour plus d’informations sur la conversion des littéraux numériques vers des types de données [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] numériques, consultez [Littéraux &#40;SSIS&#41;](../../integration-services/expressions/literals-ssis.md).  
...
## Tâches associées  
 [Utiliser une expression dans un composant de flux de données](../Topic/Use%20an%20Expression%20in%20a%20Data%20Flow%20Component.md)  
