---
title: "Simulation d’une sortie d’erreur du composant de Script | Documents Microsoft"
ms.custom: 
ms.date: 03/17/2017
...
3.  Sur le **Script** , définissez le **ScriptLanguage** propriété avec le langage de script que vous souhaitez utiliser pour coder le script.  
...
11. Fermer le **éditeur de Transformation de Script.**  
  
12. Attachez les sorties du composant Script aux destinations appropriées. Les destinations de fichier plat sont les plus faciles à configurer pour le test ad hoc.  
