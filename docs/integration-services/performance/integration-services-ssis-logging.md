...
helpviewer_keywords: 
  ...
  - "fournisseurs de journaux d'événements Windows [Integration Services]"
  - "fournisseurs de journaux de fichiers XML [Integration Services]"
  - "SQL Server Profiler, fournisseur de journaux"
  - "packages SQL Server Integration Services, journaux"
  - "packages SSIS, journaux"
  - "tâches [Integration Services], journaux"
  - "journaux [Integration Services], fournisseurs de journaux"
  - "packages Integration Services, journaux"
  - "modules fournisseurs d'informations [Integration Services]"
  - "packages [Integration Services], journaux"
  - "fournisseurs de journaux de fichiers texte"
  - "fournisseur de journaux SQL Server"
...
# Journalisation d&#39;Integration Services (SSIS)
 ...
 Vous pouvez configurer l'étendue des informations enregistrées lors d'une exécution de package sur le serveur [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] . Pour plus d’informations, consultez [Enable Logging for Package Execution on the SSIS Server](../../integration-services/performance/enable-logging-for-package-execution-on-the-ssis-server.md).  
...
#### Capturez les noms des colonnes dans lesquelles des erreurs se produisent  
 Lorsque vous configurez une sortie d’erreur dans le flux de données, par défaut, la sortie d’erreur fournit uniquement l’identificateur numérique de la colonne dans laquelle l’erreur s’est produite. Pour plus d’informations, consultez [Error Handling in Data](../../integration-services/data-flow/error-handling-in-data.md).  
...
-   [Boîte de dialogue Configurer les journaux SSIS](../../integration-services/performance/configure-ssis-logs-dialog-box.md)  
...
-   [Activer la journalisation des exécutions de package sur le serveur SSIS](../../integration-services/performance/enable-logging-for-package-execution-on-the-ssis-server.md)  
