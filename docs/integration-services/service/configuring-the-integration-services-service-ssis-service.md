...
>  Cette rubrique présente le service [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] , un service Windows qui permet de gérer les packages [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] . [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] prend en charge le service pour la compatibilité avec les versions antérieures de [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]. À compter de [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)], vous pouvez gérer des objets tels que des packages sur le serveur Integration Services.  
 ...
 Le service [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] dépend d'un fichier de configuration pour ses paramètres. Par défaut, le fichier de configuration se nomme MsDtsSrvr.ini.xml et se trouve dans le dossier %ProgramFiles%\Microsoft SQL Server\110\DTS\Binn.  
...
-   Dans le système de fichiers géré par le service [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)], les packages se trouvent à l'emplacement %ProgramFiles%\Microsoft SQL Server\110\DTS\Packages.  
...
## Modification de l'emplacement du fichier de configuration  
 La clé de Registre HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Microsoft SQL Server\110\SSIS\ServiceConfigFile spécifie l’emplacement et le nom du fichier de configuration utilisé par le service [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]. La valeur par défaut de la clé de Registre est C:\Program Files\Microsoft SQL Server\110\DTS\Binn\MsDtsSrvr.ini.xml. Vous pouvez mettre à jour la valeur de la clé de Registre pour utiliser un nom et un emplacement différents pour le fichier de configuration.  
