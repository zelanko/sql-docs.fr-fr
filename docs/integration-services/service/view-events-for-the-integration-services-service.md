...
---
# afficher les &#233;v&#233;nements du service Integration Services
...
### Pour afficher les événements du service Integration Services dans SQL Server Management Studio  
...
### Pour afficher les événements du service Integration Services dans l'Observateur d'événements Windows  
...
## Voir aussi  
 [Gérer le service Integration Services](../../integration-services/service/manage-the-integration-services-service.md)   
 [Ajouter un journal pour les compteurs de performances de flux de données](../../integration-services/performance/add-a-log-for-data-flow-performance-counters.md)  
