...
ms.topic: "article"
helpviewer_keywords: 
  - "service [Integration Services], instance distante"
  - "service Integration Services, connexion"
  - "service Integration Services, instance distante"
  - "service [Integration Services], connexion"
...
---
# Se connecter &#224; un serveur Integration&#160;Services distant (Service SSIS)
...
## Par défaut, le service SSIS ne prend pas en charge la délégation  
...
## Voir aussi  
 [Configurer un Pare-feu Windows pour l'accès au service SSIS](../../integration-services/service/configure-a-windows-firewall-for-access-to-the-ssis-service.md)  
