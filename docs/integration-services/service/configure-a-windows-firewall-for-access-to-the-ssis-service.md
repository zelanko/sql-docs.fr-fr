...
ms.topic: "article"
helpviewer_keywords: 
  - "sécurité [Integration Services], pare-feu"
  - "Pare-feu Windows [Integration Services]"
  - "accès non autorisé [Integration Services]"
  - "service Integration Services, pare-feu"
  - "systèmes pare-feu [Integration Services]"
  - "SQL Server Integration Services (SSIS), pare-feu"
  - "SSIS, pare-feu"
