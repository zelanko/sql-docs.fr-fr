...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server Integration Services (packages), gestion"
  - "packages [Integration Services], gestion"
  - "Integration Services (packages), gestion"
  - "stockage de packages"
  - "dossier Packages stockés"
  - "packages actuels"
  - "dossier Exécution des packages"
  - "informations d'état [Integration Services]"
  - "SSIS (packages), gestion"
  - "stockage [Integration Services]"
  - "surveillance [Integration Services], packages"
  - "Integration Services (service), gestion des packages"
  - "services [Integration Services], gestion des packages"
...
## Magasin de packages  
 ...
 Pour visualiser la liste des packages stockés dans le magasin de packages, vous devez ouvrir [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] et vous connecter à [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]. Pour plus d’informations, consultez [Afficher les packages Integration Services dans SQL Server Management Studio &#40;service SSIS&#41;](../../integration-services/service/view-integration-services-packages-in-sql-server-management-studio-ssis-service.md).  
...
## Gestion du stockage des packages  
 ...
 Pour plus d’informations, consultez [Configuration du service Integration Services &#40;Service SSIS&#41;](../../integration-services/service/configuring-the-integration-services-service-ssis-service.md).  
...
## Importation et exportation de packages  
 ...
 Pour plus d’informations, consultez [dtutil Utility](../../integration-services/dtutil-utility.md).  
  
## Tâches associées  
  
-   [Importer et exporter des packages &#40;service SSIS&#41;](../../integration-services/service/import-and-export-packages-ssis-service.md)  
  
-   [Afficher les packages Integration Services dans SQL Server Management Studio &#40;Service SSIS&#41;](../../integration-services/service/view-integration-services-packages-in-sql-server-management-studio-ssis-service.md)  
