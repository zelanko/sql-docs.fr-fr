...
ms.topic: "article"
helpviewer_keywords: 
  - "sécurité [Integration Services], rôles"
  - "db_ssisoperator, rôle"
  - "db_ssisadmin (rôle)"
  - "rôles de bases de données fixes [Integration Services]"
  - "packages [Integration Services], sécurité"
  - "rôles [Integration Services]"
  - "db_ssisltduser, rôle"
...
-   [Se connecter à Integration Services](../../integration-services/service/connect-to-integration-services.md)  
