...
ms.topic: "article"
helpviewer_keywords: 
  - "packages SSIS, sauvegarde et restauration"
  - "sauvegarde de packages [Integration Services]"
  - "packages [Integration Services], sauvegarde et restauration"
  - "packages SQL Server Integration Services, sauvegarde et restauration"
  - "restauration de packages [Integration Services]"
  - "packages Integration Services, sauvegarde et restauration"
...
---
# Sauvegarde et restauration de packages (Service SSIS)
