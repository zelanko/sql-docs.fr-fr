...
Vous pouvez inscrire des insights à l’aide de dashboard.insights. Cela revient à [didacticiel : créer un widget d’analyse personnalisée](https://docs.microsoft.com/en-us/sql/sql-operations-studio/tutorial-build-custom-insight-sql-server)
