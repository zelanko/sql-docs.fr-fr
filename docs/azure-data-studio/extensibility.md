...
ms.locfileid: "82107890"
---
# <a name="getting-started-with-name-sos-extensibility"></a>Prise en main de l’extensibilité [!INCLUDE[name-sos](../includes/name-sos-short.md)]
