---
title: Extension d’importation de données Azure Studio SQL Server | Microsoft Docs
description: Extension de SQL Server Import (version préliminaire) pour Azure Data Studio
ms.custom: tools|sos
ms.date: 09/24/2018
...
Pour en savoir plus sur la version SSMS de cette fonctionnalité, vous pouvez lire [cet article](https://docs.microsoft.com/en-us/sql/relational-databases/import-export/import-flat-file-wizard).
