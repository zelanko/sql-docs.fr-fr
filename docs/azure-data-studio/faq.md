...
Oui. La prise en charge d’Azure Data Studio pour Azure SQL Data Warehouse est actuellement en préversion, avec Azure SQL Database Managed Instance et SQL Server 2019 Big Data.
