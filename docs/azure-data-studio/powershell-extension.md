...
Vous pouvez installer la version officielle de l'extension PowerShell en suivant les étapes de la documentation [Azure Data Studio](./extensions.md).
