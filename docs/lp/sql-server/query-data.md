...
layout: HubPage
hide_bc: true
title: SQL Server - Interroger des données
description: Explorez les fonctionnalités qui facilitent l’interrogation des données dans votre base de données SQL Server.
ms.topic: hub-page
featureFlags:
- clicktale
...
<div id="main" class="v2">
    ...
    <div class="container">
        <h1>SQL Server : interroger les données</h1>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Curseurs</h3>
                                                    <p> Permet le traitement d’un jeu de résultats une ligne à la fois </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Recherche en texte intégral</h3>
                                                    <p>Les index de recherche en texte intégral incluent une ou plusieurs colonnes de type caractère dans une table, et la recherche en texte intégral vous permet de les interroger.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Jointures</h3>
                                                    <p>Explore les diverses opérations de tri, d’intersection et d’union effectuées par SQL Server lors de l’utilisation de jointures. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Création de scripts</h3>
                                                    <p>Explore les divers langages de script pris en charge par SQL Server, tels que Powershell et xQuery. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Sous-requêtes</h3>
                                                    <p> Une sous-requête est une requête qui est imbriquée dans une instruction SELECT, INSERT, UPDATE ou DELETE, ou dans une autre sous-requête. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Synonymes</h3>
                                                    <p>Objet de base de données qui fournit une couche d’abstraction pour protéger une application cliente contre les modifications apportées au nom ou à l’emplacement d’un objet de base. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Fonctions définies par l'utilisateur</h3> 
                                                    <p>Routines qui acceptent des paramètres, effectuent une action et retournent le résultat de cette action en tant que valeur. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>Création de bases de données</h3>
