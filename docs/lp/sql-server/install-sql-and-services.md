...
layout: HubPage
hide_bc: true
title: SQL Server - Installation et mise à niveau
description: Recherchez le contenu qui vous aidera à installer ou mettre à niveau votre SQL Server et les services associés.
ms.topic: hub-page
featureFlags:
- clicktale
...
<div id="main" class="v2">
    ...
    <div class="container">
        <h1>SQL Server : installer ou mettre à niveau</h1>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Installer SQL Server</h3>
                                                    <p>Vue d’ensemble des différentes options d’installation disponibles pour installer SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Installer SQL Server Analysis Services (SSAS)</h3>
                                                    <p>Moteur de données analytique qui fournit des modèles de données sémantiques de niveau entreprise pour les rapports métier et les applications clientes comme Power BI, Excel, Reporting Services et d’autres rapports de visualisation des données. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Installer SQL Server Integration Services (SSIS)</h3>
                                                    <p> Utilisez Integration Services pour résoudre des problèmes métier complexes en copiant ou en téléchargeant des fichiers, en chargeant des entrepôts de données, en nettoyant et en explorant des données et en gérant des données et des objets SQL Server. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Installer SQL Server Reporting Services (SSRS)</h3>
                                                    <p>Solution pour créer, publier et gérer des rapports, puis les remettre aux utilisateurs appropriés de différentes façons, que ce soit dans un navigateur web, sur leurs appareils mobiles ou dans un e-mail. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Mettre à niveau SQL Server</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Mettre à niveau SQL Server Analysis Services (SSAS)</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Mettre à niveau SQL Server Integration Services (SSIS)</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Mettre à niveau SQL Server Reporting Services (SSRS)</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Permet des migrations fluides de plusieurs sources de base de données vers des plateformes de données Azure avec un temps d’arrêt minimal.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Assistant Migration de données (DMA)</h3>
                                                    <p>Détecte les problèmes de compatibilité, suggère des améliorations pour votre environnement cible et déplace votre base de données et vos données.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Assistant Migration SQL Server (SSMA)</h3>
                                                    <p>Automatise la migration de bases de données vers SQL Server à partir de Microsoft Access, DB2, MySQL, Oracle et SAP ASE.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
