...
layout: HubPage
hide_bc: true
title: Gérer, surveiller et paramétrer SQL Server
description: Découvrez les fonctionnalités qui vous aident à gérer, surveiller et paramétrer votre serveur SQL Server.
ms.topic: hub-page
ms.prod: sql
featureFlags:
- clicktale
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Gestion du cycle de vie de la base de données</h3>
                                                    <p>Approche complète de la gestion du schéma, des données et des métadonnées d'une application de base de données</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Fonctionnalité de SQL Server qui facilite la compression de vos données afin qu’elles prennent moins d’espace sur les disques. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Messagerie de base de données</h3>
                                                    <p>Solution d’entreprise qui permet l’envoi d’e-mails à partir du moteur de base de données SQL Server. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Gestion basée sur des stratégies</h3>
                                                    <p>Système basé sur des stratégies permettant de gérer une ou plusieurs instances de SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Configurez des plans automatisés pour gérer votre serveur SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Fonctionnalité de SQL Server qui exécute des tâches administratives planifiées. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Événements étendus</h3>
                                                    <p>Système général de gestion des événements pour les systèmes SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQLDiag</h3>
                                                    <p>Utilitaire à usage général qui collecte les journaux et les données à partir de SQL Server. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQL Profiler</h3>
                                                    <p>Créer, gérer, analyser et remplacer les suivis effectués de l’activité de SQL Server. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Paramétrage automatique</h3>
                                                    <p>Nouvelle fonctionnalité de SQL 2017 qui détecte automatiquement les problèmes de performances potentiels. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>estimation de la cardinalité</h3>
                                                    <p>Estime le nombre de lignes qui sera retourné par une requête, et utilisé pour la création du plan d’exécution.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Index</h3>
                                                    <p>Structure sur disque associée à une table ou une vue qui accélère l’extraction des données.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>OLTP en mémoire</h3>
                                                    <p>Option d’optimisation des performances qui conserve des tables entières en mémoire.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Partitions</h3>
                                                    <p>Permet la répartition de données entre des unités, comme des groupes de fichiers. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Repères de plan</h3>
                                                    <p>Fonctionnalité de SQL Server qui permet la saisie manuelle d’un plan d’exécution pour une requête spécifique.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Gouverneur de ressources</h3>
                                                    <p>Spécifie les limites sur les quantités d’UC, d’E/S et de mémoire que les demandes d’application peuvent utiliser. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Statistiques</h3>
                                                    <p>Indique au moteur SQL Server comment les données sont distribuées et utilisées pour la création de plans d’exécution.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
