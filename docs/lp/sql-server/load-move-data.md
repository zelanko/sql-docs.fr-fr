...
<div id="main" class="v2">
    ...
    <div class="container">
        <h1>SQL Server : Migrer, charger et déplacer des données</h1>
                    ...
                    <li class="panelItem" data-index="0">
                        ...
                        <ul class="cardsD panelContent singlePanelContent" id="products1" style="margin-top: 0px; display: flex;">
                            <li class="fullSpan">
                                ...
                                <h2>Migrer des bases de données vers SQL</h2>
                            </li>
                                                         <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>BCP</h3>
                                                    <p>Copie en bloc de données entre un fichier de données, dans un format que vous spécifiez, et votre base de données SQL.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Assistant Importation de fichier plat</h3>
                                                    <p>Utilisez l’Assistant comme moyen simple de copier des données d’un fichier plat (.csv, .txt) vers votre base de données SQL. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Assistant Importation et Exportation</h3>
                                                    <p>Utilisez l’Assistant comme moyen simple de copier des données à partir d’une large gamme de sources vers votre base de données SQL. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
