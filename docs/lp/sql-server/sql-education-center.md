                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <p>Base de données unique Azure SQL Database</p> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <p>Instance managée Azure SQL Database</p> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <p>Sauvegarde et restauration SQL Server avec le service de stockage d’objets blob Azure</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="container centered pageFooter">
        ...
        <ul class="links">
           <li>
                <a href="https://aka.ms/editsqldocs" data-linktype="external"> Contribuer aux documents SQL </a>
            </li>
           <li>
                <a href="https://aka.ms/sqldocsurvey" data-linktype="external"> Commentaires relatifs à SQL Docs </a>
            </li>
           <li>
