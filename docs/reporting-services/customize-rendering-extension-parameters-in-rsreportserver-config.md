...
helpviewer_keywords: 
  ...
  - "DeviceInfo (paramètres)"
  - "extensions de rendu [Reporting Services], remplacement des comportements"
  - "paramètres [Reporting Services], rendu de rapports"
  - "remplacement du comportement de rendu du rapport"
  - "extensions [Reporting Services], rendu"
...
## Modification des paramètres d'informations de périphérique  
