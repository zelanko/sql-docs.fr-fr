...
1.  [Créer un rapport à l’aide d’un Assistant](#CreateTable)  
...
2.  [Mettre en forme les données de devise](#FormatCurrency)  
...
## <a name="FormatCurrency"></a>2. Mettre en forme les données de devise  
