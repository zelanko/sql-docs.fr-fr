...
Vous pouvez accéder à la page Abonnements en sélectionnant le **bouton de sélection (...)** d’un rapport, en sélectionnant **Gérer**, puis en sélectionnant **Abonnements**.  
