...
description: "Il existe deux manières d'intégrer Reporting Services dans des applications personnalisées : l’accès par URL et l’API SOAP de Reporting Services. Découvrez comment choisir."
ms.date: 10/19/2017
