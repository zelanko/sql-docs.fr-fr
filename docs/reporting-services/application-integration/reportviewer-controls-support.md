...
Pour plus d’informations sur la version actuelle du contrôle Report Viewer, passez en revue ce [blog](/archive/blogs/sqlrsteamblog/report-viewer-2016-control-update-now-available).