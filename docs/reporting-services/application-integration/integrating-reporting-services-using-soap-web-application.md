...
description: Vous pouvez accéder aux fonctionnalités du serveur de rapports par le biais de l’API SOAP Reporting Services, qui permet d’offrir des fonctionnalités de création de rapports d’entreprise.
ms.date: 06/26/2019
