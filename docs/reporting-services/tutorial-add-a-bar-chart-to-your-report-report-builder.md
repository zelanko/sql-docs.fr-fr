...
description: Découvrez comment utiliser un Assistant dans le Générateur de rapports pour créer un graphique à barres dans un rapport paginé Reporting Services.
ms.date: 06/15/2016
