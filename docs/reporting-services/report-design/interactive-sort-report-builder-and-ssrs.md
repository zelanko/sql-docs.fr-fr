...
description: Ajoutez des boutons de tri interactifs pour permettre à un utilisateur de basculer entre l’ordre croissant et l’ordre décroissant pour les lignes d’une table.
ms.date: 03/01/2017
