...
description: Optimisez l’affichage et l’impression de vos tables, listes ou images avec des options pour les longueurs de page, les colonnes, les en-têtes et les lignes dans le Générateur de rapports.
ms.date: 03/07/2017
