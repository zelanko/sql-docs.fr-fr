...
description: Découvrez comment utiliser des graphiques en aires qui affichent une série sous la forme d’un ensemble de points reliés par une courbe, la zone sous la courbe étant remplie dans le Générateur de rapports.
ms.date: 03/03/2017
