...
ms.topic: "article"
helpviewer_keywords: 
  - "paramètres à valeurs multiples [Reporting Services]"
  - "paramètres à valeur unique [Reporting Services]"
  - "paramètres [Reporting Services], à valeurs multiples"
  - "valeurs valides [Reporting Services]"
