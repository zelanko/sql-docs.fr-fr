---
title: Fonction Avg (Générateur de rapports) | Microsoft Docs
description: Découvrez la fonction Avg dans les rapports paginés, qui retourne la moyenne de toutes les valeurs numériques non Null spécifiées par l’expression dans le Générateur de rapports.
ms.date: 03/07/2017
