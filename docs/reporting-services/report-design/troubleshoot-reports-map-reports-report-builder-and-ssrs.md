...
## Des exemples de données spatiales sont affichés sur l'aire de conception.  
...
## Lorsque je définis un décalage pour un élément cartographique individuel, un cluster d'éléments cartographiques est déplacé.  
...
## Ma couche utilise des données spatiales d'un fichier de forme ESRI et elle a toujours des données incorporées.  
...
## J'ai renommé une source de données ou un dataset avec un nom convivial et maintenant aucunes données ne s'affichent dans ma carte.  
...
## Ma carte contient un nombre d'éléments spatiaux supérieur à la limite autorisée.  
...
## Je ne peux pas définir le centre et la vue sur un élément cartographique incorporé.  
...
## J'ai défini le centre et la vue cartographique dans mon rapport. Lorsque j'ouvre le rapport à nouveau, pourquoi la vue cartographique n'est-elle pas la même ?  
...
## L'option permettant de définir le centre et la vue d'une couche ne fonctionne pas.  
...
## J'obtiens une erreur d'expression concernant l'étendue du dataset lorsque je définis une étiquette ou une info-bulle sur une expression.  
...
## Voir aussi  
 ...
 [Résolution des problèmes liés au Générateur de rapports](http://msdn.microsoft.com/fr-fr/3806fc48-56f8-44d1-a3c1-df8c33cce0a3)  
