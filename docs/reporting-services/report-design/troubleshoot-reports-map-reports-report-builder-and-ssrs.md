...
description: Explorez les idées de résolution des problèmes qui peuvent se produire quand vous personnalisez, ajoutez une couche ou publiez un rapport avec une carte dans le Générateur de rapports.
ms.date: 07/22/2020
