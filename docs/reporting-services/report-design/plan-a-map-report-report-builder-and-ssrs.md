...
description: Bénéficiez d’actions et d’insights avec la présentation de données analytiques sur un arrière-plan géographique en utilisant une carte dans vos rapports paginés dans le Générateur de rapports.
ms.date: 03/14/2017
