---
title: Liaison de plusieurs régions de données à un même dataset (Générateur de rapports) | Microsoft Docs
description: Découvrez comment ajouter plusieurs régions de données à un rapport paginé afin de proposer des vues différentes des données du même dataset de rapport dans le Générateur de rapports.
ms.date: 05/30/2017
