...
description: Découvrez comment personnaliser l’affichage des données dans le Générateur de rapports pour afficher toutes les données récupérées ou un sous-ensemble des données.
ms.date: 08/17/2018
