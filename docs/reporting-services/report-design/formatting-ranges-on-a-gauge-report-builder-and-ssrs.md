...
description: Indiquez visuellement avec une plage de jauge quand la valeur de pointeur entre dans une certaine plage de valeurs dans le Générateur de rapports.
ms.date: 03/01/2017
