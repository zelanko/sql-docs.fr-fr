---
title: "Fonction Union (Générateur de rapports et SSRS) | Documents Microsoft"
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="report-builder-functions---union-function"></a>Fonctions du Générateur de rapports - fonction Union
