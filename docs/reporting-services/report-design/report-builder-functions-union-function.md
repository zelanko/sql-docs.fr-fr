---
title: Fonction Union (Générateur de rapports) | Microsoft Docs
description: Découvrez cette fonction qui retourne l’union de toutes les valeurs numériques non Null spécifiées par une expression.
ms.date: 03/07/2017
