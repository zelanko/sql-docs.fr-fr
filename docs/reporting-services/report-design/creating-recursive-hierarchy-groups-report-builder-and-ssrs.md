...
description: Découvrez les utilisations des groupes de hiérarchies récursives dans le Générateur de rapports. Affichez des données hiérarchiques telles que les employés dans un organigramme.
ms.date: 03/01/2017
