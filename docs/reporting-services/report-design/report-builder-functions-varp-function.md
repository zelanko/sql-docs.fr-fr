---
title: "Fonction VarP (Générateur de rapports et SSRS) | Documents Microsoft"
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="report-builder-functions---varp-function"></a>Fonction VarP de - fonctions du Générateur de rapports
 ...
 *expression*  
 (**Entier** ou **Float**) Expression sur laquelle effectuer l’agrégation.  
