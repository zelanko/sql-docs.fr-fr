...
## Pour insérer une ligne dans un groupe dans une région de données sélectionnée  
...
## Pour supprimer une ligne d'un groupe dans une région de données sélectionnée  
