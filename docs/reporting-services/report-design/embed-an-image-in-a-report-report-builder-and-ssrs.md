...
description: Rendez une image immédiatement disponible pour un rapport. Utilisez une image qui est incorporée dans le rapport et listée dans le volet des données de rapport du Générateur de rapports.
ms.date: 03/01/2017
