---
title: "Fonction StDev (Générateur de rapports et SSRS) | Documents Microsoft"
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="report-builder-functions---stdev-function"></a>Fonction StDev de - fonctions du Générateur de rapports
