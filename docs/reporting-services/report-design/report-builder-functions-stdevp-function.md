---
title: Fonction StDevP (Générateur de rapports) | Microsoft Docs
description: Découvrez cette fonction qui retourne l’écart-type de remplissage de toutes les valeurs numériques non Null spécifiées par une expression.
ms.date: 03/07/2017
