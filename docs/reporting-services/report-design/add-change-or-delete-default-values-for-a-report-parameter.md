...
description: Utilisez ces étapes pour personnaliser vos rapports avec des valeurs par défaut ajoutées, modifiées ou supprimées pour les paramètres de rapport.
ms.date: 03/07/2017
