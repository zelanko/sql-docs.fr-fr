...
description: Contrôlez l’affichage des polygones, des lignes et des points en définissant des options et des règles, ou en substituant des options pour les éléments cartographiques incorporés dans le Générateur de rapports.
ms.date: 03/07/2017
