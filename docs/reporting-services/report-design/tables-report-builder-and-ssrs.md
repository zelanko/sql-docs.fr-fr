...
##  <a name="AddingRowGroups"></a> Ajout de groupes de lignes à une table  
 ...
 ![Table regroupée par date, puis par commande](../../reporting-services/media/rs-basictablegroupspreview.gif "Table regroupée par date, puis par commande")  
