...
## <a name="displaying-data-on-rows-and-columns"></a>Affichage des données dans des lignes et des colonnes  
 ...
 Pour plus d’informations sur les hiérarchies de groupe, consultez [présentation des groupes &#40; Le Générateur de rapports et SSRS &#41; ](../../reporting-services/report-design/understanding-groups-report-builder-and-ssrs.md).  
