...
description: Découvrez la syntaxe requise dans les expressions, avant le traitement ou la publication, pour prendre en charge les références aux collections et aux fonctions intégrées dans le Générateur de rapports.
ms.date: 03/01/2017
