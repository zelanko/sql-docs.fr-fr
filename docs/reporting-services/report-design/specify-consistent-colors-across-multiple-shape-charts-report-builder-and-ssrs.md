...
description: Découvrez comment le choix des couleurs pour un graphique à base de formes entraîne le mappage de chaque couleur dans la palette à un point de données dans le dataset.
ms.date: 03/01/2017
