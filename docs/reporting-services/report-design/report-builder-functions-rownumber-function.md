---
title: Fonction RowNumber (Générateur de rapports) | Microsoft Docs
description: Utilisez la fonction RowNumber du Générateur de rapports pour retourner un nombre évolutif du nombre de lignes pour l’étendue spécifiée.
ms.date: 03/07/2017
