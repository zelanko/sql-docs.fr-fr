---
title: "Dernier (fonction) (Générateur de rapports et SSRS) | Documents Microsoft"
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="report-builder-functions---last-function"></a>-Fonctions du Générateur de rapports de la dernière (fonction)
