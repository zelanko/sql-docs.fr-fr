---
title: Fonction Last (Générateur de rapports) | Microsoft Docs
description: La fonction Last retourne la valeur finale d’un jeu de données après que l’étendue spécifiée a été correctement triée et filtrée dans le Générateur de rapports.
ms.date: 03/07/2017
