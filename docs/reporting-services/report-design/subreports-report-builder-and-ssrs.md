...
description: Affichez un rapport à l’intérieur d’un autre rapport. Affichez-les et stockez-les dans le même dossier de serveur dans le Générateur de rapports.
ms.date: 03/07/2017
