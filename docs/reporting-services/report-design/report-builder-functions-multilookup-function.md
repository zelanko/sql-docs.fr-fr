...
description: La fonction Multilookup retourne le jeu de valeurs de première correspondance pour le jeu de noms spécifié d’un dataset contenant des paires nom/valeur dans le Générateur de rapports.
ms.date: 03/07/2017
...
### <a name="a-use-multilookup-function"></a>R. Utiliser la fonction Multilookup
...
### <a name="b-use-multilookup-with-multivalue-parameter"></a>B. Utiliser MultiLookup avec un paramètre à valeurs multiples  
