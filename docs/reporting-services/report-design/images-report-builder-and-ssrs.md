...
description: Découvrez les images en tant qu’éléments dans le Générateur de rapports. Ces éléments contiennent une référence à une image incorporée dans un rapport ou stockée dans une base de données.
ms.date: 03/01/2017
