...
## Pour sélectionner une région de données de manière à afficher les poignées de ligne et de colonne  
...
## Pour insérer une colonne dans un groupe d'une région de données sélectionnée  
...
## Pour supprimer une colonne d'un groupe d'une région de données sélectionnée  
