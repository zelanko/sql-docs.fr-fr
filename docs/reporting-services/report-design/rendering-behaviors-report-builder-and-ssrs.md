...
description: Découvrez les règles appliquées au corps du rapport et son contenu lors du rendu d’un rapport dans le Générateur de rapports.
ms.date: 03/07/2017
