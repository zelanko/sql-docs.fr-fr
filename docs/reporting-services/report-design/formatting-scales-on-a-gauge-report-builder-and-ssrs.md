...
description: Apprenez-en davantage sur la plage de l’échelle de la jauge de nombres liés par une valeur minimale et une valeur maximale dans un rapport paginé dans le Générateur de rapports.
ms.date: 03/01/2017
