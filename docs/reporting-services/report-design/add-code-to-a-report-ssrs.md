...
description: Découvrez comment appeler votre propre code personnalisé pour toute expression que vous avez dans votre rapport dans le Générateur de rapports.
ms.date: 03/14/2017
