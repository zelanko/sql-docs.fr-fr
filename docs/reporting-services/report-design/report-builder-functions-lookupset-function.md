---
title: "Fonction LookupSet (Générateur de rapports et SSRS) | Documents Microsoft"
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="report-builder-functions---lookupset-function"></a>Fonction LookupSet de - fonctions du Générateur de rapports
