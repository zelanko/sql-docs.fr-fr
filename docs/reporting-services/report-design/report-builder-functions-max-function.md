---
title: "Fonction MAX (Générateur de rapports et SSRS) | Documents Microsoft"
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="report-builder-functions---max-function"></a>Fonctions du Générateur de rapports - Max (fonction)
