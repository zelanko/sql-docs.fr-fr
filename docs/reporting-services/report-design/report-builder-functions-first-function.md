---
title: Fonction First (Générateur de rapports) | Microsoft Docs
description: Utilisez la fonction First pour retourner la première valeur dans l’étendue donnée de l’expression spécifiée dans le Générateur de rapports.
ms.date: 03/07/2017
