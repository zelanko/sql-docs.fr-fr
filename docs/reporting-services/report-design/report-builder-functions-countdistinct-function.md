...
description: Obtenez le nombre de toutes les valeurs non Null distinctes qui sont spécifiées par une expression, dans le contexte d’une étendue donnée.
ms.date: 03/07/2017
