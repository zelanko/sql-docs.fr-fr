...
# [Conseils de conception d’un rapport](report-design-tips-report-builder-and-ssrs.md)  
# [Concepts de création d’un rapport](report-authoring-concepts-report-builder-and-ssrs.md)  
...
## [Régions et cartes de données](data-regions-and-maps-report-builder-and-ssrs.md)  
## [Concepts de paramètres d’un rapport](report-parameters-concepts-report-builder-and-ssrs.md)  
...
### [Légende de graphique - mise en forme](chart-legend-formatting-report-builder.md)  
### [Légende de graphique - masquer des éléments](chart-legend-hide-items-report-builder.md)  
### [Légende de graphique - modifier le texte des éléments](chart-legend-change-item-text-report-builder.md)  
...
### [Effets de graphique - 3D, biseau et autres](chart-effects-3d-bevel-and-other-report-builder.md)  
### [Graphique des effets - ajouter des effets 3D](chart-effects-add-3d-effects-report-builder.md)  
### [Graphique des effets - ajouter un biseau, un relief ou une texture](chart-effects-add-bevel-emboss-or-texture-report-builder.md)  
...
## [Personnaliser le volet des paramètres dans un rapport](customize-the-parameters-pane-in-a-report-report-builder.md)  
...
### [Fonctions de générateur de rapports - référence aux fonctions d'agrégation](report-builder-functions-aggregate-functions-reference.md)  
#### [Fonctions de générateur de rapports - fonction d'agrégation](report-builder-functions-aggregate-function.md)  
#### [Fonctions de générateur de rapports - fonction moyenne](report-builder-functions-avg-function.md)  
#### [Fonctions de générateur de rapports - fonction de compte](report-builder-functions-count-function.md)  
#### [Fonctions de générateur de rapports - fonction CountDistinct](report-builder-functions-countdistinct-function.md)  
#### [Fonctions de générateur de rapports - fonction CountRows](report-builder-functions-countrows-function.md)  
#### [Fonctions de générateur de rapports - première fonction](report-builder-functions-first-function.md)  
#### [Fonctions de générateur de rapports - fonction InScope](report-builder-functions-inscope-function.md)  
#### [Fonctions de générateur de rapports - dernière fonction](report-builder-functions-last-function.md)  
#### [Fonctions de générateur de rapports - fonction de niveau](report-builder-functions-level-function.md)  
#### [Fonctions de générateur de rapports - fonction de verrouillage](report-builder-functions-lookup-function.md)  
#### [Fonctions de générateur de rapports - fonction LookupSet](report-builder-functions-lookupset-function.md)  
#### [Fonctions de générateur de rapports - fonction maxi](report-builder-functions-max-function.md)  
#### [Fonctions de générateur de rapports - fonction mini](report-builder-functions-min-function.md)  
#### [Fonctions de générateur de rapports - fonction Multilookup](report-builder-functions-multilookup-function.md)  
#### [Fonctions de générateur de rapports - fonction précédente](report-builder-functions-previous-function.md)  
#### [Fonctions de générateur de rapports fonction RowNumber](report-builder-functions-rownumber-function.md)  
#### [Fonctions de générateur de rapports - fonction RunningValue](report-builder-functions-runningvalue-function.md)  
#### [Fonctions de générateur de rapports - fonction StDev](report-builder-functions-stdev-function.md)  
#### [Fonctions de générateur de rapports - fonction StDevP](report-builder-functions-stdevp-function.md)  
#### [Fonctions de générateur de rapports - fonction de somme](report-builder-functions-sum-function.md)  
#### [Fonctions de générateur de rapports - fonction d’union](report-builder-functions-union-function.md)  
#### [Fonctions de générateur de rapports - fonction Var](report-builder-functions-var-function.md)  
#### [Fonctions de générateur de rapports - fonction VarP](report-builder-functions-varp-function.md)  
...
#### [Collections intégrées - références aux collections de paramètres](built-in-collections-parameters-collection-references-report-builder.md)  
#### [Collections intégrées - références aux collections de champs de jeux de données](built-in-collections-dataset-fields-collection-references-report-builder.md)  
#### [Collections intégrées - références aux sources de données et aux jeux de données](built-in-collections-datasources-and-datasets-references-report-builder.md)  
#### [Collections intégrées - références aux variables de rapports et de groupes](built-in-collections-report-and-group-variables-references-report-builder.md)  
#### [Collections intégrées - références aux collections de ReportItems](built-in-collections-reportitems-collection-references-report-builder.md)  
### [Formules dans les requêtes de modèles de rapports](formulas-in-report-model-queries-report-builder-and-ssrs.md)  
# [Tri interactif, cartes de documents et liens](interactive-sort-document-maps-and-links-report-builder-and-ssrs.md)  
...
## [Créer une carte de documents (Générateur de rapports et SSRS)](create-a-document-map-report-builder-and-ssrs.md)  
# [Mise en page et rendu](page-layout-and-rendering-report-builder-and-ssrs.md)  
## [Rendu de comportements](rendering-behaviors-report-builder-and-ssrs.md)  
### [Rendu de régions de données](rendering-data-regions-report-builder-and-ssrs.md)  
### [Rendu d’éléments de rapport](rendering-report-items-report-builder-and-ssrs.md)  
...
## [Contrôle des sauts de page, en-têtes, colonnes et lignes](controlling-page-breaks-headings-columns-and-rows-report-builder-and-ssrs.md)  
...
## [Afficher les numéros de page ou d'autres propriétés du rapport](display-page-numbers-or-other-report-properties-report-builder-and-ssrs.md)  
