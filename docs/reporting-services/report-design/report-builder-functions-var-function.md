---
title: "Fonction VAR (Générateur de rapports et SSRS) | Documents Microsoft"
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="report-builder-functions---var-function"></a>Fonction Var de - fonctions du Générateur de rapports
