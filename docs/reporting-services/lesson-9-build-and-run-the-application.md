...
description: Découvrez comment générer et exécuter l’application de site web après avoir créé un filtre de données pour la table de données.
ms.date: 05/18/2016
