...
description: Découvrez comment personnaliser l’apparence de votre portail web pour votre entreprise à l’aide d’un package de personnalisation. Le package de personnalisation a été conçu de telle sorte que vous n’avez pas besoin de connaissances approfondies en CSS.
ms.topic: conceptual
author: maggiesMSFT
ms.author: maggies
