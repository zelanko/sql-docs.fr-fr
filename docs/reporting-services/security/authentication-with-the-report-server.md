...
helpviewer_keywords: 
  ...
  - "connexions [Reporting Services], comptes"
...
|Pour gérer le scénario d’authentification personnalisé, activez le [!INCLUDE[ssRSWebPortal](../../includes/ssrswebportal.md)].|[Configurer le portail web pour passer des cookies d’authentification personnalisée](http://msdn.microsoft.com/fr-fr/91aeb053-149e-4562-ae4c-a688d0e1b2ba)|  
