...
ms.topic: "article"
helpviewer_keywords: 
  - "authentification par formulaires, configuration"
  - "authentification personnalisée [Reporting Services]"
...
12. Ajoutez la structure d’éléments **PassThroughCookies** au fichier de configuration. Pour plus d’informations, consultez [Configurer le Gestionnaire de rapports pour passer des cookies d’authentification personnalisée](../Topic/Configure%20Report%20Manager%20to%20Pass%20Custom%20Authentication%20Cookies.md).  
