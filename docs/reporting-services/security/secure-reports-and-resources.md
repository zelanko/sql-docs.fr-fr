...
ms.topic: "article"
helpviewer_keywords: 
  - "sécurité [Reporting Services], rapports"
  - "sécurité [Reporting Services], ressources"
  - "rapports [Reporting Services], sécurité"
  - "rapports confidentiels [Reporting Services]"
  - "ressources [Reporting Services], sécurité"
...
## Limitation des attaques par injection de script dans un lien hypertexte figurant dans un rapport ou un document publié  
