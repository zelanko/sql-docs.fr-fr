...
helpviewer_keywords: 
  ...
  - "sécurité [Reporting Services], attributions de rôle"
...
## Création d'une attribution de rôle au niveau système  
 ...
 Pour plus d’informations, consultez [Accorder à un utilisateur l’accès à un serveur de rapports &#40;Gestionnaire de rapports&#41;](../../reporting-services/security/grant-user-access-to-a-report-server-report-manager.md) et [Rôles prédéfinis](../../reporting-services/security/predefined-roles.md).  
