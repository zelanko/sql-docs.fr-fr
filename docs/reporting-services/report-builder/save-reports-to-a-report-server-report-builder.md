...
description: Dans le Générateur de rapports, vous pouvez publier un rapport sur un serveur de rapports. Les autres utilisateurs peuvent l’afficher. Chaque fois que vous exécutez le rapport publié, vous voyez les données les plus récentes.
ms.date: 03/01/2017
...
1.  À partir du bouton Générateur de rapports, cliquez sur **Enregistrer**. La boîte de dialogue **Enregistrer sous** _\<Report Item>_ s’affiche.  
...
1.  À partir du bouton Générateur de rapports, cliquez sur **Enregistrer sous**. La boîte de dialogue **Enregistrer sous** _\<Report Item>_ s’affiche.  
