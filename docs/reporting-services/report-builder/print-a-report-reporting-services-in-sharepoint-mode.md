...
description: Si un serveur de rapports s’exécute en mode SharePoint, vous pouvez imprimer un rapport dans une application web SharePoint à partir d’un site SharePoint, d’un navigateur ou d’une application cible.
ms.date: 05/14/2019
