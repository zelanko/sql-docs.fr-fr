...
---
# G&#233;n&#233;rer des flux de donn&#233;es &#224; partir d&#39;un rapport (G&#233;n&#233;rateur de rapports et SSRS)
  Vous pouvez générer des flux de données conformes à Atom à partir de rapports paginés, puis utiliser ces flux de données dans des applications, par exemple le client [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)], qui est capable d’utiliser des flux de données.  
