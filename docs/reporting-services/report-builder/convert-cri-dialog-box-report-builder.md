...
description: Le Générateur de rapports vous invite à convertir les éléments de rapport personnalisés qui comprennent des fonctionnalités non prises en charge au nouveau format de définition de rapport.
ms.date: 08/17/2018
