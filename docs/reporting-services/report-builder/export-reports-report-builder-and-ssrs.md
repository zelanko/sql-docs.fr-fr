---
title: "Exporter des rapports (Générateur de rapports et SSRS) | Documents Microsoft"
ms.custom:
- SQL2016_New_Updated
ms.date: 05/30/2017
...
2.  Cliquez sur **Exporter**dans le ruban.  
     ...
     ![Exportation du Générateur de rapports](../../reporting-services/report-builder/media/ssrb-export.png "exportation du Générateur de rapports")  
...
3.  Dans la barre d’outils Visionneuse de rapports, cliquez sur la flèche déroulante **Exporter** .  
     ...
     ![Portail web de Reporting Services exportation](../../reporting-services/report-builder/media/ssrsportal-export.png "portail web de Reporting Services exportation")  
