...
-   [Pour exporter un rapport du Générateur de rapports](#bkmk_export_from_rb)  
  
-   [Pour exporter un rapport à partir du portail web Reporting Services](#bkmk_export_from_rm)  
  
-   [Pour exporter un rapport à partir d’une bibliothèque SharePoint](#bkmk_export_from_sharepoint)  
  
-   [Types d'extensions de rendu](#RendererTypes)  
  
-   [Formats d’exportation disponibles pendant l’affichage de rapports](#ExportFormats)  
  
-   [Génération de flux à partir d'un rapport](#GeneratingDataFeedsFromReport)  
  
-   [Dépannage des rapports exportés](#Troubleshooting)  
  
-   [Autres modes d'exportation des rapports](#OtherWaysExportingReports)  
...
1.  À partir de la page **Accueil** du portail web [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)], naviguez jusqu’au rapport que vous souhaitez exporter.  
...
|EXCELOPENXML|Saut de page conditionnelle|Affiché avec la mention « Excel » dans les menus d’exportation lors de la consultation de rapports. L’extension de rendu Excel affiche un rapport au format Excel (.xslx) compatible avec [!INCLUDE[ofprexcel](../../includes/ofprexcel-md.md)] 2013.  Pour plus d’informations, consultez [Exportation vers Microsoft Excel &#40;Générateur de rapports et SSRS&#41;](../../reporting-services/report-builder/exporting-to-microsoft-excel-report-builder-and-ssrs.md).|  
