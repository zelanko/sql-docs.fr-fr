...
ms.topic: "article"
helpviewer_keywords: 
  - "abonnements [Reporting Services], distribution des rapports"
  - "rapports [Reporting Services], distribution"
  - "distribution de rapports [Reporting Services]"
  - "rapports publiés [Reporting Services], distribution"
  - "envoi des rapports"
  - "partage des rapports"
  - "remise des rapports [Reporting Services]"
  - "distribution de rapports [Reporting Services], abonnements"
  - "abonnements [Reporting Services], à propos des abonnements"
