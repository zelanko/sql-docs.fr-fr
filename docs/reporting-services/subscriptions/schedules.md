...
helpviewer_keywords: 
  ...
  - "planifications [Reporting Services], à propos des planifications"
  - "rapports publiés [Reporting Services], planifications"
  - "rapports [Reporting Services], planification"
  - "abonnements [Reporting Services], planification"
  - "traitement automatique des rapports"
