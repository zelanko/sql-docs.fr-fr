...
description: Dans cet article, vous allez découvrir comment utiliser l’extension de remise par e-mail, qui permet d’envoyer par e-mail un rapport à des utilisateurs individuels ou à des groupes.
ms.date: 03/14/2017
