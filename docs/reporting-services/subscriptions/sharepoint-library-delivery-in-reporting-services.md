...
description: Découvrez comment utiliser l’extension de remise de la bibliothèque SharePoint dans Reporting Services, à l’aide d’un abonnement à partir d’une page d’application sur un site SharePoint.
ms.date: 03/14/2017
