...
description: Découvrez comment utiliser Reporting Services pour identifier l’état d’exécution dans le but d’interagir avec le rapport de plusieurs façons.
ms.date: 03/03/2017
