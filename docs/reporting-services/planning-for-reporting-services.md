...
# <a name="planning-for-reporting-services"></a>Planification pour Reporting Services
 ...
 ![Icône de dossier petit fichier](../analysis-services/media/filefolder-small.png "petite icône du dossier") **générales de Reporting Services fonctionnalité planification et Architecture**  
 ...
 [Affichage des rapports Reporting Services sur des appareils Microsoft Surface et Apple iOS](http://msdn.microsoft.com/library/2124bcf5-d60a-475f-a4ae-de6df44d2860)  
  
 ![Petite icône de dossier du fichier](../analysis-services/media/filefolder-small.png "petite icône de dossier du fichier") **le programme d’installation de Reporting Services**  
 [Serveur de rapports Reporting Services](../reporting-services/report-server-sharepoint/reporting-services-report-server.md)  
  
 [Liste de vérification de déploiement : Installer Reporting Services dans une batterie de serveurs SharePoint existante](http://msdn.microsoft.com/library/436b4c3d-3f2f-464a-be7e-5c051d9ffb8f)  
