...
ms.topic: "article"
helpviewer_keywords: 
  - "accès URL [Reporting Services]"
  - "liens [Reporting Services], accès URL"
  - "accès URL [Reporting Services], à propos de l’accès URL"
  - "paramètres [Reporting Services], accès URL"
  - "serveurs de rapports [Reporting Services], accès URL"
  - "liens hypertexte [Reporting Services]"
