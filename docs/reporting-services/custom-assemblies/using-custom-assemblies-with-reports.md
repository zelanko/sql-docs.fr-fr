...
description: Développez un assembly de code personnalisé à l’aide de Microsoft .NET Framework dans le but de le référencer à partir de vos fichiers de définition de rapport.
ms.date: 03/14/2017
