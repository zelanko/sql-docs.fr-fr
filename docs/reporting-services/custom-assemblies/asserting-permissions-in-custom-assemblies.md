...
description: Découvrez comment accorder des autorisations pour implémenter un assembly personnalisé qui effectue des appels sécurisés vers des ressources protégées au sein de votre système de sécurité.
ms.date: 03/14/2017
