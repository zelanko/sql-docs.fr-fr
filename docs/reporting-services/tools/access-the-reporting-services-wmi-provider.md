...
helpviewer_keywords: 
  - "fournisseur WMI [Reporting Services]"
  - "programmation [Reporting Services]"
...
|-----------|---------------|-----------------|  
|MSReportServer_Instance|root\Microsoft\SqlServer\ReportServer\RS_*\<nom_instance_codée>*\v13|Fournit les informations de base nécessaires à un client pour établir la connexion à un serveur de rapports installé.|  
|MSReportServer_ConfigurationSetting|root\Microsoft\SqlServer\ReportServer\RS_*\<nom_instance_codée>*\v13\Admin|Représente les paramètres d'installation et d'exécution d'une instance de serveur de rapports. Ces paramètres sont stockés dans le fichier de configuration du serveur de rapports.<br /><br /> **\*\* Important \*\*** Cette classe est accessible uniquement avec des privilèges d’administrateur.|  
...
## Déterminez le nom de l'instance dans la chaîne de l'espace de noms  
...
## Accédez aux classes WMI à l'aide de PowerShell  
...
## Interrogez les méthodes et les propriétés disponibles  
...
## Utilisez une propriété ou une méthode WMI  
