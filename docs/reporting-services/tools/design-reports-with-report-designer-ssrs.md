...
ms.topic: "article"
helpviewer_keywords: 
  - "Concepteur de rapports [Reporting Services], création de rapports"
...
##  <a name="a-namebkmkshareddatasourcesa-shared-data-sources"></a><a name="bkmk_SharedDataSources"></a> Sources de données partagées  
 ...
 Pour plus d’informations, consultez [Data Connections, Data Sources, and Connection Strings &#40;Report Builder and SSRS&#41;](../../reporting-services/report-data/data-connections-data-sources-and-connection-strings-report-builder-and-ssrs.md).  
   
##  <a name="a-namebkmkshareddatasetsa-shared-datasets"></a><a name="bkmk_SharedDatasets"></a> Datasets partagés  
...
##  <a name="a-namebkmkreportsa-paginated-reports"></a><a name="bkmk_Reports"></a> Rapports paginés  
...
-   **Importez un rapport [!INCLUDE[msCoName](../../includes/msconame-md.md)] Access.** Importez tous les rapports à partir d’une base de données Access (.mdb, .accdb) ou du fichier de projet (.adp). Le Concepteur de rapports convertit chaque rapport dans un fichier de base de données ou de projet au format RDL, puis l'enregistre dans le projet de rapport. Les fonctionnalités d'un rapport Access ne sont pas toutes transférables dans un fichier de définition de rapport (.rdl). Pour plus d’informations, consultez [Importer des rapports depuis Microsoft Access &#40;Reporting Services&#41;](../Topic/Import%20Reports%20from%20Microsoft%20Access%20\(Reporting%20Services\).md) et [Fonctionnalités des états Access prises en charge &#40;SSRS&#41;](../Topic/Supported%20Access%20Report%20Features%20\(SSRS\).md).  
...
##  <a name="a-namebkmkreportpartsa-report-parts"></a><a name="bkmk_ReportParts"></a> Parties de rapports  
...
##  <a name="a-namebkmkresourcesa-resources"></a><a name="bkmk_Resources"></a> Ressources  
...
##  <a name="a-namebkmkreportlayouta-paginated-report-layout"></a><a name="bkmk_ReportLayout"></a> Mise en page de rapport paginé  
...
##  <a name="a-namebkmkpreviewa-preview-a-paginated-report"></a><a name="bkmk_Preview"></a> Aperçu d’un rapport paginé  
...
##  <a name="a-namebkmksaveanddeploya-save-and-deploy-paginated-reports"></a><a name="bkmk_SaveandDeploy"></a> Enregistrer et déployer des rapports paginés  
...
>  Pour déboguer les expressions et les erreurs de déploiement, vous devez afficher la définition de rapport dans le dossier de génération. N'utilisez pas **Afficher la source**. **Afficher la source** affiche la source de définition de rapport à partir de le dossier du projet.  
 ...
 Pour plus d’informations, consultez [Deployment and Version Support in SQL Server Data Tools &#40;SSRS&#41;](../../reporting-services/tools/deployment-and-version-support-in-sql-server-data-tools-ssrs.md).  
...
##  <a name="a-namebkmkreportvalidationanderrorlevelsa-report-validation-and-error-levels"></a><a name="bkmk_ReportValidationandErrorLevels"></a> Validation de rapport et niveaux d’erreurs  
...
*  [Télécharger SQL Server Data Tools](http://go.microsoft.com/fwlink/?LinkID=616714)  [Reporting Services dans SQL Server Data Tools &#40;SSDT&#41;](../../reporting-services/tools/reporting-services-in-sql-server-data-tools-ssdt.md)   
*  [Outils de création de requêtes &#40;SSRS&#41;](../../reporting-services/report-data/query-design-tools-ssrs.md)   
*  [Déploiement et prise en charge des versions dans SQL Server Data Tools &#40;SSRS&#41;](../../reporting-services/tools/deployment-and-version-support-in-sql-server-data-tools-ssrs.md)  
