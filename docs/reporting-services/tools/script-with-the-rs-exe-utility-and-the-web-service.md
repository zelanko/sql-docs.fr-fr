...
ms.topic: "article"
helpviewer_keywords: 
  - "service Web [Reporting Services], scripts"
  - "utilitaire rs.exe"
  - "service Web XML [Reporting Services], scripts"
  - "service Web Report Server, scripts"
  - "scripts [Reporting Services], service web"
