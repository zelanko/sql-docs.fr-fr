...
helpviewer_keywords: 
  ...
  - "Reporting Services, création de scripts"
...
## Exemples et applets de commande PowerShell du mode SharePoint de Reporting Services  
...
## Exemples du modèle d'objet Reporting Services et de Powershell  
 ![Contenu relatif à PowerShell](../../analysis-services/instances/install-windows/media/rs-powershellicon.png "Contenu relatif à PowerShell")  
...
-   [Comment administrer SSRS à l’aide de PowerShell](http://curah.microsoft.com/13107/how-to-administer-ssrs-using-powershell).  
  
## Exemples de scripts RS.exe  
