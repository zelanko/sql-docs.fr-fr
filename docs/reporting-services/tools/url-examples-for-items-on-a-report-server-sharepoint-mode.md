...
description: Regardez des exemples d’utilisation d’URL qui spécifient des emplacements dans une hiérarchie web de sites SharePoint sur un serveur de rapports.
ms.date: 03/14/2017
