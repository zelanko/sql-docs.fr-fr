...
helpviewer_keywords: 
  ...
  - "serveurs de rapports [Reporting Services], duplication de paramètres"
  - "déploiement [Reporting Services], scripts"
  - "copie de paramètres du serveur de rapports"
  - "tâches d'administration [Reporting Services]"
  - "duplication de l'environnement du serveur de rapports"
  - "migration de rapports [Reporting Services]"
  - "scripts [Reporting Services], déploiements"
  - "transfert de rapports"
  - "rapports [Reporting Services], migration"
...
|Sauvegarder les clés de chiffrement.|Choisissez l'une des approches suivantes pour automatiser la sauvegarde des clés de chiffrement :<br /><br /> -   Exécutez l’utilitaire rskeymgmt.exe pour sauvegarder les clés. Pour plus d’informations, consultez [Back Up and Restore Reporting Services Encryption Keys](../../reporting-services/install-windows/back-up-and-restore-reporting-services-encryption-keys.md).<br />-   Écrivez le code personnalisé à exécuter sur le fournisseur WMI Report Server.|  
...
## Voir aussi  
 [Méthode GenerateDatabaseCreationScript &#40;WMI MSReportServer_ConfigurationSetting&#41;](../../reporting-services/wmi-provider-library-reference/generatedatabasecreationscript-method-wmi-msreportserver-configurationsetting.md)   
 [Méthode GenerateDatabaseRightsScript &#40;WMI MSReportServer_ConfigurationSetting&#41;](../../reporting-services/wmi-provider-library-reference/generatedatabaserightsscript-method-wmi-msreportserver-configurationsetting.md)   
 [Méthode GenerateDatabaseUpgradeScript &#40;WMI MSReportServer_ConfigurationSetting&#41;](../../reporting-services/wmi-provider-library-reference/generatedatabaseupgradescript-method-wmi-msreportserver-configurationsetting.md)   
