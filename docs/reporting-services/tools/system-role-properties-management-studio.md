...
description: Découvrez les options de la page Rôles système dans laquelle vous pouvez voir les définitions des rôles système qui sont actuellement configurées pour le serveur de rapports.
ms.date: 03/14/2017
