...
description: Découvrez comment utiliser les options de la boîte de dialogue Annuler les travaux du serveur de rapports pour afficher ou annuler les rapports en cours.
ms.date: 03/01/2017
