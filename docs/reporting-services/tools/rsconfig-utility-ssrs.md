---
title: "Utilitaire rsconfig (SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/20/2017"
...
helpviewer_keywords: 
  ...
  - "utilitaires d’invite de commandes [SQL Server], rsconfig"
...
|----------|------------------------|----------------|  
|**-?**|Ce paramètre est facultatif.|Affiche la syntaxe des arguments de Rsconfig.exe.|  
...
#### Spécification d'un compte d'utilisateur de base de données SQL Server  
...
#### Spécification d'un compte prédéfini  
...
#### Spécification d'un compte de service  
...
#### Spécification du compte sans assistance sur un serveur local  
...
#### Spécification du compte sans assistance sur un serveur distant  
