...
description: Découvrez comment définir les propriétés système du serveur de rapports dans SQL Server Management Studio afin d’activer des fonctionnalités ou de définir les valeurs par défaut du serveur.
ms.date: 03/20/2017
