...
description: Découvrez comment utiliser le mode Création dans le Concepteur de rapports Reporting Services afin d’organiser les éléments d’un rapport.
ms.date: 05/31/2016
