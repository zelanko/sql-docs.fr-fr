...
description: Découvrez comment Reporting Services fournit le Gestionnaire des alertes de données pour permettre aux travailleurs de l’information SharePoint de gérer les alertes de données.
ms.date: 07/02/2017
