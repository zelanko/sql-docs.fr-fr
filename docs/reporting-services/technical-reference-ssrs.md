---
title: "Informations techniques de référence (SSRS) | Documents Microsoft"
ms.custom: 
ms.date: 05/30/2017
...
# <a name="technical-reference-ssrs"></a>Références techniques (SSRS)
  ...
  Trouvez les outils et la documentation de référence PowerShell pour utiliser ou administrer SQL Server Reporting Services.  
 ...
 ![Icône de dossier petit fichier](../analysis-services/media/filefolder-small.png "petite icône du dossier") **utilitaires d’invite de commandes de serveur de rapports**  
 ...
 ![Icône de dossier petit fichier](../analysis-services/media/filefolder-small.png "petite icône du dossier") **Reporting Services bibliothèque de classe du fournisseur WMI**  
 [Reporting Services référence de bibliothèque du fournisseur WMI &#40; SSRS &#41;](../reporting-services/wmi-provider-library-reference/reporting-services-wmi-provider-library-reference-ssrs.md)  
