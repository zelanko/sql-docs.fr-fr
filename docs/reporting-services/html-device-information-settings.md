...
ms.topic: "article"
helpviewer_keywords: 
  - "HTML [Reporting Services], rendu"
  - "paramètres d'informations sur l'appareil [Reporting Services], rendu HTML"
