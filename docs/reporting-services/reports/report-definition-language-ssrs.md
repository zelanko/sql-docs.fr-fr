...
helpviewer_keywords: 
  ...
  - "RDL [Reporting Services], à propos du langage RDL (Report Definition Language)"
  - "SSRS, RDL"
  - "RDL (Report Definition Language), à propos de RDL (Report Definition Language)"
  - "Report Definition Language (RDL)"
  - "RDL [Reporting Services]"
  - "rapports [Reporting Services], définitions"
...
|**Booléen**|Propriété de l’objet ayant pour valeur **true** ou **false**. Sauf indication contraire, la valeur d’un objet Boolean facultatif omis est **False**.|  
...
|**Entier**|Propriété dotée d'une valeur entière (int32).|  
