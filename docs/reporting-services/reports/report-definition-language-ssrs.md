...
description: Découvrez plus en détail le langage RDL. Vous verrez que le langage RDL est une représentation XML d’une définition de rapport SQL Server Reporting Services.
ms.date: 01/24/2019
