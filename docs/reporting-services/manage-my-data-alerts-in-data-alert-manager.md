...
description: Découvrez comment afficher la liste des alertes de données créées et les informations les concernant dans le Gestionnaire des alertes de données.
ms.date: 08/17/2017
