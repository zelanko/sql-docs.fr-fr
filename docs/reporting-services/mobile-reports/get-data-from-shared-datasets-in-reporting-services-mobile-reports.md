...
description: L’éditeur de rapports mobiles SQL Server peut accéder aux données provenant de quasiment n’importe quelle source à l’aide d’une source de données partagée et configurée sur un portail web Reporting Services.
ms.date: 03/30/2017
