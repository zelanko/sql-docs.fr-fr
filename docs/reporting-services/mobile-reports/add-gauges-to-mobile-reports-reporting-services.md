...
2. Sous Filtré par, sélectionnez le navigateur avec lequel vous voulez filtrer la jauge.
   ...
   ![Capture d’écran des options développées de Valeur principale, avec l’option Filtrer par liste de produits sélectionnée.](../../reporting-services/mobile-reports/media/mobile-report-gauge-navigator.png)
