...
description: Une fois que vous avez créé un rapport mobile Reporting Services dans l’éditeur de rapports mobiles SQL Server, vous pouvez concevoir une version pour téléphone et tablette.
ms.date: 03/01/2017
...
1. Dans le coin supérieur droit de [!INCLUDE[SS_MobileReptPub_Short](../../includes/ss-mobilereptpub-short.md)], sélectionnez l’icône de disposition, puis choisissez **Téléphone** ou **Tablette**.  
