...
description: L’éditeur de rapports mobiles SQL Server prend en charge les opérations de données complexes, telles que le filtrage, l’agrégation et le découpage temporel. Découvrez comment préparer les données pour ces opérations.
ms.date: 02/08/2016
