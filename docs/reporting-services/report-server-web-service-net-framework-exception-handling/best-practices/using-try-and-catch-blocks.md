...
description: Découvrez comment fournir une couche de protection supplémentaire contre les requêtes non valides en appliquant une gestion adaptée des exceptions via l’utilisation de blocs try/catch.
ms.date: 03/06/2017
