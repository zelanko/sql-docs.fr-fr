...
description: Apprenez-en davantage sur les limites de taille de rapport quand un rapport est publié sur Report Server, rendu au moment de l’exécution et enregistré dans le système de fichiers.
ms.date: 03/14/2017
