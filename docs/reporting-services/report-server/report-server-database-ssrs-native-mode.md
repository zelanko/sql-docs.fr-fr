---
title: "Serveur de base de données (SSRS en Mode natif) rapports | Documents Microsoft"
ms.custom: 
ms.date: 03/14/2017
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Administrer une base de données du serveur de rapports &#40; En Mode natif de SSRS &#41;](../../reporting-services/report-server/administer-a-report-server-database-ssrs-native-mode.md)   
