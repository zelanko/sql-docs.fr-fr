...
description: Découvrez comment activer et désactiver la fonctionnalité Mes rapports dans Reporting Services. Mes rapports fournit un stockage dans la base de données du serveur de rapports pour les utilisateurs.
ms.date: 03/01/2017
