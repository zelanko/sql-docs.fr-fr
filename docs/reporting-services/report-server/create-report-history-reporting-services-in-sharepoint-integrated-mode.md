...
description: Dans Reporting Services en mode intégré SharePoint, découvrez comment créer un historique de rapport, qui est une collection d’instantanés de rapport que vous créez au fil du temps.
ms.date: 03/01/2017
