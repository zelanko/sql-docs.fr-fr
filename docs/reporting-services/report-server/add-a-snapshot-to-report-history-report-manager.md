---
title: "ajout d&#39;un instantan&#233; &#224; un historique de rapport (Gestionnaire de rapports) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "historique de rapport [Reporting Services], ajout de captures instantanées"
  - "données historiques [Reporting Services]"
  - "instantanés [Reporting Services], ajout de captures instantanées de rapports"
  - "ajout d'instantanés à l'historique de rapport"
  - "captures instantanées de rapport [Reporting Services], ajout"
...
### Pour ajouter manuellement des instantanés à un historique de rapport  
...
### Pour ajouter automatiquement tous les instantanés à un historique de rapport  
...
### Pour ajouter automatiquement tous les instantanés à un historique de rapport planifié  
