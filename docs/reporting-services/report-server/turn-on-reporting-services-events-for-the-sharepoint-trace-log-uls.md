...
|Gestionnaire de configuration service Web Report Server|Entrées témoin :<br /><br /> Url interne du serveur de rapports mediumusing http://localhost `http://localhost:80/ReportServer`.<br /><br /> Paramètre UnexpectedMissing ou Invalid ExtendedProtectionLevel|  
