...
description: Découvrez comment afficher les messages d’événements dans le journal des applications qui sont générés par les applications du serveur de rapports exécutées sur le système local.
ms.date: 03/01/2017
