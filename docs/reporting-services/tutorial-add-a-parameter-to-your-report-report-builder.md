...
---
# Didacticiel&#160;: ajouter un param&#232;tre &#224; un rapport (G&#233;n&#233;rateur de rapports)
...
1.  [Créer un rapport de matrice et un dataset dans l’Assistant Tableau ou matrice](#Setup)  
  
2.  [Organiser les données et choisir la disposition dans l’Assistant](#CompleteWizard)  
...
4.  [Modifier le type de données par défaut et d'autres propriétés pour un paramètre de rapport](#ChangeDefaultProperties)  
    ...
    2.  [Spécifier les valeurs disponibles à afficher dans une liste](#AvailableValues)  
  
    3.  [Spécifier une valeur par défaut](#DefaultValues)  
  
    4.  [Rechercher une paire nom/valeur](#NameValue)  
...
7.  Dans **Invite**, remplacez **Identificateur du magasin ?** par **Nom du magasin ?**.  
...
6.  Remplacez le **signe égal** (=) par **IN** dans la clause [!INCLUDE[tsql](../includes/tsql-md.md)] **WHERE** dans la dernière ligne de la requête :  
...
*  [Fonction Lookup](../reporting-services/report-design/lookup-function-report-builder-and-ssrs.md)   
