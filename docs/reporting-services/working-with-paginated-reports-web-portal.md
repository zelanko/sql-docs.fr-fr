...
> [!NOTE] Si vous ne voyez pas de rapports paginés dans le dossier, vérifiez que vous affichez bien les rapports paginés. Vous pouvez sélectionner **Afficher** dans la barre de menus dans le coin supérieur droit du portail web. Vérifiez que **Rapports paginés** est coché.  
...
> [!NOTE] Cela n’actualise pas le cache.  
