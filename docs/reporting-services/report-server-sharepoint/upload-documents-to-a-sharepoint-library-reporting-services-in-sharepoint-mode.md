...
description: Dans SQL Server Reporting Services en mode SharePoint, vous pouvez charger des définitions de rapport et des modèles de rapport sur une bibliothèque SharePoint.
ms.date: 09/25/2017
