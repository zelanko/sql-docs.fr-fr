...
-   [Exemples de base de PowerShell pour Reporting Services](#bkmk_basic_samples)  
  
-   [Exemples détaillés de PowerShell pour Reporting Services](#bkmk_detailedsamples)  
    ...
    -   [Obtenir et définir les propriétés de la base de données d’application Reporting Services](#bkmk_example_db_properties)  
  
    -   [Répertorier les extensions de données Reporting Services](#bkmk_example_list_data_extensions)  
  
    -   [Modifier et répertorier les propriétaires d’abonnements Reporting Services](#bkmk_change_subscription_owner)  
