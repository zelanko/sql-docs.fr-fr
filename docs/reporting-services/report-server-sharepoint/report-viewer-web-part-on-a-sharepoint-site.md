...
### Action d'exportation sur la barre d'outils Rapport  
...
### Action d'impression sur la barre d'outils Rapport  
...
### Action de Recherche sur la barre d'outils Rapport  
...
### Volets destinés à la définition des paramètres et des informations d'identification  
...
### Définition des propriétés du composant WebPart Visionneuse de rapports  
