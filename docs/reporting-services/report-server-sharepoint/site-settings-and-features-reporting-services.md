---
title: "Paramètres du site de Reporting Services et fonctionnalités (mode SharePoint) de site | Documents Microsoft"
ms.custom: 
ms.date: 09/25/2017
...
---
# <a name="reporting-services-site-settings-and-site-features-sharepoint-mode"></a>Rapports des paramètres de site des Services et fonctionnalités du site (mode SharePoint)

[!INCLUDE[ssrs-appliesto](../../includes/ssrs-appliesto.md)] [!INCLUDE[ssrs-appliesto-2016](../../includes/ssrs-appliesto-2016.md)] [!INCLUDE[ssrs-appliesto-sharepoint-2013-2016i](../../includes/ssrs-appliesto-sharepoint-2013-2016.md)] [!INCLUDE[ssrs-appliesto-not-pbirsi](../../includes/ssrs-appliesto-not-pbirs.md)])

[!INCLUDE [ssrs-previous-versions](../../includes/ssrs-previous-versions.md)]

Reporting Services en mode SharePoint ont plusieurs fonctionnalités personnalisées au niveau du site et fonctionnalité de site qui peut être gérée à partir de la page Paramètres du Site SharePoint. Les paramètres sont larges à un site et affectent toutes les applications de service Reporting Services. Vous devez disposer des autorisations de gestionnaire de contenu et d'administrateur système pour consulter cette page.  
...
|------------------|-----------------|  
|Paramètres du Site Reporting Services|Paramètres de site décrites dans cette rubrique.|  
...
## <a name="open-the-reporting-services-site-settings-page"></a>Ouvrez la page Paramètres du site Reporting Services
  
1.  À partir du site SharePoint **Actions du Site** menu, sélectionnez **paramètres du Site**.  
  
2.  Dans le **Reporting Services** section, sélectionnez **paramètres du Site Reporting Services**.  
  
## <a name="options-for-reporting-services-site-settings"></a>Options pour les paramètres de site de Reporting Services
