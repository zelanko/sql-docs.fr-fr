...
2.  Allez à **Paramètres du site**.  
    ...
    -   Dans SharePoint 2013, cliquez sur l'icône **Paramètres** . ![Paramètres SharePoint](/analysis-services/analysis-services/media/as-sharepoint2013-settings-gear.gif "Paramètres SharePoint")  
...
4.  Recherchez **Fonctionnalité d'intégration Report Server** dans la liste et cliquez sur **Désactiver**.  
     ...
     ![Capture d’écran de la fonctionnalité d’intégration Report Server montrant les options Désactiver et Activer.](../../reporting-services/report-server-sharepoint/media/rs-reportserver-integration-active.gif "rs_reportserver_integration_active")  
  
5.  Actualisez le navigateur, puis cliquez sur **Activer** pour la **Fonctionnalité d'intégration Report Server**.  
  
     ![Capture d’écran de la fonctionnalité d’intégration Report Server montrant l’option Activer.](../../reporting-services/report-server-sharepoint/media/rs-reportserver-integration-deactivate.gif)  
...
##  <a name="to-enable-content-type-management-for-a-single-document-library-sharepoint-2010"></a><a name="bkmk_enable_content_management_2010"></a> Pour activer la gestion des types de contenu pour une bibliothèque de documents (SharePoint 2010)  
