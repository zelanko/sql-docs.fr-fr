---
title: "Fonctionnalités déconseillées dans SQL Server Reporting Services dans SQL Server 2016 | Documents Microsoft"
ms.custom: 
ms.date: 03/16/2017
...
---
# <a name="deprecated-features-in-sql-server-reporting-services-ssrs"></a>Fonctionnalités déconseillées dans SQL Server Reporting Services (SSRS)
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Compatibilité descendante | Reporting Services](../reporting-services/reporting-services-backward-compatibility.md)   
