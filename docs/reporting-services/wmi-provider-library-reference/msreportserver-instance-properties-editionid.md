---
title: "Propriété de EditionID (WMI MSReportServer_Instance) | Documents Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="msreportserverinstance-properties---editionid"></a>Propriétés MSReportServer_Instance - EditionID
