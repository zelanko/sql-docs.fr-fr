...
apitype: "MOFDef"
helpviewer_keywords: 
  - "fournisseur WMI [Reporting Services], classe MSReportServer_Instance"
...
# Classe MSReportServer_Instance
 ...
 Pour obtenir la liste de tous les membres de ce type, consultez [MSReportServer_Instance Members](../../reporting-services/wmi-provider-library-reference/msreportserver-instance-members.md)  
