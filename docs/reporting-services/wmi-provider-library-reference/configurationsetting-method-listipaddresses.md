---
description: Méthode ListIPAddresses (WMI MSReportServer_ConfigurationSetting)
...
## <a name="remarks"></a>Notes  
 ...
 Si *IsDhcpEnabled* a la valeur **True**, l' *IPAddress* est dynamique. Elle ne doit pas être utilisée pour les liaisons TLS.  
