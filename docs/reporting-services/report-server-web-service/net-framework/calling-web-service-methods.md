...
description: Appelez les méthodes d’une classe proxy pour effectuer des opérations de création de rapports sur le serveur de rapports. Les méthodes de service web ont un accès public et nécessitent les arguments appropriés.
ms.date: 03/14/2017
