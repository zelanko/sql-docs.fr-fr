...
description: Certaines propriétés des types complexes du service Web Report Server prennent en charge la propriété Specified, qui vous permet d’omettre une valeur pour certaines propriétés accessibles en écriture.
ms.date: 03/04/2017
