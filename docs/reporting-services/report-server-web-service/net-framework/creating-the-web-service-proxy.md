...
description: Un service client et web peut communiquer en utilisant des messages SOAP. Ajoutez une classe proxy à votre projet pour mapper des paramètres à des éléments XML et envoyer des messages SOAP.
ms.date: 03/14/2017
