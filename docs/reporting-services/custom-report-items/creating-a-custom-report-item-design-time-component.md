...
description: Découvrez comment créer un composant design-time d’élément de rapport personnalisé. Ce composant fournit une aire de conception activée qui accepte les opérations de glisser-déplacer.
ms.date: 03/14/2017
