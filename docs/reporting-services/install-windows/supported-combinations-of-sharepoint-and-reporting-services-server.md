...
|Number|Serveur de rapports|Complément|Version SharePoint|
|-|-------------------|-------------|------------------------|
...
|12|SQL Server 2008 R2|SQL Server 2012 et SQL Server 2012 SP1 ou version ultérieure|SharePoint 2010|
...
## <a name="next-steps"></a>Étapes suivantes
 ...
 [Fonctionnalités prises en charge par les éditions de SQL Server 2016](~/sql-server/editions-and-components-of-sql-server-2017.md)   
