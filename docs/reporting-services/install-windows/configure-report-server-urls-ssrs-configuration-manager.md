...
ms.topic: "article"
helpviewer_keywords: 
  - "service Report Server Windows, répertoires virtuels"
  - "serveurs de rapports [Reporting Services], répertoires virtuels"
  - "répertoires virtuels [Reporting Services]"
  - "gestionnaire de rapports [Reporting Services], répertoires virtuels"
...
---
# Configurer des URL de serveurs de rapports (Gestionnaire de configuration de SSRS)
