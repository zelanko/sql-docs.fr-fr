---
title: "Configurer un d&#233;ploiement par mont&#233;e en puissance parall&#232;le de serveurs de rapports en mode natif (Gestionnaire de configuration de SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "serveurs de rapports [Reporting Services], déploiements"
  - "déploiement [Reporting Services], modèle de déploiement avec montée en puissance parallèle"
...
manager: "erikre"
---
# Configurer un d&#233;ploiement par mont&#233;e en puissance parall&#232;le de serveurs de rapports en mode natif (Gestionnaire de configuration de SSRS)
...
-   Pour obtenir des instructions sur l’installation d’instances de serveur de rapports, examinez [Installer SQL Server 2016 avec l’Assistant Installation &#40;programme d’installation&#41;](../../database-engine/install-windows/install-sql-server-2016-from-the-installation-wizard-setup.md) dans la documentation en ligne [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
...
## Pour installer une instance de SQL Server en vue d'héberger les bases de données du serveur de rapports  
...
## Pour installer et configurer la deuxième instance du serveur de rapports  
...
## Pour joindre la deuxième instance de serveur de rapports au déploiement avec montée en puissance parallèle  
