...
ms.topic: "article"
helpviewer_keywords: 
  - "configuration d'URL [Reporting Services]"
...
---
# URL des fichiers de configuration (Gestionnaire de configuration de SSRS)
...
#### URL connectant le [!INCLUDE[ssRSWebPortal](../../includes/ssrswebportal.md)] et les composants WebPart au service Web Report Server  
