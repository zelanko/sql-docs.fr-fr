...
manager: "erikre"
---
# Cr&#233;er une base de donn&#233;es du serveur de rapports en mode natif (Gestionnaire de configuration de SSRS)
...
## Quand créer ou configurer les bases de données de serveur de rapports  
 ...
 **Sélectionner un serveur de base de données**  
 Consultez les versions prises en charge du [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)] dans [Créer une base de données du serveur de rapports &#40;Gestionnaire de configuration de SSRS&#41;](../../reporting-services/install-windows/create-a-report-server-database-ssrs-configuration-manager.md).  
