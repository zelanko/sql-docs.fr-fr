---
title: "Installation c&#244;te &#224; c&#244;te de Reporting Services et d&#39;Internet Information Services (SSRS en mode natif) | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "déploiement [Reporting Services] IIS"
...
|Exemple|Demande|  
|-------------|-------------|  
|http://123.234.345.456:80/reports|Reçoit toutes les requêtes envoyées à http://123.234.345.456/reports ou http://\<nom_ordinateur>/reports si un service de nom de domaine peut convertir l’adresse IP vers ce nom d’hôte.|  
...
## Réservations d’URL pour IIS 8.0, 8.5 avec [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Reporting Services  
...
## Déploiements côte à côte de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] et de SQL Server 2016 Reporting Services sur IIS 8.0, 8.5  
...
-   Instance du serveur de rapports [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] installée dans la configuration par défaut, où la réservation d’URL spécifie également le port 80 et où l’application [!INCLUDE[ssRSWebPortal-Non-Markdown](../../includes/ssrswebportal-non-markdown-md.md)] utilise également « Reports » comme nom de répertoire virtuel.  
  
 Avec cette configuration, une requête envoyée à http://\<nom_ordinateur>: 80/reports sera reçue par le [!INCLUDE[ssRSWebPortal-Non-Markdown](../../includes/ssrswebportal-non-markdown-md.md)]. L'application accessible via le répertoire virtuel Reports dans IIS ne reçoit plus de requêtes une fois que l'instance du serveur de rapports [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] est installée.  
