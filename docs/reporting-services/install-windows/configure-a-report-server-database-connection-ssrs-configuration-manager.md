...
ms.topic: "article"
helpviewer_keywords: 
  - "connexions [Reporting Services], configuration"
  - "connexions [Reporting Services]"
  - "serveurs de rapports [Reporting Services], connexions"
  - "base de données du serveur de rapports"
  - "bases de données [Reporting Services], connexions"
  - "sécurité [Reporting Services], connexions de base de données"
...
### Stockage des informations de connexion à la base de données  
 ...
 Certaines valeurs ne sont pas définies pour tous les types de connexion. Si vous configurez la connexion à l’aide de valeurs par défaut (c’est-à-dire avec des comptes de service pour établir la connexion), \<**LogonUser**>, \<**LogonDomain**> et \<**LogonCred**> apparaîtront vides, comme ceci :  
