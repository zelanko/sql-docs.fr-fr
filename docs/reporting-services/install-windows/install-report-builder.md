...
## Installez l’ [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] à partir d’un portail web ou d’une bibliothèque SharePoint 
...
### Site SharePoint intégré avec [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]
...
## Installer [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] avec System Center Configuration Manager 
...
## Pour installer [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] à partir d’un partage  
...
## Pour installer l’ [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] à partir de la ligne de commande 
...
## Définir les paramètres par défaut de l’ [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)]  
