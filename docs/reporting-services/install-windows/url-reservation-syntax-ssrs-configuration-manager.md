---
description: Syntaxe de réservation d’URL (Gestionnaire de configuration du serveur de rapports)
...
ms.locfileid: "91934131"
---
# <a name="url-reservation-syntax--report-server-configuration-manager"></a>Syntaxe de réservation d’URL (Gestionnaire de configuration du serveur de rapports)
