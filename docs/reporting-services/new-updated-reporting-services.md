---
title: "Mise à jour - Reporting Services pour la documentation de SQL Server | Documents Microsoft"
description: "Extraits de l’affichage de contenu mis à jour pour obtenir une documentation récemment modifié, pour Reporting Services pour Microsoft SQL Server."
services: na
documentationcenter: 
author: MightyPen
manager: jhubbard
...
1. [Ajouter le composant WebPart Visionneuse de rapports à une page SharePoint](report-server-sharepoint/add-report-viewer-web-part-to-page.md)
2. [Déployer le composant WebPart Visionneuse de rapports sur un site SharePoint](report-server-sharepoint/deploy-report-viewer-web-part.md)
