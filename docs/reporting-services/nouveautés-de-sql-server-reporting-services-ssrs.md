---
title: "Nouveaut&#233;s de Reporting Services (SSRS) | Microsoft Docs"
ms.date: "03/14/2017"
ms.prod: "sql-vnext"
ms.reviewer: ""
ms.suite: ""
...
helpviewer_keywords: 
  ...
  - "Reporting Services, nouveautés"
  - "SQL Server Reporting Services, nouveautés"
  - "SSRS, nouveautés"
...
Découvrez les nouveautés de SQL Server [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]. Cette rubrique, qui aborde les fonctionnalités majeures, est mise à jour à mesure de la sortie de nouveaux éléments.
  ...
  Pour plus d’informations sur les nouveautés concernant d’autres aspects de SQL Server, consultez les articles [Nouveautés de SQL Server vNext](../sql-server/what-s-new-in-sql-server-vnext.md) ou [Nouveautés de SQL Server 2016](../sql-server/what-s-new-in-sql-server-2016.md).
...
-   Vous avez un compte Azure ?  Puis cliquez **[ici](https://azure.microsoft.com/en-us/marketplace/partners/microsoft/sqlserver2016sp1enterprisewindowsserver2016/)** pour lancer une machine virtuelle sur laquelle [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] est déjà installé.  
  
 ![remarque](../analysis-services/instances/install-windows/media/ssrs-fyi-note.png "remarque") Pour les notes de publication actuelles, consultez les articles [Technical Preview of Power BI reports in SSRS - Release notes (Version d’évaluation technique des rapports Power Bi dans SSRS - Notes de publication)](../reporting-services/notes-de-publication-sur-reporting-services.md) ou [Notes de publication de SQL Server 2016](../sql-server/sql-server-2016-release-notes.md).  

## <a name="whats-new-in-the-january-2017-technical-preview-of-power-bi-reports-in-sql-server-reporting-services"></a>Nouveautés de la version d’évaluation technique de janvier 2017 des rapports Power BI de SQL Server Reporting Services

### <a name="reporting-services-has-a-new-setup-experience"></a>Reporting Services dispose d’un nouveau système d’installation

Reporting Services peut désormais être installé en dehors du programme d’installation de SQL Server. Le système d’installation possède moins d’étapes et est plus léger. Le programme d’installation installe les fichiers de Reporting Services. Vous pouvez ensuite configurer la base de données de votre serveur de rapports. Cette opération nécessite que vous disposiez d’un accès à un serveur de moteur de base de données SQL Server dans votre environnement.

![ssrs-standalone-setup1](../reporting-services/media/ssrs-standalone-setup1.png)

Pour plus d’informations, consultez l’article [Install the January 2017 Technical Preview of Power BI reports in SQL Server Reporting Services (Installer la version d’évaluation technique de janvier 2017 des rapports Power BI de SQL Server Reporting Services)](Install%20the%20January%202017%20Technical%20Preview%20of%20Power%20BI%20reports%20in%20SQL%20Server%20Reporting%20Services.md).

### <a name="host-power-bi-reports-within-the-web-portal"></a>Héberger les rapports Power BI dans le portail web

Vous pouvez désormais charger vos fichiers Power BI Desktop sur Reporting Services et afficher les rapports directement dans le portail web.

![ssrs-powerbi-report-config-render](../reporting-services/media/ssrs-powerbi-report-config-render.png)

Vous devez télécharger la version Power BI Desktop (SQL Server Reporting Services). Pour le moment, la version d’évaluation ne prend en charge que les rapports créés dans cette version Power BI Desktop. Power BI Desktop (SQL Server Reporting Services) peut coexister avec Power BI Desktop pour le service Power BI. Pour télécharger Power BI Desktop (SQL Server Reporting services), accédez au Centre de téléchargement Microsoft. 

Pour le moment, vous êtes cantonné à la création d’un rapport Power BI sur des connexions actives à Analysis Services (tabulaire ou multidimensionnel). Nous prévoyons d’ajouter la prise en charge d’autres sources de données et d’utiliser les fonctionnalités Power Query dans une prochaine version d’évaluation.

Pour plus d’informations, consultez l’article [Power BI reports in Reporting Services (Rapports Power BI dans Reporting Services)](../reporting-services/power-bi-reports-in-reporting-services.md).
 
## <a name="whats-new-in-sql-server-2016"></a>Nouveautés de SQL Server 2016
  
### <a name="reporting-services-includessrswebportal-non-markdowntokenssrswebportal-non-markdownmdmd"></a>[!INCLUDE[ssRSWebPortal-Non-Markdown](../includes/ssrswebportal-non-markdown-md.md)] Reporting Services  
 ...
 #### <a name="custom-branding-for-the-includessrswebportal-non-markdowntokenssrswebportal-non-markdownmdmd"></a>Personnaliser le [!INCLUDE[ssRSWebPortal-Non-Markdown](../includes/ssrswebportal-non-markdown-md.md)] 
  ...
  Pour plus d’informations sur la personnalisation, consultez [Personnalisation du portail web](http://msdn.microsoft.com/fr-fr/6dac97f7-02a6-4711-81a3-e850a6b40bf1).
 
 #### <a name="key-performance-indicators-kpi-in-the-includessrswebportal-non-markdowntokenssrswebportal-non-markdownmdmd"></a>Indicateurs de performance clé (KPI) dans le [!INCLUDE[ssRSWebPortal-Non-Markdown](../includes/ssrswebportal-non-markdown-md.md)] 
...
Vous pouvez créer directement dans le [!INCLUDE[ssRSWebPortal-Non-Markdown](../includes/ssrswebportal-non-markdown-md.md)] des indicateurs de performance clés ayant pour contexte le dossier dans lequel vous vous trouvez. Quand vous créez des indicateurs de performance clés, vous pouvez choisir les champs du dataset et synthétiser ces valeurs. Vous pouvez également sélectionner le contenu associé pour explorer au niveau du détail.
 ...
 Pour plus d’informations, consultez [Utilisation des indicateurs de performance clés dans le portail web](http://msdn.microsoft.com/fr-fr/a28cf500-6d47-4268-a248-04837e7a09eb)
...
#### <a name="mobile-report-publisher"></a>Éditeur de rapports mobiles  
 L’[!INCLUDE[SS_MobileReptPub_Long](../includes/ss-mobilereptpub-long-md.md)] vous permet de créer et de publier des rapports mobiles SQL Server sur votre [!INCLUDE[ssRSWebPortal-Non-Markdown](../includes/ssrswebportal-non-markdown-md.md)] [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)].  
...
**Prise en charge des résolutions élevées :** le [!INCLUDE[ssRBnoversion](../includes/ssrbnoversion-md.md)] pour [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]prend en charge les appareils et la mise à l’échelle haute résolution.  Pour plus d’informations sur la haute résolution, consultez les documents suivants :  
...
## <a name="see-also"></a>Voir aussi  
 [Nouveautés d’Analysis Services](http://msdn.microsoft.com/fr-fr/aa69c299-b8f4-4969-86d8-b3292fe13f08)  
 [Technical Preview of Power BI reports in SSRS - Release notes (Version d’évaluation technique des rapports Power Bi dans SSRS - Notes de publication)](../reporting-services/notes-de-publication-sur-reporting-services.md)  
 [Notes de publication de SQL Server 2016](../sql-server/sql-server-2016-release-notes.md)   
 [Compatibilité descendante](http://msdn.microsoft.com/fr-fr/675b0e0e-cfee-4790-9675-80fc3ea6d30f)   
 [Fonctionnalités Reporting Services prises en charge par les éditions de SQL Server 2016](http://msdn.microsoft.com/fr-fr/39f03d2d-6e48-4b34-a9d3-07f86313b937)   
