...
## [Spécifier les paramètres d’informations d’appareil dans une URL](specify-device-information-settings-in-a-url.md)  
...
## [Paramètres d’informations d’appareil pour les extensions de rendu](device-information-settings-for-rendering-extensions-reporting-services.md)  
### [Paramètres d’informations d’appareil ATOM](atom-device-information-settings.md)  
### [Paramètres d’informations d’appareil CSV](csv-device-information-settings.md)  
### [Paramètres d’informations d’appareil Excel](excel-device-information-settings.md)  
### [Paramètres d'informations d’appareil HTML](html-device-information-settings.md)  
...
### [Paramètres d'informations d’appareil PDF](pdf-device-information-settings.md)  
### [Paramètres d’informations d’appareil PPTX](pptx-device-information-settings.md)  
### [Paramètres d’informations d’appareil XML](xml-device-information-settings.md)  
### [Paramètres d’informations d’appareil Word](word-device-information-settings.md)  
### [Paramètres d’informations d’appareil RGDI](rgdi-device-information-settings.md)  
