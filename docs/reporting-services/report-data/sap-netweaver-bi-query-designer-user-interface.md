---
title: "Interface utilisateur du Concepteur de SAP NetWeaver BI requête | Documents Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
## <a name="graphical-query-designer-in-design-mode"></a>Concepteur de requêtes graphique en mode Création  
 ...
 ![Concepteur de requêtes avec MDX en Mode Création](../../reporting-services/report-data/media/rsqd-dssapbw-mdx-designmode.gif "Concepteur de requêtes à l’aide de MDX en Mode Création")  
...
## <a name="graphical-query-designer-in-query-mode"></a>Concepteur de requêtes graphique en mode Requête  
 ...
 ![Le Concepteur de requêtes SAP BW MDX en mode requête](../../reporting-services/report-data/media/rsqd-dssapbw-mdx-querymode.gif "le Concepteur de requêtes SAP BW MDX en mode de requête")  
