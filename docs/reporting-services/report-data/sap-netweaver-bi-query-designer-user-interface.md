...
f1_keywords: 
  ...
  - "10014"
helpviewer_keywords: 
  - "Source de données [Reporting Services], SAP NetWeaver Business Intelligence"
  - "SAP NetWeaver Business Intelligence [Reporting Services], concepteur de requêtes"
...
## Concepteur de requêtes graphique en mode Requête  
 ...
 ![Concepteur de requêtes SAP BW MDX en mode Affichage des requêtes](../../reporting-services/report-data/media/rsqd-dssapbw-mdx-querymode.gif "Concepteur de requêtes SAP BW MDX en mode Affichage des requêtes")  
...
-   **Supprimer** (![Supprimer](../../reporting-services/report-data/media/rsqdicon-delete.png "Supprimer"))  
