...
description: Découvrez les utilisations des paramètres de rapport de Reporting Services, les propriétés que vous pouvez définir et comment associer un paramètre de requête de jeu de données à un paramètre de rapport.
ms.date: 03/01/2017
