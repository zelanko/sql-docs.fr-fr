...
ms.topic: "article"
helpviewer_keywords: 
  - "fichiers Office Data Connection (.odc)"
  - "intégration SharePoint [Reporting Services], sources de données partagées"
  - "fichiers .odc"
...
manager: "erikre"
---
# Utiliser une connexion de donn&#233;es Office (.odc) avec les rapports (Reporting Services en mode int&#233;gr&#233; SharePoint)
...
### Pour télécharger et utiliser un fichier .odc  
