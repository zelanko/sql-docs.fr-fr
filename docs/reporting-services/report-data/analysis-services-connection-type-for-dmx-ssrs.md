...
description: Découvrez le type de connexion Analysis Services pour DMX et apprenez à utiliser le concepteur de requêtes DMX pour créer une requête DMX à l’aide d’éléments graphiques.
ms.date: 03/14/2017
