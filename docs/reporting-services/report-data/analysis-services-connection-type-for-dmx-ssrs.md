...
ms.topic: "article"
helpviewer_keywords: 
  - "paramètres [Reporting Services], DMX"
  - "prédiction d'exploration de données [Reporting Services]"
  - "vue de requête [Reporting Services]"
  - "DMX [Reporting Services]"
  - "vue de conception [Reporting Services]"
  - "exploration de données [Reporting Services]"
  - "passage de paramètres [Reporting Services]"
