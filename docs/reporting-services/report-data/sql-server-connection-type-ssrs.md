...
description: Découvrez le type de connexion SQL Server et l’inclusion de données à partir d’une base de données SQL Server dans votre rapport.
ms.date: 08/17/2018
