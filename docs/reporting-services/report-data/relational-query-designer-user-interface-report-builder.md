...
description: Découvrez comment utiliser le Concepteur de requêtes graphique pour explorer les métadonnées, créer une requête de manière interactive et afficher les résultats de votre requête.
ms.date: 03/14/2017
...
#### <a name="group-and-aggregate"></a>Groupe et agrégat  
 ...
 Pour plus d’informations sur [!INCLUDE[tsql](../../includes/tsql-md.md)], consultez [Référence Transact-SQL &#40;moteur de base de données&#41;](../../t-sql/language-reference.md).  
