...
ms.topic: "article"
helpviewer_keywords: 
  - "paramètres [Reporting Services], MDX"
  - "expressions multidimensionnelles [Reporting Services]"
  - "prédiction d'exploration de données [Reporting Services]"
  - "MDX [Reporting Services], définition de paramètres"
...
3.  Dans la barre d’outils du Concepteur de requêtes MDX, cliquez sur le bouton **Paramètres de la requête** \(![Icône de la boîte de dialogue Paramètres de la requête](../../reporting-services/report-data/media/iconqueryparameter.png "Icône de la boîte de dialogue Paramètres de la requête")). La boîte de dialogue Paramètres de la requête s'ouvre.  
