...
helpviewer_keywords: 
  ...
  - "Fournisseurs de données .NET Framework pour Reporting Services"
...
## Inscription d'un fournisseur de données .NET Framework sur le serveur de rapports  
...
## Inscription d'un fournisseur de données .NET Framework sur le client du Concepteur de rapports  
