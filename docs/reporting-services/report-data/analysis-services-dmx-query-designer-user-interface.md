...
helpviewer_keywords: 
  ...
  - "DMX [Analysis Services], interface utilisateur"
  - "concepteurs de requêtes [DMX]"
...
|![Change to MDX query view](../../reporting-services/report-data/media/rsqdicon-commandtypemdx.gif "Change to MDX query view")|Bascule vers le mode Concepteur de requêtes MDX.|  
|![Basculer vers l'affichage de langage de requête DMX](../../reporting-services/report-data/media/rsqdicon-commandtypedmx.png "Basculer vers l'affichage de langage de requête DMX")|Bascule vers le mode Concepteur de requêtes DMX.|  
...
|![Exécuter la requête](../../reporting-services/report-data/media/rsqdicon-run.png "Exécuter la requête")|Prépare la requête.|  
|![Basculer en mode Création](../../reporting-services/media/rsqdicon-designmode.png "Basculer en mode Création")|Bascule entre le mode Création et le mode Requête. Pour passer d’une vue de résultat à l’autre, cliquez avec le bouton droit dans le volet Création et choisissez **Résultat**.|  
...
## Concepteur de requêtes graphique DMX en mode Requête  
 ...
 ![Concepteur de requêtes DMX Analysis Services, affichage des requêtes](../../reporting-services/report-data/media/rsqd-dsawas-dmx-querymode.gif "Concepteur de requêtes DMX Analysis Services, affichage des requêtes")  
...
## Concepteur de requêtes graphique DMX en mode Résultat  
 ...
 ![Concepteur de requêtes DMX Analysis Services, affichage du résultat](../../reporting-services/report-data/media/rsqd-dsawas-dmx-resultmode.gif "Concepteur de requêtes DMX Analysis Services, affichage du résultat")  
