...
> Pour obtenir un contenu pour les versions précédentes de SQL Server, consultez [Reporting Services (SSRS)](https://msdn.microsoft.com/en-US/library/ms159106(SQL.120).aspx).
