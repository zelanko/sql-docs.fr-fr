 ...
 **Pour plus d’informations :** [Gestion des assemblys de modèles multidimensionnels](../analysis-services/multidimensional-models/multidimensional-model-assemblies-management.md)  
