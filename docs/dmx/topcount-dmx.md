...
## <a name="remarks"></a>Notes  
 La valeur fournie par l' \<expression de classement > argument détermine l’ordre de classement décroissant pour les lignes fournies dans l' \<expression de table > argument et le nombre de lignes supérieures spécifiées dans l' expressiondetable.\<l’argument Count > est retourné.  
 ...
 Toutefois, dans certaines situations, il se peut que vous deviez toujours utiliser le nombre de la valeur. Par exemple, DMX ne prend pas en charge le qualificateur **Top** dans une instruction sub-select. La [fonction &#40;DMX&#41; PredictHistogram](../dmx/predicthistogram-dmx.md) ne prend pas non plus en charge l’ajout de **Top**.  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [&#40;DMX plus haut&#41;](../dmx/topsum-dmx.md)  
