...
## <a name="remarks"></a>Notes  
 Si l'état prédit est omis, l'état ayant la probabilité la plus élevée est utilisé, à l'exception du compartiment des états manquants. Pour inclure le compartiment des États manquants, définissez l’État \<prédite > sur **INCLUDE_NULL**. Pour retourner la probabilité pour les États manquants, affectez la valeur NULL à l’État \<prédit >.  
...
## <a name="see-also"></a>Voir aussi  
 [Informations de référence &#40;sur&#41; les fonctions DMX des Extensions d’exploration de données](../dmx/data-mining-extensions-dmx-function-reference.md)   
