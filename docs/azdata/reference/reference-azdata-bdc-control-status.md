...
description: Utilisez cet article de référence pour comprendre les commandes SQL dans l’outil azdata, en particulier la commande bdc control status.
author: MikeRayMSFT
ms.author: mikeray
