...
description: Utilisez cet article de référence pour comprendre les commandes SQL dans l’outil azdata, en particulier les commandes bdc spark batch.
author: MikeRayMSFT
ms.author: mikeray
