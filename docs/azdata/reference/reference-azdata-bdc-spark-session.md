...
description: Utilisez cet article de référence pour comprendre les commandes SQL dans l’outil azdata, en particulier la commande bdc spark session.
author: MikeRayMSFT
ms.author: mikeray
