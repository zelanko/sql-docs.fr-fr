...
description: Utilisez cet article de référence pour comprendre les commandes SQL dans l’outil azdata, en particulier les diverses commandes app.
author: MikeRayMSFT
ms.author: mikeray
