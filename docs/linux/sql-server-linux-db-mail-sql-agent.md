...
description: Découvrez comment utiliser DB Mail et configurer les alertes par e-mail avec SQL Server Agent (mssql-server-agent) sur Linux.
author: VanMSFT
ms.author: vanto
ms.date: 02/20/2018
ms.topic: conceptual
