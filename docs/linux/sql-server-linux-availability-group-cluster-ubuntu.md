...
La commande suivante crée un cluster à trois nœuds. Avant d’exécuter le script, remplacez les valeurs comprises entre `**< ... >**`. Exécutez la commande suivante sur le nœud principal. 
