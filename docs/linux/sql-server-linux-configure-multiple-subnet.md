---
title: Configurer le sous-réseau de plusieurs groupes de disponibilité AlwaysOn et les instances de cluster de basculement sur Linux
description: ''
author: MikeRayMSFT
ms.author: mikeray
ms.reviewer: vanto
