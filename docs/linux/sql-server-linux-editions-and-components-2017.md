...
description: Cet article décrit les fonctionnalités prises en charge par les différentes éditions de SQL Server 2017 sur Linux. Il vous aide à choisir parmi les éditions et les composants disponibles.
ms.date: 01/14/2020
ms.prod: sql
ms.technology: linux
ms.topic: conceptual
...
- [Notes de publication de SQL Server 2017 sur Linux](sql-server-linux-release-notes.md)
- [Nouveautés dans SQL Server 2017 sur Linux](sql-server-linux-whats-new.md)
