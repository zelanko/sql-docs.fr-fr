...
Le tableau suivant répertorie l’historique de publication des versions antérieures de SQL Server 2019.

| Version                   | Options de version       | Date de publication |
|---------------------------|---------------|--------------|
| [Version Release Candidate](#rc)  | 15.0.1900.25  | 2019-8-21    |
