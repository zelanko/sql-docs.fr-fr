...
description: Cet article contient les notes de publication et fonctionnalités prises en charge pour SQL Server 2019 CTP est en cours d’exécution sur Linux. Les notes de publication sont incluses dans la version la plus récente et plusieurs versions précédentes.
author: rothja
ms.author: jroth
manager: craigg
ms.date: 09/24/2018
...
Les notes de publication suivantes s’appliquent à SQL Server 2019 CTP est en cours d’exécution sur Linux. Cet article est divisé en sections pour chaque version. Chaque version a un lien vers un article du support technique décrivant les modifications CU, ainsi que des liens vers les téléchargements du package de Linux.

> [!TIP]
> Pour en savoir plus sur les nouvelles fonctionnalités de Linux dans SQL Server 2019, consultez [quelles sont les nouveautés dans SQL Server 2019](../sql-server/what-s-new-in-sql-server-ver15.md?view=sql-server-ver15#sqllinux).
...
Le tableau suivant répertorie l’historique des versions pour les versions CTP de SQL Server 2019.
