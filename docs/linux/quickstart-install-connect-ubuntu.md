...
Dans ce guide de démarrage rapide, vous installez d’abord SQL Server 2017 sur Ubuntu 16.04puis vous vous connectez avec **sqlcmd** pour créer votre première base de données et exécuter des requêtes.
...
1. Après la fin de l’installation package, exécutez le programme d’installation **mssql-conf** et suivez les invites pour définir le mot de passe SA et choisisr votre édition.
