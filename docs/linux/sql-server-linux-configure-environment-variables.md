...
Vous pouvez utiliser plusieurs variables d’environnement différent pour configurer SQL Server 2019 CTP 2.0 sur Linux. Ces variables sont utilisées dans deux scénarios :
