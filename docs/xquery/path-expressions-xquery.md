...
-   La première étape extrait le \<ProductDescription > enfants de nœud d’élément de la racine du document.  
  
-   La seconde étape extrait le \<Résumé > enfants du nœud élément pour chaque récupérées \<ProductDescription > nœud d’élément, qui à son tour devienne le nœud de contexte.  
...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Spécification d’un Test de nœud dans une étape d’Expression de chemin d’accès](../xquery/path-expressions-specifying-node-test.md)  
