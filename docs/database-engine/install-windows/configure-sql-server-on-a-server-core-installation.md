...
ms.topic: "article"
helpviewer_keywords: 
  - "Propriété du serveur IsHadrEnabled"
  - "Installation Server Core [SQL Server]"
...
-   [Configurer et gérer Server Core sur Windows Server](../../database-engine/install-windows/configure-sql-server-on-a-server-core-installation.md#BKMK_ConfigureWindows)  
  
-   [Installer des mises à jour de SQL Server](../../database-engine/install-windows/configure-sql-server-on-a-server-core-installation.md#BKMK_InstallSQLUpdates)  
  
-   [Démarrer/arrêter un service SQL Server](../../database-engine/install-windows/configure-sql-server-on-a-server-core-installation.md#BKMK_StartStopServices)  
  
-   [Activer les groupes de disponibilité AlwaysOn](../../database-engine/install-windows/configure-sql-server-on-a-server-core-installation.md#BKMK_EnableAlwaysON)  
  
-   [Configuration de l'accès à distance de SQL Server s'exécutant sur Server Core](../../database-engine/install-windows/configure-sql-server-on-a-server-core-installation.md#BKMK_ConfigureRemoteAccess)  
  
-   [SQL Server Profiler](../../database-engine/install-windows/configure-sql-server-on-a-server-core-installation.md#BKMK_Profiler)  
  
-   [Audit SQL Server](../../database-engine/install-windows/configure-sql-server-on-a-server-core-installation.md#BKMK_Auditing)  
  
-   [Utilitaires de ligne de commande](../../database-engine/install-windows/configure-sql-server-on-a-server-core-installation.md#BKMK_CMD)  
  
-   [Utiliser les outils de dépannage](../../database-engine/install-windows/configure-sql-server-on-a-server-core-installation.md#BKMK_troubleshoot)  
...
-   [Installation d’un rôle de serveur sur un serveur exécutant une installation Server Core de Windows Server 2008 R2 : Présentation](http://go.microsoft.com/fwlink/?LinkId=245960) (http://go.microsoft.com/fwlink/?LinkId=245960)  
  
-   [Installation de fonctionnalités Windows sur un serveur exécutant une installation Server Core de Windows Server 2008 R2 : Présentation](http://go.microsoft.com/fwlink/?LinkId=245961) (http://go.microsoft.com/fwlink/?LinkId=245961)  
...
-   [Installation des mises à jour de SQL Server 2016 pendant une nouvelle installation](../../database-engine/install-windows/configure-sql-server-on-a-server-core-installation.md#bkmk_NewInstall)  
  
-   [Installation des mises à jour de SQL Server 2016 après qu’il a déjà été installé](../../database-engine/install-windows/configure-sql-server-on-a-server-core-installation.md#bkmk_alreadyInstall)  
...
### Utilisation du Gestionnaire de configuration [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] à distance  
 Les étapes qui suivent doivent être effectuées sur un ordinateur exécutant l’édition cliente de [!INCLUDE[win7](../../includes/win7-md.md)] ou version ultérieure, ou un autre serveur sur lequel l’interpréteur de commandes graphique de serveur est installé (c’est-à-dire une installation complète de [!INCLUDE[winserver2008r2](../../includes/winserver2008r2-md.md)] ou une installation de [!INCLUDE[win8srv](../../includes/win8srv-md.md)] avec la fonctionnalité d’interpréteur de commandes graphique de serveur activée).  
...
1.  Ouvrez la Gestion de l'ordinateur. Pour ouvrir la Gestion de l'ordinateur, effectuez l'une des actions suivantes :  
    ...
    2.  Sur [!INCLUDE[win8srv](../../includes/win8srv-md.md)] avec l’interpréteur de commandes graphique de serveur activé :  
...
### Activer les connexions distantes sur l'instance de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
### Activer et démarrer le service [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Browser  
...
### Activer TCP/IP sur l’instance de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
## Voir aussi  
 [Installer SQL Server 2016 sur Server Core](../../database-engine/install-windows/install-sql-server-2016-on-server-core.md)   
