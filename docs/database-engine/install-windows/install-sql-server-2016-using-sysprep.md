---
title: "Installation de SQL Server&#160;2016 &#224; l’aide de SysPrep | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
manager: "jhubbard"
---
# Installation de SQL Server&#160;2016 &#224; l’aide de SysPrep
...
-   [Désinstallation d'une instance préparée](../../database-engine/install-windows/install-sql-server-2016-using-sysprep.md#Uninstall)  
  
-   [Modification ou désinstallation d'une instance finalisée de SQL Server.](../../database-engine/install-windows/install-sql-server-2016-using-sysprep.md#bk_Modifying_Uninstalling)  
...
#### Pour préparer un cluster de basculement [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (sans assistance)  
...
#### Création d'un cluster de basculement [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (sans assistance)  
...
#### Ajout d'un nœud à un cluster de basculement [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] existant (sans assistance)  
...
#### Préparez une instance autonome de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
...
#### Finaliser une instance préparée de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
5.  Dans la page **Clé du produit** , sélectionnez une case d'option pour indiquer si vous installez une édition gratuite de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]ou une version de production du produit qui a une clé PID. Pour plus d’informations, consultez [Éditions et composants de SQL Server 2016](../../sql-server/editions-and-components-of-sql-server-2016.md). Si vous installez l'édition Evaluation, la période d'essai de 180 jours démarre lorsque vous terminez cette étape.  
...
8.  Dans la page **Vérification des fonctionnalités** sont répertoriés les fonctionnalités et composants sélectionnés inclus dans l'installation pendant l'étape de préparation. Si vous souhaitez ajouter davantage de fonctionnalités à votre instance de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] non incluses dans l'instance préparée, vous devez d'abord effectuer cette étape pour finaliser l'instance de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] , puis ajouter les fonctionnalités à partir de **Ajouter des fonctionnalités** dans le **Centre d'installation**.  
    ...
    > [!NOTE]  
    >  Vous pouvez ajouter des fonctionnalités qui sont disponibles pour la version du produit que vous installez. Pour plus d’informations, consultez [Fonctionnalités prises en charge par les éditions de SQL Server 2016](../Topic/Features%20Supported%20by%20the%20Editions%20of%20SQL%20Server%202016.md).  
...
#### Ajouter des fonctionnalités à une instance préparée de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
#### Suppression de fonctionnalités d'une instance préparée de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
#### Désinstaller une instance préparée de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
## Voir aussi  
 ...
 [Fonctionnement de SysPrepWork](http://go.microsoft.com/fwlink/?LinkId=143547)  
