...
helpviewer_keywords: 
  ...
  - "bases de données [Analysis Services], mise à niveau"
  - "installation d’Analysis Services, installations côte à côte"
  - "mises à niveau d'Analysis Services"
  - "mises à niveau d’Analysis Services, à propos de la mise à niveau d’Analysis Services"
  - "SSAS, migration de base de données"
  - "mise à niveau d'Analysis Services"
  - "installation d’Analysis Services, mise à niveau"
  - "SSAS, mise à niveau"
...
# Mettre &#224; niveau Analysis Services
  Les instances d’Analysis Services peuvent être mises à niveau vers une version SQL Server 2016 du même mode de serveur pour tirer parti des fonctionnalités introduites dans la version actuelle, telle que décrite dans [What's New in Analysis Services](../../analysis-services/what-s-new-in-analysis-services.md).  
...
-   [Notes de publication de SQL Server 2016](http://go.microsoft.com/fwlink/?LinkID=398124) décrit les problèmes connus et les solutions de contournement.  
...
## Mise à niveau du modèle tabulaire vers le niveau de compatibilité 1200  
...
## Version après mise à niveau pour les modèles tabulaires au niveau de compatibilité 1200  
...
## Mettre à niveau des modèles tabulaires en mode DirectQuery  
...
4.  Réactivez **DirectQuery** . Pour obtenir des instructions, consultez [DirectQuery for Tabular 1200 models](../Topic/DirectQuery%20for%20Tabular%201200%20models.md) .  
...
## Voir aussi  
 ...
 [Installer Analysis Services en mode multidimensionnel et exploration de données](../Topic/Install%20Analysis%20Services%20in%20Multidimensional%20and%20Data%20Mining%20Mode.md)   
