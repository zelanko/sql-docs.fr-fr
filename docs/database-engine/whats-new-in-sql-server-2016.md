...
- Pour télécharger [SQL Server 2016](https://www.microsoft.com/en-us/evalcenter/evaluate-sql-server-2016).
...
-   [Index columnstore](#columnstore-indexes)
-   [Configurations étendues à la base de données](#database-scoped-configurations)
...
-   [Prise en charge du codage UTF-8](#support-for-utf-8)
-   [Nouvelles valeurs par défaut de taille de base de données et de croissance automatique](#new-default-database-size-and-autogrow-values)
-   [Améliorations de Transact-SQL](#transact-sql-enhancements)
-   [Améliorations des vues système](#system-view-enhancements)
-   [Améliorations de la sécurité](#security-enhancements)
-   [Améliorations en matière de haute disponibilité](#high-availability-enhancements)
-   [Améliorations apportées à la réplication](#replication-enhancements)
-   [Améliorations apportées aux outils](#tools-enhancements)
