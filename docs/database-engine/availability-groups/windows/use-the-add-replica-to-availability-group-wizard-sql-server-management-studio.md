...
---
# Utiliser l&#39;Assistant Ajouter un r&#233;plica au groupe de disponibilit&#233; (SQL Server Management Studio)
  Utilisez l’Assistant Ajouter un réplica au groupe de disponibilité pour ajouter un nouveau réplica secondaire à un groupe de disponibilité Always On existant.  
...
-   **Pour ajouter un réplica, à l’aide de :** [Assistant Ajouter un réplica au groupe de disponibilité (SQL Server Management Studio)](#SSMSProcedure)  
