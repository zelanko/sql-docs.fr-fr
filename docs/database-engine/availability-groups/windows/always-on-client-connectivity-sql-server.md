...
|[Microsoft JDBC Driver 4.0+ pour SQL Server](../../../connect/oledb/oledb-driver-for-sql-server.md)|Oui|Oui|Oui|Oui|Oui| 
|[Microsoft OLE DB Driver pour SQL Server](../../../connect/jdbc/microsoft-jdbc-driver-for-sql-server.md)|Oui|Oui|Oui|Oui|Oui| 
 ...
 *Téléchargez le nouveau pilote Microsoft OLE DB Driver pour SQL Server : [https://aka.ms/downloadmsoledbsql](https://aka.ms/downloadmsoledbsql).  
