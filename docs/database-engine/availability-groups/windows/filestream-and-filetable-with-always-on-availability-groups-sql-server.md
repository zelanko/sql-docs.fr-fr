...
ms.topic: "article"
helpviewer_keywords: 
  - "FileTables [SQL Server], groupes de disponibilité"
  - "FILESTREAM [SQL Server], groupes de disponibilité"
...
---
# FILESTREAM et FileTable avec groupes de disponibilit&#233; Always On (SQL Server)
