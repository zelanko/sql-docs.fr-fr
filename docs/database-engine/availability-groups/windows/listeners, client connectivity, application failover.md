...
helpviewer_keywords: 
  ...
  - "connexions d'intention de lecture [Groupes de disponibilité AlwaysOn]"
  - "Groupes de disponibilité [SQL Server], configuration"
  - "Groupes de disponibilité [SQL Server], routage en lecture seule"
...
###  <a name="DbmConnectionString"></a> Utilisation de chaînes de connexion de mise en miroir de bases de données avec des groupes de disponibilité  
...
-   [Présentation de l’écouteur du groupe de disponibilité](http://blogs.msdn.com/b/sqlAlways%20On/archive/2012/01/16/introduction-to-the-availability-group-listener.aspx) (blog de l’équipe SQL Server Always On)  
