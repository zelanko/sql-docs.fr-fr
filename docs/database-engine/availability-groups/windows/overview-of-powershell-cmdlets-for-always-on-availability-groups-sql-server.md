...
ms.topic: "article"
helpviewer_keywords: 
  - "Groupes de disponibilité [SQL Server], applets de commande PowerShell"
  - "Groupes de disponibilité [SQL Server], à propos des"
...
---
# Vue d’ensemble des applets de commande PowerShell pour les groupes de disponibilit&#233; Always On (SQL Server)
