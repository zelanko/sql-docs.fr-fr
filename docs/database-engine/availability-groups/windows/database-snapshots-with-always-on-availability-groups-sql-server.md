...
ms.topic: "article"
helpviewer_keywords: 
  - "captures instantanées de base de données, groupes de disponibilité AlwaysOn (SQL Server)"
...
---
# Instantan&#233;s de base de donn&#233;es avec des groupes de disponibilit&#233; Always On (SQL Server)
