...
helpviewer_keywords: 
  - "Groupes de disponibilité [SQL Server], reprise d’une base de données"
...
2.  Reprenez la base de données secondaire à l’aide de l’instruction [ALTER DATABASE](../Topic/ALTER%20DATABASE%20SET%20HADR%20\(Transact-SQL\).md)suivante :  
