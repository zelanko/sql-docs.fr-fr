...
ms.topic: "article"
helpviewer_keywords: 
  - "dépannage [SQL Server], déploiement"
  - "Groupes de disponibilité [SQL Server], dépannage"
...
##  <a name="SystemName"></a> Nom système  
...
##  <a name="NetworkAccess"></a> Accès réseau  
