---
title: "R&#233;plication, suivi des modifications, capture de donn&#233;es modifi&#233;es et groupes de disponibilit&#233; Always On (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "suivi des modifications [SQL Server], groupes de disponibilité AlwaysOn"
  - "capture de données de modification [SQL Server], groupes de disponibilité AlwaysOn"
...
manager: "jhubbard"
---
# R&#233;plication, suivi des modifications, capture de donn&#233;es modifi&#233;es et groupes de disponibilit&#233; Always On (SQL Server)
...
-   [Vue d’ensemble de la réplication sur les groupes de disponibilité Always On](#Overview)  
  
    -   [Redirection de serveur de publication](#PublisherRedirect)  
  
    -   [Modifications apportées aux agents de réplication pour prendre en charge les groupes de disponibilité Always On](#Changes)  
  
    -   [Procédures stockées qui prennent en charge Always On](#StoredProcs)  
  
    -   [Capture de données modifiées](#CDC)  
  
    -   [Suivi des modifications](#CT)  
  
-   [Conditions préalables, restrictions et considérations relatives à l’utilisation de la réplication avec des groupes de disponibilité Always On](#Prereqs)  
  
-   [Tâches associées](#RelatedTasks)  
  
##  <a name="Overview"></a> Vue d’ensemble de la réplication sur les groupes de disponibilité Always On  
...
###  <a name="PublisherRedirect"></a> Redirection de serveur de publication  
 ...
 Dans un groupe de disponibilité Always On, une base de données secondaire ne peut pas être un serveur de publication. La republication est prise en charge uniquement lorsque la réplication transactionnelle est associée à [!INCLUDE[ssHADR](../../../includes/sshadr-md.md)].  
...
###  <a name="Changes"></a> Modifications générales apportées aux agents de réplication pour prendre en charge les groupes de disponibilité Always On  
...
###  <a name="StoredProcs"></a> Procédures stockées qui prennent en charge Always On  
