...
helpviewer_keywords: 
  ...
  - "copie des journaux de transaction [SQL Server], travaux"
  - "travaux de copie [SQL Server]"
  - "bases de données primaires [SQL Server]"
  - "copie des journaux de transaction [SQL Server], analyse"
  - "copie des journaux de transaction [SQL Server], à propos de la copie des journaux de transaction"
  - "travaux d'alerte [SQL Server]"
  - "disponibilité [SQL Server]"
  - "travaux [SQL Server], copie des journaux de transaction"
  - "serveurs moniteurs [SQL Server]"
  - "travaux de restauration [SQL Server]"
  - "copie des journaux de transaction [SQL Server]"
  - "travaux de sauvegarde [SQL Server]"
