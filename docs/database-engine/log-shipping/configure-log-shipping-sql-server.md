...
description: Découvrez comment configurer la copie des journaux de transaction à l’aide de SQL Server Management Studio ou de Transact-SQL dans SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
