...
description: Découvrez comment voir le rapport de copie des journaux de transaction dans l’interface graphique utilisateur de SSMS (SQL Server Management Studio).
