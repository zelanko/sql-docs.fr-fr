...
|Outils|Utilitaire sqlmaint|Utilisez la fonction de plan de maintenance [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] |Aucune|Aucune|  
...
|Pointeurs de texte|WRITETEXT<br /><br /> UPDATETEXT<br /><br /> READTEXT|Aucune|UPDATETEXT ou WRITETEXT<br /><br /> READTEXT|115<br /><br /> 114|  
|Pointeurs de texte|TEXTPTR()<br /><br /> TEXTVALID()|Aucune|TEXTPTR<br /><br /> TEXTVALID|5<br /><br /> 6|  
...
|[!INCLUDE[tsql](../includes/tsql-md.md)]|Pas d'instructions [!INCLUDE[tsql](../includes/tsql-md.md)] se terminant avec un point-virgule.|Terminez les instructions [!INCLUDE[tsql](../includes/tsql-md.md)] avec un point-virgule (;).|Aucune|Aucune|  
