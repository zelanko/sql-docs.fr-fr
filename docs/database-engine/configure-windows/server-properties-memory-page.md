...
description: Se familiariser avec les options de mémoire du serveur dans SQL Server. En savoir plus sur la mémoire minimale et maximale du serveur, la mémoire de création d’index et d’autres paramètres.
ms.custom: ''
ms.date: 03/08/2016
ms.prod: sql
