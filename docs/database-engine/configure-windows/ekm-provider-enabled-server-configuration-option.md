---
title: "Fournisseur EKM activ&#233; (option de configuration de serveur) | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2017"
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx_md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  L’option **Fournisseur EKM activé** contrôle la prise en charge du périphérique EKM dans [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Par défaut, cette option est désactivée.  
