...
ms.topic: "article"
helpviewer_keywords: 
  - "Gestionnaire de configuration SQL Server, accès"
  - "Moteur de base de données [SQL Server], services"
  - "gestion des services [SQL Server], à propos de la gestion de services"
  - "services [SQL Server]"
  - "Service SQL Server Agent, gestion"
  - "Services SQL Server, à propos du service SQL Server"
  - "MSSQLServer"
  - "configuration du serveur [SQL Server]"
  - "gestion des services [SQL Server]"
  - "service SQL Server Agent"
  - "services [SQL Server], gestion"
  - "gestion de SQL Server, services"
  - "services SQL Server"
...
> [!NOTE]  
>  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Le Gestionnaire de configuration ne peut pas gérer les services [!INCLUDE[ssVersion2000](../../includes/ssversion2000-md.md)].  
...
|[Exécuter SQL Server avec ou sans réseau](../../database-engine/configure-windows/run-sql-server-with-or-without-a-network.md)|[Configurer les options de démarrage du serveur &#40;Gestionnaire de configuration SQL Server&#41;](../../database-engine/configure-windows/configure-server-startup-options-sql-server-configuration-manager.md)|  
...
|[Options de démarrage du service moteur de base de données](../../database-engine/configure-windows/database-engine-service-startup-options.md)|[Configurer des journaux d'erreurs SQL Server](../../database-engine/configure-windows/configure-sql-server-error-logs.md)|  
