...
ms.topic: "article"
helpviewer_keywords: 
  - "connexions [SQL Server], autres ordinateurs"
...
manager: "jhubbard"
---
# Se connecter &#224; un autre ordinateur (Gestionnaire de configuration SQL&#160;Server)
...
#### Pour se connecter à un autre ordinateur avec la Gestion de l'ordinateur Windows  
