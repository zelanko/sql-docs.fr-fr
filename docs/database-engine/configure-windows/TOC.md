...
# [option de configuration du serveur affinity64 Input-Output mask](affinity64-input-output-mask-server-configuration-option.md)
...
# [Se connecter à un autre ordinateur (Gestionnaire de configuration SQL Server)](connect-to-another-computer-sql-server-configuration-manager.md)
...
# [Configurer l'option de configuration du serveur Langue par défaut](configure-the-default-language-server-configuration-option.md)
...
# [Configurer l'option de configuration de serveur Facteur de remplissage](configure-the-fill-factor-server-configuration-option.md)
...
# [Authentification de la base de données à relation contenant-contenu (option de configuration de serveur)](contained-database-authentication-server-configuration-option.md)
...
# [Configurer l’option de configuration du serveur remote data archive](configure-the-remote-data-archive-server-configuration-option.md)
...
# [option de configuration de serveur scripts externes activés](external-scripts-enabled-server-configuration-option.md)
...
# [option de configuration de serveur Masque d’affinité d’E/S](affinity-input-output-mask-server-configuration-option.md)
...
# [Extension du pool de mémoires tampons](buffer-pool-extension.md)
# [Nouveautés de SQL Server 2016 (moteur de base de données)](what-s-new-in-sql-server-2016-database-engine.md)
...
# [Propriétés de SQL Server (page FILESTREAM)](sql-server-properties-filestream-page.md)
...
# [Configurer les options de démarrage du serveur (Gestionnaire de configuration SQL Server)](configure-server-startup-options-sql-server-configuration-manager.md)
...
# [Moteur de base de données](sql-server-database-engine.md)
# [Configuration des protocoles réseau par défaut de SQL Server](default-sql-server-network-protocol-configuration.md)
# [Conformité des critères communs activée (option de configuration de serveur)](common-criteria-compliance-enabled-server-configuration-option.md)
...
# [Résoudre les problèmes de connexion au moteur de base de données SQL Server](troubleshoot-connecting-to-the-sql-server-database-engine.md)
...
# [Nouveautés de SQL Server vNext (moteur de base de données)](what-s-new-in-sql-server-vnext-database-engine.md)
# [Configurer des protocoles clients](configure-client-protocols.md)
# [Configurer l'option de configuration du serveur index create memory](configure-the-index-create-memory-server-configuration-option.md)
...
# [Regroupement léger (option de configuration de serveur)](lightweight-pooling-server-configuration-option.md)
...
# [Afficher ou configurer l'option de configuration du serveur valeur par défaut de compression de la sauvegarde](view-or-configure-the-backup-compression-default-server-configuration-option.md)
...
# [Configurer l'option de configuration du serveur cursor threshold](configure-the-cursor-threshold-server-configuration-option.md)
...
# [Propriétés du serveur (page Général) - SQL Server Management Studio](server-properties-general-page-sql-server-management-studio.md)
# [Configurer l'option de configuration du serveur query wait](configure-the-query-wait-server-configuration-option.md)
# [Configurer l'option de configuration du serveur Langue de texte intégral par défaut](configure-the-default-full-text-language-server-configuration-option.md)
...
# [Vue d'ensemble du moniteur SQL Server](sql-server-monitor-overview.md)
# [Configurer des journaux d'erreurs SQL Server](configure-sql-server-error-logs.md)
