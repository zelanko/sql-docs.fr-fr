...
## [clr strict security (option de configuration de serveur)](clr-strict-security.md)  
...
## [external scripts enabled (option de configuration de serveur)](external-scripts-enabled-server-configuration-option.md)  
...
## [Services SCM - Se connecter à un autre ordinateur](scm-services-connect-to-another-computer.md)  
### [Services SCM - Définir le démarrage automatique d’une instance](scm-services-set-an-instance-to-start-automatically.md)  
### [Services SCM - Empêcher le démarrage automatique](scm-services-prevent-automatic-startup-of-an-instance.md)  
### [Services SCM - Changer le compte de démarrage du service](scm-services-change-the-service-startup-account.md)  
### [SCM Services - Configurer les options de démarrage du serveur](scm-services-configure-server-startup-options.md)  
### [Services SCM - Changer le mot de passe des comptes](scm-services-change-the-password-of-the-accounts-used.md)  
### [Services SCM - Configurer des journaux d’erreurs SQL Server](scm-services-configure-sql-server-error-logs.md)  
