---
title: "Configurer un serveur pour &#233;couter un port&#160;TCP sp&#233;cifique (Gestionnaire de configuration SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "port fixe"
  - "ports statiques"
  - "ports [SQL Server], affectation de numéros"
  - "affectation de numéros de port"
  - "ports dynamiques [SQL Server]"
...
#### Pour affecter un numéro de port TCP/IP au moteur de base de données SQL Server  
...
4.  Dans la zone **Port TCP**, dans *Propriétés* **IP****n**, tapez le numéro du port sur lequel vous voulez que cette adresse IP écoute, puis cliquez sur **OK**.  
