---
title: "D&#233;marrer, arr&#234;ter, suspendre, reprendre, red&#233;marrer le moteur de base de donn&#233;es, SQL Server Agent ou le service SQL Server Browser | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Gestionnaire de configuration SQL Server, démarrer et arrêter les services"
  - "arrêt de l'Agent SQL Server"
  - "paramètres [SQL Server], options de démarrage"
  - "SQL Server, options de démarrage"
  - "Moteur de base de données [SQL Server], démarrage et arrêt des services"
  - "suspension de SQL Server"
  - "PowerShell [SQL Server], démarrage et arrêt des services"
  - "mode mono-utilisateur [SQL Server], démarrage en"
  - "SQL Server Management Studio [SQL Server], démarrage ou arrêt des services"
  - "arrêt du service SQL Server Browser"
  - "démarrage de l'Agent SQL Server"
  - "instances par défaut [SQL Server], démarrage et arrêt"
  - "SQL Server Agent, démarrage et arrêt"
  - "invite de commandes [SQL Server], démarrage et arrêt des services SQL Server"
  - "poursuite de l'exécution de SQL Server"
  - "démarrage du moteur de base de données SQL Server"
  - "commandes net stop [SQL Server]"
  - "invite de commandes [SQL Server], service SQL Browser"
  - "Gestionnaire de configuration, démarrer et arrêter les services"
  - "reprise de SQL Server"
  - "options de démarrage [SQL Server]"
  - "instances nommées [SQL Server], démarrage et arrêt"
  - "commandes net start [SQL Server]"
  - "SQL Server, démarrage et arrêt"
  - "arrêt de SQL Server"
  - "démarrage du service SQL Server Browser"
  - "options de démarrage du moteur de base de données SQL Server"
  - "administration de SQL Server, démarrage et arrêt des services"
  - "Management Studio [SQL Server], démarrage ou arrêt des services"
...
#### Démarrage du Gestionnaire de configuration [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
#### Pour démarrer, arrêter, interrompre, reprendre, ou redémarrer une instance du [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]  
...
> [!NOTE]  
>  Pour démarrer une instance de [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)] avec les options de démarrage, consultez [Configurer les options de démarrage du serveur &#40;Gestionnaire de configuration SQL Server&#41;](../../database-engine/configure-windows/configure-server-startup-options-sql-server-configuration-manager.md).  
  
#### Pour démarrer, arrêter, interrompre, reprendre, ou redémarrer [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Browser ou une instance de l'Agent [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
#### Pour démarrer, arrêter ou redémarrer une instance de l'Agent [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
#### Pour arrêter le [!INCLUDE[ssDE](../../includes/ssde-md.md)] à l'aide de [!INCLUDE[tsql](../../includes/tsql-md.md)]  
...
#### Pour démarrer et arrêter des services du [!INCLUDE[ssDE](../../includes/ssde-md.md)]  
...
## Voir aussi  
 [Vue d'ensemble de la documentation d'installation de SQL Server](../Topic/Overview%20of%20SQL%20Server%20Setup%20Documentation.md)   
