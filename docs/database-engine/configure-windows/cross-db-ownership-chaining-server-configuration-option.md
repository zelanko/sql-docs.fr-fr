...
description: Apprenez à utiliser l’option « cross db ownership chaining » dans SQL Server. Affichez les considérations sur l'activation ou la désactivation du chaînage des propriétés des bases de données croisées.
ms.custom: ''
ms.date: 08/15/2017
ms.prod: sql
