---
title: "Conformit&#233; des crit&#232;res communs activ&#233;e (option de configuration de serveur) | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2017"
...
helpviewer_keywords: 
  - "CC (critères communs) [moteur de base de données]"
  - "conformité avec les critères communs [moteur de base de données]"
  - "protection des informations résiduelles (moteur de base de données)"
