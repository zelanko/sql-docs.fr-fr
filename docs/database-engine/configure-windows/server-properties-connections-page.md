...
description: Découvrez les paramètres de connexion dans SQL Server. Apprenez-en davantage sur les options qui définissent le contrôle de contrainte différée, la gestion NULL et les autres comportements.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
## <a name="see-also"></a>Voir aussi  
 [Options &#40;exécution de requête : SQL Server : page Avancé&#41;](https://docs.microsoft.com/sql/ssms/f1-help/database-engine-query-editor-sql-server-management-studio)   
