...
description: Familiarisez-vous avec l’option « in-doubt xact resolution ». Découvrez comment elle détermine le résultat par défaut des transactions incertaines dans SQL Server.
ms.custom: ''
ms.date: 03/02/2017
ms.prod: sql
