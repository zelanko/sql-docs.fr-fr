---
title: "Configurer un pare-feu Windows pour acc&#233;der au moteur de base de donn&#233;es | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "connexions [SQL Server], systèmes de pare-feu"
  - "systèmes de pare-feu [moteur de base de données]"
  - "sécurité [SQL Server], pare-feu"
