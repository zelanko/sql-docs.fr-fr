...
description: Découvrez l’option « user connections ». Découvrez comment elle peut vous aider à éviter de surcharger une instance de SQL Server avec un trop grand nombre de connexions simultanées.
ms.custom: ''
ms.date: 03/02/2017
ms.prod: sql
