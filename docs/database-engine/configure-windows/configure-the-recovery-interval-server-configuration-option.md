...
description: Découvrez l’option recovery interval. Découvrez comment sa valeur affecte la fréquence à laquelle SQL Server émet des points de contrôle automatiques sur une base de données.
ms.custom: ''
ms.date: 03/02/2017
ms.prod: sql
