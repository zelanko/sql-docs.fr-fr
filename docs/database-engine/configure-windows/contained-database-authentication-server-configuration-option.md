...
description: Apprenez-en plus sur l’option « authentification de la base de données autonome ». Découvrez comment l’activer afin de pouvoir attacher les bases de données autonomes au moteur de base de données SQL Server.
ms.custom: ''
ms.date: 03/02/2017
ms.prod: sql
