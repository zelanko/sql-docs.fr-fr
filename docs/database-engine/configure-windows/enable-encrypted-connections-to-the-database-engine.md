...
2. Dans la boîte de dialogue **Propriétés** de _Protocoles pour\<_ **nom_instance>** , sous l’onglet **Certificat**, sélectionnez le certificat voulu dans la liste déroulante de la zone **Certificat**, puis cliquez sur **OK**.  
