...
ms.topic: "article"
helpviewer_keywords: 
  - "configuration du client [SQL Server], connexions"
  - "Moteur de base de données [SQL Server], configurations réseau"
  - "connexions [SQL Server], configuration du client"
  - "connexions du client [SQL Server], à propos des connexions réseau du client"
  - "ordinateurs clients [SQL Server]"
  - "connexions clientes [SQL Server]"
  - "connexions réseau [SQL Server], configuration du client"
