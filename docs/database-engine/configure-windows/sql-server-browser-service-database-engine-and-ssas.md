...
## <a name="see-also"></a> Voir aussi  
 ...
 [Masquer une instance du moteur de base de données SQL Server](../../database-engine/configure-windows/hide-an-instance-of-sql-server-database-engine.md)  
