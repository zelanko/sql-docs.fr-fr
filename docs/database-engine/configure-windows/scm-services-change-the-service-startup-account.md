---
title: "Modifier le compte de d&#233;marrage du service pour SQL Server (Gestionnaire de configuration SQL Server) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "01/06/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Services SQL Server, modification des comptes de démarrage"
  - "comptes de démarrage [SQL Server]"
  - "modification des comptes de démarrage des services"
...
---
# Modifier le compte de d&#233;marrage du service pour SQL Server (Gestionnaire de configuration SQL Server)
...
4.  Dans la boîte de dialogue **SQL Server \<***nom_instance***> Propriétés**, cliquez sur l’onglet **Ouvrir une session**, sélectionnez un type de compte **Ouvrir une session en tant que**.  
