...
ms.topic: "article"
helpviewer_keywords: 
  - "gestion de serveurs [SQL Server], serveurs distants"
  - "serveurs distants [SQL Server], configuration"
  - "serveurs distants [SQL Server]"
...
> [!NOTE]  
>  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ne prend pas en charge l’option **trusted** pour **sp_remoteoption**.  
...
## Contenu connexe  
 ...
 [Configurer l'option de configuration du serveur remote access](../../database-engine/configure-windows/configure-the-remote-access-server-configuration-option.md)  
