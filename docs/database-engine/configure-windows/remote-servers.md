...
description: En savoir plus sur les serveurs distants, qui ont été remplacés par les serveurs liés dans SQL Server. Afficher des informations sur les fonctionnalités, la configuration et la sécurité.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
