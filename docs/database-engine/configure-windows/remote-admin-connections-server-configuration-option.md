...
description: Découvrez comment les applications sur des ordinateurs distants peuvent utiliser l’application de la couche Données (DAC). Consultez la page utilisation de l’option « connexions d’administration distantes » avec « sp_configure » pour activer cette fonctionnalité.
ms.custom: ''
ms.date: 03/02/2017
ms.prod: sql
