...
helpviewer_keywords: 
  - "NUMA"
  - "mémoire [SQL Server], NUMA"
  - "affinité NUMA"
  - "ports [SQL Server], utilisation de NUMA"
  - "UC [SQL Server], prise en charge de NUMA"
  - "NUMA, mappage d’un port à un nœud NUMA"
  - "affinité NUMA"
  - "TCP/IP [SQL Server], prise en charge de NUMA"
...
---
# Mapper les ports&#160;TCP/IP aux nœuds&#160;NUMA (SQL Server)
