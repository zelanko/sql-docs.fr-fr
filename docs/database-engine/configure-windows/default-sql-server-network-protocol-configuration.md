...
ms.topic: "article"
helpviewer_keywords: 
  - "protocoles [SQL Server], paramètres par défaut"
  - "protocoles par défaut, après l’installation"
...
Evaluation  | Nouvelle installation  | Activé   | Désactivé  | Désactivés pour les connexions réseau.
...
* [Création d'une chaîne de connexion valide à l'aide de canaux nommés](Creating%20a%20Valid%20Connection%20String%20Using%20Named%20Pipes.xml)
...
* lors d'une installation côte à côte avec une autre instance [!INCLUDE[ssNoVersion_md](../../includes/ssnoversion-md.md)] ;
