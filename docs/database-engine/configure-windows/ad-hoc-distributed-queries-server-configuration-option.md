...
description: Découvrez comment activer des requêtes distribuées ad hoc dans SQL Server. Vous pouvez ensuite utiliser OPENROWSET et OPENDATASOURCE pour vous connecter à des sources de données OLE DB distantes.
ms.custom: ''
ms.date: 03/02/2017
ms.prod: sql
