...
description: Découvrez l’option « default trace enabled ». Découvrez comment le suivi par défaut peut faciliter la résolution des problèmes.
ms.custom: ''
ms.date: 03/02/2017
ms.prod: sql
