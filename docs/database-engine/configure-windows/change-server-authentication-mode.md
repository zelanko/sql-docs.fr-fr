---
title: "Modifier le mode d&#39;authentification du serveur | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "compte sa"
  - "authentification [SQL Server], modification de modes"
  - "mode d'authentification du serveur [SQL Server]"
  - "modification du mode d'authentification du serveur"
...
#### Pour modifier le mode d'authentification de sécurité  
