...
ms.topic: "article"
helpviewer_keywords: 
  - "moteur de base de données [SQL Server], masquage d'instances"
  - "masquer des instances du moteur de base de données"
...
## Voir aussi  
 ...
 [Comment affecter un port statique à une instance nommée SQL Server et éviter un piège courant](http://blogs.msdn.com/b/arvindsh/archive/2012/09/08/how-to-assign-a-static-port-to-a-sql-server-named-instance-and-avoid-a-common-pitfall.aspx)  
