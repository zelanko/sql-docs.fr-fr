---
title: "Configurer l&#39;option de configuration du serveur Degr&#233; maximal de parall&#233;lisme | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "requêtes exécutées en parallèle [SQL Server]"
  - "processeurs [SQL Server], requêtes parallèles"
  - "nombre de processeurs pour les requêtes parallèles"
...
-   Vous pouvez remplacer la valeur de l'option max degree of parallelism dans les requêtes en spécifiant l'indicateur de requête MAXDOP dans l'instruction de requête. Pour plus d’informations, consultez [Indicateurs de requête &#40;Transact-SQL&#41;](../Topic/Query%20Hints%20\(Transact-SQL\).md).  
