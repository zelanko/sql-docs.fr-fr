...
helpviewer_keywords: 
  ...
  - "LocalDB, description"
  - "runtime de base de données locale"
...
-   Pour télécharger et installer SQL Server 2016 Express, accédez au **[Centre de téléchargement](http://www.microsoft.com/download/details.aspx?id=52679)**. LocalDB est une fonctionnalité sélectionnable lors de l’installation. Dans le **Centre de téléchargement**, LocalDB est disponible à partir du menu **Installation personnalisée** ou lorsque vous téléchargez le média. Si vous téléchargez le média, choisissez le package **Express Advanced** ou **LocalDB**. 
  
-   Vous avez un compte Azure ?  Cliquez **[ici](https://azure.microsoft.com/en-us/marketplace/partners/microsoft/sqlserver2016ctp33evaluationwindowsserver2012r2/?wt.mc_id=sqL16_vm)** pour lancer une machine virtuelle déjà équipée de [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] .  
...
|Nom partagé|""|  
|Propriétaire|"\<Votre_utilisateur_Windows>"|  
