...
## <a name="description"></a>Description  
 ...
 Pour plus d’informations sur l’inclusion de **LocalDB** dans une application, consultez les rubriques [Vue d’ensemble des données locales](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2012/ms233817(v=vs.110)), [Procédure pas à pas : création d’une base de données LocalDB](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2012/ms233763(v=vs.110)) et [Procédure pas à pas : connexion à des données dans une base de données SQL Server LocalDB (Windows Forms)](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2012/ms171890(v=vs.110)) dans la documentation [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)].  
  
 Pour un exemple de code qui utilise l’API **LocalDB**, consultez [Référence SQL Server Express LocalDB](../../relational-databases/sql-server-express-localdb-reference.md).  
