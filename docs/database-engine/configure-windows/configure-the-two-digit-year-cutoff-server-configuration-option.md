---
title: "Configurer l&#39;option de configuration du serveur two digit year cutoff | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2017"
...
helpviewer_keywords: 
  ...
  - "années sur quatre chiffres [SQL Server]"
...
-   **Pour configurer l'option Année de coupure à deux chiffres, utilisez :**  
  
     [SQL Server Management Studio](#SSMSProcedure)  
  
     [Transact-SQL](#TsqlProcedure)  
  
-   **Suivi :**  [Après avoir configuré l'option Année de coupure à deux chiffres](#FollowUp)  
...
#### Pour configurer l'option Année de coupure à deux chiffres  
...
##  <a name="FollowUp"></a> Suivi : Après avoir configuré l'option Année de coupure à deux chiffres  
