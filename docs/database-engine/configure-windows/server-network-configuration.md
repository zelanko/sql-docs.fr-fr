...
description: Familiarisez-vous avec les tâches de configuration réseau SQL Server. Affichez des informations sur l’activation des protocoles, la configuration du chiffrement, l’inscription des noms de principal du service et d’autres actions.
ms.custom: ''
ms.date: 07/27/2016
ms.prod: sql
