...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server, détermination de l’installation"
  - "vérification de l'installation du moteur de base de données"
  - "affichage de l'installation du moteur de base de données"
  - "vérification de Moteur de base de données installé [SQL Server]"
...
---
# D&#233;terminer si le moteur de base de donn&#233;es est install&#233; et d&#233;marr&#233;
...
#### Comment afficher et démarrer le moteur de base de données à l'aide du Gestionnaire de configuration SQL Server  
