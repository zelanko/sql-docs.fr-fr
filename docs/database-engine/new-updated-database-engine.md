...
1. [Guide de surveillance et de résolution des problèmes des groupes de disponibilité Always On](availability-groups/windows/always-on-availability-groups-troubleshooting-and-monitoring-guide.md)
2. [Événements étendus des groupes de disponibilité Always On](availability-groups/windows/always-on-extended-events.md)
3. [Journal de diagnostic d’intégrité des groupes de disponibilité Always On](availability-groups/windows/always-on-health-diagnostics-log.md)
4. [Stratégies des groupes de disponibilité Always On](availability-groups/windows/always-on-policies.md)
5. [Mémoires tampons en anneau des groupes de disponibilité Always On](availability-groups/windows/always-on-ring-buffers.md)
6. [Types d’attentes des groupes de disponibilité Always On](availability-groups/windows/always-on-wait-types.md)
7. [CLUSTER.LOG (groupes de disponibilité Always On)](availability-groups/windows/cluster-log-always-on-availability-groups.md)
8. [Vues de gestion dynamique et affichages catalogue système (groupes de disponibilité Always On)](availability-groups/windows/dynamic-management-views-and-system-catalog-views-always-on-availability-groups.md)
9. [Monitorer les performances des groupes de disponibilité Always On](availability-groups/windows/monitor-performance-for-always-on-availability-groups.md)
10. [Journal des erreurs SQL Server (groupes de disponibilité Always On)](availability-groups/windows/sql-server-error-log-always-on-availability-groups.md)
11. [Dépanner : dépassement de RPO du groupe de disponibilité](availability-groups/windows/troubleshoot-availability-group-exceeded-rpo.md)
12. [Dépanner : dépassement de RTO du groupe de disponibilité](availability-groups/windows/troubleshoot-availability-group-exceeded-rto.md)
13. [Dépanner : les changements sur le réplica principal ne sont pas répercutés sur le réplica secondaire](availability-groups/windows/troubleshoot-primary-changes-not-reflected-on-secondary.md)
14. [Outils utiles pour le dépannage](availability-groups/windows/useful-tools-for-troubleshooting.md)
