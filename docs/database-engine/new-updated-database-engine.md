...
1. [Amorçage automatique pour les réplicas secondaires](availability-groups/windows/automatic-seeding-secondary-replicas.md)
2. [Configurer un groupe de disponibilité pour les transactions distribuées](availability-groups/windows/configure-availability-group-for-distributed-transactions.md)
3. [Configurer un groupe de disponibilité distribué](availability-groups/windows/configure-distributed-availability-groups.md)
4. [Groupes de disponibilité distribués](availability-groups/windows/distributed-availability-groups.md)
5. [Groupes de disponibilité indépendants du domaine](availability-groups/windows/domain-independent-availability-groups.md)
6. [Fonctionnalités du moteur de base de données déconseillées dans SQL Server 2017](deprecated-database-engine-features-in-sql-server-2017.md)
