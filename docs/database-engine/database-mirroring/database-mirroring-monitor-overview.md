...
helpviewer_keywords: 
  - "Moniteur de mise en miroir de bases de données [SQL Server], interface"
...
---
# Vue d&#39;ensemble du moniteur de mise en miroir de bases de donn&#233;es
