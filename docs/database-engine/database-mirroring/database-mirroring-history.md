...
description: Découvrez comment afficher l’historique d’état de la mise en miroir d’une base de données sur une instance de serveur spécifiée dans SQL Server Management Studio.
ms.custom: ''
ms.date: 03/07/2017
ms.prod: sql
