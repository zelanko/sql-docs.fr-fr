---
title: "S&#233;curit&#233; du transport de la mise en miroir de bases de donn&#233;es et des groupes de disponibilit&#233; Always On (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "chiffrement [SQL Server], mise en miroir de bases de données"
  - "certificats [SQL Server], mise en miroir de base de données"
  - "cryptage [SQL Server], mise en miroir de bases de données"
