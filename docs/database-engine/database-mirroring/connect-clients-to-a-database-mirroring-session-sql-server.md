...
ms.topic: "article"
helpviewer_keywords: 
  - "partenaires [SQL Server], connexion de clients"
  - "mise en mémoire de bases de données [SQL Server], connexion de clients"
  - "connexions de clients [SQL Server], mise en miroir de bases de données"
  - "connexions [SQL Server], mise en miroir de bases de données"
 ...
 **Dans cette rubrique :**  
 ...
 [Établissement de la connexion initiale à une session de mise en miroir de bases de données](#InitialConnection)  
 ...
 [Algorithme de délai entre deux tentatives de connexion (pour les connexions TCP/IP)](#RetryAlgorithm)  
 Décrit l'algorithme de délai entre deux tentatives de connexion pour les connexions TCP/IP.  
  
 [Reconnexion à une session de mise en miroir de bases de données](#Reconnecting)  
 ...
 [Impact d'un nom de partenaire de basculement obsolète](#StalePartnerName)  
