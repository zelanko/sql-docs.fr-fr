---
title: "Conditions pr&#233;alables, limitations et recommandations relatives &#224; la mise en miroir de bases de donn&#233;es | Microsoft Docs"
ms.custom: ""
ms.date: "05/17/2016"
...
helpviewer_keywords: 
  ...
  - "mise en miroir de base de données [SQL Server], conditions préalables"
  - "mise en miroir de base de données [SQL Server], recommandations"
  - "mise en miroir de base de données [SQL Server], restrictions"
  - "mise en miroir de base de données [SQL Server], planification"
...
-   [Prise en charge de la mise en miroir de bases de données](#DbmSupport)  
  
-   [Configuration requise](#Prerequisites)  
  
-   [Restrictions](#Restrictions)  
  
-   [Recommandations relatives à la configuration des serveurs partenaires](#RecommendationsForPartners)  
  
-   [Recommandations relatives au déploiement de la mise en miroir de bases de données](#RecommendationsForDeploying)  
  
##  <a name="DbmSupport"></a> Prise en charge de la mise en miroir de bases de données  
 Pour plus d’informations sur la prise en charge de la mise en miroir de bases de données dans [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)], consultez [Fonctionnalités prises en charge par les éditions de SQL Server 2016](../Topic/Features%20Supported%20by%20the%20Editions%20of%20SQL%20Server%202016.md).  
