...
ms.topic: "article"
helpviewer_keywords: 
  - "délai d'attente [mise en miroir de bases de données SQL Server]"
  - "erreurs logicielles [SQL Server]"
  - "mise en miroir de base de données [SQL Server], dépannage"
  - "erreurs de délai d'attente [SQL Server]"
  - "dépannage [SQL Server], mise en miroir de base de données"
  - "erreurs matérielles"
  - "sessions de mise en miroir de bases de données ayant échoué [SQL Server]"
...
## Défaillances dues à des erreurs matérielles  
...
## Défaillances dues à des erreurs logicielles  
...
### Mécanisme du délai d'attente de la mise en miroir  
