---
title: "Estimer l&#39;interruption de service au cours d&#39;un basculement de r&#244;le (mise en miroir de bases de donn&#233;es) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "restauration par progression en parallèle [SQL Server]"
  - "basculement de rôle [SQL Server]"
  - "mise en miroir de bases de données [SQL Server], files d’attente"
  - "basculement [SQL Server], mise en miroir de bases de données"
  - "restauration par progression [mise en miroir de bases de données]"
