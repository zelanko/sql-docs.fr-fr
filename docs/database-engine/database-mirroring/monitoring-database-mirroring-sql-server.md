...
ms.topic: "article"
helpviewer_keywords: 
  - "analyse [SQL Server], mise en miroir de bases de données"
...
###  <a name="perf_metrics_of_dbm_monitor"></a> État affiché par le moniteur de mise en miroir de bases de données  
...
#### Journal sur le serveur principal  
...
-   **sys.database_mirroring_witnesses**  
     ...
     Cet affichage catalogue contient les métadonnées de la mise en miroir de bases de données correspondant à chaque session dans laquelle une instance de serveur est le témoin. Pour plus d’informations, consultez [sys.database_mirroring_witnesses &#40;Transact-SQL&#41;](../Topic/sys.database_mirroring_witnesses%20\(Transact-SQL\).md).  
...
-   **sys.dm_db_mirroring_connections**  
     ...
     Pour plus d’informations, consultez [sys.dm_db_mirroring_connections &#40;Transact-SQL&#41;](../Topic/sys.dm_db_mirroring_connections%20\(Transact-SQL\).md).  
