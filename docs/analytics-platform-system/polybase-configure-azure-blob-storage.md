...
Explorez les autres façons d’utiliser et surveiller PolyBase dans les articles suivants :

[Mappage de type avec PolyBase](../relational-databases/polybase/polybase-type-mapping.md).  
