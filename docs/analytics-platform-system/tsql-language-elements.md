...
description: Éléments de langage T-SQL pour le système de plateforme d’analyse (APS) SQL Server Parallel Data Warehouse (PDW).
author: mzaman1
ms.prod: sql
...
* [EFFECTUE](../t-sql/language-elements/execute-transact-sql.md)
* [manifestations](../t-sql/language-elements/expressions-transact-sql.md)
* [INSTRUCTION](../t-sql/language-elements/kill-transact-sql.md)
* [Solution de contournement de la propriété IDENTity](../t-sql/statements/create-table-transact-sql-identity-property.md)
* [ÉTENDUE](../t-sql/language-elements/print-transact-sql.md)
* [FAITES](../t-sql/language-elements/use-transact-sql.md)

## <a name="batches-control-of-flow-and-variables"></a>Lots, contrôle de flux et variables
* [COMMENCER... EFFET](../t-sql/language-elements/begin-end-transact-sql.md)
* [SAUT](../t-sql/language-elements/break-transact-sql.md)
* [INSTRUCTION@local_variable](../t-sql/language-elements/declare-local-variable-transact-sql.md)
* [IF... TIERCE](../t-sql/language-elements/if-else-transact-sql.md)
* [RAISERROR](../t-sql/language-elements/raiserror-transact-sql.md)
* [SET@local_variable](../t-sql/language-elements/set-local-variable-transact-sql.md)
* [LEVER](../t-sql/language-elements/throw-transact-sql.md)
* [ESSAYER... CEPTION](../t-sql/language-elements/try-catch-transact-sql.md)
* [DURANT](../t-sql/language-elements/while-transact-sql.md)
...
* [LES](../t-sql/language-elements/and-transact-sql.md)
* [BETWEEN](../t-sql/language-elements/between-transact-sql.md)
* [CORRESPOND](../t-sql/language-elements/exists-transact-sql.md)
* [DANS](../t-sql/language-elements/in-transact-sql.md)
* [N’EST PAS](../t-sql/queries/is-null-transact-sql.md)
* [PARENT](../t-sql/language-elements/like-transact-sql.md)
* [PAS](../t-sql/language-elements/not-transact-sql.md)
* [NI](../t-sql/language-elements/or-transact-sql.md)
...
* [ABSOLUE](../t-sql/functions/abs-transact-sql.md)
* [ACOS](../t-sql/functions/acos-transact-sql.md)
* [R](../t-sql/functions/ascii-transact-sql.md)
...
* [ÉTUDES](../t-sql/language-elements/case-transact-sql.md)
* [CAST et CONVERT](../t-sql/functions/cast-and-convert-transact-sql.md)
* [PLAFOND](../t-sql/functions/ceiling-transact-sql.md)
* [CHAR](../t-sql/functions/char-transact-sql.md)
* [CHARINDEX](../t-sql/functions/charindex-transact-sql.md)
* [EEPROM](../t-sql/functions/checksum-transact-sql.md)
* [TAMPON](../t-sql/language-elements/coalesce-transact-sql.md)
...
* [SAUT](../t-sql/functions/count-transact-sql.md)
...
* [TEMPS](../t-sql/functions/day-transact-sql.md)
...
* [DIFFÉRENCE](../t-sql/functions/difference-transact-sql.md)
...
* [VENIR](../t-sql/functions/exp-transact-sql.md)
...
* [DUISENT](../t-sql/functions/lead-transact-sql.md)
* [LEFT](../t-sql/functions/left-transact-sql.md)
* [LEN](../t-sql/functions/len-transact-sql.md)
* [Sign](../t-sql/functions/log-transact-sql.md)
* [LOG10](../t-sql/functions/log10-transact-sql.md)
* [INFÉRIEUR](../t-sql/functions/lower-transact-sql.md)
...
* [CHRONIQUE](../t-sql/functions/month-transact-sql.md)
...
* [EXPÉDITEUR](../t-sql/functions/sign-transact-sql.md)
...
* [ESPACE](../t-sql/functions/space-transact-sql.md)
* [SQL_VARIANT_PROPERTY](../t-sql/functions/sql-variant-property-transact-sql.md)
* [RACINE](../t-sql/functions/sqrt-transact-sql.md)
...
* [ÉLÉMENTS](../t-sql/functions/stuff-transact-sql.md)
* [SUBSTRING](../t-sql/functions/substring-transact-sql.md)
* [CHECKSUM](../t-sql/functions/sum-transact-sql.md)
...
* [COIN](../t-sql/functions/upper-transact-sql.md)
...
* [CRÉER UNE SESSION DE DIAGNOSTIC](../t-sql/language-elements/create-diagnostics-session-transact-sql.md)
...
* [DÉFINIR ANSI_NULL_DFLT_ON](../t-sql/statements/set-ansi-null-dflt-on-transact-sql.md)
* [DÉFINIR ANSI_NULLS](../t-sql/statements/set-ansi-nulls-transact-sql.md)
* [DÉFINIR ANSI_PADDING](../t-sql/statements/set-ansi-padding-transact-sql.md)
* [DÉFINIR ANSI_WARNINGS](../t-sql/statements/set-ansi-warnings-transact-sql.md)
...
* [DÉFINIR QUOTED_IDENTIFIER](../t-sql/statements/set-quoted-identifier-transact-sql.md)
...
* [DÉFINIR LE NIVEAU D’ISOLATION DE LA TRANSACTION](../t-sql/statements/set-transaction-isolation-level-transact-sql.md)
