---
title: Vues système
description: Vues système pour le système de plateforme d’analyse (APS) SQL Server Parallel Data Warehouse (PDW).
author: mzaman1
ms.prod: sql
...
Vues système pour le système de plateforme d’analyse (APS) SQL Server Parallel Data Warehouse (PDW).

## <a name="parallel-data-warehouse-catalog-views"></a>Affichages catalogue de Data Warehouse parallèles
...
## <a name="parallel-data-warehouse-dynamic-management-views-dmvs"></a>Vues de gestion dynamique (DMV) de Data Warehouse parallèles
...
## <a name="sql-server-dmvs-applicable-to-parallel-data-warehouse"></a>SQL Server DMV applicables aux Data Warehouse parallèles
...
* [sys. synonymes](../relational-databases/system-catalog-views/sys-synonyms-transact-sql.md)
...
## <a name="sql-server-dmvs-available-in-parallel-data-warehouse"></a>SQL Server DMV disponibles en parallèle Data Warehouse
Parallel Data Warehouse expose un grand nombre des SQL Server vues de gestion dynamique (DMV). Ces vues, lorsqu’elles sont interrogées en parallèle Data Warehouse, signalent l’état des bases de données SQL Server s’exécutant sur les distributions.

Chacun de ces DMV a une colonne spécifique appelée pdw_node_id. Il s’agit de l’identificateur du nœud de calcul. 
...
| Nom DMV en parallèle Data Warehouse | Lien vers SQL Server rubrique T-SQL |
|:--- |:--- |
...
## <a name="sql-server-2016-polybase-dmvs-available-in-parallel-data-warehouse"></a>SQL Server DMV 2016 Polybase disponibles en parallèle Data Warehouse
...
## <a name="sql-server-information_schema-views"></a>Vues INFORMATION_SCHEMA SQL Server
* [CHECK_CONSTRAINTS](../relational-databases/system-information-schema-views/check-constraints-transact-sql.md)
* [COLONNES](../relational-databases/system-information-schema-views/columns-transact-sql.md)
* [PARAMÈTRES](../relational-databases/system-information-schema-views/parameters-transact-sql.md)
...
* [ELLES](../relational-databases/system-information-schema-views/tables-transact-sql.md)
...
* [Affichage](../relational-databases/system-information-schema-views/views-transact-sql.md)

## <a name="next-steps"></a>Étapes suivantes
Pour plus d’informations de référence, consultez [éléments de langage t-SQL](tsql-language-elements.md) et [instructions t-SQL](tsql-statements.md).
