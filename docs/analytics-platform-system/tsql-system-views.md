---
title: "Vues système de T-SQL - Analytique plateforme système Parallel Data Warehouse | Documents Microsoft"
author: barbkess
ms.author: barbkess
manager: jhubbard
...
description: "Vues système Transact-SQL (T-SQL) pour un système de plateforme analyse (APS) SQL Server Parallel Data Warehouse (PDW)."
...
Vues système Transact-SQL (T-SQL) pour un système de plateforme analyse (APS) SQL Server Parallel Data Warehouse (PDW).
