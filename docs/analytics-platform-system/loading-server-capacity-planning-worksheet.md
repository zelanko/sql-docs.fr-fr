...
## <a name="clipboard-capacity-planning-worksheet"></a>![Presse-papiers](media/clipboard-icon.png "Presse-papiers") Feuille de planification de la capacité
...
[Acquérir et configurer un](acquire-and-configure-loading-server.md)
[chargeur de ligne de commande dwloader](dwloader.md) du serveur de chargement
