...
Pour plus d’informations sur le scoring dans SQL Server, consultez le [guide pratique pour générer des prédictions dans SQL Server Machine Learning](how-to-do-realtime-scoring.md).
