...
ms.topic: "article"
helpviewer_keywords: 
  - "utilitaires à invite de commandes [SQL Server], sqlservr"
  - "invite de commandes [SQL Server], suspension/reprise de l’instance de SQL Server"
  - "démarrage de l'instance de SQL Server"
  - "invite de commandes [SQL Server], poursuite de l’instance de SQL Server"
  - "sqlservr (utilitaire)"
  - "suspension de l'instance de SQL Server"
  - "arrêt de l'instance de SQL Server"
  - "reprise de SQL Server"
  - "invite de commandes [SQL Server], arrêt de l’instance de SQL Server"
  - "invite de commandes [SQL Server], démarrage de l’instance de SQL Server"
  - "poursuite de l'instance de SQL Server"
...
-   « Failed Virtual Allocate Bytes : FAIL_VIRTUAL_COMMIT \<taille> »  
