---
title: "Dériver un modèle à partir d’une Trace en cours d’exécution (SQL Server Profiler) | Documents Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Cette rubrique décrit comment créer un modèle de trace à partir d’une trace existante pendant son exécution à l’aide de [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].  
