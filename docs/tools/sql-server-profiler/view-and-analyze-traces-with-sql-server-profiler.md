...
ms.topic: "article"
helpviewer_keywords: 
  - "Profiler [SQL Server Profiler], affichage de traces"
  - "SQL Server Profiler, affichage de traces"
  - "traces [SQL Server], affichage"
  - "SQL Server Profiler, résolution de problèmes"
  - "résolution de problèmes [SQL Server], traces"
  - "événements [SQL Server], recherche dans une trace"
  - "Profiler [SQL Server Profiler], résolution de problèmes"
