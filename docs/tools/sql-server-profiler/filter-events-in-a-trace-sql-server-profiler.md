...
### Pour filtrer les événements dans une trace  
...
-   Si vous définissez un filtre sur les colonnes **StartTime** et **EndTime** de l’onglet Sélection des événements, vérifiez les éléments suivants :  
    ...
    -   La case **Utiliser des paramètres régionaux pour afficher les valeurs de date et d’heure** est cochée dans la boîte de dialogue **Options générales**. Pour afficher la boîte de dialogue **Options générales**, dans le menu **Outils** de [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)], cliquez sur **Options**.  
