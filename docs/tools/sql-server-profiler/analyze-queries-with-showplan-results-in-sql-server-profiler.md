...
ms.topic: "article"
helpviewer_keywords: 
  - "événements [SQL Server], plan d’exécution de requêtes"
  - "profileur [SQL Server Profiler], résultats du plan d’exécution de requêtes"
  - "SQL Server Profiler, résultats du plan d’exécution de requêtes"
