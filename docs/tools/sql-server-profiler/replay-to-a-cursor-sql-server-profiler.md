...
description: Découvrez comment utiliser un curseur dans SQL Server Profiler pour suspendre la relecture d’une trace à un point spécifique. Facilitez le débogage en relisant à un curseur.
ms.prod: sql
