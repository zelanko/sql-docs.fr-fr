---
title: "Aide (F1) du G&#233;n&#233;rateur de profils SQL | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "Profileur [SQL Server Profiler], aide"
  - "SQL Server Profiler, aide"
  - "Propriétés de la trace (boîte de dialogue)"
  - "Propriétés du modèle de trace (boîte de dialogue)"
  - "Propriétés des fichiers de suivi (boîte de dialogue)"
  - "Limite des compteurs de performances (boîte de dialogue)"
  - "Options générales (boîte de dialogue)"
  - "Sélectionner une table de charge de travail (boîte de dialogue)"
  - "Table de destination (boîte de dialogue)"
...
manager: "jhubbard"
---
# Aide (F1) du G&#233;n&#233;rateur de profils SQL
 ...
 ## Propriétés de la trace (Général)
 ...
 **Activer l'heure d'arrêt de la trace**  
 Définissez la date et l'heure auxquelles la trace doit s'arrêter et se fermer. Utilisez l'onglet **Sélection des événements** de la boîte de dialogue **Propriétés de la trace** pour afficher ou spécifier les événements à tracer et les colonnes de données.  
  
 ## Propriétés de la trace (onglet Sélection des événements)
...
## Propriétés du modèle de trace (onglet Général)
...
## Modifier les propriétés du modèle de trace (onglet Général)
 ...
 **Utiliser comme modèle par défaut pour le type de serveur sélectionné**  
 ...
 ## Propriétés du modèle de trace (onglet Sélection des événements)
...
#### Options  
 ...
 Spécifiez des filtres en cliquant sur l'en-tête de la colonne de données et en entrant les critères de filtre. Les colonnes de données filtrées sont indiquées par une icône de filtre à gauche de l'étiquette de colonne dans la boîte de dialogue **Modifier le filtre** .  
 ...
 **Organiser les colonnes**  
 ...
 ## Propriétés du fichier de trace (onglet Général) 
...
#### Options  
 **Nom de fichier**  
 Le chemin d'accès et le nom du fichier de trace ouvert.  
  
 **Nom du fournisseur de trace**  
 Affiche le nom de l'instance [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] qui a été tracée.  
 ...
 **Modifié le**  
 ...
 ## Propriétés du fichier de suivi (onglet Sélection des événements)
 ...
 **Organiser les colonnes**  
 ...
 ## Propriétés de la table de trace (onglet Sélection des événements)
 ...
 **Organiser les colonnes**  
 Après avoir sélectionné les colonnes **Événements** et de données à inclure dans la trace, cliquez sur **Organiser les colonnes** pour forcer la réorganisation dans la grille des colonnes de la fenêtre des résultats de la trace.  
  ...
  ## Générateur de profils SQL Server - Limite des compteurs de performances
...
### Pour sélectionner les objets et compteurs de performances à corréler avec une trace  
...
2.  Activez les compteurs que vous souhaitez corréler avec le fichier de trace du [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] .  
 ...
 ## Générateur de profils SQL Server - Outils/Options (page Options générales)
...
> **REMARQUE :**en cochant et en décochant cette case, vous modifiez le format d’affichage des colonnes de temps comme **StartTime** et **EndTime**. Toutefois, vous ne modifiez pas les paramètres de valeur **DateTime** dans les événements de langage ou les appels de procédure distante (RPC).  
...
### Options de substitution de fichier  
 ...
 **Intervalle d'interrogation du moniteur d'intégrité par défaut (sec)**  
 ...
 ## Générateur de profils SQL Server - Table source/Assistant Paramétrage du moteur de base de données - Sélectionner une table de charge de travail
...
#### Options  
 **SQL Server**  
 Spécifie l’instance de SQL Server actuellement connectée. Ce champ est rempli automatiquement et ne peut pas être mis à jour.  
 ...
 **Table**  
 ...
 ## Générateur de profils SQL Server – Table de destination
 ...
 **Table**  
 ...
 ## Générateur de profils SQL Server – Configuration de la relecture (Options de relecture de base)
 ...
 **Afficher les résultats de relecture**  
 ...
 ## Générateur de profils SQL Server - Configuration de la relecture (Options de relecture avancées)
 ...
 **Délai d'attente du moniteur de processus bloqués (s)**  
 ...
 ## Générateur de profils SQL Server (boîte de dialogue Rechercher)
 ...
 **Rechercher dans la colonne**  
 Cliquez sur la colonne de données sur laquelle la recherche doit porter, ou cliquez sur **\<Toutes les colonnes>** pour effectuer une recherche sur l’ensemble des colonnes de données de la trace.  
 ...
 **Précédent**  
 ...
 ## Générateur de profils SQL Server - Organiser les colonnes
 ...
 **Descendre**  
 ...
 ## Générateur de profils SQL Server - Modifier le filtre
...
> **REMARQUE :** pour les colonnes de données de type chaîne, les critères de filtre s’afficheront en tant que valeur de chaîne LIKE ou NOT LIKE.  

## Sélectionner le nom du modèle
