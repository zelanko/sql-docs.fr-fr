...
ms.topic: "article"
helpviewer_keywords: 
  - "organisation des colonnes de trace affichées [SQL Server]"
  - "disposition des colonnes de trace affichées"
...
### Pour grouper des colonnes de données affichées dans une trace  
...
### Pour grouper et agréger des colonnes de données dans une trace  
