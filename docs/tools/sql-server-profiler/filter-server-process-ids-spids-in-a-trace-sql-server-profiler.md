---
title: "Filtrer des identificateurs de processus serveur (SPID, Server Process ID) dans une trace (SQL Server Profiler) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Filtrer des identificateurs de processus serveur (SPID, Server Process ID) dans une trace (SQL Server Profiler)
...
### Pour filtrer des ID système dans une trace  
