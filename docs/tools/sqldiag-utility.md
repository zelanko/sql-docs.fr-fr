...
ms.topic: "article"
helpviewer_keywords: 
  - "utilitaires à invite de commandes [SQL Server], SQLdiag"
  - "arrêt de la collecte des diagnostics"
  - "stockage des informations de diagnostic"
  - "performances [SQL Server], collecte des diagnostics"
  - "enregistrements de diagnostic [SQL Server]"
  - "scripts [SQL Server], collecte des diagnostics"
  - "journaux [SQL Server], collecte des diagnostics"
  - "démarrage de la collecte des diagnostics"
  - "instance cluster de SQL Server"
  - "surveillance des performances [SQL Server], collecte des diagnostics"
  - "sécurité [SQL Server], collecte des diagnostics"
  - "SQLDIAG (service)"
  - "espace [SQL Server], collecte des diagnostics"
  - "SQLdiag (utilitaire)"
  - "espace disque [SQL Server], collecte des diagnostics"
  - "fichiers de configuration [SQL Server]"
  - "collecte automatique des diagnostics"
  - "clusters [SQL Server], collecte des diagnostics"
...
## Spécifications de sécurité  
 Sauf si **SQLdiag** est exécuté en mode générique (avec l’argument de ligne de commande **/G**), l’utilisateur qui exécute **SQLdiag** doit être membre du groupe **Administrateurs** de Windows et membre du rôle serveur fixe **sysadmin** de [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]. Par défaut, **SQLdiag** établit la connexion à [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] en utilisant l’authentification Windows, mais il prend également en charge l’authentification [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] .  
