...
# [Protocoles pour <serveur> (Gestionnaire de configuration SQL Server)](protocols-for-server-sql-server-configuration-manager.md)
# [Agent SQL Server<serveur> (Gestionnaire de configuration SQL Server)](sql-server-agent-server-sql-server-configuration-manager.md)
# [Report Server <serveur> (Gestionnaire de configuration SQL Server)](report-server-server-sql-server-configuration-manager.md)
...
# [SQL Server <serveur> (Gestionnaire de configuration SQL Server)](sql-server-server-sql-server-configuration-manager.md)
# [Propriétés de NS$<nom du service> (onglet Avancé)](ns-service-name-properties-advanced-tab.md)
...
# [Analysis Server <serveur> (Gestionnaire de configuration SQL Server)](analysis-server-server-sql-server-configuration-manager.md)
...
# [Propriétés de NS$<Nom service> (onglet Ouvrir une session)](ns-service-name-properties-log-on-tab.md)
...
# [Propriétés de l'Agent SQL Server (onglet Avancé)](sql-server-agent-properties-advanced-tab.md)
# [Propriétés de NS$<Nom service> (onglet Service)](ns-service-name-properties-service-tab.md)
...
# [Propriétés de l'Agent SQL Server (onglet Service)](sql-server-agent-properties-service-tab.md)
...
# [Propriétés de l'Agent SQL Server (onglet Ouvrir une session)](sql-server-agent-properties-log-on-tab.md)
