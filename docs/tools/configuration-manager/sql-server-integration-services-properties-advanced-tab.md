...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Microsoft [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] est implémenté en tant que le [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]service. Si des propriétés personnalisées sont définies, elles apparaissent dans cet onglet, avec les valeurs correspondantes. Il est possible qu'aucune propriété ne soit répertoriée dans cet onglet.  
