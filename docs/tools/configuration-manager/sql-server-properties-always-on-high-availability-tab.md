...
---
# Propri&#233;t&#233;s de SQL Server (onglet Haute disponibilit&#233; AlwaysOn)
...
> [!NOTE]  
>  Pour plus d’informations sur la prise en charge des fonctionnalités et sur les conditions préalables, restrictions et recommandations supplémentaires pour [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)], consultez la documentation en ligne de [!INCLUDE[ssHADR](../../includes/sshadr-md.md)].  
