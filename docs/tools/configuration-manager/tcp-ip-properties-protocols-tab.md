...
## Voir aussi  
 ...
 [Création d’une chaîne de connexion valide à l’aide du protocole TCP/IP](/sql-docs/docs/tools/configuration-manager/creating-a-valid-connection-string-using-tcp-ip)  
