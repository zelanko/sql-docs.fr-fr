 ...
 **\<chemin d’installation de contrôleur > \DReplayController.config**  
 ...
 **\<chemin d’installation de client > \DReplayClient.config**  
 ...
 **\<chemin d’installation d’outil Administration > \DReplayAdmin\DReplay.exe.preprocess.config**  
 ...
 **\<chemin d’installation d’outil Administration > \DReplayAdmin\DReplay.exe.replay.config**  
