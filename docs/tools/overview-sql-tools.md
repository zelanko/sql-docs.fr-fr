...
- Vous souhaitez interroger le serveur SQL Server avec un outil de ligne de commande qui fonctionnalités IntelliSense, syntaxe haute-éclairage, et bien plus encore ? Choose [mssql-cli](mssql-cli.md)
