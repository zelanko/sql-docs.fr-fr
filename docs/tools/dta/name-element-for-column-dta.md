...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Spécifie le nom d’une colonne d’index dans une configuration spécifiée par l’utilisateur.  
