...
applies_to: 
  - "SQL Server 2016"
helpviewer_keywords: 
  - "charges de travail [SQL Server], paramétrage"
...
2.  Démarrez l'Assistant Paramétrage du moteur de base de données. Voir [Lancement de l’Assistant Paramétrage du moteur de base de données](../../tools/dta/launching-database-engine-tuning-advisor.md).  
...
[Affichage des recommandations pour le paramétrage](../../tools/dta/viewing-tuning-recommendations.md)  
