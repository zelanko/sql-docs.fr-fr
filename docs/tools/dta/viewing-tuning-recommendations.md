---
title: "Affichage des recommandations pour le param&#233;trage | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
1.  Démarrez l’Assistant Paramétrage du [!INCLUDE[ssDE](../../includes/ssde-md.md)]. Consultez [Lancement de l’Assistant Paramétrage du moteur de base de données](../../tools/dta/launching-database-engine-tuning-advisor.md). Assurez-vous de vous connecter à la même instance [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] que celle utilisée au cours de l’exercice [Paramétrage d’une charge de travail](../../tools/dta/tuning-a-workload.md).  
...
[Affichage des rapports de paramétrage](../../tools/dta/viewing-tuning-reports.md)  
