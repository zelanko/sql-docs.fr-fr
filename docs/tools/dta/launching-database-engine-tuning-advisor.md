...
helpviewer_keywords: 
  ...
  - "Assistant Paramétrage du moteur de base de données [SQL Server], démarrage"
...
[Définition des options du menu Outils et de la disposition](../../tools/dta/setting-tool-options-and-layout.md)  
