...
helpviewer_keywords: 
  - "serveurs inscrits [SQL Server], exportation"
  - "exportation des informations des serveurs inscrits"
...
---
# Exporter les informations des serveurs inscrits (SQL&#160;Server Management Studio)
...
#### Pour exporter les informations des serveurs inscrits  
