...
helpviewer_keywords: 
  - "transfert des informations des serveurs inscrits"
  - "serveurs inscrits [SQL Server], importation"
  - "importation des informations des serveurs inscrits"
...
---
# Importer des informations de serveur inscrit (SQL Server Management Studio)
...
#### Pour importer des informations de serveur inscrit  
