---
title: "Cr&#233;er un nouveau serveur inscrit (SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "Serveurs inscrits [SQL Server], création de serveurs inscrits"
...
---
# Cr&#233;er un nouveau serveur inscrit (SQL Server Management Studio)
...
#### Pour inscrire automatiquement les instances de serveur local  
...
#### Pour créer un nouveau serveur inscrit  
...
1.  Si l'élément Serveurs inscrits n'est pas visible dans [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)], dans le menu **Affichage** , cliquez sur **Serveurs inscrits**.  
     ...
     **Nom du serveur**  
     Sélectionnez l’instance de serveur à inscrire en utilisant le format : *\<nom_serveur>*[\\*\<nom_instance>*].  
