...
helpviewer_keywords: 
  - "tql"
  - "modèles [Transact-SQL], création"
  - "modèles [Transact-SQL]"
...
[Enregistrer des scripts sous forme de projets ou de solutions](../../tools/sql-server-management-studio/save-scripts-as-projects-or-solutions.md)  
