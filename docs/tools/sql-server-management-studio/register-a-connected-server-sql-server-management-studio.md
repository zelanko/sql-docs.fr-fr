...
helpviewer_keywords: 
  - "Serveurs inscrits [SQL Server], inscrire des serveurs connectés"
  - "inscriptions de serveurs connectés [SQL Server]"
...
---
# Inscrire un serveur connect&#233; (SQL Server Management Studio)
...
#### Pour inscrire un serveur connecté  
