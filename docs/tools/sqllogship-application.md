...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]
 ...
 ![Icône de lien de rubrique](../database-engine/configure-windows/media/topic-link.gif "Icône de lien de rubrique") Pour connaître les conventions de syntaxe, consultez [référence &#40;de l'&#41;utilitaire d’invite de commandes moteur de base de données](../tools/command-prompt-utility-reference-database-engine.md).  
