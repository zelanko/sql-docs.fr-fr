---
title: Configuration de compte de service SQL Server approuvée Launchpad | Microsoft Docs
description: Comment modifier le compte de service Launchpad approuvé de SQL Server utilisé pour l’exécution du script externe sur SQL Server.
ms.prod: sql
...
1. Ouvrez le [Gestionnaire de configuration SQL Server](../../relational-databases/sql-server-configuration-manager.md). 
  ...
  + Sur la page de démarrage, tapez **MMC** pour ouvrir la Console de gestion Microsoft.
