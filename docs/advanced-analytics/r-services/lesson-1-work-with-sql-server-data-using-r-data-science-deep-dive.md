---
title: "Le&#231;on 1 : Utiliser les donn&#233;es SQL Server &#224; l’aide de R (Immersion dans la science des donn&#233;es) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "09/30/2016"
...
---
# Le&#231;on 1 : Utiliser les donn&#233;es SQL Server &#224; l’aide de R (Immersion dans la science des donn&#233;es)
...
> [!NOTE]  
> Dans le cas d’une lecture seule des données, le compte qui exécute les scripts R requiert uniquement des autorisations SELECT (rôle **db_datareader**) sur la base de données spécifiée. Toutefois, dans ce didacticiel, vous avez besoin de privilèges d’administrateur DDL pour préparer la base de données et créer des tables pour enregistrer les résultats des évaluations.  
...
## Voir aussi  
[Immersion dans la science des données](http://msdn.microsoft.com/library/mt637368(SQL.130).aspx)  
