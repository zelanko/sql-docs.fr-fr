---
title: 'Tutoriel : Déployer un modèle de clustering dans python'
...
Dans la [troisième partie](tutorial-python-clustering-model-build.md), vous avez appris à créer et à former un modèle de clustering K-means dans Python.

## <a name="prerequisites"></a>Prérequis

* La quatrième partie de cette série de didacticiels suppose que vous avez rempli les conditions préalables de la [**première partie**](tutorial-python-clustering-model.md)et effectué les étapes de la deuxième [**partie**](tutorial-python-clustering-model-prepare-data.md) et de la troisième [**partie**](tutorial-python-clustering-model-build.md).
