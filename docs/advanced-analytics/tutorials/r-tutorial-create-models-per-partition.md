...
Vérifier la version en exécutant **`SELECT @@Version`** comme une requête T-SQL dans un outil de requête. Sortie doit être « Microsoft SQL Server 2019 (CTP 2.3) - 15.0.x ».
