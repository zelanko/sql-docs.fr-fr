---
title: Guide de démarrage rapide sur les types de données R et SQL et des objets (SQL Server Machine Learning) | Microsoft Docs
...
> [Démarrage rapide : Utiliser R des fonctions avec des données SQL Server](rtsql-using-r-functions-with-sql-server-data.md)
