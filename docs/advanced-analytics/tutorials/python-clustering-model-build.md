---
title: 'Tutoriel : Créer un modèle dans Python pour catégoriser les clients'
...
ms.locfileid: "70294404"
---
# <a name="tutorial-build-a-model-in-python-to-categorize-customers-with-sql-server-machine-learning-services"></a>Tutoriel : Créez un modèle dans Python pour classer les clients avec SQL Server Machine Learning Services
...
* La troisième partie de ce didacticiel suppose que vous avez rempli les conditions préalables de la [**première partie**](python-clustering-model.md)et effectué les étapes de la [**deuxième partie**](python-clustering-model-prepare-data.md).
...
Les quatre moyennes du cluster sont fournies à l’aide des variables définies dans la [première partie](python-clustering-model-prepare-data.md#separate-customers):
...
> [Tutoriel : Déployez un modèle de clustering dans Python avec SQL Server Machine Learning Services](python-clustering-model-deploy.md)