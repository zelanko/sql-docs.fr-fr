...
ms.locfileid: "62641305"
---
# <a name="tutorial-use-revoscaler-r-functions-with-sql-server-data"></a>Tutoriel : Utiliser les fonctions RevoScaleR R avec des données de SQL Server
