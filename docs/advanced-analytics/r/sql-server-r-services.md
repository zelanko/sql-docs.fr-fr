...
> [!Note]
> R Services a été renommé dans SQL Server 2017 et versions ultérieures à [SQL Server Machine Learning Services](../what-is-sql-server-machine-learning.md), qui reflète l’ajout de Python.
