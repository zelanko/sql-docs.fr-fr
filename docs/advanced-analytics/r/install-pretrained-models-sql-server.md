...
Cet article décrit comment ajouter modèles dont l’apprentissage à une instance (de-de base de données) de SQL Server qui a déjà R Services ou SQL Server Machine Learning Services installé. 
