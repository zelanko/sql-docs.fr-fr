...
3. Définir une chaîne de connexion à l’instance et de la base de données où la gestion des packages est activée et utiliser la chaîne de connexion pour créer un contexte de calcul de SQL Server.
