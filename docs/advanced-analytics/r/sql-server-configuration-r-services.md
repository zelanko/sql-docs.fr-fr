...
+ [Soft-NUMA automatique : Il exécute plus rapidement (Bob Ward)](https://blogs.msdn.microsoft.com/bobsql/2016/06/03/sql-2016-it-just-runs-faster-automatic-soft-numa/)

   Décrit l’historique, ainsi que les détails d’implémentation, avec des performances sur des serveurs multicœurs plus récents.
