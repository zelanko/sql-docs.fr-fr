---
title: Événements étendus pour Python dans l’apprentissage de SQL Server | Documents Microsoft
ms.prod: sql
...
ms.locfileid: "31201631"
---
# <a name="extended-events-for-python-in-sql-server-machine-learning"></a>Événements étendus pour Python dans l’apprentissage de SQL Server
