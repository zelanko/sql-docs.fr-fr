...
1. Télécharger un script d’installation.
  ...
  + [https://aka.ms/mls93-py](https://aka.ms/mls93-py) Installe la version 9.3 des packages Python de Microsoft. Cette version est un meilleur choix si votre instance de SQL Server 2017 à distance est [liés à Machine Learning Server 9.3](../install/upgrade-r-and-python.md).
...
4. Entrez et exécutez `print(revoscalepy.__version__)` pour retourner les informations de version. Vous devriez voir 9.2.1 ou 9.3.0. Vous pouvez utiliser une de ces versions avec [revoscalepy sur le serveur](../package-management/installed-package-information.md). 
