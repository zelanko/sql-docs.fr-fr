...
+ Sécurité des données. En associant les R et Python l’exécution de plus près à la source de données permet d’éviter le déplacement des données superflues ou non sécurisé.
