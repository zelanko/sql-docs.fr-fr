...
Découvrez comment exécuter des scripts Python et R dans un notebook dans [Azure Data Studio](https://docs.microsoft.com/sql/azure-data-studio/what-is) avec [SQL Server Machine Learning Services](../what-is-sql-server-machine-learning.md). Azure Data Studio est un outil de base de données multiplateforme.
