...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Contient le nom du serveur où se trouvent les bases de données que vous voulez paramétrer.  
