...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Contient des informations sur les index, les statistiques ou les structures de segments d’une configuration spécifiée par l’utilisateur.  
