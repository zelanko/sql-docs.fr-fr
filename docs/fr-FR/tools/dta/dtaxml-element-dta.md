...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] L’élément racine d’un fichier d’entrée ou de sortie de l’Assistant Paramétrage du moteur de base de données, **DTAXML**, contient tous les éléments qui décrivent les entrées et les sorties de paramétrage générées par l’Assistant Paramétrage du moteur de base de données.  
