...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Spécifie si les index, les vues indexées ou les partitions recommandés par l’Assistant Paramétrage du moteur de base de données peuvent être créés en ligne.  
