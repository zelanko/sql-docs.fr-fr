...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Contient les structures PDS (index ou vues indexées) que l’Assistant Paramétrage du moteur de base de données doit utiliser lors de l’analyse.  
