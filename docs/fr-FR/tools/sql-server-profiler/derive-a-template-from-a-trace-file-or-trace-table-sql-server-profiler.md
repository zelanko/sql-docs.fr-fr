...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Cette rubrique explique comment créer un modèle de trace à partir d’un fichier ou d’une table de trace existant avec [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].  
