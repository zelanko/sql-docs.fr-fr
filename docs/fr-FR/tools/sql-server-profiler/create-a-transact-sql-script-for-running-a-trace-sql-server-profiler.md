...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Cette rubrique explique comment créer un script Transact-SQL à partir d’une table ou d’un fichier de trace existant avec [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].  
