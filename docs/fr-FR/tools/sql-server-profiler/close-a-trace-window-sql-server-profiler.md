...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Cette rubrique explique comment fermer la fenêtre de trace pour des traces en cours d’exécution ou des traces enregistrées que vous visualisez avec [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].  
