...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Cette rubrique explique comment définir des options qui s’appliquent à toutes les traces créées avec une instance spécifique de [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].  
