...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Cette rubrique explique comment spécifier les classes d’événements et les colonnes de données des traces avec [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].  
