...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Cette rubrique explique comment ouvrir une table de trace existante avec [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].  
