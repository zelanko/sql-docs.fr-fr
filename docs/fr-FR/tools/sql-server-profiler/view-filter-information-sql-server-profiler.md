...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Cette rubrique décrit comment afficher des filtres sur des colonnes de données pour des classes d’événements avec [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].  
