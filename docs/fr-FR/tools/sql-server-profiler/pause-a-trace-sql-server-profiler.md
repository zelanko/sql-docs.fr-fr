...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Le fait de mettre en pause une trace empêche la capture de nouvelles données d’événement jusqu’au redémarrage de la trace.  
