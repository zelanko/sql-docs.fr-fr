...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Cette rubrique décrit la création d’un modèle de trace à partir d’une trace existante en cours d’exécution avec [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].  
