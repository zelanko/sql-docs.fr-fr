---
title: 'Commande (Index de la syntaxe Visual C++ avec #import) | Documents Microsoft'
ms.prod: sql
...
---
# <a name="command-visual-c-syntax-index-with-import"></a>Commande (Index de la syntaxe Visual C++ avec #import)
