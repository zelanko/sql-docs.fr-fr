---
title: DataControl, objet (RDS) Propriétés, méthodes et événements | Documents Microsoft
ms.prod: sql
...
## <a name="events"></a>Événements  
 [onError, événement (RDS)](../../../ado/reference/rds-api/onerror-event-rds.md)  
  
 [onReadyStateChange, événement (RDS)](../../../ado/reference/rds-api/onreadystatechange-event-rds.md)  
